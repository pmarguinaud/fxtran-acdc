...
SUBROUTINE SAVE_TECUCONVCA (SELF, KLUN)
...
SUBROUTINE LOAD_TECUCONVCA (SELF, KLUN)
...
SUBROUTINE COPY_TECUCONVCA (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE HOST_TECUCONVCA (SELF)
...
SUBROUTINE CRC64_TECUCONVCA (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TECUCONVCA (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TECUCONVCA (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
