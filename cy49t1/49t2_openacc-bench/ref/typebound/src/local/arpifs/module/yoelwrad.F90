...
PROCEDURE :: COPY => COPY_TELWRAD
PROCEDURE :: CRC64 => CRC64_TELWRAD
PROCEDURE :: HOST => HOST_TELWRAD
PROCEDURE :: LOAD => LOAD_TELWRAD
PROCEDURE :: SAVE => SAVE_TELWRAD
PROCEDURE :: SIZE => SIZE_TELWRAD
PROCEDURE :: WIPE => WIPE_TELWRAD
END TYPE TELWRAD
!============================================================================
...
MODULE SUBROUTINE COPY_TELWRAD (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TELWRAD (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TELWRAD (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TELWRAD (SELF, KLUN)
...
MODULE FUNCTION SIZE_TELWRAD (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TELWRAD (SELF, LDDELETED, LDFIELDAPI)
