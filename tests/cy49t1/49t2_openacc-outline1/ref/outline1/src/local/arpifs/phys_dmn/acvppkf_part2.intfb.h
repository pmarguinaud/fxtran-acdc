INTERFACE
SUBROUTINE ACVPPKF_PART2 (LDOCHTRANS, D, KKICE, K_KCH1, YDCPG_OPTS, YDML_PHY_MF&
&, PRDOCP, KCLBASS, KCLTOPS, KSDPL, KSLCL, KSPBL, LDTRIG1, PPABS, PRC, PRCTEN,&
& PRI, PRITEN, PRV, PRVTEN, PSHAL_ZCH1, PSHAL_ZCH1TENS, PSRVLCL, PSTHES, PSTHLCL&
&, PSTHV, PSTHVELCL, PSTLCL, PSWLCL, PSZLCL, PT, PTHT, PTTEN, PZUMF, PZZ)
