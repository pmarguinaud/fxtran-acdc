INTERFACE
SUBROUTINE APL_ARPEGE_SURFACE_LMSE_F (YDMF_PHYS_SURF, YDMODEL, YDCPG_OPTS, YDCPG_MISC&
&, YDMF_PHYS, YDMF_PHYS_BASE_STATE, YDCPG_BNDS, PFLU_CDN, PFMDV, PCOEFA, PCHROV, PSC_FEVN&
&, PCP, PNEBS, PDSA_CPS, PCFBS, PCFAU, PNEBDIFF, PNEBCH, PALPHA1, PCFBU, PFLU_FEVI, PXDROV&
&, PFLU_VEG, PDSE, PFMDU, PDIFWS, PXQRO, PSC_FCLN, PXHROV, PFLU_EMIS, PSC_FEVI, PHQ, PCFBV&
&, PQV, PHU, PLVT, PQICE, PFLU_CD, PFLU_NEIJ, PHTR, PCFBQ, PFLU_QSATS, PXURO, PDQSTS,&
& PCFAS, PQI, PCDROV, PQL, PDSA_LHS, PSC_FCLL, PXTRO, PCEROV, PDIFWQ)
