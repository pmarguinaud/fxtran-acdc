...
IF (LLCALL_CPCFU.OR.LLCALL_CPXFU.OR.LLCALL_CUMCPLDM) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CPG_DIA_FLU_PARALLEL:0')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZSTRCU, YL_ZSTRCU)
    CALL SGET_HOST_DATA_RDWR (ZSTRCV, YL_ZSTRCV)
    CALL SGET_HOST_DATA_RDWR (ZSTRDU, YL_ZSTRDU)
    CALL SGET_HOST_DATA_RDWR (ZSTRDV, YL_ZSTRDV)
    CALL SGET_HOST_DATA_RDWR (ZSTRTU, YL_ZSTRTU)
    CALL SGET_HOST_DATA_RDWR (ZSTRTV, YL_ZSTRTV)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_STRCU, YDMF_PHYS_OUT%F_STRCU)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_STRCV, YDMF_PHYS_OUT%F_STRCV)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_STRDU, YDMF_PHYS_OUT%F_STRDU)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_STRDV, YDMF_PHYS_OUT%F_STRDV)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_STRTU, YDMF_PHYS_OUT%F_STRTU)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_STRTV, YDMF_PHYS_OUT%F_STRTV)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('CPG_DIA_FLU_PARALLEL:0')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (ZSTRTU, YL_ZSTRTU)
      CALL SGET_HOST_DATA_RDWR (ZSTRTV, YL_ZSTRTV)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_STRCU, YDMF_PHYS_OUT%F_STRCU)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_STRCV, YDMF_PHYS_OUT%F_STRCV)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_STRDU, YDMF_PHYS_OUT%F_STRDU)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_STRDV, YDMF_PHYS_OUT%F_STRDV)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_STRTU, YDMF_PHYS_OUT%F_STRTU)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_STRTV, YDMF_PHYS_OUT%F_STRTV)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:0')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('CPG_DIA_FLU_PARALLEL:0:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDWR (ZSTRCU, YL_ZSTRCU)
    CALL SGET_DEVICE_DATA_RDWR (ZSTRCV, YL_ZSTRCV)
    CALL SGET_DEVICE_DATA_RDWR (ZSTRDU, YL_ZSTRDU)
    CALL SGET_DEVICE_DATA_RDWR (ZSTRDV, YL_ZSTRDV)
    CALL SGET_DEVICE_DATA_RDWR (ZSTRTU, YL_ZSTRTU)
    CALL SGET_DEVICE_DATA_RDWR (ZSTRTV, YL_ZSTRTV)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_STRCU, YDMF_PHYS_OUT%F_STRCU)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_STRCV, YDMF_PHYS_OUT%F_STRCV)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_STRDU, YDMF_PHYS_OUT%F_STRDU)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_STRDV, YDMF_PHYS_OUT%F_STRDV)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_STRTU, YDMF_PHYS_OUT%F_STRTU)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_STRTV, YDMF_PHYS_OUT%F_STRTV)
    IF (LHOOK) CALL DR_HOOK ('CPG_DIA_FLU_PARALLEL:0:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('CPG_DIA_FLU_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YFXTRAN_ACDC_STACK, ZSTRCU, ZSTRCV, ZSTRDU, ZSTRDV,  & 
    !$OMP &          ZSTRTU, ZSTRTV, Z_YDMF_PHYS_OUT_STRCU, Z_YDMF_PHYS_OUT_STRCV,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_STRDU, Z_YDMF_PHYS_OUT_STRDV, Z_YDMF_PHYS_OUT_STRTU,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_STRTV)  & 
    !$OMP & PRIVATE (JBLK)  & 
...
IF (LLCALL_CPXFU.OR.YDMODEL%YRML_PHY_G%YRDPHY%LDIRCLSMOD) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CPG_DIA_FLU_PARALLEL:1')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZNUCLS, YL_ZNUCLS)
    CALL SGET_HOST_DATA_RDWR (ZNVCLS, YL_ZNVCLS)
    CALL SGET_HOST_DATA_RDWR (ZUCLS, YL_ZUCLS)
    CALL SGET_HOST_DATA_RDWR (ZUGST, YL_ZUGST)
    CALL SGET_HOST_DATA_RDWR (ZVCLS, YL_ZVCLS)
    CALL SGET_HOST_DATA_RDWR (ZVGST, YL_ZVGST)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_NUCLS, YDMF_PHYS_OUT%F_NUCLS)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_NVCLS, YDMF_PHYS_OUT%F_NVCLS)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_UCLS, YDMF_PHYS_OUT%F_UCLS)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_UGST, YDMF_PHYS_OUT%F_UGST)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_VCLS, YDMF_PHYS_OUT%F_VCLS)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_VGST, YDMF_PHYS_OUT%F_VGST)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('CPG_DIA_FLU_PARALLEL:1')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (ZVCLS, YL_ZVCLS)
      CALL SGET_HOST_DATA_RDWR (ZVGST, YL_ZVGST)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_NUCLS, YDMF_PHYS_OUT%F_NUCLS)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_NVCLS, YDMF_PHYS_OUT%F_NVCLS)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_UCLS, YDMF_PHYS_OUT%F_UCLS)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_UGST, YDMF_PHYS_OUT%F_UGST)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_VCLS, YDMF_PHYS_OUT%F_VCLS)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_VGST, YDMF_PHYS_OUT%F_VGST)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:1')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('CPG_DIA_FLU_PARALLEL:1:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDWR (ZNUCLS, YL_ZNUCLS)
    CALL SGET_DEVICE_DATA_RDWR (ZNVCLS, YL_ZNVCLS)
    CALL SGET_DEVICE_DATA_RDWR (ZUCLS, YL_ZUCLS)
    CALL SGET_DEVICE_DATA_RDWR (ZUGST, YL_ZUGST)
    CALL SGET_DEVICE_DATA_RDWR (ZVCLS, YL_ZVCLS)
    CALL SGET_DEVICE_DATA_RDWR (ZVGST, YL_ZVGST)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_NUCLS, YDMF_PHYS_OUT%F_NUCLS)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_NVCLS, YDMF_PHYS_OUT%F_NVCLS)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_UCLS, YDMF_PHYS_OUT%F_UCLS)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_UGST, YDMF_PHYS_OUT%F_UGST)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_VCLS, YDMF_PHYS_OUT%F_VCLS)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_VGST, YDMF_PHYS_OUT%F_VGST)
    IF (LHOOK) CALL DR_HOOK ('CPG_DIA_FLU_PARALLEL:1:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('CPG_DIA_FLU_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YFXTRAN_ACDC_STACK, ZNUCLS, ZNVCLS, ZUCLS, ZUGST, ZVCLS,  & 
    !$OMP &          ZVGST, Z_YDMF_PHYS_OUT_NUCLS, Z_YDMF_PHYS_OUT_NVCLS, Z_YDMF_PHYS_OUT_UCLS,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_UGST, Z_YDMF_PHYS_OUT_VCLS, Z_YDMF_PHYS_OUT_VGST)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (YDCPG_OPTS%LDIAB.OR.(YDMODEL%YRML_PHY_MF%YRSIMPHL%LSIMPH&
  ...
  IF (LLCALL_CPCFU.OR.LLCALL_CPXFU.OR.LLCALL_CUMCPLDM) THEN
    ...
    ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:2')) THEN
      ...
      !$OMP TARGET TEAMS DISTRIBUTE  & 
      !$OMP & MAP(PRESENT:YDCPG_OPTS, YFXTRAN_ACDC_STACK, ZSTRCU, ZSTRCV, ZSTRDU, ZSTRDV,  & 
      !$OMP &          ZSTRTU, ZSTRTV, Z_YDVARS_GEOMETRY_GM_P)  & 
      !$OMP & PRIVATE (JBLK)  & 
      !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
  ...
  IF (LLCALL_CPXFU.OR.YDMODEL%YRML_PHY_G%YRDPHY%LDIRCLSMOD) THEN
    ...
    ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:3')) THEN
      ...
      !$OMP TARGET TEAMS DISTRIBUTE  & 
      !$OMP & MAP(PRESENT:YDCPG_OPTS, YFXTRAN_ACDC_STACK, ZNUCLS, ZNVCLS, ZUCLS, ZUGST, ZVCLS,  & 
      !$OMP &          ZVGST, Z_YDVARS_GEOMETRY_GM_P)  & 
      !$OMP & PRIVATE (JBLK)  & 
      !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (LLCALL_CPXFU) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CPG_DIA_FLU_PARALLEL:4')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZDPRECIPS, YL_ZDPRECIPS)
    CALL SGET_HOST_DATA_RDWR (ZDPRECIPS2, YL_ZDPRECIPS2)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_XP2_PPRECIP2, YDMF_PHYS_SURF%GSD_XP2%F_PRECIP2)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_XP_PPRECIP, YDMF_PHYS_SURF%GSD_XP%F_PRECIP)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:4')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('CPG_DIA_FLU_PARALLEL:4:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDWR (ZDPRECIPS, YL_ZDPRECIPS)
    CALL SGET_DEVICE_DATA_RDWR (ZDPRECIPS2, YL_ZDPRECIPS2)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_XP2_PPRECIP2, YDMF_PHYS_SURF%GSD_XP2%F_PRECIP2)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_XP_PPRECIP, YDMF_PHYS_SURF%GSD_XP%F_PRECIP)
    IF (LHOOK) CALL DR_HOOK ('CPG_DIA_FLU_PARALLEL:4:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('CPG_DIA_FLU_PARALLEL:4:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZDPRECIPS, ZDPRECIPS2,  & 
