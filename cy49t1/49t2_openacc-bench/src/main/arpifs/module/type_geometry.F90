...
!$ACDC methods --methods-list=crc64,size,host,copy,wipe,save,load --skip-components GEOMETRY%YRCSGEOMAD,GEOMETRY%YRGSGEOMAD,GEOMETRY%YROROG,GEOMETRY%YRCSGEOMAD_NB,GEOMETRY%YRGSGEOMAD_NB,GEOMETRY%YRCSGEOM_NB,GEOMETRY%YRCSGEOM,GEOMETRY%YRCSGEOM_B,GEOMETRY%YRGSGEOM_NB,GEOMETRY%YRGSGEOM,GEOMETRY%YRGSGEOM_B
