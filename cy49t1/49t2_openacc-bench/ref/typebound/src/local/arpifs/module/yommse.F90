...
CONTAINS
PROCEDURE :: COPY => COPY_TMSE
PROCEDURE :: CRC64 => CRC64_TMSE
PROCEDURE :: HOST => HOST_TMSE
PROCEDURE :: LOAD => LOAD_TMSE
PROCEDURE :: SAVE => SAVE_TMSE
PROCEDURE :: SIZE => SIZE_TMSE
PROCEDURE :: WIPE => WIPE_TMSE
END TYPE TMSE
...
MODULE SUBROUTINE COPY_TMSE (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TMSE (SELF)

IMPLICIT NONE
CLASS (TMSE), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TMSE (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TMSE (SELF, KLUN)
...
MODULE SUBROUTINE WIPE_TMSE (SELF, LDDELETED, LDFIELDAPI)
