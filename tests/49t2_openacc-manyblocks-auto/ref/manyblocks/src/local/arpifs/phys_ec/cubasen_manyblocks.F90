...
DO JKK=KLEV, JKT1,-1
  ...
  IF (IS/=0) THEN
    ...
    IF (JKK==KLEV) THEN
      ...
      DO JBLK = 1, KGPBLKS
        ...
        !$ACC LOOP VECTOR &
        !$ACC&PRIVATE (JL, ZKHVFL, ZRHO, ZTVENH, ZTVUH, ZUST, ZWS) 
    ...
    ELSE
      ...
      DO JBLK = 1, KGPBLKS
        ...
        !$ACC LOOP VECTOR &
        !$ACC&PRIVATE (JK, JL, ZQEXC, ZRHO, ZTEXC, ZTVENH, ZTVUH, ZWORK1, ZWORK2) 
  ...
  DO JBLK = 1, KGPBLKS
    ...
    !$ACC LOOP VECTOR &
    !$ACC&PRIVATE (IK, IS, JK, JKB, JL, Z1S, Z2S, ZALFAW, ZBUOF, ZCOND, ZCOND1, ZCOR, ZCOR_CUADJTQ, &
    !$ACC&         ZDP, ZDQ, ZDQSDT, ZDTDP, ZEPS, ZESDP, ZF, ZFAC, ZFACI, ZFACW, ZFOEEWI, ZFOEEWL, &
    !$ACC&         ZI, ZL, ZLGLAC, ZOEALFA, ZPDIFFBOT, ZPDIFFTOP, ZQF, ZQMAX, ZQP, ZQSAT, &
    !$ACC&         ZQSU, ZSF, ZTARG, ZTMP, ZTVENH, ZTVUH, ZXENTRORG, ZXENTSTPC1) 
  ...
  IF (JKK<KLEV) THEN
    ...
    DO JBLK = 1, KGPBLKS
      ...
      !$ACC LOOP VECTOR &
      !$ACC&PRIVATE (JKB, JKT, JL, LLRESET) 
