...
PROCEDURE :: ACDC_COPY => ACDC_COPY_FIELD_4RD_ARRAY
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_FIELD_4RD_ARRAY
PROCEDURE :: ACDC_HOST => ACDC_HOST_FIELD_4RD_ARRAY
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_FIELD_4RD_ARRAY
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_FIELD_4RD_ARRAY
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_FIELD_4RD_ARRAY
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_FIELD_4RD_ARRAY
END TYPE
...
MODULE SUBROUTINE ACDC_COPY_FIELD_4RD_ARRAY (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (FIELD_4RD_ARRAY), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDCREATED, LDFIELDAPI
END SUBROUTINE

MODULE SUBROUTINE ACDC_CRC64_FIELD_4RD_ARRAY (SELF, KLUN, CDPATH)
USE FIELD_UTIL_MODULE
...
MODULE SUBROUTINE ACDC_LOAD_FIELD_4RD_ARRAY (SELF, KLUN)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (FIELD_4RD_ARRAY), INTENT (OUT), TARGET :: SELF
INTEGER, INTENT (IN) :: KLUN
END SUBROUTINE

MODULE SUBROUTINE ACDC_SAVE_FIELD_4RD_ARRAY (SELF, KLUN)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (FIELD_4RD_ARRAY), INTENT (IN), TARGET :: SELF
INTEGER, INTENT (IN) :: KLUN
...
MODULE FUNCTION ACDC_SIZE_FIELD_4RD_ARRAY (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (FIELD_4RD_ARRAY),     INTENT (IN), TARGET :: SELF
...
MODULE SUBROUTINE ACDC_WIPE_FIELD_4RD_ARRAY (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (FIELD_4RD_ARRAY), INTENT (IN), TARGET :: SELF
