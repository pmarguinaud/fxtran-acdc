...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','MF_PHYS_PREP_PARALLEL:PREP')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN0_GWFL, YDCPG_DYN0%F_GWFL)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN0_GWFM, YDCPG_DYN0%F_GWFM)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN0_GWFT, YDCPG_DYN0%F_GWFT)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN0_NHPREF, YDCPG_DYN0%F_NHPREF)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN0_NHPREH, YDCPG_DYN0%F_NHPREH)
  ...
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN9_GWFT, YDCPG_DYN9%F_GWFT)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN9_NHPREF, YDCPG_DYN9%F_NHPREF)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN9_NHPREH, YDCPG_DYN9%F_NHPREH)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN9_PRE, YDCPG_DYN9%F_PRE)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN9_PREF, YDCPG_DYN9%F_PREF)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN9_XYB_ALPH, YDCPG_DYN9%XYB%F_ALPH)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN9_XYB_DELP, YDCPG_DYN9%XYB%F_DELP)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN9_XYB_LNPR, YDCPG_DYN9%XYB%F_LNPR)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN9_XYB_RDELP, YDCPG_DYN9%XYB%F_RDELP)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_PRE, YDCPG_PHY0%F_PRE)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_PREF, YDCPG_PHY0%F_PREF)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_PREHYD, YDCPG_PHY0%F_PREHYD)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_PREHYDF, YDCPG_PHY0%F_PREHYDF)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_W, YDCPG_PHY0%F_W)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_WL, YDCPG_PHY0%F_WL)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_WM, YDCPG_PHY0%F_WM)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_XYB_ALPH, YDCPG_PHY0%XYB%F_ALPH)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_XYB_DELP, YDCPG_PHY0%XYB%F_DELP)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_XYB_LNPR, YDCPG_PHY0%XYB%F_LNPR)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_XYB_RDELP, YDCPG_PHY0%XYB%F_RDELP)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY9_PRE, YDCPG_PHY9%F_PRE)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY9_PREF, YDCPG_PHY9%F_PREF)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY9_PREHYD, YDCPG_PHY9%F_PREHYD)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY9_PREHYDF, YDCPG_PHY9%F_PREHYDF)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY9_W, YDCPG_PHY9%F_W)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY9_XYB_ALPH, YDCPG_PHY9%XYB%F_ALPH)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY9_XYB_DELP, YDCPG_PHY9%XYB%F_DELP)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY9_XYB_LNPR, YDCPG_PHY9%XYB%F_LNPR)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY9_XYB_RDELP, YDCPG_PHY9%XYB%F_RDELP)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('MF_PHYS_PREP_PARALLEL:PREP')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN0_GWFL, YDCPG_DYN0%F_GWFL)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN0_GWFM, YDCPG_DYN0%F_GWFM)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN0_GWFT, YDCPG_DYN0%F_GWFT)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN0_NHPREF, YDCPG_DYN0%F_NHPREF)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN0_NHPREH, YDCPG_DYN0%F_NHPREH)
    ...
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN9_GWFT, YDCPG_DYN9%F_GWFT)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN9_NHPREF, YDCPG_DYN9%F_NHPREF)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN9_NHPREH, YDCPG_DYN9%F_NHPREH)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN9_PRE, YDCPG_DYN9%F_PRE)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN9_PREF, YDCPG_DYN9%F_PREF)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN9_XYB_ALPH, YDCPG_DYN9%XYB%F_ALPH)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN9_XYB_DELP, YDCPG_DYN9%XYB%F_DELP)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN9_XYB_LNPR, YDCPG_DYN9%XYB%F_LNPR)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN9_XYB_RDELP, YDCPG_DYN9%XYB%F_RDELP)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_PRE, YDCPG_PHY0%F_PRE)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_PREF, YDCPG_PHY0%F_PREF)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_PREHYD, YDCPG_PHY0%F_PREHYD)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_PREHYDF, YDCPG_PHY0%F_PREHYDF)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','MF_PHYS_PREP_PARALLEL:PREP')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('MF_PHYS_PREP_PARALLEL:PREP:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN0_GWFL, YDCPG_DYN0%F_GWFL)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN0_GWFM, YDCPG_DYN0%F_GWFM)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN0_GWFT, YDCPG_DYN0%F_GWFT)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN0_NHPREF, YDCPG_DYN0%F_NHPREF)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN0_NHPREH, YDCPG_DYN0%F_NHPREH)
  ...
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN9_GWFT, YDCPG_DYN9%F_GWFT)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN9_NHPREF, YDCPG_DYN9%F_NHPREF)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN9_NHPREH, YDCPG_DYN9%F_NHPREH)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN9_PRE, YDCPG_DYN9%F_PRE)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN9_PREF, YDCPG_DYN9%F_PREF)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN9_XYB_ALPH, YDCPG_DYN9%XYB%F_ALPH)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN9_XYB_DELP, YDCPG_DYN9%XYB%F_DELP)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN9_XYB_LNPR, YDCPG_DYN9%XYB%F_LNPR)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN9_XYB_RDELP, YDCPG_DYN9%XYB%F_RDELP)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY0_PRE, YDCPG_PHY0%F_PRE)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY0_PREF, YDCPG_PHY0%F_PREF)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY0_PREHYD, YDCPG_PHY0%F_PREHYD)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY0_PREHYDF, YDCPG_PHY0%F_PREHYDF)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY0_W, YDCPG_PHY0%F_W)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY0_WL, YDCPG_PHY0%F_WL)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY0_WM, YDCPG_PHY0%F_WM)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY0_XYB_ALPH, YDCPG_PHY0%XYB%F_ALPH)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY0_XYB_DELP, YDCPG_PHY0%XYB%F_DELP)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY0_XYB_LNPR, YDCPG_PHY0%XYB%F_LNPR)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY0_XYB_RDELP, YDCPG_PHY0%XYB%F_RDELP)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY9_PRE, YDCPG_PHY9%F_PRE)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY9_PREF, YDCPG_PHY9%F_PREF)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY9_PREHYD, YDCPG_PHY9%F_PREHYD)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY9_PREHYDF, YDCPG_PHY9%F_PREHYDF)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY9_W, YDCPG_PHY9%F_W)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY9_XYB_ALPH, YDCPG_PHY9%XYB%F_ALPH)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY9_XYB_DELP, YDCPG_PHY9%XYB%F_DELP)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY9_XYB_LNPR, YDCPG_PHY9%XYB%F_LNPR)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_PHY9_XYB_RDELP, YDCPG_PHY9%XYB%F_RDELP)
  IF (LHOOK) CALL DR_HOOK ('MF_PHYS_PREP_PARALLEL:PREP:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('MF_PHYS_PREP_PARALLEL:PREP:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDARPHY, YDCPG_OPTS, YDDYNA, YDGEOMETRY, YFXTRAN_ACDC_STACK,  & 
  !$OMP &          Z_YDCPG_DYN0_GWFL, Z_YDCPG_DYN0_GWFM, Z_YDCPG_DYN0_GWFT,  & 
  !$OMP &          Z_YDCPG_DYN0_NHPREF, Z_YDCPG_DYN0_NHPREH, Z_YDCPG_DYN0_PRE,  & 
  !$OMP &          Z_YDCPG_DYN0_PREF, Z_YDCPG_DYN0_XYB_ALPH, Z_YDCPG_DYN0_XYB_DELP,  & 
  !$OMP &          Z_YDCPG_DYN0_XYB_LNPR, Z_YDCPG_DYN0_XYB_RDELP, Z_YDCPG_DYN9_GWFT,  & 
  !$OMP &          Z_YDCPG_DYN9_NHPREF, Z_YDCPG_DYN9_NHPREH, Z_YDCPG_DYN9_PRE,  & 
  !$OMP &          Z_YDCPG_DYN9_PREF, Z_YDCPG_DYN9_XYB_ALPH, Z_YDCPG_DYN9_XYB_DELP,  & 
  !$OMP &          Z_YDCPG_DYN9_XYB_LNPR, Z_YDCPG_DYN9_XYB_RDELP, Z_YDCPG_PHY0_PRE,  & 
  !$OMP &          Z_YDCPG_PHY0_PREF, Z_YDCPG_PHY0_PREHYD, Z_YDCPG_PHY0_PREHYDF,  & 
  !$OMP &          Z_YDCPG_PHY0_W, Z_YDCPG_PHY0_WL, Z_YDCPG_PHY0_WM, Z_YDCPG_PHY0_XYB_ALPH,  & 
  !$OMP &          Z_YDCPG_PHY0_XYB_DELP, Z_YDCPG_PHY0_XYB_LNPR, Z_YDCPG_PHY0_XYB_RDELP,  & 
  !$OMP &          Z_YDCPG_PHY9_PRE, Z_YDCPG_PHY9_PREF, Z_YDCPG_PHY9_PREHYD,  & 
  !$OMP &          Z_YDCPG_PHY9_PREHYDF, Z_YDCPG_PHY9_W, Z_YDCPG_PHY9_XYB_ALPH,  & 
  !$OMP &          Z_YDCPG_PHY9_XYB_DELP, Z_YDCPG_PHY9_XYB_LNPR, Z_YDCPG_PHY9_XYB_RDELP)  & 
  !$OMP & PRIVATE (JBLK)  & 
