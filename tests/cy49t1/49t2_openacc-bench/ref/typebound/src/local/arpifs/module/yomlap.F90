...
CONTAINS
PROCEDURE :: COPY => COPY_TLAP
PROCEDURE :: CRC64 => CRC64_TLAP
PROCEDURE :: HOST => HOST_TLAP
PROCEDURE :: LOAD => LOAD_TLAP
PROCEDURE :: SAVE => SAVE_TLAP
PROCEDURE :: SIZE => SIZE_TLAP
PROCEDURE :: WIPE => WIPE_TLAP
END TYPE TLAP


INTERFACE

MODULE SUBROUTINE COPY_TLAP (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TLAP (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TLAP (SELF)
...
MODULE FUNCTION SIZE_TLAP (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TLAP (SELF, LDDELETED, LDFIELDAPI)
