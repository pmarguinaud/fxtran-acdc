...
PROCEDURE :: COPY => COPY_TDYN
PROCEDURE :: CRC64 => CRC64_TDYN
PROCEDURE :: HOST => HOST_TDYN
PROCEDURE :: LOAD => LOAD_TDYN
PROCEDURE :: SAVE => SAVE_TDYN
PROCEDURE :: SIZE => SIZE_TDYN
PROCEDURE :: WIPE => WIPE_TDYN
END TYPE TDYN
...
MODULE SUBROUTINE COPY_TDYN (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TDYN (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TDYN (SELF)

IMPLICIT NONE
CLASS (TDYN), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TDYN (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TDYN (SELF, KLUN)
...
MODULE FUNCTION SIZE_TDYN (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TDYN (SELF, LDDELETED, LDFIELDAPI)
