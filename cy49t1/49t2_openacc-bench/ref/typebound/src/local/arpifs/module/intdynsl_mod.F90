...
PROCEDURE :: COPY => COPY_TLSCAW
PROCEDURE :: CRC64 => CRC64_TLSCAW
PROCEDURE :: HOST => HOST_TLSCAW
PROCEDURE :: LOAD => LOAD_TLSCAW
PROCEDURE :: SAVE => SAVE_TLSCAW
PROCEDURE :: SIZE => SIZE_TLSCAW
PROCEDURE :: WIPE => WIPE_TLSCAW
END TYPE TLSCAW
...
PROCEDURE :: COPY => COPY_TRSCAW
PROCEDURE :: CRC64 => CRC64_TRSCAW
PROCEDURE :: HOST => HOST_TRSCAW
PROCEDURE :: LOAD => LOAD_TRSCAW
PROCEDURE :: SAVE => SAVE_TRSCAW
PROCEDURE :: SIZE => SIZE_TRSCAW
PROCEDURE :: WIPE => WIPE_TRSCAW
END TYPE TRSCAW
...
PROCEDURE :: COPY => COPY_TSCO
PROCEDURE :: CRC64 => CRC64_TSCO
PROCEDURE :: HOST => HOST_TSCO
PROCEDURE :: LOAD => LOAD_TSCO
PROCEDURE :: SAVE => SAVE_TSCO
PROCEDURE :: SIZE => SIZE_TSCO
PROCEDURE :: WIPE => WIPE_TSCO
END TYPE TSCO
...
PROCEDURE :: COPY => COPY_TCCO
PROCEDURE :: CRC64 => CRC64_TCCO
PROCEDURE :: HOST => HOST_TCCO
PROCEDURE :: LOAD => LOAD_TCCO
PROCEDURE :: SAVE => SAVE_TCCO
PROCEDURE :: SIZE => SIZE_TCCO
PROCEDURE :: WIPE => WIPE_TCCO
END TYPE TCCO
...
MODULE SUBROUTINE COPY_TLSCAW (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TLSCAW (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TLSCAW (SELF)

IMPLICIT NONE
CLASS (TLSCAW), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TLSCAW (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TLSCAW (SELF, KLUN)
...
MODULE FUNCTION SIZE_TLSCAW (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TLSCAW (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TRSCAW (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TRSCAW (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE LOAD_TRSCAW (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TRSCAW (SELF, KLUN)
...
MODULE FUNCTION SIZE_TRSCAW (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TRSCAW (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TSCO (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TSCO (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_TSCO (SELF)

IMPLICIT NONE
CLASS (TSCO), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TSCO (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TSCO (SELF, KLUN)
...
MODULE FUNCTION SIZE_TSCO (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TSCO (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TCCO (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TCCO (SELF)

IMPLICIT NONE
CLASS (TCCO), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TCCO (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TCCO (SELF, KLUN)
...
MODULE FUNCTION SIZE_TCCO (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TCCO (SELF, LDDELETED, LDFIELDAPI)
