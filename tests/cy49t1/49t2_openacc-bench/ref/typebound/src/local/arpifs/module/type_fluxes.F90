...
CONTAINS
PROCEDURE :: COPY => COPY_FLUXES_DESCRIPTOR
PROCEDURE :: HOST => HOST_FLUXES_DESCRIPTOR
PROCEDURE :: SIZE => SIZE_FLUXES_DESCRIPTOR
PROCEDURE :: WIPE => WIPE_FLUXES_DESCRIPTOR
END TYPE FLUXES_DESCRIPTOR

INTERFACE

MODULE SUBROUTINE COPY_FLUXES_DESCRIPTOR (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_FLUXES_DESCRIPTOR (SELF)
...
MODULE SUBROUTINE WIPE_FLUXES_DESCRIPTOR (SELF, LDDELETED, LDFIELDAPI)
