...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:INIT')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (LLLAND, YL_LLLAND)
  CALL SGET_HOST_DATA_RDWR (LLSHCV, YL_LLSHCV)
  CALL SGET_HOST_DATA_RDWR (ZACPR, YL_ZACPR)
  CALL SGET_HOST_DATA_RDWR (ZCUCONVCA, YL_ZCUCONVCA)
  CALL SGET_HOST_DATA_RDWR (ZDXTDK, YL_ZDXTDK)
  CALL SGET_HOST_DATA_RDWR (ZFCQLF, YL_ZFCQLF)
  CALL SGET_HOST_DATA_RDWR (ZFCQLI, YL_ZFCQLI)
  CALL SGET_HOST_DATA_RDWR (ZGEOM1, YL_ZGEOM1)
  CALL SGET_HOST_DATA_RDWR (ZGEOMH, YL_ZGEOMH)
  CALL SGET_HOST_DATA_RDWR (ZLCRIT_AER, YL_ZLCRIT_AER)
  CALL SGET_HOST_DATA_RDWR (ZLISUM, YL_ZLISUM)
  CALL SGET_HOST_DATA_RDWR (ZVERVEL, YL_ZVERVEL)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
  &:INIT:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (LLLAND, YL_LLLAND)
  CALL SGET_DEVICE_DATA_RDWR (LLSHCV, YL_LLSHCV)
  CALL SGET_DEVICE_DATA_RDWR (ZACPR, YL_ZACPR)
  CALL SGET_DEVICE_DATA_RDWR (ZCUCONVCA, YL_ZCUCONVCA)
  CALL SGET_DEVICE_DATA_RDWR (ZDXTDK, YL_ZDXTDK)
  CALL SGET_DEVICE_DATA_RDWR (ZFCQLF, YL_ZFCQLF)
  CALL SGET_DEVICE_DATA_RDWR (ZFCQLI, YL_ZFCQLI)
  CALL SGET_DEVICE_DATA_RDWR (ZGEOM1, YL_ZGEOM1)
  CALL SGET_DEVICE_DATA_RDWR (ZGEOMH, YL_ZGEOMH)
  CALL SGET_DEVICE_DATA_RDWR (ZLCRIT_AER, YL_ZLCRIT_AER)
  CALL SGET_DEVICE_DATA_RDWR (ZLISUM, YL_ZLISUM)
  CALL SGET_DEVICE_DATA_RDWR (ZVERVEL, YL_ZVERVEL)
  ...
  !$OMP & MAP(PRESENT:LLLAND, LLSHCV, YDCPG_OPTS, YDGEOMETRY, YFXTRAN_ACDC_STACK, ZACPR,  & 
  !$OMP &          ZCUCONVCA, ZDXTDK, ZFCQLF, ZFCQLI, ZGEOM1, ZGEOMH, ZLCRIT_AER, ZLISUM,  & 
  !$OMP &          ZVERVEL, Z_YDCPG_DYN0_CTY_VVEL, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  & 
  !$OMP &          Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDVARS_GEOMETRY_GM_T0)  & 
  !$OMP & PRIVATE (JBLK)  & 
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:PTENHA, PTENQVA, YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, Z_YDMF_PHYS_BASE_STATE_Q,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_OUT_DIFCQ,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_DIFCS, Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_DIFTS,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FCCQL, Z_YDMF_PHYS_OUT_FCCQN, Z_YDMF_PHYS_OUT_FPEVPCL,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FPEVPCN, Z_YDMF_PHYS_OUT_FPFPCL, Z_YDMF_PHYS_OUT_FPFPCN,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FPLCL, Z_YDMF_PHYS_OUT_FPLCN, Z_YDMF_PHYS_OUT_FRSO,  & 
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:ZERO')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (PRDG_CVGQ, YD_PRDG_CVGQ)
  CALL SGET_HOST_DATA_RDONLY (PRDG_CVGT, YD_PRDG_CVGT)
  CALL SGET_HOST_DATA_RDONLY (PTENHA, YD_PTENHA)
  CALL SGET_HOST_DATA_RDONLY (PTENQVA, YD_PTENQVA)
  CALL SGET_HOST_DATA_RDWR (ZTENDQ, YL_ZTENDQ)
  CALL SGET_HOST_DATA_RDWR (ZTENDT, YL_ZTENDT)
  CALL SGET_HOST_DATA_RDWR (ZTENQ, YL_ZTENQ)
  CALL SGET_HOST_DATA_RDWR (ZTENT, YL_ZTENT)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL:ZERO')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (PRDG_CVGQ, YD_PRDG_CVGQ)
    CALL SGET_HOST_DATA_RDWR (PRDG_CVGT, YD_PRDG_CVGT)
    CALL SGET_HOST_DATA_RDWR (PTENHA, YD_PTENHA)
    CALL SGET_HOST_DATA_RDWR (PTENQVA, YD_PTENQVA)
    CALL SGET_HOST_DATA_RDWR (ZTENDQ, YL_ZTENDQ)
    CALL SGET_HOST_DATA_RDWR (ZTENDT, YL_ZTENDT)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
  &:ZERO:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (PRDG_CVGQ, YD_PRDG_CVGQ)
  CALL SGET_DEVICE_DATA_RDONLY (PRDG_CVGT, YD_PRDG_CVGT)
  CALL SGET_DEVICE_DATA_RDONLY (PTENHA, YD_PTENHA)
  CALL SGET_DEVICE_DATA_RDONLY (PTENQVA, YD_PTENQVA)
  CALL SGET_DEVICE_DATA_RDWR (ZTENDQ, YL_ZTENDQ)
  CALL SGET_DEVICE_DATA_RDWR (ZTENDT, YL_ZTENDT)
  CALL SGET_DEVICE_DATA_RDWR (ZTENQ, YL_ZTENQ)
  CALL SGET_DEVICE_DATA_RDWR (ZTENT, YL_ZTENT)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:PRDG_CVGQ, PRDG_CVGT, PTENHA, PTENQVA, YDCPG_OPTS, YFXTRAN_ACDC_STACK,  & 
  !$OMP &          ZTENDQ, ZTENDT, ZTENQ, ZTENT, ZTENU, ZTENV, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:CUCALLN_MF')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (IBASC, YL_IBASC)
  CALL SGET_HOST_DATA_RDWR (IBOTSC, YL_IBOTSC)
  CALL SGET_HOST_DATA_RDWR (ICBOT, YL_ICBOT)
  CALL SGET_HOST_DATA_RDWR (ICBOT_LIG, YL_ICBOT_LIG)
  CALL SGET_HOST_DATA_RDWR (ICTOP, YL_ICTOP)
  CALL SGET_HOST_DATA_RDWR (ICTOP_LIG, YL_ICTOP_LIG)
  CALL SGET_HOST_DATA_RDWR (ITOPC, YL_ITOPC)
  CALL SGET_HOST_DATA_RDWR (ITYPE, YL_ITYPE)
  CALL SGET_HOST_DATA_RDWR (LLCUM, YL_LLCUM)
  CALL SGET_HOST_DATA_RDWR (LLCUM_LIG, YL_LLCUM_LIG)
  CALL SGET_HOST_DATA_RDONLY (LLLAND, YL_LLLAND)
  CALL SGET_HOST_DATA_RDWR (LLSC, YL_LLSC)
  CALL SGET_HOST_DATA_RDONLY (LLSHCV, YL_LLSHCV)
  CALL SGET_HOST_DATA_RDONLY (PQV, YD_PQV)
  CALL SGET_HOST_DATA_RDWR (ZACPR, YL_ZACPR)
  CALL SGET_HOST_DATA_RDONLY (ZCUCONVCA, YL_ZCUCONVCA)
  CALL SGET_HOST_DATA_RDWR (ZDIFF, YL_ZDIFF)
  CALL SGET_HOST_DATA_RDONLY (ZDXTDK, YL_ZDXTDK)
  CALL SGET_HOST_DATA_RDWR (ZFCQLF, YL_ZFCQLF)
  CALL SGET_HOST_DATA_RDWR (ZFCQLI, YL_ZFCQLI)
  CALL SGET_HOST_DATA_RDWR (ZFHPCL, YL_ZFHPCL)
  CALL SGET_HOST_DATA_RDWR (ZFHPCN, YL_ZFHPCN)
  CALL SGET_HOST_DATA_RDONLY (ZGEOM1, YL_ZGEOM1)
  CALL SGET_HOST_DATA_RDONLY (ZGEOMH, YL_ZGEOMH)
  CALL SGET_HOST_DATA_RDONLY (ZGP2DSPPA, YL_ZGP2DSPPA)
  CALL SGET_HOST_DATA_RDONLY (ZLCRIT_AER, YL_ZLCRIT_AER)
  CALL SGET_HOST_DATA_RDWR (ZLGLAC, YL_ZLGLAC)
  CALL SGET_HOST_DATA_RDONLY (ZLISUM, YL_ZLISUM)
  CALL SGET_HOST_DATA_RDWR (ZLRAIN, YL_ZLRAIN)
  CALL SGET_HOST_DATA_RDWR (ZLU, YL_ZLU)
  CALL SGET_HOST_DATA_RDWR (ZLUDE, YL_ZLUDE)
  CALL SGET_HOST_DATA_RDWR (ZLUDELI, YL_ZLUDELI)
  CALL SGET_HOST_DATA_RDWR (ZMFD, YL_ZMFD)
  CALL SGET_HOST_DATA_RDWR (ZMFDDE_RATE, YL_ZMFDDE_RATE)
  CALL SGET_HOST_DATA_RDWR (ZMFU, YL_ZMFU)
  CALL SGET_HOST_DATA_RDWR (ZMFUDE_RATE, YL_ZMFUDE_RATE)
  CALL SGET_HOST_DATA_RDWR (ZRSUD, YL_ZRSUD)
  CALL SGET_HOST_DATA_RDWR (ZSNDE, YL_ZSNDE)
  CALL SGET_HOST_DATA_RDWR (ZTENDQ, YL_ZTENDQ)
  CALL SGET_HOST_DATA_RDWR (ZTENDT, YL_ZTENDT)
  CALL SGET_HOST_DATA_RDWR (ZTENQ, YL_ZTENQ)
  CALL SGET_HOST_DATA_RDWR (ZTENT, YL_ZTENT)
  CALL SGET_HOST_DATA_RDWR (ZTENU, YL_ZTENU)
  CALL SGET_HOST_DATA_RDWR (ZTENV, YL_ZTENV)
  CALL SGET_HOST_DATA_RDWR (ZVDISCU, YL_ZVDISCU)
  CALL SGET_HOST_DATA_RDONLY (ZVERVEL, YL_ZVERVEL)
  CALL SGET_HOST_DATA_RDWR (ZWMEAN, YL_ZWMEAN)
  CALL SGET_HOST_DATA_RDWR (ZWU, YL_ZWU)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL:CUCALLN_MF')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZGEOM1, YL_ZGEOM1)
    CALL SGET_HOST_DATA_RDWR (ZGEOMH, YL_ZGEOMH)
    CALL SGET_HOST_DATA_RDWR (ZGP2DSPPA, YL_ZGP2DSPPA)
    CALL SGET_HOST_DATA_RDWR (ZLCRIT_AER, YL_ZLCRIT_AER)
    CALL SGET_HOST_DATA_RDWR (ZLGLAC, YL_ZLGLAC)
    CALL SGET_HOST_DATA_RDWR (ZLISUM, YL_ZLISUM)
    CALL SGET_HOST_DATA_RDWR (ZLRAIN, YL_ZLRAIN)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN',&
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
  &:CUCALLN_MF:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (IBASC, YL_IBASC)
  CALL SGET_DEVICE_DATA_RDWR (IBOTSC, YL_IBOTSC)
  CALL SGET_DEVICE_DATA_RDWR (ICBOT, YL_ICBOT)
  CALL SGET_DEVICE_DATA_RDWR (ICBOT_LIG, YL_ICBOT_LIG)
  CALL SGET_DEVICE_DATA_RDWR (ICTOP, YL_ICTOP)
  CALL SGET_DEVICE_DATA_RDWR (ICTOP_LIG, YL_ICTOP_LIG)
  CALL SGET_DEVICE_DATA_RDWR (ITOPC, YL_ITOPC)
  CALL SGET_DEVICE_DATA_RDWR (ITYPE, YL_ITYPE)
  CALL SGET_DEVICE_DATA_RDWR (LLCUM, YL_LLCUM)
  CALL SGET_DEVICE_DATA_RDWR (LLCUM_LIG, YL_LLCUM_LIG)
  CALL SGET_DEVICE_DATA_RDONLY (LLLAND, YL_LLLAND)
  CALL SGET_DEVICE_DATA_RDWR (LLSC, YL_LLSC)
  CALL SGET_DEVICE_DATA_RDONLY (LLSHCV, YL_LLSHCV)
  CALL SGET_DEVICE_DATA_RDONLY (PQV, YD_PQV)
  CALL SGET_DEVICE_DATA_RDWR (ZACPR, YL_ZACPR)
  CALL SGET_DEVICE_DATA_RDONLY (ZCUCONVCA, YL_ZCUCONVCA)
  CALL SGET_DEVICE_DATA_RDWR (ZDIFF, YL_ZDIFF)
  CALL SGET_DEVICE_DATA_RDONLY (ZDXTDK, YL_ZDXTDK)
  CALL SGET_DEVICE_DATA_RDWR (ZFCQLF, YL_ZFCQLF)
  CALL SGET_DEVICE_DATA_RDWR (ZFCQLI, YL_ZFCQLI)
  CALL SGET_DEVICE_DATA_RDWR (ZFHPCL, YL_ZFHPCL)
  CALL SGET_DEVICE_DATA_RDWR (ZFHPCN, YL_ZFHPCN)
  CALL SGET_DEVICE_DATA_RDONLY (ZGEOM1, YL_ZGEOM1)
  CALL SGET_DEVICE_DATA_RDONLY (ZGEOMH, YL_ZGEOMH)
  CALL SGET_DEVICE_DATA_RDONLY (ZGP2DSPPA, YL_ZGP2DSPPA)
  CALL SGET_DEVICE_DATA_RDONLY (ZLCRIT_AER, YL_ZLCRIT_AER)
  CALL SGET_DEVICE_DATA_RDWR (ZLGLAC, YL_ZLGLAC)
  CALL SGET_DEVICE_DATA_RDONLY (ZLISUM, YL_ZLISUM)
  CALL SGET_DEVICE_DATA_RDWR (ZLRAIN, YL_ZLRAIN)
  CALL SGET_DEVICE_DATA_RDWR (ZLU, YL_ZLU)
  CALL SGET_DEVICE_DATA_RDWR (ZLUDE, YL_ZLUDE)
  CALL SGET_DEVICE_DATA_RDWR (ZLUDELI, YL_ZLUDELI)
  CALL SGET_DEVICE_DATA_RDWR (ZMFD, YL_ZMFD)
  CALL SGET_DEVICE_DATA_RDWR (ZMFDDE_RATE, YL_ZMFDDE_RATE)
  CALL SGET_DEVICE_DATA_RDWR (ZMFU, YL_ZMFU)
  CALL SGET_DEVICE_DATA_RDWR (ZMFUDE_RATE, YL_ZMFUDE_RATE)
  CALL SGET_DEVICE_DATA_RDWR (ZRSUD, YL_ZRSUD)
  CALL SGET_DEVICE_DATA_RDWR (ZSNDE, YL_ZSNDE)
  CALL SGET_DEVICE_DATA_RDWR (ZTENDQ, YL_ZTENDQ)
  CALL SGET_DEVICE_DATA_RDWR (ZTENDT, YL_ZTENDT)
  CALL SGET_DEVICE_DATA_RDWR (ZTENQ, YL_ZTENQ)
  CALL SGET_DEVICE_DATA_RDWR (ZTENT, YL_ZTENT)
  CALL SGET_DEVICE_DATA_RDWR (ZTENU, YL_ZTENU)
  CALL SGET_DEVICE_DATA_RDWR (ZTENV, YL_ZTENV)
  CALL SGET_DEVICE_DATA_RDWR (ZVDISCU, YL_ZVDISCU)
  CALL SGET_DEVICE_DATA_RDONLY (ZVERVEL, YL_ZVERVEL)
  CALL SGET_DEVICE_DATA_RDWR (ZWMEAN, YL_ZWMEAN)
  CALL SGET_DEVICE_DATA_RDWR (ZWU, YL_ZWU)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:IBASC, IBOTSC, ICBOT, ICBOT_LIG, ICTOP, ICTOP_LIG, ITOPC, ITYPE, LLCUM,  & 
  !$OMP &          LLCUM_LIG, LLLAND, LLSC, LLSHCV, PQV, YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK,  & 
  !$OMP &          ZACPR, ZCUCONVCA, ZDIFF, ZDXTDK, ZFCQLF, ZFCQLI, ZFHPCL, ZFHPCN, ZGEOM1,  & 
  !$OMP &          ZGEOMH, ZGP2DSPPA, ZLCRIT_AER, ZLGLAC, ZLISUM, ZLRAIN, ZLU, ZLUDE,  & 
  !$OMP &          ZLUDELI, ZMFD, ZMFDDE_RATE, ZMFU, ZMFUDE_RATE, ZRSUD, ZSNDE, ZTENDQ,  & 
  !$OMP &          ZTENDT, ZTENQ, ZTENT, ZTENU, ZTENV, ZVDISCU, ZVERVEL, ZWMEAN, ZWU, Z_YDMF_PHYS_BASE_STATE_T,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_OUT_CAPE,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_DIFCQ, Z_YDMF_PHYS_OUT_DIFCS, Z_YDMF_PHYS_OUT_DIFTQ,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_DIFTS, Z_YDMF_PHYS_OUT_FPLCL, Z_YDMF_PHYS_OUT_FPLCN,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_STRCU, Z_YDMF_PHYS_OUT_STRCV, Z_YDVARS_GEOMETRY_GM_T0)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:COPY')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (ZSNDE, YL_ZSNDE)
  CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_FCCQL, YDMF_PHYS%OUT%F_FCCQL)
  CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_FCCQN, YDMF_PHYS%OUT%F_FCCQN)
  CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_FPEVPCL, YDMF_PHYS%OUT%F_FPEVPCL)
  CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_FPEVPCN, YDMF_PHYS%OUT%F_FPEVPCN)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
  ...
  CALL SGET_DEVICE_DATA_RDONLY (ZSNDE, YL_ZSNDE)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:PFPCOR, YDCPG_OPTS, YFXTRAN_ACDC_STACK, ZSNDE, Z_YDMF_PHYS_OUT_FCCQL,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FCCQN, Z_YDMF_PHYS_OUT_FPEVPCL, Z_YDMF_PHYS_OUT_FPEVPCN,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FPFPCL, Z_YDMF_PHYS_OUT_FPFPCN, Z_YDMF_PHYS_OUT_FPLCL,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FPLCN)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (YDCPG_OPTS%LFLASH) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:CULIGHT')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (ICBOT, YL_ICBOT)
    CALL SGET_HOST_DATA_RDONLY (ICTOP, YL_ICTOP)
    CALL SGET_HOST_DATA_RDONLY (LLCUM, YL_LLCUM)
    CALL SGET_HOST_DATA_RDONLY (LLLAND, YL_LLLAND)
    CALL SGET_HOST_DATA_RDWR (LLLINOX, YL_LLLINOX)
    CALL SGET_HOST_DATA_RDWR (ZCDEPTH, YL_ZCDEPTH)
    CALL SGET_HOST_DATA_RDWR (ZCHARGE, YL_ZCHARGE)
    CALL SGET_HOST_DATA_RDWR (ZCTOPH, YL_ZCTOPH)
    CALL SGET_HOST_DATA_RDWR (ZGAW, YL_ZGAW)
    CALL SGET_HOST_DATA_RDWR (ZICE, YL_ZICE)
    CALL SGET_HOST_DATA_RDWR (ZLIGH_CTG, YL_ZLIGH_CTG)
    CALL SGET_HOST_DATA_RDONLY (ZLU, YL_ZLU)
    CALL SGET_HOST_DATA_RDONLY (ZMFU, YL_ZMFU)
    CALL SGET_HOST_DATA_RDWR (ZPRECMX, YL_ZPRECMX)
    CALL SGET_HOST_DATA_RDWR (ZQPFROZ, YL_ZQPFROZ)
    CALL SGET_HOST_DATA_RDWR (ZWMFU, YL_ZWMFU)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI&
    &, YDMF_PHYS_BASE_STATE%YCPG_DYN%F_PHI)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF&
    ...
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_FPLCL, YDMF_PHYS%OUT%F_FPLCL)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_FPLCN, YDMF_PHYS%OUT%F_FPLCN)
    CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_GEOMETRY_GAW_P, YDVARS%GEOMETRY%GAW%FT0)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL:CULIGHT')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_FPLCL, YDMF_PHYS%OUT%F_FPLCL)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_FPLCN, YDMF_PHYS%OUT%F_FPLCN)
      CALL SGET_HOST_DATA_RDWR (Z_YDVARS_GEOMETRY_GAW_P, YDVARS%GEOMETRY%GAW%FT0)
      IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
    &:CULIGHT:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDONLY (ICBOT, YL_ICBOT)
    CALL SGET_DEVICE_DATA_RDONLY (ICTOP, YL_ICTOP)
    CALL SGET_DEVICE_DATA_RDONLY (LLCUM, YL_LLCUM)
    CALL SGET_DEVICE_DATA_RDONLY (LLLAND, YL_LLLAND)
    CALL SGET_DEVICE_DATA_RDWR (LLLINOX, YL_LLLINOX)
    CALL SGET_DEVICE_DATA_RDWR (ZCDEPTH, YL_ZCDEPTH)
    CALL SGET_DEVICE_DATA_RDWR (ZCHARGE, YL_ZCHARGE)
    CALL SGET_DEVICE_DATA_RDWR (ZCTOPH, YL_ZCTOPH)
    CALL SGET_DEVICE_DATA_RDWR (ZGAW, YL_ZGAW)
    CALL SGET_DEVICE_DATA_RDWR (ZICE, YL_ZICE)
    CALL SGET_DEVICE_DATA_RDWR (ZLIGH_CTG, YL_ZLIGH_CTG)
    CALL SGET_DEVICE_DATA_RDONLY (ZLU, YL_ZLU)
    CALL SGET_DEVICE_DATA_RDONLY (ZMFU, YL_ZMFU)
    CALL SGET_DEVICE_DATA_RDWR (ZPRECMX, YL_ZPRECMX)
    CALL SGET_DEVICE_DATA_RDWR (ZQPFROZ, YL_ZQPFROZ)
    CALL SGET_DEVICE_DATA_RDWR (ZWMFU, YL_ZWMFU)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI&
    &, YDMF_PHYS_BASE_STATE%YCPG_DYN%F_PHI)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF&
    ...
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_FPLCL, YDMF_PHYS%OUT%F_FPLCL)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_FPLCN, YDMF_PHYS%OUT%F_FPLCN)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_GAW_P, YDVARS%GEOMETRY%GAW%FT0)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
    &:CULIGHT:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
    &:CULIGHT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:ICBOT, ICTOP, LLCUM, LLLAND, LLLINOX, YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK,  & 
    !$OMP &          ZCDEPTH, ZCHARGE, ZCTOPH, ZGAW, ZICE, ZLIGH_CTG, ZLU, ZMFU, ZPRECMX,  & 
    !$OMP &          ZQPFROZ, ZWMFU, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_OUT_CAPE,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_FLASH, Z_YDMF_PHYS_OUT_FPLCL, Z_YDMF_PHYS_OUT_FPLCN,  & 
    !$OMP &          Z_YDVARS_GEOMETRY_GAW_P)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
