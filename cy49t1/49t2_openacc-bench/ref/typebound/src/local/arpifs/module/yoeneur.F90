...
PROCEDURE :: COPY => COPY_TENEUR
PROCEDURE :: CRC64 => CRC64_TENEUR
PROCEDURE :: HOST => HOST_TENEUR
PROCEDURE :: LOAD => LOAD_TENEUR
PROCEDURE :: SAVE => SAVE_TENEUR
PROCEDURE :: SIZE => SIZE_TENEUR
PROCEDURE :: WIPE => WIPE_TENEUR
END TYPE TENEUR
!============================================================================
...
MODULE SUBROUTINE COPY_TENEUR (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TENEUR (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TENEUR (SELF)

IMPLICIT NONE
CLASS (TENEUR), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TENEUR (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TENEUR (SELF, KLUN)
...
MODULE FUNCTION SIZE_TENEUR (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TENEUR (SELF, LDDELETED, LDFIELDAPI)
