...
LXPNUDG = ALLOCATED (SELF%XPNUDG)
IF (LXPNUDG) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%XPNUDG)
  !$OMP TARGET UPDATE TO (SELF%XPNUDG)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%XPNUDG)
ENDIF
...
LXPNUDG = ALLOCATED (SELF%XPNUDG)
IF (LXPNUDG) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%XPNUDG)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%XPNUDG)
ENDIF
