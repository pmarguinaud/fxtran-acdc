...
DO JGFL=1, SIZE (YDCPG_SL1%GFL)
  ...
  IF ((YDCPG_SL1%GFL (JGFL)%YCOMP%CSLINT/='LAITVSPCQM  ').AND.YDCPG_SL1%GFL (JGFL)%YCOMP%LADV) THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','LAVABO_EXPL_LAITVSPCQM_PART2_PARALLEL:0')) THEN
      ...
      IF (LSYNCHOST ('LAVABO_EXPL_LAITVSPCQM_PART2_PARALLEL:0')) THEN
        IF (LHOOK) CALL DR_HOOK ('LAVABO_EXPL_LAITVSPCQM_PART2_PARALLEL&
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAVABO_EXPL_LAITVSPCQM_PART2_PARALLEL:0')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAVABO_EXPL_LAITVSPCQM_PART2_PARALLEL:0')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('LAVABO_EXPL_LAITVSPCQM_PART2_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC&PRESENT (YDCPG_OPTS, YSTACK, Z_YDCPG_SL1_GFL_P_F) &
        !$ACC&PRIVATE (JBLK) &
...
ENDSUBROUTINE LAVABO_EXPL_LAITVSPCQM_PART2_PARALLEL
