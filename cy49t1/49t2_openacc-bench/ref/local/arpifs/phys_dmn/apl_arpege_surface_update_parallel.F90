...
IF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SURFACE_UPDATE_PARALLEL:LMSE_F')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_SURFACE_UPDATE_PARALLEL:LMSE_F')) THEN
      IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_UPDATE_PARALLEL&
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_SURFACE_UPDATE_PARALLEL:LMSE_F')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_SURFACE_UPDATE_PARALLEL:LMSE_F')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_UPDATE_PARALLEL:LMSE_F:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&PRESENT (PDSA_C1, PDSA_C2, PFLU_FEVI, PFLU_VEG, YDCPG_OPTS, YDMODEL, YSTACK, &
...
ELSE
  ...
  IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SURFACE_UPDATE_PARALLEL:LMSE_T')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_SURFACE_UPDATE_PARALLEL:LMSE_T')) THEN
      IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_UPDATE_PARALLEL&
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_SURFACE_UPDATE_PARALLEL:LMSE_T')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_SURFACE_UPDATE_PARALLEL:LMSE_T')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_UPDATE_PARALLEL:LMSE_T:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YSTACK, Z_YDCPG_GPAR_VTS, Z_YDMF_PHYS_SURF_GSP_RR_PT_T0, &
...
ENDSUBROUTINE APL_ARPEGE_SURFACE_UPDATE_PARALLEL
