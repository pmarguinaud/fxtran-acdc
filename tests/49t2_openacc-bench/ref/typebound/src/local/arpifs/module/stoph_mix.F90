...
PROCEDURE :: ACDC_COPY => ACDC_COPY_TSTOPH
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TSTOPH
PROCEDURE :: ACDC_HOST => ACDC_HOST_TSTOPH
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TSTOPH
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TSTOPH
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TSTOPH
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TSTOPH
END TYPE TSTOPH
!============================================================================
