...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TPHY3
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TPHY3
PROCEDURE :: ACDC_HOST => ACDC_HOST_TPHY3
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TPHY3
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TPHY3
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TPHY3
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TPHY3
END TYPE TPHY3
...
MODULE SUBROUTINE ACDC_WIPE_TPHY3 (SELF, LDDELETED, LDFIELDAPI)
