...
&, KFDIA, KLON, KGPBLKS, KLEV, LDTDKMF, PTSPHY, PTENH, PQENH, PUEN, PVEN, PTEN, PQEN, PQSEN, PLITOT&
&, PGEO, PGEOH, PAP, PAPH, PVERVEL, PWUBASE, PGP2DSPP, LDLAND, LDCUM, KTYPE, KLAB, LSCVFLAG, PTU&
&, PQU, PLU, PLRAIN, PMFU, PMFUB, PLGLAC, PMFUS, PMFUQ, PMFUL, PLUDE, PLUDELI, PDMFUP, PLCRIT_AER&
&, PDMFEN, KCBOT, KCTOP, KCTOP0, KDPL, PMFUDE_RATE, PKINEU, PWU, PWMEAN)
...
REAL (KIND=JPRB), INTENT (INOUT)::PQENH (:, :, :)
...
REAL (KIND=JPRB), INTENT (INOUT)::PTU (:, :, :)
REAL (KIND=JPRB), INTENT (INOUT)::PQU (:, :, :)
REAL (KIND=JPRB), INTENT (INOUT)::PLU (:, :, :)
REAL (KIND=JPRB), INTENT (INOUT)::PLRAIN (:, :, :)
...
REAL (KIND=JPRB), INTENT (OUT)::PKINEU (:, :, :)
