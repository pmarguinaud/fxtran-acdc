...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TADVPRS
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TADVPRS
PROCEDURE :: ACDC_HOST => ACDC_HOST_TADVPRS
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TADVPRS
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TADVPRS
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TADVPRS
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TADVPRS
END TYPE
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TPHY0
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TPHY0
PROCEDURE :: ACDC_HOST => ACDC_HOST_TPHY0
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TPHY0
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TPHY0
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TPHY0
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TPHY0
END TYPE TPHY0
