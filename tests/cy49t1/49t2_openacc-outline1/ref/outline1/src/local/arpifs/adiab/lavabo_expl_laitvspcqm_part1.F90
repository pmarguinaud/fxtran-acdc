...
#include "lavabo_expl_laitvspcqm_part1_outline_000.intfb.h"
...
DO JGFL=1, SIZE (YDCPG_SL1%GFL)
  ...
  IF ((YDCPG_SL1%GFL (JGFL)%YCOMP%CSLINT/='LAITVSPCQM  ').AND.YDCPG_SL1%GFL (JGFL)%YCOMP%LADV) THEN
    CALL LAVABO_EXPL_LAITVSPCQM_PART1_OUTLINE_000 (JGFL, YDCPG_BNDS, YDCPG_SL1, YDGEOMETRY)
  ENDIF

ENDDO

IF (LHOOK) CALL DR_HOOK ('LAVABO_EXPL_LAITVSPCQM_PART1', 1, ZHOOK_HANDLE)
ENDSUBROUTINE LAVABO_EXPL_LAITVSPCQM_PART1
