...
temp (INTEGER (KIND=JPIM), ILAV, (KPROMA, KFLEV))
temp (INTEGER (KIND=JPIM), IILEV, (KPROMA, KFLEV))
INTEGER (KIND=JPIM)::ILO3 
INTEGER (KIND=JPIM)::ILO2 
INTEGER (KIND=JPIM)::ILO1 
INTEGER (KIND=JPIM)::ILO0 
temp (INTEGER (KIND=JPIM), ILO1IK, (KPROMA, KFLEV))
temp (INTEGER (KIND=JPIM), ILO0IK, (KPROMA, KFLEV))
temp (INTEGER (KIND=JPIM), ILO3IK, (KPROMA, KFLEV))
temp (INTEGER (KIND=JPIM), ILO2IK, (KPROMA, KFLEV))
REAL (KIND=JPRB)::ZDDMAD
REAL (KIND=JPRB)::ZDCMAD
REAL (KIND=JPRB)::ZDBMAD
REAL (KIND=JPRB)::ZDAMAD
temp (REAL (KIND=JPRB), ZKHTURB, (KPROMA, KFLEV, KDIMK))
LOGICAL::LLSLVF
LOGICAL::LL3DTURB
LOGICAL::LLSLHD_OLD
LOGICAL::LLSLHDQUAD
...
temp (REAL (KIND=JPRB), ZCLO, (KPROMA, KFLEV, 3))
temp (REAL (KIND=JPRB), ZCLA, (KPROMA, KFLEV, 3))
