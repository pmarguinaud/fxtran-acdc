...
CALL CPUTQY_APLPAR_EXPL_ZDEC (PDT, ZRRG, YDCPG_OPTS, ZFLAG, YDMF_PHYS_BASE_STATE, YDPHY, YDCPG_BNDS&
&, ZDTT1, PTENDV_ZDEC, PTENDH, PTENDU_ZDEC, ZDEC, PTENDTKE, ZRRGDELP, ZTDCP)
CALL CPUTQY_APLPAR_EXPL_PFDIS (YDCPG_OPTS, YDPHY, YDCPG_BNDS, ZRRGDELP, PFDIS, ZDEC, PTENDTKE)
