...
DO JIJ=IIJB,IIJE 
  ...
  + ZRHODJ_DFDT_O_DZ(JIJ,IKB+IKL) * 0.5*PIMPL * PVARM(JIJ,IKB+IKL)    &
  + ZRHODJ_DFDT_O_DZ(JIJ,IKB+IKL) * 0.5*PIMPL * PVARM(JIJ,IKB)
ENDDO
!
DO JK=1+IKTB,IKTE-1
  DO JIJ=IIJB,IIJE 
    ...
    + ZRHODJ_DFDT_O_DZ(JIJ,JK+IKL) * 0.5*PIMPL * PVARM(JIJ,JK+IKL)  &
    + ZRHODJ_DFDT_O_DZ(JIJ,JK+IKL) * 0.5*PIMPL * PVARM(JIJ,JK)  &
    - ZRHODJ_DFDT_O_DZ(JIJ,JK) * 0.5*PIMPL * PVARM(JIJ,JK)  &
    - ZRHODJ_DFDT_O_DZ(JIJ,JK) * 0.5*PIMPL * PVARM(JIJ,JK-IKL)
  ENDDO
END DO
! 
IF (IKE==IKU) THEN
...
ELSE
  DO JIJ=IIJB,IIJE 
    ...
    - ZRHODJ_DFDT_O_DZ(JIJ,IKE) * 0.5*PIMPL * PVARM(JIJ,IKE) &
    - ZRHODJ_DFDT_O_DZ(JIJ,IKE) * 0.5*PIMPL * PVARM(JIJ,IKE-IKL)
  ENDDO
ENDIF
!
!
...
!
  DO JIJ=IIJB,IIJE 
    ...
    + ZRHODJ_DFDT_O_DZ(JIJ,IKB+IKL) * 0.5*PIMPL
  ...
  DO JK=1+IKTB,IKTE-1
    DO JIJ=IIJB,IIJE 
      ...
      + ZRHODJ_DFDT_O_DZ(JIJ,JK+IKL) * 0.5*PIMPL &
      - ZRHODJ_DFDT_O_DZ(JIJ,JK) * 0.5*PIMPL
  ...
  DO JIJ=IIJB,IIJE 
    ...
    - ZRHODJ_DFDT_O_DZ(JIJ,IKE) * 0.5*PIMPL
  ENDDO
!
!*       3.2 going up
!            --------
