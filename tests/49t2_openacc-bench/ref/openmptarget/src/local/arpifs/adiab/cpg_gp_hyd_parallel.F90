...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_HYD_PARALLEL:0')) THEN
  ...
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDGEOMETRY, YDMODEL, YFXTRAN_ACDC_STACK, Z_RPREF_T0,  & 
  !$OMP &          Z_XYBDER_ALPHL_T0, Z_XYBDER_ALPHM_T0, Z_XYBDER_ALPHPLL_T0,  & 
  !$OMP &          Z_XYBDER_ALPHPLM_T0, Z_XYBDER_COEFAPL_T0, Z_XYBDER_COEFA_T0,  & 
  !$OMP &          Z_XYBDER_COEFD_T0, Z_XYBDER_LNPRL_T0, Z_XYBDER_LNPRM_T0,  & 
  !$OMP &          Z_YDCPG_DYN0_GWFT, Z_YDCPG_DYN0_NHX, Z_YDCPG_DYN0_PRE, Z_YDCPG_DYN0_PREF,  & 
  !$OMP &          Z_YDCPG_DYN0_PREL, Z_YDCPG_DYN0_PREM, Z_YDCPG_DYN0_XYB_ALPH,  & 
  !$OMP &          Z_YDCPG_DYN0_XYB_DELP, Z_YDCPG_DYN0_XYB_LNPR, Z_YDCPG_DYN0_XYB_RDELP,  & 
  !$OMP &          Z_YDCPG_DYN0_XYB_RPP, Z_YDCPG_DYN0_XYB_RPRE, Z_YDCPG_DYN0_XYB_RTGR)  & 
  !$OMP & PRIVATE (JBLK)  & 
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_HYD_PARALLEL:1')) THEN
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDGEOMETRY, YDMODEL, YFXTRAN_ACDC_STACK, Z_DPHYCTY_T0,  & 
  !$OMP &          Z_RDT_T0, Z_RPREF_T0, Z_RT_T0, Z_YDCPG_DYN0_CTY_DIVDP, Z_YDCPG_DYN0_CTY_EVEL,  & 
  !$OMP &          Z_YDCPG_DYN0_CTY_PSDIV, Z_YDCPG_DYN0_CTY_PSDVBC, Z_YDCPG_DYN0_CTY_VVEL,  & 
  !$OMP &          Z_YDCPG_DYN0_PREL, Z_YDCPG_DYN0_PREM, Z_YDCPG_DYN0_RCP_R,  & 
  !$OMP &          Z_YDCPG_DYN0_RTL, Z_YDCPG_DYN0_RTM, Z_YDCPG_DYN0_XYB_ALPH,  & 
  !$OMP &          Z_YDCPG_DYN0_XYB_DELP, Z_YDCPG_DYN0_XYB_LNPR, Z_YDCPG_DYN0_XYB_RDELP,  & 
  !$OMP &          Z_YDCPG_DYN0_XYB_RPP, Z_YDCPG_DYN0_XYB_RPRE, Z_YDCPG_DYN0_XYB_RTGR,  & 
  !$OMP &          Z_YDVARS_DIV_T0, Z_YDVARS_EDOT_T0, Z_YDVARS_PHYCTY_T0, Z_YDVARS_Q_DL,  & 
  !$OMP &          Z_YDVARS_Q_DM, Z_YDVARS_RSPEC_DL, Z_YDVARS_RSPEC_DM, Z_YDVARS_T_DL,  & 
  !$OMP &          Z_YDVARS_T_DM, Z_YDVARS_T_T0, Z_YDVARS_U_T0, Z_YDVARS_V_T0)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_HYD_PARALLEL:2')) THEN
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:P_GWHT_T0, YDCPG_OPTS, YDGEOMETRY, YDMODEL, YFXTRAN_ACDC_STACK,  & 
  !$OMP &          Z_DVER_T0, Z_GPHL_T0, Z_GPHM_T0, Z_NHXT_T0, Z_PSGRTL_T0, Z_PSGRTM_T0,  & 
  !$OMP &          Z_RDT_T0, Z_RT_T0, Z_SGRTL_T0, Z_SGRTM_T0, Z_US_T0, Z_VS_T0, Z_XYBDER_ALPHL_T0,  & 
  !$OMP &          Z_XYBDER_ALPHM_T0, Z_XYBDER_ALPHPLL_T0, Z_XYBDER_ALPHPLM_T0,  & 
  !$OMP &          Z_XYBDER_LNPRL_T0, Z_XYBDER_LNPRM_T0, Z_YDCPG_DYN0_CTY_VVEL,  & 
  !$OMP &          Z_YDCPG_DYN0_GWFT, Z_YDCPG_DYN0_KENE, Z_YDCPG_DYN0_OROGL,  & 
  !$OMP &          Z_YDCPG_DYN0_OROGM, Z_YDCPG_DYN0_PHI, Z_YDCPG_DYN0_PHIF,  & 
  !$OMP &          Z_YDCPG_DYN0_PHIFL, Z_YDCPG_DYN0_PHIFM, Z_YDCPG_DYN0_PREL,  & 
  !$OMP &          Z_YDCPG_DYN0_PREM, Z_YDCPG_DYN0_RCP_KAP, Z_YDCPG_DYN0_RCP_R,  & 
  !$OMP &          Z_YDCPG_DYN0_RTL, Z_YDCPG_DYN0_RTM, Z_YDCPG_DYN0_UVH_UH,  & 
  !$OMP &          Z_YDCPG_DYN0_UVH_VH, Z_YDCPG_DYN0_UVH_WWI, Z_YDCPG_DYN0_XYB_ALPH,  & 
  !$OMP &          Z_YDCPG_DYN0_XYB_LNPR, Z_YDCPG_DYN0_XYB_RTGR, Z_YDCPG_TND_TNDT,  & 
  !$OMP &          Z_YDCPG_TND_TNDU, Z_YDCPG_TND_TNDU_NOC, Z_YDCPG_TND_TNDV,  & 
  !$OMP &          Z_YDCPG_TND_TNDV_NOC, Z_YDVARS_DIV_T0, Z_YDVARS_GEOMETRY_GNORDL_T0,  & 
  !$OMP &          Z_YDVARS_GEOMETRY_GNORDM_T0, Z_YDVARS_GEOMETRY_OROG_T0,  & 
  !$OMP &          Z_YDVARS_GEOMETRY_RCORI_T0, Z_YDVARS_SGRTL_T0, Z_YDVARS_SGRTL_T9,  & 
  !$OMP &          Z_YDVARS_SGRTM_T0, Z_YDVARS_SGRTM_T9, Z_YDVARS_T_T0, Z_YDVARS_U_T0,  & 
  !$OMP &          Z_YDVARS_V_T0)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_HYD_PARALLEL:3')) THEN
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:P_GWHT_T0, YDCPG_OPTS, YFXTRAN_ACDC_STACK)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
