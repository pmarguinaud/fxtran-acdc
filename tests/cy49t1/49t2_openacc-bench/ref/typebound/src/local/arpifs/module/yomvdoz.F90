...
CONTAINS
PROCEDURE :: COPY => COPY_TVDOZ
PROCEDURE :: CRC64 => CRC64_TVDOZ
PROCEDURE :: HOST => HOST_TVDOZ
PROCEDURE :: LOAD => LOAD_TVDOZ
PROCEDURE :: SAVE => SAVE_TVDOZ
PROCEDURE :: SIZE => SIZE_TVDOZ
PROCEDURE :: WIPE => WIPE_TVDOZ
END TYPE TVDOZ
...
MODULE SUBROUTINE COPY_TVDOZ (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TVDOZ (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TVDOZ (SELF)

IMPLICIT NONE
CLASS (TVDOZ), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TVDOZ (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TVDOZ (SELF, KLUN)
...
MODULE FUNCTION SIZE_TVDOZ (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TVDOZ (SELF, LDDELETED, LDFIELDAPI)
