...
IF (IDEV_MALLOC /= 0) THEN
  ...
  ISIZE = INT (KIND (SELF%ZDATA4), KIND=C_SIZE_T) * INT (KPROMA, KIND=C_SIZE_T) * INT (KLEV, KIND=C_SIZE_T) * &
        & INT (ISIZE4, KIND=C_SIZE_T) * INT (KGPBLKS, KIND=C_SIZE_T)

  CALL FXTRAN_ACDC_DEV_MALLOC (ISIZE, IADDR)
  CALL C_F_POINTER (IADDR, SELF%ZDATA4, SHAPE=[KPROMA, KLEV, ISIZE4, KGPBLKS])

  ISIZE = INT (KIND (SELF%ZDATA8), KIND=C_SIZE_T) * INT (KPROMA, KIND=C_SIZE_T) * INT (KLEV, KIND=C_SIZE_T) * &
        & INT (ISIZE8, KIND=C_SIZE_T) * INT (KGPBLKS, KIND=C_SIZE_T)
...
FXTRAN_ACDC_ENTER_DATA_CREATE (SELF%ZDATA4)
FXTRAN_ACDC_ENTER_DATA_CREATE (SELF%ZDATA8)

FXTRAN_ACDC_ENTER_DATA_CREATE (SELF)
FXTRAN_ACDC_UPDATE_DEVICE (SELF)
FXTRAN_ACDC_ENTER_DATA_ATTACH (SELF%ZDATA4)
FXTRAN_ACDC_ENTER_DATA_ATTACH (SELF%ZDATA8)
...
FXTRAN_ACDC_EXIT_DATA_DETACH (SELF%ZDATA8)
FXTRAN_ACDC_EXIT_DATA_DETACH (SELF%ZDATA4)

FXTRAN_ACDC_EXIT_DATA_DELETE (SELF)

FXTRAN_ACDC_EXIT_DATA_DELETE (SELF%ZDATA8)
FXTRAN_ACDC_EXIT_DATA_DELETE (SELF%ZDATA4)
