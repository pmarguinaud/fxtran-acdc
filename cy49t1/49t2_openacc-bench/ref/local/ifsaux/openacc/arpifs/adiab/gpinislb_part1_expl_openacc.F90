...
IF (YDDYNA%LSLAG) THEN
  ...
  IF (YDDYNA%LNHDYN) THEN
    ...
    IF (YDDYNA%LNHX)  THEN
        PGMVNHX1 (JLON, 1:YDGEOMETRY%YRDIMV%NFLEVG)=0.0_JPRB
    ENDIF
...
ELSE
  ...
  IF (YDDYN%NCURRENT_ITER==0) THEN
    ...
    IF (YDDYNA%LNHDYN) THEN
      ...
      IF (YDDYNA%LNHX)  THEN
          PGMVNHX1 (JLON, 1:YDGEOMETRY%YRDIMV%NFLEVG)=PNHX9 (JLON, 1:YDGEOMETRY%YRDIMV%NFLEVG)*PTE
      ENDIF
...
ENDSUBROUTINE GPINISLB_PART1_EXPL_OPENACC
