...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_MF_PHYS_STATE_GSP_SG_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_MF_PHYS_STATE_GSP_SG_TYPE
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_MF_PHYS_STATE_GSP_RR_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_MF_PHYS_STATE_GSP_RR_TYPE
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_MF_PHYS_STATE_GSP_SB_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_MF_PHYS_STATE_GSP_SB_TYPE
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_MF_PHYS_BASE_STATE_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_MF_PHYS_BASE_STATE_TYPE
...
REAL(KIND=JPRB), POINTER :: ZP1AERO0(:,:,:), ZP1AERO9(:,:,:)
...
IF (PRESENT (PGFL)) THEN
  ...
  CALL SC2PRG (1, YDMODEL%YRML_GCONF%YGFL%YAERO(:)%MP , YDMODEL%YRML_GCONF%YGFL%NAERO,    PGFL, ZP1AERO0)    !  YDVARS%AERO(1)%T0
  CALL SC2PRG (1, YDMODEL%YRML_GCONF%YGFL%YAERO(:)%MP9, YDMODEL%YRML_GCONF%YGFL%NAERO,    PGFL, ZP1AERO9)    !  YDVARS%AERO(1)%T9
...
IF (YDMODEL%YRML_DYN%YRDYNA%LTWOTL) THEN
  ...
  SELF%IMF => YDVARS%IMF%T0
  SELF%F_IMF => YDVARS%IMF%FT0
  SELF%LMF => YDVARS%LMF%T0
  SELF%F_LMF => YDVARS%LMF%FT0
  SELF%AMF => YDVARS%AMF%T0
  SELF%F_AMF => YDVARS%AMF%FT0
...
ELSE
  ...
  SELF%IMF => YDVARS%IMF%T9
  SELF%F_IMF => YDVARS%IMF%FT9
  SELF%LMF => YDVARS%LMF%T9
  SELF%F_LMF => YDVARS%LMF%FT9
  SELF%AMF => YDVARS%AMF%T9
  SELF%F_AMF => YDVARS%AMF%FT9
...
ENDIF
IF (ASSOCIATED (SELF%F_IMF)) THEN
  SELF%IMF => SELF%F_IMF%GET_VIEW (BLOCK_INDEX)
ENDIF
IF (ASSOCIATED (SELF%F_LMF)) THEN
  SELF%LMF => SELF%F_LMF%GET_VIEW (BLOCK_INDEX)
ENDIF
IF (ASSOCIATED (SELF%F_AMF)) THEN
  SELF%AMF => SELF%F_AMF%GET_VIEW (BLOCK_INDEX)
ENDIF
