...
IF (KFLAG==1) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','GPMPFC_EXPL_PARALLEL:0')) THEN
    ...
    IF (LSYNCHOST ('GPMPFC_EXPL_PARALLEL:0')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPMPFC_EXPL_PARALLEL:0')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPMPFC_EXPL_PARALLEL:0')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('GPMPFC_EXPL_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&PRESENT (PGM, YDCPG_OPTS, YSTACK, ZGM) &
      !$ACC&PRIVATE (JBLK) &
...
IF (LPARALLELMETHOD ('OPENMP','GPMPFC_EXPL_PARALLEL:1')) THEN
  ...
  IF (LSYNCHOST ('GPMPFC_EXPL_PARALLEL:1')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPMPFC_EXPL_PARALLEL:1')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPMPFC_EXPL_PARALLEL:1')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('GPMPFC_EXPL_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDDYN, YDDYNA, YDML_GCONF, YSTACK, ZGM, Z_YDVARS_DIV_T0, &
    !$ACC&         Z_YDVARS_DIV_T9, Z_YDVARS_NHX_DL, Z_YDVARS_NHX_DM, Z_YDVARS_SPD_DL, &
    !$ACC&         Z_YDVARS_SPD_DL9, Z_YDVARS_SPD_DM, Z_YDVARS_SPD_DM9, Z_YDVARS_SP_DL, &
    !$ACC&         Z_YDVARS_SP_DL9, Z_YDVARS_SP_DM, Z_YDVARS_SP_DM9, Z_YDVARS_SVD_DL, &
    !$ACC&         Z_YDVARS_SVD_DL9, Z_YDVARS_SVD_DM, Z_YDVARS_SVD_DM9, Z_YDVARS_T_DL, &
    !$ACC&         Z_YDVARS_T_DL9, Z_YDVARS_T_DM, Z_YDVARS_T_DM9, Z_YDVARS_U_DL, &
    !$ACC&         Z_YDVARS_U_T0, Z_YDVARS_U_T9, Z_YDVARS_VOR_T0, Z_YDVARS_V_DL, &
