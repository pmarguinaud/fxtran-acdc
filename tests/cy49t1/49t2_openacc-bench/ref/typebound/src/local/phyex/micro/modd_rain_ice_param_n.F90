...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_RAIN_ICE_PARAM_T
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_RAIN_ICE_PARAM_T
PROCEDURE :: ACDC_HOST => ACDC_HOST_RAIN_ICE_PARAM_T
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_RAIN_ICE_PARAM_T
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_RAIN_ICE_PARAM_T
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_RAIN_ICE_PARAM_T
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_RAIN_ICE_PARAM_T
