...
CALL APL_ARPEGE_INIT_OUTLINE_000 (YDVARS, YDCPG_OPTS, YDMODEL, YDCPG_BNDS, PAIPCMT, PDECRD)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART1', 1, ZHOOK_HANDLE_1)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART2', 0, ZHOOK_HANDLE_1)
CALL APL_ARPEGE_INIT_OUTLINE_001 (YDVARS, YDCPG_MISC, YDCPG_OPTS, YDMF_PHYS_SURF&
&, YDMF_PHYS_BASE_STATE, YDMODEL, YDCPG_BNDS, PQO3)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART2', 1, ZHOOK_HANDLE_1)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART3', 0, ZHOOK_HANDLE_1)
CALL APL_ARPEGE_INIT_OUTLINE_002 (YDCPG_OPTS, YDMF_PHYS_BASE_STATE&
&, YDMODEL, YDCST, YDCPG_BNDS, PPOID, ZIPOI, PPRODTH_CVPP)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART3', 1, ZHOOK_HANDLE_1)
PEPS0=1.E-12_JPRB
PEPSNEB=1.E-10_JPRB
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART4', 0, ZHOOK_HANDLE_1)
CALL APL_ARPEGE_INIT_OUTLINE_003 (PEPS0, YDCPG_OPTS, PTENHA, PCOEFA, PSC_FEVI, PCONDCVPPL, PEDMFS&
&, PQLI_CVPP, PKQLROV, PCFBV, PTENT, PSC_FEVN, PKQROV, PUNEBH, PNEBS, PLVT, PCFAU, PQICE, PXTROV&
&, PNEBDIFF, PDIFCVPPS, PCFBTH, PXUROV, PDIFCVPPV, PNEBCH, PSEDIQL, PEDMFQ, PALPHA1, KNLAB_CVPP&
...
CALL APL_ARPEGE_INIT_OUTLINE_004 (YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_BASE_STATE&
&, YDCPG_BNDS, PQS, PPOID, PQR, PQV, ZIPOI, PQI, PQL)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART5', 1, ZHOOK_HANDLE_1)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART6', 0, ZHOOK_HANDLE_1)
CALL APL_ARPEGE_INIT_OUTLINE_005 (YDCPG_OPTS, YDMODEL, YDCPG_BNDS, PTRSODIR, PTRSODIF, PAERINDS, PXDROV&
&, PALBP, KMOC_CLPH, PSFSWDIF, PTRSOD, PCTRSO, PAER, PSFSWDIR, PSUDU, PXHROV, PCEMTR, PALBD)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART6', 1, ZHOOK_HANDLE_1)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART7', 0, ZHOOK_HANDLE_1)
CALL APL_ARPEGE_INIT_OUTLINE_006 (YDCPG_OPTS, YDMODEL, YDCPG_BNDS, PPFL_FPLSH, PPFL_FPLCH)
