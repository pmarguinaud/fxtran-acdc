...
PROCEDURE :: COPY => COPY_TESWRT
PROCEDURE :: CRC64 => CRC64_TESWRT
PROCEDURE :: HOST => HOST_TESWRT
PROCEDURE :: LOAD => LOAD_TESWRT
PROCEDURE :: SAVE => SAVE_TESWRT
PROCEDURE :: SIZE => SIZE_TESWRT
PROCEDURE :: WIPE => WIPE_TESWRT
END TYPE TESWRT

INTERFACE

MODULE SUBROUTINE COPY_TESWRT (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TESWRT (SELF)
...
MODULE SUBROUTINE WIPE_TESWRT (SELF, LDDELETED, LDFIELDAPI)
