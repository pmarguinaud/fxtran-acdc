...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CUBASEN_PARALLEL:0')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (KDPL, YD_KDPL)
  CALL SGET_HOST_DATA_RDWR (LLFIRST, YL_LLFIRST)
  CALL SGET_HOST_DATA_RDWR (LLGO_ON, YL_LLGO_ON)
  CALL SGET_HOST_DATA_RDWR (PWUBASE, YD_PWUBASE)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUBASEN_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUBASEN_PARALLEL:0:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (KDPL, YD_KDPL)
  CALL SGET_DEVICE_DATA_RDWR (LLFIRST, YL_LLFIRST)
  CALL SGET_DEVICE_DATA_RDWR (LLGO_ON, YL_LLGO_ON)
  CALL SGET_DEVICE_DATA_RDWR (PWUBASE, YD_PWUBASE)
  IF (LHOOK) CALL DR_HOOK ('CUBASEN_PARALLEL:0:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CUBASEN_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUBASEN_PARALLEL:1')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDONLY (KLAB, YD_KLAB)
  ...
  CALL SGET_DEVICE_DATA_RDONLY (PQENH, YD_PQENH)
  CALL SGET_DEVICE_DATA_RDONLY (PQU, YD_PQU)
  CALL SGET_DEVICE_DATA_RDONLY (PTEN, YD_PTEN)
  CALL SGET_DEVICE_DATA_RDONLY (PTENH, YD_PTENH)
  CALL SGET_DEVICE_DATA_RDONLY (PTU, YD_PTU)
  CALL SGET_DEVICE_DATA_RDWR (PWU2H, YD_PWU2H)
  CALL SGET_DEVICE_DATA_RDWR (ZCAPE, YL_ZCAPE)
  CALL SGET_DEVICE_DATA_RDWR (ZLU, YL_ZLU)
  CALL SGET_DEVICE_DATA_RDWR (ZQENH, YL_ZQENH)
  CALL SGET_DEVICE_DATA_RDWR (ZQU, YL_ZQU)
  CALL SGET_DEVICE_DATA_RDWR (ZS, YL_ZS)
  CALL SGET_DEVICE_DATA_RDWR (ZSENH, YL_ZSENH)
  CALL SGET_DEVICE_DATA_RDWR (ZTU, YL_ZTU)
  CALL SGET_DEVICE_DATA_RDWR (ZWU2H, YL_ZWU2H)
  IF (LHOOK) CALL DR_HOOK ('CUBASEN_PARALLEL:1:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CUBASEN_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CUBASEN_PARALLEL:2')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (IDPL, YL_IDPL)
  CALL SGET_HOST_DATA_RDWR (ILAB, YL_ILAB)
  CALL SGET_HOST_DATA_RDWR (KBOTSC, YD_KBOTSC)
  ...
  CALL SGET_HOST_DATA_RDWR (LDSC, YD_LDSC)
  CALL SGET_HOST_DATA_RDWR (LLDCUM, YL_LLDCUM)
  CALL SGET_HOST_DATA_RDWR (LLDEEP, YL_LLDEEP)
  CALL SGET_HOST_DATA_RDWR (LLDSC, YL_LLDSC)
  CALL SGET_HOST_DATA_RDWR (LLFIRST, YL_LLFIRST)
  CALL SGET_HOST_DATA_RDWR (LLFLAG, YL_LLFLAG)
  CALL SGET_HOST_DATA_RDWR (LLGO_ON, YL_LLGO_ON)
  CALL SGET_HOST_DATA_RDWR (LLRESETJL, YL_LLRESETJL)
  CALL SGET_HOST_DATA_RDWR (LL_LDBASE, YL_LL_LDBASE)
  CALL SGET_HOST_DATA_RDONLY (PAHFS, YD_PAHFS)
  CALL SGET_HOST_DATA_RDONLY (PAPH, YD_PAPH)
  CALL SGET_HOST_DATA_RDONLY (PGEO, YD_PGEO)
  CALL SGET_HOST_DATA_RDONLY (PGEOH, YD_PGEOH)
  CALL SGET_HOST_DATA_RDONLY (PKMFL, YD_PKMFL)
  ...
  CALL SGET_HOST_DATA_RDWR (PWU2H, YD_PWU2H)
  CALL SGET_HOST_DATA_RDWR (PWUBASE, YD_PWUBASE)
  CALL SGET_HOST_DATA_RDWR (ZBUOH, YL_ZBUOH)
  CALL SGET_HOST_DATA_RDWR (ZCAPE, YL_ZCAPE)
  CALL SGET_HOST_DATA_RDWR (ZCBASE, YL_ZCBASE)
  CALL SGET_HOST_DATA_RDWR (ZDZ, YL_ZDZ)
  CALL SGET_HOST_DATA_RDWR (ZLU, YL_ZLU)
  CALL SGET_HOST_DATA_RDWR (ZMIX, YL_ZMIX)
  CALL SGET_HOST_DATA_RDWR (ZPH, YL_ZPH)
  CALL SGET_HOST_DATA_RDONLY (ZQENH, YL_ZQENH)
  CALL SGET_HOST_DATA_RDWR (ZQEX, YL_ZQEX)
  CALL SGET_HOST_DATA_RDWR (ZQOLD, YL_ZQOLD)
  CALL SGET_HOST_DATA_RDWR (ZQU, YL_ZQU)
  CALL SGET_HOST_DATA_RDONLY (ZSENH, YL_ZSENH)
  CALL SGET_HOST_DATA_RDWR (ZSUH, YL_ZSUH)
  CALL SGET_HOST_DATA_RDWR (ZTEX, YL_ZTEX)
  CALL SGET_HOST_DATA_RDWR (ZTU, YL_ZTU)
  CALL SGET_HOST_DATA_RDWR (ZWU2H, YL_ZWU2H)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUBASEN_PARALLEL:2')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDWR (IDPL, YL_IDPL)
  CALL SGET_DEVICE_DATA_RDWR (ILAB, YL_ILAB)
  CALL SGET_DEVICE_DATA_RDWR (KBOTSC, YD_KBOTSC)
  ...
  CALL SGET_DEVICE_DATA_RDWR (LDSC, YD_LDSC)
  CALL SGET_DEVICE_DATA_RDWR (LLDCUM, YL_LLDCUM)
  CALL SGET_DEVICE_DATA_RDWR (LLDEEP, YL_LLDEEP)
  CALL SGET_DEVICE_DATA_RDWR (LLDSC, YL_LLDSC)
  CALL SGET_DEVICE_DATA_RDWR (LLFIRST, YL_LLFIRST)
  CALL SGET_DEVICE_DATA_RDWR (LLFLAG, YL_LLFLAG)
  CALL SGET_DEVICE_DATA_RDWR (LLGO_ON, YL_LLGO_ON)
  CALL SGET_DEVICE_DATA_RDWR (LLRESETJL, YL_LLRESETJL)
  CALL SGET_DEVICE_DATA_RDWR (LL_LDBASE, YL_LL_LDBASE)
  CALL SGET_DEVICE_DATA_RDONLY (PAHFS, YD_PAHFS)
  CALL SGET_DEVICE_DATA_RDONLY (PAPH, YD_PAPH)
  CALL SGET_DEVICE_DATA_RDONLY (PGEO, YD_PGEO)
  CALL SGET_DEVICE_DATA_RDONLY (PGEOH, YD_PGEOH)
  CALL SGET_DEVICE_DATA_RDONLY (PKMFL, YD_PKMFL)
  ...
  CALL SGET_DEVICE_DATA_RDWR (PWU2H, YD_PWU2H)
  CALL SGET_DEVICE_DATA_RDWR (PWUBASE, YD_PWUBASE)
  CALL SGET_DEVICE_DATA_RDWR (ZBUOH, YL_ZBUOH)
  CALL SGET_DEVICE_DATA_RDWR (ZCAPE, YL_ZCAPE)
  CALL SGET_DEVICE_DATA_RDWR (ZCBASE, YL_ZCBASE)
  CALL SGET_DEVICE_DATA_RDWR (ZDZ, YL_ZDZ)
  CALL SGET_DEVICE_DATA_RDWR (ZLU, YL_ZLU)
  CALL SGET_DEVICE_DATA_RDWR (ZMIX, YL_ZMIX)
  CALL SGET_DEVICE_DATA_RDWR (ZPH, YL_ZPH)
  CALL SGET_DEVICE_DATA_RDONLY (ZQENH, YL_ZQENH)
  CALL SGET_DEVICE_DATA_RDWR (ZQEX, YL_ZQEX)
  CALL SGET_DEVICE_DATA_RDWR (ZQOLD, YL_ZQOLD)
  CALL SGET_DEVICE_DATA_RDWR (ZQU, YL_ZQU)
  CALL SGET_DEVICE_DATA_RDONLY (ZSENH, YL_ZSENH)
  CALL SGET_DEVICE_DATA_RDWR (ZSUH, YL_ZSUH)
  CALL SGET_DEVICE_DATA_RDWR (ZTEX, YL_ZTEX)
  CALL SGET_DEVICE_DATA_RDWR (ZTU, YL_ZTU)
  CALL SGET_DEVICE_DATA_RDWR (ZWU2H, YL_ZWU2H)
  IF (LHOOK) CALL DR_HOOK ('CUBASEN_PARALLEL:2:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CUBASEN_PARALLEL:2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CUBASEN_PARALLEL:3')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (ZCAPE, YL_ZCAPE)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUBASEN_PARALLEL:3')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDONLY (ZCAPE, YL_ZCAPE)
  IF (LHOOK) CALL DR_HOOK ('CUBASEN_PARALLEL:3:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CUBASEN_PARALLEL:3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
