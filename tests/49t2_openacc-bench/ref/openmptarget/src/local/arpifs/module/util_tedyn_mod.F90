...
LRDIVORE = ALLOCATED (SELF%RDIVORE)
IF (LRDIVORE) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%RDIVORE)
  !$OMP TARGET UPDATE TO (SELF%RDIVORE)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%RDIVORE)
ENDIF

LRDIDIVE = ALLOCATED (SELF%RDIDIVE)
IF (LRDIDIVE) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%RDIDIVE)
  !$OMP TARGET UPDATE TO (SELF%RDIDIVE)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%RDIDIVE)
ENDIF

LRDITE = ALLOCATED (SELF%RDITE)
IF (LRDITE) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%RDITE)
  !$OMP TARGET UPDATE TO (SELF%RDITE)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%RDITE)
ENDIF

LRDIGFLE = ALLOCATED (SELF%RDIGFLE)
IF (LRDIGFLE) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%RDIGFLE)
  !$OMP TARGET UPDATE TO (SELF%RDIGFLE)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%RDIGFLE)
ENDIF

LRDIPDE = ALLOCATED (SELF%RDIPDE)
IF (LRDIPDE) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%RDIPDE)
  !$OMP TARGET UPDATE TO (SELF%RDIPDE)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%RDIPDE)
ENDIF

LRDIVDE = ALLOCATED (SELF%RDIVDE)
IF (LRDIVDE) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%RDIVDE)
  !$OMP TARGET UPDATE TO (SELF%RDIVDE)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%RDIVDE)
ENDIF

LRDISPE = ALLOCATED (SELF%RDISPE)
IF (LRDISPE) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%RDISPE)
  !$OMP TARGET UPDATE TO (SELF%RDISPE)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%RDISPE)
ENDIF

LRDSVORE = ALLOCATED (SELF%RDSVORE)
IF (LRDSVORE) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%RDSVORE)
  !$OMP TARGET UPDATE TO (SELF%RDSVORE)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%RDSVORE)
ENDIF

LRDSDIVE = ALLOCATED (SELF%RDSDIVE)
IF (LRDSDIVE) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%RDSDIVE)
  !$OMP TARGET UPDATE TO (SELF%RDSDIVE)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%RDSDIVE)
ENDIF

LRDSVDE = ALLOCATED (SELF%RDSVDE)
IF (LRDSVDE) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%RDSVDE)
  !$OMP TARGET UPDATE TO (SELF%RDSVDE)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%RDSVDE)
ENDIF

LREFILV = ALLOCATED (SELF%REFILV)
IF (LREFILV) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%REFILV)
  !$OMP TARGET UPDATE TO (SELF%REFILV)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%REFILV)
ENDIF

LREFILD = ALLOCATED (SELF%REFILD)
IF (LREFILD) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%REFILD)
  !$OMP TARGET UPDATE TO (SELF%REFILD)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%REFILD)
ENDIF
...
LRDIVORE = ALLOCATED (SELF%RDIVORE)
IF (LRDIVORE) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%RDIVORE)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%RDIVORE)
ENDIF

LRDIDIVE = ALLOCATED (SELF%RDIDIVE)
IF (LRDIDIVE) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%RDIDIVE)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%RDIDIVE)
ENDIF

LRDITE = ALLOCATED (SELF%RDITE)
IF (LRDITE) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%RDITE)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%RDITE)
ENDIF

LRDIGFLE = ALLOCATED (SELF%RDIGFLE)
IF (LRDIGFLE) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%RDIGFLE)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%RDIGFLE)
ENDIF

LRDIPDE = ALLOCATED (SELF%RDIPDE)
IF (LRDIPDE) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%RDIPDE)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%RDIPDE)
ENDIF

LRDIVDE = ALLOCATED (SELF%RDIVDE)
IF (LRDIVDE) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%RDIVDE)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%RDIVDE)
ENDIF

LRDISPE = ALLOCATED (SELF%RDISPE)
IF (LRDISPE) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%RDISPE)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%RDISPE)
ENDIF

LRDSVORE = ALLOCATED (SELF%RDSVORE)
IF (LRDSVORE) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%RDSVORE)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%RDSVORE)
ENDIF

LRDSDIVE = ALLOCATED (SELF%RDSDIVE)
IF (LRDSDIVE) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%RDSDIVE)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%RDSDIVE)
ENDIF

LRDSVDE = ALLOCATED (SELF%RDSVDE)
IF (LRDSVDE) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%RDSVDE)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%RDSVDE)
ENDIF

LREFILV = ALLOCATED (SELF%REFILV)
IF (LREFILV) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%REFILV)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%REFILV)
ENDIF

LREFILD = ALLOCATED (SELF%REFILD)
IF (LREFILD) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%REFILD)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%REFILD)
ENDIF
