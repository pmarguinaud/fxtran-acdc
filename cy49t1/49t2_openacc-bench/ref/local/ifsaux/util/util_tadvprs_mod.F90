...
SUBROUTINE SAVE_TADVPRS (SELF, KLUN)
...
SUBROUTINE LOAD_TADVPRS (SELF, KLUN)
...
SUBROUTINE COPY_TADVPRS (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE CRC64_TADVPRS (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TADVPRS (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TADVPRS (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
