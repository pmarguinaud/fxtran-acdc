...
IF ((.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE)) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_OCEANIC_FLUXES_PARALLEL:ACFLUSO')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_OCEANIC_FLUXES_PARALLEL:ACFLUSO')) THEN
    ...
    &:ACFLUSO:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&         PFLU_CH, PFLU_QSATS, YDCPG_OPTS, YDMODEL, YSTACK, ZCE, ZCRTI, Z_YDMF_PHYS_BASE_STATE_Q, &
      ...
      !$ACC&         Z_YDMF_PHYS_OUT_VGST, Z_YDMF_PHYS_SURF_GSD_VF_PLSM) &
      !$ACC&PRIVATE (JBLK) &
...
ELSE
  ...
  IF (LPARALLELMETHOD ('OpenMP','APL_ARPEGE_OCEANIC_FLUXES_PARALLEL:1')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_OCEANIC_FLUXES_PARALLEL:1')) THEN
