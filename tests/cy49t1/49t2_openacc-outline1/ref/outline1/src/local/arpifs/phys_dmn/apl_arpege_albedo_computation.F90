...
IF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  CALL APL_ARPEGE_ALBEDO_COMPUTATION_OUTLINE_000 (PEPS0, YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_BASE_STATE&
  &, YDMF_PHYS_SURF, YDMODEL, YDCPG_BNDS, PALBDIR, PALBP, PFLU_NEIJ, PRDG_MU0, PFLU_EMIS, PALBD)
ENDIF
