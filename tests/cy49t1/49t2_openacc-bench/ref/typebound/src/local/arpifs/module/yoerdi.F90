...
PROCEDURE :: COPY => COPY_TERDI
PROCEDURE :: CRC64 => CRC64_TERDI
PROCEDURE :: HOST => HOST_TERDI
PROCEDURE :: LOAD => LOAD_TERDI
PROCEDURE :: SAVE => SAVE_TERDI
PROCEDURE :: SIZE => SIZE_TERDI
PROCEDURE :: WIPE => WIPE_TERDI
END TYPE TERDI
!============================================================================
...
MODULE SUBROUTINE COPY_TERDI (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TERDI (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TERDI (SELF)

IMPLICIT NONE
CLASS (TERDI), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TERDI (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TERDI (SELF, KLUN)
...
MODULE FUNCTION SIZE_TERDI (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TERDI (SELF, LDDELETED, LDFIELDAPI)
