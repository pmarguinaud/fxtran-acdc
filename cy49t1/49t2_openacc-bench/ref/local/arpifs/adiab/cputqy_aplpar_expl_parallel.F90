...
IF (LPARALLELMETHOD ('OPENMP','CPUTQY_APLPAR_EXPL_PARALLEL:ZTDCP')) THEN
  ...
  IF (LSYNCHOST ('CPUTQY_APLPAR_EXPL_PARALLEL:ZTDCP')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPUTQY_APLPAR_EXPL_PARALLEL:ZTDCP')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPUTQY_APLPAR_EXPL_PARALLEL:ZTDCP')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPUTQY_APLPAR_EXPL_PARALLEL:ZTDCP:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&PRESENT (YDCPG_OPTS, YSTACK, ZTDCP) &
    !$ACC&PRIVATE (JBLK) &
...
IF (LPARALLELMETHOD ('OPENMP','CPUTQY_APLPAR_EXPL_PARALLEL:ZDEC')) THEN
  ...
  IF (LSYNCHOST ('CPUTQY_APLPAR_EXPL_PARALLEL:ZDEC')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPUTQY_APLPAR_EXPL_PARALLEL:ZDEC')) THEN
  ...
  !$OMP PARALLEL DO PRIVATE (JBLK, JLEV, JLON, YLCPG_BNDS, YLSTACK, ZCPF, ZH)
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPUTQY_APLPAR_EXPL_PARALLEL:ZDEC')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPUTQY_APLPAR_EXPL_PARALLEL:ZDEC:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         YSTACK, ZDEC, ZDTT1, ZRRGDELP, ZTDCP, Z_YDMF_PHYS_BASE_STATE_T, &
    ...
    !$ACC LOOP VECTOR &
    !$ACC&PRIVATE (JLEV, JLON, YLCPG_BNDS, YLSTACK, ZCPF, ZH) 
...
IF (LPARALLELMETHOD ('OPENMP','CPUTQY_APLPAR_EXPL_PARALLEL:PFDIS')) THEN
  ...
  IF (LSYNCHOST ('CPUTQY_APLPAR_EXPL_PARALLEL:PFDIS')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPUTQY_APLPAR_EXPL_PARALLEL:PFDIS')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPUTQY_APLPAR_EXPL_PARALLEL:PFDIS')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPUTQY_APLPAR_EXPL_PARALLEL:PFDIS:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (PFDIS, PTENDTKE, YDCPG_OPTS, YDPHY, YSTACK, ZDEC, ZRRGDELP) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ENDSUBROUTINE CPUTQY_APLPAR_EXPL_PARALLEL
