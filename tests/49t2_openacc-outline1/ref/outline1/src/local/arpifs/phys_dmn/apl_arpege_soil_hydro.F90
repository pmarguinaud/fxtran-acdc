SUBROUTINE APL_ARPEGE_SOIL_HYDRO (YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS&
&, YDMF_PHYS, YDMF_PHYS_SURF, YDMODEL, PCHROV, PFLU_NEIJ, PFLU_QSAT, PFLU_QSATS&
&, PFLU_VEG, PGWDCS, PHQ, PHTR, PHU, PQV, PWFC, PWLMX, PWWILT)
...
#include "apl_arpege_soil_hydro_acveg.intfb.h"
...
IF (YDMODEL%YRML_PHY_MF%YRPHY%LSOLV.AND.(.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE)) THEN
  CALL APL_ARPEGE_SOIL_HYDRO_ACVEG (YDCPG_BNDS, YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_BASE_STATE&
...
ENDSUBROUTINE APL_ARPEGE_SOIL_HYDRO
