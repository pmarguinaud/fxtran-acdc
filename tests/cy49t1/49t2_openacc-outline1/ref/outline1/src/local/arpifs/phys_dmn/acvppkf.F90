...
CALL ACVPPKF_PART0 (LLOCHTRANS, YDCST, YDCPG_OPTS, I_KCH1, YDCPG_BNDS, YDML_PHY_MF, ZDPSG&
&, ICLBAS, ZZUMF, ZUQV, ZURV, ZUMFMAX, ZVTEN, ZDTDT, ZTKECLS, ZDQIDT, PV, ZRC, PU, ZZZ&
&, ICLTOPS, I_KCLTOP, PT, PQ, ZDQVDT, ZTTEN, ZLS, ZZW, ZRV, PAPRSF, PAPHIF, ZUTEN, ZRCTEN&
&, ZRVTEN, ZSHAL_ZCH1TEN, ZQC, ZDQLDT, ZUMF, ZSHAL_ZCH1, ZT, ICLTOP, ZRI, ZRITEN, ICLBASS&
&, PTKE, ZUQL, I_KCLBAS, ZPABS, ZDVDT, PQI, ZURCI, ZDUDT, PQL, PDELP, ZLV)
CALL ACVPPKF_PART1 (LLOCHTRANS, I_KBDIA, YDCPG_OPTS, KTDIA, I_KCH1, D, IKICE, YDCST,&
& YDML_PHY_MF, ZSWLCL, ZSTHES, ZTHT, ZRCTEN, ISPBL, ZSTLCL, LLTRIG1, ZRVTEN, ZZUMF, ZTKECLS&
&, ZSHAL_ZCH1TENS, ZSTHVELCL, ISDPL, ZSTHLCL, ISLCL, ZSHAL_ZCH1, ZT, ZRC, ZRI, ZZZ, ICLTOPS&
&, ZRITEN, ICLBASS, ZSZLCL, ZPABS, ZSTHV, ZTTEN, ZZW, ZRV, ZSRVLCL)
CALL ACVPPKF_PART2 (LLOCHTRANS, ZRDOCP, YDCPG_OPTS, I_KCH1, D, IKICE, YDCST, YDML_PHY_MF&
&, ZSWLCL, ZSTHES, ZRCTEN, ZTHT, ISPBL, ZSTLCL, ZRVTEN, LLTRIG1, ZZUMF, ZSHAL_ZCH1TENS&
&, ZSTHVELCL, ISDPL, ZSTHLCL, ISLCL, ZSHAL_ZCH1, ZT, ZRC, ZRI, ZZZ, ICLTOPS, ICLBASS&
&, ZRITEN, ZSZLCL, ZPABS, ZTTEN, ZSTHV, ZRV, ZSRVLCL)
CALL ACVPPKF_PART3 (LLCONDWT, LLOCHTRANS, ZVMD, YDCST, YDCPG_OPTS, ZWMD, I_KCH1, ZEPS, ZSMD&
&, YDCPG_BNDS, YDML_PHY_MF, ZDPSG, ICLBAS, ZZUMF, PR, ZUQV, PCP, ZUMFMAX, ZURV, ZVTEN, ZDTDT&
&, ZDQIDT, PFCCQL, KNND, ICLTOPS, I_KCLTOP, PT, ZDQVDT, ZLS, ZTTEN, PAPRSF, ZUTEN, PPRODTH&
&, ZRCTEN, ZRVTEN, PFCCQN, ZSHAL_ZCH1TEN, ZQC, KNLAB, ZDQLDT, ZUMF, ICLTOP, ZRITEN, ICLBASS&
&, PNEBPP, ZUQL, PDIFCS, I_KCLBAS, ZDVDT, PQCPP, ZURCI, ZDUDT, PDIFCQ, ZLV)
