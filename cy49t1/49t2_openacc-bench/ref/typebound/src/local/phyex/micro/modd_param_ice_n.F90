...
!
CONTAINS
PROCEDURE :: COPY => COPY_PARAM_ICE_T
PROCEDURE :: CRC64 => CRC64_PARAM_ICE_T
PROCEDURE :: HOST => HOST_PARAM_ICE_T
PROCEDURE :: LOAD => LOAD_PARAM_ICE_T
PROCEDURE :: SAVE => SAVE_PARAM_ICE_T
PROCEDURE :: SIZE => SIZE_PARAM_ICE_T
PROCEDURE :: WIPE => WIPE_PARAM_ICE_T
...
MODULE SUBROUTINE COPY_PARAM_ICE_T (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_PARAM_ICE_T (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_PARAM_ICE_T (SELF)

IMPLICIT NONE
CLASS (PARAM_ICE_T), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_PARAM_ICE_T (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_PARAM_ICE_T (SELF, KLUN)
...
MODULE FUNCTION SIZE_PARAM_ICE_T (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_PARAM_ICE_T (SELF, LDDELETED, LDFIELDAPI)
