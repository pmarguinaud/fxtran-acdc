...
IF (LOROG) THEN
  ...
  ALLOCATE (ZTMP2(LBOUND(YD%OROG,1):UBOUND(YD%OROG,1), LBOUND(YD%OROG,2):UBOUND(YD%OROG,2)))
  READ (KLUN) ZTMP2
  YD%OROG = ZTMP2
  DEALLOCATE (ZTMP2)
ENDIF
...
IF (LOROGL) THEN
  ...
  ALLOCATE (ZTMP2(LBOUND(YD%OROGL,1):UBOUND(YD%OROGL,1), LBOUND(YD%OROGL,2):UBOUND(YD%OROGL,2)))
  READ (KLUN) ZTMP2
  YD%OROGL = ZTMP2
  DEALLOCATE (ZTMP2)
ENDIF
...
IF (LOROGM) THEN
  ...
  ALLOCATE (ZTMP2(LBOUND(YD%OROGM,1):UBOUND(YD%OROGM,1), LBOUND(YD%OROGM,2):UBOUND(YD%OROGM,2)))
  READ (KLUN) ZTMP2
  YD%OROGM = ZTMP2
  DEALLOCATE (ZTMP2)
ENDIF
...
IF (LOROGLL) THEN
  ...
  ALLOCATE (ZTMP2(LBOUND(YD%OROGLL,1):UBOUND(YD%OROGLL,1), LBOUND(YD%OROGLL,2):UBOUND(YD%OROGLL,2)))
  READ (KLUN) ZTMP2
  YD%OROGLL = ZTMP2
  DEALLOCATE (ZTMP2)
ENDIF
...
IF (LOROGMM) THEN
  ...
  ALLOCATE (ZTMP2(LBOUND(YD%OROGMM,1):UBOUND(YD%OROGMM,1), LBOUND(YD%OROGMM,2):UBOUND(YD%OROGMM,2)))
  READ (KLUN) ZTMP2
  YD%OROGMM = ZTMP2
  DEALLOCATE (ZTMP2)
ENDIF
...
IF (LOROGLM) THEN
  ...
  ALLOCATE (ZTMP2(LBOUND(YD%OROGLM,1):UBOUND(YD%OROGLM,1), LBOUND(YD%OROGLM,2):UBOUND(YD%OROGLM,2)))
  READ (KLUN) ZTMP2
  YD%OROGLM = ZTMP2
  DEALLOCATE (ZTMP2)
ENDIF
...
SUBROUTINE COPY_TOROG_BLOCKED (YD, LDCREATED, LDFIELDAPI)
...
SUBROUTINE HOST_TOROG_BLOCKED (YD)

IMPLICIT NONE
TYPE (TOROG_BLOCKED), TARGET :: YD
LOGICAL :: LOROG, LOROGL, LOROGLL, LOROGLM, LOROGM, LOROGMM
...
SUBROUTINE CRC64_TOROG_BLOCKED (YD, KLUN, CDPATH)
...
SUBROUTINE WIPE_TOROG_BLOCKED (YD, LDDELETED, LDFIELDAPI)
...
INTEGER*8 FUNCTION SIZE_TOROG_BLOCKED (YD, CDPATH, LDPRINT) RESULT (KSIZE)
