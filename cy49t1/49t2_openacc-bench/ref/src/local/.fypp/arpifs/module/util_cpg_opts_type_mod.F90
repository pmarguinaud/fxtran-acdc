...
SUBROUTINE SAVE_CPG_OPTS_TYPE (SELF, KLUN)
...
CALL SAVE_CPG_OPTS_SURF_TYPE (SELF%YRSURF_OPTS, KLUN)
CALL SAVE_CPG_DIMS_SURF_TYPE (SELF%YRSURF_DIMS, KLUN)
CALL SAVE_CPG_DIMS_VARS_TYPE (SELF%YRVARS_DIMS, KLUN)
...
CALL SAVE_TCLI (SELF%YRCLI, KLUN)
...
SUBROUTINE LOAD_CPG_OPTS_TYPE (SELF, KLUN)
USE UTIL_CPG_DIMS_SURF_TYPE_MOD
USE UTIL_CPG_DIMS_VARS_TYPE_MOD
USE UTIL_CPG_OPTS_SURF_TYPE_MOD
USE UTIL_TCLI_MOD
...
CALL LOAD_CPG_OPTS_SURF_TYPE (SELF%YRSURF_OPTS, KLUN)
CALL LOAD_CPG_DIMS_SURF_TYPE (SELF%YRSURF_DIMS, KLUN)
CALL LOAD_CPG_DIMS_VARS_TYPE (SELF%YRVARS_DIMS, KLUN)
...
READ (KLUN) ZTMP0
SELF%ZBETADT = ZTMP0
CALL LOAD_TCLI (SELF%YRCLI, KLUN)
...
SUBROUTINE COPY_CPG_OPTS_TYPE (SELF, LDCREATED, LDFIELDAPI)
USE UTIL_CPG_DIMS_SURF_TYPE_MOD
USE UTIL_CPG_DIMS_VARS_TYPE_MOD
USE UTIL_CPG_OPTS_SURF_TYPE_MOD
USE UTIL_TCLI_MOD
...
CALL COPY_CPG_OPTS_SURF_TYPE (SELF%YRSURF_OPTS, LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)

CALL COPY_CPG_DIMS_SURF_TYPE (SELF%YRSURF_DIMS, LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)

CALL COPY_CPG_DIMS_VARS_TYPE (SELF%YRVARS_DIMS, LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)

CALL COPY_TCLI (SELF%YRCLI, LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)
...
SUBROUTINE HOST_CPG_OPTS_TYPE (SELF)
USE UTIL_CPG_DIMS_SURF_TYPE_MOD
USE UTIL_CPG_DIMS_VARS_TYPE_MOD
USE UTIL_CPG_OPTS_SURF_TYPE_MOD
USE UTIL_TCLI_MOD
...
CALL HOST_CPG_OPTS_SURF_TYPE (SELF%YRSURF_OPTS)

CALL HOST_CPG_DIMS_SURF_TYPE (SELF%YRSURF_DIMS)

CALL HOST_CPG_DIMS_VARS_TYPE (SELF%YRVARS_DIMS)

CALL HOST_TCLI (SELF%YRCLI)

END SUBROUTINE

     

SUBROUTINE CRC64_CPG_OPTS_TYPE (SELF, KLUN, CDPATH)
USE UTIL_CPG_DIMS_SURF_TYPE_MOD
USE UTIL_CPG_DIMS_VARS_TYPE_MOD
USE UTIL_CPG_OPTS_SURF_TYPE_MOD
USE UTIL_TCLI_MOD
...
CLIND = ''
CALL CRC64_CPG_OPTS_SURF_TYPE (SELF%YRSURF_OPTS, KLUN, CDPATH//'%YRSURF_OPTS'//TRIM(CLIND))

CLIND = ''
CALL CRC64_CPG_DIMS_SURF_TYPE (SELF%YRSURF_DIMS, KLUN, CDPATH//'%YRSURF_DIMS'//TRIM(CLIND))

CLIND = ''
CALL CRC64_CPG_DIMS_VARS_TYPE (SELF%YRVARS_DIMS, KLUN, CDPATH//'%YRVARS_DIMS'//TRIM(CLIND))
...
CLIND = ''
CALL CRC64_TCLI (SELF%YRCLI, KLUN, CDPATH//'%YRCLI'//TRIM(CLIND))
...
SUBROUTINE WIPE_CPG_OPTS_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE UTIL_CPG_DIMS_SURF_TYPE_MOD
USE UTIL_CPG_DIMS_VARS_TYPE_MOD
USE UTIL_CPG_OPTS_SURF_TYPE_MOD
USE UTIL_TCLI_MOD
...
CALL WIPE_CPG_OPTS_SURF_TYPE (SELF%YRSURF_OPTS, LDDELETED=.TRUE., LDFIELDAPI=LDFIELDAPI)

CALL WIPE_CPG_DIMS_SURF_TYPE (SELF%YRSURF_DIMS, LDDELETED=.TRUE., LDFIELDAPI=LDFIELDAPI)

CALL WIPE_CPG_DIMS_VARS_TYPE (SELF%YRVARS_DIMS, LDDELETED=.TRUE., LDFIELDAPI=LDFIELDAPI)

CALL WIPE_TCLI (SELF%YRCLI, LDDELETED=.TRUE., LDFIELDAPI=LDFIELDAPI)
