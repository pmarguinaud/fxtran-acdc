...
SUBROUTINE SAVE_SPP_MODEL (SELF, KLUN)
...
DO J1 = LBOUND (SELF%PNDEF, 1), UBOUND (SELF%PNDEF, 1)
  CALL SAVE_spp_pert (SELF%PNDEF (J1), KLUN)
ENDDO
DO J1 = LBOUND (SELF%PN, 1), UBOUND (SELF%PN, 1)
  CALL SAVE_spp_pert (SELF%PN (J1), KLUN)
ENDDO
WRITE (KLUN) SELF%TAU
...
SUBROUTINE LOAD_SPP_MODEL (SELF, KLUN)
USE UTIL_spp_pert_MOD
...
DO J1 = LBOUND (SELF%PNDEF, 1), UBOUND (SELF%PNDEF, 1)
  CALL LOAD_spp_pert (SELF%PNDEF (J1), KLUN)
ENDDO
DO J1 = LBOUND (SELF%PN, 1), UBOUND (SELF%PN, 1)
  CALL LOAD_spp_pert (SELF%PN (J1), KLUN)
ENDDO
READ (KLUN) ZTMP0
SELF%TAU = ZTMP0
READ (KLUN) ZTMP0
...
SUBROUTINE COPY_SPP_MODEL (SELF, LDCREATED, LDFIELDAPI)
USE UTIL_spp_pert_MOD
IMPLICIT NONE
TYPE (SPP_MODEL), INTENT (IN), TARGET :: SELF
...
DO J1 = LBOUND (SELF%PNDEF, 1), UBOUND (SELF%PNDEF, 1)
  CALL COPY_spp_pert (SELF%PNDEF (J1), LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)
ENDDO

DO J1 = LBOUND (SELF%PN, 1), UBOUND (SELF%PN, 1)
  CALL COPY_spp_pert (SELF%PN (J1), LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)
ENDDO

END SUBROUTINE

SUBROUTINE HOST_SPP_MODEL (SELF)
USE UTIL_spp_pert_MOD
...
DO J1 = LBOUND (SELF%PNDEF, 1), UBOUND (SELF%PNDEF, 1)
  CALL HOST_spp_pert (SELF%PNDEF (J1))
ENDDO

DO J1 = LBOUND (SELF%PN, 1), UBOUND (SELF%PN, 1)
  CALL HOST_spp_pert (SELF%PN (J1))
ENDDO
...
SUBROUTINE CRC64_SPP_MODEL (SELF, KLUN, CDPATH)
USE UTIL_spp_pert_MOD
...
DO J1 = LBOUND (SELF%PNDEF, 1), UBOUND (SELF%PNDEF, 1)
  WRITE (CLIND, '("(",I0,")")') J1
  CALL CRC64_spp_pert (SELF%PNDEF (J1), KLUN, CDPATH//'%PNDEF'//TRIM(CLIND))
ENDDO

DO J1 = LBOUND (SELF%PN, 1), UBOUND (SELF%PN, 1)
  WRITE (CLIND, '("(",I0,")")') J1
  CALL CRC64_spp_pert (SELF%PN (J1), KLUN, CDPATH//'%PN'//TRIM(CLIND))
ENDDO
...
SUBROUTINE WIPE_SPP_MODEL (SELF, LDDELETED, LDFIELDAPI)
USE UTIL_spp_pert_MOD
IMPLICIT NONE
TYPE (SPP_MODEL), INTENT (IN), TARGET :: SELF
...
DO J1 = LBOUND (SELF%PNDEF, 1), UBOUND (SELF%PNDEF, 1)
  CALL WIPE_spp_pert (SELF%PNDEF (J1), LDDELETED=.TRUE., LDFIELDAPI=LDFIELDAPI)
ENDDO

DO J1 = LBOUND (SELF%PN, 1), UBOUND (SELF%PN, 1)
  CALL WIPE_spp_pert (SELF%PN (J1), LDDELETED=.TRUE., LDFIELDAPI=LDFIELDAPI)
ENDDO
...
FUNCTION SIZE_SPP_MODEL (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
USE UTIL_spp_pert_MOD
IMPLICIT NONE
TYPE (SPP_MODEL),     INTENT (IN), TARGET :: SELF
...
JSIZE = 0
DO J1 = LBOUND (SELF%PNDEF, 1), UBOUND (SELF%PNDEF, 1)
  ISIZE = SIZE_spp_pert (SELF%PNDEF (J1), CLPATH//'%PNDEF', .FALSE.)
  JSIZE = JSIZE + ISIZE
  KSIZE = KSIZE + ISIZE
ENDDO
IF (LLPRINT) THEN
...
JSIZE = 0
DO J1 = LBOUND (SELF%PN, 1), UBOUND (SELF%PN, 1)
  ISIZE = SIZE_spp_pert (SELF%PN (J1), CLPATH//'%PN', .FALSE.)
  JSIZE = JSIZE + ISIZE
  KSIZE = KSIZE + ISIZE
ENDDO
IF (LLPRINT) THEN
