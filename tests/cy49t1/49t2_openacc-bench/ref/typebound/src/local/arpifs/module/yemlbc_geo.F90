...
CONTAINS
PROCEDURE :: COPY => COPY_TELBC_GEO
PROCEDURE :: CRC64 => CRC64_TELBC_GEO
PROCEDURE :: HOST => HOST_TELBC_GEO
PROCEDURE :: LOAD => LOAD_TELBC_GEO
PROCEDURE :: SAVE => SAVE_TELBC_GEO
PROCEDURE :: SIZE => SIZE_TELBC_GEO
PROCEDURE :: WIPE => WIPE_TELBC_GEO
END TYPE TELBC_GEO
...
MODULE SUBROUTINE COPY_TELBC_GEO (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TELBC_GEO (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TELBC_GEO (SELF)

IMPLICIT NONE
CLASS (TELBC_GEO), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TELBC_GEO (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TELBC_GEO (SELF, KLUN)
...
MODULE FUNCTION SIZE_TELBC_GEO (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TELBC_GEO (SELF, LDDELETED, LDFIELDAPI)
