...
fxtran_acdc_temp (REAL (KIND=JPRB), ZUSLE, (KLON, KLEV))
...
fxtran_acdc_temp (REAL (KIND=JPRB), ZECTCLS, (KLON))
fxtran_acdc_temp (REAL (KIND=JPRB), ZKCLS, (KLON))
fxtran_acdc_temp (REAL (KIND=JPRB), ZDIFFAR, (KLON, KLEV))
fxtran_acdc_temp (REAL (KIND=JPRB), ZTABFL, (KLON, KLEV))
fxtran_acdc_temp (REAL (KIND=JPRB), ZTABHL, (KLON, 0:KLEV))
...
IF (KIND (ZUSLE) == 8) THEN
    fxtran_acdc_alloc8 (ZUSLE)
ELSEIF (KIND (ZUSLE) == 4) THEN
    fxtran_acdc_alloc4 (ZUSLE)
ELSE
    STOP 1
ENDIF
...
IF (KIND (ZECTCLS) == 8) THEN
    fxtran_acdc_alloc8 (ZECTCLS)
ELSEIF (KIND (ZECTCLS) == 4) THEN
    fxtran_acdc_alloc4 (ZECTCLS)
ELSE
    STOP 1
ENDIF
...
IF (KIND (ZKCLS) == 8) THEN
    fxtran_acdc_alloc8 (ZKCLS)
ELSEIF (KIND (ZKCLS) == 4) THEN
    fxtran_acdc_alloc4 (ZKCLS)
ELSE
    STOP 1
ENDIF
...
IF (KIND (ZTABFL) == 8) THEN
    fxtran_acdc_alloc8 (ZTABFL)
ELSEIF (KIND (ZTABFL) == 4) THEN
    fxtran_acdc_alloc4 (ZTABFL)
ELSE
    STOP 1
ENDIF
...
IF (KIND (ZTABHL) == 8) THEN
    fxtran_acdc_alloc8 (ZTABHL)
ELSEIF (KIND (ZTABHL) == 4) THEN
    fxtran_acdc_alloc4 (ZTABHL)
ELSE
    STOP 1
ENDIF
