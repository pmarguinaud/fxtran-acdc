...
SUBROUTINE SAVE_TERDI (SELF, KLUN)
...
SUBROUTINE LOAD_TERDI (SELF, KLUN)
...
SUBROUTINE COPY_TERDI (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE CRC64_TERDI (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TERDI (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TERDI (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
