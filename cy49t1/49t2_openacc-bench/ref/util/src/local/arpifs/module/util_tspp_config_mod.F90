...
SUBROUTINE SAVE_TSPP_CONFIG (SELF, KLUN)
...
CALL SAVE_SPP_MODEL (SELF%SM, KLUN)
CALL SAVE_SPP_PERT_POINTER (SELF%PPTR, KLUN)
...
SUBROUTINE LOAD_TSPP_CONFIG (SELF, KLUN)
USE UTIL_SPP_MODEL_MOD
USE UTIL_SPP_PERT_POINTER_MOD
...
CALL LOAD_SPP_MODEL (SELF%SM, KLUN)
CALL LOAD_SPP_PERT_POINTER (SELF%PPTR, KLUN)
...
SUBROUTINE COPY_TSPP_CONFIG (SELF, LDCREATED, LDFIELDAPI)
USE UTIL_SPP_MODEL_MOD
USE UTIL_SPP_PERT_POINTER_MOD
IMPLICIT NONE
TYPE (TSPP_CONFIG), INTENT (IN), TARGET :: SELF
...
CALL COPY_SPP_MODEL (SELF%SM, LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)

CALL COPY_SPP_PERT_POINTER (SELF%PPTR, LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)

END SUBROUTINE

SUBROUTINE HOST_TSPP_CONFIG (SELF)
USE UTIL_SPP_MODEL_MOD
USE UTIL_SPP_PERT_POINTER_MOD
...
CALL HOST_SPP_MODEL (SELF%SM)

CALL HOST_SPP_PERT_POINTER (SELF%PPTR)

END SUBROUTINE

     

SUBROUTINE CRC64_TSPP_CONFIG (SELF, KLUN, CDPATH)
USE UTIL_SPP_MODEL_MOD
USE UTIL_SPP_PERT_POINTER_MOD
...
CLIND = ''
CALL CRC64_SPP_MODEL (SELF%SM, KLUN, CDPATH//'%SM'//TRIM(CLIND))

CLIND = ''
CALL CRC64_SPP_PERT_POINTER (SELF%PPTR, KLUN, CDPATH//'%PPTR'//TRIM(CLIND))
...
SUBROUTINE WIPE_TSPP_CONFIG (SELF, LDDELETED, LDFIELDAPI)
USE UTIL_SPP_MODEL_MOD
USE UTIL_SPP_PERT_POINTER_MOD
IMPLICIT NONE
TYPE (TSPP_CONFIG), INTENT (IN), TARGET :: SELF
...
CALL WIPE_SPP_MODEL (SELF%SM, LDDELETED=.TRUE., LDFIELDAPI=LDFIELDAPI)

CALL WIPE_SPP_PERT_POINTER (SELF%PPTR, LDDELETED=.TRUE., LDFIELDAPI=LDFIELDAPI)
...
FUNCTION SIZE_TSPP_CONFIG (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
USE UTIL_SPP_MODEL_MOD
USE UTIL_SPP_PERT_POINTER_MOD
IMPLICIT NONE
TYPE (TSPP_CONFIG),     INTENT (IN), TARGET :: SELF
...
KSIZE = KSIZE + ISIZE
JSIZE = 0
ISIZE = SIZE_SPP_MODEL (SELF%SM, CLPATH//'%SM', .FALSE.)
JSIZE = JSIZE + ISIZE
KSIZE = KSIZE + ISIZE
IF (LLPRINT) THEN
...
ENDIF
JSIZE = 0
ISIZE = SIZE_SPP_PERT_POINTER (SELF%PPTR, CLPATH//'%PPTR', .FALSE.)
JSIZE = JSIZE + ISIZE
KSIZE = KSIZE + ISIZE
IF (LLPRINT) THEN
  WRITE (*, '(I10," ")', ADVANCE='NO') JSIZE
