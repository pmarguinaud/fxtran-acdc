...
CONTAINS
PROCEDURE :: COPY => COPY_TXFU_KEYS
PROCEDURE :: HOST => HOST_TXFU_KEYS
PROCEDURE :: SIZE => SIZE_TXFU_KEYS
PROCEDURE :: WIPE => WIPE_TXFU_KEYS
END TYPE TXFU_KEYS
...
PROCEDURE :: COPY => COPY_TXFU
PROCEDURE :: HOST => HOST_TXFU
PROCEDURE :: SIZE => SIZE_TXFU
PROCEDURE :: WIPE => WIPE_TXFU
END TYPE TXFU
...
MODULE SUBROUTINE COPY_TXFU_KEYS (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TXFU_KEYS (SELF)
...
MODULE SUBROUTINE WIPE_TXFU_KEYS (SELF, LDDELETED, LDFIELDAPI)
