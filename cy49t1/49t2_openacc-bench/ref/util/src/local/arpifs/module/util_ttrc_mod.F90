...
SUBROUTINE SAVE_TTRC (SELF, KLUN)
...
SUBROUTINE LOAD_TTRC (SELF, KLUN)
...
SUBROUTINE COPY_TTRC (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE CRC64_TTRC (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TTRC (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TTRC (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
