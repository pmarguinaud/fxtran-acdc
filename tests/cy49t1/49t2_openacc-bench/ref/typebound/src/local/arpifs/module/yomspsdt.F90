...
CONTAINS
PROCEDURE :: COPY => COPY_TSPPT_CONFIG
PROCEDURE :: CRC64 => CRC64_TSPPT_CONFIG
PROCEDURE :: HOST => HOST_TSPPT_CONFIG
PROCEDURE :: LOAD => LOAD_TSPPT_CONFIG
PROCEDURE :: SAVE => SAVE_TSPPT_CONFIG
PROCEDURE :: SIZE => SIZE_TSPPT_CONFIG
PROCEDURE :: WIPE => WIPE_TSPPT_CONFIG
...
MODULE SUBROUTINE COPY_TSPPT_CONFIG (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TSPPT_CONFIG (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TSPPT_CONFIG (SELF)

IMPLICIT NONE
CLASS (TSPPT_CONFIG), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TSPPT_CONFIG (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TSPPT_CONFIG (SELF, KLUN)
...
MODULE FUNCTION SIZE_TSPPT_CONFIG (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TSPPT_CONFIG (SELF, LDDELETED, LDFIELDAPI)
