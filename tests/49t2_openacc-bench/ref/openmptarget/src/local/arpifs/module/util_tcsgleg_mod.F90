...
LRW = ALLOCATED (SELF%RW)
IF (LRW) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%RW)
  !$OMP TARGET UPDATE TO (SELF%RW)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%RW)
ENDIF
...
LR1MU2 = ALLOCATED (SELF%R1MU2)
IF (LR1MU2) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%R1MU2)
  !$OMP TARGET UPDATE TO (SELF%R1MU2)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%R1MU2)
ENDIF

LR1MUI = ALLOCATED (SELF%R1MUI)
IF (LR1MUI) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%R1MUI)
  !$OMP TARGET UPDATE TO (SELF%R1MUI)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%R1MUI)
ENDIF

LR1MUA = ALLOCATED (SELF%R1MUA)
IF (LR1MUA) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%R1MUA)
  !$OMP TARGET UPDATE TO (SELF%R1MUA)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%R1MUA)
ENDIF
...
LR1QM2 = ALLOCATED (SELF%R1QM2)
IF (LR1QM2) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%R1QM2)
  !$OMP TARGET UPDATE TO (SELF%R1QM2)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%R1QM2)
ENDIF

LRACTHE = ALLOCATED (SELF%RACTHE)
IF (LRACTHE) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%RACTHE)
  !$OMP TARGET UPDATE TO (SELF%RACTHE)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%RACTHE)
ENDIF
...
LRW = ALLOCATED (SELF%RW)
IF (LRW) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%RW)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%RW)
ENDIF
...
LR1MU2 = ALLOCATED (SELF%R1MU2)
IF (LR1MU2) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%R1MU2)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%R1MU2)
ENDIF

LR1MUI = ALLOCATED (SELF%R1MUI)
IF (LR1MUI) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%R1MUI)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%R1MUI)
ENDIF

LR1MUA = ALLOCATED (SELF%R1MUA)
IF (LR1MUA) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%R1MUA)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%R1MUA)
ENDIF
...
LR1QM2 = ALLOCATED (SELF%R1QM2)
IF (LR1QM2) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%R1QM2)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%R1QM2)
ENDIF

LRACTHE = ALLOCATED (SELF%RACTHE)
IF (LRACTHE) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%RACTHE)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%RACTHE)
ENDIF
