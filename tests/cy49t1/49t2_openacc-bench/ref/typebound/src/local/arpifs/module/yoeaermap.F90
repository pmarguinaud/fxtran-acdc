...
PROCEDURE :: COPY => COPY_TEAERMAP
PROCEDURE :: CRC64 => CRC64_TEAERMAP
PROCEDURE :: HOST => HOST_TEAERMAP
PROCEDURE :: LOAD => LOAD_TEAERMAP
PROCEDURE :: SAVE => SAVE_TEAERMAP
PROCEDURE :: SIZE => SIZE_TEAERMAP
PROCEDURE :: WIPE => WIPE_TEAERMAP
END TYPE TEAERMAP
!=====================================================================
...
MODULE SUBROUTINE COPY_TEAERMAP (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TEAERMAP (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TEAERMAP (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TEAERMAP (SELF, KLUN)
...
MODULE FUNCTION SIZE_TEAERMAP (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TEAERMAP (SELF, LDDELETED, LDFIELDAPI)
