...
CONTAINS
PROCEDURE :: COPY => COPY_TVSLETA
PROCEDURE :: CRC64 => CRC64_TVSLETA
PROCEDURE :: HOST => HOST_TVSLETA
PROCEDURE :: LOAD => LOAD_TVSLETA
PROCEDURE :: SAVE => SAVE_TVSLETA
PROCEDURE :: SIZE => SIZE_TVSLETA
PROCEDURE :: WIPE => WIPE_TVSLETA
END TYPE TVSLETA
...
MODULE SUBROUTINE COPY_TVSLETA (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TVSLETA (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TVSLETA (SELF)

IMPLICIT NONE
CLASS (TVSLETA), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TVSLETA (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TVSLETA (SELF, KLUN)
...
MODULE FUNCTION SIZE_TVSLETA (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TVSLETA (SELF, LDDELETED, LDFIELDAPI)
