!OPTIONS XOPT(NOEVAL)
SUBROUTINE ACRANEB_COEFS(YDPHY3,KIDIA,KFDIA,KLON,KTDIA,KLEV,LDMASKS,&
! - INPUT 2D
...
REAL(KIND=JPRB) :: ZG1,ZG2,ZMU0IC,ZMU0IN,ZRHO,ZTAU,ZTRLI
...
DO JLEV=KTDIA,KLEV
      ...
      ZEORAY=YDPHY3%FRS_K_SCAT0*(1._JPRB+PMU0I(JLON)*PAPRSF(JLON,JLEV)/&
       &     YDPHY3%FRS_P_CRIT)**(YDPHY3%FRS_BETA-1._JPRB)
