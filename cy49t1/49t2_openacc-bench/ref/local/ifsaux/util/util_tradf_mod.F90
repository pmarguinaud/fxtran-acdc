...
SUBROUTINE SAVE_TRADF (SELF, KLUN)
...
SUBROUTINE LOAD_TRADF (SELF, KLUN)
...
SUBROUTINE COPY_TRADF (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE CRC64_TRADF (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TRADF (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TRADF (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
