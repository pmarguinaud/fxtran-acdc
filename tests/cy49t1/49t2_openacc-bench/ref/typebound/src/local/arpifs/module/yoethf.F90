...
TYPE TTHF
  ...
  REAL(KIND=JPRB) :: RKOOP2
CONTAINS
PROCEDURE :: COPY => COPY_TTHF
PROCEDURE :: CRC64 => CRC64_TTHF
PROCEDURE :: HOST => HOST_TTHF
PROCEDURE :: LOAD => LOAD_TTHF
PROCEDURE :: SAVE => SAVE_TTHF
PROCEDURE :: SIZE => SIZE_TTHF
PROCEDURE :: WIPE => WIPE_TTHF
END TYPE TTHF
...
MODULE SUBROUTINE COPY_TTHF (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TTHF (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TTHF (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TTHF (SELF, KLUN)
...
MODULE FUNCTION SIZE_TTHF (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TTHF (SELF, LDDELETED, LDFIELDAPI)
