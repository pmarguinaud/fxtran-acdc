...
IF (LPARALLELMETHOD ('OPENMP','CPGLAG_PARALLEL:0')) THEN
  ...
  IF (LSYNCHOST ('CPGLAG_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPGLAG_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPGLAG_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPGLAG_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, Z_YDCPG_SL2_PDSI, Z_YDCPG_SL2_SPSI, &
    !$ACC&         Z_YDCPG_SL2_TSI, Z_YDCPG_SL2_USI, Z_YDCPG_SL2_VDSI, Z_YDCPG_SL2_VSI, &
    !$ACC&         Z_YDVARS_SPD_T1, Z_YDVARS_SP_T1, Z_YDVARS_SVD_T1, Z_YDVARS_T_T1, &
...
IF (YDMODEL%YRML_DYN%YRDYNA%LSPRT) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','CPGLAG_PARALLEL:1')) THEN
    ...
    IF (LSYNCHOST ('CPGLAG_PARALLEL:1')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPGLAG_PARALLEL:1')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPGLAG_PARALLEL:1')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('CPGLAG_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, ZR1, Z_YDVARS_T_T1) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LLSTR) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','CPGLAG_PARALLEL:STR')) THEN
    ...
    IF (LSYNCHOST ('CPGLAG_PARALLEL:STR')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPGLAG_PARALLEL:STR')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPGLAG_PARALLEL:STR')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('CPGLAG_PARALLEL:STR:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, Z_YDVARS_GEOMETRY_GM_P, Z_YDVARS_U_T1, &
      !$ACC&         Z_YDVARS_V_T1) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
