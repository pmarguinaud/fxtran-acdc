...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','MF_PHYS_SAVE_PHSURF_PART1_PARALLEL:PART1')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (PDAL_T0, YD_PDAL_T0)
  CALL SGET_HOST_DATA_RDONLY (PDOM_T0, YD_PDOM_T0)
  CALL SGET_HOST_DATA_RDONLY (PGSD_VF_PZ0F, YD_PGSD_VF_PZ0F)
  CALL SGET_HOST_DATA_RDONLY (PGSD_VH_PPBLH, YD_PGSD_VH_PPBLH)
  CALL SGET_HOST_DATA_RDONLY (PGSD_VH_PQSH, YD_PGSD_VH_PQSH)
  CALL SGET_HOST_DATA_RDONLY (PGSD_VH_PSPSH, YD_PGSD_VH_PSPSH)
  CALL SGET_HOST_DATA_RDONLY (PGSD_VK_PUDGRO, YD_PGSD_VK_PUDGRO)
  CALL SGET_HOST_DATA_RDONLY (PGSD_VV_PHV, YD_PGSD_VV_PHV)
  CALL SGET_HOST_DATA_RDONLY (PGSD_VV_PZ0H, YD_PGSD_VV_PZ0H)
  ...
  CALL SGET_HOST_DATA_RDONLY (PUAL_T0, YD_PUAL_T0)
  CALL SGET_HOST_DATA_RDONLY (PUEN_T0, YD_PUEN_T0)
  CALL SGET_HOST_DATA_RDONLY (PUNEBH_T0, YD_PUNEBH_T0)
  CALL SGET_HOST_DATA_RDONLY (PUOM_T0, YD_PUOM_T0)
  IF (LHOOK) CALL DR_HOOK ('MF_PHYS_SAVE_PHSURF_PART1_PARALLEL&
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
  ...
  IF (LHOOK) CALL DR_HOOK ('MF_PHYS_SAVE_PHSURF_PART1_PARALLEL&
  &:PART1:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (PDAL_T0, YD_PDAL_T0)
  CALL SGET_DEVICE_DATA_RDONLY (PDOM_T0, YD_PDOM_T0)
  CALL SGET_DEVICE_DATA_RDONLY (PGSD_VF_PZ0F, YD_PGSD_VF_PZ0F)
  CALL SGET_DEVICE_DATA_RDONLY (PGSD_VH_PPBLH, YD_PGSD_VH_PPBLH)
  CALL SGET_DEVICE_DATA_RDONLY (PGSD_VH_PQSH, YD_PGSD_VH_PQSH)
  CALL SGET_DEVICE_DATA_RDONLY (PGSD_VH_PSPSH, YD_PGSD_VH_PSPSH)
  CALL SGET_DEVICE_DATA_RDONLY (PGSD_VK_PUDGRO, YD_PGSD_VK_PUDGRO)
  CALL SGET_DEVICE_DATA_RDONLY (PGSD_VV_PHV, YD_PGSD_VV_PHV)
  CALL SGET_DEVICE_DATA_RDONLY (PGSD_VV_PZ0H, YD_PGSD_VV_PZ0H)
  CALL SGET_DEVICE_DATA_RDWR (PSAV_DDAL, YD_PSAV_DDAL)
  CALL SGET_DEVICE_DATA_RDWR (PSAV_DDOM, YD_PSAV_DDOM)
  CALL SGET_DEVICE_DATA_RDWR (PSAV_ENTCH, YD_PSAV_ENTCH)
  CALL SGET_DEVICE_DATA_RDWR (PSAV_FHPS, YD_PSAV_FHPS)
  CALL SGET_DEVICE_DATA_RDWR (PSAV_GZ0F, YD_PSAV_GZ0F)
  CALL SGET_DEVICE_DATA_RDWR (PSAV_GZ0HF, YD_PSAV_GZ0HF)
  CALL SGET_DEVICE_DATA_RDWR (PSAV_HV, YD_PSAV_HV)
  CALL SGET_DEVICE_DATA_RDWR (PSAV_PBLH, YD_PSAV_PBLH)
  CALL SGET_DEVICE_DATA_RDWR (PSAV_QSH, YD_PSAV_QSH)
  CALL SGET_DEVICE_DATA_RDWR (PSAV_UDAL, YD_PSAV_UDAL)
  CALL SGET_DEVICE_DATA_RDWR (PSAV_UDGRO, YD_PSAV_UDGRO)
  CALL SGET_DEVICE_DATA_RDWR (PSAV_UDOM, YD_PSAV_UDOM)
  CALL SGET_DEVICE_DATA_RDWR (PSAV_UNEBH, YD_PSAV_UNEBH)
  CALL SGET_DEVICE_DATA_RDONLY (PUAL_T0, YD_PUAL_T0)
  CALL SGET_DEVICE_DATA_RDONLY (PUEN_T0, YD_PUEN_T0)
  CALL SGET_DEVICE_DATA_RDONLY (PUNEBH_T0, YD_PUNEBH_T0)
  CALL SGET_DEVICE_DATA_RDONLY (PUOM_T0, YD_PUOM_T0)
  IF (LHOOK) CALL DR_HOOK ('MF_PHYS_SAVE_PHSURF_PART1_PARALLEL&
  &:PART1:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('MF_PHYS_SAVE_PHSURF_PART1_PARALLEL:PART1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
