...
CONTAINS
PROCEDURE :: COPY => COPY_TSTA
PROCEDURE :: CRC64 => CRC64_TSTA
PROCEDURE :: HOST => HOST_TSTA
PROCEDURE :: LOAD => LOAD_TSTA
PROCEDURE :: SAVE => SAVE_TSTA
PROCEDURE :: SIZE => SIZE_TSTA
PROCEDURE :: WIPE => WIPE_TSTA
END TYPE TSTA
...
MODULE SUBROUTINE HOST_TSTA (SELF)

IMPLICIT NONE
CLASS (TSTA), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TSTA (SELF, KLUN)
