...
generateStructureMethods.pl \
  --host --dir $dir --skip-components cpg --no-allocate $no_alloc \
  --module-map $module_map --field-api --field-api-class cpg --tmp /tmp/$USER \
  $f
done
...
generateStructureMethods.pl \
  --crc64 --legacy --size --wipe --copy --host --dir $dir --skip-components var --no-allocate $no_alloc \
  --module-map $module_map --field-api --field-api-class var --tmp /tmp/$USER \
...
generateStructureMethods.pl \
  --size --wipe --copy --host --dir $dir --skip-components flu --no-allocate $no_alloc \
  --module-map $module_map --field-api --field-api-class flu --tmp /tmp/$USER \
...
generateStructureMethods.pl \
  --host --wipe --copy --dir $dir --skip-components cpg --no-allocate $no_alloc \
  --module-map $module_map --field-api --field-api-class cpg --tmp /tmp/$USER \
...
generateStructureMethods.pl \
  --host --wipe --copy --dir $dir --skip-components cpg --no-allocate $no_alloc --tmp /tmp/$USER \
  --module-map $module_map --field-api --field-api-class cpg \
...
generateStructureMethods.pl \
  --host --wipe --copy --dir $dir \
  --module-map $module_map --no-allocate $no_alloc --field-api --field-api-class sfc --tmp /tmp/$USER \
