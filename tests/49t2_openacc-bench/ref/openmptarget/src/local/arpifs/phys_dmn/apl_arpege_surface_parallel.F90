...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SURFACE_PARALLEL:ACDIFV1')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (PEDMFQ, YD_PEDMFQ)
  CALL SGET_HOST_DATA_RDONLY (PEDMFS, YD_PEDMFS)
  CALL SGET_HOST_DATA_RDONLY (PEDMFU, YD_PEDMFU)
  CALL SGET_HOST_DATA_RDONLY (PEDMFV, YD_PEDMFV)
  CALL SGET_HOST_DATA_RDONLY (PKQROV, YD_PKQROV)
  CALL SGET_HOST_DATA_RDONLY (PKTROV, YD_PKTROV)
  CALL SGET_HOST_DATA_RDONLY (PKUROV, YD_PKUROV)
  CALL SGET_HOST_DATA_RDONLY (PMF_UP, YD_PMF_UP)
  ...
  CALL SGET_HOST_DATA_RDWR (ZCFAQ, YL_ZCFAQ)
  CALL SGET_HOST_DATA_RDWR (ZCFAS, YL_ZCFAS)
  CALL SGET_HOST_DATA_RDWR (ZCFASV, YL_ZCFASV)
  CALL SGET_HOST_DATA_RDWR (ZCFBQ, YL_ZCFBQ)
  CALL SGET_HOST_DATA_RDWR (ZCFBS, YL_ZCFBS)
  CALL SGET_HOST_DATA_RDWR (ZCFBSV, YL_ZCFBSV)
  CALL SGET_HOST_DATA_RDWR (ZDSE, YL_ZDSE)
  CALL SGET_HOST_DATA_RDONLY (ZDUMMY, YL_ZDUMMY)
  CALL SGET_HOST_DATA_RDWR (ZQT, YL_ZQT)
  CALL SGET_HOST_DATA_RDONLY (ZSVM, YL_ZSVM)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_SURFACE_PARALLEL:ACDIFV1')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZCFBSV, YL_ZCFBSV)
    CALL SGET_HOST_DATA_RDWR (ZDSE, YL_ZDSE)
    CALL SGET_HOST_DATA_RDWR (ZDUMMY, YL_ZDUMMY)
    CALL SGET_HOST_DATA_RDWR (ZQT, YL_ZQT)
    CALL SGET_HOST_DATA_RDWR (ZSVM, YL_ZSVM)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
  ...
  CALL SGET_DEVICE_DATA_RDONLY (PCP, YD_PCP)
  CALL SGET_DEVICE_DATA_RDONLY (PEDMFQ, YD_PEDMFQ)
  CALL SGET_DEVICE_DATA_RDONLY (PEDMFS, YD_PEDMFS)
  CALL SGET_DEVICE_DATA_RDONLY (PEDMFU, YD_PEDMFU)
  CALL SGET_DEVICE_DATA_RDONLY (PEDMFV, YD_PEDMFV)
  CALL SGET_DEVICE_DATA_RDONLY (PKQROV, YD_PKQROV)
  CALL SGET_DEVICE_DATA_RDONLY (PKTROV, YD_PKTROV)
  CALL SGET_DEVICE_DATA_RDONLY (PKUROV, YD_PKUROV)
  CALL SGET_DEVICE_DATA_RDONLY (PMF_UP, YD_PMF_UP)
  ...
  CALL SGET_DEVICE_DATA_RDWR (ZCFAQ, YL_ZCFAQ)
  CALL SGET_DEVICE_DATA_RDWR (ZCFAS, YL_ZCFAS)
  CALL SGET_DEVICE_DATA_RDWR (ZCFASV, YL_ZCFASV)
  CALL SGET_DEVICE_DATA_RDWR (ZCFBQ, YL_ZCFBQ)
  CALL SGET_DEVICE_DATA_RDWR (ZCFBS, YL_ZCFBS)
  CALL SGET_DEVICE_DATA_RDWR (ZCFBSV, YL_ZCFBSV)
  CALL SGET_DEVICE_DATA_RDWR (ZDSE, YL_ZDSE)
  CALL SGET_DEVICE_DATA_RDONLY (ZDUMMY, YL_ZDUMMY)
  CALL SGET_DEVICE_DATA_RDWR (ZQT, YL_ZQT)
  CALL SGET_DEVICE_DATA_RDONLY (ZSVM, YL_ZSVM)
  ...
  !$OMP & MAP(PRESENT:PCFATH, PCFAU, PCFBTH, PCFBU, PCFBV, PCP, PEDMFQ, PEDMFS, PEDMFU, PEDMFV,  & 
  !$OMP &          PKQROV, PKTROV, PKUROV, PMF_UP, PQI, PQL, PQV, PXDROV, PXHROV, PXQRO, PXTRO,  & 
  !$OMP &          PXTROV, PXURO, PXUROV, YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK,  & 
  !$OMP &          ZCFAQ, ZCFAS, ZCFASV, ZCFBQ, ZCFBS, ZCFBSV, ZDSE, ZDUMMY, ZQT, ZSVM, Z_YDMF_PHYS_BASE_STATE_T,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP)  & 
  !$OMP & PRIVATE (JBLK)  & 
...
IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE.AND.YDCPG_OPTS%LCALLSFX) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OpenMP','APL_ARPEGE_SURFACE_PARALLEL:1')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (PCFATH, YD_PCFATH)
    CALL SGET_HOST_DATA_RDONLY (PCFAU, YD_PCFAU)
    CALL SGET_HOST_DATA_RDONLY (PCFBTH, YD_PCFBTH)
    CALL SGET_HOST_DATA_RDONLY (PCFBU, YD_PCFBU)
    CALL SGET_HOST_DATA_RDONLY (PCFBV, YD_PCFBV)
    CALL SGET_HOST_DATA_RDWR (PCOEFA, YD_PCOEFA)
    CALL SGET_HOST_DATA_RDONLY (PCOEFN, YD_PCOEFN)
    ...
    CALL SGET_HOST_DATA_RDONLY (PRDG_MU0N, YD_PRDG_MU0N)
    CALL SGET_HOST_DATA_RDWR (PSFSWDIF, YD_PSFSWDIF)
    CALL SGET_HOST_DATA_RDWR (PSFSWDIR, YD_PSFSWDIR)
    CALL SGET_HOST_DATA_RDONLY (PSGROUPEL, YD_PSGROUPEL)
    CALL SGET_HOST_DATA_RDONLY (PSRAIN, YD_PSRAIN)
    CALL SGET_HOST_DATA_RDONLY (PSSNOW, YD_PSSNOW)
    CALL SGET_HOST_DATA_RDWR (PTSN, YD_PTSN)
    CALL SGET_HOST_DATA_RDWR (ZBUDSO, YL_ZBUDSO)
    CALL SGET_HOST_DATA_RDWR (ZBUDTH, YL_ZBUDTH)
    CALL SGET_HOST_DATA_RDWR (ZCD, YL_ZCD)
    CALL SGET_HOST_DATA_RDONLY (ZCFAQ, YL_ZCFAQ)
    CALL SGET_HOST_DATA_RDONLY (ZCFBQ, YL_ZCFBQ)
    CALL SGET_HOST_DATA_RDWR (ZCH, YL_ZCH)
    CALL SGET_HOST_DATA_RDWR (ZDEPTH_HEIGHT, YL_ZDEPTH_HEIGHT)
    CALL SGET_HOST_DATA_RDWR (ZFCLL, YL_ZFCLL)
    CALL SGET_HOST_DATA_RDWR (ZFEV, YL_ZFEV)
    CALL SGET_HOST_DATA_RDWR (ZFEVS, YL_ZFEVS)
    CALL SGET_HOST_DATA_RDWR (ZFMDU, YL_ZFMDU)
    CALL SGET_HOST_DATA_RDWR (ZFMDV, YL_ZFMDV)
    CALL SGET_HOST_DATA_RDWR (ZHV2, YL_ZHV2)
    CALL SGET_HOST_DATA_RDWR (ZRHODREFM, YL_ZRHODREFM)
    CALL SGET_HOST_DATA_RDWR (ZSFCO2, YL_ZSFCO2)
    CALL SGET_HOST_DATA_RDWR (ZSFSV, YL_ZSFSV)
    CALL SGET_HOST_DATA_RDWR (ZSSO_STDEV, YL_ZSSO_STDEV)
    CALL SGET_HOST_DATA_RDONLY (ZSVM, YL_ZSVM)
    CALL SGET_HOST_DATA_RDWR (ZTOWNS, YL_ZTOWNS)
    CALL SGET_HOST_DATA_RDWR (ZTWSNOW, YL_ZTWSNOW)
    CALL SGET_HOST_DATA_RDWR (ZZS, YL_ZZS)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GPAR_ALBDIR, YDCPG_GPAR%F_ALBDIR)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GPAR_ALBSCA, YDCPG_GPAR%F_ALBSCA)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GPAR_CD, YDCPG_GPAR%F_CD)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GPAR_GZ0, YDCPG_GPAR%F_GZ0)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GPAR_GZ0H, YDCPG_GPAR%F_GZ0H)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GPAR_VEMIS, YDCPG_GPAR%F_VEMIS)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GPAR_VQS, YDCPG_GPAR%F_VQS)
    ...
    CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_GEOMETRY_RINDX_T0, YDVARS%GEOMETRY%RINDX%FT0)
    CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_GEOMETRY_RINDY_T0, YDVARS%GEOMETRY%RINDY%FT0)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_SURFACE_PARALLEL:1')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (PCFBV, YD_PCFBV)
      CALL SGET_HOST_DATA_RDWR (PCOEFA, YD_PCOEFA)
      CALL SGET_HOST_DATA_RDWR (PCOEFN, YD_PCOEFN)
      CALL SGET_HOST_DATA_RDWR (PFLU_EMIS, YD_PFLU_EMIS)
      CALL SGET_HOST_DATA_RDWR (PLVT, YD_PLVT)
      CALL SGET_HOST_DATA_RDWR (PQI, YD_PQI)
      CALL SGET_HOST_DATA_RDWR (PQICE, YD_PQICE)
      ...
      CALL SGET_HOST_DATA_RDWR (PRDG_MU0N, YD_PRDG_MU0N)
      CALL SGET_HOST_DATA_RDWR (PSFSWDIF, YD_PSFSWDIF)
      CALL SGET_HOST_DATA_RDWR (PSFSWDIR, YD_PSFSWDIR)
      CALL SGET_HOST_DATA_RDWR (PSGROUPEL, YD_PSGROUPEL)
      CALL SGET_HOST_DATA_RDWR (PSRAIN, YD_PSRAIN)
      CALL SGET_HOST_DATA_RDWR (PSSNOW, YD_PSSNOW)
      CALL SGET_HOST_DATA_RDWR (PTSN, YD_PTSN)
      CALL SGET_HOST_DATA_RDWR (ZBUDSO, YL_ZBUDSO)
      CALL SGET_HOST_DATA_RDWR (ZBUDTH, YL_ZBUDTH)
      CALL SGET_HOST_DATA_RDWR (ZCD, YL_ZCD)
      ...
      CALL SGET_HOST_DATA_RDWR (Z_YDVARS_GEOMETRY_RINDX_T0, YDVARS%GEOMETRY%RINDX%FT0)
      CALL SGET_HOST_DATA_RDWR (Z_YDVARS_GEOMETRY_RINDY_T0, YDVARS%GEOMETRY%RINDY%FT0)
...
ELSEIF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SURFACE_PARALLEL:LMSE_F')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (PALPHA1, YD_PALPHA1)
    CALL SGET_HOST_DATA_RDONLY (PCDROV, YD_PCDROV)
    CALL SGET_HOST_DATA_RDONLY (PCEROV, YD_PCEROV)
    CALL SGET_HOST_DATA_RDONLY (PCFAU, YD_PCFAU)
    CALL SGET_HOST_DATA_RDWR (PCFBU, YD_PCFBU)
    CALL SGET_HOST_DATA_RDWR (PCFBV, YD_PCFBV)
    CALL SGET_HOST_DATA_RDONLY (PCHROV, YD_PCHROV)
    CALL SGET_HOST_DATA_RDWR (PCOEFA, YD_PCOEFA)
    CALL SGET_HOST_DATA_RDONLY (PCP, YD_PCP)
    CALL SGET_HOST_DATA_RDWR (PDIFWQ, YD_PDIFWQ)
    CALL SGET_HOST_DATA_RDWR (PDIFWS, YD_PDIFWS)
    CALL SGET_HOST_DATA_RDONLY (PDQSTS, YD_PDQSTS)
    CALL SGET_HOST_DATA_RDONLY (PDSA_CPS, YD_PDSA_CPS)
    CALL SGET_HOST_DATA_RDWR (PDSA_LHS, YD_PDSA_LHS)
    CALL SGET_HOST_DATA_RDONLY (PFLU_CD, YD_PFLU_CD)
    CALL SGET_HOST_DATA_RDONLY (PFLU_CDN, YD_PFLU_CDN)
    ...
    CALL SGET_HOST_DATA_RDONLY (PFLU_QSATS, YD_PFLU_QSATS)
    CALL SGET_HOST_DATA_RDONLY (PFLU_VEG, YD_PFLU_VEG)
    CALL SGET_HOST_DATA_RDONLY (PHQ, YD_PHQ)
    CALL SGET_HOST_DATA_RDONLY (PHTR, YD_PHTR)
    CALL SGET_HOST_DATA_RDONLY (PHU, YD_PHU)
    CALL SGET_HOST_DATA_RDWR (PLVT, YD_PLVT)
    CALL SGET_HOST_DATA_RDONLY (PNEBCH, YD_PNEBCH)
    CALL SGET_HOST_DATA_RDWR (PNEBDIFF, YD_PNEBDIFF)
    CALL SGET_HOST_DATA_RDONLY (PNEBS, YD_PNEBS)
    CALL SGET_HOST_DATA_RDONLY (PQI, YD_PQI)
    CALL SGET_HOST_DATA_RDWR (PQICE, YD_PQICE)
    CALL SGET_HOST_DATA_RDONLY (PQL, YD_PQL)
    CALL SGET_HOST_DATA_RDONLY (PQV, YD_PQV)
    ...
    CALL SGET_HOST_DATA_RDONLY (PXDROV, YD_PXDROV)
    CALL SGET_HOST_DATA_RDONLY (PXHROV, YD_PXHROV)
    CALL SGET_HOST_DATA_RDONLY (PXQRO, YD_PXQRO)
    CALL SGET_HOST_DATA_RDONLY (PXTRO, YD_PXTRO)
    CALL SGET_HOST_DATA_RDONLY (PXURO, YD_PXURO)
    CALL SGET_HOST_DATA_RDONLY (ZCFAS, YL_ZCFAS)
    CALL SGET_HOST_DATA_RDWR (ZCFBQ, YL_ZCFBQ)
    CALL SGET_HOST_DATA_RDWR (ZCFBQ_G, YL_ZCFBQ_G)
    CALL SGET_HOST_DATA_RDWR (ZCFBS, YL_ZCFBS)
    CALL SGET_HOST_DATA_RDWR (ZCFBS_G, YL_ZCFBS_G)
    CALL SGET_HOST_DATA_RDWR (ZCFBU_G, YL_ZCFBU_G)
    CALL SGET_HOST_DATA_RDWR (ZCFBV_G, YL_ZCFBV_G)
    CALL SGET_HOST_DATA_RDONLY (ZDSE, YL_ZDSE)
    CALL SGET_HOST_DATA_RDWR (ZFMDU, YL_ZFMDU)
    CALL SGET_HOST_DATA_RDWR (ZFMDV, YL_ZFMDV)
    ...
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VH_PQSH, YDMF_PHYS_SURF%GSD_VH%F_QSH)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VH_PSPSH, YDMF_PHYS_SURF%GSD_VH%F_SPSH)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_SURFACE_PARALLEL:LMSE_F')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (PALPHA1, YD_PALPHA1)
      CALL SGET_HOST_DATA_RDWR (PCDROV, YD_PCDROV)
      CALL SGET_HOST_DATA_RDWR (PCEROV, YD_PCEROV)
      CALL SGET_HOST_DATA_RDWR (PCFAU, YD_PCFAU)
      CALL SGET_HOST_DATA_RDWR (PCFBU, YD_PCFBU)
      CALL SGET_HOST_DATA_RDWR (PCFBV, YD_PCFBV)
      CALL SGET_HOST_DATA_RDWR (PCHROV, YD_PCHROV)
      CALL SGET_HOST_DATA_RDWR (PCOEFA, YD_PCOEFA)
      CALL SGET_HOST_DATA_RDWR (PCP, YD_PCP)
      CALL SGET_HOST_DATA_RDWR (PDIFWQ, YD_PDIFWQ)
      CALL SGET_HOST_DATA_RDWR (PDIFWS, YD_PDIFWS)
      CALL SGET_HOST_DATA_RDWR (PDQSTS, YD_PDQSTS)
      CALL SGET_HOST_DATA_RDWR (PDSA_CPS, YD_PDSA_CPS)
      CALL SGET_HOST_DATA_RDWR (PDSA_LHS, YD_PDSA_LHS)
      CALL SGET_HOST_DATA_RDWR (PFLU_CD, YD_PFLU_CD)
      CALL SGET_HOST_DATA_RDWR (PFLU_CDN, YD_PFLU_CDN)
      CALL SGET_HOST_DATA_RDWR (PFLU_EMIS, YD_PFLU_EMIS)
      CALL SGET_HOST_DATA_RDWR (PFLU_FEVI, YD_PFLU_FEVI)
      CALL SGET_HOST_DATA_RDWR (PFLU_NEIJ, YD_PFLU_NEIJ)
      CALL SGET_HOST_DATA_RDWR (PFLU_QSATS, YD_PFLU_QSATS)
      CALL SGET_HOST_DATA_RDWR (PFLU_VEG, YD_PFLU_VEG)
      CALL SGET_HOST_DATA_RDWR (PHQ, YD_PHQ)
      CALL SGET_HOST_DATA_RDWR (PHTR, YD_PHTR)
      CALL SGET_HOST_DATA_RDWR (PHU, YD_PHU)
      CALL SGET_HOST_DATA_RDWR (PLVT, YD_PLVT)
      ...
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, YDMF_PHYS_SURF%GSD_VF%F_Z0F)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VH_PQSH, YDMF_PHYS_SURF%GSD_VH%F_QSH)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VH_PSPSH, YDMF_PHYS_SURF%GSD_VH%F_SPSH)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VV_PHV, YDMF_PHYS_SURF%GSD_VV%F_HV)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
    ...
    CALL SGET_DEVICE_DATA_RDONLY (PCDROV, YD_PCDROV)
    CALL SGET_DEVICE_DATA_RDONLY (PCEROV, YD_PCEROV)
    CALL SGET_DEVICE_DATA_RDONLY (PCFAU, YD_PCFAU)
    CALL SGET_DEVICE_DATA_RDWR (PCFBU, YD_PCFBU)
    CALL SGET_DEVICE_DATA_RDWR (PCFBV, YD_PCFBV)
    CALL SGET_DEVICE_DATA_RDONLY (PCHROV, YD_PCHROV)
    ...
    CALL SGET_DEVICE_DATA_RDONLY (PDQSTS, YD_PDQSTS)
    CALL SGET_DEVICE_DATA_RDONLY (PDSA_CPS, YD_PDSA_CPS)
    CALL SGET_DEVICE_DATA_RDWR (PDSA_LHS, YD_PDSA_LHS)
    CALL SGET_DEVICE_DATA_RDONLY (PFLU_CD, YD_PFLU_CD)
    CALL SGET_DEVICE_DATA_RDONLY (PFLU_CDN, YD_PFLU_CDN)
    CALL SGET_DEVICE_DATA_RDONLY (PFLU_EMIS, YD_PFLU_EMIS)
    CALL SGET_DEVICE_DATA_RDWR (PFLU_FEVI, YD_PFLU_FEVI)
    CALL SGET_DEVICE_DATA_RDONLY (PFLU_NEIJ, YD_PFLU_NEIJ)
    CALL SGET_DEVICE_DATA_RDONLY (PFLU_QSATS, YD_PFLU_QSATS)
    CALL SGET_DEVICE_DATA_RDONLY (PFLU_VEG, YD_PFLU_VEG)
    CALL SGET_DEVICE_DATA_RDONLY (PHQ, YD_PHQ)
    CALL SGET_DEVICE_DATA_RDONLY (PHTR, YD_PHTR)
    CALL SGET_DEVICE_DATA_RDONLY (PHU, YD_PHU)
    CALL SGET_DEVICE_DATA_RDWR (PLVT, YD_PLVT)
    CALL SGET_DEVICE_DATA_RDONLY (PNEBCH, YD_PNEBCH)
    CALL SGET_DEVICE_DATA_RDWR (PNEBDIFF, YD_PNEBDIFF)
    CALL SGET_DEVICE_DATA_RDONLY (PNEBS, YD_PNEBS)
    CALL SGET_DEVICE_DATA_RDONLY (PQI, YD_PQI)
    ...
    CALL SGET_DEVICE_DATA_RDONLY (PXDROV, YD_PXDROV)
    CALL SGET_DEVICE_DATA_RDONLY (PXHROV, YD_PXHROV)
    CALL SGET_DEVICE_DATA_RDONLY (PXQRO, YD_PXQRO)
    CALL SGET_DEVICE_DATA_RDONLY (PXTRO, YD_PXTRO)
    CALL SGET_DEVICE_DATA_RDONLY (PXURO, YD_PXURO)
    CALL SGET_DEVICE_DATA_RDONLY (ZCFAS, YL_ZCFAS)
    CALL SGET_DEVICE_DATA_RDWR (ZCFBQ, YL_ZCFBQ)
    CALL SGET_DEVICE_DATA_RDWR (ZCFBQ_G, YL_ZCFBQ_G)
    CALL SGET_DEVICE_DATA_RDWR (ZCFBS, YL_ZCFBS)
    CALL SGET_DEVICE_DATA_RDWR (ZCFBS_G, YL_ZCFBS_G)
    CALL SGET_DEVICE_DATA_RDWR (ZCFBU_G, YL_ZCFBU_G)
    CALL SGET_DEVICE_DATA_RDWR (ZCFBV_G, YL_ZCFBV_G)
    CALL SGET_DEVICE_DATA_RDONLY (ZDSE, YL_ZDSE)
    CALL SGET_DEVICE_DATA_RDWR (ZFMDU, YL_ZFMDU)
    CALL SGET_DEVICE_DATA_RDWR (ZFMDV, YL_ZFMDV)
    ...
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_SB_T, YDMF_PHYS_BASE_STATE%YGSP_SB%F_T)
    ...
    CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, YDMF_PHYS_SURF%GSD_VF%F_Z0F)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VH_PQSH, YDMF_PHYS_SURF%GSD_VH%F_QSH)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VH_PSPSH, YDMF_PHYS_SURF%GSD_VH%F_SPSH)
    ...
    CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, YDMF_PHYS_SURF%GSD_VV%F_Z0H)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:LMSE_F:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:LMSE_F:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:PALPHA1, PCDROV, PCEROV, PCFAU, PCFBU, PCFBV, PCHROV, PCOEFA, PCP, PDIFWQ,  & 
    !$OMP &          PDIFWS, PDQSTS, PDSA_CPS, PDSA_LHS, PFLU_CD, PFLU_CDN, PFLU_EMIS,  & 
    !$OMP &          PFLU_FEVI, PFLU_NEIJ, PFLU_QSATS, PFLU_VEG, PHQ, PHTR, PHU, PLVT, PNEBCH,  & 
    !$OMP &          PNEBDIFF, PNEBS, PQI, PQICE, PQL, PQV, PSC_FCLL, PSC_FCLN, PSC_FEVI,  & 
    !$OMP &          PSC_FEVN, PXDROV, PXHROV, PXQRO, PXTRO, PXURO, YDCPG_OPTS, YDMODEL,  & 
    !$OMP &          YFXTRAN_ACDC_STACK, ZCFAS, ZCFBQ, ZCFBQ_G, ZCFBS, ZCFBS_G, ZCFBU_G,  & 
    !$OMP &          ZCFBV_G, ZDSE, ZFMDU, ZFMDV, Z_YDCPG_MISC_NEB, Z_YDCPG_MISC_QS,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_V,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YGSP_SB_T, Z_YDMF_PHYS_OUT_CT, Z_YDMF_PHYS_OUT_DIFTQ,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_DIFTS, Z_YDMF_PHYS_OUT_FCHSP, Z_YDMF_PHYS_OUT_FCLL,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_FCLN, Z_YDMF_PHYS_OUT_FCS, Z_YDMF_PHYS_OUT_FEVL,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_FEVN, Z_YDMF_PHYS_OUT_FEVV, Z_YDMF_PHYS_OUT_FRSO,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_FRTH, Z_YDMF_PHYS_OUT_FTR, Z_YDMF_PHYS_SURF_GSD_VF_PLSM,  & 
    !$OMP &          Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, Z_YDMF_PHYS_SURF_GSD_VH_PQSH,  & 
    !$OMP &          Z_YDMF_PHYS_SURF_GSD_VH_PSPSH, Z_YDMF_PHYS_SURF_GSD_VV_PHV,  & 
    !$OMP &          Z_YDMF_PHYS_SURF_GSD_VV_PIVEG, Z_YDMF_PHYS_SURF_GSD_VV_PZ0H)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
ELSEIF (.NOT.YDCPG_OPTS%LCALLSFX) THEN
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:CALLSFX_F:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDWR (ZFEV, YL_ZFEV)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_OUT_FCS, YDMF_PHYS%OUT%F_FCS)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:CALLSFX_F:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:CALLSFX_F:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YFXTRAN_ACDC_STACK, ZFEV, Z_YDMF_PHYS_OUT_FCS)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SURFACE_PARALLEL:ACDIFV2')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (PALPHA1, YD_PALPHA1)
  CALL SGET_HOST_DATA_RDONLY (PCFAU, YD_PCFAU)
  CALL SGET_HOST_DATA_RDONLY (PCFBU, YD_PCFBU)
  CALL SGET_HOST_DATA_RDONLY (PCFBV, YD_PCFBV)
  CALL SGET_HOST_DATA_RDONLY (PCOEFA, YD_PCOEFA)
  CALL SGET_HOST_DATA_RDWR (PDIFEXT, YD_PDIFEXT)
  CALL SGET_HOST_DATA_RDONLY (PKQLROV, YD_PKQLROV)
  CALL SGET_HOST_DATA_RDONLY (PKQROV, YD_PKQROV)
  CALL SGET_HOST_DATA_RDONLY (PKTROV, YD_PKTROV)
  CALL SGET_HOST_DATA_RDONLY (PKUROV, YD_PKUROV)
  CALL SGET_HOST_DATA_RDONLY (PLVT, YD_PLVT)
  CALL SGET_HOST_DATA_RDONLY (PPOID, YD_PPOID)
  CALL SGET_HOST_DATA_RDONLY (PQI, YD_PQI)
  CALL SGET_HOST_DATA_RDONLY (PQICE, YD_PQICE)
  CALL SGET_HOST_DATA_RDONLY (PQL, YD_PQL)
  CALL SGET_HOST_DATA_RDONLY (PTSN, YD_PTSN)
  CALL SGET_HOST_DATA_RDONLY (PXHROV, YD_PXHROV)
  CALL SGET_HOST_DATA_RDONLY (ZCFAQ, YL_ZCFAQ)
  CALL SGET_HOST_DATA_RDONLY (ZCFAS, YL_ZCFAS)
  CALL SGET_HOST_DATA_RDONLY (ZCFASV, YL_ZCFASV)
  CALL SGET_HOST_DATA_RDONLY (ZCFBQ, YL_ZCFBQ)
  CALL SGET_HOST_DATA_RDONLY (ZCFBS, YL_ZCFBS)
  CALL SGET_HOST_DATA_RDONLY (ZCFBSV, YL_ZCFBSV)
  CALL SGET_HOST_DATA_RDONLY (ZDSE, YL_ZDSE)
  CALL SGET_HOST_DATA_RDONLY (ZFEV, YL_ZFEV)
  CALL SGET_HOST_DATA_RDONLY (ZFMDU, YL_ZFMDU)
  CALL SGET_HOST_DATA_RDONLY (ZFMDV, YL_ZFMDV)
  CALL SGET_HOST_DATA_RDONLY (ZQT, YL_ZQT)
  CALL SGET_HOST_DATA_RDONLY (ZSFSV, YL_ZSFSV)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%F_U)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_V, YDMF_PHYS_BASE_STATE%F_V)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD&
  ...
  CALL SGET_HOST_DATA_RDWR (Z_YDVARS_SHTUR_T0, YDVARS%SHTUR%FT0)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:ACDIFV2:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (PALPHA1, YD_PALPHA1)
  CALL SGET_DEVICE_DATA_RDONLY (PCFAU, YD_PCFAU)
  CALL SGET_DEVICE_DATA_RDONLY (PCFBU, YD_PCFBU)
  CALL SGET_DEVICE_DATA_RDONLY (PCFBV, YD_PCFBV)
  CALL SGET_DEVICE_DATA_RDONLY (PCOEFA, YD_PCOEFA)
  CALL SGET_DEVICE_DATA_RDWR (PDIFEXT, YD_PDIFEXT)
  CALL SGET_DEVICE_DATA_RDONLY (PKQLROV, YD_PKQLROV)
  CALL SGET_DEVICE_DATA_RDONLY (PKQROV, YD_PKQROV)
  CALL SGET_DEVICE_DATA_RDONLY (PKTROV, YD_PKTROV)
  CALL SGET_DEVICE_DATA_RDONLY (PKUROV, YD_PKUROV)
  CALL SGET_DEVICE_DATA_RDONLY (PLVT, YD_PLVT)
  CALL SGET_DEVICE_DATA_RDONLY (PPOID, YD_PPOID)
  CALL SGET_DEVICE_DATA_RDONLY (PQI, YD_PQI)
  CALL SGET_DEVICE_DATA_RDONLY (PQICE, YD_PQICE)
  CALL SGET_DEVICE_DATA_RDONLY (PQL, YD_PQL)
  CALL SGET_DEVICE_DATA_RDONLY (PTSN, YD_PTSN)
  CALL SGET_DEVICE_DATA_RDONLY (PXHROV, YD_PXHROV)
  CALL SGET_DEVICE_DATA_RDONLY (ZCFAQ, YL_ZCFAQ)
  CALL SGET_DEVICE_DATA_RDONLY (ZCFAS, YL_ZCFAS)
  CALL SGET_DEVICE_DATA_RDONLY (ZCFASV, YL_ZCFASV)
  CALL SGET_DEVICE_DATA_RDONLY (ZCFBQ, YL_ZCFBQ)
  CALL SGET_DEVICE_DATA_RDONLY (ZCFBS, YL_ZCFBS)
  CALL SGET_DEVICE_DATA_RDONLY (ZCFBSV, YL_ZCFBSV)
  CALL SGET_DEVICE_DATA_RDONLY (ZDSE, YL_ZDSE)
  CALL SGET_DEVICE_DATA_RDONLY (ZFEV, YL_ZFEV)
  CALL SGET_DEVICE_DATA_RDONLY (ZFMDU, YL_ZFMDU)
  CALL SGET_DEVICE_DATA_RDONLY (ZFMDV, YL_ZFMDV)
  CALL SGET_DEVICE_DATA_RDONLY (ZQT, YL_ZQT)
  CALL SGET_DEVICE_DATA_RDONLY (ZSFSV, YL_ZSFSV)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%F_U)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_V, YDMF_PHYS_BASE_STATE%F_V)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD&
  ...
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SHTUR_T0, YDVARS%SHTUR%FT0)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:ACDIFV2:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:ACDIFV2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:PALPHA1, PCFAU, PCFBU, PCFBV, PCOEFA, PDIFEXT, PKQLROV, PKQROV, PKTROV,  & 
  !$OMP &          PKUROV, PLVT, PPOID, PQI, PQICE, PQL, PTSN, PXHROV, YDCPG_OPTS, YDMODEL,  & 
  !$OMP &          YFXTRAN_ACDC_STACK, ZCFAQ, ZCFAS, ZCFASV, ZCFBQ, ZCFBS, ZCFBSV, ZDSE,  & 
  !$OMP &          ZFEV, ZFMDU, ZFMDV, ZQT, ZSFSV, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_U,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP, Z_YDMF_PHYS_OUT_DIFCQ,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_DIFCS, Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_DIFTQL,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_DIFTQN, Z_YDMF_PHYS_OUT_DIFTS, Z_YDMF_PHYS_OUT_FCS,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_STRCU, Z_YDMF_PHYS_OUT_STRCV, Z_YDMF_PHYS_OUT_STRTU,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_STRTV, Z_YDVARS_SHTUR_T0)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (YDMODEL%YRML_PHY_MF%YRPHY%LEDKF) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SURFACE_PARALLEL:LEDKF')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_SFL_PGROUP, YDMF_PHYS_SURF%GSD_SFL%F_GROUP)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
    ...
    CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_SFL_PGROUP, YDMF_PHYS_SURF%GSD_SFL%F_GROUP)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:LEDKF:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:LEDKF:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YFXTRAN_ACDC_STACK, Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_DIFTS,  & 
    !$OMP &          Z_YDMF_PHYS_SURF_GSD_SFL_PGROUP)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SURFACE_PARALLEL:LMSE_F2')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (PTSN, YD_PTSN)
    CALL SGET_HOST_DATA_RDONLY (ZTWSNOW, YL_ZTWSNOW)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:LMSE_F2:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDONLY (PTSN, YD_PTSN)
    CALL SGET_DEVICE_DATA_RDONLY (ZTWSNOW, YL_ZTWSNOW)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GPAR_VTS, YDCPG_GPAR%F_VTS)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_SURF_GSP_SG_PF_T1, YDMF_PHYS_SURF%GSP_SG%F_F_T1)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:LMSE_F2:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:LMSE_F2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:PTSN, YDCPG_OPTS, YFXTRAN_ACDC_STACK, ZTWSNOW, Z_YDCPG_GPAR_VTS,  & 
    !$OMP &          Z_YDMF_PHYS_SURF_GSP_SG_PF_T1)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
