...
CONTAINS
PROCEDURE :: COPY => COPY_TCFU_KEYS
PROCEDURE :: HOST => HOST_TCFU_KEYS
PROCEDURE :: SIZE => SIZE_TCFU_KEYS
PROCEDURE :: WIPE => WIPE_TCFU_KEYS
END TYPE TCFU_KEYS
...
PROCEDURE :: COPY => COPY_TCFU
PROCEDURE :: HOST => HOST_TCFU
PROCEDURE :: SIZE => SIZE_TCFU
PROCEDURE :: WIPE => WIPE_TCFU
END TYPE TCFU

INTERFACE

MODULE SUBROUTINE COPY_TCFU_KEYS (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TCFU_KEYS (SELF)

IMPLICIT NONE
CLASS (TCFU_KEYS), TARGET :: SELF
END SUBROUTINE

MODULE FUNCTION SIZE_TCFU_KEYS (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TCFU_KEYS (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TCFU (SELF)
USE FIELD_UTIL_MODULE
