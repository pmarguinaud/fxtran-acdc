...
!$ACDC methods 
  ...
  PROCEDURE :: COPY => COPY_SPP_PERT_POINTER
PROCEDURE :: CRC64 => CRC64_SPP_PERT_POINTER
PROCEDURE :: HOST => HOST_SPP_PERT_POINTER
PROCEDURE :: LOAD => LOAD_SPP_PERT_POINTER
PROCEDURE :: SAVE => SAVE_SPP_PERT_POINTER
PROCEDURE :: SIZE => SIZE_SPP_PERT_POINTER
PROCEDURE :: WIPE => WIPE_SPP_PERT_POINTER
end type spp_pert_pointer


INTERFACE

MODULE SUBROUTINE COPY_SPP_PERT_POINTER (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_SPP_PERT_POINTER (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_SPP_PERT_POINTER (SELF)

IMPLICIT NONE
CLASS (SPP_PERT_POINTER), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_SPP_PERT_POINTER (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_SPP_PERT_POINTER (SELF, KLUN)
...
MODULE FUNCTION SIZE_SPP_PERT_POINTER (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_SPP_PERT_POINTER (SELF, LDDELETED, LDFIELDAPI)
