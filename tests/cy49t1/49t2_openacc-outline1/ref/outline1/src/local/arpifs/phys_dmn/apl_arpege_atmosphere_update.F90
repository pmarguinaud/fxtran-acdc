...
CALL APL_ARPEGE_ATMOSPHERE_UPDATE_CPTEND_NEW (YDVARS, YDCPG_OPTS, YDDDH, YDMF_PHYS_NEXT_STATE&
&, YDGEOMETRY, YDCPG_DYN0, YDMF_PHYS, YDMF_PHYS_BASE_STATE, YDMODEL, YDCPG_BNDS, PPFL_FEFB1&
&, PPFL_FTKE, PMSC_FRMQ, PPFL_FEFB2, ZTENDI, PDIFEXT, ZTENDR, PDSA_CPS, ZTENDSCONV, ZTENDLCONV&
&, PFCHQ, ZTENDEFB2, ZTENDD, ZTENDEFB1, ZTENDU, ZTENDV, ZTENDICONV, ZTENDH, PPFL_FEFB3, PPFL_FTKEI&
&, ZTENDL, ZTENDEFB3, ZTENDTKE, ZTENDQ, ZTENDG, ZTENDRCONV, ZTENDS)
