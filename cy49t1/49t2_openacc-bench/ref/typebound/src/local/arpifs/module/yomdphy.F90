...
PROCEDURE :: COPY => COPY_TDPHY
PROCEDURE :: CRC64 => CRC64_TDPHY
PROCEDURE :: HOST => HOST_TDPHY
PROCEDURE :: LOAD => LOAD_TDPHY
PROCEDURE :: SAVE => SAVE_TDPHY
PROCEDURE :: SIZE => SIZE_TDPHY
PROCEDURE :: WIPE => WIPE_TDPHY
END TYPE TDPHY
!     --------------------------------------------------------------------------------
...
MODULE SUBROUTINE COPY_TDPHY (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TDPHY (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TDPHY (SELF)

IMPLICIT NONE
CLASS (TDPHY), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TDPHY (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TDPHY (SELF, KLUN)
...
MODULE FUNCTION SIZE_TDPHY (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TDPHY (SELF, LDDELETED, LDFIELDAPI)
