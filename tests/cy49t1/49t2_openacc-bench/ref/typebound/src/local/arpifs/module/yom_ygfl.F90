...
INTEGER(KIND=JPIM) :: MPPC_PH   = -99999999 ! Predictor/corrector auxiliary array "pointer" for physics
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TYPE_GFL_COMP
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TYPE_GFL_COMP
PROCEDURE :: ACDC_HOST => ACDC_HOST_TYPE_GFL_COMP
PROCEDURE :: ACDC_LEGACY => ACDC_LEGACY_TYPE_GFL_COMP
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TYPE_GFL_COMP
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TYPE_GFL_COMP
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TYPE_GFL_COMP
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TYPE_GFL_COMP
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TYPE_GFL_NAML
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TYPE_GFL_NAML
PROCEDURE :: ACDC_HOST => ACDC_HOST_TYPE_GFL_NAML
PROCEDURE :: ACDC_LEGACY => ACDC_LEGACY_TYPE_GFL_NAML
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TYPE_GFL_NAML
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TYPE_GFL_NAML
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TYPE_GFL_NAML
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TYPE_GFL_NAML
...
TYPE(TYPE_GFL_COMP),POINTER  :: YLMF        => NULL() ! QL from mass flux
TYPE(TYPE_GFL_COMP),POINTER  :: YIMF        => NULL() ! QI from mass flux
TYPE(TYPE_GFL_COMP),POINTER  :: YAMF        => NULL() ! CF from mass flux
...
TYPE(TYPE_GFL_NAML)  :: YAMF_NL               ! Cloud fraction from mass flux
TYPE(TYPE_GFL_NAML)  :: YLMF_NL               ! Cloud from mass flux
TYPE(TYPE_GFL_NAML)  :: YIMF_NL               ! ice from mass flux
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TYPE_GFLD
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TYPE_GFLD
PROCEDURE :: ACDC_HOST => ACDC_HOST_TYPE_GFLD
PROCEDURE :: ACDC_LEGACY => ACDC_LEGACY_TYPE_GFLD
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TYPE_GFLD
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TYPE_GFLD
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TYPE_GFLD
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TYPE_GFLD
END TYPE TYPE_GFLD
...
MODULE SUBROUTINE ACDC_COPY_TYPE_GFL_NAML (SELF, LDCREATED, LDFIELDAPI)
