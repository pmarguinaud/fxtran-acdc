...
!-------------------------------------------------------------------------------
  ...
  IF (YDPHY%LRNUMX) THEN
    PFMC(JLON,KTDIA-1)=PA5C(JLON,KTDIA)*(ZAL2&
     & *PFDC(JLON,KTDIA-1))+PFMC(JLON,KTDIA-1)
    PFDC(JLON,KTDIA)=PA4C(JLON,KTDIA)*(ZAL2&
     & *PFDC(JLON,KTDIA-1))+PFDC(JLON,KTDIA)
    PFMN(JLON,KTDIA-1)=PA5N(JLON,KTDIA)*(ZBE2&
     & *PFDC(JLON,KTDIA-1))+PFMN(JLON,KTDIA-1)
    PFDN(JLON,KTDIA)=PA4N(JLON,KTDIA)*(ZBE2&
...
DO JLEV=KTDIA+1,KLEV
    ...
    IF (YDPHY%LRNUMX) THEN
      ...
      ZTD3=1._JPRB/(1._JPRB-PA5N(JLON,JLEV)*(ZBE2*ZTU7(JLON,JLEV-1)&
       & +ZDE2*ZTU9(JLON,JLEV-1))-ZTD2*ZTU1(JLON,JLEV))
      ...
      ZTU4(JLON,JLEV)=ZTD3*(PA4N(JLON,JLEV)*ZBE1&
       & +ZTD2*ZTU2(JLON,JLEV))
      ZTU5(JLON,JLEV)=ZTD3*(PA4N(JLON,JLEV)*ZDE1&
       & +ZTD2*ZTU3(JLON,JLEV))
