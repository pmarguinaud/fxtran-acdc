...
CALL APL_ARPEGE_CPPHINP (YDVARS, YDCPG_DYN0, YDCPG_OPTS, YDCPG_PHY0, YDMODEL, YDGEOMETRY, YDCPG_BNDS&
&, ZRDG_CVGQ, ZRDG_SOLO, ZRDG_CVGT, ZRDG_MU0LU, ZRDG_MU0N, ZRDG_MU0M, ZRDG_MU0)
CALL APL_ARPEGE_ZRDG_LCVQ (YDCPG_OPTS, YDMODEL, YDCPG_BNDS, ZRDG_LCVQ, ZRDG_CVGQ, ZQCO2, ZFLU_QSATS)
...
CALL APL_ARPEGE_APLPAR_INIT (YDCPG_OPTS, YDMF_PHYS_SURF, YDMODEL, YDCPG_BNDS, ZFLU_CDN, ZFLU_QSAT&
&, ZFLU_QSATS, ZFLU_CD, ZDSA_RS, ZFLU_EMIS, ZPFL_FTKEI, ZPFL_FEFB3, ZPFL_FEFB2, ZMSC_TW,&
& ZFLU_NEIJ, ZPFL_FEFB1, ZFLU_VEG, ZMSC_LSCPE, ZFLU_CH, ZDSA_CPS, ZMSC_FRMQ, ZFCHQ, ZMSC_QW&
&, ZFLU_FEVI, ZDSA_LHS, ZDSA_C2, ZPFL_FTKE, ZDSA_C1, IMOC_CLPH, ZMSC_LH)
CALL APL_ARPEGE_PLSM (YDMF_PHYS_SURF, YDCPG_BNDS)

IF (YDMODEL%YRML_PHY_MF%YRPHY%LGCHECKMV) THEN
  CALL APL_ARPEGE_CHECKMV (YDVARS, YDMF_PHYS_SURF, YDMF_PHYS_BASE_STATE&
  &, YDCPG_OPTS, YDMODEL, YDCPG_BNDS, ZRDG_MU0)
ENDIF
...
CALL APL_ARPEGE_ACTQSAT (YDCPG_MISC, YDCPG_OPTS, YDMF_PHYS_BASE_STATE, YDMODEL&
&, YDCPG_BNDS, ZFLU_QSAT, ZMSC_QW, ZQV, ZMSC_TW, ZMSC_LSCPE, ZMSC_LH)

IF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  CALL APL_ARPEGE_ACSOL (LLHMT, YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_SURF, YDMF_PHYS_BASE_STATE, YDMODEL&
  &, YDCPG_BNDS, ZC3, ZNEIJG, ZWWILT, ZWSEQ, ZWSMX, ZWPMX, ZCN, ZDSA_C2, ZNEIJV, ZDSA_C1, ZWFC)
ENDIF
...
CALL APL_ARPEGE_ZDPHIV (YDCPG_OPTS, YDMODEL, YDCPG_BNDS, ZDPHIV, ZDPHIT)
LLCLS=.TRUE.
LLHMT=.TRUE.

IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  CALL APL_ARPEGE_ACHMTLS (LLCLS, YDCPG_MISC, YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_BASE_STATE, ZRVMD, YDMODEL&
  &, YDCPG_BNDS, ZFLU_CDN, ZRTI, ZMRIPP, ZFLU_CD, ZDSA_LHS, ZDPHIT, ZNBVNO, ZGWDCS, ZPCLS, ZDSA_CPS)
ELSE
  CALL APL_ARPEGE_ACHMT (LLCLS, LLHMT, YDCPG_OPTS, YDCPG_MISC, YDMF_PHYS, YDMF_PHYS_SURF, YDMF_PHYS_BASE_STATE&
  &, YDMODEL, YDCPG_BNDS, ZFLU_CDN, ZNEIJG, ZXDROV, ZFLU_QSATS, ZDQSTS, ZFLU_CD, ZDSA_RS, ZCHROV&
  &, ZNEIJV, ZPFL_FPLCH, ZQV, ZDPHIV, ZFLU_NEIJ, ZNBVNO, ZFLU_VEG, ZFLU_CH, ZHQ, ZDSA_CPS, ZRTI&
  &, ZMRIPP, ZHU, ZPFL_FPLSH, ZDPHIT, ZXHROV, ZWFC, ZCDROV, ZGWDCS, ZPCLS)
ENDIF

CALL APL_ARPEGE_ACCLPH (YDCPG_MISC, YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_BASE_STATE&
&, YDMODEL, YDCPG_BNDS, ZCP, ZBLH, ZQV, IMOC_CLPH)
...
CALL APL_ARPEGE_DIFTQ (YDCPG_OPTS, YDMF_PHYS, YDMODEL, YDCPG_BNDS, ZDIFCVPPS&
&, ZEDMFS, ZEDMFQ, ZEDMFV, ZDIFCVPPU, ZDIFCVPPV, ZDIFCVPPQ, ZEDMFU)
CALL APL_ARPEGE_FRSOPT (YDMF_PHYS_BASE_STATE, YDCPG_OPTS,&
& YDMF_PHYS, YDMODEL, YDCPG_BNDS, ZFLU_EMIS, ZRDG_MU0)
CALL APL_ARPEGE_ACDRAG (YDVARS, YDCPG_MISC, YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_SURF&
&, YDMF_PHYS_BASE_STATE, YDMODEL, YDCPG_BNDS, ZNEBS, ZMSC_QW, ZDQSTS, ZCHROV&
&, ZFLU_EMIS, ZQLIS, ZQV, ZNBVNO, ZFLU_NEIJ, ZGWDCS)
...
IF (YDMODEL%YRML_PHY_MF%YRPHY%LECTPRODCVP) THEN
  CALL APL_ARPEGE_TURBULENCE_PART2 (YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_BASE_STATE, YDMODEL&
  &, YDCPG_BNDS, ZTKE1, ZUSLE, ZPFL_FTKE, ZECTCLS, ZKCLS, ZPRODTH, ZKUROV2)
ENDIF
...
CALL APL_ARPEGE_QNGCOR (YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_BASE_STATE, YDMODEL, YDCPG_BNDS&
&, ZFPLSL, ZQL, ZPFL_FPLSH, ZQI, ZFPLSN, ZPFL_FPLCH, ZQV, ZFPCOR, ZSEDIQI, ZSEDIQL)
...
CALL APL_ARPEGE_ACDRME (YDVARS, YDCPG_MISC, YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_BASE_STATE&
&, YDMODEL, YDGEOMETRY, YDCPG_BNDS, ZQV, ZMSC_FRMQ)
...
IF (YDMODEL%YRML_PHY_MF%YRPHY2%LRAFTKE) THEN
  CALL APL_ARPEGE_ACEVADCAPE (YDVARS, YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_BASE_STATE&
  &, YDMODEL, YDCPG_BNDS, ZTKE1, ZBLH, ZDCAPE, IMOC_CLPH)
ENDIF

CALL APL_ARPEGE_ACVISIH (YDCPG_MISC, YDCPG_OPTS, YDMF_PHYS, ZEPSNEB&
&, YDMF_PHYS_BASE_STATE, YDMODEL, YDCPG_BNDS, ZQR, ZQS)
CALL APL_ARPEGE_ZBAY_QRCONV (YDCPG_OPTS, YDMF_PHYS, YDMODEL, YDCPG_BNDS, ZBAY_QRCONV, ZBAY_QSCONV)
CALL APL_ARPEGE_ZDE2MR (YDMF_PHYS_BASE_STATE, YDCPG_OPTS&
&, YDMODEL, YDCPG_BNDS, ZBAY_QRCONV, ZBAY_QSCONV)
CALL APL_ARPEGE_PPWETPOINT (YDMF_PHYS_BASE_STATE, YDCPG_OPTS, YDMF_PHYS, YDMODEL, YDCPG_BNDS, ZPCLS)
...
IF (YDCPG_OPTS%LCORWAT) THEN
  CALL APL_ARPEGE_OUTLINE_022 (YDMF_PHYS_SURF, YDCPG_OPTS, YDMF_PHYS, YDCPG_BNDS)
ENDIF


IF (YDMODEL%YRML_PHY_MF%YRPHY%NDPSFI==1) THEN
  CALL APL_ARPEGE_OUTLINE_023 (YDCPG_MISC, YDCPG_OPTS, YDCPG_PHY0,&
  & YDMF_PHYS_SURF, YDMODEL, YDGEOMETRY, YDCPG_BNDS, ZFLU_QSATS)
ENDIF
...
IF (YDMODEL%YRML_PHY_MF%YRPHY%LCVPGY) THEN
  CALL APL_ARPEGE_OUTLINE_024 (YDVARS, YDCPG_OPTS, YDCPG_BNDS)
ENDIF
...
CALL APL_ARPEGE_BAYRAD (YDVARS, YDCPG_OPTS, YDMODEL, YDCPG_BNDS, ZBAY_QRCONV, ZBAY_QSCONV)

IF (YDMODEL%YRML_PHY_EC%YREPHY%LEMWAVE) THEN
  CALL APL_ARPEGE_MWAVE (YDCPG_MISC, YDMF_PHYS, YDCPG_BNDS, YDCPG_OPTS, YDPHYSMWAVE)
ENDIF

CALL APL_ARPEGE_EDR (YDMF_PHYS_SURF, YDCPG_OPTS, YDMF_PHYS, YDMODEL)
CALL APL_ARPEGE_PRECIPS (YDMF_PHYS_SURF, YDCPG_OPTS, YDMODEL&
&, YDCPG_BNDS, ZPRC_DPRECIPS2, ZPRC_DPRECIPS)
