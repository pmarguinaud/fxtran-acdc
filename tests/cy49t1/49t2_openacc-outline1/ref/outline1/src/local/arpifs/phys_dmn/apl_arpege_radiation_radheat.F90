SUBROUTINE APL_ARPEGE_RADIATION_RADHEAT (YDVARS, YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_BASE_STATE&
&, YDMODEL, YDCPG_BNDS, PTRSODIR, PTRSODIF, PTENT, PQV, PTRSOD, PFRSODS, PCTRSO, PSUDU&
