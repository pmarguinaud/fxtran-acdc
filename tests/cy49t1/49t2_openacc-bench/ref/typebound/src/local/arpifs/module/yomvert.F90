...
CONTAINS
PROCEDURE :: COPY => COPY_TVAB
PROCEDURE :: CRC64 => CRC64_TVAB
PROCEDURE :: HOST => HOST_TVAB
PROCEDURE :: LOAD => LOAD_TVAB
PROCEDURE :: SAVE => SAVE_TVAB
PROCEDURE :: SIZE => SIZE_TVAB
PROCEDURE :: WIPE => WIPE_TVAB
END TYPE TVAB
...
CONTAINS
PROCEDURE :: COPY => COPY_TVETA
PROCEDURE :: CRC64 => CRC64_TVETA
PROCEDURE :: HOST => HOST_TVETA
PROCEDURE :: LOAD => LOAD_TVETA
PROCEDURE :: SAVE => SAVE_TVETA
PROCEDURE :: SIZE => SIZE_TVETA
PROCEDURE :: WIPE => WIPE_TVETA
END TYPE TVETA
...
CONTAINS
PROCEDURE :: COPY => COPY_TVFE
PROCEDURE :: CRC64 => CRC64_TVFE
PROCEDURE :: HOST => HOST_TVFE
PROCEDURE :: LOAD => LOAD_TVFE
PROCEDURE :: SAVE => SAVE_TVFE
PROCEDURE :: SIZE => SIZE_TVFE
PROCEDURE :: WIPE => WIPE_TVFE
END TYPE TVFE
...
TYPE TVERTICAL_GEOM
  ...
  TYPE(TCVER) :: YRCVER
CONTAINS
PROCEDURE :: COPY => COPY_TVERTICAL_GEOM
PROCEDURE :: CRC64 => CRC64_TVERTICAL_GEOM
PROCEDURE :: HOST => HOST_TVERTICAL_GEOM
PROCEDURE :: LOAD => LOAD_TVERTICAL_GEOM
PROCEDURE :: SAVE => SAVE_TVERTICAL_GEOM
PROCEDURE :: SIZE => SIZE_TVERTICAL_GEOM
PROCEDURE :: WIPE => WIPE_TVERTICAL_GEOM
END TYPE TVERTICAL_GEOM

INTERFACE

MODULE SUBROUTINE COPY_TVAB (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TVAB (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TVAB (SELF)

IMPLICIT NONE
CLASS (TVAB), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TVAB (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TVAB (SELF, KLUN)
...
MODULE FUNCTION SIZE_TVAB (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TVAB (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TVETA (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TVETA (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_TVETA (SELF)

IMPLICIT NONE
CLASS (TVETA), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TVETA (SELF, KLUN)
USE PARKIND1, ONLY : JPRD
...
MODULE SUBROUTINE SAVE_TVETA (SELF, KLUN)
...
MODULE FUNCTION SIZE_TVETA (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TVETA (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TVFE (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TVFE (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_TVFE (SELF)

IMPLICIT NONE
CLASS (TVFE), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TVFE (SELF, KLUN)
USE PARKIND1, ONLY : JPRD
...
MODULE SUBROUTINE SAVE_TVFE (SELF, KLUN)
...
MODULE FUNCTION SIZE_TVFE (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TVFE (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TVERTICAL_GEOM (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE WIPE_TVERTICAL_GEOM (SELF, LDDELETED, LDFIELDAPI)
