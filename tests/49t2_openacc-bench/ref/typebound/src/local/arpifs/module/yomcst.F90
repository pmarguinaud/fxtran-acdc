...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TCST
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TCST
PROCEDURE :: ACDC_HOST => ACDC_HOST_TCST
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TCST
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TCST
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TCST
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TCST
END TYPE TCST
...
MODULE SUBROUTINE ACDC_COPY_TCST (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE ACDC_WIPE_TCST (SELF, LDDELETED, LDFIELDAPI)
