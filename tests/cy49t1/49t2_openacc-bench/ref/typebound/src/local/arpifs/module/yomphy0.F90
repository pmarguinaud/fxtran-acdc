...
CONTAINS
PROCEDURE :: COPY => COPY_TADVPRS
PROCEDURE :: CRC64 => CRC64_TADVPRS
PROCEDURE :: HOST => HOST_TADVPRS
PROCEDURE :: LOAD => LOAD_TADVPRS
PROCEDURE :: SAVE => SAVE_TADVPRS
PROCEDURE :: SIZE => SIZE_TADVPRS
PROCEDURE :: WIPE => WIPE_TADVPRS
END TYPE
...
CONTAINS
PROCEDURE :: COPY => COPY_TPHY0
PROCEDURE :: CRC64 => CRC64_TPHY0
PROCEDURE :: HOST => HOST_TPHY0
PROCEDURE :: LOAD => LOAD_TPHY0
PROCEDURE :: SAVE => SAVE_TPHY0
PROCEDURE :: SIZE => SIZE_TPHY0
PROCEDURE :: WIPE => WIPE_TPHY0
END TYPE TPHY0
...
MODULE SUBROUTINE COPY_TADVPRS (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TADVPRS (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TADVPRS (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TADVPRS (SELF, KLUN)
...
MODULE FUNCTION SIZE_TADVPRS (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TADVPRS (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TPHY0 (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE WIPE_TPHY0 (SELF, LDDELETED, LDFIELDAPI)
