...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_INIT_PARALLEL:0')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_INIT_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_INIT_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_INIT_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&PRESENT (PAIPCMT, PDECRD, YDCPG_OPTS, YDMODEL, YSTACK, Z_YDVARS_GEOMETRY_GEMU_T0) &
    !$ACC&PRIVATE (JBLK) &
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_INIT_PARALLEL:1')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_INIT_PARALLEL:1')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_INIT_PARALLEL:1')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_INIT_PARALLEL:1')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (PQO3, YDCPG_OPTS, YDMODEL, YSTACK, ZROZ, Z_YDCPG_MISC_KOZO, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, &
    !$ACC&         Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP, Z_YDMF_PHYS_SURF_GSD_VC_PA, &
    !$ACC&         Z_YDMF_PHYS_SURF_GSD_VC_PB, Z_YDMF_PHYS_SURF_GSD_VC_PC, &
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_INIT_PARALLEL:2')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_INIT_PARALLEL:2')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_INIT_PARALLEL:2')) THEN
  ...
  !$OMP PARALLEL DO PRIVATE (JBLK, JLEV, JLON, YLCPG_BNDS, YLSTACK, ZGDT, ZGDTI)
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_INIT_PARALLEL:2')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT_PARALLEL:2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (PPOID, PPRODTH_CVPP, YDCPG_OPTS, YDCST, YDMODEL, YSTACK, ZIPOI, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, &
    ...
    !$ACC LOOP VECTOR &
    !$ACC&PRIVATE (JLEV, JLON, YLCPG_BNDS, YLSTACK, ZGDT, ZGDTI) 
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_INIT_PARALLEL:3')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_INIT_PARALLEL:3')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_INIT_PARALLEL:3')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_INIT_PARALLEL:3')) THEN
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_INIT_PARALLEL:4')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_INIT_PARALLEL:4')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_INIT_PARALLEL:4')) THEN
  ...
  !$OMP PARALLEL DO PRIVATE (JBLK, JLEV, JLON, YLCPG_BNDS, YLSTACK, ZDQC, ZDQI, ZDQL, ZDQR, ZDQS, ZDQV, ZQV0)
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_INIT_PARALLEL:4')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT_PARALLEL:4:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (PPOID, PQI, PQL, PQR, PQS, PQV, YDCPG_OPTS, YSTACK, ZIPOI, Z_YDMF_PHYS_BASE_STATE_I, &
    !$ACC&         Z_YDMF_PHYS_BASE_STATE_L, Z_YDMF_PHYS_BASE_STATE_Q, Z_YDMF_PHYS_BASE_STATE_R, &
    !$ACC&         Z_YDMF_PHYS_BASE_STATE_S, Z_YDMF_PHYS_OUT_FCQLNG, Z_YDMF_PHYS_OUT_FCQNG, &
    ...
    !$ACC LOOP VECTOR &
    !$ACC&PRIVATE (JLEV, JLON, YLCPG_BNDS, YLSTACK, ZDQC, ZDQI, ZDQL, ZDQR, ZDQS, ZDQV, ZQV0) 
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_INIT_PARALLEL:5')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_INIT_PARALLEL:5')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_INIT_PARALLEL:5')) THEN
  ...
  !$OMP PARALLEL DO PRIVATE (JBLK, JCHA, JLEV, JLON, JSG, YLCPG_BNDS, YLSTACK)
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_INIT_PARALLEL:5')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT_PARALLEL:5:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC LOOP VECTOR &
    !$ACC&PRIVATE (JCHA, JLEV, JLON, JSG, YLCPG_BNDS, YLSTACK) 
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_INIT_PARALLEL:6')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_INIT_PARALLEL:6')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_INIT_PARALLEL:6')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_INIT_PARALLEL:6')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT_PARALLEL:6:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (PPFL_FPLCH, PPFL_FPLSH, YDCPG_OPTS, YDMODEL, YSTACK) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ENDSUBROUTINE APL_ARPEGE_INIT_PARALLEL
