...
!$ACDC PARALLEL, TARGET=OpenMP/OpenMPSingleColumn/OpenACCSingleColumn,NAME=ZTDCP {
...
!$ACDC PARALLEL, TARGET=OpenMP/OpenMPSingleColumn/OpenACCSingleColumn,NAME=ZDEC {
...
!$ACDC PARALLEL, TARGET=OpenMP/OpenMPSingleColumn/OpenACCSingleColumn,NAME=PFDIS {
...
CALL CPUTQY0 (.TRUE.,            YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%U,     PDT,     YDMF_PHYS_NEXT_STATE%U%P,     PTENDU)
CALL CPUTQY0 (.TRUE.,            YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%V,     PDT,     YDMF_PHYS_NEXT_STATE%V%P,     PTENDV)
CALL CPUTQY0 (.TRUE.,            YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%T,     1._JPRB, YDMF_PHYS_NEXT_STATE%T%P,     ZDTT1)
CALL CPUTQY0 (YDDYNA%LNHDYN,     YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%SVD,   PDT,     YDMF_PHYS_NEXT_STATE%SVD%P,   PTENDD)
CALL CPUTQY0 (YDVARS%L%LT1,      YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%L,     PDT,     YDMF_PHYS_NEXT_STATE%L%P,     PTENDL)
CALL CPUTQY0 (YDVARS%I%LT1,      YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%I,     PDT,     YDMF_PHYS_NEXT_STATE%I%P,     PTENDI)
CALL CPUTQY0 (YDVARS%S%LT1,      YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%S,     PDT,     YDMF_PHYS_NEXT_STATE%S%P,     PTENDS)
CALL CPUTQY0 (YDVARS%R%LT1,      YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%R,     PDT,     YDMF_PHYS_NEXT_STATE%R%P,     PTENDR)
CALL CPUTQY0 (YDVARS%G%LT1,      YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%G,     PDT,     YDMF_PHYS_NEXT_STATE%G%P,     PTENDG)
CALL CPUTQY0 (YDVARS%TKE%LT1,    YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%TKE,   PDT,     YDMF_PHYS_NEXT_STATE%TKE%P,   PTENDTKE)
CALL CPUTQY0 (YDVARS%EFB1%LT1,   YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%EFB1,  PDT,     YDMF_PHYS_NEXT_STATE%EFB1%P,  PTENDEFB1)
CALL CPUTQY0 (YDVARS%EFB2%LT1,   YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%EFB2,  PDT,     YDMF_PHYS_NEXT_STATE%EFB2%P,  PTENDEFB2)
CALL CPUTQY0 (YDVARS%EFB3%LT1,   YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%EFB3,  PDT,     YDMF_PHYS_NEXT_STATE%EFB3%P,  PTENDEFB3)
CALL CPUTQY0 (YDVARS%LCONV%LT1,  YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%LCONV, PDT,     YDMF_PHYS_NEXT_STATE%LCONV%P, PTENDLCONV)
CALL CPUTQY0 (YDVARS%ICONV%LT1,  YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%ICONV, PDT,     YDMF_PHYS_NEXT_STATE%ICONV%P, PTENDICONV)
CALL CPUTQY0 (YDVARS%RCONV%LT1,  YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%RCONV, PDT,     YDMF_PHYS_NEXT_STATE%RCONV%P, PTENDRCONV)
CALL CPUTQY0 (YDVARS%SCONV%LT1,  YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%SCONV, PDT,     YDMF_PHYS_NEXT_STATE%SCONV%P, PTENDSCONV)
CALL CPUTQY0 (YDVARS%Q%LT1,      YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%Q,     PDT,     YDMF_PHYS_NEXT_STATE%Q%P,     PTENDQ)
