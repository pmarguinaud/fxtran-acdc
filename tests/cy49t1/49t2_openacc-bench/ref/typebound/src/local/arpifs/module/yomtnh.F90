...
PROCEDURE :: COPY => COPY_TTNH
PROCEDURE :: CRC64 => CRC64_TTNH
PROCEDURE :: HOST => HOST_TTNH
PROCEDURE :: LOAD => LOAD_TTNH
PROCEDURE :: SAVE => SAVE_TTNH
PROCEDURE :: SIZE => SIZE_TTNH
PROCEDURE :: WIPE => WIPE_TTNH
END TYPE TTNH
...
MODULE SUBROUTINE COPY_TTNH (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TTNH (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TTNH (SELF)

IMPLICIT NONE
CLASS (TTNH), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TTNH (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TTNH (SELF, KLUN)
...
MODULE FUNCTION SIZE_TTNH (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TTNH (SELF, LDDELETED, LDFIELDAPI)
