...
TYPE TGRADIENT_PTR
  ...
  INTEGER :: NDIMGOG
CONTAINS
PROCEDURE :: COPY => COPY_TGRADIENT_PTR
PROCEDURE :: CRC64 => CRC64_TGRADIENT_PTR
PROCEDURE :: HOST => HOST_TGRADIENT_PTR
PROCEDURE :: LOAD => LOAD_TGRADIENT_PTR
PROCEDURE :: SAVE => SAVE_TGRADIENT_PTR
PROCEDURE :: SIZE => SIZE_TGRADIENT_PTR
PROCEDURE :: WIPE => WIPE_TGRADIENT_PTR
ENDTYPE
!
! ---------------------------------------------------------------------
!
...
CONTAINS
PROCEDURE :: COPY => COPY_TGRADIENT
PROCEDURE :: CRC64 => CRC64_TGRADIENT
PROCEDURE :: HOST => HOST_TGRADIENT
PROCEDURE :: LOAD => LOAD_TGRADIENT
PROCEDURE :: SAVE => SAVE_TGRADIENT
PROCEDURE :: SIZE => SIZE_TGRADIENT
PROCEDURE :: WIPE => WIPE_TGRADIENT
ENDTYPE
!   
INTERFACE

MODULE SUBROUTINE COPY_TGRADIENT_PTR (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TGRADIENT_PTR (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TGRADIENT_PTR (SELF)

IMPLICIT NONE
CLASS (TGRADIENT_PTR), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TGRADIENT_PTR (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TGRADIENT_PTR (SELF, KLUN)
...
MODULE FUNCTION SIZE_TGRADIENT_PTR (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TGRADIENT_PTR (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TGRADIENT (SELF, LDCREATED, LDFIELDAPI)
...
MODULE FUNCTION SIZE_TGRADIENT (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TGRADIENT (SELF, LDDELETED, LDFIELDAPI)
