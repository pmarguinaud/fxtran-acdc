...
PROCEDURE :: COPY => COPY_TEAERSNK
PROCEDURE :: CRC64 => CRC64_TEAERSNK
PROCEDURE :: HOST => HOST_TEAERSNK
PROCEDURE :: LOAD => LOAD_TEAERSNK
PROCEDURE :: SAVE => SAVE_TEAERSNK
PROCEDURE :: SIZE => SIZE_TEAERSNK
PROCEDURE :: WIPE => WIPE_TEAERSNK
END TYPE TEAERSNK
!=====================================================================
...
MODULE SUBROUTINE COPY_TEAERSNK (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TEAERSNK (SELF)
...
MODULE SUBROUTINE WIPE_TEAERSNK (SELF, LDDELETED, LDFIELDAPI)
