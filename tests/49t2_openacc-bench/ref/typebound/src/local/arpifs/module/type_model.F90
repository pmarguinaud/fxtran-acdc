...
!$ACDC methods  --skip-components MODEL%YRML_SPP,MODEL%YRML_SPPT
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_MODEL
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_MODEL
PROCEDURE :: ACDC_HOST => ACDC_HOST_MODEL
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_MODEL
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_MODEL
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_MODEL
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_MODEL
END TYPE MODEL
...
SUBROUTINE PRINT_MODEL_CONFIGURATION(SELF,CDSTRING,KOUTNO)
  ...
  IF (LHOOK) CALL DR_HOOK('TYPE_MODEL:PRINT_MODEL_CONFIGURATION',0,ZHOOK_HANDLE)
  ITOPDEPTH = 0
...
! CALL SELF%YRML_PHY_RAD%PRINT(ITOPDEPTH,IOUTNO) !!
  ...
  IF (LHOOK) CALL DR_HOOK('TYPE_MODEL:PRINT_MODEL_CONFIGURATION',1,ZHOOK_HANDLE)
