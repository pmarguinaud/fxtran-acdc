...
IF ((MOD (YDCPG_OPTS%NSTEP, YDMODEL%YRML_PHY_RAD%YRERAD%NRADFR)==0).OR.(YDMODEL&
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_AEROSOLS_FOR_RADIATION_PARALLEL&
    &:RADAER')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_AEROSOLS_FOR_RADIATION_PARALLEL&
    &:RADAER')) THEN
    ...
    &:RADAER:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&PRESENT (PAER, PAERINDS, YDCPG_OPTS, YDMODEL, YSTACK, ZAEDES, ZAELAN, ZAESEA, &
      !$ACC&         ZAESOO, ZAESUL, ZAEVOL, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, &
      !$ACC&         Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, &
      !$ACC&         Z_YDMF_PHYS_SURF_GSD_VA_PDES, Z_YDMF_PHYS_SURF_GSD_VA_PLAN, &
      !$ACC&         Z_YDMF_PHYS_SURF_GSD_VA_PSEA, Z_YDMF_PHYS_SURF_GSD_VA_PSOO) &
      !$ACC&PRIVATE (JBLK) &
