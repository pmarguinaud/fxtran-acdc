...
PROCEDURE :: ACDC_COPY => ACDC_COPY_TRADIATION
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TRADIATION
PROCEDURE :: ACDC_HOST => ACDC_HOST_TRADIATION
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TRADIATION
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TRADIATION
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TRADIATION
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TRADIATION
END TYPE TRADIATION


INTERFACE

MODULE SUBROUTINE ACDC_COPY_TRADIATION (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE ACDC_WIPE_TRADIATION (SELF, LDDELETED, LDFIELDAPI)
