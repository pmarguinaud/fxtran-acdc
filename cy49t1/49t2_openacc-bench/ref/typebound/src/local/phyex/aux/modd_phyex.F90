...
CONTAINS
PROCEDURE :: COPY => COPY_PHYEX_T
PROCEDURE :: CRC64 => CRC64_PHYEX_T
PROCEDURE :: HOST => HOST_PHYEX_T
PROCEDURE :: LOAD => LOAD_PHYEX_T
PROCEDURE :: SAVE => SAVE_PHYEX_T
PROCEDURE :: SIZE => SIZE_PHYEX_T
PROCEDURE :: WIPE => WIPE_PHYEX_T
END TYPE PHYEX_t
!
INTERFACE
