...
SUBROUTINE SAVE_TRCOEF (SELF, KLUN)
...
SUBROUTINE LOAD_TRCOEF (SELF, KLUN)
...
SUBROUTINE COPY_TRCOEF (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE CRC64_TRCOEF (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TRCOEF (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TRCOEF (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
