...
PROCEDURE :: COPY => COPY_TMODERR
PROCEDURE :: CRC64 => CRC64_TMODERR
PROCEDURE :: HOST => HOST_TMODERR
PROCEDURE :: LOAD => LOAD_TMODERR
PROCEDURE :: SAVE => SAVE_TMODERR
PROCEDURE :: SIZE => SIZE_TMODERR
PROCEDURE :: WIPE => WIPE_TMODERR
END TYPE TMODERR

!     --------------------------------------------------------------------------------
INTERFACE

MODULE SUBROUTINE COPY_TMODERR (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TMODERR (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TMODERR (SELF)

IMPLICIT NONE
CLASS (TMODERR), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TMODERR (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TMODERR (SELF, KLUN)
...
MODULE FUNCTION SIZE_TMODERR (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TMODERR (SELF, LDDELETED, LDFIELDAPI)
