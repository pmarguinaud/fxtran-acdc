...
PROCEDURE :: COPY => COPY_GEOMETRY_VARIABLES
PROCEDURE :: CRC64 => CRC64_GEOMETRY_VARIABLES
PROCEDURE :: HOST => HOST_GEOMETRY_VARIABLES
PROCEDURE :: LEGACY => LEGACY_GEOMETRY_VARIABLES
PROCEDURE :: SIZE => SIZE_GEOMETRY_VARIABLES
PROCEDURE :: WIPE => WIPE_GEOMETRY_VARIABLES
...
CONTAINS
PROCEDURE :: COPY => COPY_ECPHYS_VARIABLES
PROCEDURE :: CRC64 => CRC64_ECPHYS_VARIABLES
PROCEDURE :: HOST => HOST_ECPHYS_VARIABLES
PROCEDURE :: LEGACY => LEGACY_ECPHYS_VARIABLES
PROCEDURE :: SIZE => SIZE_ECPHYS_VARIABLES
PROCEDURE :: WIPE => WIPE_ECPHYS_VARIABLES
...
PROCEDURE :: COPY => COPY_RADIATION_VARIABLES
PROCEDURE :: CRC64 => CRC64_RADIATION_VARIABLES
PROCEDURE :: HOST => HOST_RADIATION_VARIABLES
PROCEDURE :: LEGACY => LEGACY_RADIATION_VARIABLES
PROCEDURE :: SIZE => SIZE_RADIATION_VARIABLES
PROCEDURE :: WIPE => WIPE_RADIATION_VARIABLES
...
PROCEDURE :: COPY => COPY_FIELD_VARIABLES
PROCEDURE :: CRC64 => CRC64_FIELD_VARIABLES
PROCEDURE :: HOST => HOST_FIELD_VARIABLES
PROCEDURE :: LEGACY => LEGACY_FIELD_VARIABLES
PROCEDURE :: SIZE => SIZE_FIELD_VARIABLES
PROCEDURE :: WIPE => WIPE_FIELD_VARIABLES
...
MODULE SUBROUTINE CRC64_ECPHYS_VARIABLES (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE FUNCTION SIZE_ECPHYS_VARIABLES (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_ECPHYS_VARIABLES (SELF, LDDELETED, LDFIELDAPI)
