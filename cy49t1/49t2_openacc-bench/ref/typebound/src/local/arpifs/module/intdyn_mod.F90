...
CONTAINS
PROCEDURE :: COPY => COPY_TXYB
PROCEDURE :: CRC64 => CRC64_TXYB
PROCEDURE :: HOST => HOST_TXYB
PROCEDURE :: LOAD => LOAD_TXYB
PROCEDURE :: SAVE => SAVE_TXYB
PROCEDURE :: SIZE => SIZE_TXYB
PROCEDURE :: WIPE => WIPE_TXYB
END TYPE TXYB
...
INTEGER(KIND=JPIM) :: NDIM          ! total number of fields allocated
CONTAINS
PROCEDURE :: COPY => COPY_TXYBDER
PROCEDURE :: CRC64 => CRC64_TXYBDER
PROCEDURE :: HOST => HOST_TXYBDER
PROCEDURE :: LOAD => LOAD_TXYBDER
PROCEDURE :: SAVE => SAVE_TXYBDER
PROCEDURE :: SIZE => SIZE_TXYBDER
PROCEDURE :: WIPE => WIPE_TXYBDER
END TYPE TXYBDER
...
INTEGER(KIND=JPIM) :: NDIM          ! total number of fields allocated
CONTAINS
PROCEDURE :: COPY => COPY_TRCP
PROCEDURE :: CRC64 => CRC64_TRCP
PROCEDURE :: HOST => HOST_TRCP
PROCEDURE :: LOAD => LOAD_TRCP
PROCEDURE :: SAVE => SAVE_TRCP
PROCEDURE :: SIZE => SIZE_TRCP
PROCEDURE :: WIPE => WIPE_TRCP
END TYPE TRCP
...
INTEGER(KIND=JPIM) :: NDIM          ! total number of fields allocated
CONTAINS
PROCEDURE :: COPY => COPY_TCTY
PROCEDURE :: CRC64 => CRC64_TCTY
PROCEDURE :: HOST => HOST_TCTY
PROCEDURE :: LOAD => LOAD_TCTY
PROCEDURE :: SAVE => SAVE_TCTY
PROCEDURE :: SIZE => SIZE_TCTY
PROCEDURE :: WIPE => WIPE_TCTY
END TYPE TCTY
...
INTEGER(KIND=JPIM) :: NDIM          ! total number of fields allocated
CONTAINS
PROCEDURE :: COPY => COPY_THWIND
PROCEDURE :: CRC64 => CRC64_THWIND
PROCEDURE :: HOST => HOST_THWIND
PROCEDURE :: LOAD => LOAD_THWIND
PROCEDURE :: SAVE => SAVE_THWIND
PROCEDURE :: SIZE => SIZE_THWIND
PROCEDURE :: WIPE => WIPE_THWIND
END TYPE THWIND
...
INTEGER(KIND=JPIM) :: NDIM          ! total number of fields allocated
CONTAINS
PROCEDURE :: COPY => COPY_TTND
PROCEDURE :: CRC64 => CRC64_TTND
PROCEDURE :: HOST => HOST_TTND
PROCEDURE :: LOAD => LOAD_TTND
PROCEDURE :: SAVE => SAVE_TTND
PROCEDURE :: SIZE => SIZE_TTND
PROCEDURE :: WIPE => WIPE_TTND
END TYPE TTND
...
INTEGER(KIND=JPIM) :: NDIM     ! total number of fields allocated
CONTAINS
PROCEDURE :: COPY => COPY_TGMVT
PROCEDURE :: CRC64 => CRC64_TGMVT
PROCEDURE :: HOST => HOST_TGMVT
PROCEDURE :: LOAD => LOAD_TGMVT
PROCEDURE :: SAVE => SAVE_TGMVT
PROCEDURE :: SIZE => SIZE_TGMVT
PROCEDURE :: WIPE => WIPE_TGMVT
END TYPE TGMVT
...
INTEGER(KIND=JPIM) :: NDIM     ! total number of fields allocated
CONTAINS
PROCEDURE :: COPY => COPY_TGFLT
PROCEDURE :: CRC64 => CRC64_TGFLT
PROCEDURE :: HOST => HOST_TGFLT
PROCEDURE :: LOAD => LOAD_TGFLT
PROCEDURE :: SAVE => SAVE_TGFLT
PROCEDURE :: SIZE => SIZE_TGFLT
PROCEDURE :: WIPE => WIPE_TGFLT
END TYPE TGFLT
...
MODULE SUBROUTINE COPY_TXYB (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TXYB (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TXYB (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TXYB (SELF, KLUN)
...
MODULE FUNCTION SIZE_TXYB (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TXYB (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TXYBDER (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TXYBDER (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_TXYBDER (SELF)

IMPLICIT NONE
CLASS (TXYBDER), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TXYBDER (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TXYBDER (SELF, KLUN)
...
MODULE FUNCTION SIZE_TXYBDER (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TXYBDER (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TRCP (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TRCP (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_TRCP (SELF)

IMPLICIT NONE
CLASS (TRCP), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TRCP (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TRCP (SELF, KLUN)
...
MODULE FUNCTION SIZE_TRCP (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TRCP (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TCTY (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TCTY (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_TCTY (SELF)

IMPLICIT NONE
CLASS (TCTY), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TCTY (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TCTY (SELF, KLUN)
...
MODULE FUNCTION SIZE_TCTY (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TCTY (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_THWIND (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_THWIND (SELF)

IMPLICIT NONE
CLASS (THWIND), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_THWIND (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_THWIND (SELF, KLUN)
...
MODULE FUNCTION SIZE_THWIND (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_THWIND (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TTND (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TTND (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE LOAD_TTND (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TTND (SELF, KLUN)
...
MODULE FUNCTION SIZE_TTND (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TTND (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TGMVT (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TGMVT (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_TGMVT (SELF)

IMPLICIT NONE
CLASS (TGMVT), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TGMVT (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TGMVT (SELF, KLUN)
...
MODULE FUNCTION SIZE_TGMVT (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TGMVT (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TGFLT (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TGFLT (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_TGFLT (SELF)

IMPLICIT NONE
CLASS (TGFLT), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TGFLT (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TGFLT (SELF, KLUN)
...
MODULE FUNCTION SIZE_TGFLT (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TGFLT (SELF, LDDELETED, LDFIELDAPI)
