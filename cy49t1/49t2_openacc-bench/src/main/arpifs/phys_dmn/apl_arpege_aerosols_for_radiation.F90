...
IF ((MOD(YDCPG_OPTS%NSTEP,YDMODEL%YRML_PHY_RAD%YRERAD%NRADFR) == 0) &
 & .OR. (YDMODEL%YRML_PHY_MF%YRPHY%LRAY .AND. (.NOT. YDMODEL%YRML_PHY_MF%YRPHY%LRSTAER))) THEN

!$ACDC PARALLEL, TARGET=OpenMP/OpenMPSingleColumn/OpenACCSingleColumn,NAME=RADAER {
