...
IF (YDDYNA%LSLAG) THEN
  ...
  IF (YDDYNA%LTWOTL) THEN
    ...
    DO JGFL=1, SIZE (YDVARS%GFL_PTR)
      ...
      IF (YDVARS%GFL_PTR (JGFL)%LADV) THEN
        CALL GPINISLB_PART2_EXPL_OUTLINE_000 (YDVARS, YDCPG_BNDS, JGFL)
      ELSEIF (YDVARS%GFL_PTR (JGFL)%LT1) THEN
        CALL GPINISLB_PART2_EXPL_OUTLINE_001 (YDVARS, JGFL, YDCPG_OPTS, YDCPG_BNDS)
      ENDIF
  ...
  ELSE
    ...
    DO JGFL=1, SIZE (YDVARS%GFL_PTR)
      ...
      IF (YDVARS%GFL_PTR (JGFL)%LADV) THEN
        CALL GPINISLB_PART2_EXPL_OUTLINE_002 (YDVARS, YDCPG_BNDS, JGFL)
      ELSEIF (YDVARS%GFL_PTR (JGFL)%LT1) THEN
        CALL GPINISLB_PART2_EXPL_OUTLINE_003 (YDVARS, JGFL, YDCPG_OPTS, YDCPG_BNDS)
      ENDIF
...
ELSE
  ...
  IF (YDDYN%NCURRENT_ITER==0) THEN
    ...
    DO JGFL=1, SIZE (YDVARS%GFL_PTR)
      ...
      IF (YDVARS%GFL_PTR (JGFL)%LT1) THEN
        CALL GPINISLB_PART2_EXPL_OUTLINE_004 (YDVARS, JGFL, YDCPG_OPTS, YDCPG_BNDS)
      ENDIF
  ...
  ELSE
    ...
    DO JGFL=1, SIZE (YDVARS%GFL_PTR)
      ...
      IF (YDVARS%GFL_PTR (JGFL)%LT1) THEN
        CALL GPINISLB_PART2_EXPL_OUTLINE_005 (YDVARS, YDCPG_BNDS, JGFL)
      ENDIF
