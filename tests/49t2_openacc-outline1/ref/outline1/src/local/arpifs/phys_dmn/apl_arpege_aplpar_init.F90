...
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_APLPAR_INIT', 0, ZHOOK_HANDLE)
CALL APLPAR_INIT (YDCPG_OPTS%LAROME, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, YDMODEL%YRML_PHY_G%YRDPHY%NTSSG, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS, YDMF_PHYS_SURF%GSD_VF&
&%PVEG, PMSC_FRMQ, PFCHQ, PDSA_CPS, PDSA_LHS, PDSA_RS, PMSC_LH, PMSC_LSCPE, PFLU_QSAT, PMSC_QW, PMSC_TW&
&, PFLU_CD, PFLU_CDN, PFLU_CH, ZFLU_CHN, PDSA_C1, PDSA_C2, PFLU_EMIS, PFLU_FEVI, PPFL_FTKE, PPFL_FTKEI&
&, PPFL_FEFB1, PPFL_FEFB2, PPFL_FEFB3, PFLU_NEIJ, PFLU_VEG, PFLU_QSATS, KMOC_CLPH)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_APLPAR_INIT', 1, ZHOOK_HANDLE)
ENDSUBROUTINE
