...
IF (YDMODEL%YRML_PHY_MF%YRPHY2%LRAFTKE) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_WIND_GUST_PARALLEL:ACCLDIA')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (PBLH, YD_PBLH)
    CALL SGET_HOST_DATA_RDWR (PDCAPE, YD_PDCAPE)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_TKE, YDMF_PHYS_BASE_STATE%F_TKE)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_WIND_GUST_PARALLEL:ACCLDIA')) THEN
    ...
    CALL SGET_DEVICE_DATA_RDWR (PBLH, YD_PBLH)
    CALL SGET_DEVICE_DATA_RDWR (PDCAPE, YD_PDCAPE)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_TKE, YDMF_PHYS_BASE_STATE%F_TKE)
    ...
    !$OMP & MAP(PRESENT:KMOC_CLPH, PBLH, PDCAPE, YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_TKE, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_V,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_OUT_CAPE,  & 
