...
ASSOCIATE(ALMAVX=>YDPHY0%ALMAVX, ACBRPHIM=>YDPHY0%ACBRPHIM, &
 ...
 & RATM=>YDCST%RATM, RCPD=>YDCST%RCPD, RCPV=>YDCST%RCPV, RCW=>YDCST%RCW, RD=>YDCST%RD, &
 & RETV=>YDCST%RETV, RG=>YDCST%RG, RKAPPA=>YDCST%RKAPPA, RLVTT=>YDCST%RLVTT, &
 & RPI=>YDCST%RPI, RTT=>YDCST%RTT, RV=>YDCST%RV, &
