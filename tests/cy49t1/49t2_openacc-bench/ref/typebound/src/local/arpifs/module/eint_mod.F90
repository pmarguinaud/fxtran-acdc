...
PROCEDURE :: COPY => COPY_SL_STRUCT
PROCEDURE :: CRC64 => CRC64_SL_STRUCT
PROCEDURE :: HOST => HOST_SL_STRUCT
PROCEDURE :: LOAD => LOAD_SL_STRUCT
PROCEDURE :: SAVE => SAVE_SL_STRUCT
PROCEDURE :: SIZE => SIZE_SL_STRUCT
PROCEDURE :: WIPE => WIPE_SL_STRUCT
END TYPE SL_STRUCT
...
MODULE SUBROUTINE HOST_SL_STRUCT (SELF)

IMPLICIT NONE
CLASS (SL_STRUCT), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_SL_STRUCT (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_SL_STRUCT (SELF, KLUN)
