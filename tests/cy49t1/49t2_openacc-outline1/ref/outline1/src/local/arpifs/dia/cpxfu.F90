...
CALL CPXFU_OUTLINE_000 (YDCPG_OPTS, YDXFU, YDCPG_BNDS, PXNUCLS, PXUCLS, PXVGST&
&, LLGST, ZNVMEAN, ZNUMEAN, ZVMEAN, LLGST2, PXUGST, ZUMEAN, PXNVCLS, PXVCLS)
CALL CPXFU_OUTLINE_001 (YDCPG_MISC, YDCPG_OPTS, YDXFU, YDMF_PHYS_OUT&
&, YDCPG_BNDS, PSTRDU, PSTRDV, PSTRCV, PSTRTV, PSTRCU, PSTRTU)
CALL CPXFU_OUTLINE_002 (YDCPG_MISC, YDCPG_OPTS, YDXFU, YDMF_PHYS_OUT, YDCPG_BNDS, PXNUCLS, PXUCLS&
&, PXVGST, LLGST, ZNVMEAN, ZNUMEAN, ZVMEAN, LLGST2, PXUGST, ZUMEAN, PXNVCLS, PXVCLS)
CALL CPXFU_OUTLINE_003 (YDXFU, YDMF_PHYS_OUT, YDCPG_BNDS)
CALL CPXFU_OUTLINE_004 (YDXFU, YDCPG_OPTS, YDMF_PHYS_OUT&
