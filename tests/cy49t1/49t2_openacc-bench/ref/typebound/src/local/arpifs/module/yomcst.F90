...
CONTAINS
PROCEDURE :: COPY => COPY_TCST
PROCEDURE :: CRC64 => CRC64_TCST
PROCEDURE :: HOST => HOST_TCST
PROCEDURE :: LOAD => LOAD_TCST
PROCEDURE :: SAVE => SAVE_TCST
PROCEDURE :: SIZE => SIZE_TCST
PROCEDURE :: WIPE => WIPE_TCST
END TYPE TCST
...
MODULE SUBROUTINE COPY_TCST (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TCST (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TCST (SELF)

IMPLICIT NONE
CLASS (TCST), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TCST (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TCST (SELF, KLUN)
...
MODULE FUNCTION SIZE_TCST (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TCST (SELF, LDDELETED, LDFIELDAPI)
