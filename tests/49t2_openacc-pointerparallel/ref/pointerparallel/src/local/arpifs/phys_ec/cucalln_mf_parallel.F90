...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CUCALLN_MF_PARALLEL:0')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (PFPLCL, YD_PFPLCL)
  CALL SGET_HOST_DATA_RDWR (PFPLCN, YD_PFPLCN)
  ...
  CALL SGET_HOST_DATA_RDWR (ZENTHD, YL_ZENTHD)
  CALL SGET_HOST_DATA_RDWR (ZENTHS, YL_ZENTHS)
  CALL SGET_HOST_DATA_RDWR (ZQEA, YL_ZQEA)
  CALL SGET_HOST_DATA_RDWR (ZTEA, YL_ZTEA)
  CALL SGET_HOST_DATA_RDWR (ZUEA, YL_ZUEA)
  CALL SGET_HOST_DATA_RDWR (ZVEA, YL_ZVEA)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUCALLN_MF_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:0:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (PFPLCL, YD_PFPLCL)
  CALL SGET_DEVICE_DATA_RDWR (PFPLCN, YD_PFPLCN)
  ...
  CALL SGET_DEVICE_DATA_RDWR (ZENTHD, YL_ZENTHD)
  CALL SGET_DEVICE_DATA_RDWR (ZENTHS, YL_ZENTHS)
  CALL SGET_DEVICE_DATA_RDWR (ZQEA, YL_ZQEA)
  CALL SGET_DEVICE_DATA_RDWR (ZTEA, YL_ZTEA)
  CALL SGET_DEVICE_DATA_RDWR (ZUEA, YL_ZUEA)
  CALL SGET_DEVICE_DATA_RDWR (ZVEA, YL_ZVEA)
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:0:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CUCALLN_MF_PARALLEL:1')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (PCM1, YD_PCM1)
  CALL SGET_HOST_DATA_RDONLY (PQM1, YD_PQM1)
  CALL SGET_HOST_DATA_RDONLY (PTENC, YD_PTENC)
  CALL SGET_HOST_DATA_RDONLY (PTENQ, YD_PTENQ)
  CALL SGET_HOST_DATA_RDONLY (PTENT, YD_PTENT)
  CALL SGET_HOST_DATA_RDONLY (PTENU, YD_PTENU)
  CALL SGET_HOST_DATA_RDONLY (PTENV, YD_PTENV)
  CALL SGET_HOST_DATA_RDONLY (PTM1, YD_PTM1)
  CALL SGET_HOST_DATA_RDONLY (PUM1, YD_PUM1)
  CALL SGET_HOST_DATA_RDONLY (PVM1, YD_PVM1)
  CALL SGET_HOST_DATA_RDWR (ZCP1, YL_ZCP1)
  CALL SGET_HOST_DATA_RDWR (ZQP1, YL_ZQP1)
  CALL SGET_HOST_DATA_RDWR (ZQSAT, YL_ZQSAT)
  CALL SGET_HOST_DATA_RDWR (ZTP1, YL_ZTP1)
  CALL SGET_HOST_DATA_RDWR (ZUP1, YL_ZUP1)
  CALL SGET_HOST_DATA_RDWR (ZVP1, YL_ZVP1)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUCALLN_MF_PARALLEL:1')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:1:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (PCM1, YD_PCM1)
  CALL SGET_DEVICE_DATA_RDONLY (PQM1, YD_PQM1)
  CALL SGET_DEVICE_DATA_RDONLY (PTENC, YD_PTENC)
  CALL SGET_DEVICE_DATA_RDONLY (PTENQ, YD_PTENQ)
  CALL SGET_DEVICE_DATA_RDONLY (PTENT, YD_PTENT)
  CALL SGET_DEVICE_DATA_RDONLY (PTENU, YD_PTENU)
  CALL SGET_DEVICE_DATA_RDONLY (PTENV, YD_PTENV)
  CALL SGET_DEVICE_DATA_RDONLY (PTM1, YD_PTM1)
  CALL SGET_DEVICE_DATA_RDONLY (PUM1, YD_PUM1)
  CALL SGET_DEVICE_DATA_RDONLY (PVM1, YD_PVM1)
  CALL SGET_DEVICE_DATA_RDWR (ZCP1, YL_ZCP1)
  CALL SGET_DEVICE_DATA_RDWR (ZQP1, YL_ZQP1)
  CALL SGET_DEVICE_DATA_RDWR (ZQSAT, YL_ZQSAT)
  CALL SGET_DEVICE_DATA_RDWR (ZTP1, YL_ZTP1)
  CALL SGET_DEVICE_DATA_RDWR (ZUP1, YL_ZUP1)
  CALL SGET_DEVICE_DATA_RDWR (ZVP1, YL_ZVP1)
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:1:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CUCALLN_MF_PARALLEL:2')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (ZQSAT, YL_ZQSAT)
  CALL SGET_HOST_DATA_RDWR (ZRAIN, YL_ZRAIN)
  CALL SGET_HOST_DATA_RDONLY (ZTP1, YL_ZTP1)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUCALLN_MF_PARALLEL:2')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDWR (ZQSAT, YL_ZQSAT)
  CALL SGET_DEVICE_DATA_RDWR (ZRAIN, YL_ZRAIN)
  CALL SGET_DEVICE_DATA_RDONLY (ZTP1, YL_ZTP1)
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:2:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CUCALLN_MF_PARALLEL:3')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (KBASEC, YD_KBASEC)
  CALL SGET_HOST_DATA_RDONLY (KCBOT, YD_KCBOT)
  CALL SGET_HOST_DATA_RDONLY (KCTOP, YD_KCTOP)
  CALL SGET_HOST_DATA_RDWR (KTOPC, YD_KTOPC)
  CALL SGET_HOST_DATA_RDONLY (LDCUM, YD_LDCUM)
  CALL SGET_HOST_DATA_RDWR (PARPRC, YD_PARPRC)
  CALL SGET_HOST_DATA_RDONLY (PLU, YD_PLU)
  CALL SGET_HOST_DATA_RDONLY (PMFU, YD_PMFU)
  CALL SGET_HOST_DATA_RDONLY (ZQU, YL_ZQU)
  CALL SGET_HOST_DATA_RDONLY (ZRAIN, YL_ZRAIN)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUCALLN_MF_PARALLEL:3')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:3:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (KBASEC, YD_KBASEC)
  CALL SGET_DEVICE_DATA_RDONLY (KCBOT, YD_KCBOT)
  CALL SGET_DEVICE_DATA_RDONLY (KCTOP, YD_KCTOP)
  CALL SGET_DEVICE_DATA_RDWR (KTOPC, YD_KTOPC)
  CALL SGET_DEVICE_DATA_RDONLY (LDCUM, YD_LDCUM)
  CALL SGET_DEVICE_DATA_RDWR (PARPRC, YD_PARPRC)
  CALL SGET_DEVICE_DATA_RDONLY (PLU, YD_PLU)
  CALL SGET_DEVICE_DATA_RDONLY (PMFU, YD_PMFU)
  CALL SGET_DEVICE_DATA_RDONLY (ZQU, YL_ZQU)
  CALL SGET_DEVICE_DATA_RDONLY (ZRAIN, YL_ZRAIN)
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:3:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CUCALLN_MF_PARALLEL:4')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (PAPHM1, YD_PAPHM1)
  CALL SGET_HOST_DATA_RDWR (PDIFCQ, YD_PDIFCQ)
  CALL SGET_HOST_DATA_RDWR (PDIFCS, YD_PDIFCS)
  CALL SGET_HOST_DATA_RDWR (PFCQIF, YD_PFCQIF)
  CALL SGET_HOST_DATA_RDWR (PFCQLF, YD_PFCQLF)
  CALL SGET_HOST_DATA_RDWR (PFHPCL, YD_PFHPCL)
  CALL SGET_HOST_DATA_RDWR (PFHPCN, YD_PFHPCN)
  CALL SGET_HOST_DATA_RDONLY (PFPLCL, YD_PFPLCL)
  CALL SGET_HOST_DATA_RDONLY (PFPLCN, YD_PFPLCN)
  CALL SGET_HOST_DATA_RDONLY (PLUDELI, YD_PLUDELI)
  ...
  CALL SGET_HOST_DATA_RDONLY (PTENU, YD_PTENU)
  CALL SGET_HOST_DATA_RDONLY (PTENV, YD_PTENV)
  CALL SGET_HOST_DATA_RDWR (ZCONDFLL, YL_ZCONDFLL)
  CALL SGET_HOST_DATA_RDWR (ZCONDFLN, YL_ZCONDFLN)
  CALL SGET_HOST_DATA_RDONLY (ZQEA, YL_ZQEA)
  CALL SGET_HOST_DATA_RDONLY (ZQP1, YL_ZQP1)
  CALL SGET_HOST_DATA_RDONLY (ZTEA, YL_ZTEA)
  CALL SGET_HOST_DATA_RDONLY (ZUEA, YL_ZUEA)
  CALL SGET_HOST_DATA_RDONLY (ZVEA, YL_ZVEA)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUCALLN_MF_PARALLEL:4')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:4:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (PAPHM1, YD_PAPHM1)
  CALL SGET_DEVICE_DATA_RDWR (PDIFCQ, YD_PDIFCQ)
  CALL SGET_DEVICE_DATA_RDWR (PDIFCS, YD_PDIFCS)
  CALL SGET_DEVICE_DATA_RDWR (PFCQIF, YD_PFCQIF)
  CALL SGET_DEVICE_DATA_RDWR (PFCQLF, YD_PFCQLF)
  CALL SGET_DEVICE_DATA_RDWR (PFHPCL, YD_PFHPCL)
  CALL SGET_DEVICE_DATA_RDWR (PFHPCN, YD_PFHPCN)
  CALL SGET_DEVICE_DATA_RDONLY (PFPLCL, YD_PFPLCL)
  CALL SGET_DEVICE_DATA_RDONLY (PFPLCN, YD_PFPLCN)
  CALL SGET_DEVICE_DATA_RDONLY (PLUDELI, YD_PLUDELI)
  CALL SGET_DEVICE_DATA_RDWR (PSTRCU, YD_PSTRCU)
  CALL SGET_DEVICE_DATA_RDWR (PSTRCV, YD_PSTRCV)
  CALL SGET_DEVICE_DATA_RDONLY (PTENQ, YD_PTENQ)
  CALL SGET_DEVICE_DATA_RDONLY (PTENT, YD_PTENT)
  CALL SGET_DEVICE_DATA_RDONLY (PTENU, YD_PTENU)
  CALL SGET_DEVICE_DATA_RDONLY (PTENV, YD_PTENV)
  CALL SGET_DEVICE_DATA_RDWR (ZCONDFLL, YL_ZCONDFLL)
  CALL SGET_DEVICE_DATA_RDWR (ZCONDFLN, YL_ZCONDFLN)
  CALL SGET_DEVICE_DATA_RDONLY (ZQEA, YL_ZQEA)
  CALL SGET_DEVICE_DATA_RDONLY (ZQP1, YL_ZQP1)
  CALL SGET_DEVICE_DATA_RDONLY (ZTEA, YL_ZTEA)
  CALL SGET_DEVICE_DATA_RDONLY (ZUEA, YL_ZUEA)
  CALL SGET_DEVICE_DATA_RDONLY (ZVEA, YL_ZVEA)
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:4:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:4:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
