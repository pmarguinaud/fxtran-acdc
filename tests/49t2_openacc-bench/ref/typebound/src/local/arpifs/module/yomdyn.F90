...
! PSURF_MIN : min of surface pressure of the standard atmosphere
! HANDLE_CUBLAS : Handle for DGEMM / SGEMM

LOGICAL :: LSIDG
LOGICAL :: LDYN_STABAN
LOGICAL :: LREFINE_SILAPL
...
INTEGER(KIND=JPIM),ALLOCATABLE:: SIHEGIND(:)
...
!
! RNHHY_ALPHA_LI/NL:final alpha weights in linear/nonlin model (vertically dependent)
! RNHHY_BETA_LI/NL: final beta weights in linear/nonlin model (vertically dependent)
! RNHHY_GAMA_LI/NL: final gamma weights in linear/nonlin model (vertically dependent)
! RNHHY_DELTA_LI/NL:final delta weights in linear/nonlin model (vertically dependent)
! RNHHY_EPS_LI/NL : final epsilon weights in linear/nonlin model (vertically dependent)
! RNHHY_CHI_LI : final chi weights in linear model (vertically dependent)

REAL(KIND=JPRB), ALLOCATABLE :: RNHHY_ALPHA_NL(:)
REAL(KIND=JPRB), ALLOCATABLE :: RNHHY_BETA_NL(:)
REAL(KIND=JPRB), ALLOCATABLE :: RNHHY_GAMA_NL(:)
REAL(KIND=JPRB), ALLOCATABLE :: RNHHY_DELTA_NL(:)
REAL(KIND=JPRB), ALLOCATABLE :: RNHHY_EPS_NL(:)

REAL(KIND=JPRB), ALLOCATABLE :: RNHHY_ALPHA_LI(:)
REAL(KIND=JPRB), ALLOCATABLE :: RNHHY_BETA_LI(:)
REAL(KIND=JPRB), ALLOCATABLE :: RNHHY_GAMA_LI(:)
REAL(KIND=JPRB), ALLOCATABLE :: RNHHY_DELTA_LI(:)
REAL(KIND=JPRB), ALLOCATABLE :: RNHHY_EPS_LI(:)
REAL(KIND=JPRB), ALLOCATABLE :: RNHHY_CHI_LI(:)
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_TDYN
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TDYN
PROCEDURE :: ACDC_HOST => ACDC_HOST_TDYN
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TDYN
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TDYN
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TDYN
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TDYN
END TYPE TDYN
...
CONTAINS 
  ...
  SUBROUTINE PRINT_CONFIGURATION(SELF, KDEPTH, KOUTNO)
    ...
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SITRA = ', SELF%SIPRA
    ...
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LREFINE_SILAPL =',SELF%LREFINE_SILAPL
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'NITERHELM = ', SELF%NITERHELM
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'NOPT_SITRA = ', SELF%NOPT_SITRA
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'NOPT_SIPRA = ', SELF%NOPT_SIPRA
    ...
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'PSURF_MIN = ', SELF%PSURF_MIN
    ...
    !* parameter linked to nhhy blending approach
    IF (ALLOCATED(SELF%RNHHY_ALPHA_NL)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_ALPHA_NL allocated of shape ', SHAPE( SELF%RNHHY_ALPHA_NL )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_ALPHA_NL not allocated'
    ENDIF
    IF (ALLOCATED(SELF%RNHHY_BETA_NL)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_BETA_NL allocated of shape', SHAPE( SELF%RNHHY_BETA_NL )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_BETA_NL not allocated'
    ENDIF
    IF (ALLOCATED(SELF%RNHHY_GAMA_NL)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_GAMA_NL allocated of shape', SHAPE( SELF%RNHHY_GAMA_NL )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_GAMA_NL not allocated'
    ENDIF
    IF (ALLOCATED(SELF%RNHHY_DELTA_NL)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_DELTA_NL allocated of shape', SHAPE( SELF%RNHHY_DELTA_NL )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_DELTA_NL not allocated'
    ENDIF
    IF (ALLOCATED(SELF%RNHHY_EPS_NL)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_EPS_NL allocated of shape', SHAPE( SELF%RNHHY_EPS_NL )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_EPS_NL not allocated'
    ENDIF
    IF (ALLOCATED(SELF%RNHHY_ALPHA_LI)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_ALPHA_LI allocated of shape', SHAPE( SELF%RNHHY_ALPHA_LI )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_ALPHA_LI not allocated'
    ENDIF
    IF (ALLOCATED(SELF%RNHHY_BETA_LI)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_BETA_LI allocated of shape', SHAPE( SELF%RNHHY_BETA_LI )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_BETA_LI not allocated'
    ENDIF
    IF (ALLOCATED(SELF%RNHHY_GAMA_LI)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_GAMA_LI allocated of shape', SHAPE( SELF%RNHHY_GAMA_LI )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_GAMA_LI not allocated'
    ENDIF
    IF (ALLOCATED(SELF%RNHHY_DELTA_LI)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_DELTA_LI allocated of shape', SHAPE( SELF%RNHHY_DELTA_LI )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_DELTA_LI not allocated'
    ENDIF
    IF (ALLOCATED(SELF%RNHHY_EPS_LI)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_EPS_LI allocated of shape', SHAPE( SELF%RNHHY_EPS_LI )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_EPS_LI not allocated'
    ENDIF
    IF (ALLOCATED(SELF%RNHHY_CHI_LI)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_CHI_LI allocated of shape', SHAPE( SELF%RNHHY_CHI_LI )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_CHI_LI not allocated'
    ENDIF
