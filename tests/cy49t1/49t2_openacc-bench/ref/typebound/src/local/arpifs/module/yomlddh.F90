...
CONTAINS
PROCEDURE :: COPY => COPY_TLDDH
PROCEDURE :: CRC64 => CRC64_TLDDH
PROCEDURE :: HOST => HOST_TLDDH
PROCEDURE :: LOAD => LOAD_TLDDH
PROCEDURE :: SAVE => SAVE_TLDDH
PROCEDURE :: SIZE => SIZE_TLDDH
PROCEDURE :: WIPE => WIPE_TLDDH
END TYPE  TLDDH
...
MODULE SUBROUTINE COPY_TLDDH (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE WIPE_TLDDH (SELF, LDDELETED, LDFIELDAPI)
