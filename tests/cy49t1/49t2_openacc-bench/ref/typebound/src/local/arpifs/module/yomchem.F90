...
CONTAINS
PROCEDURE :: COPY => COPY_TCHEM
PROCEDURE :: CRC64 => CRC64_TCHEM
PROCEDURE :: HOST => HOST_TCHEM
PROCEDURE :: LOAD => LOAD_TCHEM
PROCEDURE :: SAVE => SAVE_TCHEM
PROCEDURE :: SIZE => SIZE_TCHEM
PROCEDURE :: WIPE => WIPE_TCHEM
END TYPE TCHEM
...
MODULE SUBROUTINE COPY_TCHEM (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TCHEM (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TCHEM (SELF)

IMPLICIT NONE
CLASS (TCHEM), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TCHEM (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TCHEM (SELF, KLUN)
...
MODULE FUNCTION SIZE_TCHEM (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TCHEM (SELF, LDDELETED, LDFIELDAPI)
