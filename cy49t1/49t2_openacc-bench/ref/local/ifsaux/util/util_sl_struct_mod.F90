...
SUBROUTINE SAVE_SL_STRUCT (SELF, KLUN)
...
SUBROUTINE LOAD_SL_STRUCT (SELF, KLUN)
...
SUBROUTINE COPY_SL_STRUCT (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE HOST_SL_STRUCT (SELF)
...
SUBROUTINE CRC64_SL_STRUCT (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_SL_STRUCT (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_SL_STRUCT (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
