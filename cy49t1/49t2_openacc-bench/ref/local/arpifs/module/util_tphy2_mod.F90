...
SUBROUTINE SAVE_TPHY2 (SELF, KLUN)
...
SUBROUTINE LOAD_TPHY2 (SELF, KLUN)
...
SUBROUTINE COPY_TPHY2 (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE CRC64_TPHY2 (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TPHY2 (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TPHY2 (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
