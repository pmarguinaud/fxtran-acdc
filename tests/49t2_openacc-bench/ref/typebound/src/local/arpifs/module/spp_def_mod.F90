...
!$ACDC methods 
  ...
  PROCEDURE :: ACDC_COPY => ACDC_COPY_SPP_PERT_POINTER
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_SPP_PERT_POINTER
PROCEDURE :: ACDC_HOST => ACDC_HOST_SPP_PERT_POINTER
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_SPP_PERT_POINTER
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_SPP_PERT_POINTER
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_SPP_PERT_POINTER
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_SPP_PERT_POINTER
