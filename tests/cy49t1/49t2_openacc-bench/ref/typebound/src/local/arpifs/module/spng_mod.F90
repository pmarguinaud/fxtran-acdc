...
PROCEDURE :: COPY => COPY_TSPNG
PROCEDURE :: CRC64 => CRC64_TSPNG
PROCEDURE :: HOST => HOST_TSPNG
PROCEDURE :: LOAD => LOAD_TSPNG
PROCEDURE :: SAVE => SAVE_TSPNG
PROCEDURE :: SIZE => SIZE_TSPNG
PROCEDURE :: WIPE => WIPE_TSPNG
END TYPE TSPNG
...
MODULE SUBROUTINE COPY_TSPNG (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TSPNG (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TSPNG (SELF)

IMPLICIT NONE
CLASS (TSPNG), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TSPNG (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TSPNG (SELF, KLUN)
...
MODULE FUNCTION SIZE_TSPNG (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TSPNG (SELF, LDDELETED, LDFIELDAPI)
