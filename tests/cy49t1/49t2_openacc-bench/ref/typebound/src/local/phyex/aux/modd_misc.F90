...
CONTAINS
PROCEDURE :: COPY => COPY_MISC_T
PROCEDURE :: CRC64 => CRC64_MISC_T
PROCEDURE :: HOST => HOST_MISC_T
PROCEDURE :: LOAD => LOAD_MISC_T
PROCEDURE :: SAVE => SAVE_MISC_T
PROCEDURE :: SIZE => SIZE_MISC_T
PROCEDURE :: WIPE => WIPE_MISC_T
END TYPE MISC_t
INTERFACE

MODULE SUBROUTINE COPY_MISC_T (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_MISC_T (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_MISC_T (SELF)

IMPLICIT NONE
CLASS (MISC_T), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_MISC_T (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_MISC_T (SELF, KLUN)
...
MODULE FUNCTION SIZE_MISC_T (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_MISC_T (SELF, LDDELETED, LDFIELDAPI)
