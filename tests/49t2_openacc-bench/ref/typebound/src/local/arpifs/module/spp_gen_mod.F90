...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_SPP_PERT
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_SPP_PERT
PROCEDURE :: ACDC_HOST => ACDC_HOST_SPP_PERT
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_SPP_PERT
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_SPP_PERT
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_SPP_PERT
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_SPP_PERT
end type spp_pert
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_SPP_MODEL
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_SPP_MODEL
PROCEDURE :: ACDC_HOST => ACDC_HOST_SPP_MODEL
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_SPP_MODEL
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_SPP_MODEL
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_SPP_MODEL
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_SPP_MODEL
end type spp_model


INTERFACE

MODULE SUBROUTINE ACDC_COPY_SPP_PERT (SELF, LDCREATED, LDFIELDAPI)
