...
PROCEDURE :: COPY => COPY_TEGWD
PROCEDURE :: CRC64 => CRC64_TEGWD
PROCEDURE :: HOST => HOST_TEGWD
PROCEDURE :: LOAD => LOAD_TEGWD
PROCEDURE :: SAVE => SAVE_TEGWD
PROCEDURE :: SIZE => SIZE_TEGWD
PROCEDURE :: WIPE => WIPE_TEGWD
END TYPE TEGWD
!=====================================================================
...
MODULE SUBROUTINE COPY_TEGWD (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TEGWD (SELF)

IMPLICIT NONE
CLASS (TEGWD), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TEGWD (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TEGWD (SELF, KLUN)
...
MODULE SUBROUTINE WIPE_TEGWD (SELF, LDDELETED, LDFIELDAPI)
