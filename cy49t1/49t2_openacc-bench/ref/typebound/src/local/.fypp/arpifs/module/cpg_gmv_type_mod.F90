...
CONTAINS
PROCEDURE :: COPY => COPY_CPG_GMV_3D_TYPE
PROCEDURE :: HOST => HOST_CPG_GMV_3D_TYPE
PROCEDURE :: WIPE => WIPE_CPG_GMV_3D_TYPE
...
PROCEDURE :: COPY => COPY_CPG_GMV_TYPE
PROCEDURE :: HOST => HOST_CPG_GMV_TYPE
PROCEDURE :: WIPE => WIPE_CPG_GMV_TYPE
...
MODULE SUBROUTINE COPY_CPG_GMV_3D_TYPE (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_CPG_GMV_3D_TYPE (SELF)
USE FIELD_UTIL_MODULE
...
MODULE SUBROUTINE WIPE_CPG_GMV_3D_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_GMV_3D_TYPE), INTENT (IN), TARGET :: SELF
