...
USE UTIL_CPG_GPAR_TYPE_MOD
USE UTIL_CPG_MISC_TYPE_MOD
USE UTIL_CPG_SL2_TYPE_MOD
USE UTIL_CPG_TND_TYPE_MOD
USE UTIL_GRADIENT_TYPE_MOD
...
IF (YDMODEL%YRML_DYN%YRDYN%NCURRENT_ITER==0) THEN
  ...
  IF (YDMODEL%YRML_DYN%YRDYNA%LTWOTL) THEN
    ...
    ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_PARALLEL:GPTF2_EXPL_2TL')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:GPTF2_EXPL_2TL:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
      CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_U_T0, YDVARS%U%FT0)
      CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_U_T9, YDVARS%U%FT9)
      CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_V_T0, YDVARS%V%FT0)
      CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_V_T9, YDVARS%V%FT9)
      IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:GPTF2_EXPL_2TL:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:GPTF2_EXPL_2TL:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      
      !$OMP TARGET TEAMS DISTRIBUTE  & 
      !$OMP & MAP(PRESENT:YDCPG_OPTS, YDGEOMETRY, YFXTRAN_ACDC_STACK, Z_YDVARS_U_T0,  & 
      !$OMP &          Z_YDVARS_U_T9, Z_YDVARS_V_T0, Z_YDVARS_V_T9)  & 
      !$OMP & PRIVATE (JBLK)  & 
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CPG_GP_PARALLEL:MAP_FACTOR')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (Z_OROGLL_T0, YL_Z_OROGLL_T0)
  CALL SGET_HOST_DATA_RDWR (Z_OROGLM_T0, YL_Z_OROGLM_T0)
  CALL SGET_HOST_DATA_RDWR (Z_OROGMM_T0, YL_Z_OROGMM_T0)
  ...
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_GEOMETRY_OROGLL_T0, YDVARS%GEOMETRY%OROGLL%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_GEOMETRY_OROGLM_T0, YDVARS%GEOMETRY%OROGLM%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_GEOMETRY_OROGL_T0, YDVARS%GEOMETRY%OROGL%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_GEOMETRY_OROGMM_T0, YDVARS%GEOMETRY%OROGMM%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_GEOMETRY_OROGM_T0, YDVARS%GEOMETRY%OROGM%FT0)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('CPG_GP_PARALLEL:MAP_FACTOR')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_GEOMETRY_OROGLL_T0, YDVARS%GEOMETRY%OROGLL%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_GEOMETRY_OROGLM_T0, YDVARS%GEOMETRY%OROGLM%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_GEOMETRY_OROGL_T0, YDVARS%GEOMETRY%OROGL%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_GEOMETRY_OROGMM_T0, YDVARS%GEOMETRY%OROGMM%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_GEOMETRY_OROGM_T0, YDVARS%GEOMETRY%OROGM%FT0)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_PARALLEL:MAP_FACTOR')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:MAP_FACTOR:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (Z_OROGLL_T0, YL_Z_OROGLL_T0)
  CALL SGET_DEVICE_DATA_RDWR (Z_OROGLM_T0, YL_Z_OROGLM_T0)
  CALL SGET_DEVICE_DATA_RDWR (Z_OROGMM_T0, YL_Z_OROGMM_T0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_DYN0_OROGL, YDCPG_DYN0%F_OROGL)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_DYN0_OROGM, YDCPG_DYN0%F_OROGM)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_GM_T0, YDVARS%GEOMETRY%GM%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_OROGLL_T0, YDVARS%GEOMETRY%OROGLL%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_OROGLM_T0, YDVARS%GEOMETRY%OROGLM%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_OROGL_T0, YDVARS%GEOMETRY%OROGL%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_OROGMM_T0, YDVARS%GEOMETRY%OROGMM%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_OROGM_T0, YDVARS%GEOMETRY%OROGM%FT0)
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:MAP_FACTOR:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:MAP_FACTOR:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, Z_OROGLL_T0, Z_OROGLM_T0,  & 
  !$OMP &          Z_OROGMM_T0, Z_YDCPG_DYN0_OROGL, Z_YDCPG_DYN0_OROGM, Z_YDVARS_GEOMETRY_GM_T0,  & 
  !$OMP &          Z_YDVARS_GEOMETRY_OROGLL_T0, Z_YDVARS_GEOMETRY_OROGLM_T0,  & 
  !$OMP &          Z_YDVARS_GEOMETRY_OROGL_T0, Z_YDVARS_GEOMETRY_OROGMM_T0,  & 
  !$OMP &          Z_YDVARS_GEOMETRY_OROGM_T0)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
  ...
  DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
    ...
    !$OMP PARALLEL DO SIMD  & 
    !$OMP & PRIVATE (JROF, YLCPG_BNDS, ZGM2)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CPG_GP_PARALLEL:GP_SPV')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN9_PRE, YDCPG_DYN9%F_PRE)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN9_PREL, YDCPG_DYN9%F_PREL)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN9_PREM, YDCPG_DYN9%F_PREM)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_SP_DL, YDVARS%SP%FDL)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_SP_DL9, YDVARS%SP%FDL9)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_SP_DM, YDVARS%SP%FDM)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_SP_DM9, YDVARS%SP%FDM9)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_SP_T0, YDVARS%SP%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_SP_T9, YDVARS%SP%FT9)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('CPG_GP_PARALLEL:GP_SPV')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_SP_T0, YDVARS%SP%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_SP_T9, YDVARS%SP%FT9)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_PARALLEL:GP_SPV')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_DYN0_PREL, YDCPG_DYN0%F_PREL)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_DYN0_PREM, YDCPG_DYN0%F_PREM)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_DYN9_PRE, YDCPG_DYN9%F_PRE)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_DYN9_PREL, YDCPG_DYN9%F_PREL)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_DYN9_PREM, YDCPG_DYN9%F_PREM)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_SP_DL, YDVARS%SP%FDL)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_SP_DL9, YDVARS%SP%FDL9)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_SP_DM, YDVARS%SP%FDM)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_SP_DM9, YDVARS%SP%FDM9)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_SP_T0, YDVARS%SP%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_SP_T9, YDVARS%SP%FT9)
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:GP_SPV:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:GP_SPV:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDGEOMETRY, YDMODEL, YFXTRAN_ACDC_STACK, Z_YDCPG_DYN0_PRE,  & 
  !$OMP &          Z_YDCPG_DYN0_PREL, Z_YDCPG_DYN0_PREM, Z_YDCPG_DYN9_PRE, Z_YDCPG_DYN9_PREL,  & 
  !$OMP &          Z_YDCPG_DYN9_PREM, Z_YDVARS_SP_DL, Z_YDVARS_SP_DL9, Z_YDVARS_SP_DM,  & 
  !$OMP &          Z_YDVARS_SP_DM9, Z_YDVARS_SP_T0, Z_YDVARS_SP_T9)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (YDMODEL%YRML_DYN%YRDYN%NCURRENT_ITER==0) THEN
  ...
  IF (YDCPG_OPTS%LDIAB.OR.YDMODEL%YRML_PHY_SLIN%YRPHLC%LSPHLC&
    ...
    ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_PARALLEL:SETZERO')) THEN
      ...
      !$OMP TARGET TEAMS DISTRIBUTE  & 
      !$OMP & MAP(PRESENT:YDCPG_OPTS, YFXTRAN_ACDC_STACK, Z_YDCPG_MISC_QS)  & 
      !$OMP & PRIVATE (JBLK)  & 
      !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CPG_GP_PARALLEL:GPINISLB_PART1_EXPL')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN9_NHX, YDCPG_DYN9%F_NHX)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QGRAUPEL, YDCPG_MISC%F_QGRAUPEL)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QICE, YDCPG_MISC%F_QICE)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QLI, YDCPG_MISC%F_QLI)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QRAIN, YDCPG_MISC%F_QRAIN)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QSNOW, YDCPG_MISC%F_QSNOW)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_G_T0, YDVARS%G%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_G_T9, YDVARS%G%FT9)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_I_T0, YDVARS%I%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_I_T9, YDVARS%I%FT9)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_L_T0, YDVARS%L%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_L_T9, YDVARS%L%FT9)
  CALL SGET_HOST_DATA_RDWR (Z_YDVARS_NHX_T1, YDVARS%NHX%FT1)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_R_T0, YDVARS%R%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_R_T9, YDVARS%R%FT9)
  ...
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_S_T0, YDVARS%S%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_S_T9, YDVARS%S%FT9)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('CPG_GP_PARALLEL:GPINISLB_PART1_EXPL')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DYN9_NHX, YDCPG_DYN9%F_NHX)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QGRAUPEL, YDCPG_MISC%F_QGRAUPEL)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QICE, YDCPG_MISC%F_QICE)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QLI, YDCPG_MISC%F_QLI)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QRAIN, YDCPG_MISC%F_QRAIN)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QSNOW, YDCPG_MISC%F_QSNOW)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_G_T0, YDVARS%G%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_G_T9, YDVARS%G%FT9)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_I_T0, YDVARS%I%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_I_T9, YDVARS%I%FT9)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_L_T0, YDVARS%L%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_L_T9, YDVARS%L%FT9)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_NHX_T1, YDVARS%NHX%FT1)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_R_T0, YDVARS%R%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_R_T9, YDVARS%R%FT9)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_SPD_T1, YDVARS%SPD%FT1)
    ...
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_S_T0, YDVARS%S%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_S_T9, YDVARS%S%FT9)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_T_T1, YDVARS%T%FT1)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:GPINISLB_PART1_EXPL:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN9_NHX, YDCPG_DYN9%F_NHX)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_MISC_QGRAUPEL, YDCPG_MISC%F_QGRAUPEL)
  ...
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_MISC_QRAIN, YDCPG_MISC%F_QRAIN)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_MISC_QSNOW, YDCPG_MISC%F_QSNOW)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_G_T0, YDVARS%G%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_G_T9, YDVARS%G%FT9)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_I_T0, YDVARS%I%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_I_T9, YDVARS%I%FT9)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_L_T0, YDVARS%L%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_L_T9, YDVARS%L%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_NHX_T1, YDVARS%NHX%FT1)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_R_T0, YDVARS%R%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_R_T9, YDVARS%R%FT9)
  ...
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_S_T0, YDVARS%S%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_S_T9, YDVARS%S%FT9)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDGEOMETRY, YDMODEL, YFXTRAN_ACDC_STACK, Z_YDCPG_DYN9_NHX,  & 
  !$OMP &          Z_YDCPG_MISC_QGRAUPEL, Z_YDCPG_MISC_QICE, Z_YDCPG_MISC_QLI,  & 
  !$OMP &          Z_YDCPG_MISC_QRAIN, Z_YDCPG_MISC_QSNOW, Z_YDVARS_G_T0, Z_YDVARS_G_T9,  & 
  !$OMP &          Z_YDVARS_I_T0, Z_YDVARS_I_T9, Z_YDVARS_L_T0, Z_YDVARS_L_T9,  & 
  !$OMP &          Z_YDVARS_NHX_T1, Z_YDVARS_R_T0, Z_YDVARS_R_T9, Z_YDVARS_SPD_T1,  & 
  !$OMP &          Z_YDVARS_SPD_T9, Z_YDVARS_SP_T1, Z_YDVARS_SP_T9, Z_YDVARS_SVD_T1,  & 
  !$OMP &          Z_YDVARS_SVD_T9, Z_YDVARS_S_T0, Z_YDVARS_S_T9, Z_YDVARS_T_T1,  & 
  !$OMP &          Z_YDVARS_T_T9, Z_YDVARS_U_T1, Z_YDVARS_U_T9, Z_YDVARS_V_T1,  & 
  !$OMP &          Z_YDVARS_V_T9)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CPG_GP_PARALLEL:GPINISLB_PART3_EXPL')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (Z_GDW_T0, YL_Z_GDW_T0)
  CALL SGET_HOST_DATA_RDONLY (Z_GWHT_T0, YL_Z_GWHT_T0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN0_CTY_VVEL, YDCPG_DYN0%CTY%F_VVEL)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN0_GWFT, YDCPG_DYN0%F_GWFT)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN0_PREF, YDCPG_DYN0%F_PREF)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_GDW, YDCPG_SL2%F_GDW)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_GWF, YDCPG_SL2%F_GWF)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_GWS, YDCPG_SL2%F_GWS)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_VVEL, YDCPG_SL2%F_VVEL)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('CPG_GP_PARALLEL:GPINISLB_PART3_EXPL')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (Z_GDW_T0, YL_Z_GDW_T0)
    CALL SGET_HOST_DATA_RDWR (Z_GWHT_T0, YL_Z_GWHT_T0)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:GPINISLB_PART3_EXPL:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (Z_GDW_T0, YL_Z_GDW_T0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_GWHT_T0, YL_Z_GWHT_T0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN0_CTY_VVEL, YDCPG_DYN0%CTY%F_VVEL)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN0_GWFT, YDCPG_DYN0%F_GWFT)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN0_PREF, YDCPG_DYN0%F_PREF)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL2_GDW, YDCPG_SL2%F_GDW)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL2_GWF, YDCPG_SL2%F_GWF)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL2_GWS, YDCPG_SL2%F_GWS)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL2_VVEL, YDCPG_SL2%F_VVEL)
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:GPINISLB_PART3_EXPL:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:GPINISLB_PART3_EXPL:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDGEOMETRY, YDMODEL, YFXTRAN_ACDC_STACK, Z_GDW_T0,  & 
  !$OMP &          Z_GWHT_T0, Z_YDCPG_DYN0_CTY_VVEL, Z_YDCPG_DYN0_GWFT, Z_YDCPG_DYN0_PREF,  & 
  !$OMP &          Z_YDCPG_SL2_GDW, Z_YDCPG_SL2_GWF, Z_YDCPG_SL2_GWS, Z_YDCPG_SL2_VVEL)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
