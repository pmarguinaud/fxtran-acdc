...
PROCEDURE :: COPY => COPY_FIELD_4RD_ARRAY
PROCEDURE :: CRC64 => CRC64_FIELD_4RD_ARRAY
PROCEDURE :: HOST => HOST_FIELD_4RD_ARRAY
PROCEDURE :: LOAD => LOAD_FIELD_4RD_ARRAY
PROCEDURE :: SAVE => SAVE_FIELD_4RD_ARRAY
PROCEDURE :: SIZE => SIZE_FIELD_4RD_ARRAY
PROCEDURE :: WIPE => WIPE_FIELD_4RD_ARRAY
END TYPE
...
MODULE SUBROUTINE COPY_FIELD_4RD_ARRAY (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_FIELD_4RD_ARRAY (SELF, KLUN, CDPATH)
USE FIELD_UTIL_MODULE
...
MODULE SUBROUTINE HOST_FIELD_4RD_ARRAY (SELF)
USE FIELD_UTIL_MODULE
...
MODULE SUBROUTINE LOAD_FIELD_4RD_ARRAY (SELF, KLUN)
USE FIELD_UTIL_MODULE
...
MODULE SUBROUTINE SAVE_FIELD_4RD_ARRAY (SELF, KLUN)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (FIELD_4RD_ARRAY), INTENT (IN), TARGET :: SELF
INTEGER, INTENT (IN) :: KLUN
...
MODULE FUNCTION SIZE_FIELD_4RD_ARRAY (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (FIELD_4RD_ARRAY),     INTENT (IN), TARGET :: SELF
...
MODULE SUBROUTINE WIPE_FIELD_4RD_ARRAY (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (FIELD_4RD_ARRAY), INTENT (IN), TARGET :: SELF
