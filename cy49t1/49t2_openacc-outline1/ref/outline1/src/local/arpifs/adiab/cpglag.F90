...
CALL CPGLAG_OUTLINE_000 (YDVARS, YDMODEL, YDCPG_SL2, YDGEOMETRY, YDCPG_BNDS)
...
IF (YDMODEL%YRML_DYN%YRDYNA%LSPRT) THEN
  ...
  CALL CPGLAG_OUTLINE_001 (ZRD_R, YDVARS, YDGEOMETRY, YDCPG_BNDS, ZR1)
ENDIF
...
IF (LLSTR) THEN
  CALL CPGLAG_STR (YDVARS, YDGEOMETRY, YDCPG_BNDS)
ENDIF
