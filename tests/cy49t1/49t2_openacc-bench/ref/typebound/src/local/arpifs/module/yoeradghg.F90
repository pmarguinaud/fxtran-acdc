...
PROCEDURE :: COPY => COPY_TRADGHG
PROCEDURE :: CRC64 => CRC64_TRADGHG
PROCEDURE :: HOST => HOST_TRADGHG
PROCEDURE :: LOAD => LOAD_TRADGHG
PROCEDURE :: SAVE => SAVE_TRADGHG
PROCEDURE :: SIZE => SIZE_TRADGHG
PROCEDURE :: WIPE => WIPE_TRADGHG
END TYPE TRADGHG
...
MODULE SUBROUTINE HOST_TRADGHG (SELF)
