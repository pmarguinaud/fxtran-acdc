...
CONTAINS
PROCEDURE :: COPY => COPY_TYPE_AERO_WVL_DIAG
PROCEDURE :: CRC64 => CRC64_TYPE_AERO_WVL_DIAG
PROCEDURE :: HOST => HOST_TYPE_AERO_WVL_DIAG
PROCEDURE :: LEGACY => LEGACY_TYPE_AERO_WVL_DIAG
PROCEDURE :: LOAD => LOAD_TYPE_AERO_WVL_DIAG
PROCEDURE :: SAVE => SAVE_TYPE_AERO_WVL_DIAG
PROCEDURE :: SIZE => SIZE_TYPE_AERO_WVL_DIAG
PROCEDURE :: WIPE => WIPE_TYPE_AERO_WVL_DIAG
...
MODULE SUBROUTINE COPY_TYPE_AERO_WVL_DIAG (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TYPE_AERO_WVL_DIAG (SELF)

IMPLICIT NONE
CLASS (TYPE_AERO_WVL_DIAG), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LEGACY_TYPE_AERO_WVL_DIAG (SELF, KADDRL, KADDRU, KDIR)
...
MODULE SUBROUTINE LOAD_TYPE_AERO_WVL_DIAG (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TYPE_AERO_WVL_DIAG (SELF, KLUN)
...
MODULE FUNCTION SIZE_TYPE_AERO_WVL_DIAG (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TYPE_AERO_WVL_DIAG (SELF, LDDELETED, LDFIELDAPI)
