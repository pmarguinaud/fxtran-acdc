...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ACVPPKF_PARALLEL:PART2')) THEN
  ...
  !$ACC PARALLEL LOOP GANG  & 
  !$ACC & COPYIN (D)  & 
  !$ACC & PRESENT (ICLBASS_GATHER, ICLTOPS_GATHER, ISDPL_GATHER, ISLCL_GATHER, ISPBL_GATHER, LLTRIG1_GATHER, YDCPG_OPTS, YDML_PHY_MF,  & 
  !$ACC &          YFXTRAN_ACDC_STACK, ZPABS_GATHER, ZRC_GATHER, ZRCTEN_GATHER, ZRI_GATHER, ZRITEN_GATHER, ZRV_GATHER, ZRVTEN_GATHER, ZSHAL_ZCH1_GATHER,  & 
  !$ACC &          ZSHAL_ZCH1TENS_GATHER, ZSRVLCL_GATHER, ZSTHES_GATHER, ZSTHLCL_GATHER, ZSTHV_GATHER, ZSTHVELCL_GATHER, ZSTLCL_GATHER,  & 
  !$ACC &          ZSWLCL_GATHER, ZSZLCL_GATHER, ZT_GATHER, ZTHT_GATHER, ZTTEN_GATHER, ZZUMF_GATHER, ZZZ_GATHER)  & 
  !$ACC & PRIVATE (JBLK)  & 
  !$ACC & VECTOR_LENGTH (YDCPG_OPTS%KLON) &
  !$ACC & COPYIN (YL_FGS)       
