...
&, YGFL, YDCHEM, YDSPP_CONFIG, YDPERTPAR, KIDIA, KFDIA, KLON, KGPBLKS, KSMAX, KLEV, PDX, KSPPN2D, LDMCAPEA&
...
&, PVDISCU, PDISS, KTRAC, PCM1, PTENC, PSCAV, PSCAV0, LDACC)
...
& YDSPP_CONFIG, YDPERTPAR, KIDIA, KFDIA, KLON, KGPBLKS, KLEV, PDX, LLTDKMF, LDMCAPEA, LDLAND, PTSPHY&
&, ZTP1, ZQP1, ZUP1, ZVP1, PLITOT, PVERVEL, ZQSAT, PQHFL, PAHFS, PAP, PAPH, PGEO, PGEOH, PGAW, PCUCONVCA&
...
&, PVDISCU, PDISS, KTRAC, ZCP1, PTENC, PSCAV, PSCAV0, LDACC = LDACC)
