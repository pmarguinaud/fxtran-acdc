...
CONTAINS
PROCEDURE :: COPY => COPY_TTOPH
PROCEDURE :: CRC64 => CRC64_TTOPH
PROCEDURE :: HOST => HOST_TTOPH
PROCEDURE :: LOAD => LOAD_TTOPH
PROCEDURE :: SAVE => SAVE_TTOPH
PROCEDURE :: SIZE => SIZE_TTOPH
PROCEDURE :: WIPE => WIPE_TTOPH
END TYPE TTOPH
...
MODULE SUBROUTINE COPY_TTOPH (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TTOPH (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TTOPH (SELF)

IMPLICIT NONE
CLASS (TTOPH), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TTOPH (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TTOPH (SELF, KLUN)
...
MODULE FUNCTION SIZE_TTOPH (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TTOPH (SELF, LDDELETED, LDFIELDAPI)
