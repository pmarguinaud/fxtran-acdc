...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SURFACE_PARALLEL:ACDIFV1')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_SURFACE_PARALLEL:ACDIFV1')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_SURFACE_PARALLEL:ACDIFV1')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_SURFACE_PARALLEL:ACDIFV1')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:ACDIFV1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PXTROV, PXURO, PXUROV, YDCPG_OPTS, YDMODEL, YSTACK, ZCFAQ, ZCFAS, ZCFASV, &
    !$ACC&         ZCFBQ, ZCFBS, ZCFBSV, ZDSE, ZDUMMY, ZQT, ZSVM, Z_YDMF_PHYS_BASE_STATE_T, &
...
IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE.AND.YDCPG_OPTS%LCALLSFX) THEN
  ...
  IF (LPARALLELMETHOD ('OpenMP','APL_ARPEGE_SURFACE_PARALLEL:1')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_SURFACE_PARALLEL:1')) THEN
...
ELSEIF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SURFACE_PARALLEL:LMSE_F')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_SURFACE_PARALLEL:LMSE_F')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_SURFACE_PARALLEL:LMSE_F')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_SURFACE_PARALLEL:LMSE_F')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:LMSE_F:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&         YSTACK, ZCFAS, ZCFBQ, ZCFBQ_G, ZCFBS, ZCFBS_G, ZCFBU_G, ZCFBV_G, ZDSE, &
      !$ACC&         ZFMDU, ZFMDV, Z_YDCPG_MISC_NEB, Z_YDCPG_MISC_QS, Z_YDMF_PHYS_BASE_STATE_T, &
      ...
      !$ACC&         Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W, Z_YDMF_PHYS_BASE_STATE_YGSP_SB_T, &
      !$ACC&         Z_YDMF_PHYS_OUT_CT, Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_DIFTS, &
      !$ACC&         Z_YDMF_PHYS_OUT_FCHSP, Z_YDMF_PHYS_OUT_FCLL, Z_YDMF_PHYS_OUT_FCLN, &
      !$ACC&         Z_YDMF_PHYS_OUT_FCS, Z_YDMF_PHYS_OUT_FEVL, Z_YDMF_PHYS_OUT_FEVN, &
      !$ACC&         Z_YDMF_PHYS_OUT_FEVV, Z_YDMF_PHYS_OUT_FRSO, Z_YDMF_PHYS_OUT_FRTH, &
      !$ACC&         Z_YDMF_PHYS_OUT_FTR, Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, &
      !$ACC&         Z_YDMF_PHYS_SURF_GSD_VH_PQSH, Z_YDMF_PHYS_SURF_GSD_VH_PSPSH, &
      ...
      DO JLON = 1, MIN (YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1) * YDCPG_OPTS%KLON)
        ...
        YLSTACK%U4 = stack_u4 (YSTACK, JBLK-YDCPG_OPTS%JBLKMIN+1, YDCPG_OPTS%KGPBLKS)
          ...
          IF (YDMODEL%YRML_PHY_MF%YRPHY%NDIFFNEB==5) THEN
            CALL ACPY (JLON, PNEBDIFF (:,:, JBLK), PNEBS (:,:, JBLK))
          ELSEIF (YDMODEL%YRML_PHY_MF%YRPHY%NDIFFNEB==2) THEN
          ...
          IF (YDMODEL%YRML_PHY_MF%YRPHY%LEDMFI) THEN
            CALL ACPY (JLON, ZCFBS_G (:,:, JBLK), ZCFBS (:,:, JBLK))
            CALL ACPY (JLON, ZCFBQ_G (:,:, JBLK), ZCFBQ (:,:, JBLK))
            CALL ACPY (JLON, ZCFBU_G (:,:, JBLK), PCFBU (:,:, JBLK))
            CALL ACPY (JLON, ZCFBV_G (:,:, JBLK), PCFBV (:,:, JBLK))
          ENDIF
        ...
        &), Z_YDMF_PHYS_SURF_GSD_VF_PZ0F(:, JBLK), Z_YDMF_PHYS_SURF_GSD_VV_PZ0H(:, JBLK),YDSTACK=YLSTACK)  
          ...
          IF (YDMODEL%YRML_PHY_MF%YRPHY%LEDMFI) THEN
            CALL ACPY (JLON, ZCFBQ (:,:, JBLK), ZCFBQ_G (:,:, JBLK))
            CALL ACPY (JLON, ZCFBS (:,:, JBLK), ZCFBS_G (:,:, JBLK))
            PCFBU (JLON, YDCPG_OPTS%KFLEVG, JBLK)=ZCFBU_G (JLON, YDCPG_OPTS%KFLEVG, JBLK)
            PCFBV (JLON, YDCPG_OPTS%KFLEVG, JBLK)=ZCFBV_G (JLON, YDCPG_OPTS%KFLEVG, JBLK)
          ENDIF
...
ELSEIF (.NOT.YDCPG_OPTS%LCALLSFX) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SURFACE_PARALLEL:CALLSFX_F')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_SURFACE_PARALLEL:CALLSFX_F')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_SURFACE_PARALLEL:CALLSFX_F')) THEN
    ...
    !$OMP PARALLEL DO PRIVATE (JBLK, JLON, JSG, YLCPG_BNDS, YLSTACK)
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_SURFACE_PARALLEL:CALLSFX_F')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:CALLSFX_F:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YSTACK, ZFEV, Z_YDMF_PHYS_OUT_FCS) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
      ...
      !$ACC LOOP VECTOR &
      !$ACC&PRIVATE (JLON, JSG, YLCPG_BNDS, YLSTACK) 
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SURFACE_PARALLEL:ACDIFV2')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_SURFACE_PARALLEL:ACDIFV2')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_SURFACE_PARALLEL:ACDIFV2')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_SURFACE_PARALLEL:ACDIFV2')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:ACDIFV2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         YSTACK, ZCFAQ, ZCFAS, ZCFASV, ZCFBQ, ZCFBS, ZCFBSV, ZDSE, ZFEV, ZFMDU, &
    !$ACC&         ZFMDV, ZQT, ZSFSV, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_U, &
...
IF (YDMODEL%YRML_PHY_MF%YRPHY%LEDKF) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SURFACE_PARALLEL:LEDKF')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_SURFACE_PARALLEL:LEDKF')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_SURFACE_PARALLEL:LEDKF')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_SURFACE_PARALLEL:LEDKF')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:LEDKF:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YSTACK, Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_DIFTS, &
...
IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SURFACE_PARALLEL:LMSE_F2')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_SURFACE_PARALLEL:LMSE_F2')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_SURFACE_PARALLEL:LMSE_F2')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_SURFACE_PARALLEL:LMSE_F2')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SURFACE_PARALLEL:LMSE_F2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (PTSN, YDCPG_OPTS, YSTACK, ZTWSNOW, Z_YDCPG_GPAR_VTS, Z_YDMF_PHYS_SURF_GSP_SG_PF_T1) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ENDSUBROUTINE APL_ARPEGE_SURFACE_PARALLEL
