...
CONTAINS
PROCEDURE :: COPY => COPY_TCOMPO_EMIS
PROCEDURE :: CRC64 => CRC64_TCOMPO_EMIS
PROCEDURE :: HOST => HOST_TCOMPO_EMIS
PROCEDURE :: LOAD => LOAD_TCOMPO_EMIS
PROCEDURE :: SAVE => SAVE_TCOMPO_EMIS
PROCEDURE :: SIZE => SIZE_TCOMPO_EMIS
PROCEDURE :: WIPE => WIPE_TCOMPO_EMIS
...
CONTAINS
PROCEDURE :: COPY => COPY_TCOMPO_EMIS_AUX
PROCEDURE :: CRC64 => CRC64_TCOMPO_EMIS_AUX
PROCEDURE :: HOST => HOST_TCOMPO_EMIS_AUX
PROCEDURE :: LOAD => LOAD_TCOMPO_EMIS_AUX
PROCEDURE :: SAVE => SAVE_TCOMPO_EMIS_AUX
PROCEDURE :: SIZE => SIZE_TCOMPO_EMIS_AUX
PROCEDURE :: WIPE => WIPE_TCOMPO_EMIS_AUX
...
CONTAINS
PROCEDURE :: COPY => COPY_TCOMPO
PROCEDURE :: CRC64 => CRC64_TCOMPO
PROCEDURE :: HOST => HOST_TCOMPO
PROCEDURE :: LOAD => LOAD_TCOMPO
PROCEDURE :: SAVE => SAVE_TCOMPO
PROCEDURE :: SIZE => SIZE_TCOMPO
PROCEDURE :: WIPE => WIPE_TCOMPO
END TYPE TCOMPO 
...
MODULE SUBROUTINE COPY_TCOMPO_EMIS (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TCOMPO_EMIS (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TCOMPO_EMIS (SELF)

IMPLICIT NONE
CLASS (TCOMPO_EMIS), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TCOMPO_EMIS (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TCOMPO_EMIS (SELF, KLUN)
...
MODULE FUNCTION SIZE_TCOMPO_EMIS (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TCOMPO_EMIS (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TCOMPO_EMIS_AUX (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TCOMPO_EMIS_AUX (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE LOAD_TCOMPO_EMIS_AUX (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TCOMPO_EMIS_AUX (SELF, KLUN)
...
MODULE FUNCTION SIZE_TCOMPO_EMIS_AUX (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TCOMPO_EMIS_AUX (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TCOMPO (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TCOMPO (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_TCOMPO (SELF)

IMPLICIT NONE
CLASS (TCOMPO), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TCOMPO (SELF, KLUN)
USE PARKIND1, ONLY : JPRD
...
MODULE SUBROUTINE SAVE_TCOMPO (SELF, KLUN)
...
MODULE FUNCTION SIZE_TCOMPO (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TCOMPO (SELF, LDDELETED, LDFIELDAPI)
