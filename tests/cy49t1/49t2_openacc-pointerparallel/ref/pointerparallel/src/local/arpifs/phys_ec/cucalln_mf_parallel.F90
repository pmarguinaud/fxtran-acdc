...
IF (LPARALLELMETHOD ('OPENMP','CUCALLN_MF_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUCALLN_MF_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&PRESENT (PFPLCL, PFPLCN, PTENQ, PTENT, PTENU, PTENV, YSTACK, ZENTHD, ZENTHS, ZQEA, &
    !$ACC&         ZTEA, ZUEA, ZVEA) &
    !$ACC&PRIVATE (JBLK) &
...
IF (LPARALLELMETHOD ('OPENMP','CUCALLN_MF_PARALLEL:1')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUCALLN_MF_PARALLEL:1')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (PCM1, PQM1, PTENC, PTENQ, PTENT, PTENU, PTENV, PTM1, PUM1, PVM1, YSTACK, &
...
IF (LPARALLELMETHOD ('OPENMP','CUCALLN_MF_PARALLEL:2')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUCALLN_MF_PARALLEL:2')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (PAP, YSTACK, ZQSAT, ZRAIN, ZTP1) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUCALLN_MF_PARALLEL:3')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUCALLN_MF_PARALLEL:3')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (KBASEC, KCBOT, KCTOP, KTOPC, LDCUM, PARPRC, PLU, PMFU, YSTACK, ZQU, ZRAIN) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUCALLN_MF_PARALLEL:4')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUCALLN_MF_PARALLEL:4')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUCALLN_MF_PARALLEL:4:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PLUDELI, PSTRCU, PSTRCV, PTENQ, PTENT, PTENU, PTENV, YSTACK, ZCONDFLL, &
    !$ACC&         ZCONDFLN, ZQEA, ZQP1, ZTEA, ZUEA, ZVEA) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ENDSUBROUTINE CUCALLN_MF_PARALLEL
