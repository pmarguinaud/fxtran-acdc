...
IF (LY2FSL) THEN
  ...
  DO J1 = LBOUND (SELF%Y2FSL, 1), UBOUND (SELF%Y2FSL, 1)
    CALL SELF%Y2FSL (J1)%COPY (LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)
  ENDDO
...
IF (LY3FSL) THEN
  ...
  DO J1 = LBOUND (SELF%Y3FSL, 1), UBOUND (SELF%Y3FSL, 1)
    CALL SELF%Y3FSL (J1)%COPY (LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)
  ENDDO
...
IF (LY2FSLA) THEN
  ...
  DO J1 = LBOUND (SELF%Y2FSLA, 1), UBOUND (SELF%Y2FSLA, 1)
    CALL SELF%Y2FSLA (J1)%COPY (LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)
  ENDDO
...
IF (LY3FSLA) THEN
  ...
  DO J1 = LBOUND (SELF%Y3FSLA, 1), UBOUND (SELF%Y3FSLA, 1)
    CALL SELF%Y3FSLA (J1)%COPY (LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)
  ENDDO
...
IF (LY2FSLB) THEN
  ...
  DO J1 = LBOUND (SELF%Y2FSLB, 1), UBOUND (SELF%Y2FSLB, 1)
    CALL SELF%Y2FSLB (J1)%COPY (LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)
  ENDDO
...
IF (LY3FSLB) THEN
  ...
  DO J1 = LBOUND (SELF%Y3FSLB, 1), UBOUND (SELF%Y3FSLB, 1)
    CALL SELF%Y3FSLB (J1)%COPY (LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)
  ENDDO
