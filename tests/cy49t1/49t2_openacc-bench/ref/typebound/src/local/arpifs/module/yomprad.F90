...
PROCEDURE :: COPY => COPY_RADIATION_GRID_STRUCT
PROCEDURE :: CRC64 => CRC64_RADIATION_GRID_STRUCT
PROCEDURE :: HOST => HOST_RADIATION_GRID_STRUCT
PROCEDURE :: LOAD => LOAD_RADIATION_GRID_STRUCT
PROCEDURE :: SAVE => SAVE_RADIATION_GRID_STRUCT
PROCEDURE :: SIZE => SIZE_RADIATION_GRID_STRUCT
PROCEDURE :: WIPE => WIPE_RADIATION_GRID_STRUCT
END TYPE RADIATION_GRID_STRUCT
!============================================================================

INTERFACE

MODULE SUBROUTINE COPY_RADIATION_GRID_STRUCT (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_RADIATION_GRID_STRUCT (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_RADIATION_GRID_STRUCT (SELF)

IMPLICIT NONE
CLASS (RADIATION_GRID_STRUCT), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_RADIATION_GRID_STRUCT (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_RADIATION_GRID_STRUCT (SELF, KLUN)
...
MODULE FUNCTION SIZE_RADIATION_GRID_STRUCT (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_RADIATION_GRID_STRUCT (SELF, LDDELETED, LDFIELDAPI)
