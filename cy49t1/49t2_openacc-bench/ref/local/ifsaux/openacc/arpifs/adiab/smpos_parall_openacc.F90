...
DO JROF=KST, KEND
  ZCOSPHI=SQRT (MAX (0._JPRB, 1._JPRB-PGEMU (JLON)**2))
  ZX_MC=YDMODEL%YRML_GCONF%YRRIP%RLUNDI*COS (YDMODEL%YRML_GCONF%YRRIP%RDECLU)*COS (YDMODEL%YRCST&
  &%RPI-YDMODEL%YRML_GCONF%YRRIP%RTMOLT)-YDMODEL%YRCST%RA*ZCOSPHI*COS (PGELAM (JLON))
  ZY_MC=YDMODEL%YRML_GCONF%YRRIP%RLUNDI*COS (YDMODEL%YRML_GCONF%YRRIP%RDECLU)*SIN (YDMODEL%YRCST&
  &%RPI-YDMODEL%YRML_GCONF%YRRIP%RTMOLT)-YDMODEL%YRCST%RA*ZCOSPHI*SIN (PGELAM (JLON))
  ZZ_MC=YDMODEL%YRML_GCONF%YRRIP%RLUNDI*SIN (YDMODEL%YRML_GCONF&
  &%YRRIP%RDECLU)-YDMODEL%YRCST%RA*PGEMU (JLON)
  ZX_EST=-SIN (PGELAM (JLON))
  ZY_EST=COS (PGELAM (JLON))
  ZZ_EST=0._JPRB
  ZX_NOR=-PGEMU (JLON)*COS (PGELAM (JLON))
  ZY_NOR=-PGEMU (JLON)*SIN (PGELAM (JLON))
  ZZ_NOR=ZCOSPHI
  ZX_ZEN=ZCOSPHI*COS (PGELAM (JLON))
  ZY_ZEN=ZCOSPHI*SIN (PGELAM (JLON))
  ZZ_ZEN=PGEMU (JLON)
  ...
  &%RPI-YDMODEL%YRML_GCONF%YRRIP%RWSOVR)-YDMODEL%YRCST%RA*ZCOSPHI*COS (PGELAM (JLON))
  ZY_MC=YDMODEL%YRML_GCONF%YRRIP%RDEASO*COS (YDMODEL%YRML_GCONF%YRRIP%RDECLI)*SIN (YDMODEL%YRCST&
  &%RPI-YDMODEL%YRML_GCONF%YRRIP%RWSOVR)-YDMODEL%YRCST%RA*ZCOSPHI*SIN (PGELAM (JLON))
  ZZ_MC=YDMODEL%YRML_GCONF%YRRIP%RDEASO*SIN (YDMODEL%YRML_GCONF&
  &%YRRIP%RDECLI)-YDMODEL%YRCST%RA*PGEMU (JLON)
  ...
  PSOLO (JLON)=MAX (0._JPRB, MIN (1._JPRB, ZCRIT_NONE*ZDEGO_NONE+(1._JPRB-ZCRIT_NONE)*(ZCRIT_TOTA*ZDEGO_TOTA&
...
ENDSUBROUTINE SMPOS_PARALL_OPENACC
