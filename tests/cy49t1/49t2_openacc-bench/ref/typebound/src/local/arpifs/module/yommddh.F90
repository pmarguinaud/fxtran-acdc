...
CONTAINS
PROCEDURE :: COPY => COPY_TMDDH
PROCEDURE :: CRC64 => CRC64_TMDDH
PROCEDURE :: HOST => HOST_TMDDH
PROCEDURE :: LOAD => LOAD_TMDDH
PROCEDURE :: SAVE => SAVE_TMDDH
PROCEDURE :: SIZE => SIZE_TMDDH
PROCEDURE :: WIPE => WIPE_TMDDH
END TYPE TMDDH
...
MODULE SUBROUTINE HOST_TMDDH (SELF)
...
MODULE SUBROUTINE WIPE_TMDDH (SELF, LDDELETED, LDFIELDAPI)
