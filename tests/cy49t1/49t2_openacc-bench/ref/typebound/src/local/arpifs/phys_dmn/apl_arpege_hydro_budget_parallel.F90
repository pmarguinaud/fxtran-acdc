...
IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_HYDRO_BUDGET_PARALLEL:LMSE')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_HYDRO_BUDGET_PARALLEL:LMSE')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_HYDRO_BUDGET_PARALLEL:LMSE')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_HYDRO_BUDGET_PARALLEL:LMSE')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_HYDRO_BUDGET_PARALLEL:LMSE:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&PRESENT (PFPLSL, PFPLSN, YDCPG_OPTS, YSTACK, Z_YDCPG_GPAR_RAIN, Z_YDCPG_GPAR_SNOW, &
...
ELSEIF (YDMODEL%YRML_PHY_MF%YRPHY%LSOLV) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_HYDRO_BUDGET_PARALLEL:ACDROV')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_HYDRO_BUDGET_PARALLEL:ACDROV')) THEN
      IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_HYDRO_BUDGET_PARALLEL&
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_HYDRO_BUDGET_PARALLEL:ACDROV')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_HYDRO_BUDGET_PARALLEL:ACDROV')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_HYDRO_BUDGET_PARALLEL:ACDROV:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&         PFPLSN, PWFC, PWLMX, PWPMX, PWSEQ, PWSMX, YDCPG_OPTS, YDMODEL, YSTACK, &
...
ENDSUBROUTINE APL_ARPEGE_HYDRO_BUDGET_PARALLEL
