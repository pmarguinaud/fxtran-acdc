...
IF (YDCFU%YFDUTP%LACTIVE) THEN
  CALL CPCFU_OUTLINE_000 (LLRESET, YDCPG_OPTS, YDMF_PHYS_OUT, YDCFU, JLEV, YDCPG_BNDS, YDRIP)
ENDIF

CALL CPCFU_OUTLINE_001 (LLRESET, YDCPG_MISC, YDCPG_OPTS, YDMF_PHYS_OUT, YDCFU&
&, YDCPG_BNDS, YDRIP, PSTRDU, PSTRDV, PSTRCV, PSTRTV, PSTRCU, PSTRTU)
CALL CPCFU_OUTLINE_002 (LLNORESET, LLRESET, YDCPG_DYN0, YDCPG_MISC, ITIME&
...
CALL CPCFU_OUTLINE_003 (LLFRRC, LLNORESET, LLRESET, YDCFU, ITIME, YDMF_PHYS_OUT, YDCPG_BNDS, YDRIP)

IF (YDCFU%YFCL%LACTIVE) THEN
  CALL CPCFU_OUTLINE_004 (LLNORESET, LLRESET, YDCFU, ITIME, YDMF_PHYS_OUT, YDCPG_BNDS, YDRIP)
ENDIF

CALL CPCFU_OUTLINE_005 (LLRESET, YDVARS, YDCPG_MISC, YDCPG_DYN0&
