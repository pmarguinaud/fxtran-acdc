...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_MF_PHYS_NEXT_STATE_2D_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_MF_PHYS_NEXT_STATE_2D_TYPE
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_MF_PHYS_NEXT_STATE_3D_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_MF_PHYS_NEXT_STATE_3D_TYPE
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_MF_PHYS_NEXT_STATE_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_MF_PHYS_NEXT_STATE_TYPE
...
MODULE SUBROUTINE ACDC_COPY_MF_PHYS_NEXT_STATE_3D_TYPE (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (MF_PHYS_NEXT_STATE_3D_TYPE), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDCREATED, LDFIELDAPI
END SUBROUTINE

MODULE SUBROUTINE ACDC_WIPE_MF_PHYS_NEXT_STATE_3D_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (MF_PHYS_NEXT_STATE_3D_TYPE), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
