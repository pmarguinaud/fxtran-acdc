...
PROCEDURE :: COPY => COPY_CPG_TNDSI_DDH_TYPE
PROCEDURE :: HOST => HOST_CPG_TNDSI_DDH_TYPE
PROCEDURE :: WIPE => WIPE_CPG_TNDSI_DDH_TYPE
...
PROCEDURE :: COPY => COPY_CPG_TNDHD_DDH_TYPE
PROCEDURE :: HOST => HOST_CPG_TNDHD_DDH_TYPE
PROCEDURE :: WIPE => WIPE_CPG_TNDHD_DDH_TYPE
...
CONTAINS
PROCEDURE :: COPY => COPY_CPG_TNDSL_DDH_3D_TYPE
PROCEDURE :: HOST => HOST_CPG_TNDSL_DDH_3D_TYPE
PROCEDURE :: WIPE => WIPE_CPG_TNDSL_DDH_3D_TYPE
...
PROCEDURE :: COPY => COPY_CPG_TNDSL_DDH_TYPE
PROCEDURE :: HOST => HOST_CPG_TNDSL_DDH_TYPE
PROCEDURE :: WIPE => WIPE_CPG_TNDSL_DDH_TYPE
...
PROCEDURE :: COPY => COPY_CPG_DDH_TND_TYPE
PROCEDURE :: HOST => HOST_CPG_DDH_TND_TYPE
PROCEDURE :: WIPE => WIPE_CPG_DDH_TND_TYPE
END TYPE CPG_DDH_TND_TYPE

INTERFACE

MODULE SUBROUTINE COPY_CPG_TNDSI_DDH_TYPE (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE WIPE_CPG_TNDSI_DDH_TYPE (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_CPG_TNDHD_DDH_TYPE (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_CPG_TNDHD_DDH_TYPE (SELF)
USE FIELD_UTIL_MODULE
...
MODULE SUBROUTINE WIPE_CPG_TNDHD_DDH_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_TNDHD_DDH_TYPE), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
...
MODULE SUBROUTINE COPY_CPG_TNDSL_DDH_3D_TYPE (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
...
MODULE SUBROUTINE HOST_CPG_TNDSL_DDH_3D_TYPE (SELF)
USE FIELD_UTIL_MODULE
...
MODULE SUBROUTINE WIPE_CPG_TNDSL_DDH_3D_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_TNDSL_DDH_3D_TYPE), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
...
MODULE SUBROUTINE COPY_CPG_TNDSL_DDH_TYPE (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_CPG_DDH_TND_TYPE (SELF, LDCREATED, LDFIELDAPI)
