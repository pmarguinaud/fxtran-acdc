...
CONTAINS
PROCEDURE :: COPY => COPY_TPHYDS
PROCEDURE :: CRC64 => CRC64_TPHYDS
PROCEDURE :: HOST => HOST_TPHYDS
PROCEDURE :: LOAD => LOAD_TPHYDS
PROCEDURE :: SAVE => SAVE_TPHYDS
PROCEDURE :: SIZE => SIZE_TPHYDS
PROCEDURE :: WIPE => WIPE_TPHYDS
END TYPE TPHYDS
...
MODULE SUBROUTINE COPY_TPHYDS (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TPHYDS (SELF)

IMPLICIT NONE
CLASS (TPHYDS), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TPHYDS (SELF, KLUN)
...
MODULE SUBROUTINE WIPE_TPHYDS (SELF, LDDELETED, LDFIELDAPI)
