...
CONTAINS
PROCEDURE :: COPY => COPY_CPG_SL1B_2D_TYPE
PROCEDURE :: HOST => HOST_CPG_SL1B_2D_TYPE
PROCEDURE :: WIPE => WIPE_CPG_SL1B_2D_TYPE
END TYPE
...
CONTAINS
PROCEDURE :: COPY => COPY_CPG_SL1B_3D_TYPE
PROCEDURE :: HOST => HOST_CPG_SL1B_3D_TYPE
PROCEDURE :: WIPE => WIPE_CPG_SL1B_3D_TYPE
END TYPE
...
PROCEDURE :: COPY => COPY_CPG_SL1B_TYPE
PROCEDURE :: HOST => HOST_CPG_SL1B_TYPE
PROCEDURE :: WIPE => WIPE_CPG_SL1B_TYPE
...
CONTAINS
PROCEDURE :: COPY => COPY_CPG_SL1F_2D_TYPE
PROCEDURE :: HOST => HOST_CPG_SL1F_2D_TYPE
PROCEDURE :: WIPE => WIPE_CPG_SL1F_2D_TYPE
END TYPE
...
TYPE CPG_SL1F_3D_TYPE
  ...
  TYPE (TYPE_GFL_COMP) :: YCOMP
CONTAINS
PROCEDURE :: COPY => COPY_CPG_SL1F_3D_TYPE
PROCEDURE :: HOST => HOST_CPG_SL1F_3D_TYPE
PROCEDURE :: WIPE => WIPE_CPG_SL1F_3D_TYPE
END TYPE
...
CONTAINS
PROCEDURE :: COPY => COPY_CPG_SL1F_1RB
PROCEDURE :: HOST => HOST_CPG_SL1F_1RB
PROCEDURE :: WIPE => WIPE_CPG_SL1F_1RB
END TYPE
...
TYPE CPG_SL1F_2RB
  ...
  INTEGER (KIND=JPIM) :: JFLD1 = -1, JFLD2 = -1
CONTAINS
PROCEDURE :: COPY => COPY_CPG_SL1F_2RB
PROCEDURE :: HOST => HOST_CPG_SL1F_2RB
PROCEDURE :: WIPE => WIPE_CPG_SL1F_2RB
END TYPE
...
PROCEDURE :: COPY => COPY_CPG_SL1F_TYPE
PROCEDURE :: HOST => HOST_CPG_SL1F_TYPE
PROCEDURE :: WIPE => WIPE_CPG_SL1F_TYPE
...
MODULE SUBROUTINE COPY_CPG_SL1B_2D_TYPE (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_CPG_SL1B_2D_TYPE (SELF)
USE FIELD_UTIL_MODULE
...
MODULE SUBROUTINE WIPE_CPG_SL1B_2D_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_SL1B_2D_TYPE), INTENT (IN), TARGET :: SELF
...
MODULE SUBROUTINE COPY_CPG_SL1B_3D_TYPE (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
...
MODULE SUBROUTINE HOST_CPG_SL1B_3D_TYPE (SELF)
USE FIELD_UTIL_MODULE
...
MODULE SUBROUTINE WIPE_CPG_SL1B_3D_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_SL1B_3D_TYPE), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
...
MODULE SUBROUTINE COPY_CPG_SL1F_2D_TYPE (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
...
MODULE SUBROUTINE HOST_CPG_SL1F_2D_TYPE (SELF)
USE FIELD_UTIL_MODULE
...
MODULE SUBROUTINE WIPE_CPG_SL1F_2D_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_SL1F_2D_TYPE), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
...
MODULE SUBROUTINE COPY_CPG_SL1F_3D_TYPE (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
...
MODULE SUBROUTINE HOST_CPG_SL1F_3D_TYPE (SELF)
USE FIELD_UTIL_MODULE
...
MODULE SUBROUTINE WIPE_CPG_SL1F_3D_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_SL1F_3D_TYPE), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
...
MODULE SUBROUTINE COPY_CPG_SL1F_1RB (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
...
MODULE SUBROUTINE HOST_CPG_SL1F_1RB (SELF)
USE FIELD_UTIL_MODULE
...
MODULE SUBROUTINE WIPE_CPG_SL1F_1RB (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_SL1F_1RB), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
...
MODULE SUBROUTINE COPY_CPG_SL1F_2RB (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
...
MODULE SUBROUTINE HOST_CPG_SL1F_2RB (SELF)
USE FIELD_UTIL_MODULE
...
MODULE SUBROUTINE WIPE_CPG_SL1F_2RB (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_SL1F_2RB), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
...
MODULE SUBROUTINE COPY_CPG_SL1F_TYPE (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
...
MODULE SUBROUTINE HOST_CPG_SL1F_TYPE (SELF)
USE FIELD_UTIL_MODULE
