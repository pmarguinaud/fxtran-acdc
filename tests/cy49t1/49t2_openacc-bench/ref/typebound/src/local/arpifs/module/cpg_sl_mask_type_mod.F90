...
PROCEDURE :: COPY => COPY_CPG_SL_MASK_TYPE
PROCEDURE :: HOST => HOST_CPG_SL_MASK_TYPE
PROCEDURE :: WIPE => WIPE_CPG_SL_MASK_TYPE
END TYPE CPG_SL_MASK_TYPE

INTERFACE

MODULE SUBROUTINE COPY_CPG_SL_MASK_TYPE (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_CPG_SL_MASK_TYPE (SELF)
USE FIELD_UTIL_MODULE
...
MODULE SUBROUTINE WIPE_CPG_SL_MASK_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_SL_MASK_TYPE), INTENT (IN), TARGET :: SELF
