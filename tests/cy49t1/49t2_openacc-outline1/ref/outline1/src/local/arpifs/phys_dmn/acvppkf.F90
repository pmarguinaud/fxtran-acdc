...
CALL ACVPPKF_PART1 (LLOCHTRANS, I_KBDIA, YDCPG_OPTS, KTDIA, I_KCH1, D, IKICE, YDML_PHY_MF&
&, ZSWLCL, ZSTHES, ZTHT, ZRCTEN, ISPBL, ZSTLCL, LLTRIG1, ZRVTEN, ZZUMF, ZTKECLS, ZSHAL_ZCH1TENS&
&, ZSTHVELCL, ISDPL, ZSTHLCL, ISLCL, ZSHAL_ZCH1, ZT, ZRC, ZRI, ZZZ, ICLTOPS, ZRITEN&
&, ICLBASS, ZSZLCL, ZPABS, ZSTHV, ZTTEN, ZZW, ZRV, ZSRVLCL)
CALL ACVPPKF_PART2 (LLOCHTRANS, ZRDOCP, YDCPG_OPTS, I_KCH1, D, IKICE, YDML_PHY_MF&
