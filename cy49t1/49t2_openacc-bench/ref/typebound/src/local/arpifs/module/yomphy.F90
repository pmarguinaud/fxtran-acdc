...
CONTAINS
PROCEDURE :: COPY => COPY_TPHY
PROCEDURE :: CRC64 => CRC64_TPHY
PROCEDURE :: HOST => HOST_TPHY
PROCEDURE :: LOAD => LOAD_TPHY
PROCEDURE :: SAVE => SAVE_TPHY
PROCEDURE :: SIZE => SIZE_TPHY
PROCEDURE :: WIPE => WIPE_TPHY
END TYPE TPHY
