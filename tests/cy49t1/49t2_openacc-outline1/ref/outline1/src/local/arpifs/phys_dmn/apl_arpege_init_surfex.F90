...
IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  CALL APL_ARPEGE_INIT_SURFEX_OUTLINE_000 (YDCPG_GPAR, YDCPG_MISC, YDCPG_OPTS, YDMF_PHYS&
  &, YDMF_PHYS_BASE_STATE, YDCPG_BNDS, PSGROUPEL, PSSNOW, PSRAIN, PTSN, PFLU_EMIS)
  CALL APL_ARPEGE_INIT_SURFEX_OUTLINE_001 (YDCPG_GPAR, YDCPG_OPTS, YDMF_PHYS&
  &, YDMF_PHYS_BASE_STATE, YDMODEL, YDCPG_BNDS, PALBP, PFLU_EMIS, PALBD)

  IF (YDCPG_OPTS%LCONFX) THEN
    CALL APL_ARPEGE_INIT_SURFEX_OUTLINE_002 (YDVARS, YDMF_PHYS, YDGEOMETRY, YDCPG_BNDS)
  ENDIF
