...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_MWAVE_PARALLEL:0')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (ZCOVPTOT, YL_ZCOVPTOT)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_MWAVE_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_MWAVE_PARALLEL:0:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (ZCOVPTOT, YL_ZCOVPTOT)
  ...
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YFXTRAN_ACDC_STACK, ZCOVPTOT, Z_YDCPG_MISC_NEB,  & 
  !$OMP &          Z_YDCPG_MISC_QICE, Z_YDCPG_MISC_QLI, Z_YDMF_PHYS_OUT_FPLCL,  & 
  ...
  DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
    ...
    !$OMP & PRIVATE (JLEV, JLON, YDPHYSMWAVE, YLCPG_BNDS)       
