...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_DPRECIPS_PARALLEL:0')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (PPRC_DPRECIPS, YD_PPRC_DPRECIPS)
  CALL SGET_HOST_DATA_RDWR (PPRC_DPRECIPS2, YD_PPRC_DPRECIPS2)
  CALL SGET_HOST_DATA_RDWR (ZDZZ, YL_ZDZZ)
  CALL SGET_HOST_DATA_RDWR (ZFPLC, YL_ZFPLC)
  CALL SGET_HOST_DATA_RDWR (ZFPLS, YL_ZFPLS)
  CALL SGET_HOST_DATA_RDWR (ZFPLSG, YL_ZFPLSG)
  CALL SGET_HOST_DATA_RDWR (ZTW, YL_ZTW)
  ...
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_DIAGH, YDMF_PHYS%OUT%F_DIAGH)
  ...
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_TPWCLS, YDMF_PHYS%OUT%F_TPWCLS)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_DPRECIPS_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DPRECIPS_PARALLEL:0:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (PPRC_DPRECIPS, YD_PPRC_DPRECIPS)
  CALL SGET_DEVICE_DATA_RDWR (PPRC_DPRECIPS2, YD_PPRC_DPRECIPS2)
  CALL SGET_DEVICE_DATA_RDWR (ZDZZ, YL_ZDZZ)
  CALL SGET_DEVICE_DATA_RDWR (ZFPLC, YL_ZFPLC)
  CALL SGET_DEVICE_DATA_RDWR (ZFPLS, YL_ZFPLS)
  CALL SGET_DEVICE_DATA_RDWR (ZFPLSG, YL_ZFPLSG)
  CALL SGET_DEVICE_DATA_RDWR (ZTW, YL_ZTW)
  ...
  &, YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYDF)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_DIAGH, YDMF_PHYS%OUT%F_DIAGH)
  ...
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_TPWCLS, YDMF_PHYS%OUT%F_TPWCLS)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_OROG_T0, YDVARS%GEOMETRY%OROG%FT0)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DPRECIPS_PARALLEL:0:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DPRECIPS_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:PPRC_DPRECIPS, PPRC_DPRECIPS2, YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK,  & 
  !$OMP &          ZDZZ, ZFPLC, ZFPLS, ZFPLSG, ZTW, ZZZ, Z_YDMF_PHYS_BASE_STATE_I, Z_YDMF_PHYS_BASE_STATE_L,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_Q, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_DIAGH, Z_YDMF_PHYS_OUT_FPLCL, Z_YDMF_PHYS_OUT_FPLCN,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FPLSL, Z_YDMF_PHYS_OUT_FPLSN, Z_YDMF_PHYS_OUT_TPWCLS,  & 
  !$OMP &          Z_YDVARS_GEOMETRY_OROG_T0)  & 
  !$OMP & PRIVATE (JBLK)  & 
