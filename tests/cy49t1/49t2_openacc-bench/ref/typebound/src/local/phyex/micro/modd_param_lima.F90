...
CONTAINS
PROCEDURE :: COPY => COPY_PARAM_LIMA_T
PROCEDURE :: CRC64 => CRC64_PARAM_LIMA_T
PROCEDURE :: HOST => HOST_PARAM_LIMA_T
PROCEDURE :: LOAD => LOAD_PARAM_LIMA_T
PROCEDURE :: SAVE => SAVE_PARAM_LIMA_T
PROCEDURE :: SIZE => SIZE_PARAM_LIMA_T
PROCEDURE :: WIPE => WIPE_PARAM_LIMA_T
...
MODULE SUBROUTINE COPY_PARAM_LIMA_T (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_PARAM_LIMA_T (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_PARAM_LIMA_T (SELF)

IMPLICIT NONE
CLASS (PARAM_LIMA_T), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_PARAM_LIMA_T (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_PARAM_LIMA_T (SELF, KLUN)
...
MODULE FUNCTION SIZE_PARAM_LIMA_T (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_PARAM_LIMA_T (SELF, LDDELETED, LDFIELDAPI)
