...
LCVDAESS = ALLOCATED (SELF%CVDAESS)
IF (LCVDAESS) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%CVDAESS)
  !$OMP TARGET UPDATE TO (SELF%CVDAESS)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%CVDAESS)
ENDIF

LCVDAEDU = ALLOCATED (SELF%CVDAEDU)
IF (LCVDAEDU) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%CVDAEDU)
  !$OMP TARGET UPDATE TO (SELF%CVDAEDU)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%CVDAEDU)
ENDIF

LCVDAEOM = ALLOCATED (SELF%CVDAEOM)
IF (LCVDAEOM) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%CVDAEOM)
  !$OMP TARGET UPDATE TO (SELF%CVDAEOM)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%CVDAEOM)
ENDIF

LCVDAEBC = ALLOCATED (SELF%CVDAEBC)
IF (LCVDAEBC) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%CVDAEBC)
  !$OMP TARGET UPDATE TO (SELF%CVDAEBC)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%CVDAEBC)
ENDIF

LCVDAESU = ALLOCATED (SELF%CVDAESU)
IF (LCVDAESU) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%CVDAESU)
  !$OMP TARGET UPDATE TO (SELF%CVDAESU)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%CVDAESU)
ENDIF
...
LCVDAESS = ALLOCATED (SELF%CVDAESS)
IF (LCVDAESS) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%CVDAESS)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%CVDAESS)
ENDIF

LCVDAEDU = ALLOCATED (SELF%CVDAEDU)
IF (LCVDAEDU) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%CVDAEDU)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%CVDAEDU)
ENDIF

LCVDAEOM = ALLOCATED (SELF%CVDAEOM)
IF (LCVDAEOM) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%CVDAEOM)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%CVDAEOM)
ENDIF

LCVDAEBC = ALLOCATED (SELF%CVDAEBC)
IF (LCVDAEBC) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%CVDAEBC)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%CVDAEBC)
ENDIF

LCVDAESU = ALLOCATED (SELF%CVDAESU)
IF (LCVDAESU) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%CVDAESU)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%CVDAESU)
ENDIF
