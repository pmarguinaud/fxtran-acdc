  ...
  IF (YDDYNA%LTWOTL) THEN
    ...
    DO JGFL=1, SIZE (YDVARS%GFL_PTR)
      ...
      IF (YDVARS%GFL_PTR (JGFL)%LADV) THEN
        ...
        IF (LPARALLELMETHOD ('OPENMP','GPINISLB_PART2_EXPL_PARALLEL:0')) THEN
          ...
          IF (LSYNCHOST ('GPINISLB_PART2_EXPL_PARALLEL:0')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPINISLB_PART2_EXPL_PARALLEL:0')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPINISLB_PART2_EXPL_PARALLEL:0')) THEN
          ...
          IF (LHOOK) CALL DR_HOOK ('GPINISLB_PART2_EXPL_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
            ...
            !$ACC&PRESENT (YDCPG_OPTS, YSTACK, Z_YDVARS_GFL_PTR_T1) &
            !$ACC&PRIVATE (JBLK) &
      ...
      ELSEIF (YDVARS%GFL_PTR (JGFL)%LT1) THEN
        ...
        IF (LPARALLELMETHOD ('OPENMP','GPINISLB_PART2_EXPL_PARALLEL:1')) THEN
          ...
          IF (LSYNCHOST ('GPINISLB_PART2_EXPL_PARALLEL:1')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPINISLB_PART2_EXPL_PARALLEL:1')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPINISLB_PART2_EXPL_PARALLEL:1')) THEN
          ...
          IF (LHOOK) CALL DR_HOOK ('GPINISLB_PART2_EXPL_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
            ...
            !$ACC PARALLEL LOOP GANG &
            !$ACC&PRESENT (YDCPG_OPTS, YSTACK, Z_YDVARS_GFL_PTR_T0, Z_YDVARS_GFL_PTR_T1) &
            !$ACC&PRIVATE (JBLK) &
            !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
  ...
  ELSE
    ...
    DO JGFL=1, SIZE (YDVARS%GFL_PTR)
      ...
      IF (YDVARS%GFL_PTR (JGFL)%LADV) THEN
        ...
        IF (LPARALLELMETHOD ('OPENMP','GPINISLB_PART2_EXPL_PARALLEL:2')) THEN
          ...
          IF (LSYNCHOST ('GPINISLB_PART2_EXPL_PARALLEL:2')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPINISLB_PART2_EXPL_PARALLEL:2')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPINISLB_PART2_EXPL_PARALLEL:2')) THEN
      ...
      ELSEIF (YDVARS%GFL_PTR (JGFL)%LT1) THEN
        ...
        IF (LPARALLELMETHOD ('OPENMP','GPINISLB_PART2_EXPL_PARALLEL:3')) THEN
          ...
          IF (LSYNCHOST ('GPINISLB_PART2_EXPL_PARALLEL:3')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPINISLB_PART2_EXPL_PARALLEL:3')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPINISLB_PART2_EXPL_PARALLEL:3')) THEN
          ...
          IF (LHOOK) CALL DR_HOOK ('GPINISLB_PART2_EXPL_PARALLEL:3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
            ...
            !$ACC PARALLEL LOOP GANG &
            !$ACC&PRESENT (YDCPG_OPTS, YSTACK, Z_YDVARS_GFL_PTR_T1, Z_YDVARS_GFL_PTR_T9) &
            !$ACC&PRIVATE (JBLK) &
            !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
  ...
  IF (YDDYN%NCURRENT_ITER==0) THEN
    ...
    DO JGFL=1, SIZE (YDVARS%GFL_PTR)
      ...
      IF (YDVARS%GFL_PTR (JGFL)%LT1) THEN
        ...
        IF (LPARALLELMETHOD ('OPENMP','GPINISLB_PART2_EXPL_PARALLEL:4')) THEN
          ...
          IF (LSYNCHOST ('GPINISLB_PART2_EXPL_PARALLEL:4')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPINISLB_PART2_EXPL_PARALLEL:4')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPINISLB_PART2_EXPL_PARALLEL:4')) THEN
  ...
  ELSE
    ...
    DO JGFL=1, SIZE (YDVARS%GFL_PTR)
      ...
      IF (YDVARS%GFL_PTR (JGFL)%LT1) THEN
        ...
        IF (LPARALLELMETHOD ('OPENMP','GPINISLB_PART2_EXPL_PARALLEL:5')) THEN
          ...
          IF (LSYNCHOST ('GPINISLB_PART2_EXPL_PARALLEL:5')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPINISLB_PART2_EXPL_PARALLEL:5')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPINISLB_PART2_EXPL_PARALLEL:5')) THEN
...
ENDSUBROUTINE GPINISLB_PART2_EXPL_PARALLEL
