...
&, YDSPP_CONFIG, YDPERTPAR, KIDIA, KFDIA, KLON, KGPBLKS, KLEV, PDX, LDTDKMF, LDMCAPEA, LDLAND, PTSPHY&
...
&, PVDISCU, PDISS, KTRAC, PCEN, PTENC, PSCAV, PSCAV0, LDACC)
...
LLMIXS=LDTDKMF
CALL CUBASEN_MANYBLOCKS (PPLDARE, PPLRG, YDTHF, YDCST, YDML_PHY_SLIN%YREPHLI, YDML_PHY_EC%YRECLDP, YDML_PHY_EC&
&%YRECUMF, YDSPP_CONFIG, KIDIA, KFDIA, KLON, KGPBLKS, KLEV, YDML_PHY_EC%YRECUMF%NJKT1, LLMIXS, LDTDKMF&
&, ZTENH, ZQENH, PGEOH, PAPH, PQHFL, PAHFS, PGP2DSPP, ZKMFL, PTEN, PQEN, PQSEN, PGEO, PTU, PQU, PLU, ZKINEU&
&, ZWUBASE, ILAB, LDCUM, LDSC, KCBOT, KBOTSC, ICTOP0, IDPL, PCAPE, LDACC = LDACC)
...
&%YRECUMF, YDSPP_CONFIG, YGFL, KIDIA, KFDIA, KLON, KGPBLKS, KLEV, LDTDKMF, PTSPHY, ZTENH&
&, ZQENH, PUEN, PVEN, PTEN, PQEN, PQSEN, PLITOT, PGEO, PGEOH, PAP, PAPH, PVERVEL, ZWUBASE&
&, PGP2DSPP, LDLAND, LDCUM, KTYPE, ILAB, LLSCVFLAG, PTU, PQU, PLU, PLRAIN, PMFU, ZMFUB&
&, PLGLAC, ZMFUS, ZMFUQ, ZMFUL, PLUDE, PLUDELI, ZDMFUP, PLCRIT_AER, ZDMFEN, KCBOT, KCTOP&
&, ICTOP0, IDPL, PMFUDE_RATE, ZKINEU, PWU, PWMEAN, LDACC = LDACC)
