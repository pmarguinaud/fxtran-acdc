...
!$ACDC methods  --skip-components TECUCONVCA%YD_RANDOM_STREAM_CA
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_TECUCONVCA
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TECUCONVCA
PROCEDURE :: ACDC_HOST => ACDC_HOST_TECUCONVCA
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TECUCONVCA
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TECUCONVCA
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TECUCONVCA
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TECUCONVCA
END TYPE TECUCONVCA
...
IF (.NOT. YDDYNA%LSLAG) LCUCONV_CA=.FALSE.
