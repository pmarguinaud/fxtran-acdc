...
IF (YDLDDH%LRSIDDH) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','LATTEX_PARALLEL:LRSIDDH')) THEN
    ...
    IF (LSYNCHOST ('LATTEX_PARALLEL:LRSIDDH')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LATTEX_PARALLEL:LRSIDDH')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTEX_PARALLEL:LRSIDDH')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LATTEX_PARALLEL:LRSIDDH:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YSTACK, Z_YDCPG_SL1_PD9_SI_P, &
...
IF (LPARALLELMETHOD ('OPENMP','LATTEX_PARALLEL:MAIN')) THEN
  ...
  IF (LSYNCHOST ('LATTEX_PARALLEL:MAIN')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LATTEX_PARALLEL:MAIN')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTEX_PARALLEL:MAIN')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('LATTEX_PARALLEL:MAIN:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         YDML_GCONF, YSTACK, ZMOY1SPD, ZMOY1T, ZMOY1U, ZMOY1V, ZMOY1VWV, ZSPDSI9, &
    !$ACC&         ZTSI9, ZUSELESS, ZUSI9, ZVSI9, ZVWVSI9, ZWT0, Z_YDCPG_SL1_NHX9_P, &
    ...
    DO JROF = 1, MIN (YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1) * YDCPG_OPTS%KLON)
        ...
        IF (YDML_DYN%YRDYNA%LTWOTL) THEN
          ...
          IF ((YDML_DYN%YRDYNA%NVDVAR==4.OR.YDML_DYN%YRDYNA%NVDVAR==5).AND.YDML_DYN%YRDYNA%ND4SYS==1) THEN
            ...
            IF (.NOT.LLCT) THEN
              ...
              CALL ACPY (JROF, Z_YDVARS_NHX_T9 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG&
              &, JBLK), PNHXT0 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK))
            ELSE
      ...
      IF (YDML_DYN%YRDYNA%LNHDYN.AND.YDML_DYN%YRDYNA%LGWADV) THEN
        ...
        IF (YDML_DYN%YRDYNA%LTWOTL) THEN
          ...
          IF (YDML_DYN%YRDYNA%LPC_FULL.AND.YDML_DYN%YRDYN%NCURRENT_ITER==0) THEN
            CALL ACPY (JROF, Z_YDVARS_GW_T9 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG&
            &, JBLK), PGWT0 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK))
          ENDIF
...
IF (YDML_DYN%YRDYN%LRHS_CURV) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','LATTEX_PARALLEL:LRHS_CURV')) THEN
    ...
    IF (LSYNCHOST ('LATTEX_PARALLEL:LRHS_CURV')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LATTEX_PARALLEL:LRHS_CURV')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTEX_PARALLEL:LRHS_CURV')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LATTEX_PARALLEL:LRHS_CURV:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YSTACK, ZUCOMP, Z_YDCPG_SL1_U0_P, &
      !$ACC&         Z_YDCPG_SL1_U9_P, Z_YDCPG_SL1_V0_P, Z_YDCPG_SL1_V9_P, Z_YDCPG_SL1_Z0_P, &
      !$ACC&         Z_YDCPG_SL1_Z9_P, Z_YDVARS_GEOMETRY_GECLO_P, Z_YDVARS_GEOMETRY_GEMU_P, &
      !$ACC&         Z_YDVARS_GEOMETRY_GESLO_P, Z_YDVARS_GEOMETRY_GSQM2_P) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
