...
IF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_ALBEDO_COMPUTATION_PARALLEL:0')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZMERL, YL_ZMERL)
    ...
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PALBF, YDMF_PHYS_SURF%GSD_VF%F_ALBF)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PEMISF, YDMF_PHYS_SURF%GSD_VF%F_EMISF)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_ALBEDO_COMPUTATION_PARALLEL:0')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_ALB, YDMF_PHYS%OUT%F_ALB)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PALBF, YDMF_PHYS_SURF%GSD_VF%F_ALBF)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PEMISF, YDMF_PHYS_SURF%GSD_VF%F_EMISF)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
    ...
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PALBF, YDMF_PHYS_SURF%GSD_VF%F_ALBF)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PEMISF, YDMF_PHYS_SURF%GSD_VF%F_EMISF)
    ...
    !$OMP & MAP(PRESENT:PALBD, PALBDIR, PALBP, PFLU_EMIS, PFLU_NEIJ, PRDG_MU0, YDCPG_OPTS,  & 
    !$OMP &          YDMODEL, YFXTRAN_ACDC_STACK, ZMERL, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_ALB, Z_YDMF_PHYS_SURF_GSD_VF_PALBF, Z_YDMF_PHYS_SURF_GSD_VF_PEMISF,  & 
    !$OMP &          Z_YDMF_PHYS_SURF_GSD_VF_PLSM)  & 
    !$OMP & PRIVATE (JBLK)  & 
    ...
    DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
      ...
      !$OMP & PRIVATE (JLON, JSG, YLCPG_BNDS, ZLAMB)       
