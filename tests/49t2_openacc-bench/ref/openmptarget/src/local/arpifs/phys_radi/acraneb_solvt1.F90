...
!   2019-09, J. Masek
!   Subroutine renamed from ACRANEB_SOLVT to ACRANEB_SOLVT1. Key LRNUMX
!   changed to dummy argument LDNUMX, enabling efficient clearsky calculations.
! End Modifications
!-----------------------------------------------------------------------
...
IF (LHOOK) CALL DR_HOOK('ACRANEB_SOLVT1',0,ZHOOK_HANDLE)
!-----------------------------------------------------------------------
...
IF (LHOOK) CALL DR_HOOK('ACRANEB_SOLVT1',1,ZHOOK_HANDLE)
