...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_ATMOSPHERE_UPDATE_PARALLEL:CPTEND_NEW')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_ATMOSPHERE_UPDATE_PARALLEL:CPTEND_NEW')) THEN
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_ATMOSPHERE_UPDATE_PARALLEL&
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_ATMOSPHERE_UPDATE_PARALLEL&
  &:CPTEND_NEW')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_ATMOSPHERE_UPDATE_PARALLEL&
  &:CPTEND_NEW')) THEN
  ...
  &:CPTEND_NEW:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PPFL_FTKE, PPFL_FTKEI, YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, &
...
ENDSUBROUTINE APL_ARPEGE_ATMOSPHERE_UPDATE_PARALLEL
