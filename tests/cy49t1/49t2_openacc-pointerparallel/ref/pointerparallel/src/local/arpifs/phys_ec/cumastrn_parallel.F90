...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:0')) THEN
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:1')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:1')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PVDISCU, PVEN, YSTACK, ZKMFL, ZQD, ZQENH, ZQSENH, ZTD, ZTENH, ZUD, ZUU, ZVD, &
    !$ACC&         ZVU) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:2')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:2')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (IDTOP, KCBOT, LDCUM, PAHFS, PAPH, PQHFL, PTEN, PTENQ, PTENT, YSTACK, ZCAPPBL, &
    !$ACC&         ZDHPBL, ZKHFL, ZKHVFL) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:3')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:3')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (ICTOP0, KCBOT, KTYPE, LDCUM, PAPH, PGEOH, PLU, PQU, PTEN, PTU, YSTACK, ZDHPBL, &
    !$ACC&         ZKHVFL, ZMFUB, ZMF_SHAL, ZQENH, ZTENH) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:4')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:4')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:4:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (ICTOP0, KCBOT, KCTOP, KTYPE, LDCUM, PAPH, PMFD, PTENU, PTENV, YSTACK, ZDMFDP, &
    !$ACC&         ZDMFUP, ZDPMEL, ZMFDQ, ZMFDS, ZRFL, ZTENU, ZTENV) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:5')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:5')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:5:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PMFU, PQSEN, PQU, PTEN, PTU, YSTACK, ZDMFDE, ZDMFDP, ZKINED, ZMFDQ, ZMFDS, &
    !$ACC&         ZMFUB, ZQD, ZQENH, ZRFL, ZTD, ZTENH) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:6')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:6')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:6:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         YSTACK, ZCAPDCYCL, ZCAPDCYCLLD, ZCAPDCYCLSE, ZCAPE, ZCAPE2, ZCAPPBL, &
    !$ACC&         ZDQCV, ZDX, ZHEAT, ZKHVFL, ZMFUB, ZMFUB1, ZQENH, ZQENH2, ZSATFR, ZTAU, &
    !$ACC&         ZTAUPBL, ZTENH, ZTENH2, ZXTAU) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:7')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:7')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:7:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (KCBOT, KTYPE, LDCUM, PAPH, PCAPE, PCUCONVCA, PVERVEL, YSTACK, ZCAPDCYCL, &
    !$ACC&         ZCAPE, ZCAPE2, ZDQCV, ZFACCA, ZHEAT, ZMFUB, ZMFUB1, ZSATFR, ZXTAU) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:8')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:8')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:8:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (KCBOT, KTYPE, LDCUM, PAPH, PGEOH, PLU, PMFD, PQU, PTU, YSTACK, ZDHPBL, ZKHFL, &
    !$ACC&         ZMFUB, ZMFUB1, ZMF_SHAL, ZQD, ZQENH, ZTD, ZTENH) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:9')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:9')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:9:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (KCBOT, KCTOP, KTYPE, LDCUM, LLDDRAF, PAPH, PMFD, PMFDDE_RATE, PMFU, YSTACK, &
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:10')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:10')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:10:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         LLO2, PLUDE, PLUDELI, PMFU, PMFUDE_RATE, YSTACK, ZDMFEN, ZDMFUP, ZMFS, &
    !$ACC&         ZMFUL, ZMFUQ, ZMFUS) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:11')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:11')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:11:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PQEN, PQSEN, PRAIN, PSNDE, PTEN, YSTACK, ZDMFDP, ZDMFUP, ZDPMEL, ZMFDQ, &
    !$ACC&         ZMFDS, ZMFUL, ZMFUQ, ZMFUS, ZQENH, ZTENH) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:12')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:12')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:12:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PMFLXR, PMFLXS, PMFU, PMFUDE_RATE, PQEN, PSNDE, YSTACK, ZDMFDP, ZDMFUP, &
    !$ACC&         ZMFDQ, ZMFUL, ZMFUQ) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:13')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:13')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:13:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PQSEN, PQU, PSNDE, PTEN, PTENQ, PTENT, PTU, YSTACK, ZDMFUP, ZDPMEL, ZMFDQ, &
    !$ACC&         ZMFDS, ZMFUL, ZMFUQ, ZMFUS, ZQD, ZQENH, ZTD, ZTENH) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:14')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:14')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:14:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PMFU, PMFUDE_RATE, PTENT, PTENU, PTENV, PUEN, PVDISCU, PVEN, YSTACK, &
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:15')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:15')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:15:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (KCBOT, KCTOP, LLO2, PMFDDE_RATE, PMFUDE_RATE, YSTACK) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDML_PHY_EC%YREPHY%LMFTRAC.AND.KTRAC>0) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:16')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:16')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:16:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&         YSTACK, ZDMFDPC, ZDMFUPC, ZMFDDR, ZMFDUS, ZMFS, ZMFUDR, ZMFUUS) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CUMASTRN_PARALLEL:17')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUMASTRN_PARALLEL:17')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CUMASTRN_PARALLEL:17:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PTENV, PTU, PUEN, PVEN, YSTACK, ZQD, ZQENH, ZTD, ZTENH, ZTENU, ZTENV) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ENDSUBROUTINE CUMASTRN_PARALLEL
