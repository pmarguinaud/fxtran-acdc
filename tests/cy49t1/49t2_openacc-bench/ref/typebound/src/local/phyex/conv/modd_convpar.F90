...
CONTAINS
PROCEDURE :: COPY => COPY_CONVPAR_T
PROCEDURE :: CRC64 => CRC64_CONVPAR_T
PROCEDURE :: HOST => HOST_CONVPAR_T
PROCEDURE :: LOAD => LOAD_CONVPAR_T
PROCEDURE :: SAVE => SAVE_CONVPAR_T
PROCEDURE :: SIZE => SIZE_CONVPAR_T
PROCEDURE :: WIPE => WIPE_CONVPAR_T
END TYPE CONVPAR_T
...
MODULE SUBROUTINE COPY_CONVPAR_T (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_CONVPAR_T (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_CONVPAR_T (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_CONVPAR_T (SELF, KLUN)
...
MODULE FUNCTION SIZE_CONVPAR_T (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_CONVPAR_T (SELF, LDDELETED, LDFIELDAPI)
