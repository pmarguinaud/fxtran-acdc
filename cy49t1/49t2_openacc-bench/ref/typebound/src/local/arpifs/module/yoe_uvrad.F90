...
PROCEDURE :: COPY => COPY_TEUVRAD
PROCEDURE :: CRC64 => CRC64_TEUVRAD
PROCEDURE :: HOST => HOST_TEUVRAD
PROCEDURE :: LOAD => LOAD_TEUVRAD
PROCEDURE :: SAVE => SAVE_TEUVRAD
PROCEDURE :: SIZE => SIZE_TEUVRAD
PROCEDURE :: WIPE => WIPE_TEUVRAD
END TYPE TEUVRAD
!============================================================================
...
MODULE SUBROUTINE COPY_TEUVRAD (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TEUVRAD (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TEUVRAD (SELF)

IMPLICIT NONE
CLASS (TEUVRAD), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TEUVRAD (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TEUVRAD (SELF, KLUN)
...
MODULE FUNCTION SIZE_TEUVRAD (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TEUVRAD (SELF, LDDELETED, LDFIELDAPI)
