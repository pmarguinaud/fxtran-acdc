...
PROCEDURE :: ACDC_COPY => ACDC_COPY_TMCC
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TMCC
PROCEDURE :: ACDC_HOST => ACDC_HOST_TMCC
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TMCC
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TMCC
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TMCC
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TMCC
END TYPE TMCC
!======================================================================
