...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TVAB
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TVAB
PROCEDURE :: ACDC_HOST => ACDC_HOST_TVAB
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TVAB
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TVAB
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TVAB
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TVAB
END TYPE TVAB
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TVETA
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TVETA
PROCEDURE :: ACDC_HOST => ACDC_HOST_TVETA
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TVETA
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TVETA
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TVETA
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TVETA
END TYPE TVETA
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TVFE
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TVFE
PROCEDURE :: ACDC_HOST => ACDC_HOST_TVFE
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TVFE
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TVFE
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TVFE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TVFE
END TYPE TVFE
...
TYPE TVERTICAL_GEOM
  ...
  TYPE(TCVER) :: YRCVER
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TVERTICAL_GEOM
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TVERTICAL_GEOM
PROCEDURE :: ACDC_HOST => ACDC_HOST_TVERTICAL_GEOM
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TVERTICAL_GEOM
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TVERTICAL_GEOM
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TVERTICAL_GEOM
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TVERTICAL_GEOM
