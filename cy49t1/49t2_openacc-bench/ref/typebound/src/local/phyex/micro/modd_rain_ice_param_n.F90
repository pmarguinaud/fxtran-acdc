...
CONTAINS
PROCEDURE :: COPY => COPY_RAIN_ICE_PARAM_T
PROCEDURE :: CRC64 => CRC64_RAIN_ICE_PARAM_T
PROCEDURE :: HOST => HOST_RAIN_ICE_PARAM_T
PROCEDURE :: LOAD => LOAD_RAIN_ICE_PARAM_T
PROCEDURE :: SAVE => SAVE_RAIN_ICE_PARAM_T
PROCEDURE :: SIZE => SIZE_RAIN_ICE_PARAM_T
PROCEDURE :: WIPE => WIPE_RAIN_ICE_PARAM_T
...
MODULE SUBROUTINE COPY_RAIN_ICE_PARAM_T (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_RAIN_ICE_PARAM_T (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_RAIN_ICE_PARAM_T (SELF)

IMPLICIT NONE
CLASS (RAIN_ICE_PARAM_T), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_RAIN_ICE_PARAM_T (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_RAIN_ICE_PARAM_T (SELF, KLUN)
...
MODULE FUNCTION SIZE_RAIN_ICE_PARAM_T (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_RAIN_ICE_PARAM_T (SELF, LDDELETED, LDFIELDAPI)
