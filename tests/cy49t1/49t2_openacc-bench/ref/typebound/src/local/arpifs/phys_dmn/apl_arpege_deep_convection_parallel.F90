...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:INIT')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL:INIT')) THEN
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:INIT')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:INIT')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL:INIT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&PRESENT (LLLAND, LLSHCV, YDCPG_OPTS, YDGEOMETRY, YSTACK, ZACPR, ZCUCONVCA, &
    !$ACC&         ZDXTDK, ZFCQLF, ZFCQLI, ZGEOM1, ZGEOMH, ZLCRIT_AER, ZLISUM, ZVERVEL, &
    !$ACC&         Z_YDCPG_DYN0_CTY_VVEL, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, &
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:ACUPTQ')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL:ACUPTQ')) THEN
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:ACUPTQ')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:ACUPTQ')) THEN
  ...
  &:ACUPTQ:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (PTENHA, PTENQVA, YDCPG_OPTS, YDMODEL, YSTACK, Z_YDMF_PHYS_BASE_STATE_Q, &
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:ZERO')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL:ZERO')) THEN
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:ZERO')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:ZERO')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL:ZERO:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (PRDG_CVGQ, PRDG_CVGT, PTENHA, PTENQVA, YDCPG_OPTS, YSTACK, ZTENDQ, &
    !$ACC&         ZTENDT, ZTENQ, ZTENT, ZTENU, ZTENV, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:CUCALLN_MF')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL:CUCALLN_MF')) THEN
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
  &:CUCALLN_MF')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
  &:CUCALLN_MF')) THEN
  ...
  &:CUCALLN_MF:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         LLCUM_LIG, LLLAND, LLSC, LLSHCV, PQV, YDCPG_OPTS, YDMODEL, YSTACK, &
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:COPY')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL:COPY')) THEN
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:COPY')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:COPY')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL:COPY:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (PFPCOR, YDCPG_OPTS, YSTACK, ZSNDE, Z_YDMF_PHYS_OUT_FCCQL, Z_YDMF_PHYS_OUT_FCCQN, &
    !$ACC&         Z_YDMF_PHYS_OUT_FPEVPCL, Z_YDMF_PHYS_OUT_FPEVPCN, Z_YDMF_PHYS_OUT_FPFPCL, &
    !$ACC&         Z_YDMF_PHYS_OUT_FPFPCN, Z_YDMF_PHYS_OUT_FPLCL, Z_YDMF_PHYS_OUT_FPLCN) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDCPG_OPTS%LFLASH) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:CULIGHT')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL:CULIGHT')) THEN
      IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DEEP_CONVECTION_PARALLEL&
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:CULIGHT')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_DEEP_CONVECTION_PARALLEL:CULIGHT')) THEN
    ...
    &:CULIGHT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (ICBOT, ICTOP, LLCUM, LLLAND, LLLINOX, YDCPG_OPTS, YDMODEL, YSTACK, &
...
ENDSUBROUTINE APL_ARPEGE_DEEP_CONVECTION_PARALLEL
