...
!  switch to use heterogeneous chemistry in BASCOE-stratospheric chemistry. Default is true.
!  Only set to false in case of an emergency.
...
!  original C-SHAPE profile for LiNOx (from Pickering et al., 1998)
...
!   Emission-driven mode for methane (else, default to concentration driven)
    LOGICAL             :: LCHEM_EMICH4
    
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TCHEM
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TCHEM
PROCEDURE :: ACDC_HOST => ACDC_HOST_TCHEM
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TCHEM
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TCHEM
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TCHEM
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TCHEM
END TYPE TCHEM
