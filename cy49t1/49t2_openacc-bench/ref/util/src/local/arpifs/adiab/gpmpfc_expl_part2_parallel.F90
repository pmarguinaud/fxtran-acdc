...
DO JFLD=1, SIZE (YDVARS%GFL_PTR)
  ...
  IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LCDERS) THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','GPMPFC_EXPL_PART2_PARALLEL:0')) THEN
      ...
      IF (LSYNCHOST ('GPMPFC_EXPL_PART2_PARALLEL:0')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPMPFC_EXPL_PART2_PARALLEL:0')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPMPFC_EXPL_PART2_PARALLEL:0')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('GPMPFC_EXPL_PART2_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC&PRESENT (PGM, YDCPG_OPTS, YSTACK, Z_YDVARS_GFL_PTR_DL, Z_YDVARS_GFL_PTR_DM) &
        !$ACC&PRIVATE (JBLK) &
...
ENDSUBROUTINE GPMPFC_EXPL_PART2_PARALLEL
