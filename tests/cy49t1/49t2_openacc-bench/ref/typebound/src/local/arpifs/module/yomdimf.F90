...
PROCEDURE :: COPY => COPY_TDIMF
PROCEDURE :: CRC64 => CRC64_TDIMF
PROCEDURE :: HOST => HOST_TDIMF
PROCEDURE :: LOAD => LOAD_TDIMF
PROCEDURE :: SAVE => SAVE_TDIMF
PROCEDURE :: SIZE => SIZE_TDIMF
PROCEDURE :: WIPE => WIPE_TDIMF
END TYPE TDIMF

INTERFACE

MODULE SUBROUTINE COPY_TDIMF (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE LOAD_TDIMF (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TDIMF (SELF, KLUN)
...
MODULE SUBROUTINE WIPE_TDIMF (SELF, LDDELETED, LDFIELDAPI)
