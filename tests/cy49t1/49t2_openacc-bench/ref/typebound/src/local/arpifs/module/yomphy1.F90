...
!       RZ0_TO_HEIGHT: RATIO OF MECHANICAL ROUGHNESS LENGTH TO OBSTACLE HEIGHT
...
!       LCLS_TOUCANS : REPLACE SURFEX SCREEN LEVEL DIAGNOSTIC BY TOUCANS ONE
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TPHY1
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TPHY1
PROCEDURE :: ACDC_HOST => ACDC_HOST_TPHY1
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TPHY1
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TPHY1
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TPHY1
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TPHY1
END TYPE TPHY1
