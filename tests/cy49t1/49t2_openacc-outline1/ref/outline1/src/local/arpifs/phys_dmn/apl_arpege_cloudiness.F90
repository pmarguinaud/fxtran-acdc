...
CALL APL_ARPEGE_CLOUDINESS_ACNEBCOND (LDREDPR, YDVARS, YDCPG_OPTS, YDSTA, YDCPG_MISC, YDMF_PHYS, YDMF_PHYS_BASE_STATE&
&, YDMODEL, YDCPG_BNDS, PCLCT_RAD, PQLI_CVPP, PQV, PUNEBH, PNEBS, PAIPCMT, PFLU_QSAT, PMSC_QW, PNEBCH,&
& PQLIS0, PDECRD, PQLI_CVP, PNEB_CVPP, PNEBC0, PNEBS0, PQI, PQL, PPFL_FPLCH, PQLIS)
