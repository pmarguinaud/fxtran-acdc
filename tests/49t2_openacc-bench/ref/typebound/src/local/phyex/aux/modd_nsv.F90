...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_NSV_T
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_NSV_T
PROCEDURE :: ACDC_HOST => ACDC_HOST_NSV_T
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_NSV_T
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_NSV_T
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_NSV_T
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_NSV_T
END TYPE NSV_t
!
