...
CONTAINS
PROCEDURE :: COPY => COPY_SPP_PERT
PROCEDURE :: CRC64 => CRC64_SPP_PERT
PROCEDURE :: HOST => HOST_SPP_PERT
PROCEDURE :: LOAD => LOAD_SPP_PERT
PROCEDURE :: SAVE => SAVE_SPP_PERT
PROCEDURE :: SIZE => SIZE_SPP_PERT
PROCEDURE :: WIPE => WIPE_SPP_PERT
end type spp_pert
...
CONTAINS
PROCEDURE :: COPY => COPY_SPP_MODEL
PROCEDURE :: CRC64 => CRC64_SPP_MODEL
PROCEDURE :: HOST => HOST_SPP_MODEL
PROCEDURE :: LOAD => LOAD_SPP_MODEL
PROCEDURE :: SAVE => SAVE_SPP_MODEL
PROCEDURE :: SIZE => SIZE_SPP_MODEL
PROCEDURE :: WIPE => WIPE_SPP_MODEL
end type spp_model


INTERFACE

MODULE SUBROUTINE COPY_SPP_PERT (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_SPP_PERT (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_SPP_PERT (SELF)

IMPLICIT NONE
CLASS (SPP_PERT), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_SPP_PERT (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_SPP_PERT (SELF, KLUN)
...
MODULE FUNCTION SIZE_SPP_PERT (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_SPP_PERT (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_SPP_MODEL (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_SPP_MODEL (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_SPP_MODEL (SELF)

IMPLICIT NONE
CLASS (SPP_MODEL), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_SPP_MODEL (SELF, KLUN)
USE PARKIND1, ONLY : JPRD
...
MODULE SUBROUTINE SAVE_SPP_MODEL (SELF, KLUN)
...
MODULE FUNCTION SIZE_SPP_MODEL (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_SPP_MODEL (SELF, LDDELETED, LDFIELDAPI)
