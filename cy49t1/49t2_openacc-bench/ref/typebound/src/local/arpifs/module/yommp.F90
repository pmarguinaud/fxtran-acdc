...
CONTAINS
PROCEDURE :: COPY => COPY_TMP
PROCEDURE :: CRC64 => CRC64_TMP
PROCEDURE :: HOST => HOST_TMP
PROCEDURE :: LOAD => LOAD_TMP
PROCEDURE :: SAVE => SAVE_TMP
PROCEDURE :: SIZE => SIZE_TMP
PROCEDURE :: WIPE => WIPE_TMP
END TYPE TMP
...
MODULE SUBROUTINE COPY_TMP (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TMP (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TMP (SELF)

IMPLICIT NONE
CLASS (TMP), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TMP (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TMP (SELF, KLUN)
...
MODULE FUNCTION SIZE_TMP (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TMP (SELF, LDDELETED, LDFIELDAPI)
