...
IF (LPARALLELMETHOD ('UPDATEVIEW','CPG_PARALLEL:ZEROPB2')) THEN
  ...
  IF (LSYNCHOST ('CPG_PARALLEL:ZEROPB2')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPMETHOD','CPG_PARALLEL:ZEROPB2')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCMETHOD','CPG_PARALLEL:ZEROPB2')) THEN
...
IF (LPARALLELMETHOD ('OPENMP','CPG_PARALLEL:ISETTLOFF')) THEN
  ...
  IF (LSYNCHOST ('CPG_PARALLEL:ISETTLOFF')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_PARALLEL:ISETTLOFF')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_PARALLEL:ISETTLOFF')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_PARALLEL:ISETTLOFF:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&PRESENT (YDCPG_OPTS, YSTACK, Z_YDCPG_SLMISC_ISETTLOFF) &
    !$ACC&PRIVATE (JBLK) &
...
IF (YDCPG_OPTS%LUSEPB1) THEN
  ...
  IF (LPARALLELMETHOD ('UPDATEVIEW','CPG_PARALLEL:ZEROSL1')) THEN
    ...
    IF (LSYNCHOST ('CPG_PARALLEL:ZEROSL1')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPMETHOD','CPG_PARALLEL:ZEROSL1')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCMETHOD','CPG_PARALLEL:ZEROSL1')) THEN
...
IF (LPARALLELMETHOD ('OPENMP','CPG_PARALLEL:LSMTSOL')) THEN
  ...
  IF (LSYNCHOST ('CPG_PARALLEL:LSMTSOL')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_PARALLEL:LSMTSOL')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_PARALLEL:LSMTSOL')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_PARALLEL:LSMTSOL:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, Z_YDCPG_MISC_LSM, Z_YDCPG_MISC_TSOL, &
    !$ACC&         Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_SURF_GSP_RR_PT_T0, &
    !$ACC&         Z_YDVARS_T_T0) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDCPG_OPTS%LUSEPB1) THEN
  ...
  IF (LPARALLELMETHOD ('UPDATEVIEW','CPG_PARALLEL:SHUFFLESL1')) THEN
    ...
    IF (LSYNCHOST ('CPG_PARALLEL:SHUFFLESL1')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPMETHOD','CPG_PARALLEL:SHUFFLESL1')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCMETHOD','CPG_PARALLEL:SHUFFLESL1')) THEN
