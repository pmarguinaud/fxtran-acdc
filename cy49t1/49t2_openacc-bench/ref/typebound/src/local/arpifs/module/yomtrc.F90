...
PROCEDURE :: COPY => COPY_TTRC
PROCEDURE :: CRC64 => CRC64_TTRC
PROCEDURE :: HOST => HOST_TTRC
PROCEDURE :: LOAD => LOAD_TTRC
PROCEDURE :: SAVE => SAVE_TTRC
PROCEDURE :: SIZE => SIZE_TTRC
PROCEDURE :: WIPE => WIPE_TTRC
END TYPE TTRC
!============================================================================
...
MODULE SUBROUTINE COPY_TTRC (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TTRC (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TTRC (SELF)

IMPLICIT NONE
CLASS (TTRC), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TTRC (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TTRC (SELF, KLUN)
...
MODULE FUNCTION SIZE_TTRC (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TTRC (SELF, LDDELETED, LDFIELDAPI)
