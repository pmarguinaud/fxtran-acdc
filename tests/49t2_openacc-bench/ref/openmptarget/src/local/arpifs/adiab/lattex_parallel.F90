...
IF (YDLDDH%LRSIDDH) THEN
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTEX_PARALLEL:LRSIDDH')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LATTEX_PARALLEL:LRSIDDH:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_PD9_SI_P, YDCPG_SL1%PD9_SI%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_T9_SI_P, YDCPG_SL1%T9_SI%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_U9_SI_P, YDCPG_SL1%U9_SI%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_V9_SI_P, YDCPG_SL1%V9_SI%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_VD9_SI_P, YDCPG_SL1%VD9_SI%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_PD_T0, YDCPG_TNDSI_DDH%PD%FT0)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_T_T0, YDCPG_TNDSI_DDH%T%FT0)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_U_T0, YDCPG_TNDSI_DDH%U%FT0)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_VD_T0, YDCPG_TNDSI_DDH%VD%FT0)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_V_T0, YDCPG_TNDSI_DDH%V%FT0)
    IF (LHOOK) CALL DR_HOOK ('LATTEX_PARALLEL:LRSIDDH:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('LATTEX_PARALLEL:LRSIDDH:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTEX_PARALLEL:MAIN')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('LATTEX_PARALLEL:MAIN:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (PBDT, YD_PBDT)
  CALL SGET_DEVICE_DATA_RDONLY (PEVEL, YD_PEVEL)
  CALL SGET_DEVICE_DATA_RDONLY (PGAGT0L, YD_PGAGT0L)
  CALL SGET_DEVICE_DATA_RDONLY (PGAGT0M, YD_PGAGT0M)
  CALL SGET_DEVICE_DATA_RDONLY (PGAGT9L, YD_PGAGT9L)
  CALL SGET_DEVICE_DATA_RDONLY (PGAGT9M, YD_PGAGT9M)
  CALL SGET_DEVICE_DATA_RDONLY (PGWFT0, YD_PGWFT0)
  CALL SGET_DEVICE_DATA_RDONLY (PGWT0, YD_PGWT0)
  CALL SGET_DEVICE_DATA_RDONLY (PGWT9, YD_PGWT9)
  CALL SGET_DEVICE_DATA_RDONLY (PHIF0, YD_PHIF0)
  CALL SGET_DEVICE_DATA_RDONLY (PLPD0, YD_PLPD0)
  CALL SGET_DEVICE_DATA_RDONLY (PLPD9, YD_PLPD9)
  CALL SGET_DEVICE_DATA_RDONLY (PMIXNL, YD_PMIXNL)
  CALL SGET_DEVICE_DATA_RDONLY (PNHXT0, YD_PNHXT0)
  CALL SGET_DEVICE_DATA_RDONLY (PNHXT9, YD_PNHXT9)
  CALL SGET_DEVICE_DATA_RDONLY (POROGL, YD_POROGL)
  CALL SGET_DEVICE_DATA_RDONLY (POROGM, YD_POROGM)
  CALL SGET_DEVICE_DATA_RDONLY (PRDELP, YD_PRDELP)
  CALL SGET_DEVICE_DATA_RDONLY (PSPDS0, YD_PSPDS0)
  CALL SGET_DEVICE_DATA_RDONLY (PSPDS9, YD_PSPDS9)
  CALL SGET_DEVICE_DATA_RDONLY (PTOD0, YD_PTOD0)
  CALL SGET_DEVICE_DATA_RDONLY (PTOD9, YD_PTOD9)
  CALL SGET_DEVICE_DATA_RDWR (ZMOY1SPD, YL_ZMOY1SPD)
  CALL SGET_DEVICE_DATA_RDWR (ZMOY1T, YL_ZMOY1T)
  CALL SGET_DEVICE_DATA_RDWR (ZMOY1U, YL_ZMOY1U)
  CALL SGET_DEVICE_DATA_RDWR (ZMOY1V, YL_ZMOY1V)
  CALL SGET_DEVICE_DATA_RDWR (ZMOY1VWV, YL_ZMOY1VWV)
  CALL SGET_DEVICE_DATA_RDWR (ZSPDSI9, YL_ZSPDSI9)
  CALL SGET_DEVICE_DATA_RDWR (ZTSI9, YL_ZTSI9)
  CALL SGET_DEVICE_DATA_RDWR (ZUSELESS, YL_ZUSELESS)
  CALL SGET_DEVICE_DATA_RDWR (ZUSI9, YL_ZUSI9)
  CALL SGET_DEVICE_DATA_RDWR (ZVSI9, YL_ZVSI9)
  CALL SGET_DEVICE_DATA_RDWR (ZVWVSI9, YL_ZVWVSI9)
  CALL SGET_DEVICE_DATA_RDWR (ZWT0, YL_ZWT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_NHX9_P, YDCPG_SL1%NHX9%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_PD0_P, YDCPG_SL1%PD0%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_PD9_NL_P, YDCPG_SL1%PD9_NL%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_PD9_P, YDCPG_SL1%PD9%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_PD9_SI_P, YDCPG_SL1%PD9_SI%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_T0_P, YDCPG_SL1%T0%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_T9_NL_P, YDCPG_SL1%T9_NL%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_T9_P, YDCPG_SL1%T9%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_T9_SI_P, YDCPG_SL1%T9_SI%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_TF9_P, YDCPG_SL1%TF9%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_U0_P, YDCPG_SL1%U0%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_U9_NL_P, YDCPG_SL1%U9_NL%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_U9_P, YDCPG_SL1%U9%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_U9_SI_P, YDCPG_SL1%U9_SI%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_UF9_P, YDCPG_SL1%UF9%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_V0_P, YDCPG_SL1%V0%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_V9_NL_P, YDCPG_SL1%V9_NL%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_V9_P, YDCPG_SL1%V9%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_V9_SI_P, YDCPG_SL1%V9_SI%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_VD0_P, YDCPG_SL1%VD0%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_VD9_NL_P, YDCPG_SL1%VD9_NL%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_VD9_P, YDCPG_SL1%VD9%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_VD9_SI_P, YDCPG_SL1%VD9_SI%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_VDF9_P, YDCPG_SL1%VDF9%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_VF9_P, YDCPG_SL1%VF9%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL2_PDSI, YDCPG_SL2%F_PDSI)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL2_TSI, YDCPG_SL2%F_TSI)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL2_USI, YDCPG_SL2%F_USI)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL2_VDSI, YDCPG_SL2%F_VDSI)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL2_VSI, YDCPG_SL2%F_VSI)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_PD_T0, YDCPG_TNDSI_DDH%PD%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_PD_T9, YDCPG_TNDSI_DDH%PD%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_T_T0, YDCPG_TNDSI_DDH%T%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_T_T9, YDCPG_TNDSI_DDH%T%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_U_T0, YDCPG_TNDSI_DDH%U%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_U_T9, YDCPG_TNDSI_DDH%U%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_VD_T0, YDCPG_TNDSI_DDH%VD%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_VD_T9, YDCPG_TNDSI_DDH%VD%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_V_T0, YDCPG_TNDSI_DDH%V%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_TNDSI_DDH_V_T9, YDCPG_TNDSI_DDH%V%FT9)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_TND_TNDGW, YDCPG_TND%F_TNDGW)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_TND_TNDPD, YDCPG_TND%F_TNDPD)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_TND_TNDT, YDCPG_TND%F_TNDT)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_TND_TNDU_NOC, YDCPG_TND%F_TNDU_NOC)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_TND_TNDVD, YDCPG_TND%F_TNDVD)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_TND_TNDV_NOC, YDCPG_TND%F_TNDV_NOC)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_CSPDNL_T9, YDVARS%CSPDNL%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_CTNL_T9, YDVARS%CTNL%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_CUNL_T9, YDVARS%CUNL%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_CVNL_T9, YDVARS%CVNL%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_CVWVNL_T9, YDVARS%CVWVNL%FT9)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_GEMU_T0, YDVARS%GEOMETRY%GEMU%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_GOMVRL_P, YDVARS%GEOMETRY%GOMVRL%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_GOMVRM_P, YDVARS%GEOMETRY%GOMVRM%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_OROG_P, YDVARS%GEOMETRY%OROG%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_RCORI_P, YDVARS%GEOMETRY%RCORI%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_RCORI_T0, YDVARS%GEOMETRY%RCORI%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_GW_T9, YDVARS%GW%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_NHX_T1, YDVARS%NHX%FT1)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_NHX_T9, YDVARS%NHX%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SPDNL_T9, YDVARS%SPDNL%FT9)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_SPD_T0, YDVARS%SPD%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SPD_T1, YDVARS%SPD%FT1)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_SPD_T9, YDVARS%SPD%FT9)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_SVD_T0, YDVARS%SVD%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SVD_T1, YDVARS%SVD%FT1)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_SVD_T9, YDVARS%SVD%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_TNL_T9, YDVARS%TNL%FT9)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_T_T0, YDVARS%T%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_T_T1, YDVARS%T%FT1)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_T_T9, YDVARS%T%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_UNL_T9, YDVARS%UNL%FT9)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_U_T0, YDVARS%U%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_U_T1, YDVARS%U%FT1)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_U_T9, YDVARS%U%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_VNL_T9, YDVARS%VNL%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_VWVNL_T9, YDVARS%VWVNL%FT9)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_V_T0, YDVARS%V%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_V_T1, YDVARS%V%FT1)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_V_T9, YDVARS%V%FT9)
  IF (LHOOK) CALL DR_HOOK ('LATTEX_PARALLEL:MAIN:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('LATTEX_PARALLEL:MAIN:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
...
IF (YDML_DYN%YRDYN%LRHS_CURV) THEN
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTEX_PARALLEL:LRHS_CURV')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LATTEX_PARALLEL:LRHS_CURV:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDWR (ZUCOMP, YL_ZUCOMP)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_U0_P, YDCPG_SL1%U0%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_U9_P, YDCPG_SL1%U9%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_V0_P, YDCPG_SL1%V0%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_V9_P, YDCPG_SL1%V9%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_Z0_P, YDCPG_SL1%Z0%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_Z9_P, YDCPG_SL1%Z9%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_GECLO_P, YDVARS%GEOMETRY%GECLO%FT0)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_GEMU_P, YDVARS%GEOMETRY%GEMU%FT0)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_GESLO_P, YDVARS%GEOMETRY%GESLO%FT0)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_GSQM2_P, YDVARS%GEOMETRY%GSQM2%FT0)
    IF (LHOOK) CALL DR_HOOK ('LATTEX_PARALLEL:LRHS_CURV:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('LATTEX_PARALLEL:LRHS_CURV:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
