...
PROCEDURE :: ACDC_COPY => ACDC_COPY_TECUMF2
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TECUMF2
PROCEDURE :: ACDC_HOST => ACDC_HOST_TECUMF2
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TECUMF2
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TECUMF2
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TECUMF2
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TECUMF2
END TYPE TECUMF2
!============================================================================
...
MODULE SUBROUTINE ACDC_WIPE_TECUMF2 (SELF, LDDELETED, LDFIELDAPI)
