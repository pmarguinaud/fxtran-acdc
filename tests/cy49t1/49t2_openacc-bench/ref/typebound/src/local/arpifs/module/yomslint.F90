...
PROCEDURE :: COPY => COPY_TSLINT
PROCEDURE :: CRC64 => CRC64_TSLINT
PROCEDURE :: HOST => HOST_TSLINT
PROCEDURE :: LOAD => LOAD_TSLINT
PROCEDURE :: SAVE => SAVE_TSLINT
PROCEDURE :: SIZE => SIZE_TSLINT
PROCEDURE :: WIPE => WIPE_TSLINT
END TYPE TSLINT
!     ------------------------------------------------------------------
!     ------------------------------------------------------------------
...
MODULE SUBROUTINE COPY_TSLINT (SELF, LDCREATED, LDFIELDAPI)
...
MODULE FUNCTION SIZE_TSLINT (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
