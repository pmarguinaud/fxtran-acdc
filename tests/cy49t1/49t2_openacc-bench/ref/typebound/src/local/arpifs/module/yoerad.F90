...
PROCEDURE :: COPY => COPY_TERAD
PROCEDURE :: CRC64 => CRC64_TERAD
PROCEDURE :: HOST => HOST_TERAD
PROCEDURE :: LOAD => LOAD_TERAD
PROCEDURE :: SAVE => SAVE_TERAD
PROCEDURE :: SIZE => SIZE_TERAD
PROCEDURE :: WIPE => WIPE_TERAD
END TYPE TERAD
!============================================================================
...
MODULE SUBROUTINE COPY_TERAD (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TERAD (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TERAD (SELF)

IMPLICIT NONE
CLASS (TERAD), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TERAD (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TERAD (SELF, KLUN)
...
MODULE FUNCTION SIZE_TERAD (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TERAD (SELF, LDDELETED, LDFIELDAPI)
