...
PROCEDURE :: COPY => COPY_GEOMETRY
PROCEDURE :: CRC64 => CRC64_GEOMETRY
PROCEDURE :: HOST => HOST_GEOMETRY
PROCEDURE :: LOAD => LOAD_GEOMETRY
PROCEDURE :: SAVE => SAVE_GEOMETRY
PROCEDURE :: SIZE => SIZE_GEOMETRY
PROCEDURE :: WIPE => WIPE_GEOMETRY
END TYPE GEOMETRY
