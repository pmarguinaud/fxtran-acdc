...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CUASCN_PARALLEL:0')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (LLKLAB, YL_LLKLAB)
  CALL SGET_HOST_DATA_RDWR (LSCVFLAG, YD_LSCVFLAG)
  CALL SGET_HOST_DATA_RDWR (PMFUB, YD_PMFUB)
  CALL SGET_HOST_DATA_RDWR (PQU, YD_PQU)
  CALL SGET_HOST_DATA_RDWR (PWMEAN, YD_PWMEAN)
  CALL SGET_HOST_DATA_RDWR (ZDPMEAN, YL_ZDPMEAN)
  CALL SGET_HOST_DATA_RDWR (ZLUOLD, YL_ZLUOLD)
  CALL SGET_HOST_DATA_RDWR (ZOENTR, YL_ZOENTR)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUASCN_PARALLEL:0')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDWR (LLKLAB, YL_LLKLAB)
  CALL SGET_DEVICE_DATA_RDWR (LSCVFLAG, YD_LSCVFLAG)
  CALL SGET_DEVICE_DATA_RDWR (PMFUB, YD_PMFUB)
  CALL SGET_DEVICE_DATA_RDWR (PQU, YD_PQU)
  CALL SGET_DEVICE_DATA_RDWR (PWMEAN, YD_PWMEAN)
  CALL SGET_DEVICE_DATA_RDWR (ZDPMEAN, YL_ZDPMEAN)
  CALL SGET_DEVICE_DATA_RDWR (ZLUOLD, YL_ZLUOLD)
  CALL SGET_DEVICE_DATA_RDWR (ZOENTR, YL_ZOENTR)
  IF (LHOOK) CALL DR_HOOK ('CUASCN_PARALLEL:0:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CUASCN_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CUASCN_PARALLEL:1')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (KCTOP0, YD_KCTOP0)
  CALL SGET_HOST_DATA_RDWR (KLAB, YD_KLAB)
  CALL SGET_HOST_DATA_RDONLY (KTYPE, YD_KTYPE)
  CALL SGET_HOST_DATA_RDWR (LDCUM, YD_LDCUM)
  CALL SGET_HOST_DATA_RDONLY (LLKLAB, YL_LLKLAB)
  CALL SGET_HOST_DATA_RDONLY (PAPH, YD_PAPH)
  CALL SGET_HOST_DATA_RDWR (PDMFEN, YD_PDMFEN)
  CALL SGET_HOST_DATA_RDWR (PDMFUP, YD_PDMFUP)
  CALL SGET_HOST_DATA_RDONLY (PGEOH, YD_PGEOH)
  CALL SGET_HOST_DATA_RDWR (PKINEU, YD_PKINEU)
  CALL SGET_HOST_DATA_RDWR (PLGLAC, YD_PLGLAC)
  CALL SGET_HOST_DATA_RDWR (PLRAIN, YD_PLRAIN)
  ...
  CALL SGET_HOST_DATA_RDONLY (PMFUB, YD_PMFUB)
  CALL SGET_HOST_DATA_RDWR (PMFUDE_RATE, YD_PMFUDE_RATE)
  CALL SGET_HOST_DATA_RDWR (PMFUL, YD_PMFUL)
  CALL SGET_HOST_DATA_RDWR (PMFUQ, YD_PMFUQ)
  CALL SGET_HOST_DATA_RDWR (PMFUS, YD_PMFUS)
  CALL SGET_HOST_DATA_RDONLY (PQU, YD_PQU)
  CALL SGET_HOST_DATA_RDONLY (PTU, YD_PTU)
  CALL SGET_HOST_DATA_RDWR (PWU, YD_PWU)
  CALL SGET_HOST_DATA_RDONLY (PWUBASE, YD_PWUBASE)
  CALL SGET_HOST_DATA_RDWR (ZBUO, YL_ZBUO)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUASCN_PARALLEL:1')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDWR (KCTOP0, YD_KCTOP0)
  CALL SGET_DEVICE_DATA_RDWR (KLAB, YD_KLAB)
  CALL SGET_DEVICE_DATA_RDONLY (KTYPE, YD_KTYPE)
  CALL SGET_DEVICE_DATA_RDWR (LDCUM, YD_LDCUM)
  CALL SGET_DEVICE_DATA_RDONLY (LLKLAB, YL_LLKLAB)
  CALL SGET_DEVICE_DATA_RDONLY (PAPH, YD_PAPH)
  CALL SGET_DEVICE_DATA_RDWR (PDMFEN, YD_PDMFEN)
  CALL SGET_DEVICE_DATA_RDWR (PDMFUP, YD_PDMFUP)
  CALL SGET_DEVICE_DATA_RDONLY (PGEOH, YD_PGEOH)
  CALL SGET_DEVICE_DATA_RDWR (PKINEU, YD_PKINEU)
  CALL SGET_DEVICE_DATA_RDWR (PLGLAC, YD_PLGLAC)
  CALL SGET_DEVICE_DATA_RDWR (PLRAIN, YD_PLRAIN)
  ...
  CALL SGET_DEVICE_DATA_RDONLY (PMFUB, YD_PMFUB)
  CALL SGET_DEVICE_DATA_RDWR (PMFUDE_RATE, YD_PMFUDE_RATE)
  CALL SGET_DEVICE_DATA_RDWR (PMFUL, YD_PMFUL)
  CALL SGET_DEVICE_DATA_RDWR (PMFUQ, YD_PMFUQ)
  CALL SGET_DEVICE_DATA_RDWR (PMFUS, YD_PMFUS)
  CALL SGET_DEVICE_DATA_RDONLY (PQU, YD_PQU)
  CALL SGET_DEVICE_DATA_RDONLY (PTU, YD_PTU)
  CALL SGET_DEVICE_DATA_RDWR (PWU, YD_PWU)
  CALL SGET_DEVICE_DATA_RDONLY (PWUBASE, YD_PWUBASE)
  CALL SGET_DEVICE_DATA_RDWR (ZBUO, YL_ZBUO)
  IF (LHOOK) CALL DR_HOOK ('CUASCN_PARALLEL:1:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CUASCN_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CUASCN_PARALLEL:2')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (KCBOT, YD_KCBOT)
  CALL SGET_HOST_DATA_RDWR (KCTOP, YD_KCTOP)
  CALL SGET_HOST_DATA_RDONLY (KDPL, YD_KDPL)
  CALL SGET_HOST_DATA_RDWR (KLAB, YD_KLAB)
  CALL SGET_HOST_DATA_RDWR (KTYPE, YD_KTYPE)
  CALL SGET_HOST_DATA_RDWR (LDCUM, YD_LDCUM)
  CALL SGET_HOST_DATA_RDWR (LLFLAG, YL_LLFLAG)
  CALL SGET_HOST_DATA_RDWR (LLFLAGUV, YL_LLFLAGUV)
  CALL SGET_HOST_DATA_RDWR (LLFLAG_CUADJTQ000, YL_LLFLAG_CUADJTQ000)
  CALL SGET_HOST_DATA_RDWR (LLFLAG_CUADJTQ001, YL_LLFLAG_CUADJTQ001)
  CALL SGET_HOST_DATA_RDWR (LLO1, YL_LLO1)
  CALL SGET_HOST_DATA_RDONLY (LSCVFLAG, YD_LSCVFLAG)
  ...
  CALL SGET_HOST_DATA_RDONLY (PGEOH, YD_PGEOH)
  CALL SGET_HOST_DATA_RDWR (PKINEU, YD_PKINEU)
  CALL SGET_HOST_DATA_RDONLY (PLCRIT_AER, YD_PLCRIT_AER)
  CALL SGET_HOST_DATA_RDWR (PLGLAC, YD_PLGLAC)
  CALL SGET_HOST_DATA_RDONLY (PLITOT, YD_PLITOT)
  CALL SGET_HOST_DATA_RDWR (PLRAIN, YD_PLRAIN)
  CALL SGET_HOST_DATA_RDWR (PLU, YD_PLU)
  CALL SGET_HOST_DATA_RDWR (PLUDE, YD_PLUDE)
  CALL SGET_HOST_DATA_RDWR (PLUDELI, YD_PLUDELI)
  ...
  CALL SGET_HOST_DATA_RDWR (ZLUOLD, YL_ZLUOLD)
  CALL SGET_HOST_DATA_RDWR (ZOENTR, YL_ZOENTR)
  CALL SGET_HOST_DATA_RDWR (ZPH, YL_ZPH)
  CALL SGET_HOST_DATA_RDWR (ZPRECIP, YL_ZPRECIP)
  CALL SGET_HOST_DATA_RDWR (ZQOLD, YL_ZQOLD)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUASCN_PARALLEL:2')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDWR (KCBOT, YD_KCBOT)
  CALL SGET_DEVICE_DATA_RDWR (KCTOP, YD_KCTOP)
  CALL SGET_DEVICE_DATA_RDONLY (KDPL, YD_KDPL)
  CALL SGET_DEVICE_DATA_RDWR (KLAB, YD_KLAB)
  CALL SGET_DEVICE_DATA_RDWR (KTYPE, YD_KTYPE)
  CALL SGET_DEVICE_DATA_RDWR (LDCUM, YD_LDCUM)
  CALL SGET_DEVICE_DATA_RDWR (LLFLAG, YL_LLFLAG)
  CALL SGET_DEVICE_DATA_RDWR (LLFLAGUV, YL_LLFLAGUV)
  CALL SGET_DEVICE_DATA_RDWR (LLFLAG_CUADJTQ000, YL_LLFLAG_CUADJTQ000)
  CALL SGET_DEVICE_DATA_RDWR (LLFLAG_CUADJTQ001, YL_LLFLAG_CUADJTQ001)
  CALL SGET_DEVICE_DATA_RDWR (LLO1, YL_LLO1)
  CALL SGET_DEVICE_DATA_RDONLY (LSCVFLAG, YD_LSCVFLAG)
  ...
  CALL SGET_DEVICE_DATA_RDONLY (PGEOH, YD_PGEOH)
  CALL SGET_DEVICE_DATA_RDWR (PKINEU, YD_PKINEU)
  CALL SGET_DEVICE_DATA_RDONLY (PLCRIT_AER, YD_PLCRIT_AER)
  CALL SGET_DEVICE_DATA_RDWR (PLGLAC, YD_PLGLAC)
  CALL SGET_DEVICE_DATA_RDONLY (PLITOT, YD_PLITOT)
  CALL SGET_DEVICE_DATA_RDWR (PLRAIN, YD_PLRAIN)
  CALL SGET_DEVICE_DATA_RDWR (PLU, YD_PLU)
  CALL SGET_DEVICE_DATA_RDWR (PLUDE, YD_PLUDE)
  CALL SGET_DEVICE_DATA_RDWR (PLUDELI, YD_PLUDELI)
  ...
  CALL SGET_DEVICE_DATA_RDWR (ZLUOLD, YL_ZLUOLD)
  CALL SGET_DEVICE_DATA_RDWR (ZOENTR, YL_ZOENTR)
  CALL SGET_DEVICE_DATA_RDWR (ZPH, YL_ZPH)
  CALL SGET_DEVICE_DATA_RDWR (ZPRECIP, YL_ZPRECIP)
  CALL SGET_DEVICE_DATA_RDWR (ZQOLD, YL_ZQOLD)
  IF (LHOOK) CALL DR_HOOK ('CUASCN_PARALLEL:2:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CUASCN_PARALLEL:2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CUASCN_PARALLEL:3')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (LDCUM, YD_LDCUM)
  CALL SGET_HOST_DATA_RDWR (PWMEAN, YD_PWMEAN)
  CALL SGET_HOST_DATA_RDONLY (ZDPMEAN, YL_ZDPMEAN)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CUASCN_PARALLEL:3')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDWR (LDCUM, YD_LDCUM)
  CALL SGET_DEVICE_DATA_RDWR (PWMEAN, YD_PWMEAN)
  CALL SGET_DEVICE_DATA_RDONLY (ZDPMEAN, YL_ZDPMEAN)
  IF (LHOOK) CALL DR_HOOK ('CUASCN_PARALLEL:3:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CUASCN_PARALLEL:3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
