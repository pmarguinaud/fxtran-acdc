...
SUBROUTINE SAVE_TEWCOU (SELF, KLUN)
...
SUBROUTINE LOAD_TEWCOU (SELF, KLUN)
...
SUBROUTINE COPY_TEWCOU (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE CRC64_TEWCOU (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TEWCOU (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TEWCOU (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
