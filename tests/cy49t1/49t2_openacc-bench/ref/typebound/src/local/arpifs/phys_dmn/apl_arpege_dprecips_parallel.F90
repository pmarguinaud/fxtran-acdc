...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_DPRECIPS_PARALLEL:0')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_DPRECIPS_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_DPRECIPS_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_DPRECIPS_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_DPRECIPS_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&PRESENT (PPRC_DPRECIPS, PPRC_DPRECIPS2, YDCPG_OPTS, YDMODEL, YSTACK, ZDZZ, &
    !$ACC&         ZFPLC, ZFPLS, ZFPLSG, ZTW, ZZZ, Z_YDMF_PHYS_BASE_STATE_I, Z_YDMF_PHYS_BASE_STATE_L, &
...
ENDSUBROUTINE APL_ARPEGE_DPRECIPS_PARALLEL
