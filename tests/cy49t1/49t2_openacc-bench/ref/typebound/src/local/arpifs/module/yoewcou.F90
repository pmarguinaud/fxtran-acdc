...
PROCEDURE :: COPY => COPY_TEWCOU
PROCEDURE :: CRC64 => CRC64_TEWCOU
PROCEDURE :: HOST => HOST_TEWCOU
PROCEDURE :: LOAD => LOAD_TEWCOU
PROCEDURE :: SAVE => SAVE_TEWCOU
PROCEDURE :: SIZE => SIZE_TEWCOU
PROCEDURE :: WIPE => WIPE_TEWCOU
END TYPE TEWCOU
...
MODULE SUBROUTINE COPY_TEWCOU (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TEWCOU (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TEWCOU (SELF)

IMPLICIT NONE
CLASS (TEWCOU), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TEWCOU (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TEWCOU (SELF, KLUN)
...
MODULE FUNCTION SIZE_TEWCOU (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TEWCOU (SELF, LDDELETED, LDFIELDAPI)
