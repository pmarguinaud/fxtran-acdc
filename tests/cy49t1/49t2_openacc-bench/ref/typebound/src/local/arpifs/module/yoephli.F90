...
PROCEDURE :: COPY => COPY_TEPHLI
PROCEDURE :: CRC64 => CRC64_TEPHLI
PROCEDURE :: HOST => HOST_TEPHLI
PROCEDURE :: LOAD => LOAD_TEPHLI
PROCEDURE :: SAVE => SAVE_TEPHLI
PROCEDURE :: SIZE => SIZE_TEPHLI
PROCEDURE :: WIPE => WIPE_TEPHLI
END TYPE TEPHLI
!============================================================================
...
MODULE SUBROUTINE COPY_TEPHLI (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE LOAD_TEPHLI (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TEPHLI (SELF, KLUN)
...
MODULE SUBROUTINE WIPE_TEPHLI (SELF, LDDELETED, LDFIELDAPI)
