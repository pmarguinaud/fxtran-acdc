...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CPUTQY_APLPAR_EXPL_PARALLEL:ZTDCP')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (ZTDCP, YL_ZTDCP)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
  ...
  IF (LHOOK) CALL DR_HOOK ('CPUTQY_APLPAR_EXPL_PARALLEL:ZTDCP:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (ZTDCP, YL_ZTDCP)
  IF (LHOOK) CALL DR_HOOK ('CPUTQY_APLPAR_EXPL_PARALLEL:ZTDCP:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CPUTQY_APLPAR_EXPL_PARALLEL:ZTDCP:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YFXTRAN_ACDC_STACK, ZTDCP)  & 
  !$OMP & PRIVATE (JBLK)  & 
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CPUTQY_APLPAR_EXPL_PARALLEL:ZDEC')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (PTENDH, YD_PTENDH)
  CALL SGET_HOST_DATA_RDONLY (PTENDTKE, YD_PTENDTKE)
  CALL SGET_HOST_DATA_RDONLY (PTENDU_ZDEC, YD_PTENDU_ZDEC)
  CALL SGET_HOST_DATA_RDONLY (PTENDV_ZDEC, YD_PTENDV_ZDEC)
  CALL SGET_HOST_DATA_RDWR (ZDEC, YL_ZDEC)
  CALL SGET_HOST_DATA_RDWR (ZDTT1, YL_ZDTT1)
  CALL SGET_HOST_DATA_RDWR (ZRRGDELP, YL_ZRRGDELP)
  CALL SGET_HOST_DATA_RDONLY (ZTDCP, YL_ZTDCP)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('CPUTQY_APLPAR_EXPL_PARALLEL:ZDEC')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (PTENDH, YD_PTENDH)
    CALL SGET_HOST_DATA_RDWR (PTENDTKE, YD_PTENDTKE)
    CALL SGET_HOST_DATA_RDWR (PTENDU_ZDEC, YD_PTENDU_ZDEC)
    CALL SGET_HOST_DATA_RDWR (PTENDV_ZDEC, YD_PTENDV_ZDEC)
    CALL SGET_HOST_DATA_RDWR (ZDEC, YL_ZDEC)
    CALL SGET_HOST_DATA_RDWR (ZDTT1, YL_ZDTT1)
    CALL SGET_HOST_DATA_RDWR (ZRRGDELP, YL_ZRRGDELP)
    CALL SGET_HOST_DATA_RDWR (ZTDCP, YL_ZTDCP)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPUTQY_APLPAR_EXPL_PARALLEL:ZDEC')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPUTQY_APLPAR_EXPL_PARALLEL:ZDEC:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (PTENDH, YD_PTENDH)
  CALL SGET_DEVICE_DATA_RDONLY (PTENDTKE, YD_PTENDTKE)
  CALL SGET_DEVICE_DATA_RDONLY (PTENDU_ZDEC, YD_PTENDU_ZDEC)
  CALL SGET_DEVICE_DATA_RDONLY (PTENDV_ZDEC, YD_PTENDV_ZDEC)
  CALL SGET_DEVICE_DATA_RDWR (ZDEC, YL_ZDEC)
  CALL SGET_DEVICE_DATA_RDWR (ZDTT1, YL_ZDTT1)
  CALL SGET_DEVICE_DATA_RDWR (ZRRGDELP, YL_ZRRGDELP)
  CALL SGET_DEVICE_DATA_RDONLY (ZTDCP, YL_ZTDCP)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:PTENDH, PTENDTKE, PTENDU_ZDEC, PTENDV_ZDEC, YDCPG_OPTS, YDPHY,  & 
  !$OMP &          YFXTRAN_ACDC_STACK, ZDEC, ZDTT1, ZRRGDELP, ZTDCP, Z_YDMF_PHYS_BASE_STATE_T,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
  ...
  DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
    ...
    !$OMP PARALLEL DO SIMD  & 
    !$OMP & PRIVATE (JLEV, JLON, YLCPG_BNDS, ZCPF, ZH)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CPUTQY_APLPAR_EXPL_PARALLEL:PFDIS')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (PFDIS, YD_PFDIS)
  CALL SGET_HOST_DATA_RDONLY (PTENDTKE, YD_PTENDTKE)
  CALL SGET_HOST_DATA_RDONLY (ZDEC, YL_ZDEC)
  CALL SGET_HOST_DATA_RDONLY (ZRRGDELP, YL_ZRRGDELP)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
  ...
  IF (LHOOK) CALL DR_HOOK ('CPUTQY_APLPAR_EXPL_PARALLEL:PFDIS:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (PFDIS, YD_PFDIS)
  CALL SGET_DEVICE_DATA_RDONLY (PTENDTKE, YD_PTENDTKE)
  CALL SGET_DEVICE_DATA_RDONLY (ZDEC, YL_ZDEC)
  CALL SGET_DEVICE_DATA_RDONLY (ZRRGDELP, YL_ZRRGDELP)
  IF (LHOOK) CALL DR_HOOK ('CPUTQY_APLPAR_EXPL_PARALLEL:PFDIS:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CPUTQY_APLPAR_EXPL_PARALLEL:PFDIS:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:PFDIS, PTENDTKE, YDCPG_OPTS, YDPHY, YFXTRAN_ACDC_STACK, ZDEC, ZRRGDELP)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
