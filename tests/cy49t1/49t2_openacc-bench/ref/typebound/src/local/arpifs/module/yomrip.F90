...
PROCEDURE :: COPY => COPY_TRIP
PROCEDURE :: CRC64 => CRC64_TRIP
PROCEDURE :: HOST => HOST_TRIP
PROCEDURE :: LOAD => LOAD_TRIP
PROCEDURE :: SAVE => SAVE_TRIP
PROCEDURE :: SIZE => SIZE_TRIP
PROCEDURE :: WIPE => WIPE_TRIP
END TYPE TRIP
...
MODULE SUBROUTINE LOAD_TRIP (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TRIP (SELF, KLUN)
