...
INTERFACE ACDC_COPY
MODULE PROCEDURE ACDC_COPY_VARIABLE_3RB
END INTERFACE

INTERFACE ACDC_HOST
MODULE PROCEDURE ACDC_HOST_VARIABLE_3RB
END INTERFACE

INTERFACE ACDC_LEGACY
MODULE PROCEDURE ACDC_LEGACY_VARIABLE_3RB
END INTERFACE

INTERFACE ACDC_CRC64
MODULE PROCEDURE ACDC_CRC64_VARIABLE_3RB
END INTERFACE

INTERFACE ACDC_WIPE
MODULE PROCEDURE ACDC_WIPE_VARIABLE_3RB
END INTERFACE


INTERFACE ACDC_SIZE
MODULE PROCEDURE ACDC_SIZE_VARIABLE_3RB
END INTERFACE
...
LFT0 = ASSOCIATED (SELF%FT0)
IF (LFT0) THEN
  CALL HOST_FIELD_3RB (SELF%FT0)
ENDIF

LFT1 = ASSOCIATED (SELF%FT1)
IF (LFT1) THEN
  CALL HOST_FIELD_3RB (SELF%FT1)
ENDIF

LFT9 = ASSOCIATED (SELF%FT9)
IF (LFT9) THEN
  CALL HOST_FIELD_3RB (SELF%FT9)
ENDIF

LFPH9 = ASSOCIATED (SELF%FPH9)
IF (LFPH9) THEN
  CALL HOST_FIELD_3RB (SELF%FPH9)
ENDIF

LFDL = ASSOCIATED (SELF%FDL)
IF (LFDL) THEN
  CALL HOST_FIELD_3RB (SELF%FDL)
ENDIF

LFDM = ASSOCIATED (SELF%FDM)
IF (LFDM) THEN
  CALL HOST_FIELD_3RB (SELF%FDM)
ENDIF

LFDL9 = ASSOCIATED (SELF%FDL9)
IF (LFDL9) THEN
  CALL HOST_FIELD_3RB (SELF%FDL9)
ENDIF

LFDM9 = ASSOCIATED (SELF%FDM9)
IF (LFDM9) THEN
  CALL HOST_FIELD_3RB (SELF%FDM9)
ENDIF

LFPC_PH = ASSOCIATED (SELF%FPC_PH)
IF (LFPC_PH) THEN
  CALL HOST_FIELD_3RB (SELF%FPC_PH)
ENDIF
...
LFT0 = ASSOCIATED (SELF%FT0)
IF (LFT0) THEN
  CALL LEGACY_FIELD_3RB (SELF%FT0, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFT1 = ASSOCIATED (SELF%FT1)
IF (LFT1) THEN
  CALL LEGACY_FIELD_3RB (SELF%FT1, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFT9 = ASSOCIATED (SELF%FT9)
IF (LFT9) THEN
  CALL LEGACY_FIELD_3RB (SELF%FT9, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFPH9 = ASSOCIATED (SELF%FPH9)
IF (LFPH9) THEN
  CALL LEGACY_FIELD_3RB (SELF%FPH9, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFDL = ASSOCIATED (SELF%FDL)
IF (LFDL) THEN
  CALL LEGACY_FIELD_3RB (SELF%FDL, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFDM = ASSOCIATED (SELF%FDM)
IF (LFDM) THEN
  CALL LEGACY_FIELD_3RB (SELF%FDM, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFDL9 = ASSOCIATED (SELF%FDL9)
IF (LFDL9) THEN
  CALL LEGACY_FIELD_3RB (SELF%FDL9, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFDM9 = ASSOCIATED (SELF%FDM9)
IF (LFDM9) THEN
  CALL LEGACY_FIELD_3RB (SELF%FDM9, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFPC_PH = ASSOCIATED (SELF%FPC_PH)
IF (LFPC_PH) THEN
  CALL LEGACY_FIELD_3RB (SELF%FPC_PH, KADDRL, KADDRU, KDIR=KDIR)
ENDIF
...
LFT0 = ASSOCIATED (SELF%FT0)
IF (LFT0 .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_3RB (SELF%FT0)
ENDIF

LFT1 = ASSOCIATED (SELF%FT1)
IF (LFT1 .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_3RB (SELF%FT1)
ENDIF

LFT9 = ASSOCIATED (SELF%FT9)
IF (LFT9 .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_3RB (SELF%FT9)
ENDIF

LFPH9 = ASSOCIATED (SELF%FPH9)
IF (LFPH9 .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_3RB (SELF%FPH9)
ENDIF

LFDL = ASSOCIATED (SELF%FDL)
IF (LFDL .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_3RB (SELF%FDL)
ENDIF

LFDM = ASSOCIATED (SELF%FDM)
IF (LFDM .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_3RB (SELF%FDM)
ENDIF

LFDL9 = ASSOCIATED (SELF%FDL9)
IF (LFDL9 .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_3RB (SELF%FDL9)
ENDIF

LFDM9 = ASSOCIATED (SELF%FDM9)
IF (LFDM9 .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_3RB (SELF%FDM9)
ENDIF

LFPC_PH = ASSOCIATED (SELF%FPC_PH)
IF (LFPC_PH .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_3RB (SELF%FPC_PH)
ENDIF
