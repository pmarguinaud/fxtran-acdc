...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CPG_PARALLEL:ISETTLOFF')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SLMISC_ISETTLOFF, YDCPG_SLMISC%F_ISETTLOFF)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_PARALLEL:ISETTLOFF')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_PARALLEL:ISETTLOFF:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SLMISC_ISETTLOFF, YDCPG_SLMISC%F_ISETTLOFF)
  IF (LHOOK) CALL DR_HOOK ('CPG_PARALLEL:ISETTLOFF:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CPG_PARALLEL:ISETTLOFF:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YFXTRAN_ACDC_STACK, Z_YDCPG_SLMISC_ISETTLOFF)  & 
  !$OMP & PRIVATE (JBLK)  & 
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CPG_PARALLEL:LSMTSOL')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_LSM, YDCPG_MISC%F_LSM)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_TSOL, YDCPG_MISC%F_TSOL)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_PARALLEL:LSMTSOL')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_PARALLEL:LSMTSOL:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_MISC_LSM, YDCPG_MISC%F_LSM)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_MISC_TSOL, YDCPG_MISC%F_TSOL)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PLSM, YDMF_PHYS_SURF%GSD_VF%F_LSM)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSP_RR_PT_T0, YDMF_PHYS_SURF%GSP_RR%F_T_T0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_T_T0, YDVARS%T%FT0)
  IF (LHOOK) CALL DR_HOOK ('CPG_PARALLEL:LSMTSOL:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('CPG_PARALLEL:LSMTSOL:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDGEOMETRY, YFXTRAN_ACDC_STACK, Z_YDCPG_MISC_LSM,  & 
  !$OMP &          Z_YDCPG_MISC_TSOL, Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_SURF_GSP_RR_PT_T0,  & 
  !$OMP &          Z_YDVARS_T_T0)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
