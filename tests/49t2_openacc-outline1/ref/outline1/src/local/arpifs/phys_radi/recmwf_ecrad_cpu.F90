SUBROUTINE RECMWF_ECRAD_CPU (KAERO, YDCPG_BNDS, YDCPG_OPTS, YDMODEL, PAEROCPL, PALBD, PALBP, PAPRS&
...
IF (LHOOK) CALL DR_HOOK ('RECMWF_ECRAD_CPU', 0, ZHOOK_HANDLE)
CALL RADIATION_SCHEME_CPU (YDMODEL, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDCPG_OPTS%KLON, YDCPG_OPTS&
&%KFLEVG, KAERO, YDMODEL%YRML_PHY_MF%YRPHY3%RII0, PRMU0, PTS, PALBD, PALBP, PSPECTRALEMISS, PCCNL&
&, PCCNO, PGELAM, PGEMU, PLSM, PAPRSF, PT, PAPRS, PTH, PQ, PRCO2, PRCH4, PRN2O, PRNO2, PRC11, PRC12&
&, PRC22, PRCL4, PPQO3, PRCLC, PQLWP, PQIWP, PRR, PS, PRAER, PPAERO, PAEROCPL, PSWFT (:,:, 1), PLWFT&
& (:,:, 1), PFCS, PFCT, PFRSOD, PFRTED, PPFRSODC, PPFRTEDC, PPFDIR, PPCDIR, PSUDU, PFLUX_UV, PFLUX_PAR&
&, PFLUX_PAR_CLEAR, PTINCF, PEMIT, PLWDERIVATIVE, PSWDIFFUSEBAND, PSWDIRECTBAND)
IF (LHOOK) CALL DR_HOOK ('RECMWF_ECRAD_CPU', 1, ZHOOK_HANDLE)
ENDSUBROUTINE
