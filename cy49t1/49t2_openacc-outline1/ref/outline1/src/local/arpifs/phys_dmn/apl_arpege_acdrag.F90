SUBROUTINE APL_ARPEGE_ACDRAG (YDVARS, YDCPG_MISC, YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_SURF&
&, YDMF_PHYS_BASE_STATE, YDMODEL, YDCPG_BNDS, PNEBS, PMSC_QW, PDQSTS, PCHROV&
&, PFLU_EMIS, PQLIS, PQV, PNBVNO, PFLU_NEIJ, PGWDCS)
