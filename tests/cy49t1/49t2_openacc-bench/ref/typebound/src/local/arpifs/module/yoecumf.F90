...
PROCEDURE :: ACDC_COPY => ACDC_COPY_TECUMF
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TECUMF
PROCEDURE :: ACDC_HOST => ACDC_HOST_TECUMF
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TECUMF
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TECUMF
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TECUMF
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TECUMF
END TYPE TECUMF
!============================================================================
...
MODULE SUBROUTINE ACDC_COPY_TECUMF (SELF, LDCREATED, LDFIELDAPI)
