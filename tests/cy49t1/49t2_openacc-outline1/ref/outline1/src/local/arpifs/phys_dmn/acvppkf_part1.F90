SUBROUTINE ACVPPKF_PART1 (LDOCHTRANS, K_KBDIA, YDCPG_OPTS, KTDIA, K_KCH1, D, KKICE, YDML_PHY_MF&
&, PSWLCL, PSTHES, PTHT, PRCTEN, KSPBL, PSTLCL, LDTRIG1, PRVTEN, PZUMF, PTKECLS, PSHAL_ZCH1TENS&
&, PSTHVELCL, KSDPL, PSTHLCL, KSLCL, PSHAL_ZCH1, PT, PRC, PRI, PZZ, KCLTOPS, PRITEN,&
& KCLBASS, PSZLCL, PPABS, PSTHV, PTTEN, PZW, PRV, PSRVLCL)
