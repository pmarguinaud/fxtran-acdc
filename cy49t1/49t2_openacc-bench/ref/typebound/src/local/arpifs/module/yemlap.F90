...
CONTAINS
PROCEDURE :: COPY => COPY_TLEP
PROCEDURE :: CRC64 => CRC64_TLEP
PROCEDURE :: HOST => HOST_TLEP
PROCEDURE :: LOAD => LOAD_TLEP
PROCEDURE :: SAVE => SAVE_TLEP
PROCEDURE :: SIZE => SIZE_TLEP
PROCEDURE :: WIPE => WIPE_TLEP
END TYPE TLEP

!     ------------------------------------------------------------------
INTERFACE

MODULE SUBROUTINE COPY_TLEP (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TLEP (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TLEP (SELF)

IMPLICIT NONE
CLASS (TLEP), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TLEP (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TLEP (SELF, KLUN)
...
MODULE FUNCTION SIZE_TLEP (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TLEP (SELF, LDDELETED, LDFIELDAPI)
