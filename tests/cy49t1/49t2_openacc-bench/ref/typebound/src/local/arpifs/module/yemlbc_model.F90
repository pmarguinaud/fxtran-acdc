...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TGMVSTENC
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TGMVSTENC
PROCEDURE :: ACDC_HOST => ACDC_HOST_TGMVSTENC
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TGMVSTENC
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TGMVSTENC
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TGMVSTENC
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TGMVSTENC
END TYPE TGMVSTENC
...
INTEGER(KIND=JPIM) :: NDIMT      ! number of temporally interpolated fields (includes derivatives)
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TGMVCPL
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TGMVCPL
PROCEDURE :: ACDC_HOST => ACDC_HOST_TGMVCPL
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TGMVCPL
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TGMVCPL
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TGMVCPL
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TGMVCPL
END TYPE TGMVCPL
...
INTEGER(KIND=JPIM) :: NDIMT      ! number of temporally interpolated fields (includes derivatives)
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TGMVSCPL
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TGMVSCPL
PROCEDURE :: ACDC_HOST => ACDC_HOST_TGMVSCPL
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TGMVSCPL
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TGMVSCPL
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TGMVSCPL
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TGMVSCPL
END TYPE TGMVSCPL
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TELBC_MODEL
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TELBC_MODEL
PROCEDURE :: ACDC_HOST => ACDC_HOST_TELBC_MODEL
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TELBC_MODEL
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TELBC_MODEL
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TELBC_MODEL
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TELBC_MODEL
...
MODULE SUBROUTINE ACDC_COPY_TGMVSTENC (SELF, LDCREATED, LDFIELDAPI)
...
MODULE FUNCTION ACDC_SIZE_TGMVSTENC (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE ACDC_CRC64_TGMVSCPL (SELF, KLUN, CDPATH)
USE FXTRAN_ACDC_CRC64_INTRINSIC_MOD, ONLY : FCRC64 => FXTRAN_ACDC_CRC64
IMPLICIT NONE
...
IF (YDML_LBC%LECOBI) THEN
  ...
  IF (YDML_LBC%LUNBC) THEN
    ZRZONU = 1.0_JPRB/(YDGEOMETRY%YRVERT_GEOM%YRVETA%VETAF(NBZONU+1)-YDGEOMETRY%YRVERT_GEOM%YRVETA%VETAF(1))
  ENDIF
  ...
  DO JFLD =1,YDML_LBC%NGALEF
    ...
    ELSE
      ...
      IF (YDML_LBC%LUNBC) THEN
        ! Compute ZBU:
        DO JA=2,NBZONU
          ZA=(YDGEOMETRY%YRVERT_GEOM%YRVETA%VETAF(JA)-YDGEOMETRY%YRVERT_GEOM%YRVETA%VETAF(1))*ZRZONU
          IF(ZREPA(JFLD) <= -2.0_JPRB) THEN
