...
IF ((.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE)) THEN
  CALL APL_ARPEGE_OCEANIC_FLUXES_ACFLUSO (LDHMT, YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_SURF&
  &, YDMF_PHYS_BASE_STATE, YDMODEL, YDCPG_BNDS, PFLU_CDN, PFLU_QSATS, PCHROV, PDSA_RS&
  &, PDPHIT, PFLU_CH, PCDROV, PFLU_CD, ZCE, PDPHIV, PCEROV)
ELSE
  CALL APL_ARPEGE_OCEANIC_FLUXES_OUTLINE_001 (YDCPG_OPTS, YDCPG_BNDS, PFLU_CH, PCHROV, ZCE, PCEROV)
ENDIF
