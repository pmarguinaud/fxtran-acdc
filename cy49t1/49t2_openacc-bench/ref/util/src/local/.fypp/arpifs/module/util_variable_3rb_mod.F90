...
SUBROUTINE COPY_VARIABLE_3RB (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE HOST_VARIABLE_3RB (SELF)
USE FIELD_UTIL_MODULE
...
SUBROUTINE LEGACY_VARIABLE_3RB (SELF, KADDRL, KADDRU, KDIR)
USE FIELD_UTIL_MODULE
...
SUBROUTINE CRC64_VARIABLE_3RB (SELF, KLUN, CDPATH)
USE FIELD_UTIL_MODULE
...
SUBROUTINE WIPE_VARIABLE_3RB (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
...
FUNCTION SIZE_VARIABLE_3RB (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
USE FIELD_UTIL_MODULE
