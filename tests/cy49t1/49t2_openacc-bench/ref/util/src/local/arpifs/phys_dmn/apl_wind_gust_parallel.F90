...
IF (YDMODEL%YRML_PHY_MF%YRPHY2%LRAFTKE) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_WIND_GUST_PARALLEL:ACCLDIA')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_WIND_GUST_PARALLEL:ACCLDIA')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_WIND_GUST_PARALLEL:ACCLDIA:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&PRESENT (KMOC_CLPH, PBLH, PDCAPE, YDCPG_OPTS, YDMODEL, YSTACK, Z_YDMF_PHYS_BASE_STATE_TKE, &
      !$ACC&         Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, &
      !$ACC&         Z_YDMF_PHYS_OUT_CAPE, Z_YDMF_PHYS_OUT_UCLS, Z_YDMF_PHYS_OUT_UGST, &
      !$ACC&         Z_YDMF_PHYS_OUT_VCLS, Z_YDMF_PHYS_OUT_VGST, Z_YDVARS_GEOMETRY_OROG_T0) &
      !$ACC&PRIVATE (JBLK) &
...
ENDSUBROUTINE APL_WIND_GUST_PARALLEL
