...
PROCEDURE :: ACDC_COPY => ACDC_COPY_CPG_TNDSI_DDH_TYPE
PROCEDURE :: ACDC_HOST => ACDC_HOST_CPG_TNDSI_DDH_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_CPG_TNDSI_DDH_TYPE
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_CPG_TNDHD_DDH_TYPE
PROCEDURE :: ACDC_HOST => ACDC_HOST_CPG_TNDHD_DDH_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_CPG_TNDHD_DDH_TYPE
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_CPG_TNDSL_DDH_3D_TYPE
PROCEDURE :: ACDC_HOST => ACDC_HOST_CPG_TNDSL_DDH_3D_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_CPG_TNDSL_DDH_3D_TYPE
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_CPG_TNDSL_DDH_TYPE
PROCEDURE :: ACDC_HOST => ACDC_HOST_CPG_TNDSL_DDH_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_CPG_TNDSL_DDH_TYPE
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_CPG_DDH_TND_TYPE
PROCEDURE :: ACDC_HOST => ACDC_HOST_CPG_DDH_TND_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_CPG_DDH_TND_TYPE
...
MODULE SUBROUTINE ACDC_WIPE_CPG_TNDHD_DDH_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_TNDHD_DDH_TYPE), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
...
MODULE SUBROUTINE ACDC_COPY_CPG_TNDSL_DDH_3D_TYPE (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_TNDSL_DDH_3D_TYPE), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDCREATED, LDFIELDAPI
END SUBROUTINE
...
MODULE SUBROUTINE ACDC_WIPE_CPG_TNDSL_DDH_3D_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_TNDSL_DDH_3D_TYPE), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
...
MODULE SUBROUTINE ACDC_HOST_CPG_TNDSL_DDH_TYPE (SELF)
