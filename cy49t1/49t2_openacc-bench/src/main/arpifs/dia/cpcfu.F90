...
LOGICAL :: LLFRRC, LLRESET, LLNORESET
...
IF (YDCFU%YLOADSNOW%LACTIVE)            CALL COPY1_CFU (YDCFU%YLOADSNOW, YDCFU%LOADSNOW, YDMF_PHYS_OUT%LOADSNOW)
IF (YDCFU%YLOADICE%LACTIVE)             CALL COPY1_CFU (YDCFU%YLOADICE, YDCFU%LOADICE, YDMF_PHYS_OUT%LOADICE)
IF (YDCFU%YDIAMACCR%LACTIVE)            CALL COPY1_CFU (YDCFU%YDIAMACCR, YDCFU%DIAMACCR, YDMF_PHYS_OUT%DIAMACCR)
IF (YDCFU%YPCPWSNOW%LACTIVE)            CALL COPY1_CFU (YDCFU%YPCPWSNOW, YDCFU%PCPWSNOW, YDMF_PHYS_OUT%PCPWSNOW)
IF (YDCFU%YPCPICE%LACTIVE)              CALL COPY1_CFU (YDCFU%YPCPICE, YDCFU%PCPICE, YDMF_PHYS_OUT%PCPICE)
