...
IF (LPARALLELMETHOD ('OPENMP','CPG_GP_HYD_PARALLEL:0')) THEN
  ...
  IF (LSYNCHOST ('CPG_GP_HYD_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_GP_HYD_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_HYD_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_HYD_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, Z_RPREF_T0, Z_XYBDER_ALPHL_T0, &
    !$ACC&         Z_XYBDER_ALPHM_T0, Z_XYBDER_ALPHPLL_T0, Z_XYBDER_ALPHPLM_T0, &
    !$ACC&         Z_XYBDER_COEFAPL_T0, Z_XYBDER_COEFA_T0, Z_XYBDER_COEFD_T0, &
    !$ACC&         Z_XYBDER_LNPRL_T0, Z_XYBDER_LNPRM_T0, Z_YDCPG_DYN0_GWFT, &
    !$ACC&         Z_YDCPG_DYN0_NHX, Z_YDCPG_DYN0_PRE, Z_YDCPG_DYN0_PREF, Z_YDCPG_DYN0_PREL, &
    !$ACC&         Z_YDCPG_DYN0_PREM, Z_YDCPG_DYN0_XYB_ALPH, Z_YDCPG_DYN0_XYB_DELP, &
    !$ACC&         Z_YDCPG_DYN0_XYB_LNPR, Z_YDCPG_DYN0_XYB_RDELP, Z_YDCPG_DYN0_XYB_RPP, &
    !$ACC&         Z_YDCPG_DYN0_XYB_RPRE, Z_YDCPG_DYN0_XYB_RTGR) &
    !$ACC&PRIVATE (JBLK) &
...
IF (LPARALLELMETHOD ('OPENMP','CPG_GP_HYD_PARALLEL:1')) THEN
  ...
  IF (LSYNCHOST ('CPG_GP_HYD_PARALLEL:1')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_GP_HYD_PARALLEL:1')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_HYD_PARALLEL:1')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_HYD_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, Z_DPHYCTY_T0, Z_RDT_T0, &
    !$ACC&         Z_RPREF_T0, Z_RT_T0, Z_YDCPG_DYN0_CTY_DIVDP, Z_YDCPG_DYN0_CTY_EVEL, &
    ...
    DO JROF = 1, MIN (YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1) * YDCPG_OPTS%KLON)
      ...
      ELSE
        CALL ACPY (JROF, Z_RDT_T0 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG,&
        & JBLK), Z_RT_T0 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK))
      ENDIF
...
IF (LPARALLELMETHOD ('OPENMP','CPG_GP_HYD_PARALLEL:2')) THEN
  ...
  IF (LSYNCHOST ('CPG_GP_HYD_PARALLEL:2')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_GP_HYD_PARALLEL:2')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_HYD_PARALLEL:2')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_HYD_PARALLEL:2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (P_GWHT_T0, YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, Z_DVER_T0, &
    !$ACC&         Z_GPHL_T0, Z_GPHM_T0, Z_NHXT_T0, Z_PSGRTL_T0, Z_PSGRTM_T0, Z_RDT_T0, &
    !$ACC&         Z_RT_T0, Z_SGRTL_T0, Z_SGRTM_T0, Z_US_T0, Z_VS_T0, Z_XYBDER_ALPHL_T0, &
    !$ACC&         Z_XYBDER_ALPHM_T0, Z_XYBDER_ALPHPLL_T0, Z_XYBDER_ALPHPLM_T0, &
    ...
    DO JROF = 1, MIN (YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1) * YDCPG_OPTS%KLON)
      ...
      IF (YDMODEL%YRML_DYN%YRDYNA%LGRADSP) THEN
        ...
        CALL ACPY (JROF, Z_YDVARS_SGRTL_T0 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG&
        &, JBLK), Z_PSGRTL_T0 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK))
        CALL ACPY (JROF, Z_YDVARS_SGRTM_T0 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG&
        &, JBLK), Z_PSGRTM_T0 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK))
        CALL ACPY (JROF, Z_PSGRTL_T0 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG,&
        & JBLK), Z_SGRTL_T0 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK))
        CALL ACPY (JROF, Z_PSGRTM_T0 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG,&
        & JBLK), Z_SGRTM_T0 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK))
      ENDIF
...
IF (LPARALLELMETHOD ('OPENMP','CPG_GP_HYD_PARALLEL:3')) THEN
  ...
  IF (LSYNCHOST ('CPG_GP_HYD_PARALLEL:3')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_GP_HYD_PARALLEL:3')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_HYD_PARALLEL:3')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_HYD_PARALLEL:3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (P_GWHT_T0, YDCPG_OPTS, YSTACK) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ENDSUBROUTINE CPG_GP_HYD_PARALLEL
