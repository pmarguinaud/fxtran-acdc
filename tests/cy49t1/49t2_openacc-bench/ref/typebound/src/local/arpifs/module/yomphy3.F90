...
CONTAINS
PROCEDURE :: COPY => COPY_TPHY3
PROCEDURE :: CRC64 => CRC64_TPHY3
PROCEDURE :: HOST => HOST_TPHY3
PROCEDURE :: LOAD => LOAD_TPHY3
PROCEDURE :: SAVE => SAVE_TPHY3
PROCEDURE :: SIZE => SIZE_TPHY3
PROCEDURE :: WIPE => WIPE_TPHY3
END TYPE TPHY3
...
MODULE SUBROUTINE COPY_TPHY3 (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TPHY3 (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TPHY3 (SELF)

IMPLICIT NONE
CLASS (TPHY3), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TPHY3 (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TPHY3 (SELF, KLUN)
...
MODULE FUNCTION SIZE_TPHY3 (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TPHY3 (SELF, LDDELETED, LDFIELDAPI)
