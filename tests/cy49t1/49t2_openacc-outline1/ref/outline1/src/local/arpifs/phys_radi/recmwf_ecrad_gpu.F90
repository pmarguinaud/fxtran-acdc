SUBROUTINE RECMWF_ECRAD_GPU (KAERO, YDCPG_OPTS, YDMODEL, YDCPG_BNDS, PSWDIRECTBAND, PRC12, PLSM, PPFRTEDC&
&, PAEROCPL, PPFRSODC, PPFDIR, PFCT, PTINCF, PFRTED, PGELAM, PPCDIR, PQLWP, PFLUX_PAR_CLEAR, PRNO2&
&, PRAER, PFCS, PRCLC, PTH, PFLUX_UV, PRMU0, PSPECTRALEMISS, PGEMU, PQ, PALBD, PAPRS, PFRSOD, PPAERO&
&, PRR, PRC11, PPQO3, PT, PSWDIFFUSEBAND, PRCL4, PTS, PRN2O, PCCNO, PQIWP, PALBP, PRC22, PRCO2, PLWFT&
&, PFLUX_PAR, PSWFT, PCCNL, PEMIT, PSUDU, PAPRSF, PLWDERIVATIVE, PS, PRCH4)
