...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PRECIPITATION_PARALLEL:ACUPTQ')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_PRECIPITATION_PARALLEL:ACUPTQ')) THEN
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PRECIPITATION_PARALLEL&
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PRECIPITATION_PARALLEL:ACUPTQ')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PRECIPITATION_PARALLEL:ACUPTQ')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PRECIPITATION_PARALLEL:ACUPTQ:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         YDSTA, YSTACK, ZFRSO, ZFRTH, ZQMIC, ZTMIC, Z_YDMF_PHYS_BASE_STATE_Q, &
...
ENDSUBROUTINE APL_ARPEGE_PRECIPITATION_PARALLEL
