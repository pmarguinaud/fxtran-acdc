...
CONTAINS
PROCEDURE :: COPY => COPY_TDYNA
PROCEDURE :: CRC64 => CRC64_TDYNA
PROCEDURE :: HOST => HOST_TDYNA
PROCEDURE :: LOAD => LOAD_TDYNA
PROCEDURE :: SAVE => SAVE_TDYNA
PROCEDURE :: SIZE => SIZE_TDYNA
PROCEDURE :: WIPE => WIPE_TDYNA
END TYPE TDYNA
! ----------------------------------------------------------------------
INTERFACE
...
MODULE SUBROUTINE CRC64_TDYNA (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TDYNA (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TDYNA (SELF, KLUN)
...
MODULE FUNCTION SIZE_TDYNA (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TDYNA (SELF, LDDELETED, LDFIELDAPI)
