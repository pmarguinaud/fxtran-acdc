...
!$ACDC methods  --only-types TSPPT_CONFIG
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TSPPT_CONFIG
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TSPPT_CONFIG
PROCEDURE :: ACDC_HOST => ACDC_HOST_TSPPT_CONFIG
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TSPPT_CONFIG
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TSPPT_CONFIG
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TSPPT_CONFIG
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TSPPT_CONFIG
