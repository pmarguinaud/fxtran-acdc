...
CONTAINS
PROCEDURE :: COPY => COPY_REGLATLON_FIELD
PROCEDURE :: CRC64 => CRC64_REGLATLON_FIELD
PROCEDURE :: HOST => HOST_REGLATLON_FIELD
PROCEDURE :: LOAD => LOAD_REGLATLON_FIELD
PROCEDURE :: SAVE => SAVE_REGLATLON_FIELD
PROCEDURE :: SIZE => SIZE_REGLATLON_FIELD
PROCEDURE :: WIPE => WIPE_REGLATLON_FIELD
END TYPE REGLATLON_FIELD

INTERFACE

MODULE SUBROUTINE COPY_REGLATLON_FIELD (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_REGLATLON_FIELD (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_REGLATLON_FIELD (SELF)

IMPLICIT NONE
CLASS (REGLATLON_FIELD), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_REGLATLON_FIELD (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_REGLATLON_FIELD (SELF, KLUN)
...
MODULE FUNCTION SIZE_REGLATLON_FIELD (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_REGLATLON_FIELD (SELF, LDDELETED, LDFIELDAPI)
