...
CONTAINS
PROCEDURE :: COPY => COPY_TEGEO
PROCEDURE :: CRC64 => CRC64_TEGEO
PROCEDURE :: HOST => HOST_TEGEO
PROCEDURE :: LOAD => LOAD_TEGEO
PROCEDURE :: SAVE => SAVE_TEGEO
PROCEDURE :: SIZE => SIZE_TEGEO
PROCEDURE :: WIPE => WIPE_TEGEO
END TYPE TEGEO

!     ------------------------------------------------------------------
INTERFACE

MODULE SUBROUTINE COPY_TEGEO (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TEGEO (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TEGEO (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TEGEO (SELF, KLUN)
...
MODULE FUNCTION SIZE_TEGEO (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TEGEO (SELF, LDDELETED, LDFIELDAPI)
