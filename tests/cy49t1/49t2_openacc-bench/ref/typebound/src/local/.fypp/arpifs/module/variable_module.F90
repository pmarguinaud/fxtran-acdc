...
PROCEDURE :: ACDC_COPY => ACDC_COPY_VARIABLE_BASE
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_VARIABLE_BASE
PROCEDURE :: ACDC_HOST => ACDC_HOST_VARIABLE_BASE
PROCEDURE :: ACDC_LEGACY => ACDC_LEGACY_VARIABLE_BASE
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_VARIABLE_BASE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_VARIABLE_BASE
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_VARIABLE_2RB
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_VARIABLE_2RB
PROCEDURE :: ACDC_HOST => ACDC_HOST_VARIABLE_2RB
PROCEDURE :: ACDC_LEGACY => ACDC_LEGACY_VARIABLE_2RB
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_VARIABLE_2RB
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_VARIABLE_2RB
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_VARIABLE_3RB
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_VARIABLE_3RB
PROCEDURE :: ACDC_HOST => ACDC_HOST_VARIABLE_3RB
PROCEDURE :: ACDC_LEGACY => ACDC_LEGACY_VARIABLE_3RB
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_VARIABLE_3RB
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_VARIABLE_3RB
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_VARIABLE_4RB
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_VARIABLE_4RB
PROCEDURE :: ACDC_HOST => ACDC_HOST_VARIABLE_4RB
PROCEDURE :: ACDC_LEGACY => ACDC_LEGACY_VARIABLE_4RB
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_VARIABLE_4RB
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_VARIABLE_4RB
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_VARIABLE_2RD
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_VARIABLE_2RD
PROCEDURE :: ACDC_HOST => ACDC_HOST_VARIABLE_2RD
PROCEDURE :: ACDC_LEGACY => ACDC_LEGACY_VARIABLE_2RD
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_VARIABLE_2RD
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_VARIABLE_2RD
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_VARIABLE_3RD
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_VARIABLE_3RD
PROCEDURE :: ACDC_HOST => ACDC_HOST_VARIABLE_3RD
PROCEDURE :: ACDC_LEGACY => ACDC_LEGACY_VARIABLE_3RD
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_VARIABLE_3RD
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_VARIABLE_3RD
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_VARIABLE_4RD
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_VARIABLE_4RD
PROCEDURE :: ACDC_HOST => ACDC_HOST_VARIABLE_4RD
PROCEDURE :: ACDC_LEGACY => ACDC_LEGACY_VARIABLE_4RD
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_VARIABLE_4RD
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_VARIABLE_4RD
...
MODULE SUBROUTINE ACDC_COPY_VARIABLE_2RB (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE ACDC_CRC64_VARIABLE_2RB (SELF, KLUN, CDPATH)
USE FIELD_UTIL_MODULE
USE FXTRAN_ACDC_CRC64_INTRINSIC_MOD, ONLY : FCRC64 => FXTRAN_ACDC_CRC64
IMPLICIT NONE
...
MODULE FUNCTION ACDC_SIZE_VARIABLE_2RB (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_2RB),     INTENT (IN), TARGET :: SELF
CHARACTER(LEN=*), INTENT (IN), OPTIONAL :: CDPATH
...
MODULE SUBROUTINE ACDC_CRC64_VARIABLE_3RB (SELF, KLUN, CDPATH)
USE FIELD_UTIL_MODULE
USE FXTRAN_ACDC_CRC64_INTRINSIC_MOD, ONLY : FCRC64 => FXTRAN_ACDC_CRC64
IMPLICIT NONE
...
MODULE SUBROUTINE ACDC_HOST_VARIABLE_3RB (SELF)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_3RB), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE ACDC_LEGACY_VARIABLE_3RB (SELF, KADDRL, KADDRU, KDIR)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_3RB), TARGET :: SELF
INTEGER*8, INTENT (IN) :: KADDRL
...
MODULE FUNCTION ACDC_SIZE_VARIABLE_3RB (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_3RB),     INTENT (IN), TARGET :: SELF
CHARACTER(LEN=*), INTENT (IN), OPTIONAL :: CDPATH
...
MODULE SUBROUTINE ACDC_WIPE_VARIABLE_3RB (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_3RB), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
...
MODULE SUBROUTINE ACDC_COPY_VARIABLE_4RB (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_4RB), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDCREATED, LDFIELDAPI
END SUBROUTINE

MODULE SUBROUTINE ACDC_CRC64_VARIABLE_4RB (SELF, KLUN, CDPATH)
USE FIELD_UTIL_MODULE
USE FXTRAN_ACDC_CRC64_INTRINSIC_MOD, ONLY : FCRC64 => FXTRAN_ACDC_CRC64
IMPLICIT NONE
...
MODULE SUBROUTINE ACDC_HOST_VARIABLE_4RB (SELF)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_4RB), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE ACDC_LEGACY_VARIABLE_4RB (SELF, KADDRL, KADDRU, KDIR)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_4RB), TARGET :: SELF
INTEGER*8, INTENT (IN) :: KADDRL
...
MODULE FUNCTION ACDC_SIZE_VARIABLE_4RB (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_4RB),     INTENT (IN), TARGET :: SELF
CHARACTER(LEN=*), INTENT (IN), OPTIONAL :: CDPATH
...
MODULE SUBROUTINE ACDC_WIPE_VARIABLE_4RB (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_4RB), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
...
MODULE SUBROUTINE ACDC_COPY_VARIABLE_2RD (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
...
MODULE SUBROUTINE ACDC_LEGACY_VARIABLE_2RD (SELF, KADDRL, KADDRU, KDIR)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_2RD), TARGET :: SELF
INTEGER*8, INTENT (IN) :: KADDRL
...
MODULE SUBROUTINE ACDC_WIPE_VARIABLE_2RD (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_2RD), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
...
MODULE SUBROUTINE ACDC_COPY_VARIABLE_3RD (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_3RD), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDCREATED, LDFIELDAPI
END SUBROUTINE

MODULE SUBROUTINE ACDC_CRC64_VARIABLE_3RD (SELF, KLUN, CDPATH)
USE FIELD_UTIL_MODULE
USE FXTRAN_ACDC_CRC64_INTRINSIC_MOD, ONLY : FCRC64 => FXTRAN_ACDC_CRC64
IMPLICIT NONE
...
MODULE SUBROUTINE ACDC_LEGACY_VARIABLE_3RD (SELF, KADDRL, KADDRU, KDIR)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_3RD), TARGET :: SELF
INTEGER*8, INTENT (IN) :: KADDRL
...
MODULE FUNCTION ACDC_SIZE_VARIABLE_3RD (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_3RD),     INTENT (IN), TARGET :: SELF
CHARACTER(LEN=*), INTENT (IN), OPTIONAL :: CDPATH
...
MODULE SUBROUTINE ACDC_WIPE_VARIABLE_3RD (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_3RD), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
...
MODULE SUBROUTINE ACDC_COPY_VARIABLE_4RD (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_4RD), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDCREATED, LDFIELDAPI
END SUBROUTINE

MODULE SUBROUTINE ACDC_CRC64_VARIABLE_4RD (SELF, KLUN, CDPATH)
USE FIELD_UTIL_MODULE
USE FXTRAN_ACDC_CRC64_INTRINSIC_MOD, ONLY : FCRC64 => FXTRAN_ACDC_CRC64
IMPLICIT NONE
...
MODULE SUBROUTINE ACDC_HOST_VARIABLE_4RD (SELF)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_4RD), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE ACDC_LEGACY_VARIABLE_4RD (SELF, KADDRL, KADDRU, KDIR)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_4RD), TARGET :: SELF
INTEGER*8, INTENT (IN) :: KADDRL
...
MODULE FUNCTION ACDC_SIZE_VARIABLE_4RD (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_4RD),     INTENT (IN), TARGET :: SELF
CHARACTER(LEN=*), INTENT (IN), OPTIONAL :: CDPATH
...
MODULE SUBROUTINE ACDC_WIPE_VARIABLE_4RD (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (VARIABLE_4RD), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
