...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_NEB_T
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_NEB_T
PROCEDURE :: ACDC_HOST => ACDC_HOST_NEB_T
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_NEB_T
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_NEB_T
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_NEB_T
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_NEB_T
END TYPE NEB_t
