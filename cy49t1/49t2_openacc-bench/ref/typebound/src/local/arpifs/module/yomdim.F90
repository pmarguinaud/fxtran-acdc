...
CONTAINS
PROCEDURE :: COPY => COPY_TDIM
PROCEDURE :: CRC64 => CRC64_TDIM
PROCEDURE :: HOST => HOST_TDIM
PROCEDURE :: LOAD => LOAD_TDIM
PROCEDURE :: SAVE => SAVE_TDIM
PROCEDURE :: SIZE => SIZE_TDIM
PROCEDURE :: WIPE => WIPE_TDIM
END TYPE TDIM
...
MODULE SUBROUTINE COPY_TDIM (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TDIM (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TDIM (SELF)

IMPLICIT NONE
CLASS (TDIM), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TDIM (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TDIM (SELF, KLUN)
...
MODULE FUNCTION SIZE_TDIM (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TDIM (SELF, LDDELETED, LDFIELDAPI)
