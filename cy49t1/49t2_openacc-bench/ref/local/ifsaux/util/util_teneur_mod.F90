...
SUBROUTINE SAVE_TENEUR (SELF, KLUN)
...
SUBROUTINE LOAD_TENEUR (SELF, KLUN)
...
SUBROUTINE COPY_TENEUR (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE CRC64_TENEUR (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TENEUR (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TENEUR (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
