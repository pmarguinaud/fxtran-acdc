...
IF (LPARALLELMETHOD ('OPENMP','LARMES_PARALLEL:LARMES')) THEN
  ...
  IF (LSYNCHOST ('LARMES_PARALLEL:LARMES')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARMES_PARALLEL:LARMES')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARMES_PARALLEL:LARMES')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('LARMES_PARALLEL:LARMES:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         YDRIP, YDSL, YSTACK, ZPLEV, ZSCO, ZWF, ZWFASM, ZWFSM, ZWF_2, ZWO_2, ZX0, &
    !$ACC&         ZXF, ZY0, ZYF, ZZ0, ZZF, Z_YDA_KVSEPC_P, Z_YDA_KVSEPL_P, Z_YDCPG_SL1_UR0_P, &
    !$ACC&         Z_YDCPG_SL1_VR0_P, Z_YDCPG_SL1_WR0_P, Z_YDCPG_SL1_WRA_P, &
    !$ACC&         Z_YDCPG_SL1_ZR0_P, Z_YDCPG_SL2_STDDISU, Z_YDCPG_SL2_STDDISV, &
    !$ACC&         Z_YDCPG_SL2_STDDISW, Z_YDCPG_SL2_URL, Z_YDCPG_SL2_VRL, Z_YDCPG_SL2_WRL, &
    !$ACC&         Z_YDGEOMVARS_GECLO_P, Z_YDGEOMVARS_GEMU_P, Z_YDGEOMVARS_GESLO_P, &
    !$ACC&         Z_YDGEOMVARS_GNORDL_P, Z_YDGEOMVARS_GNORDM_P, Z_YDGEOMVARS_GSQM2_P, &
    !$ACC&         Z_YDGEOMVARS_RCOLON_P, Z_YDGEOMVARS_RSILON_P, Z_YDMASK_SL2_P) &
    !$ACC&PRIVATE (JBLK) &
