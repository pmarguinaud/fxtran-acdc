...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LATTES_PARALLEL:0')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (PRES0, YD_PRES0)
  CALL SGET_HOST_DATA_RDONLY (PSDIV0, YD_PSDIV0)
  CALL SGET_HOST_DATA_RDONLY (PSDIV9, YD_PSDIV9)
  CALL SGET_HOST_DATA_RDONLY (PSDVBC, YD_PSDVBC)
  CALL SGET_HOST_DATA_RDWR (ZMOY1SP, YL_ZMOY1SP)
  CALL SGET_HOST_DATA_RDWR (ZMOYSPNL, YL_ZMOYSPNL)
  CALL SGET_HOST_DATA_RDWR (ZSPNLT0, YL_ZSPNLT0)
  CALL SGET_HOST_DATA_RDWR (ZSPNLT1, YL_ZSPNLT1)
  CALL SGET_HOST_DATA_RDWR (ZSPNLT_FE, YL_ZSPNLT_FE)
  CALL SGET_HOST_DATA_RDWR (ZSPT1, YL_ZSPT1)
  CALL SGET_HOST_DATA_RDWR (ZSPTB, YL_ZSPTB)
  ...
  CALL SGET_HOST_DATA_RDWR (Z_YDVARS_CSPNL_T9, YDVARS%CSPNL%FT9)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_GEOMETRY_OROG_T0, YDVARS%GEOMETRY%OROG%FT0)
  CALL SGET_HOST_DATA_RDWR (Z_YDVARS_SPNL_T9, YDVARS%SPNL%FT9)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('LATTES_PARALLEL:0')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (PRES0, YD_PRES0)
    CALL SGET_HOST_DATA_RDWR (PSDIV0, YD_PSDIV0)
    CALL SGET_HOST_DATA_RDWR (PSDIV9, YD_PSDIV9)
    CALL SGET_HOST_DATA_RDWR (PSDVBC, YD_PSDVBC)
    CALL SGET_HOST_DATA_RDWR (ZMOY1SP, YL_ZMOY1SP)
    CALL SGET_HOST_DATA_RDWR (ZMOYSPNL, YL_ZMOYSPNL)
    CALL SGET_HOST_DATA_RDWR (ZSPNLT0, YL_ZSPNLT0)
    CALL SGET_HOST_DATA_RDWR (ZSPNLT1, YL_ZSPNLT1)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTES_PARALLEL:0')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDONLY (PRES0, YD_PRES0)
  CALL SGET_DEVICE_DATA_RDONLY (PSDIV0, YD_PSDIV0)
  CALL SGET_DEVICE_DATA_RDONLY (PSDIV9, YD_PSDIV9)
  CALL SGET_DEVICE_DATA_RDONLY (PSDVBC, YD_PSDVBC)
  CALL SGET_DEVICE_DATA_RDWR (ZMOY1SP, YL_ZMOY1SP)
  CALL SGET_DEVICE_DATA_RDWR (ZMOYSPNL, YL_ZMOYSPNL)
  CALL SGET_DEVICE_DATA_RDWR (ZSPNLT0, YL_ZSPNLT0)
  CALL SGET_DEVICE_DATA_RDWR (ZSPNLT1, YL_ZSPNLT1)
  CALL SGET_DEVICE_DATA_RDWR (ZSPNLT_FE, YL_ZSPNLT_FE)
  CALL SGET_DEVICE_DATA_RDWR (ZSPT1, YL_ZSPT1)
  CALL SGET_DEVICE_DATA_RDWR (ZSPTB, YL_ZSPTB)
  CALL SGET_DEVICE_DATA_RDWR (ZVWEI, YL_ZVWEI)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_C9_NL_P, YDCPG_SL1%C9_NL%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_C9_P, YDCPG_SL1%C9%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_SP9_P, YDCPG_SL1%SP9%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL2_SPSI, YDCPG_SL2%F_SPSI)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_CSPNL_T9, YDVARS%CSPNL%FT9)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_OROG_T0, YDVARS%GEOMETRY%OROG%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SPNL_T9, YDVARS%SPNL%FT9)
  ...
  !$OMP & MAP(PRESENT:PBDT, PMIXNL, POROGL, POROGM, PRES0, PSDIV0, PSDIV9, PSDVBC, YDCPG_OPTS,  & 
  !$OMP &          YDGEOMETRY, YDML_DYN, YDRIP, YFXTRAN_ACDC_STACK, ZMOY1SP, ZMOYSPNL,  & 
  !$OMP &          ZSPNLT0, ZSPNLT1, ZSPNLT_FE, ZSPT1, ZSPTB, ZVWEI, Z_YDCPG_SL1_C9_NL_P,  & 
  !$OMP &          Z_YDCPG_SL1_C9_P, Z_YDCPG_SL1_SP9_P, Z_YDCPG_SL2_SPSI, Z_YDVARS_CSPNL_T9,  & 
  !$OMP &          Z_YDVARS_GEOMETRY_OROG_T0, Z_YDVARS_SPNL_T9, Z_YDVARS_SP_DL,  & 
  !$OMP &          Z_YDVARS_SP_DM, Z_YDVARS_SP_T0, Z_YDVARS_SP_T1, Z_YDVARS_SP_T9,  & 
  !$OMP &          Z_YDVARS_U_T0, Z_YDVARS_V_T0)  & 
  !$OMP & PRIVATE (JBLK)  & 
  ...
  DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
    ...
    !$OMP & PRIVATE (JLEV, JROF, YLCPG_BNDS, YLSTACK, ZMIXNL, ZNESC, ZSETTLS)       
