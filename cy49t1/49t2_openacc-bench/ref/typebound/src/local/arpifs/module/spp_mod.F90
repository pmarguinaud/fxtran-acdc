...
CONTAINS
PROCEDURE :: COPY => COPY_TSPP_CONFIG
PROCEDURE :: CRC64 => CRC64_TSPP_CONFIG
PROCEDURE :: HOST => HOST_TSPP_CONFIG
PROCEDURE :: LOAD => LOAD_TSPP_CONFIG
PROCEDURE :: SAVE => SAVE_TSPP_CONFIG
PROCEDURE :: SIZE => SIZE_TSPP_CONFIG
PROCEDURE :: WIPE => WIPE_TSPP_CONFIG
...
MODULE SUBROUTINE COPY_TSPP_CONFIG (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TSPP_CONFIG (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TSPP_CONFIG (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TSPP_CONFIG (SELF, KLUN)
...
MODULE FUNCTION SIZE_TSPP_CONFIG (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TSPP_CONFIG (SELF, LDDELETED, LDFIELDAPI)
