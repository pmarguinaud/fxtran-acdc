...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LARMES_PARALLEL:LARMES')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (IDEP, YL_IDEP)
  CALL SGET_HOST_DATA_RDWR (IL0A, YL_IL0A)
  CALL SGET_HOST_DATA_RDWR (INOWENO, YL_INOWENO)
  CALL SGET_HOST_DATA_RDWR (ISTESB, YL_ISTESB)
  CALL SGET_HOST_DATA_RDWR (ISTEST, YL_ISTEST)
  CALL SGET_HOST_DATA_RDWR (KL0, YD_KL0)
  CALL SGET_HOST_DATA_RDWR (KLEV, YD_KLEV)
  CALL SGET_HOST_DATA_RDWR (KLH0, YD_KLH0)
  CALL SGET_HOST_DATA_RDWR (PCCO, YD_PCCO)
  CALL SGET_HOST_DATA_RDWR (PLEV, YD_PLEV)
  CALL SGET_HOST_DATA_RDWR (PLSCAW, YD_PLSCAW)
  CALL SGET_HOST_DATA_RDWR (PRSCAW, YD_PRSCAW)
  CALL SGET_HOST_DATA_RDWR (PSCO, YD_PSCO)
  CALL SGET_HOST_DATA_RDWR (PUF, YD_PUF)
  CALL SGET_HOST_DATA_RDWR (PVF, YD_PVF)
  CALL SGET_HOST_DATA_RDWR (PWF, YD_PWF)
  CALL SGET_HOST_DATA_RDWR (ZPLEV, YL_ZPLEV)
  CALL SGET_HOST_DATA_RDWR (ZSCO, YL_ZSCO)
  CALL SGET_HOST_DATA_RDWR (ZWF, YL_ZWF)
  CALL SGET_HOST_DATA_RDWR (ZWFASM, YL_ZWFASM)
  CALL SGET_HOST_DATA_RDWR (ZWFSM, YL_ZWFSM)
  CALL SGET_HOST_DATA_RDWR (ZWF_2, YL_ZWF_2)
  CALL SGET_HOST_DATA_RDWR (ZWO_2, YL_ZWO_2)
  CALL SGET_HOST_DATA_RDWR (ZX0, YL_ZX0)
  CALL SGET_HOST_DATA_RDWR (ZXF, YL_ZXF)
  CALL SGET_HOST_DATA_RDWR (ZY0, YL_ZY0)
  CALL SGET_HOST_DATA_RDWR (ZYF, YL_ZYF)
  CALL SGET_HOST_DATA_RDWR (ZZ0, YL_ZZ0)
  CALL SGET_HOST_DATA_RDWR (ZZF, YL_ZZF)
  CALL SGET_HOST_DATA_RDWR (Z_YDA_KVSEPC_P, YDA_KVSEPC%F_P)
  CALL SGET_HOST_DATA_RDWR (Z_YDA_KVSEPL_P, YDA_KVSEPL%F_P)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_UR0_P, YDCPG_SL1%UR0%F_P)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_VR0_P, YDCPG_SL1%VR0%F_P)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_WR0_P, YDCPG_SL1%WR0%F_P)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_WRA_P, YDCPG_SL1%WRA%F_P)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_ZR0_P, YDCPG_SL1%ZR0%F_P)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_STDDISU, YDCPG_SL2%F_STDDISU)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_STDDISV, YDCPG_SL2%F_STDDISV)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_STDDISW, YDCPG_SL2%F_STDDISW)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_URL, YDCPG_SL2%F_URL)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_VRL, YDCPG_SL2%F_VRL)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_WRL, YDCPG_SL2%F_WRL)
  CALL SGET_HOST_DATA_RDONLY (Z_YDGEOMVARS_GECLO_P, YDGEOMVARS%GECLO%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDGEOMVARS_GEMU_P, YDGEOMVARS%GEMU%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDGEOMVARS_GESLO_P, YDGEOMVARS%GESLO%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDGEOMVARS_GNORDL_P, YDGEOMVARS%GNORDL%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDGEOMVARS_GNORDM_P, YDGEOMVARS%GNORDM%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDGEOMVARS_GSQM2_P, YDGEOMVARS%GSQM2%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDGEOMVARS_RCOLON_P, YDGEOMVARS%RCOLON%FT0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDGEOMVARS_RSILON_P, YDGEOMVARS%RSILON%FT0)
  CALL SGET_HOST_DATA_RDWR (Z_YDMASK_SL2_P, YDMASK_SL2%F_P)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('LARMES_PARALLEL:LARMES')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_WRA_P, YDCPG_SL1%WRA%F_P)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_ZR0_P, YDCPG_SL1%ZR0%F_P)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_STDDISU, YDCPG_SL2%F_STDDISU)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_STDDISV, YDCPG_SL2%F_STDDISV)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_STDDISW, YDCPG_SL2%F_STDDISW)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_URL, YDCPG_SL2%F_URL)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_VRL, YDCPG_SL2%F_VRL)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_WRL, YDCPG_SL2%F_WRL)
    CALL SGET_HOST_DATA_RDWR (Z_YDGEOMVARS_GECLO_P, YDGEOMVARS%GECLO%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDGEOMVARS_GEMU_P, YDGEOMVARS%GEMU%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDGEOMVARS_GESLO_P, YDGEOMVARS%GESLO%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDGEOMVARS_GNORDL_P, YDGEOMVARS%GNORDL%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDGEOMVARS_GNORDM_P, YDGEOMVARS%GNORDM%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDGEOMVARS_GSQM2_P, YDGEOMVARS%GSQM2%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDGEOMVARS_RCOLON_P, YDGEOMVARS%RCOLON%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDGEOMVARS_RSILON_P, YDGEOMVARS%RSILON%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDMASK_SL2_P, YDMASK_SL2%F_P)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARMES_PARALLEL:LARMES')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('LARMES_PARALLEL:LARMES:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (IDEP, YL_IDEP)
  CALL SGET_DEVICE_DATA_RDWR (IL0A, YL_IL0A)
  CALL SGET_DEVICE_DATA_RDWR (INOWENO, YL_INOWENO)
  CALL SGET_DEVICE_DATA_RDWR (ISTESB, YL_ISTESB)
  CALL SGET_DEVICE_DATA_RDWR (ISTEST, YL_ISTEST)
  CALL SGET_DEVICE_DATA_RDWR (KL0, YD_KL0)
  CALL SGET_DEVICE_DATA_RDWR (KLEV, YD_KLEV)
  CALL SGET_DEVICE_DATA_RDWR (KLH0, YD_KLH0)
  CALL SGET_DEVICE_DATA_RDWR (PCCO, YD_PCCO)
  CALL SGET_DEVICE_DATA_RDWR (PLEV, YD_PLEV)
  CALL SGET_DEVICE_DATA_RDWR (PLSCAW, YD_PLSCAW)
  CALL SGET_DEVICE_DATA_RDWR (PRSCAW, YD_PRSCAW)
  CALL SGET_DEVICE_DATA_RDWR (PSCO, YD_PSCO)
  CALL SGET_DEVICE_DATA_RDWR (PUF, YD_PUF)
  CALL SGET_DEVICE_DATA_RDWR (PVF, YD_PVF)
  CALL SGET_DEVICE_DATA_RDWR (PWF, YD_PWF)
  CALL SGET_DEVICE_DATA_RDWR (ZPLEV, YL_ZPLEV)
  CALL SGET_DEVICE_DATA_RDWR (ZSCO, YL_ZSCO)
  CALL SGET_DEVICE_DATA_RDWR (ZWF, YL_ZWF)
  CALL SGET_DEVICE_DATA_RDWR (ZWFASM, YL_ZWFASM)
  CALL SGET_DEVICE_DATA_RDWR (ZWFSM, YL_ZWFSM)
  CALL SGET_DEVICE_DATA_RDWR (ZWF_2, YL_ZWF_2)
  CALL SGET_DEVICE_DATA_RDWR (ZWO_2, YL_ZWO_2)
  CALL SGET_DEVICE_DATA_RDWR (ZX0, YL_ZX0)
  CALL SGET_DEVICE_DATA_RDWR (ZXF, YL_ZXF)
  CALL SGET_DEVICE_DATA_RDWR (ZY0, YL_ZY0)
  CALL SGET_DEVICE_DATA_RDWR (ZYF, YL_ZYF)
  CALL SGET_DEVICE_DATA_RDWR (ZZ0, YL_ZZ0)
  CALL SGET_DEVICE_DATA_RDWR (ZZF, YL_ZZF)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDA_KVSEPC_P, YDA_KVSEPC%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDA_KVSEPL_P, YDA_KVSEPL%F_P)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_UR0_P, YDCPG_SL1%UR0%F_P)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_VR0_P, YDCPG_SL1%VR0%F_P)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_WR0_P, YDCPG_SL1%WR0%F_P)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_WRA_P, YDCPG_SL1%WRA%F_P)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_ZR0_P, YDCPG_SL1%ZR0%F_P)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_STDDISU, YDCPG_SL2%F_STDDISU)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_STDDISV, YDCPG_SL2%F_STDDISV)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_STDDISW, YDCPG_SL2%F_STDDISW)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_URL, YDCPG_SL2%F_URL)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_VRL, YDCPG_SL2%F_VRL)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_WRL, YDCPG_SL2%F_WRL)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDGEOMVARS_GECLO_P, YDGEOMVARS%GECLO%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDGEOMVARS_GEMU_P, YDGEOMVARS%GEMU%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDGEOMVARS_GESLO_P, YDGEOMVARS%GESLO%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDGEOMVARS_GNORDL_P, YDGEOMVARS%GNORDL%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDGEOMVARS_GNORDM_P, YDGEOMVARS%GNORDM%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDGEOMVARS_GSQM2_P, YDGEOMVARS%GSQM2%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDGEOMVARS_RCOLON_P, YDGEOMVARS%RCOLON%FT0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDGEOMVARS_RSILON_P, YDGEOMVARS%RSILON%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDMASK_SL2_P, YDMASK_SL2%F_P)
  IF (LHOOK) CALL DR_HOOK ('LARMES_PARALLEL:LARMES:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('LARMES_PARALLEL:LARMES:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:IDEP, IL0A, INOWENO, ISTESB, ISTEST, KL0, KLEV, KLH0, PCCO, PLEV, PLSCAW,  & 
  !$OMP &          PRSCAW, PSCO, PUF, PVF, PWF, YDCPG_OPTS, YDCST, YDGEOMETRY, YDML_DYN,  & 
  !$OMP &          YDRIP, YDSL, YFXTRAN_ACDC_STACK, ZPLEV, ZSCO, ZWF, ZWFASM, ZWFSM, ZWF_2,  & 
  !$OMP &          ZWO_2, ZX0, ZXF, ZY0, ZYF, ZZ0, ZZF, Z_YDA_KVSEPC_P, Z_YDA_KVSEPL_P,  & 
  !$OMP &          Z_YDCPG_SL1_UR0_P, Z_YDCPG_SL1_VR0_P, Z_YDCPG_SL1_WR0_P,  & 
  !$OMP &          Z_YDCPG_SL1_WRA_P, Z_YDCPG_SL1_ZR0_P, Z_YDCPG_SL2_STDDISU,  & 
  !$OMP &          Z_YDCPG_SL2_STDDISV, Z_YDCPG_SL2_STDDISW, Z_YDCPG_SL2_URL,  & 
  !$OMP &          Z_YDCPG_SL2_VRL, Z_YDCPG_SL2_WRL, Z_YDGEOMVARS_GECLO_P, Z_YDGEOMVARS_GEMU_P,  & 
  !$OMP &          Z_YDGEOMVARS_GESLO_P, Z_YDGEOMVARS_GNORDL_P, Z_YDGEOMVARS_GNORDM_P,  & 
  !$OMP &          Z_YDGEOMVARS_GSQM2_P, Z_YDGEOMVARS_RCOLON_P, Z_YDGEOMVARS_RSILON_P,  & 
  !$OMP &          Z_YDMASK_SL2_P)  & 
  !$OMP & PRIVATE (JBLK)  & 
  ...
  DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
    ...
    !$OMP & PRIVATE (IHVI, IROT, ITIP, JITER, JLEV, JROF, LLINTV, YLCPG_BNDS, YLSTACK, Z2COPHI,  & 
    !$OMP &          ZEF, ZEO, ZFN, ZFX, ZHVETAON, ZHVETAOX, ZLEVB, ZLEVO, ZLEVT, ZPU, ZPV, ZVDISP,  & 
    !$OMP &          ZVDISP_1, ZVDISP_2, ZVETAON, ZVETAOX, ZZ)       
