...
!$ACDC methods 
  ...
  PROCEDURE :: COPY => COPY_MODEL_GENERAL_CONF_TYPE
PROCEDURE :: CRC64 => CRC64_MODEL_GENERAL_CONF_TYPE
PROCEDURE :: HOST => HOST_MODEL_GENERAL_CONF_TYPE
PROCEDURE :: LOAD => LOAD_MODEL_GENERAL_CONF_TYPE
PROCEDURE :: SAVE => SAVE_MODEL_GENERAL_CONF_TYPE
PROCEDURE :: SIZE => SIZE_MODEL_GENERAL_CONF_TYPE
PROCEDURE :: WIPE => WIPE_MODEL_GENERAL_CONF_TYPE
...
MODULE FUNCTION SIZE_MODEL_GENERAL_CONF_TYPE (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
