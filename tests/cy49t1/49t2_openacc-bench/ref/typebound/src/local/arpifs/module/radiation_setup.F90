...
PROCEDURE :: COPY => COPY_TRADIATION
PROCEDURE :: CRC64 => CRC64_TRADIATION
PROCEDURE :: HOST => HOST_TRADIATION
PROCEDURE :: LOAD => LOAD_TRADIATION
PROCEDURE :: SAVE => SAVE_TRADIATION
PROCEDURE :: SIZE => SIZE_TRADIATION
PROCEDURE :: WIPE => WIPE_TRADIATION
END TYPE TRADIATION


INTERFACE

MODULE SUBROUTINE COPY_TRADIATION (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TRADIATION (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TRADIATION (SELF)

IMPLICIT NONE
CLASS (TRADIATION), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TRADIATION (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TRADIATION (SELF, KLUN)
...
MODULE FUNCTION SIZE_TRADIATION (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TRADIATION (SELF, LDDELETED, LDFIELDAPI)
