...
!
CONTAINS
PROCEDURE :: COPY => COPY_CSTURB_T
PROCEDURE :: CRC64 => CRC64_CSTURB_T
PROCEDURE :: HOST => HOST_CSTURB_T
PROCEDURE :: LOAD => LOAD_CSTURB_T
PROCEDURE :: SAVE => SAVE_CSTURB_T
PROCEDURE :: SIZE => SIZE_CSTURB_T
PROCEDURE :: WIPE => WIPE_CSTURB_T
END TYPE CSTURB_t
!
...
MODULE SUBROUTINE COPY_CSTURB_T (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_CSTURB_T (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_CSTURB_T (SELF)

IMPLICIT NONE
CLASS (CSTURB_T), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_CSTURB_T (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_CSTURB_T (SELF, KLUN)
...
MODULE FUNCTION SIZE_CSTURB_T (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_CSTURB_T (SELF, LDDELETED, LDFIELDAPI)
