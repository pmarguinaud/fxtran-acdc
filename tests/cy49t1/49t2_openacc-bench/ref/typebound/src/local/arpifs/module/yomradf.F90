...
PROCEDURE :: COPY => COPY_TRADF
PROCEDURE :: CRC64 => CRC64_TRADF
PROCEDURE :: HOST => HOST_TRADF
PROCEDURE :: LOAD => LOAD_TRADF
PROCEDURE :: SAVE => SAVE_TRADF
PROCEDURE :: SIZE => SIZE_TRADF
PROCEDURE :: WIPE => WIPE_TRADF
END TYPE TRADF
!============================================================================
...
MODULE SUBROUTINE COPY_TRADF (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TRADF (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TRADF (SELF)

IMPLICIT NONE
CLASS (TRADF), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TRADF (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TRADF (SELF, KLUN)
...
MODULE FUNCTION SIZE_TRADF (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TRADF (SELF, LDDELETED, LDFIELDAPI)
