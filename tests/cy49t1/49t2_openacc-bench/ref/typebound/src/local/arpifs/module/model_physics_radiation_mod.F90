...
! YRRO : radiation grid to model grid
  ...
  PROCEDURE :: COPY => COPY_MODEL_PHYSICS_RADIATION_TYPE
PROCEDURE :: CRC64 => CRC64_MODEL_PHYSICS_RADIATION_TYPE
PROCEDURE :: HOST => HOST_MODEL_PHYSICS_RADIATION_TYPE
PROCEDURE :: LOAD => LOAD_MODEL_PHYSICS_RADIATION_TYPE
PROCEDURE :: SAVE => SAVE_MODEL_PHYSICS_RADIATION_TYPE
PROCEDURE :: SIZE => SIZE_MODEL_PHYSICS_RADIATION_TYPE
PROCEDURE :: WIPE => WIPE_MODEL_PHYSICS_RADIATION_TYPE
