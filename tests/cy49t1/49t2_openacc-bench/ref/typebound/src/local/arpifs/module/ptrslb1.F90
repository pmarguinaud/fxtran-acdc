...
PROCEDURE :: COPY => COPY_TPTRSLB1
PROCEDURE :: CRC64 => CRC64_TPTRSLB1
PROCEDURE :: HOST => HOST_TPTRSLB1
PROCEDURE :: LOAD => LOAD_TPTRSLB1
PROCEDURE :: SAVE => SAVE_TPTRSLB1
PROCEDURE :: SIZE => SIZE_TPTRSLB1
PROCEDURE :: WIPE => WIPE_TPTRSLB1
END TYPE TPTRSLB1
!==============================================================
...
MODULE SUBROUTINE COPY_TPTRSLB1 (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TPTRSLB1 (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TPTRSLB1 (SELF)

IMPLICIT NONE
CLASS (TPTRSLB1), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TPTRSLB1 (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TPTRSLB1 (SELF, KLUN)
...
MODULE FUNCTION SIZE_TPTRSLB1 (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TPTRSLB1 (SELF, LDDELETED, LDFIELDAPI)
