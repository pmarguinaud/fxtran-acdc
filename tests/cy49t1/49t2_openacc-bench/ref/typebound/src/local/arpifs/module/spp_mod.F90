...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TSPP_CONFIG
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TSPP_CONFIG
PROCEDURE :: ACDC_HOST => ACDC_HOST_TSPP_CONFIG
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TSPP_CONFIG
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TSPP_CONFIG
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TSPP_CONFIG
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TSPP_CONFIG
