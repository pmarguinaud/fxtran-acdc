...
PROCEDURE :: COPY => COPY_TEAERVOL
PROCEDURE :: CRC64 => CRC64_TEAERVOL
PROCEDURE :: HOST => HOST_TEAERVOL
PROCEDURE :: LOAD => LOAD_TEAERVOL
PROCEDURE :: SAVE => SAVE_TEAERVOL
PROCEDURE :: SIZE => SIZE_TEAERVOL
PROCEDURE :: WIPE => WIPE_TEAERVOL
END TYPE TEAERVOL
!=====================================================================
...
MODULE SUBROUTINE COPY_TEAERVOL (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TEAERVOL (SELF)

IMPLICIT NONE
CLASS (TEAERVOL), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TEAERVOL (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TEAERVOL (SELF, KLUN)
...
MODULE SUBROUTINE WIPE_TEAERVOL (SELF, LDDELETED, LDFIELDAPI)
