...
LMASK_WAVE_IN = ALLOCATED (SELF%MASK_WAVE_IN)
IF (LMASK_WAVE_IN) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%MASK_WAVE_IN)
  !$OMP TARGET UPDATE TO (SELF%MASK_WAVE_IN)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%MASK_WAVE_IN)
ENDIF

LMASK_WAVE_OUT = ALLOCATED (SELF%MASK_WAVE_OUT)
IF (LMASK_WAVE_OUT) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%MASK_WAVE_OUT)
  !$OMP TARGET UPDATE TO (SELF%MASK_WAVE_OUT)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%MASK_WAVE_OUT)
ENDIF

LMWVIN_SENDCNT = ALLOCATED (SELF%MWVIN_SENDCNT)
IF (LMWVIN_SENDCNT) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%MWVIN_SENDCNT)
  !$OMP TARGET UPDATE TO (SELF%MWVIN_SENDCNT)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%MWVIN_SENDCNT)
ENDIF

LMWVIN_RECVCNT = ALLOCATED (SELF%MWVIN_RECVCNT)
IF (LMWVIN_RECVCNT) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%MWVIN_RECVCNT)
  !$OMP TARGET UPDATE TO (SELF%MWVIN_RECVCNT)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%MWVIN_RECVCNT)
ENDIF

LMWVIN_SENDOFF = ALLOCATED (SELF%MWVIN_SENDOFF)
IF (LMWVIN_SENDOFF) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%MWVIN_SENDOFF)
  !$OMP TARGET UPDATE TO (SELF%MWVIN_SENDOFF)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%MWVIN_SENDOFF)
ENDIF

LMWVIN_RECVOFF = ALLOCATED (SELF%MWVIN_RECVOFF)
IF (LMWVIN_RECVOFF) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%MWVIN_RECVOFF)
  !$OMP TARGET UPDATE TO (SELF%MWVIN_RECVOFF)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%MWVIN_RECVOFF)
ENDIF

LMWVIN_SENDBUF = ALLOCATED (SELF%MWVIN_SENDBUF)
IF (LMWVIN_SENDBUF) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%MWVIN_SENDBUF)
  !$OMP TARGET UPDATE TO (SELF%MWVIN_SENDBUF)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%MWVIN_SENDBUF)
ENDIF

LMWVIN_RECVBUF = ALLOCATED (SELF%MWVIN_RECVBUF)
IF (LMWVIN_RECVBUF) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%MWVIN_RECVBUF)
  !$OMP TARGET UPDATE TO (SELF%MWVIN_RECVBUF)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%MWVIN_RECVBUF)
ENDIF

LMWVIN_SENDIND = ALLOCATED (SELF%MWVIN_SENDIND)
IF (LMWVIN_SENDIND) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%MWVIN_SENDIND)
  !$OMP TARGET UPDATE TO (SELF%MWVIN_SENDIND)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%MWVIN_SENDIND)
ENDIF

LIWV_LON = ALLOCATED (SELF%IWV_LON)
IF (LIWV_LON) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%IWV_LON)
  !$OMP TARGET UPDATE TO (SELF%IWV_LON)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%IWV_LON)
ENDIF

LIWV_LAT = ALLOCATED (SELF%IWV_LAT)
IF (LIWV_LAT) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%IWV_LAT)
  !$OMP TARGET UPDATE TO (SELF%IWV_LAT)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%IWV_LAT)
ENDIF

LWV_W2IWGHT = ALLOCATED (SELF%WV_W2IWGHT)
IF (LWV_W2IWGHT) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%WV_W2IWGHT)
  !$OMP TARGET UPDATE TO (SELF%WV_W2IWGHT)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%WV_W2IWGHT)
ENDIF
...
LMASK_WAVE_IN = ALLOCATED (SELF%MASK_WAVE_IN)
IF (LMASK_WAVE_IN) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%MASK_WAVE_IN)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%MASK_WAVE_IN)
ENDIF

LMASK_WAVE_OUT = ALLOCATED (SELF%MASK_WAVE_OUT)
IF (LMASK_WAVE_OUT) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%MASK_WAVE_OUT)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%MASK_WAVE_OUT)
ENDIF

LMWVIN_SENDCNT = ALLOCATED (SELF%MWVIN_SENDCNT)
IF (LMWVIN_SENDCNT) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%MWVIN_SENDCNT)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%MWVIN_SENDCNT)
ENDIF

LMWVIN_RECVCNT = ALLOCATED (SELF%MWVIN_RECVCNT)
IF (LMWVIN_RECVCNT) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%MWVIN_RECVCNT)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%MWVIN_RECVCNT)
ENDIF

LMWVIN_SENDOFF = ALLOCATED (SELF%MWVIN_SENDOFF)
IF (LMWVIN_SENDOFF) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%MWVIN_SENDOFF)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%MWVIN_SENDOFF)
ENDIF

LMWVIN_RECVOFF = ALLOCATED (SELF%MWVIN_RECVOFF)
IF (LMWVIN_RECVOFF) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%MWVIN_RECVOFF)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%MWVIN_RECVOFF)
ENDIF

LMWVIN_SENDBUF = ALLOCATED (SELF%MWVIN_SENDBUF)
IF (LMWVIN_SENDBUF) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%MWVIN_SENDBUF)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%MWVIN_SENDBUF)
ENDIF

LMWVIN_RECVBUF = ALLOCATED (SELF%MWVIN_RECVBUF)
IF (LMWVIN_RECVBUF) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%MWVIN_RECVBUF)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%MWVIN_RECVBUF)
ENDIF

LMWVIN_SENDIND = ALLOCATED (SELF%MWVIN_SENDIND)
IF (LMWVIN_SENDIND) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%MWVIN_SENDIND)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%MWVIN_SENDIND)
ENDIF

LIWV_LON = ALLOCATED (SELF%IWV_LON)
IF (LIWV_LON) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%IWV_LON)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%IWV_LON)
ENDIF

LIWV_LAT = ALLOCATED (SELF%IWV_LAT)
IF (LIWV_LAT) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%IWV_LAT)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%IWV_LAT)
ENDIF

LWV_W2IWGHT = ALLOCATED (SELF%WV_W2IWGHT)
IF (LWV_W2IWGHT) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%WV_W2IWGHT)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%WV_W2IWGHT)
ENDIF
