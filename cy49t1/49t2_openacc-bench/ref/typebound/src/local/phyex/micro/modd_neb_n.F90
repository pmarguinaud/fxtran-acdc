...
CONTAINS
PROCEDURE :: COPY => COPY_NEB_T
PROCEDURE :: CRC64 => CRC64_NEB_T
PROCEDURE :: HOST => HOST_NEB_T
PROCEDURE :: LOAD => LOAD_NEB_T
PROCEDURE :: SAVE => SAVE_NEB_T
PROCEDURE :: SIZE => SIZE_NEB_T
PROCEDURE :: WIPE => WIPE_NEB_T
END TYPE NEB_t
...
MODULE SUBROUTINE COPY_NEB_T (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_NEB_T (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_NEB_T (SELF)

IMPLICIT NONE
CLASS (NEB_T), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_NEB_T (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_NEB_T (SELF, KLUN)
...
MODULE FUNCTION SIZE_NEB_T (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_NEB_T (SELF, LDDELETED, LDFIELDAPI)
