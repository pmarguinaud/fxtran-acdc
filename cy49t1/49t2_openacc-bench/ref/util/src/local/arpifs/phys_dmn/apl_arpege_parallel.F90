...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:CPPHINP')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:CPPHINP')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:CPPHINP:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZRDG_CVGQ, ZRDG_CVGT, &
    !$ACC&         ZRDG_MU0, ZRDG_MU0LU, ZRDG_MU0M, ZRDG_MU0N, ZRDG_SOLO, Z_YDCPG_DYN0_CTY_EVEL, &
    !$ACC&         Z_YDCPG_PHY0_XYB_RDELP, Z_YDVARS_CVGQ_DL, Z_YDVARS_CVGQ_DM, &
    !$ACC&         Z_YDVARS_CVGQ_T0, Z_YDVARS_GEOMETRY_GELAM_T0, Z_YDVARS_GEOMETRY_GEMU_T0, &
    !$ACC&         Z_YDVARS_Q_DL, Z_YDVARS_Q_DM, Z_YDVARS_Q_T0, Z_YDVARS_T_DL, &
    !$ACC&         Z_YDVARS_T_DM, Z_YDVARS_U_T0, Z_YDVARS_V_T0) &
    !$ACC&PRIVATE (JBLK) &
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:ZRDG_LCVQ')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ZRDG_LCVQ')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ZRDG_LCVQ:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZFLU_QSATS, ZQCO2, ZRDG_CVGQ, ZRDG_LCVQ) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:APLPAR_INIT')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:APLPAR_INIT')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:APLPAR_INIT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (IMOC_CLPH, YDCPG_OPTS, YDMODEL, YSTACK, ZDSA_C1, ZDSA_C2, ZDSA_CPS, &
    !$ACC&         ZDSA_LHS, ZDSA_RS, ZFCHQ, ZFLU_CD, ZFLU_CDN, ZFLU_CH, ZFLU_CHN, ZFLU_EMIS, &
    !$ACC&         ZFLU_FEVI, ZFLU_NEIJ, ZFLU_QSAT, ZFLU_QSATS, ZFLU_VEG, ZMSC_FRMQ, &
    !$ACC&         ZMSC_LH, ZMSC_LSCPE, ZMSC_QW, ZMSC_TW, ZPFL_FEFB1, ZPFL_FEFB2, &
    !$ACC&         ZPFL_FEFB3, ZPFL_FTKE, ZPFL_FTKEI, Z_YDMF_PHYS_SURF_GSD_VF_PVEG) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:PLSM')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:PLSM')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:PLSM:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YSTACK, Z_YDMF_PHYS_SURF_GSD_VF_PLSM) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACTQSAT')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACTQSAT')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACTQSAT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZFLU_QSAT, ZGEOSLC, ZMSC_LH, ZMSC_LSCPE, &
    !$ACC&         ZMSC_QW, ZMSC_TW, ZQV, Z_YDCPG_MISC_RH, Z_YDMF_PHYS_BASE_STATE_T, &
...
IF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACSOL')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACSOL')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACSOL:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZC3, ZCG, ZCN, ZDSA_C1, ZDSA_C2, ZNEIJG, &
      !$ACC&         ZNEIJV, ZWFC, ZWPMX, ZWSEQ, ZWSMX, ZWWILT, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC, &
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:ZDPHIV')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ZDPHIV')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ZDPHIV:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZDPHIT, ZDPHIV) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACHMTLS')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACHMTLS')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACHMTLS:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZDPHI, ZDPHIT, ZDSA_CPS, ZDSA_LHS, ZFLU_CD, &
      !$ACC&         ZFLU_CDN, ZGWDCS, ZMRIPP, ZNBVNO, ZPCLS, ZPRS, ZRTI, Z_YDCPG_MISC_QS, &
      ...
      !$ACC&         Z_YDMF_PHYS_OUT_GZ0, Z_YDMF_PHYS_OUT_GZ0H) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ELSE
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACHMT')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACHMT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACHMT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZCDROV, ZCHROV, ZDPHIT, ZDPHIV, ZDQSTS, &
      !$ACC&         ZDSA_CPS, ZDSA_RS, ZFLU_CD, ZFLU_CDN, ZFLU_CH, ZFLU_NEIJ, ZFLU_QSATS, &
      !$ACC&         ZFLU_VEG, ZGWDCS, ZHQ, ZHU, ZMRIPP, ZNBVNO, ZNEIJG, ZNEIJV, ZPCLS, ZPFL_FPLCH, &
      !$ACC&         ZPFL_FPLSH, ZQV, ZRTI, ZSTAB, ZWFC, ZXDROV, ZXHROV, Z_YDCPG_MISC_QS, &
      !$ACC&         Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_V, &
      !$ACC&         Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, &
      ...
      !$ACC&         Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, &
      !$ACC&         Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, &
      !$ACC&         Z_YDMF_PHYS_OUT_GZ0, Z_YDMF_PHYS_OUT_GZ0H, Z_YDMF_PHYS_OUT_NUCLS, &
      !$ACC&         Z_YDMF_PHYS_OUT_NVCLS, Z_YDMF_PHYS_OUT_QCLS, Z_YDMF_PHYS_OUT_RHCLS, &
      ...
      !$ACC&         Z_YDMF_PHYS_SURF_GSD_VF_PVEG, Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, &
      !$ACC&         Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, Z_YDMF_PHYS_SURF_GSD_VV_PHV, &
      !$ACC&         Z_YDMF_PHYS_SURF_GSD_VV_PZ0H) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACCLPH')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACCLPH')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACCLPH:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (IMOC_CLPH, YDCPG_OPTS, YDMODEL, YSTACK, ZBLH, ZCP, ZQV, ZTHETAV, ZTHETAVS, &
    !$ACC&         ZUGST, ZVGST, Z_YDCPG_MISC_QS, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_U, &
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:DIFTQ')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:DIFTQ')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:DIFTQ:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZDIFCVPPQ, ZDIFCVPPS, ZDIFCVPPU, ZDIFCVPPV, &
    !$ACC&         ZEDMFQ, ZEDMFS, ZEDMFU, ZEDMFV, Z_YDMF_PHYS_OUT_DIFTQ, Z_YDMF_PHYS_OUT_DIFTS, &
    !$ACC&         Z_YDMF_PHYS_OUT_STRTU, Z_YDMF_PHYS_OUT_STRTV) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:FRSOPT')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:FRSOPT')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:FRSOPT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZFLU_EMIS, ZRDG_MU0, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, &
    !$ACC&         Z_YDMF_PHYS_OUT_FRSOPT, Z_YDMF_PHYS_OUT_FRTH, Z_YDMF_PHYS_OUT_FRTHDS) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACDRAG')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACDRAG')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACDRAG:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZCHROV, ZDQSTS, ZFLU_EMIS, ZFLU_NEIJ, &
    !$ACC&         ZGWDCS, ZMSC_QW, ZNBVNO, ZNEBS, ZQLIS, ZQV, ZTRAJGWD, Z_YDCPG_MISC_QS, &
    !$ACC&         Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_V, &
    !$ACC&         Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, &
...
IF (YDMODEL%YRML_PHY_MF%YRPHY%LECTPRODCVP) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:TURBULENCE_PART2')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:TURBULENCE_PART2')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:TURBULENCE_PART2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZECTCLS, ZKCLS, ZKUROV2, ZPFL_FTKE, &
      !$ACC&         ZPRODTH, ZTKE1, ZUSLE, Z_YDMF_PHYS_BASE_STATE_Q, Z_YDMF_PHYS_BASE_STATE_T, &
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:QNGCOR')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:QNGCOR')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:QNGCOR:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZFLX_LOTT_GWU, ZFLX_LOTT_GWV, ZFPCOR, &
    !$ACC&         ZFPLSL, ZFPLSN, ZPFL_FPLCH, ZPFL_FPLSH, ZQI, ZQL, ZQV, ZSEDIQI, ZSEDIQL, &
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACDRME')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACDRME')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACDRME:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZMSC_FRMQ, ZQV, Z_YDCPG_MISC_NEB, &
    !$ACC&         Z_YDCPG_MISC_QICE, Z_YDCPG_MISC_QLI, Z_YDMF_PHYS_BASE_STATE_T, &
    !$ACC&         Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, &
    !$ACC&         Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, Z_YDMF_PHYS_OUT_FRMH, &
    !$ACC&         Z_YDMF_PHYS_OUT_STRMU, Z_YDMF_PHYS_OUT_STRMV, Z_YDVARS_A_T1, &
    !$ACC&         Z_YDVARS_IRAD_T1, Z_YDVARS_LRAD_T1) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDMODEL%YRML_PHY_MF%YRPHY2%LRAFTKE) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACEVADCAPE')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACEVADCAPE')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACEVADCAPE:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (IMOC_CLPH, YDCPG_OPTS, YDMODEL, YSTACK, ZBLH, ZDCAPE, ZTKE1, Z_YDMF_PHYS_BASE_STATE_T, &
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACVISIH')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACVISIH')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACVISIH:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZQGM, ZQR, ZQS, Z_YDCPG_MISC_QICE, Z_YDCPG_MISC_QLI, &
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:ZBAY_QRCONV')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ZBAY_QRCONV')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ZBAY_QRCONV:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZBAY_QRCONV, ZBAY_QSCONV, Z_YDMF_PHYS_OUT_FPLCL, &
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:ZDE2MR')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ZDE2MR')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ZDE2MR:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZBAY_QRCONV, ZBAY_QSCONV, ZDE2MR, &
    !$ACC&         Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:PPWETPOINT')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:PPWETPOINT')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:PPWETPOINT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZPCLS, Z_YDMF_PHYS_BASE_STATE_I, &
...
IF (YDCPG_OPTS%LCORWAT) THEN
  ...
  IF (LPARALLELMETHOD ('OpenMP','APL_ARPEGE_PARALLEL:22')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_PARALLEL:22')) THEN
...
IF (YDMODEL%YRML_PHY_MF%YRPHY%NDPSFI==1) THEN
  ...
  IF (LPARALLELMETHOD ('OpenMP','APL_ARPEGE_PARALLEL:23')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_PARALLEL:23')) THEN
...
IF (YDMODEL%YRML_PHY_MF%YRPHY%LCVPGY) THEN
  ...
  IF (LPARALLELMETHOD ('OpenMP','APL_ARPEGE_PARALLEL:24')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_PARALLEL:24')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:BAYRAD')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:BAYRAD')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:BAYRAD:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZBAY_QRCONV, ZBAY_QSCONV, Z_YDVARS_RCONV_T1, &
    !$ACC&         Z_YDVARS_SCONV_T1) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:EDR')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:EDR')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:EDR:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, Z_YDMF_PHYS_OUT_EDR, Z_YDMF_PHYS_SURF_GSD_DI_PXEDR) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_PARALLEL:PRECIPS')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:PRECIPS')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:PRECIPS:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZPRC_DPRECIPS, ZPRC_DPRECIPS2, Z_YDMF_PHYS_SURF_GSD_XP2_PPRECIP2, &
    !$ACC&         Z_YDMF_PHYS_SURF_GSD_XP_PPRECIP) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ENDSUBROUTINE APL_ARPEGE_PARALLEL
