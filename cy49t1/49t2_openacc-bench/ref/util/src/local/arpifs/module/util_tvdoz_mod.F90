...
SUBROUTINE SAVE_TVDOZ (SELF, KLUN)
...
SUBROUTINE LOAD_TVDOZ (SELF, KLUN)
...
SUBROUTINE COPY_TVDOZ (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE CRC64_TVDOZ (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TVDOZ (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TVDOZ (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
