...
SUBROUTINE SAVE_TEDYN (SELF, KLUN)
...
SUBROUTINE LOAD_TEDYN (SELF, KLUN)
...
SUBROUTINE COPY_TEDYN (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE CRC64_TEDYN (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TEDYN (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TEDYN (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
