...
PROCEDURE :: ACDC_COPY => ACDC_COPY_TEAERSRC
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TEAERSRC
PROCEDURE :: ACDC_HOST => ACDC_HOST_TEAERSRC
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TEAERSRC
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TEAERSRC
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TEAERSRC
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TEAERSRC
END TYPE TEAERSRC
!=====================================================================
...
MODULE SUBROUTINE ACDC_COPY_TEAERSRC (SELF, LDCREATED, LDFIELDAPI)
