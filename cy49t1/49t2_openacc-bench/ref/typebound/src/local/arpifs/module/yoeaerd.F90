...
PROCEDURE :: COPY => COPY_TEAERD
PROCEDURE :: CRC64 => CRC64_TEAERD
PROCEDURE :: HOST => HOST_TEAERD
PROCEDURE :: LOAD => LOAD_TEAERD
PROCEDURE :: SAVE => SAVE_TEAERD
PROCEDURE :: SIZE => SIZE_TEAERD
PROCEDURE :: WIPE => WIPE_TEAERD
END TYPE TEAERD
!============================================================================
...
MODULE SUBROUTINE WIPE_TEAERD (SELF, LDDELETED, LDFIELDAPI)
