...
PROCEDURE :: COPY => COPY_TEPHY
PROCEDURE :: CRC64 => CRC64_TEPHY
PROCEDURE :: HOST => HOST_TEPHY
PROCEDURE :: LOAD => LOAD_TEPHY
PROCEDURE :: SAVE => SAVE_TEPHY
PROCEDURE :: SIZE => SIZE_TEPHY
PROCEDURE :: WIPE => WIPE_TEPHY
END TYPE TEPHY
...
MODULE SUBROUTINE COPY_TEPHY (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TEPHY (SELF)
...
MODULE SUBROUTINE WIPE_TEPHY (SELF, LDDELETED, LDFIELDAPI)
