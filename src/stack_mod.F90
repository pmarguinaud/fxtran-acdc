...
PRIVATE
PUBLIC :: STACK, YSTACK, STACK_INIT, STACK_ALLOC, OPERATOR (+), OPERATOR (-)

CONTAINS

SUBROUTINE STACK_INIT (SELF, YDSTACK_DATA, KBLOCK, KGPBLKS, YDOFFSET) 
...
TYPE (STACK), INTENT (IN), OPTIONAL :: YDOFFSET
...
TYPE (STACK) FUNCTION STACK_PLUS (YDSTACK1, YDSTACK2)
TYPE (STACK), INTENT (IN) :: YDSTACK1, YDSTACK2
STACK_PLUS%L4 = YDSTACK1%L4 + YDSTACK2%L4
STACK_PLUS%L8 = YDSTACK1%L8 + YDSTACK2%L8
END  FUNCTION
 
TYPE (STACK) FUNCTION STACK_MINUS (YDSTACK1, YDSTACK2)
TYPE (STACK), INTENT (IN) :: YDSTACK1, YDSTACK2
STACK_MINUS%L4 = YDSTACK1%L4 - YDSTACK2%L4
STACK_MINUS%L8 = YDSTACK1%L8 - YDSTACK2%L8
END  FUNCTION
 
SUBROUTINE STACK_ALLOC (SELF, KPTR, KSIZE, KKIND, CDFILE, KLINE)
