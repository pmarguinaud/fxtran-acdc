...
IF (LPARALLELMETHOD ('OPENMP','MF_PHYS_PREP_PARALLEL:PREP')) THEN
  ...
  IF (LSYNCHOST ('MF_PHYS_PREP_PARALLEL:PREP')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','MF_PHYS_PREP_PARALLEL:PREP')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','MF_PHYS_PREP_PARALLEL:PREP')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('MF_PHYS_PREP_PARALLEL:PREP:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&PRESENT (YDARPHY, YDCPG_OPTS, YDDYNA, YDGEOMETRY, YSTACK, Z_YDCPG_DYN0_GWFL, &
    !$ACC&         Z_YDCPG_DYN0_GWFM, Z_YDCPG_DYN0_GWFT, Z_YDCPG_DYN0_NHPREF, &
    !$ACC&         Z_YDCPG_DYN0_NHPREH, Z_YDCPG_DYN0_PRE, Z_YDCPG_DYN0_PREF, &
    !$ACC&         Z_YDCPG_DYN0_XYB_ALPH, Z_YDCPG_DYN0_XYB_DELP, Z_YDCPG_DYN0_XYB_LNPR, &
    !$ACC&         Z_YDCPG_DYN0_XYB_RDELP, Z_YDCPG_DYN9_GWFT, Z_YDCPG_DYN9_NHPREF, &
    !$ACC&         Z_YDCPG_DYN9_NHPREH, Z_YDCPG_DYN9_PRE, Z_YDCPG_DYN9_PREF, &
    !$ACC&         Z_YDCPG_DYN9_XYB_ALPH, Z_YDCPG_DYN9_XYB_DELP, Z_YDCPG_DYN9_XYB_LNPR, &
    !$ACC&         Z_YDCPG_DYN9_XYB_RDELP, Z_YDCPG_PHY0_PRE, Z_YDCPG_PHY0_PREF, &
    !$ACC&         Z_YDCPG_PHY0_PREHYD, Z_YDCPG_PHY0_PREHYDF, Z_YDCPG_PHY0_W, &
    !$ACC&         Z_YDCPG_PHY0_WL, Z_YDCPG_PHY0_WM, Z_YDCPG_PHY0_XYB_ALPH, &
    ...
    DO JLON = 1, MIN (YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1) * YDCPG_OPTS%KLON)
      ...
      YLCPG_BNDS%KFDIA = JLON
        ...
        IF (YDARPHY%LMPA) THEN
          ...
          IF (YDDYNA%LNHDYN.AND.YDDYNA%LTWOTL) THEN
            CALL ACPY (JLON, Z_YDCPG_PHY0_PREF (:,:, JBLK), Z_YDCPG_DYN0_NHPREF (:,:, JBLK))
            CALL ACPY (JLON, Z_YDCPG_PHY0_PRE (:,:, JBLK), Z_YDCPG_DYN0_NHPREH (:,:, JBLK))
          ELSEIF (YDDYNA%LNHDYN.AND.(.NOT.YDDYNA%LTWOTL)) THEN
            CALL ACPY (JLON, Z_YDCPG_PHY9_PREF (:,:, JBLK), Z_YDCPG_DYN9_NHPREF (:,:, JBLK))
            CALL ACPY (JLON, Z_YDCPG_PHY9_PRE (:,:, JBLK), Z_YDCPG_DYN9_NHPREH (:,:, JBLK))
          ELSEIF ((.NOT.YDDYNA%LNHDYN).AND.YDDYNA%LTWOTL) THEN
            CALL ACPY (JLON, Z_YDCPG_PHY0_PREF (:,:, JBLK), Z_YDCPG_DYN0_PREF (:,:, JBLK))
            CALL ACPY (JLON, Z_YDCPG_PHY0_PRE (:,:, JBLK), Z_YDCPG_DYN0_PRE (:,:, JBLK))
          ELSEIF ((.NOT.YDDYNA%LNHDYN).AND.(.NOT.YDDYNA%LTWOTL)) THEN
            CALL ACPY (JLON, Z_YDCPG_PHY9_PREF (:,:, JBLK), Z_YDCPG_DYN9_PREF (:,:, JBLK))
            CALL ACPY (JLON, Z_YDCPG_PHY9_PRE (:,:, JBLK), Z_YDCPG_DYN9_PRE (:,:, JBLK))
          ENDIF

        ENDIF
  
        CALL ACPY (JLON, Z_YDCPG_PHY0_PREHYDF (:,:, JBLK), Z_YDCPG_DYN0_PREF (:,:, JBLK))  
        CALL ACPY (JLON, Z_YDCPG_PHY0_PREHYD (:,:, JBLK), Z_YDCPG_DYN0_PRE (:,:, JBLK))  
        CALL ACPY (JLON, Z_YDCPG_PHY0_XYB_DELP (:,:, JBLK), Z_YDCPG_DYN0_XYB_DELP (:,:, JBLK))  
        CALL ACPY (JLON, Z_YDCPG_PHY0_XYB_RDELP (:,:, JBLK), Z_YDCPG_DYN0_XYB_RDELP (:,:, JBLK))  
        CALL ACPY (JLON, Z_YDCPG_PHY0_XYB_LNPR (:,:, JBLK), Z_YDCPG_DYN0_XYB_LNPR (:,:, JBLK))  
        CALL ACPY (JLON, Z_YDCPG_PHY0_XYB_ALPH (:,:, JBLK), Z_YDCPG_DYN0_XYB_ALPH (:,:, JBLK))  

        IF (.NOT.YDDYNA%LTWOTL) THEN
          CALL ACPY (JLON, Z_YDCPG_PHY9_PREHYDF (:,:, JBLK), Z_YDCPG_DYN9_PREF (:,:, JBLK))
          CALL ACPY (JLON, Z_YDCPG_PHY9_PREHYD (:,:, JBLK), Z_YDCPG_DYN9_PRE (:,:, JBLK))
          CALL ACPY (JLON, Z_YDCPG_PHY9_XYB_DELP (:,:, JBLK), Z_YDCPG_DYN9_XYB_DELP (:,:, JBLK))
          CALL ACPY (JLON, Z_YDCPG_PHY9_XYB_RDELP (:,:, JBLK), Z_YDCPG_DYN9_XYB_RDELP (:,:, JBLK))
          CALL ACPY (JLON, Z_YDCPG_PHY9_XYB_LNPR (:,:, JBLK), Z_YDCPG_DYN9_XYB_LNPR (:,:, JBLK))
          CALL ACPY (JLON, Z_YDCPG_PHY9_XYB_ALPH (:,:, JBLK), Z_YDCPG_DYN9_XYB_ALPH (:,:, JBLK))
        ENDIF
...
ENDSUBROUTINE MF_PHYS_PREP_PARALLEL
