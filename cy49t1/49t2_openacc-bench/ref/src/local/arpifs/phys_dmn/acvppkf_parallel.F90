...
IF (LPARALLELMETHOD ('OPENMP','ACVPPKF_PARALLEL:PART0')) THEN
  ...
  IF (LSYNCHOST ('ACVPPKF_PARALLEL:PART0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','ACVPPKF_PARALLEL:PART0')) THEN
  ...
  !$OMP PARALLEL DO PRIVATE (JBLK, JKP, JLEV, JLON, JN, YLCPG_BNDS, YLSTACK)
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ACVPPKF_PARALLEL:PART0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         YSTACK, ZAPHIF, ZCAPE, ZCH1, ZDPSG, ZDQIDT, ZDQLDT, ZDQVDT, ZDTDT, ZDUDT, &
    !$ACC&         ZDVDT, ZLS, ZLV, ZPABS, ZQC, ZRC, ZRCTEN, ZRI, ZRITEN, ZRV, ZRVTEN, ZSHAL_ZCH1, &
    !$ACC&         ZSHAL_ZCH1TEN, ZT, ZTKECLS, ZTTEN, ZU, ZUMF, ZUMFMAX, ZUQL, ZUQV, ZURCI, &
    !$ACC&         ZURV, ZUTEN, ZV, ZVTEN, ZW, ZZUMF, ZZW, ZZZ) &
    !$ACC&PRIVATE (JBLK) &
    ...
    !$ACC LOOP VECTOR &
    !$ACC&PRIVATE (JKP, JLEV, JLON, JN, YLCPG_BNDS, YLSTACK) 
...
IF (LPARALLELMETHOD ('OPENMP','ACVPPKF_PARALLEL:PART1')) THEN
  ...
  IF (LSYNCHOST ('ACVPPKF_PARALLEL:PART1')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','ACVPPKF_PARALLEL:PART1')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ACVPPKF_PARALLEL:PART1')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         YSTACK, ZPABS, ZRC, ZRCTEN, ZRI, ZRITEN, ZRV, ZRVTEN, ZSHAL_ZCH1, ZSHAL_ZCH1TENS, &
    !$ACC&         ZSRVLCL, ZSTHES, ZSTHLCL, ZSTHV, ZSTHVELCL, ZSTLCL, ZSWLCL, ZSZLCL, &
    !$ACC&         ZT, ZTHT, ZTKECLS, ZTTEN, ZZUMF, ZZW, ZZZ) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','ACVPPKF_PARALLEL:PART2')) THEN
  ...
  IF (LSYNCHOST ('ACVPPKF_PARALLEL:PART2')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','ACVPPKF_PARALLEL:PART2')) THEN
  ...
  DO JBLK = 1, YL_FGS%KGPBLKS
    ...
    DO JLON = 1, MIN (YL_FGS%KLON, YL_FGS%KGPTOT - (JBLK - 1) * YL_FGS%KLON)
      ...
      D%NIB = YLCPG_BNDS%KIDIA
      D%NIE = YLCPG_BNDS%KFDIA
      YLSTACK%L8 = stack_l8 (YSTACK, JBLK-1+1, YL_FGS%KGPBLKS)
      YLSTACK%U8 = stack_u8 (YSTACK, JBLK-1+1, YL_FGS%KGPBLKS)
      YLSTACK%L4 = stack_l4 (YSTACK, JBLK-1+1, YL_FGS%KGPBLKS)
      YLSTACK%U4 = stack_u4 (YSTACK, JBLK-1+1, YL_FGS%KGPBLKS)
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ACVPPKF_PARALLEL:PART2')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&COPYIN (YL_FGS) &
    !$ACC&PRESENT (ICLBASS, ICLTOPS, ISDPL, ISLCL, ISPBL, LLTRIG1, YDML_PHY_MF, YSTACK, &
...
IF (LPARALLELMETHOD ('OPENMP','ACVPPKF_PARALLEL:PART3')) THEN
  ...
  IF (LSYNCHOST ('ACVPPKF_PARALLEL:PART3')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','ACVPPKF_PARALLEL:PART3')) THEN
  ...
  !$OMP PARALLEL DO PRIVATE (JBLK, JKP, JLEV, JLON, JN, YLCPG_BNDS, YLSTACK, ZDQCDT, ZDTLDT, ZTDCP)
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ACVPPKF_PARALLEL:PART3')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PR, PT, YDCPG_OPTS, YDCST, YDML_PHY_MF, YSTACK, ZBETA, ZCH1TEN, ZDPSG, &
    !$ACC&         ZDQIDT, ZDQLDT, ZDQVDT, ZDTDT, ZDUDT, ZDVDT, ZLS, ZLV, ZQC, ZRCTEN, ZRHO, &
    !$ACC&         ZRITEN, ZRVTEN, ZSHAL_ZCH1TEN, ZTHETA, ZTTEN, ZUMF, ZUMFMAX, ZUQL, &
    !$ACC&         ZUQV, ZURCI, ZURV, ZUTEN, ZVTEN, ZZUMF) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
    ...
    !$ACC LOOP VECTOR &
    !$ACC&PRIVATE (JKP, JLEV, JLON, JN, YLCPG_BNDS, YLSTACK, ZDQCDT, ZDTLDT, ZTDCP) 
...
ENDSUBROUTINE ACVPPKF_PARALLEL
