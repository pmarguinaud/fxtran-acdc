...
INTERFACE COPY
MODULE PROCEDURE COPY_VARIABLE_2RB
END INTERFACE

INTERFACE HOST
MODULE PROCEDURE HOST_VARIABLE_2RB
END INTERFACE

INTERFACE LEGACY
MODULE PROCEDURE LEGACY_VARIABLE_2RB
END INTERFACE
     
INTERFACE CRC64
MODULE PROCEDURE CRC64_VARIABLE_2RB
END INTERFACE

INTERFACE WIPE
MODULE PROCEDURE WIPE_VARIABLE_2RB
END INTERFACE

INTERFACE SIZE
MODULE PROCEDURE SIZE_VARIABLE_2RB
END INTERFACE
...
SUBROUTINE COPY_VARIABLE_2RB (YD, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
USE UTIL_VARIABLE_BASE_MOD, ONLY : VARIABLE_BASE, COPY_VARIABLE_BASE
IMPLICIT NONE
TYPE (VARIABLE_2RB), INTENT (IN), TARGET :: YD
...
LFT0 = ASSOCIATED (YD%FT0)
IF (LFT0) THEN
  CALL HOST_FIELD_2RB (YD%FT0)
ENDIF

LFT1 = ASSOCIATED (YD%FT1)
IF (LFT1) THEN
  CALL HOST_FIELD_2RB (YD%FT1)
ENDIF

LFT9 = ASSOCIATED (YD%FT9)
IF (LFT9) THEN
  CALL HOST_FIELD_2RB (YD%FT9)
ENDIF

LFPH9 = ASSOCIATED (YD%FPH9)
IF (LFPH9) THEN
  CALL HOST_FIELD_2RB (YD%FPH9)
ENDIF

LFDL = ASSOCIATED (YD%FDL)
IF (LFDL) THEN
  CALL HOST_FIELD_2RB (YD%FDL)
ENDIF

LFDM = ASSOCIATED (YD%FDM)
IF (LFDM) THEN
  CALL HOST_FIELD_2RB (YD%FDM)
ENDIF

LFDL9 = ASSOCIATED (YD%FDL9)
IF (LFDL9) THEN
  CALL HOST_FIELD_2RB (YD%FDL9)
ENDIF

LFDM9 = ASSOCIATED (YD%FDM9)
IF (LFDM9) THEN
  CALL HOST_FIELD_2RB (YD%FDM9)
ENDIF

LFPC_PH = ASSOCIATED (YD%FPC_PH)
IF (LFPC_PH) THEN
  CALL HOST_FIELD_2RB (YD%FPC_PH)
ENDIF

END SUBROUTINE

SUBROUTINE LEGACY_VARIABLE_2RB (YD, KADDRL, KADDRU, KDIR)
USE FIELD_UTIL_MODULE
...
LFT0 = ASSOCIATED (YD%FT0)
IF (LFT0) THEN
  CALL LEGACY_FIELD_2RB (YD%FT0, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFT1 = ASSOCIATED (YD%FT1)
IF (LFT1) THEN
  CALL LEGACY_FIELD_2RB (YD%FT1, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFT9 = ASSOCIATED (YD%FT9)
IF (LFT9) THEN
  CALL LEGACY_FIELD_2RB (YD%FT9, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFPH9 = ASSOCIATED (YD%FPH9)
IF (LFPH9) THEN
  CALL LEGACY_FIELD_2RB (YD%FPH9, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFDL = ASSOCIATED (YD%FDL)
IF (LFDL) THEN
  CALL LEGACY_FIELD_2RB (YD%FDL, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFDM = ASSOCIATED (YD%FDM)
IF (LFDM) THEN
  CALL LEGACY_FIELD_2RB (YD%FDM, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFDL9 = ASSOCIATED (YD%FDL9)
IF (LFDL9) THEN
  CALL LEGACY_FIELD_2RB (YD%FDL9, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFDM9 = ASSOCIATED (YD%FDM9)
IF (LFDM9) THEN
  CALL LEGACY_FIELD_2RB (YD%FDM9, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

LFPC_PH = ASSOCIATED (YD%FPC_PH)
IF (LFPC_PH) THEN
  CALL LEGACY_FIELD_2RB (YD%FPC_PH, KADDRL, KADDRU, KDIR=KDIR)
ENDIF

END SUBROUTINE     

SUBROUTINE CRC64_VARIABLE_2RB (YD, KLUN, CDPATH)
USE FIELD_UTIL_MODULE
...
SUBROUTINE WIPE_VARIABLE_2RB (YD, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
...
LFT0 = ASSOCIATED (YD%FT0)
IF (LFT0 .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_2RB (YD%FT0)
ENDIF

LFT1 = ASSOCIATED (YD%FT1)
IF (LFT1 .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_2RB (YD%FT1)
ENDIF

LFT9 = ASSOCIATED (YD%FT9)
IF (LFT9 .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_2RB (YD%FT9)
ENDIF

LFPH9 = ASSOCIATED (YD%FPH9)
IF (LFPH9 .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_2RB (YD%FPH9)
ENDIF

LFDL = ASSOCIATED (YD%FDL)
IF (LFDL .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_2RB (YD%FDL)
ENDIF

LFDM = ASSOCIATED (YD%FDM)
IF (LFDM .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_2RB (YD%FDM)
ENDIF

LFDL9 = ASSOCIATED (YD%FDL9)
IF (LFDL9 .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_2RB (YD%FDL9)
ENDIF

LFDM9 = ASSOCIATED (YD%FDM9)
IF (LFDM9 .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_2RB (YD%FDM9)
ENDIF

LFPC_PH = ASSOCIATED (YD%FPC_PH)
IF (LFPC_PH .AND. LLFIELDAPI) THEN
  CALL WIPE_FIELD_2RB (YD%FPC_PH)
ENDIF
...
INTEGER*8 FUNCTION SIZE_VARIABLE_2RB (YD, CDPATH, LDPRINT) RESULT (KSIZE)
USE FIELD_UTIL_MODULE
