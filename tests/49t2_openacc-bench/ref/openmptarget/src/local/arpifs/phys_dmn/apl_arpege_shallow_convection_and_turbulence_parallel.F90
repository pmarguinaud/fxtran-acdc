...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SHALLOW_CONVECTION_AND_TURBULENCE_PARALLEL&
  ...
  CALL SGET_HOST_DATA_RDONLY (KNLAB_CVPP, YD_KNLAB_CVPP)
  ...
  CALL SGET_HOST_DATA_RDWR (PKUROV2, YD_PKUROV2)
  CALL SGET_HOST_DATA_RDONLY (PMSC_LSCPE, YD_PMSC_LSCPE)
  CALL SGET_HOST_DATA_RDWR (PNBVNO, YD_PNBVNO)
  CALL SGET_HOST_DATA_RDWR (PNEBS, YD_PNEBS)
  CALL SGET_HOST_DATA_RDWR (PNEBS0, YD_PNEBS0)
  CALL SGET_HOST_DATA_RDONLY (PPFL_FPLCH, YD_PPFL_FPLCH)
  ...
  CALL SGET_HOST_DATA_RDONLY (PPRODTH_CVPP, YD_PPRODTH_CVPP)
  CALL SGET_HOST_DATA_RDONLY (PQI, YD_PQI)
  CALL SGET_HOST_DATA_RDONLY (PQIC, YD_PQIC)
  CALL SGET_HOST_DATA_RDONLY (PQL, YD_PQL)
  CALL SGET_HOST_DATA_RDONLY (PQLC, YD_PQLC)
  CALL SGET_HOST_DATA_RDWR (PQLIS, YD_PQLIS)
  CALL SGET_HOST_DATA_RDWR (PQLIS0, YD_PQLIS0)
  CALL SGET_HOST_DATA_RDONLY (PQV, YD_PQV)
  CALL SGET_HOST_DATA_RDWR (PTKE1, YD_PTKE1)
  CALL SGET_HOST_DATA_RDWR (PUSLE, YD_PUSLE)
  CALL SGET_HOST_DATA_RDWR (PXTROV, YD_PXTROV)
  CALL SGET_HOST_DATA_RDWR (PXUROV, YD_PXUROV)
  CALL SGET_HOST_DATA_RDWR (ZCDROV_SAVE, YL_ZCDROV_SAVE)
  CALL SGET_HOST_DATA_RDWR (ZCHROV_SAVE, YL_ZCHROV_SAVE)
  CALL SGET_HOST_DATA_RDWR (ZKTROV_SAVE, YL_ZKTROV_SAVE)
  CALL SGET_HOST_DATA_RDWR (ZKUROV_SAVE, YL_ZKUROV_SAVE)
  CALL SGET_HOST_DATA_RDWR (ZNLAB, YL_ZNLAB)
  CALL SGET_HOST_DATA_RDWR (ZNLABCVP, YL_ZNLABCVP)
  CALL SGET_HOST_DATA_RDWR (ZTPRDY, YL_ZTPRDY)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_SHALLOW_CONVECTION_AND_TURBULENCE_PARALLEL:ACTKE')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (PKUROV, YD_PKUROV)
    CALL SGET_HOST_DATA_RDWR (PKUROV2, YD_PKUROV2)
    CALL SGET_HOST_DATA_RDWR (PMSC_LSCPE, YD_PMSC_LSCPE)
    CALL SGET_HOST_DATA_RDWR (PNBVNO, YD_PNBVNO)
    CALL SGET_HOST_DATA_RDWR (PNEBS, YD_PNEBS)
    CALL SGET_HOST_DATA_RDWR (PNEBS0, YD_PNEBS0)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_SHALLOW_CONVECTION_AND_TURBULENCE_PARALLEL&
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SHALLOW_CONVECTION_AND_TURBULENCE_PARALLEL&
  &:ACTKE:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (KNLAB_CVPP, YD_KNLAB_CVPP)
  CALL SGET_DEVICE_DATA_RDONLY (PCDROV, YD_PCDROV)
  CALL SGET_DEVICE_DATA_RDONLY (PCHROV, YD_PCHROV)
  CALL SGET_DEVICE_DATA_RDWR (PCOEFN, YD_PCOEFN)
  CALL SGET_DEVICE_DATA_RDWR (PECTCLS, YD_PECTCLS)
  CALL SGET_DEVICE_DATA_RDONLY (PFLU_CD, YD_PFLU_CD)
  CALL SGET_DEVICE_DATA_RDONLY (PFLU_CH, YD_PFLU_CH)
  CALL SGET_DEVICE_DATA_RDWR (PKCLS, YD_PKCLS)
  ...
  CALL SGET_DEVICE_DATA_RDWR (PKUROV2, YD_PKUROV2)
  CALL SGET_DEVICE_DATA_RDONLY (PMSC_LSCPE, YD_PMSC_LSCPE)
  CALL SGET_DEVICE_DATA_RDWR (PNBVNO, YD_PNBVNO)
  CALL SGET_DEVICE_DATA_RDWR (PNEBS, YD_PNEBS)
  CALL SGET_DEVICE_DATA_RDWR (PNEBS0, YD_PNEBS0)
  CALL SGET_DEVICE_DATA_RDONLY (PPFL_FPLCH, YD_PPFL_FPLCH)
  CALL SGET_DEVICE_DATA_RDWR (PPFL_FTKE, YD_PPFL_FTKE)
  CALL SGET_DEVICE_DATA_RDWR (PPFL_FTKEI, YD_PPFL_FTKEI)
  CALL SGET_DEVICE_DATA_RDWR (PPRODTH, YD_PPRODTH)
  CALL SGET_DEVICE_DATA_RDONLY (PPRODTH_CVPP, YD_PPRODTH_CVPP)
  CALL SGET_DEVICE_DATA_RDONLY (PQI, YD_PQI)
  CALL SGET_DEVICE_DATA_RDONLY (PQIC, YD_PQIC)
  CALL SGET_DEVICE_DATA_RDONLY (PQL, YD_PQL)
  CALL SGET_DEVICE_DATA_RDONLY (PQLC, YD_PQLC)
  ...
  CALL SGET_DEVICE_DATA_RDWR (PTKE1, YD_PTKE1)
  CALL SGET_DEVICE_DATA_RDWR (PUSLE, YD_PUSLE)
  CALL SGET_DEVICE_DATA_RDWR (PXTROV, YD_PXTROV)
  CALL SGET_DEVICE_DATA_RDWR (PXUROV, YD_PXUROV)
  CALL SGET_DEVICE_DATA_RDWR (ZCDROV_SAVE, YL_ZCDROV_SAVE)
  CALL SGET_DEVICE_DATA_RDWR (ZCHROV_SAVE, YL_ZCHROV_SAVE)
  CALL SGET_DEVICE_DATA_RDWR (ZKTROV_SAVE, YL_ZKTROV_SAVE)
  CALL SGET_DEVICE_DATA_RDWR (ZKUROV_SAVE, YL_ZKUROV_SAVE)
  CALL SGET_DEVICE_DATA_RDWR (ZNLAB, YL_ZNLAB)
  CALL SGET_DEVICE_DATA_RDWR (ZNLABCVP, YL_ZNLABCVP)
  CALL SGET_DEVICE_DATA_RDWR (ZTPRDY, YL_ZTPRDY)
  ...
  !$OMP & MAP(PRESENT:KNLAB_CVPP, PCDROV, PCHROV, PCOEFN, PECTCLS, PFLU_CD, PFLU_CH, PKCLS,  & 
  !$OMP &          PKQLROV, PKQROV, PKTROV, PKUROV, PKUROV2, PMSC_LSCPE, PNBVNO, PNEBS,  & 
  !$OMP &          PNEBS0, PPFL_FPLCH, PPFL_FTKE, PPFL_FTKEI, PPRODTH, PPRODTH_CVPP,  & 
  !$OMP &          PQI, PQIC, PQL, PQLC, PQLIS, PQLIS0, PQV, PTKE1, PUSLE, PXTROV, PXUROV, YDCPG_OPTS,  & 
  !$OMP &          YDMODEL, YFXTRAN_ACDC_STACK, ZCDROV_SAVE, ZCHROV_SAVE, ZKTROV_SAVE,  & 
  !$OMP &          ZKUROV_SAVE, ZNLAB, ZNLABCVP, ZTPRDY, Z_YDCPG_MISC_QICE, Z_YDCPG_MISC_QLI,  & 
  !$OMP &          Z_YDCPG_MISC_QS, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_TKE,  & 
  ...
  !$OMP &          Z_YDMF_PHYS_OUT_CLPH, Z_YDMF_PHYS_OUT_EDR, Z_YDMF_PHYS_OUT_GZ0)  & 
  !$OMP & PRIVATE (JBLK)  & 
