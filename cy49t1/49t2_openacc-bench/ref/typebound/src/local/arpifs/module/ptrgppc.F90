...
PROCEDURE :: COPY => COPY_TPTRGPPC
PROCEDURE :: CRC64 => CRC64_TPTRGPPC
PROCEDURE :: HOST => HOST_TPTRGPPC
PROCEDURE :: LOAD => LOAD_TPTRGPPC
PROCEDURE :: SAVE => SAVE_TPTRGPPC
PROCEDURE :: SIZE => SIZE_TPTRGPPC
PROCEDURE :: WIPE => WIPE_TPTRGPPC
END TYPE TPTRGPPC
...
MODULE SUBROUTINE COPY_TPTRGPPC (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TPTRGPPC (SELF)
...
MODULE SUBROUTINE WIPE_TPTRGPPC (SELF, LDDELETED, LDFIELDAPI)
