...
CONTAINS
PROCEDURE :: COPY => COPY_NSV_T
PROCEDURE :: CRC64 => CRC64_NSV_T
PROCEDURE :: HOST => HOST_NSV_T
PROCEDURE :: LOAD => LOAD_NSV_T
PROCEDURE :: SAVE => SAVE_NSV_T
PROCEDURE :: SIZE => SIZE_NSV_T
PROCEDURE :: WIPE => WIPE_NSV_T
END TYPE NSV_t
!
...
MODULE SUBROUTINE COPY_NSV_T (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_NSV_T (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_NSV_T (SELF)

IMPLICIT NONE
CLASS (NSV_T), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_NSV_T (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_NSV_T (SELF, KLUN)
...
MODULE FUNCTION SIZE_NSV_T (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_NSV_T (SELF, LDDELETED, LDFIELDAPI)
