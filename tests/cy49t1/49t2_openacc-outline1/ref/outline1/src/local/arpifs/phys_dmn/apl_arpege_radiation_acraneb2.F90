SUBROUTINE APL_ARPEGE_RADIATION_ACRANEB2 (YDVARS, YDCPG_OPTS, YDCFU, YDCPG_MISC, YDMF_PHYS&
&, YDMF_PHYS_BASE_STATE, YDMF_PHYS_SURF, YDMODEL, YDCPG_BNDS, PCLCT_RAD, PQV, PFRSODS&
