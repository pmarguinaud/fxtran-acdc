...
DO JFLD=1, SIZE (YDCPG_GMV9%GMV)
  ...
  IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:ZERO_GMV9')) THEN
    ...
    IF (LSYNCHOST ('LAPINEB_PARALLEL:ZERO_GMV9')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:ZERO_GMV9')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:ZERO_GMV9')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:ZERO_GMV9:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&PRESENT (YDCPG_OPTS, YSTACK, Z_YDCPG_GMV9_GMV_P) &
      !$ACC&PRIVATE (JBLK) &
...
IF (YDMODEL%YRML_DYN%YRDYNA%LSLINL) THEN
  ...
  DO JFLD=1, SIZE (YDCPG_GMV9_SI%GMV)
    ...
    IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:ZERO_GMV9_SI')) THEN
      ...
      IF (LSYNCHOST ('LAPINEB_PARALLEL:ZERO_GMV9_SI')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:ZERO_GMV9_SI')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:ZERO_GMV9_SI')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:ZERO_GMV9_SI:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (YDCPG_OPTS, YSTACK, Z_YDCPG_GMV9_SI_GMV_P) &
        !$ACC&PRIVATE (JBLK) &
        !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDMODEL%YRML_DYN%YRDYNA%LPC_CHEAP.AND.YDMODEL%YRML_DYN%YRDYNA%LSETTLS) THEN
  ...
  DO JFLD=1, SIZE (YDCPG_GMV9_NL%GMV)
    ...
    IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:ZERO_GMV9_SL')) THEN
      ...
      IF (LSYNCHOST ('LAPINEB_PARALLEL:ZERO_GMV9_SL')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:ZERO_GMV9_SL')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:ZERO_GMV9_SL')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:ZERO_GMV9_SL:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (YDCPG_OPTS, YSTACK, Z_YDCPG_GMV9_NL_GMV_P) &
        !$ACC&PRIVATE (JBLK) &
        !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LDSLPHY) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:ZERO_UV9')) THEN
    ...
    IF (LSYNCHOST ('LAPINEB_PARALLEL:ZERO_UV9')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:ZERO_UV9')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:ZERO_UV9')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:ZERO_UV9:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YSTACK, ZUP9, ZVP9) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:ROTUVGEO')) THEN
  ...
  IF (LSYNCHOST ('LAPINEB_PARALLEL:ROTUVGEO')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:ROTUVGEO')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:ROTUVGEO')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:ROTUVGEO:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZP, ZQ, Z_YDA_PCCO_P, Z_YDVARS_GEOMETRY_GNORDL_P, &
    !$ACC&         Z_YDVARS_GEOMETRY_GNORDM_P) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDCPG_OPTS%LRPLANE) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:LRPLANE')) THEN
    ...
    IF (LSYNCHOST ('LAPINEB_PARALLEL:LRPLANE')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:LRPLANE')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:LRPLANE')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:LRPLANE:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZGMDTX, ZGMDTY, ZINEZV, &
      !$ACC&         Z_YDA_PCCO_P, Z_YDA_PSCO_P, Z_YDVARS_GEOMETRY_GM_P, Z_YDVARS_GEOMETRY_RINDX_P, &
      !$ACC&         Z_YDVARS_GEOMETRY_RINDY_P) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
      ...
      DO JROF = 1, MIN (YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1) * YDCPG_OPTS%KLON)
        ...
        CALL ACPY (JROF, Z_YDA_PCCO_P (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, YDMODEL%YRML_DYN%YYTCCO%M_RLON, JBLK&
        &), Z_YDA_PSCO_P (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, YDMODEL%YRML_DYN%YYTSCO%M_SINLA, JBLK))
        CALL ACPY (JROF, Z_YDA_PCCO_P (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, YDMODEL%YRML_DYN%YYTCCO%M_RLAT, JBLK&
        &), Z_YDA_PSCO_P (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, YDMODEL%YRML_DYN%YYTSCO%M_COPHI, JBLK))
      ENDDO
...
IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:ZVWEI')) THEN
  ...
  IF (LSYNCHOST ('LAPINEB_PARALLEL:ZVWEI')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:ZVWEI')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:ZVWEI')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:ZVWEI:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, ZVWEI) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDMODEL%YRML_DYN%YRDYN%NVLAG==2) THEN
  ...
  ELSE
    ...
    IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:NVLAG2')) THEN
      ...
      IF (LSYNCHOST ('LAPINEB_PARALLEL:NVLAG2')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:NVLAG2')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:NVLAG2')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:NVLAG2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, ZC9, ZDP9, ZVWEI, Z_YDVARS_SP_T1) &
        !$ACC&PRIVATE (JBLK) &
        !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ELSEIF (YDMODEL%YRML_DYN%YRDYN%NVLAG==3) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:NVLAG3')) THEN
    ...
    IF (LSYNCHOST ('LAPINEB_PARALLEL:NVLAG3')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:NVLAG3')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:NVLAG3')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:NVLAG3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZC9, ZC9_SI, ZDP9, ZSPT1, &
      !$ACC&         ZSPTO, ZVWEI, Z_YDCPG_SL2_SPSI, Z_YDVARS_SP_T1) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ELSE
  ...
  IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:ROTUV')) THEN
    ...
    IF (LSYNCHOST ('LAPINEB_PARALLEL:ROTUV')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:ROTUV')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:ROTUV')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:ROTUV:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZP, ZQ, ZUP9, ZVP9, Z_YDA_PUP9_P, &
      !$ACC&         Z_YDA_PVP9_P, Z_YDCPG_GMV9_SI_U_P, Z_YDCPG_GMV9_SI_V_P, Z_YDCPG_GMV9_U_P, &
      !$ACC&         Z_YDCPG_GMV9_V_P, Z_YDCPG_SL2_USI, Z_YDCPG_SL2_VSI, Z_YDVARS_U_T1, &
      !$ACC&         Z_YDVARS_V_T1) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:TEMP_EQ')) THEN
  ...
  IF (LSYNCHOST ('LAPINEB_PARALLEL:TEMP_EQ')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:TEMP_EQ')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:TEMP_EQ')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:TEMP_EQ:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, Z_YDCPG_GMV9_SI_T_P, &
...
DO JFLD=1, SIZE (YDVARS%GFL_PTR)
  ...
  IF (YDMODEL%YRML_DYN%YRDYNA%LSLDIA.AND.(YDVARS%GFL_PTR (JFLD)%YCOMP%CNAME&
    ...
    IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:DPDETA0')) THEN
      ...
      IF (LSYNCHOST ('LAPINEB_PARALLEL:DPDETA0')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:DPDETA0')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:DPDETA0')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:DPDETA0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, ZDP9, Z_YDVARS_GEOMETRY_OROG_P, &
  ...
  IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LADV) THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:CVGQ')) THEN
      ...
      IF (LSYNCHOST ('LAPINEB_PARALLEL:CVGQ')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:CVGQ')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:CVGQ')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:CVGQ:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDVARS, YSTACK, Z_YDCPG_GFL9_GFL_P, Z_YDVARS_GFL_PTR_T1, &
        !$ACC&         Z_YDVARS_Q_T0) &
        !$ACC&PRIVATE (JBLK) &
        !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDMODEL%YRML_GCONF%YGFL%YCVGQ%LSP) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:YCVGQ')) THEN
    ...
    IF (LSYNCHOST ('LAPINEB_PARALLEL:YCVGQ')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:YCVGQ')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:YCVGQ')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:YCVGQ:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, Z_YDVARS_CVGQ_T1, Z_YDVARS_Q_T1) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
      ...
      DO JROF = 1, MIN (YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1) * YDCPG_OPTS%KLON)
        ...
        CALL ACPY (JROF, Z_YDVARS_CVGQ_T1 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG&
        &, JBLK), Z_YDVARS_Q_T1 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK))
      ENDDO
...
IF (YDMODEL%YRML_DYN%YRDYNA%L_RDRY_VD) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:L_RDRY_VD')) THEN
    ...
    IF (LSYNCHOST ('LAPINEB_PARALLEL:L_RDRY_VD')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:L_RDRY_VD')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:L_RDRY_VD')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:L_RDRY_VD:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZRT1, Z_YDVARS_T_T1) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDMODEL%YRML_DYN%YRDYN%LADVF.AND..NOT.(YDMODEL%YRML_DYN%YRDYNA&
  ...
  IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:LACONE')) THEN
    ...
    IF (LSYNCHOST ('LAPINEB_PARALLEL:LACONE')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:LACONE')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:LACONE')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:LACONE:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZP, ZQ, Z_YDA_PCCO_P, Z_YDCPG_GMV9_U_P, &
      !$ACC&         Z_YDCPG_GMV9_V_P, Z_YDVARS_PCF_U_PC_PH, Z_YDVARS_PCF_V_PC_PH, &
      ...
      DO JROF = 1, MIN (YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1) * YDCPG_OPTS%KLON)
        ...
        IF (YDCPG_OPTS%LRPLANE) THEN
          CALL ACPY (JROF, Z_YDCPG_GMV9_U_P (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK), Z_YDA_PCCO_P&
          & (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, YDMODEL%YRML_DYN%YYTCCO%M_RLON, JBLK))
          CALL ACPY (JROF, Z_YDCPG_GMV9_V_P (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK), Z_YDA_PCCO_P&
          & (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, YDMODEL%YRML_DYN%YYTCCO%M_RLAT, JBLK))
        ELSE
          CALL LACONE_OPENACC (YDGEOMETRY%YRDIM%NPROMA, YLCPG_BNDS%KIDIA, YLCPG_BNDS%KFDIA, YDGEOMETRY&
          &%YRDIMV%NFLEVG, YDGEOMETRY%YRGEM%NSTTYP, YDCPG_OPTS%N2DINI, YDMODEL%YRML_DYN%YRDYN%YRSWE&
...
IF (YDMODEL%YRML_DYN%YRDYN%L2TLFF.AND..NOT.(YDMODEL%YRML_DYN%YRDYNA&
  ...
  ELSE
    ...
    IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:LARCHE')) THEN
      ...
      IF (LSYNCHOST ('LAPINEB_PARALLEL:LARCHE')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:LARCHE')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:LARCHE')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:LARCHE:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZP, ZQ, ZUT1, ZUZ9, ZVT1, ZVZ9, &
        !$ACC&         Z_YDA_PCCO_P, Z_YDA_PSCO_P, Z_YDCPG_GMV9_U_P, Z_YDCPG_GMV9_V_P, &
        !$ACC&         Z_YDVARS_GEOMETRY_GECLO_P, Z_YDVARS_GEOMETRY_GEMU_P, Z_YDVARS_GEOMETRY_GESLO_P, &
        !$ACC&         Z_YDVARS_GEOMETRY_GNORDL_P, Z_YDVARS_GEOMETRY_GNORDL_T0, &
        !$ACC&         Z_YDVARS_GEOMETRY_GNORDM_P, Z_YDVARS_GEOMETRY_GNORDM_T0, &
        !$ACC&         Z_YDVARS_GEOMETRY_GSQM2_P, Z_YDVARS_GEOMETRY_RCOLON_P, &
        !$ACC&         Z_YDVARS_GEOMETRY_RSILON_P, Z_YDVARS_U_T1, Z_YDVARS_V_T1) &
        !$ACC&PRIVATE (JBLK) &
        !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:ROTUVGEO')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:ROTUVGEO:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, ZP2, ZQ2, Z_YDA_PCCO_P, &
      !$ACC&         Z_YDCPG_GMV9_U_P, Z_YDCPG_GMV9_V_P, Z_YDVARS_GEOMETRY_GNORDL_P, &
...
IF (YDMODEL%YRML_DYN%YRDYNA%LRDBBC) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','LAPINEB_PARALLEL:LRDBBC')) THEN
    ...
    IF (LSYNCHOST ('LAPINEB_PARALLEL:LRDBBC')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEB_PARALLEL:LRDBBC')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEB_PARALLEL:LRDBBC')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LAPINEB_PARALLEL:LRDBBC:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, ZDBBC9, ZDPHI9, ZGWS9, ZOROGL_SR, &
      !$ACC&         ZOROGM_SR, ZUST1, ZVST1, Z_YDCPG_SL2_DBBC1, Z_YDCPG_SL2_DPHI1, &
      !$ACC&         Z_YDVARS_SVD_T1) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ENDSUBROUTINE LAPINEB_PARALLEL
