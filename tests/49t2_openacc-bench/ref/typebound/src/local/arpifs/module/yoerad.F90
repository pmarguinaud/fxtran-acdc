...
INTEGER(KIND=JPIM) :: NTLW
  ...
  INTEGER(KIND=JPIM) :: NMCLAT, NMCLON, NMCLEV
  INTEGER(KIND=JPIM) :: NSWGASOPTICS, NLWGASOPTICS
  INTEGER(KIND=JPIM) :: NGASOPTICSSCHEME
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_TERAD
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TERAD
PROCEDURE :: ACDC_HOST => ACDC_HOST_TERAD
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TERAD
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TERAD
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TERAD
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TERAD
END TYPE TERAD
!============================================================================
...
!    M. Michou, P. Nabat Jan 2023    : Modifications related to the use of chemistry and/or aerosol schemes
!    R J Hogan 24 Jun  2021: Added NSWGASOPTICS, NLWGASOPTICS
!    P Ukkonen 2  Feb  2022: Added NGasOpticsScheme
...
! NOZOCL : INTEGER : CHOICE OF OZONE/GHG CLIMATOLOGY (0: old O3, 1: new O3, 2: O3 climatological profile, 
!                                                 3-4: MACC/CAMS O3 and GHG monthly climatology,
!                                                 5-6: 3D concentrations of O3 and GHG from chemistry scheme)
...
! NTLW   : INTEGER : MAXIMUM POSSIBLE NUMBER OF LW SPECTRAL INTERVALS 
...
!          4 = CAMS cloud droplets and ICE3 gamma laws for cloud droplet size distribution are used
...
! NRTCALL : INTEGER  Maximum possible number of calls to radiation transfert code
!                    for array dimensions
!                     general case : 1
! IRTCALLREF : INTEGER Reference call to radiation (=1)
! IRTCALLCLN : INTEGER Call number to radiation for clean-sky computations
...
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'NLW = ', SELF%NLW
...
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'NTLW = ', SELF%NTLW
...
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'NGASOPTICSSCHEME = ', SELF%NGASOPTICSSCHEME
