SUBROUTINE LARCINB_LAITRE_GMV (LDMOM, LDHOI2, LD_LIN, LDNOSLHD, YDCPG_DDH_TND, YDCPG_SL1, YDLDDH, KWKH&
&, KWK, KASLB1, YDML_DYN, YDGEOMETRY, YDCPG_GMVF, YDCPG_BNDS, PLSCAW, PRSCAW, KL0, KNOWENO)
