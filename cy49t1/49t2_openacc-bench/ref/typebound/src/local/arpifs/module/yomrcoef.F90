...
PROCEDURE :: COPY => COPY_TRCOEF
PROCEDURE :: CRC64 => CRC64_TRCOEF
PROCEDURE :: HOST => HOST_TRCOEF
PROCEDURE :: LOAD => LOAD_TRCOEF
PROCEDURE :: SAVE => SAVE_TRCOEF
PROCEDURE :: SIZE => SIZE_TRCOEF
PROCEDURE :: WIPE => WIPE_TRCOEF
END TYPE TRCOEF
!============================================================================
...
MODULE SUBROUTINE COPY_TRCOEF (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TRCOEF (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TRCOEF (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TRCOEF (SELF, KLUN)
...
MODULE FUNCTION SIZE_TRCOEF (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TRCOEF (SELF, LDDELETED, LDFIELDAPI)
