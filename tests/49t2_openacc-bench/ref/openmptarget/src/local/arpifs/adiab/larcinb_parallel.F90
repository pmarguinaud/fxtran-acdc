...
ELSE
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LRHS_CURV_F')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (KL0, YD_KL0)
    CALL SGET_HOST_DATA_RDONLY (KNOWENO, YD_KNOWENO)
    CALL SGET_HOST_DATA_RDONLY (PLSCAW, YD_PLSCAW)
    CALL SGET_HOST_DATA_RDONLY (PRSCAW, YD_PRSCAW)
    CALL SGET_HOST_DATA_RDWR (PUFZ, YD_PUFZ)
    CALL SGET_HOST_DATA_RDWR (PUPF, YD_PUPF)
    CALL SGET_HOST_DATA_RDWR (PVFZ, YD_PVFZ)
    CALL SGET_HOST_DATA_RDWR (PVPF, YD_PVPF)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DDH_TND_YSI_U_T0, YDCPG_DDH_TND%YSI%U%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DDH_TND_YSI_V_T0, YDCPG_DDH_TND%YSI%V%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DDH_TND_YSL_U_P, YDCPG_DDH_TND%YSL%U%F_P)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DDH_TND_YSL_V_P, YDCPG_DDH_TND%YSL%V%F_P)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GMVF_NL_U_P, YDCPG_GMVF_NL%U%F_P)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GMVF_NL_V_P, YDCPG_GMVF_NL%V%F_P)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GMVF_SI_U_P, YDCPG_GMVF_SI%U%F_P)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GMVF_SI_V_P, YDCPG_GMVF_SI%V%F_P)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GMVF_U_P, YDCPG_GMVF%U%F_P)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GMVF_V_P, YDCPG_GMVF%V%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_U0_P, YDCPG_SL1%U0%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_U9_NL_P, YDCPG_SL1%U9_NL%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_U9_P, YDCPG_SL1%U9%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_U9_SI_P, YDCPG_SL1%U9_SI%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_UF9_P, YDCPG_SL1%UF9%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_UP9_P, YDCPG_SL1%UP9%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_UR9_P, YDCPG_SL1%UR9%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_V0_P, YDCPG_SL1%V0%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_V9_NL_P, YDCPG_SL1%V9_NL%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_V9_P, YDCPG_SL1%V9%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_V9_SI_P, YDCPG_SL1%V9_SI%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_VF9_P, YDCPG_SL1%VF9%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_VP9_P, YDCPG_SL1%VP9%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_VR9_P, YDCPG_SL1%VR9%F_P)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('LARCINB_PARALLEL:LRHS_CURV_F')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (KL0, YD_KL0)
      CALL SGET_HOST_DATA_RDWR (KNOWENO, YD_KNOWENO)
      CALL SGET_HOST_DATA_RDWR (PLSCAW, YD_PLSCAW)
      CALL SGET_HOST_DATA_RDWR (PRSCAW, YD_PRSCAW)
      CALL SGET_HOST_DATA_RDWR (PUFZ, YD_PUFZ)
      CALL SGET_HOST_DATA_RDWR (PUPF, YD_PUPF)
      CALL SGET_HOST_DATA_RDWR (PVFZ, YD_PVFZ)
      CALL SGET_HOST_DATA_RDWR (PVPF, YD_PVPF)
      ...
      CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_UP9_P, YDCPG_SL1%UP9%F_P)
      ...
      CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_VP9_P, YDCPG_SL1%VP9%F_P)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LRHS_CURV_F')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LRHS_CURV_F:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDONLY (KL0, YD_KL0)
    CALL SGET_DEVICE_DATA_RDONLY (KNOWENO, YD_KNOWENO)
    CALL SGET_DEVICE_DATA_RDONLY (PLSCAW, YD_PLSCAW)
    CALL SGET_DEVICE_DATA_RDONLY (PRSCAW, YD_PRSCAW)
    CALL SGET_DEVICE_DATA_RDWR (PUFZ, YD_PUFZ)
    CALL SGET_DEVICE_DATA_RDWR (PUPF, YD_PUPF)
    CALL SGET_DEVICE_DATA_RDWR (PVFZ, YD_PVFZ)
    CALL SGET_DEVICE_DATA_RDWR (PVPF, YD_PVPF)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_DDH_TND_YSI_U_T0, YDCPG_DDH_TND%YSI%U%FT0)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_DDH_TND_YSI_V_T0, YDCPG_DDH_TND%YSI%V%FT0)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_DDH_TND_YSL_U_P, YDCPG_DDH_TND%YSL%U%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_DDH_TND_YSL_V_P, YDCPG_DDH_TND%YSL%V%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GMVF_NL_U_P, YDCPG_GMVF_NL%U%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GMVF_NL_V_P, YDCPG_GMVF_NL%V%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GMVF_SI_U_P, YDCPG_GMVF_SI%U%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GMVF_SI_V_P, YDCPG_GMVF_SI%V%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GMVF_U_P, YDCPG_GMVF%U%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GMVF_V_P, YDCPG_GMVF%V%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_U0_P, YDCPG_SL1%U0%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_U9_NL_P, YDCPG_SL1%U9_NL%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_U9_P, YDCPG_SL1%U9%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_U9_SI_P, YDCPG_SL1%U9_SI%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_UF9_P, YDCPG_SL1%UF9%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_UP9_P, YDCPG_SL1%UP9%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_UR9_P, YDCPG_SL1%UR9%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_V0_P, YDCPG_SL1%V0%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_V9_NL_P, YDCPG_SL1%V9_NL%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_V9_P, YDCPG_SL1%V9%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_V9_SI_P, YDCPG_SL1%V9_SI%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_VF9_P, YDCPG_SL1%VF9%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_VP9_P, YDCPG_SL1%VP9%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_VR9_P, YDCPG_SL1%VR9%F_P)
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LRHS_CURV_F:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LRHS_CURV_F:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:KL0, KNOWENO, PLSCAW, PRSCAW, PUFZ, PUPF, PVFZ, PVPF, YDCPG_OPTS, YDGEOMETRY,  & 
    !$OMP &          YDLDDH, YDML_DYN, YFXTRAN_ACDC_STACK, Z_YDCPG_DDH_TND_YSI_U_T0,  & 
    !$OMP &          Z_YDCPG_DDH_TND_YSI_V_T0, Z_YDCPG_DDH_TND_YSL_U_P, Z_YDCPG_DDH_TND_YSL_V_P,  & 
    !$OMP &          Z_YDCPG_GMVF_NL_U_P, Z_YDCPG_GMVF_NL_V_P, Z_YDCPG_GMVF_SI_U_P,  & 
    !$OMP &          Z_YDCPG_GMVF_SI_V_P, Z_YDCPG_GMVF_U_P, Z_YDCPG_GMVF_V_P,  & 
    !$OMP &          Z_YDCPG_SL1_U0_P, Z_YDCPG_SL1_U9_NL_P, Z_YDCPG_SL1_U9_P,  & 
    !$OMP &          Z_YDCPG_SL1_U9_SI_P, Z_YDCPG_SL1_UF9_P, Z_YDCPG_SL1_UP9_P,  & 
    !$OMP &          Z_YDCPG_SL1_UR9_P, Z_YDCPG_SL1_V0_P, Z_YDCPG_SL1_V9_NL_P,  & 
    !$OMP &          Z_YDCPG_SL1_V9_P, Z_YDCPG_SL1_V9_SI_P, Z_YDCPG_SL1_VF9_P,  & 
    !$OMP &          Z_YDCPG_SL1_VP9_P, Z_YDCPG_SL1_VR9_P)  & 
    !$OMP & PRIVATE (JBLK)  & 
    ...
    DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
      ...
      !$OMP & PRIVATE (IWK, JLEV, JROF, LLHOI2, LLMOM, YLCPG_BNDS, YLSTACK)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LAITRE_GMV')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (PLSCAW, YD_PLSCAW)
  CALL SGET_HOST_DATA_RDONLY (PRSCAW, YD_PRSCAW)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DDH_TND_YSL_T_P, YDCPG_DDH_TND%YSL%T%F_P)
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GMVF_T_P, YDCPG_GMVF%T%F_P)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_T9_P, YDCPG_SL1%T9%F_P)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_TF9_P, YDCPG_SL1%TF9%F_P)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LAITRE_GMV')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDONLY (PLSCAW, YD_PLSCAW)
  CALL SGET_DEVICE_DATA_RDONLY (PRSCAW, YD_PRSCAW)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_DDH_TND_YSL_T_P, YDCPG_DDH_TND%YSL%T%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GMVF_T_P, YDCPG_GMVF%T%F_P)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_T9_P, YDCPG_SL1%T9%F_P)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_TF9_P, YDCPG_SL1%TF9%F_P)
  IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LAITRE_GMV:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LAITRE_GMV:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:KL0, KNOWENO, PLSCAW, PRSCAW, YDCPG_OPTS, YDGEOMETRY, YDLDDH, YDML_DYN,  & 
  !$OMP &          YFXTRAN_ACDC_STACK, Z_YDCPG_DDH_TND_YSL_T_P, Z_YDCPG_GMVF_T_P,  & 
  !$OMP &          Z_YDCPG_SL1_T9_P, Z_YDCPG_SL1_TF9_P)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
  ...
  DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
    ...
    !$OMP PARALLEL DO SIMD  & 
    !$OMP & PRIVATE (IWK, JLEV, JROF, LLHOI2, YLCPG_BNDS, YLSTACK)       
...
IF (YDML_DYN%YRDYN%NTLAG>=3) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:NTLAG_3')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (KL0, YD_KL0)
    CALL SGET_HOST_DATA_RDONLY (PLSCAW, YD_PLSCAW)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DDH_TND_YSI_T_T0, YDCPG_DDH_TND%YSI%T%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GMVF_NL_T_P, YDCPG_GMVF_NL%T%F_P)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GMVF_SI_T_P, YDCPG_GMVF_SI%T%F_P)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GMVF_T_P, YDCPG_GMVF%T%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_T0_P, YDCPG_SL1%T0%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_T9_NL_P, YDCPG_SL1%T9_NL%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_T9_SI_P, YDCPG_SL1%T9_SI%F_P)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:NTLAG_3')) THEN
    ...
    CALL SGET_DEVICE_DATA_RDONLY (KL0, YD_KL0)
    CALL SGET_DEVICE_DATA_RDONLY (PLSCAW, YD_PLSCAW)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_DDH_TND_YSI_T_T0, YDCPG_DDH_TND%YSI%T%FT0)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GMVF_NL_T_P, YDCPG_GMVF_NL%T%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GMVF_SI_T_P, YDCPG_GMVF_SI%T%F_P)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GMVF_T_P, YDCPG_GMVF%T%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_T0_P, YDCPG_SL1%T0%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_T9_NL_P, YDCPG_SL1%T9_NL%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_T9_SI_P, YDCPG_SL1%T9_SI%F_P)
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:NTLAG_3:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:NTLAG_3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:KL0, PLSCAW, YDCPG_OPTS, YDGEOMETRY, YDLDDH, YDML_DYN, YFXTRAN_ACDC_STACK,  & 
    !$OMP &          Z_YDCPG_DDH_TND_YSI_T_T0, Z_YDCPG_GMVF_NL_T_P, Z_YDCPG_GMVF_SI_T_P,  & 
    !$OMP &          Z_YDCPG_GMVF_T_P, Z_YDCPG_SL1_T0_P, Z_YDCPG_SL1_T9_NL_P,  & 
    !$OMP &          Z_YDCPG_SL1_T9_SI_P)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (LDSLPHY) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LDSLPHY')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (KL0, YD_KL0)
    CALL SGET_HOST_DATA_RDONLY (PLSCAW, YD_PLSCAW)
    CALL SGET_HOST_DATA_RDWR (PTPF, YD_PTPF)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_TP9_P, YDCPG_SL1%TP9%F_P)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('LARCINB_PARALLEL:LDSLPHY')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (PLSCAW, YD_PLSCAW)
      CALL SGET_HOST_DATA_RDWR (PTPF, YD_PTPF)
      CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_TP9_P, YDCPG_SL1%TP9%F_P)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LDSLPHY')) THEN
    ...
    CALL SGET_DEVICE_DATA_RDONLY (KL0, YD_KL0)
    CALL SGET_DEVICE_DATA_RDONLY (PLSCAW, YD_PLSCAW)
    CALL SGET_DEVICE_DATA_RDWR (PTPF, YD_PTPF)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_TP9_P, YDCPG_SL1%TP9%F_P)
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LDSLPHY:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LDSLPHY:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:KL0, PLSCAW, PTPF, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YFXTRAN_ACDC_STACK,  & 
    !$OMP &          Z_YDCPG_SL1_TP9_P)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
  ...
  IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LADV.AND.(.NOT.YDVARS%GFL_PTR (JFLD)%YCOMP%LMGRID)) THEN
    ...
    IF (YDVARS%GFL_PTR (JFLD)%YCOMP%CSLINT (1:3)=="LIN") THEN
      ...
      IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LIN')) THEN
        ...
        CALL SGET_HOST_DATA_RDONLY (KL0, YD_KL0)
        CALL SGET_HOST_DATA_RDONLY (PLSCAW, YD_PLSCAW)
        CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GFLF_GFL_P, YDCPG_GFLF%GFL (JFLD)%F_P)
        CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_GFL_P, YDCPG_SL1%GFL (JFLD)%F_P)
        ...
        IF (FXTRAN_ACDC_LSYNCHOST ('LARCINB_PARALLEL:LIN')) THEN
          ...
          CALL SGET_HOST_DATA_RDWR (PLSCAW, YD_PLSCAW)
          CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GFLF_GFL_P, YDCPG_GFLF%GFL (JFLD)%F_P)
          CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_GFL_P, YDCPG_SL1%GFL (JFLD)%F_P)
      ...
      ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LIN')) THEN
        ...
        CALL SGET_DEVICE_DATA_RDONLY (KL0, YD_KL0)
        CALL SGET_DEVICE_DATA_RDONLY (PLSCAW, YD_PLSCAW)
        CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GFLF_GFL_P, YDCPG_GFLF%GFL (JFLD)%F_P)
        CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_GFL_P, YDCPG_SL1%GFL (JFLD)%F_P)
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LIN:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LIN:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        
        !$OMP TARGET TEAMS DISTRIBUTE  & 
        !$OMP & MAP(PRESENT:KL0, PLSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YDML_GCONF, YFXTRAN_ACDC_STACK,  & 
        !$OMP &          Z_YDCPG_GFLF_GFL_P, Z_YDCPG_SL1_GFL_P)  & 
        !$OMP & PRIVATE (JBLK)  & 
        !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
        ...
        DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
          ...
          !$OMP PARALLEL DO SIMD  & 
          !$OMP & PRIVATE (JROF, LLCOMAD, YLCPG_BNDS, YLSTACK)       
    ...
    ELSEIF (YDML_GCONF%YGFL%NUMFLDS_SL1>0.AND.YDML_GCONF%YGFL%NUMFLDS_SPL&
      ...
      IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LAITVSPCQM')) THEN
        ...
        CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GFLF_GFL_P, YDCPG_GFLF%GFL (JFLD)%F_P)
        CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_GFL_P, YDCPG_SL1%GFL (JFLD)%F_P)
        CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_GFL_P_SP, YDCPG_SL1%GFL (JFLD)%F_P_SP)
        ...
        IF (FXTRAN_ACDC_LSYNCHOST ('LARCINB_PARALLEL:LAITVSPCQM')) THEN
          ...
          CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GFLF_GFL_P, YDCPG_GFLF%GFL (JFLD)%F_P)
          CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_GFL_P, YDCPG_SL1%GFL (JFLD)%F_P)
          CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_GFL_P_SP, YDCPG_SL1%GFL (JFLD)%F_P_SP)
      ...
      ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LAITVSPCQM')) THEN
        ...
        CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GFLF_GFL_P, YDCPG_GFLF%GFL (JFLD)%F_P)
        CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_GFL_P, YDCPG_SL1%GFL (JFLD)%F_P)
        CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_GFL_P_SP, YDCPG_SL1%GFL (JFLD)%F_P_SP)
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LAITVSPCQM:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LAITVSPCQM:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        
        !$OMP TARGET TEAMS DISTRIBUTE  & 
        !$OMP & MAP(PRESENT:KL0, KNOWENO, PLSCAW, PRSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YDML_GCONF,  & 
        !$OMP &          YDVARS, YFXTRAN_ACDC_STACK, Z_YDCPG_GFLF_GFL_P, Z_YDCPG_SL1_GFL_P,  & 
        !$OMP &          Z_YDCPG_SL1_GFL_P_SP)  & 
        !$OMP & PRIVATE (JBLK)  & 
        !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
    ...
    IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:RRINTOPT')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (Z_YDCPG_DDH_TND_YSL_GFL_P, YDCPG_DDH_TND%YSL%GFL (JFLD)%F_P)
      CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GFLF_GFL_P, YDCPG_GFLF%GFL (JFLD)%F_P)
    ...
    ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:RRINTOPT')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:RRINTOPT:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
      CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_DDH_TND_YSL_GFL_P, YDCPG_DDH_TND%YSL%GFL (JFLD)%F_P)
      CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GFLF_GFL_P, YDCPG_GFLF%GFL (JFLD)%F_P)
      IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:RRINTOPT:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
      IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:RRINTOPT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      
      !$OMP TARGET TEAMS DISTRIBUTE  & 
      !$OMP & MAP(PRESENT:YDCPG_OPTS, YDGEOMETRY, YDLDDH, YDML_DYN, YFXTRAN_ACDC_STACK,  & 
      !$OMP &          Z_YDCPG_DDH_TND_YSL_GFL_P, Z_YDCPG_GFLF_GFL_P)  & 
      !$OMP & PRIVATE (JBLK)  & 
      !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
    ...
    IF (.NOT.(YDML_DYN%YRDYN%NSPLTHOI==0.OR.YDVARS%GFL_PTR (JFLD)%YCOMP%LTDIABLIN)) THEN
      ...
      IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LTDIABLIN')) THEN
        ...
        CALL SGET_HOST_DATA_RDONLY (PLSCAW, YD_PLSCAW)
        CALL SGET_HOST_DATA_RDONLY (PRSCAW, YD_PRSCAW)
        CALL SGET_HOST_DATA_RDWR (ZGFLF, YL_ZGFLF)
        CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GFLF_GFL_P, YDCPG_GFLF%GFL (JFLD)%F_P)
        CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_GFL_P, YDCPG_SL1%GFL (JFLD)%F_P)
        CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_GFL_P_SPF, YDCPG_SL1%GFL (JFLD)%F_P_SPF)
        ...
        IF (FXTRAN_ACDC_LSYNCHOST ('LARCINB_PARALLEL:LTDIABLIN')) THEN
          ...
          CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GFLF_GFL_P, YDCPG_GFLF%GFL (JFLD)%F_P)
          CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_GFL_P, YDCPG_SL1%GFL (JFLD)%F_P)
          CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_GFL_P_SPF, YDCPG_SL1%GFL (JFLD)%F_P_SPF)
      ...
      ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LTDIABLIN')) THEN
        ...
        CALL SGET_DEVICE_DATA_RDONLY (PLSCAW, YD_PLSCAW)
        CALL SGET_DEVICE_DATA_RDONLY (PRSCAW, YD_PRSCAW)
        CALL SGET_DEVICE_DATA_RDWR (ZGFLF, YL_ZGFLF)
        CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GFLF_GFL_P, YDCPG_GFLF%GFL (JFLD)%F_P)
        CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_GFL_P, YDCPG_SL1%GFL (JFLD)%F_P)
        CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_GFL_P_SPF, YDCPG_SL1%GFL (JFLD)%F_P_SPF)
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LTDIABLIN:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LTDIABLIN:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        
        !$OMP TARGET TEAMS DISTRIBUTE  & 
        !$OMP & MAP(PRESENT:KL0, KNOWENO, PLSCAW, PRSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YDML_GCONF,  & 
        !$OMP &          YDVARS, YFXTRAN_ACDC_STACK, ZGFLF, Z_YDCPG_GFLF_GFL_P, Z_YDCPG_SL1_GFL_P,  & 
        !$OMP &          Z_YDCPG_SL1_GFL_P_SPF)  & 
        !$OMP & PRIVATE (JBLK)  & 
        !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
    ...
    IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LTDIABLIN) THEN
      ...
      IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LLCOMAD')) THEN
        ...
        CALL SGET_HOST_DATA_RDONLY (PLSCAW, YD_PLSCAW)
        CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GFLF_GFL_P, YDCPG_GFLF%GFL (JFLD)%F_P)
        CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_GFL_P_F, YDCPG_SL1%GFL (JFLD)%F_P_F)
        ...
        IF (FXTRAN_ACDC_LSYNCHOST ('LARCINB_PARALLEL:LLCOMAD')) THEN
          ...
          CALL SGET_HOST_DATA_RDWR (PLSCAW, YD_PLSCAW)
          CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GFLF_GFL_P, YDCPG_GFLF%GFL (JFLD)%F_P)
          CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_GFL_P_F, YDCPG_SL1%GFL (JFLD)%F_P_F)
      ...
      ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LLCOMAD')) THEN
        ...
        CALL SGET_DEVICE_DATA_RDONLY (PLSCAW, YD_PLSCAW)
        CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GFLF_GFL_P, YDCPG_GFLF%GFL (JFLD)%F_P)
        CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_GFL_P_F, YDCPG_SL1%GFL (JFLD)%F_P_F)
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LLCOMAD:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LLCOMAD:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        
        !$OMP TARGET TEAMS DISTRIBUTE  & 
        !$OMP & MAP(PRESENT:KL0, PLSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YFXTRAN_ACDC_STACK,  & 
        !$OMP &          Z_YDCPG_GFLF_GFL_P, Z_YDCPG_SL1_GFL_P_F)  & 
        !$OMP & PRIVATE (JBLK)  & 
        !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
  ...
  IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LADV) THEN
    ...
    IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LPHY.AND.LDSLPHY) THEN
      ...
      IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LLCOMAD_2')) THEN
        ...
        CALL SGET_HOST_DATA_RDONLY (KL0, YD_KL0)
        CALL SGET_HOST_DATA_RDONLY (PLSCAW, YD_PLSCAW)
        CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GFLPF_GFL_P, YDCPG_GFLPF%GFL (JFLD)%F_P)
        CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_GFL_P_P, YDCPG_SL1%GFL (JFLD)%F_P_P)
        ...
        IF (FXTRAN_ACDC_LSYNCHOST ('LARCINB_PARALLEL:LLCOMAD_2')) THEN
          ...
          CALL SGET_HOST_DATA_RDWR (PLSCAW, YD_PLSCAW)
          CALL SGET_HOST_DATA_RDWR (Z_YDCPG_GFLPF_GFL_P, YDCPG_GFLPF%GFL (JFLD)%F_P)
          CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_GFL_P_P, YDCPG_SL1%GFL (JFLD)%F_P_P)
      ...
      ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LLCOMAD_2')) THEN
        ...
        CALL SGET_DEVICE_DATA_RDONLY (KL0, YD_KL0)
        CALL SGET_DEVICE_DATA_RDONLY (PLSCAW, YD_PLSCAW)
        CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_GFLPF_GFL_P, YDCPG_GFLPF%GFL (JFLD)%F_P)
        CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_GFL_P_P, YDCPG_SL1%GFL (JFLD)%F_P_P)
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LLCOMAD_2:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LLCOMAD_2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        
        !$OMP TARGET TEAMS DISTRIBUTE  & 
        !$OMP & MAP(PRESENT:KL0, PLSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YFXTRAN_ACDC_STACK,  & 
        !$OMP &          Z_YDCPG_GFLPF_GFL_P, Z_YDCPG_SL1_GFL_P_P)  & 
        !$OMP & PRIVATE (JBLK)  & 
        !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (YDML_DYN%YRDYN%NVLAG==2) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:NVLAG_2')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (KL0, YD_KL0)
    CALL SGET_HOST_DATA_RDONLY (KNOWENO, YD_KNOWENO)
    CALL SGET_HOST_DATA_RDWR (PCF, YD_PCF)
    CALL SGET_HOST_DATA_RDONLY (PLSCAW, YD_PLSCAW)
    CALL SGET_HOST_DATA_RDONLY (PRSCAW, YD_PRSCAW)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_C9_P, YDCPG_SL1%C9%F_P)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:NVLAG_2')) THEN
    ...
    CALL SGET_DEVICE_DATA_RDONLY (KL0, YD_KL0)
    CALL SGET_DEVICE_DATA_RDONLY (KNOWENO, YD_KNOWENO)
    CALL SGET_DEVICE_DATA_RDWR (PCF, YD_PCF)
    CALL SGET_DEVICE_DATA_RDONLY (PLSCAW, YD_PLSCAW)
    CALL SGET_DEVICE_DATA_RDONLY (PRSCAW, YD_PRSCAW)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_C9_P, YDCPG_SL1%C9%F_P)
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:NVLAG_2:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:NVLAG_2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:KL0, KNOWENO, PCF, PLSCAW, PRSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN,  & 
    !$OMP &          YFXTRAN_ACDC_STACK, Z_YDCPG_SL1_C9_P)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (YDML_DYN%YRDYN%NVLAG==3) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:NVLAG_3')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (KL0, YD_KL0)
    CALL SGET_HOST_DATA_RDWR (PCF, YD_PCF)
    CALL SGET_HOST_DATA_RDWR (PCF_NL, YD_PCF_NL)
    CALL SGET_HOST_DATA_RDWR (PCF_SI, YD_PCF_SI)
    CALL SGET_HOST_DATA_RDONLY (PLSCAW, YD_PLSCAW)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_C9_NL_P, YDCPG_SL1%C9_NL%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_C9_P, YDCPG_SL1%C9%F_P)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_C9_SI_P, YDCPG_SL1%C9_SI%F_P)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('LARCINB_PARALLEL:NVLAG_3')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (PCF_SI, YD_PCF_SI)
      CALL SGET_HOST_DATA_RDWR (PLSCAW, YD_PLSCAW)
      CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_C9_NL_P, YDCPG_SL1%C9_NL%F_P)
      CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_C9_P, YDCPG_SL1%C9%F_P)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:NVLAG_3')) THEN
    ...
    CALL SGET_DEVICE_DATA_RDONLY (KL0, YD_KL0)
    CALL SGET_DEVICE_DATA_RDWR (PCF, YD_PCF)
    CALL SGET_DEVICE_DATA_RDWR (PCF_NL, YD_PCF_NL)
    CALL SGET_DEVICE_DATA_RDWR (PCF_SI, YD_PCF_SI)
    CALL SGET_DEVICE_DATA_RDONLY (PLSCAW, YD_PLSCAW)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_C9_NL_P, YDCPG_SL1%C9_NL%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_C9_P, YDCPG_SL1%C9%F_P)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_C9_SI_P, YDCPG_SL1%C9_SI%F_P)
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:NVLAG_3:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:NVLAG_3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:KL0, PCF, PCF_NL, PCF_SI, PLSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN,  & 
    !$OMP &          YFXTRAN_ACDC_STACK, Z_YDCPG_SL1_C9_NL_P, Z_YDCPG_SL1_C9_P,  & 
    !$OMP &          Z_YDCPG_SL1_C9_SI_P)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (YDML_DYN%YRDYNA%NQMGMV==-4) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:NQMGMV')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (KLH0, YD_KLH0)
    CALL SGET_HOST_DATA_RDWR (PDP, YD_PDP)
    CALL SGET_HOST_DATA_RDONLY (PLSCAW, YD_PLSCAW)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL1_SP9_P, YDCPG_SL1%SP9%F_P)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('LARCINB_PARALLEL:NQMGMV')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (KLH0, YD_KLH0)
      CALL SGET_HOST_DATA_RDWR (PDP, YD_PDP)
      CALL SGET_HOST_DATA_RDWR (PLSCAW, YD_PLSCAW)
      CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL1_SP9_P, YDCPG_SL1%SP9%F_P)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:NQMGMV')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:NQMGMV:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDONLY (KLH0, YD_KLH0)
    CALL SGET_DEVICE_DATA_RDWR (PDP, YD_PDP)
    CALL SGET_DEVICE_DATA_RDONLY (PLSCAW, YD_PLSCAW)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL1_SP9_P, YDCPG_SL1%SP9%F_P)
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:NQMGMV:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:NQMGMV:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:KLH0, PDP, PLSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YFXTRAN_ACDC_STACK,  & 
    !$OMP &          Z_YDCPG_SL1_SP9_P)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
ELSE
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LCOMAD_SP')) THEN
    ...
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:KLH0, PDP, PLSCAW, PRSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YFXTRAN_ACDC_STACK,  & 
    !$OMP &          Z_YDCPG_SL1_SP9_P)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
