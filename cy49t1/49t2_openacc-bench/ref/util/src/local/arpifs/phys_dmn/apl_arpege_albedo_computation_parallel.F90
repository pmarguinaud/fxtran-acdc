...
IF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_ALBEDO_COMPUTATION_PARALLEL:0')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_ALBEDO_COMPUTATION_PARALLEL:0')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_ALBEDO_COMPUTATION_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&         YDMODEL, YSTACK, ZMERL, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_OUT_ALB, &
      !$ACC&         Z_YDMF_PHYS_SURF_GSD_VF_PALBF, Z_YDMF_PHYS_SURF_GSD_VF_PEMISF, &
      ...
      !$ACC LOOP VECTOR &
      !$ACC&PRIVATE (JLON, JSG, YLCPG_BNDS, YLSTACK, ZLAMB) 
...
ENDSUBROUTINE APL_ARPEGE_ALBEDO_COMPUTATION_PARALLEL
