...
PROCEDURE :: COPY => COPY_TEAERSRC
PROCEDURE :: CRC64 => CRC64_TEAERSRC
PROCEDURE :: HOST => HOST_TEAERSRC
PROCEDURE :: LOAD => LOAD_TEAERSRC
PROCEDURE :: SAVE => SAVE_TEAERSRC
PROCEDURE :: SIZE => SIZE_TEAERSRC
PROCEDURE :: WIPE => WIPE_TEAERSRC
END TYPE TEAERSRC
!=====================================================================
...
MODULE SUBROUTINE COPY_TEAERSRC (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE WIPE_TEAERSRC (SELF, LDDELETED, LDFIELDAPI)
