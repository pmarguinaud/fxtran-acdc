...
INTERFACE COPY
MODULE PROCEDURE COPY_VARIABLE_4RB
END INTERFACE

INTERFACE HOST
MODULE PROCEDURE HOST_VARIABLE_4RB
END INTERFACE

INTERFACE LEGACY
MODULE PROCEDURE LEGACY_VARIABLE_4RB
END INTERFACE
     
INTERFACE CRC64
MODULE PROCEDURE CRC64_VARIABLE_4RB
END INTERFACE

INTERFACE WIPE
MODULE PROCEDURE WIPE_VARIABLE_4RB
END INTERFACE

INTERFACE SIZE
MODULE PROCEDURE SIZE_VARIABLE_4RB
END INTERFACE
...
SUBROUTINE COPY_VARIABLE_4RB (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE HOST_VARIABLE_4RB (SELF)
USE FIELD_UTIL_MODULE
...
SUBROUTINE LEGACY_VARIABLE_4RB (SELF, KADDRL, KADDRU, KDIR)
USE FIELD_UTIL_MODULE
...
SUBROUTINE CRC64_VARIABLE_4RB (SELF, KLUN, CDPATH)
USE FIELD_UTIL_MODULE
...
SUBROUTINE WIPE_VARIABLE_4RB (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
...
FUNCTION SIZE_VARIABLE_4RB (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
USE FIELD_UTIL_MODULE
