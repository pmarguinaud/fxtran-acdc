...
CONTAINS
PROCEDURE :: COPY => COPY_MF_PHYS_NEXT_STATE_2D_TYPE
PROCEDURE :: WIPE => WIPE_MF_PHYS_NEXT_STATE_2D_TYPE
...
CONTAINS
PROCEDURE :: COPY => COPY_MF_PHYS_NEXT_STATE_3D_TYPE
PROCEDURE :: WIPE => WIPE_MF_PHYS_NEXT_STATE_3D_TYPE
...
PROCEDURE :: COPY => COPY_MF_PHYS_NEXT_STATE_TYPE
PROCEDURE :: WIPE => WIPE_MF_PHYS_NEXT_STATE_TYPE
END TYPE MF_PHYS_NEXT_STATE_TYPE

INTERFACE

MODULE SUBROUTINE COPY_MF_PHYS_NEXT_STATE_2D_TYPE (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE WIPE_MF_PHYS_NEXT_STATE_2D_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (MF_PHYS_NEXT_STATE_2D_TYPE), INTENT (IN), TARGET :: SELF
...
MODULE SUBROUTINE COPY_MF_PHYS_NEXT_STATE_3D_TYPE (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
...
MODULE SUBROUTINE WIPE_MF_PHYS_NEXT_STATE_3D_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (MF_PHYS_NEXT_STATE_3D_TYPE), INTENT (IN), TARGET :: SELF
LOGICAL, OPTIONAL, INTENT (IN) :: LDDELETED, LDFIELDAPI
...
MODULE SUBROUTINE COPY_MF_PHYS_NEXT_STATE_TYPE (SELF, LDCREATED, LDFIELDAPI)
