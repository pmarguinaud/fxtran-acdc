...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TYPE_SURF_GEN
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TYPE_SURF_GEN
PROCEDURE :: ACDC_HOST => ACDC_HOST_TYPE_SURF_GEN
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TYPE_SURF_GEN
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TYPE_SURF_GEN
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TYPE_SURF_GEN
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TYPE_SURF_GEN
