...
CONTAINS
PROCEDURE :: COPY => COPY_TECMIP
PROCEDURE :: CRC64 => CRC64_TECMIP
PROCEDURE :: HOST => HOST_TECMIP
PROCEDURE :: LOAD => LOAD_TECMIP
PROCEDURE :: SAVE => SAVE_TECMIP
PROCEDURE :: SIZE => SIZE_TECMIP
PROCEDURE :: WIPE => WIPE_TECMIP
END TYPE TECMIP

INTERFACE

MODULE SUBROUTINE COPY_TECMIP (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TECMIP (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TECMIP (SELF)

IMPLICIT NONE
CLASS (TECMIP), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TECMIP (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TECMIP (SELF, KLUN)
...
MODULE FUNCTION SIZE_TECMIP (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TECMIP (SELF, LDDELETED, LDFIELDAPI)
