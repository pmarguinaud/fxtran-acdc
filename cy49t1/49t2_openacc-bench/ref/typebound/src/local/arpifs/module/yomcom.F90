...
PROCEDURE :: COPY => COPY_TCOM
PROCEDURE :: CRC64 => CRC64_TCOM
PROCEDURE :: HOST => HOST_TCOM
PROCEDURE :: LOAD => LOAD_TCOM
PROCEDURE :: SAVE => SAVE_TCOM
PROCEDURE :: SIZE => SIZE_TCOM
PROCEDURE :: WIPE => WIPE_TCOM
END TYPE TCOM
!======================================================================
...
MODULE SUBROUTINE CRC64_TCOM (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TCOM (SELF)
...
MODULE SUBROUTINE SAVE_TCOM (SELF, KLUN)
...
MODULE FUNCTION SIZE_TCOM (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TCOM (SELF, LDDELETED, LDFIELDAPI)
