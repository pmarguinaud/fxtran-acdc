...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TXYB
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TXYB
PROCEDURE :: ACDC_HOST => ACDC_HOST_TXYB
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TXYB
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TXYB
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TXYB
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TXYB
END TYPE TXYB
...
INTEGER(KIND=JPIM) :: NDIM          ! total number of fields allocated
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TXYBDER
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TXYBDER
PROCEDURE :: ACDC_HOST => ACDC_HOST_TXYBDER
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TXYBDER
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TXYBDER
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TXYBDER
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TXYBDER
END TYPE TXYBDER
...
INTEGER(KIND=JPIM) :: NDIM          ! total number of fields allocated
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TRCP
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TRCP
PROCEDURE :: ACDC_HOST => ACDC_HOST_TRCP
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TRCP
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TRCP
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TRCP
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TRCP
END TYPE TRCP
...
INTEGER(KIND=JPIM) :: NDIM          ! total number of fields allocated
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TCTY
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TCTY
PROCEDURE :: ACDC_HOST => ACDC_HOST_TCTY
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TCTY
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TCTY
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TCTY
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TCTY
END TYPE TCTY
...
INTEGER(KIND=JPIM) :: NDIM          ! total number of fields allocated
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_THWIND
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_THWIND
PROCEDURE :: ACDC_HOST => ACDC_HOST_THWIND
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_THWIND
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_THWIND
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_THWIND
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_THWIND
END TYPE THWIND
...
INTEGER(KIND=JPIM) :: NDIM          ! total number of fields allocated
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TTND
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TTND
PROCEDURE :: ACDC_HOST => ACDC_HOST_TTND
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TTND
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TTND
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TTND
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TTND
END TYPE TTND
...
INTEGER(KIND=JPIM) :: NDIM     ! total number of fields allocated
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TGMVT
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TGMVT
PROCEDURE :: ACDC_HOST => ACDC_HOST_TGMVT
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TGMVT
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TGMVT
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TGMVT
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TGMVT
END TYPE TGMVT
...
INTEGER(KIND=JPIM) :: NDIM     ! total number of fields allocated
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TGFLT
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TGFLT
PROCEDURE :: ACDC_HOST => ACDC_HOST_TGFLT
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TGFLT
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TGFLT
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TGFLT
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TGFLT
END TYPE TGFLT
...
MODULE SUBROUTINE ACDC_WIPE_TXYB (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE ACDC_COPY_TRCP (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE ACDC_COPY_TCTY (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE ACDC_COPY_THWIND (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE ACDC_WIPE_THWIND (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE ACDC_COPY_TTND (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE ACDC_WIPE_TTND (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE ACDC_COPY_TGMVT (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE ACDC_COPY_TGFLT (SELF, LDCREATED, LDFIELDAPI)
...
MODULE FUNCTION ACDC_SIZE_TGFLT (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE ACDC_WIPE_TGFLT (SELF, LDDELETED, LDFIELDAPI)
