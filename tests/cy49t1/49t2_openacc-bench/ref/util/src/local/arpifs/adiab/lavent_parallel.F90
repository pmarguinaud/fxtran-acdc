...
IF (LPARALLELMETHOD ('OPENMP','LAVENT_PARALLEL:0')) THEN
  ...
  IF (LSYNCHOST ('LAVENT_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAVENT_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAVENT_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('LAVENT_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         YDML_DYN, YDPARAR, YDRIP, YSTACK, ZWRL0, Z_YDCPG_SL1_U9_P, Z_YDCPG_SL1_UF9_P, &
    !$ACC&         Z_YDCPG_SL1_UR00_P, Z_YDCPG_SL1_UR0_P, Z_YDCPG_SL1_UR9_P, &
    !$ACC&         Z_YDCPG_SL1_V9_P, Z_YDCPG_SL1_VF9_P, Z_YDCPG_SL1_VR00_P, &
      ...
      ELSEIF (YDML_DYN%YRDYNA%LTWOTL.AND.(.NOT.YDML_DYN%YRDYNA%LELTRA)) THEN
        ...
        IF (.NOT.LLCT) THEN
          ...
          IF (YDCPG_OPTS%NSTEP<=YDRIP%NFOST.OR.LLNESCV) THEN
            ...
            ELSEIF (LLWSAVE) THEN
              CALL ACPY (JROF, PWRL9 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK)&
              &, Z_YDVARS_EDOT_T9 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK))
            ENDIF
          ...
          CALL ACPY (JROF, Z_YDVARS_EDOT_T9 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG&
          &, JBLK), ZWRL0 (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK))
        ELSE
