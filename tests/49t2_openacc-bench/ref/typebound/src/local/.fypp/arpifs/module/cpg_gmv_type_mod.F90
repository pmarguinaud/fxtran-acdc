...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_CPG_GMV_3D_TYPE
PROCEDURE :: ACDC_HOST => ACDC_HOST_CPG_GMV_3D_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_CPG_GMV_3D_TYPE
...
PROCEDURE :: ACDC_COPY => ACDC_COPY_CPG_GMV_TYPE
PROCEDURE :: ACDC_HOST => ACDC_HOST_CPG_GMV_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_CPG_GMV_TYPE
...
MODULE SUBROUTINE ACDC_HOST_CPG_GMV_3D_TYPE (SELF)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_GMV_3D_TYPE), TARGET :: SELF
END SUBROUTINE
