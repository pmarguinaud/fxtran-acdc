...
PROCEDURE :: COPY => COPY_TSTOPH
PROCEDURE :: CRC64 => CRC64_TSTOPH
PROCEDURE :: HOST => HOST_TSTOPH
PROCEDURE :: LOAD => LOAD_TSTOPH
PROCEDURE :: SAVE => SAVE_TSTOPH
PROCEDURE :: SIZE => SIZE_TSTOPH
PROCEDURE :: WIPE => WIPE_TSTOPH
END TYPE TSTOPH
!============================================================================
...
MODULE SUBROUTINE COPY_TSTOPH (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TSTOPH (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TSTOPH (SELF)

IMPLICIT NONE
CLASS (TSTOPH), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TSTOPH (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TSTOPH (SELF, KLUN)
...
MODULE FUNCTION SIZE_TSTOPH (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TSTOPH (SELF, LDDELETED, LDFIELDAPI)
