...
CONTAINS
PROCEDURE :: COPY => COPY_TCFUPTR
PROCEDURE :: HOST => HOST_TCFUPTR
PROCEDURE :: SIZE => SIZE_TCFUPTR
PROCEDURE :: WIPE => WIPE_TCFUPTR
END TYPE TCFUPTR

INTERFACE

MODULE SUBROUTINE COPY_TCFUPTR (SELF, LDCREATED, LDFIELDAPI)
...
MODULE FUNCTION SIZE_TCFUPTR (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TCFUPTR (SELF, LDDELETED, LDFIELDAPI)
