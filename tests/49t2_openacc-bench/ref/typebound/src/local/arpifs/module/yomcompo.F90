...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TCOMPO_EMIS
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TCOMPO_EMIS
PROCEDURE :: ACDC_HOST => ACDC_HOST_TCOMPO_EMIS
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TCOMPO_EMIS
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TCOMPO_EMIS
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TCOMPO_EMIS
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TCOMPO_EMIS
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TCOMPO_EMIS_AUX
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TCOMPO_EMIS_AUX
PROCEDURE :: ACDC_HOST => ACDC_HOST_TCOMPO_EMIS_AUX
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TCOMPO_EMIS_AUX
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TCOMPO_EMIS_AUX
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TCOMPO_EMIS_AUX
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TCOMPO_EMIS_AUX
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TCOMPO
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TCOMPO
PROCEDURE :: ACDC_HOST => ACDC_HOST_TCOMPO
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TCOMPO
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TCOMPO
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TCOMPO
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TCOMPO
END TYPE TCOMPO 
...
MODULE SUBROUTINE ACDC_WIPE_TCOMPO_EMIS (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE ACDC_COPY_TCOMPO (SELF, LDCREATED, LDFIELDAPI)
