...
CONTAINS
PROCEDURE :: COPY => COPY_TPARAR
PROCEDURE :: CRC64 => CRC64_TPARAR
PROCEDURE :: HOST => HOST_TPARAR
PROCEDURE :: LOAD => LOAD_TPARAR
PROCEDURE :: SAVE => SAVE_TPARAR
PROCEDURE :: SIZE => SIZE_TPARAR
PROCEDURE :: WIPE => WIPE_TPARAR
END TYPE TPARAR
...
MODULE SUBROUTINE COPY_TPARAR (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TPARAR (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TPARAR (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TPARAR (SELF, KLUN)
...
MODULE FUNCTION SIZE_TPARAR (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TPARAR (SELF, LDDELETED, LDFIELDAPI)
