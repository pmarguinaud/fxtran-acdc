...
IF (LYEMIS2D_DESC) THEN
  ...
  DO J1 = LBOUND (SELF%YEMIS2D_DESC, 1), UBOUND (SELF%YEMIS2D_DESC, 1)
    ISIZE = SELF%YEMIS2D_DESC (J1)%SIZE (CLPATH//'%YEMIS2D_DESC', .FALSE.)
    JSIZE = JSIZE + ISIZE
    KSIZE = KSIZE + ISIZE
  ENDDO
  IF (LLPRINT) THEN
...
IF (LYEMIS3D_DESC) THEN
  ...
  DO J1 = LBOUND (SELF%YEMIS3D_DESC, 1), UBOUND (SELF%YEMIS3D_DESC, 1)
    ISIZE = SELF%YEMIS3D_DESC (J1)%SIZE (CLPATH//'%YEMIS3D_DESC', .FALSE.)
    JSIZE = JSIZE + ISIZE
    KSIZE = KSIZE + ISIZE
  ENDDO
  IF (LLPRINT) THEN
...
IF (LYEMIS2DAUX_DESC) THEN
  ...
  DO J1 = LBOUND (SELF%YEMIS2DAUX_DESC, 1), UBOUND (SELF%YEMIS2DAUX_DESC, 1)
    ISIZE = SELF%YEMIS2DAUX_DESC (J1)%SIZE (CLPATH//'%YEMIS2DAUX_DESC', .FALSE.)
    JSIZE = JSIZE + ISIZE
    KSIZE = KSIZE + ISIZE
  ENDDO
  IF (LLPRINT) THEN
