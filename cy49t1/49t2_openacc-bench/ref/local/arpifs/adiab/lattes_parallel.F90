...
IF (LPARALLELMETHOD ('OPENMP','LATTES_PARALLEL:0')) THEN
  ...
  IF (LSYNCHOST ('LATTES_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LATTES_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTES_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('LATTES_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         YDGEOMETRY, YDML_DYN, YDRIP, YSTACK, ZMOY1SP, ZMOYSPNL, ZSPNLT0, &
    !$ACC&         ZSPNLT1, ZSPNLT_FE, ZSPT1, ZSPTB, ZVWEI, Z_YDCPG_SL1_C9_NL_P, Z_YDCPG_SL1_C9_P, &
    !$ACC&         Z_YDCPG_SL1_SP9_P, Z_YDCPG_SL2_SPSI, Z_YDVARS_CSPNL_T9, Z_YDVARS_GEOMETRY_OROG_T0, &
    !$ACC&         Z_YDVARS_SPNL_T9, Z_YDVARS_SP_DL, Z_YDVARS_SP_DM, Z_YDVARS_SP_T0, &
    !$ACC&         Z_YDVARS_SP_T1, Z_YDVARS_SP_T9, Z_YDVARS_U_T0, Z_YDVARS_V_T0) &
    !$ACC&PRIVATE (JBLK) &
