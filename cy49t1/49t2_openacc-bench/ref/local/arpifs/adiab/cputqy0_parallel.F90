...
IF (LDT1) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','CPUTQY0_PARALLEL:PVAR')) THEN
    ...
    IF (LSYNCHOST ('CPUTQY0_PARALLEL:PVAR')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPUTQY0_PARALLEL:PVAR')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPUTQY0_PARALLEL:PVAR')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('CPUTQY0_PARALLEL:PVAR:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&PRESENT (PTND, PVAR, YDCPG_OPTS, YSTACK) &
      !$ACC&PRIVATE (JBLK) &
