...
CONTAINS
PROCEDURE :: COPY => COPY_TNRTAER
PROCEDURE :: CRC64 => CRC64_TNRTAER
PROCEDURE :: HOST => HOST_TNRTAER
PROCEDURE :: LOAD => LOAD_TNRTAER
PROCEDURE :: SAVE => SAVE_TNRTAER
PROCEDURE :: SIZE => SIZE_TNRTAER
PROCEDURE :: WIPE => WIPE_TNRTAER
END TYPE TNRTAER

!     ------------------------------------------------------------------
INTERFACE

MODULE SUBROUTINE COPY_TNRTAER (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TNRTAER (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TNRTAER (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TNRTAER (SELF, KLUN)
...
MODULE FUNCTION SIZE_TNRTAER (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TNRTAER (SELF, LDDELETED, LDFIELDAPI)
