...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_CLOUDINESS_PARALLEL:ACNEBCOND')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (PAIPCMT, YD_PAIPCMT)
  CALL SGET_HOST_DATA_RDWR (PCLCT_RAD, YD_PCLCT_RAD)
  CALL SGET_HOST_DATA_RDONLY (PDECRD, YD_PDECRD)
  CALL SGET_HOST_DATA_RDONLY (PFLU_QSAT, YD_PFLU_QSAT)
  CALL SGET_HOST_DATA_RDONLY (PMSC_QW, YD_PMSC_QW)
  ...
  CALL SGET_HOST_DATA_RDONLY (PQLI_CVP, YD_PQLI_CVP)
  CALL SGET_HOST_DATA_RDONLY (PQLI_CVPP, YD_PQLI_CVPP)
  CALL SGET_HOST_DATA_RDONLY (PQV, YD_PQV)
  CALL SGET_HOST_DATA_RDONLY (PUNEBH, YD_PUNEBH)
  CALL SGET_HOST_DATA_RDWR (ZICEFR1, YL_ZICEFR1)
  CALL SGET_HOST_DATA_RDWR (ZQSATS, YL_ZQSATS)
  CALL SGET_HOST_DATA_RDWR (ZRH, YL_ZRH)
  CALL SGET_HOST_DATA_RDWR (ZRHCRI, YL_ZRHCRI)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_CLOUDINESS_PARALLEL:ACNEBCOND')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (PFLU_QSAT, YD_PFLU_QSAT)
    CALL SGET_HOST_DATA_RDWR (PMSC_QW, YD_PMSC_QW)
    CALL SGET_HOST_DATA_RDWR (PNEBC0, YD_PNEBC0)
    CALL SGET_HOST_DATA_RDWR (PNEBCH, YD_PNEBCH)
    CALL SGET_HOST_DATA_RDWR (PNEBS, YD_PNEBS)
    CALL SGET_HOST_DATA_RDWR (PNEBS0, YD_PNEBS0)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_CLOUDINESS_PARALLEL&
  &:ACNEBCOND:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (PAIPCMT, YD_PAIPCMT)
  CALL SGET_DEVICE_DATA_RDWR (PCLCT_RAD, YD_PCLCT_RAD)
  CALL SGET_DEVICE_DATA_RDONLY (PDECRD, YD_PDECRD)
  CALL SGET_DEVICE_DATA_RDONLY (PFLU_QSAT, YD_PFLU_QSAT)
  CALL SGET_DEVICE_DATA_RDONLY (PMSC_QW, YD_PMSC_QW)
  ...
  CALL SGET_DEVICE_DATA_RDONLY (PQLI_CVP, YD_PQLI_CVP)
  CALL SGET_DEVICE_DATA_RDONLY (PQLI_CVPP, YD_PQLI_CVPP)
  CALL SGET_DEVICE_DATA_RDONLY (PQV, YD_PQV)
  CALL SGET_DEVICE_DATA_RDONLY (PUNEBH, YD_PUNEBH)
  CALL SGET_DEVICE_DATA_RDWR (ZICEFR1, YL_ZICEFR1)
  CALL SGET_DEVICE_DATA_RDWR (ZQSATS, YL_ZQSATS)
  CALL SGET_DEVICE_DATA_RDWR (ZRH, YL_ZRH)
  CALL SGET_DEVICE_DATA_RDWR (ZRHCRI, YL_ZRHCRI)
  ...
  !$OMP & MAP(PRESENT:PAIPCMT, PCLCT_RAD, PDECRD, PFLU_QSAT, PMSC_QW, PNEBC0, PNEBCH, PNEBS,  & 
  !$OMP &          PNEBS0, PNEB_CVPP, PPFL_FPLCH, PQI, PQL, PQLIS, PQLIS0, PQLI_CVP, PQLI_CVPP,  & 
  !$OMP &          PQV, PUNEBH, YDCPG_OPTS, YDMODEL, YDSTA, YFXTRAN_ACDC_STACK, ZICEFR1,  & 
  !$OMP &          ZQSATS, ZRH, ZRHCRI, Z_YDCPG_MISC_CLCT, Z_YDCPG_MISC_NEB, Z_YDCPG_MISC_QICE,  & 
  ...
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_OUT_CLCC,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_CLCH, Z_YDMF_PHYS_OUT_CLCL, Z_YDMF_PHYS_OUT_CLCM,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_CTOP, Z_YDVARS_GEOMETRY_GM_T0)  & 
  !$OMP & PRIVATE (JBLK)  & 
