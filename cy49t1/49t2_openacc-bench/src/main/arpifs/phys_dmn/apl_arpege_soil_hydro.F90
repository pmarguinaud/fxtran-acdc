...
!$ACDC PARALLEL, TARGET=OpenMP/OpenMPSingleColumn/OpenACCSingleColumn,NAME=ACVEG {

  CALL ACVEG ( YDMODEL%YRML_PHY_MF%YRPHY, YDMODEL%YRML_PHY_MF%YRPHY1, KIDIA, KFDIA,                                 &
  & KLON, KFLEVG, YDMF_PHYS%OUT%FRSO, PQV, PFLU_QSAT, YDMF_PHYS_BASE_STATE%T,                                       &
  ...
  & PWWILT, YDMF_PHYS_BASE_STATE%YGSP_SB%Q (:,1), PFLU_QSATS, PHQ, PHTR, PHU, YDMF_PHYS_SURF%GSD_VV%PHV, PWLMX)
