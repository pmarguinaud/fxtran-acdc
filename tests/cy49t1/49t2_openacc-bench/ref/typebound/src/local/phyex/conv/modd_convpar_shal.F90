...
CONTAINS
PROCEDURE :: COPY => COPY_CONVPAR_SHAL
PROCEDURE :: CRC64 => CRC64_CONVPAR_SHAL
PROCEDURE :: HOST => HOST_CONVPAR_SHAL
PROCEDURE :: LOAD => LOAD_CONVPAR_SHAL
PROCEDURE :: SAVE => SAVE_CONVPAR_SHAL
PROCEDURE :: SIZE => SIZE_CONVPAR_SHAL
PROCEDURE :: WIPE => WIPE_CONVPAR_SHAL
...
MODULE SUBROUTINE COPY_CONVPAR_SHAL (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_CONVPAR_SHAL (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_CONVPAR_SHAL (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_CONVPAR_SHAL (SELF, KLUN)
...
MODULE FUNCTION SIZE_CONVPAR_SHAL (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_CONVPAR_SHAL (SELF, LDDELETED, LDFIELDAPI)
