...
CONTAINS
PROCEDURE :: COPY => COPY_TCVER
PROCEDURE :: CRC64 => CRC64_TCVER
PROCEDURE :: HOST => HOST_TCVER
PROCEDURE :: LOAD => LOAD_TCVER
PROCEDURE :: SAVE => SAVE_TCVER
PROCEDURE :: SIZE => SIZE_TCVER
PROCEDURE :: WIPE => WIPE_TCVER
END TYPE TCVER
! =============================================================================

INTERFACE

MODULE SUBROUTINE COPY_TCVER (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TCVER (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TCVER (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TCVER (SELF, KLUN)
...
MODULE FUNCTION SIZE_TCVER (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TCVER (SELF, LDDELETED, LDFIELDAPI)
