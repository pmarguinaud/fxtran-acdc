...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:PREPARE')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (PAERO, YD_PAERO)
  CALL SGET_HOST_DATA_RDONLY (PAPRS, YD_PAPRS)
  CALL SGET_HOST_DATA_RDONLY (PAPRSF, YD_PAPRSF)
  CALL SGET_HOST_DATA_RDONLY (PDELP, YD_PDELP)
  CALL SGET_HOST_DATA_RDONLY (PEMIS, YD_PEMIS)
  CALL SGET_HOST_DATA_RDONLY (PMU0M, YD_PMU0M)
  CALL SGET_HOST_DATA_RDONLY (PNEB, YD_PNEB)
  CALL SGET_HOST_DATA_RDONLY (PQ, YD_PQ)
  CALL SGET_HOST_DATA_RDONLY (PQC11, YD_PQC11)
  CALL SGET_HOST_DATA_RDONLY (PQC12, YD_PQC12)
  CALL SGET_HOST_DATA_RDONLY (PQC22, YD_PQC22)
  CALL SGET_HOST_DATA_RDONLY (PQCH4, YD_PQCH4)
  CALL SGET_HOST_DATA_RDONLY (PQCL4, YD_PQCL4)
  CALL SGET_HOST_DATA_RDONLY (PQCO2, YD_PQCO2)
  CALL SGET_HOST_DATA_RDONLY (PQICE, YD_PQICE)
  CALL SGET_HOST_DATA_RDONLY (PQLIQ, YD_PQLIQ)
  CALL SGET_HOST_DATA_RDONLY (PQN2O, YD_PQN2O)
  CALL SGET_HOST_DATA_RDONLY (PQNO2, YD_PQNO2)
  CALL SGET_HOST_DATA_RDONLY (PQO3, YD_PQO3)
  CALL SGET_HOST_DATA_RDONLY (PQSAT, YD_PQSAT)
  CALL SGET_HOST_DATA_RDONLY (PT, YD_PT)
  CALL SGET_HOST_DATA_RDONLY (PTS, YD_PTS)
  CALL SGET_HOST_DATA_RDWR (ZCCNL, YL_ZCCNL)
  CALL SGET_HOST_DATA_RDWR (ZCCNO, YL_ZCCNO)
  CALL SGET_HOST_DATA_RDWR (ZEMIW, YL_ZEMIW)
  CALL SGET_HOST_DATA_RDWR (ZNBAS, YL_ZNBAS)
  CALL SGET_HOST_DATA_RDWR (ZNTOP, YL_ZNTOP)
  CALL SGET_HOST_DATA_RDWR (ZPAERO, YL_ZPAERO)
  CALL SGET_HOST_DATA_RDWR (ZPQO3, YL_ZPQO3)
  CALL SGET_HOST_DATA_RDWR (ZQ, YL_ZQ)
  CALL SGET_HOST_DATA_RDWR (ZQIWP, YL_ZQIWP)
  CALL SGET_HOST_DATA_RDWR (ZQLWP, YL_ZQLWP)
  CALL SGET_HOST_DATA_RDWR (ZQS, YL_ZQS)
  CALL SGET_HOST_DATA_RDWR (ZRAER, YL_ZRAER)
  CALL SGET_HOST_DATA_RDWR (ZRC11, YL_ZRC11)
  CALL SGET_HOST_DATA_RDWR (ZRC12, YL_ZRC12)
  CALL SGET_HOST_DATA_RDWR (ZRC22, YL_ZRC22)
  CALL SGET_HOST_DATA_RDWR (ZRCH4, YL_ZRCH4)
  CALL SGET_HOST_DATA_RDWR (ZRCL4, YL_ZRCL4)
  CALL SGET_HOST_DATA_RDWR (ZRCLC, YL_ZRCLC)
  CALL SGET_HOST_DATA_RDWR (ZRCO2, YL_ZRCO2)
  CALL SGET_HOST_DATA_RDWR (ZRMU0, YL_ZRMU0)
  CALL SGET_HOST_DATA_RDWR (ZRN2O, YL_ZRN2O)
  CALL SGET_HOST_DATA_RDWR (ZRNO2, YL_ZRNO2)
  CALL SGET_HOST_DATA_RDWR (ZSPECTRALEMISS, YL_ZSPECTRALEMISS)
  CALL SGET_HOST_DATA_RDWR (ZTH, YL_ZTH)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('RECMWF_PARALLEL:PREPARE')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (PAERO, YD_PAERO)
    CALL SGET_HOST_DATA_RDWR (PAPRS, YD_PAPRS)
    CALL SGET_HOST_DATA_RDWR (PAPRSF, YD_PAPRSF)
    CALL SGET_HOST_DATA_RDWR (PDELP, YD_PDELP)
    CALL SGET_HOST_DATA_RDWR (PEMIS, YD_PEMIS)
    CALL SGET_HOST_DATA_RDWR (PMU0M, YD_PMU0M)
    CALL SGET_HOST_DATA_RDWR (PNEB, YD_PNEB)
    CALL SGET_HOST_DATA_RDWR (PQ, YD_PQ)
    CALL SGET_HOST_DATA_RDWR (PQC11, YD_PQC11)
    CALL SGET_HOST_DATA_RDWR (PQC12, YD_PQC12)
    CALL SGET_HOST_DATA_RDWR (PQC22, YD_PQC22)
    CALL SGET_HOST_DATA_RDWR (PQCH4, YD_PQCH4)
    CALL SGET_HOST_DATA_RDWR (PQCL4, YD_PQCL4)
    CALL SGET_HOST_DATA_RDWR (PQCO2, YD_PQCO2)
    CALL SGET_HOST_DATA_RDWR (PQICE, YD_PQICE)
    CALL SGET_HOST_DATA_RDWR (PQLIQ, YD_PQLIQ)
    CALL SGET_HOST_DATA_RDWR (PQN2O, YD_PQN2O)
    CALL SGET_HOST_DATA_RDWR (PQNO2, YD_PQNO2)
    CALL SGET_HOST_DATA_RDWR (PQO3, YD_PQO3)
    CALL SGET_HOST_DATA_RDWR (PQSAT, YD_PQSAT)
    CALL SGET_HOST_DATA_RDWR (PT, YD_PT)
    CALL SGET_HOST_DATA_RDWR (PTS, YD_PTS)
    CALL SGET_HOST_DATA_RDWR (ZCCNL, YL_ZCCNL)
    CALL SGET_HOST_DATA_RDWR (ZCCNO, YL_ZCCNO)
    CALL SGET_HOST_DATA_RDWR (ZEMIW, YL_ZEMIW)
    CALL SGET_HOST_DATA_RDWR (ZNBAS, YL_ZNBAS)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','RECMWF_PARALLEL:PREPARE')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDONLY (PAERO, YD_PAERO)
  CALL SGET_DEVICE_DATA_RDONLY (PAPRS, YD_PAPRS)
  CALL SGET_DEVICE_DATA_RDONLY (PAPRSF, YD_PAPRSF)
  CALL SGET_DEVICE_DATA_RDONLY (PDELP, YD_PDELP)
  CALL SGET_DEVICE_DATA_RDONLY (PEMIS, YD_PEMIS)
  CALL SGET_DEVICE_DATA_RDONLY (PMU0M, YD_PMU0M)
  CALL SGET_DEVICE_DATA_RDONLY (PNEB, YD_PNEB)
  CALL SGET_DEVICE_DATA_RDONLY (PQ, YD_PQ)
  CALL SGET_DEVICE_DATA_RDONLY (PQC11, YD_PQC11)
  CALL SGET_DEVICE_DATA_RDONLY (PQC12, YD_PQC12)
  CALL SGET_DEVICE_DATA_RDONLY (PQC22, YD_PQC22)
  CALL SGET_DEVICE_DATA_RDONLY (PQCH4, YD_PQCH4)
  CALL SGET_DEVICE_DATA_RDONLY (PQCL4, YD_PQCL4)
  CALL SGET_DEVICE_DATA_RDONLY (PQCO2, YD_PQCO2)
  CALL SGET_DEVICE_DATA_RDONLY (PQICE, YD_PQICE)
  CALL SGET_DEVICE_DATA_RDONLY (PQLIQ, YD_PQLIQ)
  CALL SGET_DEVICE_DATA_RDONLY (PQN2O, YD_PQN2O)
  CALL SGET_DEVICE_DATA_RDONLY (PQNO2, YD_PQNO2)
  CALL SGET_DEVICE_DATA_RDONLY (PQO3, YD_PQO3)
  CALL SGET_DEVICE_DATA_RDONLY (PQSAT, YD_PQSAT)
  CALL SGET_DEVICE_DATA_RDONLY (PT, YD_PT)
  CALL SGET_DEVICE_DATA_RDONLY (PTS, YD_PTS)
  CALL SGET_DEVICE_DATA_RDWR (ZCCNL, YL_ZCCNL)
  CALL SGET_DEVICE_DATA_RDWR (ZCCNO, YL_ZCCNO)
  CALL SGET_DEVICE_DATA_RDWR (ZEMIW, YL_ZEMIW)
  CALL SGET_DEVICE_DATA_RDWR (ZNBAS, YL_ZNBAS)
  CALL SGET_DEVICE_DATA_RDWR (ZNTOP, YL_ZNTOP)
  CALL SGET_DEVICE_DATA_RDWR (ZPAERO, YL_ZPAERO)
  CALL SGET_DEVICE_DATA_RDWR (ZPQO3, YL_ZPQO3)
  CALL SGET_DEVICE_DATA_RDWR (ZQ, YL_ZQ)
  CALL SGET_DEVICE_DATA_RDWR (ZQIWP, YL_ZQIWP)
  CALL SGET_DEVICE_DATA_RDWR (ZQLWP, YL_ZQLWP)
  CALL SGET_DEVICE_DATA_RDWR (ZQS, YL_ZQS)
  CALL SGET_DEVICE_DATA_RDWR (ZRAER, YL_ZRAER)
  CALL SGET_DEVICE_DATA_RDWR (ZRC11, YL_ZRC11)
  CALL SGET_DEVICE_DATA_RDWR (ZRC12, YL_ZRC12)
  CALL SGET_DEVICE_DATA_RDWR (ZRC22, YL_ZRC22)
  CALL SGET_DEVICE_DATA_RDWR (ZRCH4, YL_ZRCH4)
  CALL SGET_DEVICE_DATA_RDWR (ZRCL4, YL_ZRCL4)
  CALL SGET_DEVICE_DATA_RDWR (ZRCLC, YL_ZRCLC)
  CALL SGET_DEVICE_DATA_RDWR (ZRCO2, YL_ZRCO2)
  CALL SGET_DEVICE_DATA_RDWR (ZRMU0, YL_ZRMU0)
  CALL SGET_DEVICE_DATA_RDWR (ZRN2O, YL_ZRN2O)
  CALL SGET_DEVICE_DATA_RDWR (ZRNO2, YL_ZRNO2)
  CALL SGET_DEVICE_DATA_RDWR (ZSPECTRALEMISS, YL_ZSPECTRALEMISS)
  CALL SGET_DEVICE_DATA_RDWR (ZTH, YL_ZTH)
  IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:PREPARE:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:PREPARE:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:PAER, PAERO, PAPRS, PAPRSF, PDELP, PEMIS, PMU0M, PNEB, PQ, PQC11, PQC12,  & 
  !$OMP &          PQC22, PQCH4, PQCL4, PQCO2, PQICE, PQLIQ, PQN2O, PQNO2, PQO3, PQSAT, PT,  & 
  !$OMP &          PTS, YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZCCNL, ZCCNO, ZEMIW,  & 
  !$OMP &          ZNBAS, ZNTOP, ZPAERO, ZPQO3, ZQ, ZQIWP, ZQLWP, ZQS, ZRAER, ZRC11, ZRC12,  & 
  !$OMP &          ZRC22, ZRCH4, ZRCL4, ZRCLC, ZRCO2, ZRMU0, ZRN2O, ZRNO2, ZSPECTRALEMISS,  & 
  !$OMP &          ZTH)  & 
  !$OMP & PRIVATE (JBLK)  & 
  ...
  DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
    ...
    !$OMP & PRIVATE (JEMIS, JLEV, JLON, YLCPG_BNDS, ZFRAC)       
...
ELSE
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:1')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZRSWINHF, YL_ZRSWINHF)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','RECMWF_PARALLEL:1')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:1:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDWR (ZRSWINHF, YL_ZRSWINHF)
    IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:1:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZRSWINHF)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
ELSE
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:2')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZRLWINHF, YL_ZRLWINHF)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','RECMWF_PARALLEL:2')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:2:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDWR (ZRLWINHF, YL_ZRLWINHF)
    IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:2:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZRLWINHF)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (YDMODEL%YRML_PHY_RAD%YRERAD%LSRTM.AND.YDMODEL%YRML_PHY_RAD%YRERAD%LUSEPRE2017RAD) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:SRTM')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (PDELP, YD_PDELP)
    CALL SGET_HOST_DATA_RDONLY (PEMIS, YD_PEMIS)
    CALL SGET_HOST_DATA_RDONLY (PGELAM, YD_PGELAM)
    CALL SGET_HOST_DATA_RDONLY (PGEMU, YD_PGEMU)
    CALL SGET_HOST_DATA_RDONLY (PLSM, YD_PLSM)
    CALL SGET_HOST_DATA_RDWR (PLWFT, YD_PLWFT)
    CALL SGET_HOST_DATA_RDONLY (PNEB, YD_PNEB)
    CALL SGET_HOST_DATA_RDONLY (PRR, YD_PRR)
    CALL SGET_HOST_DATA_RDONLY (PS, YD_PS)
    CALL SGET_HOST_DATA_RDWR (PSWFT, YD_PSWFT)
    CALL SGET_HOST_DATA_RDONLY (PT, YD_PT)
    CALL SGET_HOST_DATA_RDONLY (PTS, YD_PTS)
    CALL SGET_HOST_DATA_RDONLY (ZCCNL, YL_ZCCNL)
    CALL SGET_HOST_DATA_RDONLY (ZCCNO, YL_ZCCNO)
    CALL SGET_HOST_DATA_RDWR (ZEMIT, YL_ZEMIT)
    CALL SGET_HOST_DATA_RDONLY (ZEMIW, YL_ZEMIW)
    CALL SGET_HOST_DATA_RDWR (ZFCS, YL_ZFCS)
    CALL SGET_HOST_DATA_RDWR (ZFCT, YL_ZFCT)
    CALL SGET_HOST_DATA_RDWR (ZFRSOD, YL_ZFRSOD)
    CALL SGET_HOST_DATA_RDWR (ZFRTED, YL_ZFRTED)
    CALL SGET_HOST_DATA_RDWR (ZLWDERIVATIVE, YL_ZLWDERIVATIVE)
    CALL SGET_HOST_DATA_RDONLY (ZPAERO, YL_ZPAERO)
    CALL SGET_HOST_DATA_RDWR (ZPARCF, YL_ZPARCF)
    CALL SGET_HOST_DATA_RDWR (ZPARF, YL_ZPARF)
    CALL SGET_HOST_DATA_RDWR (ZPCDIR, YL_ZPCDIR)
    CALL SGET_HOST_DATA_RDWR (ZPFDIF, YL_ZPFDIF)
    CALL SGET_HOST_DATA_RDWR (ZPFDIR, YL_ZPFDIR)
    CALL SGET_HOST_DATA_RDWR (ZPFRSODC, YL_ZPFRSODC)
    CALL SGET_HOST_DATA_RDWR (ZPFRTEDC, YL_ZPFRTEDC)
    CALL SGET_HOST_DATA_RDONLY (ZPQO3, YL_ZPQO3)
    CALL SGET_HOST_DATA_RDONLY (ZQ, YL_ZQ)
    CALL SGET_HOST_DATA_RDONLY (ZQIWP, YL_ZQIWP)
    CALL SGET_HOST_DATA_RDONLY (ZQLWP, YL_ZQLWP)
    CALL SGET_HOST_DATA_RDONLY (ZRAER, YL_ZRAER)
    CALL SGET_HOST_DATA_RDONLY (ZRC11, YL_ZRC11)
    CALL SGET_HOST_DATA_RDONLY (ZRC12, YL_ZRC12)
    CALL SGET_HOST_DATA_RDONLY (ZRC22, YL_ZRC22)
    CALL SGET_HOST_DATA_RDONLY (ZRCH4, YL_ZRCH4)
    CALL SGET_HOST_DATA_RDONLY (ZRCL4, YL_ZRCL4)
    CALL SGET_HOST_DATA_RDONLY (ZRCO2, YL_ZRCO2)
    CALL SGET_HOST_DATA_RDONLY (ZRMU0, YL_ZRMU0)
    CALL SGET_HOST_DATA_RDONLY (ZRN2O, YL_ZRN2O)
    CALL SGET_HOST_DATA_RDONLY (ZRNO2, YL_ZRNO2)
    CALL SGET_HOST_DATA_RDWR (ZSUDU, YL_ZSUDU)
    CALL SGET_HOST_DATA_RDWR (ZSWDIFFUSEBAND, YL_ZSWDIFFUSEBAND)
    CALL SGET_HOST_DATA_RDWR (ZSWDIRECTBAND, YL_ZSWDIRECTBAND)
    CALL SGET_HOST_DATA_RDONLY (ZTH, YL_ZTH)
    CALL SGET_HOST_DATA_RDWR (ZTINCF, YL_ZTINCF)
    CALL SGET_HOST_DATA_RDWR (ZUVDF, YL_ZUVDF)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('RECMWF_PARALLEL:SRTM')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (PDELP, YD_PDELP)
      CALL SGET_HOST_DATA_RDWR (PEMIS, YD_PEMIS)
      CALL SGET_HOST_DATA_RDWR (PGELAM, YD_PGELAM)
      CALL SGET_HOST_DATA_RDWR (PGEMU, YD_PGEMU)
      CALL SGET_HOST_DATA_RDWR (PLSM, YD_PLSM)
      CALL SGET_HOST_DATA_RDWR (PLWFT, YD_PLWFT)
      CALL SGET_HOST_DATA_RDWR (PNEB, YD_PNEB)
      CALL SGET_HOST_DATA_RDWR (PRR, YD_PRR)
      CALL SGET_HOST_DATA_RDWR (PS, YD_PS)
      CALL SGET_HOST_DATA_RDWR (PSWFT, YD_PSWFT)
      CALL SGET_HOST_DATA_RDWR (PT, YD_PT)
      CALL SGET_HOST_DATA_RDWR (PTS, YD_PTS)
      CALL SGET_HOST_DATA_RDWR (ZCCNL, YL_ZCCNL)
...
ELSEIF (YDMODEL%YRML_PHY_RAD%YRERAD%LRRTM.AND..NOT.YDMODEL%YRML_PHY_RAD&
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:RRTM')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (PAERINDS, YD_PAERINDS)
    CALL SGET_HOST_DATA_RDONLY (PALBD, YD_PALBD)
    CALL SGET_HOST_DATA_RDONLY (PALBP, YD_PALBP)
    CALL SGET_HOST_DATA_RDONLY (PAPRS, YD_PAPRS)
    CALL SGET_HOST_DATA_RDONLY (PAPRSF, YD_PAPRSF)
    CALL SGET_HOST_DATA_RDONLY (PCGA_DST, YD_PCGA_DST)
    CALL SGET_HOST_DATA_RDONLY (PDELP, YD_PDELP)
    CALL SGET_HOST_DATA_RDONLY (PEMIS, YD_PEMIS)
    CALL SGET_HOST_DATA_RDWR (PFSDNN, YD_PFSDNN)
    CALL SGET_HOST_DATA_RDWR (PFSDNV, YD_PFSDNV)
    CALL SGET_HOST_DATA_RDONLY (PLSM, YD_PLSM)
    CALL SGET_HOST_DATA_RDWR (PLWFT, YD_PLWFT)
    CALL SGET_HOST_DATA_RDONLY (PPIZA_DST, YD_PPIZA_DST)
    CALL SGET_HOST_DATA_RDWR (PSFSWDIF, YD_PSFSWDIF)
    CALL SGET_HOST_DATA_RDWR (PSFSWDIR, YD_PSFSWDIR)
    CALL SGET_HOST_DATA_RDWR (PSWFT, YD_PSWFT)
    CALL SGET_HOST_DATA_RDONLY (PT, YD_PT)
    CALL SGET_HOST_DATA_RDONLY (PTAUREL_DST, YD_PTAUREL_DST)
    CALL SGET_HOST_DATA_RDONLY (PTS, YD_PTS)
    CALL SGET_HOST_DATA_RDONLY (ZCCNL, YL_ZCCNL)
    CALL SGET_HOST_DATA_RDONLY (ZCCNO, YL_ZCCNO)
    CALL SGET_HOST_DATA_RDONLY (ZCLDROP, YL_ZCLDROP)
    CALL SGET_HOST_DATA_RDWR (ZEMIT, YL_ZEMIT)
    CALL SGET_HOST_DATA_RDONLY (ZEMIW, YL_ZEMIW)
    CALL SGET_HOST_DATA_RDWR (ZFCS, YL_ZFCS)
    CALL SGET_HOST_DATA_RDWR (ZFCT, YL_ZFCT)
    CALL SGET_HOST_DATA_RDWR (ZFRSOD, YL_ZFRSOD)
    CALL SGET_HOST_DATA_RDONLY (ZNBAS, YL_ZNBAS)
    CALL SGET_HOST_DATA_RDONLY (ZNTOP, YL_ZNTOP)
    CALL SGET_HOST_DATA_RDWR (ZPARCF, YL_ZPARCF)
    CALL SGET_HOST_DATA_RDWR (ZPARF, YL_ZPARF)
    CALL SGET_HOST_DATA_RDONLY (ZPQO3, YL_ZPQO3)
    CALL SGET_HOST_DATA_RDONLY (ZQ, YL_ZQ)
    ...
    CALL SGET_HOST_DATA_RDONLY (ZRAER, YL_ZRAER)
    CALL SGET_HOST_DATA_RDONLY (ZRCLC, YL_ZRCLC)
    CALL SGET_HOST_DATA_RDONLY (ZRLWINHF, YL_ZRLWINHF)
    CALL SGET_HOST_DATA_RDONLY (ZRMU0, YL_ZRMU0)
    CALL SGET_HOST_DATA_RDONLY (ZRSWINHF, YL_ZRSWINHF)
    CALL SGET_HOST_DATA_RDWR (ZSUDU, YL_ZSUDU)
    CALL SGET_HOST_DATA_RDONLY (ZTH, YL_ZTH)
    CALL SGET_HOST_DATA_RDWR (ZTINCF, YL_ZTINCF)
    CALL SGET_HOST_DATA_RDWR (ZUVDF, YL_ZUVDF)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('RECMWF_PARALLEL:RRTM')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (PAPRS, YD_PAPRS)
      CALL SGET_HOST_DATA_RDWR (PAPRSF, YD_PAPRSF)
      CALL SGET_HOST_DATA_RDWR (PCGA_DST, YD_PCGA_DST)
      CALL SGET_HOST_DATA_RDWR (PDELP, YD_PDELP)
      CALL SGET_HOST_DATA_RDWR (PEMIS, YD_PEMIS)
      CALL SGET_HOST_DATA_RDWR (PFSDNN, YD_PFSDNN)
      CALL SGET_HOST_DATA_RDWR (PFSDNV, YD_PFSDNV)
      CALL SGET_HOST_DATA_RDWR (PLSM, YD_PLSM)
      CALL SGET_HOST_DATA_RDWR (PLWFT, YD_PLWFT)
      CALL SGET_HOST_DATA_RDWR (PPIZA_DST, YD_PPIZA_DST)
      CALL SGET_HOST_DATA_RDWR (PSFSWDIF, YD_PSFSWDIF)
      CALL SGET_HOST_DATA_RDWR (PSFSWDIR, YD_PSFSWDIR)
      CALL SGET_HOST_DATA_RDWR (PSWFT, YD_PSWFT)
      CALL SGET_HOST_DATA_RDWR (PT, YD_PT)
      CALL SGET_HOST_DATA_RDWR (PTAUREL_DST, YD_PTAUREL_DST)
      CALL SGET_HOST_DATA_RDWR (PTS, YD_PTS)
      CALL SGET_HOST_DATA_RDWR (ZCCNL, YL_ZCCNL)
      CALL SGET_HOST_DATA_RDWR (ZCCNO, YL_ZCCNO)
      CALL SGET_HOST_DATA_RDWR (ZCLDROP, YL_ZCLDROP)
      CALL SGET_HOST_DATA_RDWR (ZEMIT, YL_ZEMIT)
      CALL SGET_HOST_DATA_RDWR (ZEMIW, YL_ZEMIW)
      CALL SGET_HOST_DATA_RDWR (ZFCS, YL_ZFCS)
      CALL SGET_HOST_DATA_RDWR (ZFCT, YL_ZFCT)
...
ELSEIF (.NOT.YDMODEL%YRML_PHY_RAD%YRERAD%LUSEPRE2017RAD) THEN
  ...
  IF (YDMODEL%YRML_PHY_RAD%YRERAD%CECRADARCH=='CPU') THEN
    ...
    IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:ECRAD_CPU')) THEN
      ...
      CALL SGET_HOST_DATA_RDONLY (PAEROCPL, YD_PAEROCPL)
      CALL SGET_HOST_DATA_RDONLY (PALBD, YD_PALBD)
      CALL SGET_HOST_DATA_RDONLY (PALBP, YD_PALBP)
      CALL SGET_HOST_DATA_RDONLY (PAPRS, YD_PAPRS)
      CALL SGET_HOST_DATA_RDONLY (PAPRSF, YD_PAPRSF)
      ...
      CALL SGET_HOST_DATA_RDWR (ZFCS, YL_ZFCS)
      CALL SGET_HOST_DATA_RDWR (ZFCT, YL_ZFCT)
      CALL SGET_HOST_DATA_RDWR (ZFLUX_PAR, YL_ZFLUX_PAR)
      CALL SGET_HOST_DATA_RDWR (ZFLUX_PAR_CLEAR, YL_ZFLUX_PAR_CLEAR)
      CALL SGET_HOST_DATA_RDWR (ZFLUX_UV, YL_ZFLUX_UV)
      CALL SGET_HOST_DATA_RDWR (ZFRSOD, YL_ZFRSOD)
      CALL SGET_HOST_DATA_RDWR (ZFRTED, YL_ZFRTED)
      CALL SGET_HOST_DATA_RDWR (ZLWDERIVATIVE, YL_ZLWDERIVATIVE)
      CALL SGET_HOST_DATA_RDONLY (ZPAERO, YL_ZPAERO)
      ...
      CALL SGET_HOST_DATA_RDONLY (ZRN2O, YL_ZRN2O)
      CALL SGET_HOST_DATA_RDONLY (ZRNO2, YL_ZRNO2)
      CALL SGET_HOST_DATA_RDONLY (ZSPECTRALEMISS, YL_ZSPECTRALEMISS)
      CALL SGET_HOST_DATA_RDWR (ZSUDU, YL_ZSUDU)
      CALL SGET_HOST_DATA_RDWR (ZSWDIFFUSEBAND, YL_ZSWDIFFUSEBAND)
      CALL SGET_HOST_DATA_RDWR (ZSWDIRECTBAND, YL_ZSWDIRECTBAND)
      CALL SGET_HOST_DATA_RDONLY (ZTH, YL_ZTH)
      ...
      IF (FXTRAN_ACDC_LSYNCHOST ('RECMWF_PARALLEL:ECRAD_CPU')) THEN
        ...
        CALL SGET_HOST_DATA_RDWR (PAEROCPL, YD_PAEROCPL)
        CALL SGET_HOST_DATA_RDWR (PALBD, YD_PALBD)
        CALL SGET_HOST_DATA_RDWR (PALBP, YD_PALBP)
        CALL SGET_HOST_DATA_RDWR (PAPRS, YD_PAPRS)
        CALL SGET_HOST_DATA_RDWR (PAPRSF, YD_PAPRSF)
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:ECRAD_POST')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (ZFRSOD, YL_ZFRSOD)
    CALL SGET_HOST_DATA_RDWR (ZPFDIF, YL_ZPFDIF)
    CALL SGET_HOST_DATA_RDONLY (ZPFDIR, YL_ZPFDIR)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','RECMWF_PARALLEL:ECRAD_POST')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:ECRAD_POST:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDONLY (ZFRSOD, YL_ZFRSOD)
    CALL SGET_DEVICE_DATA_RDWR (ZPFDIF, YL_ZPFDIF)
    CALL SGET_DEVICE_DATA_RDONLY (ZPFDIR, YL_ZPFDIR)
    IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:ECRAD_POST:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:ECRAD_POST:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YFXTRAN_ACDC_STACK, ZFRSOD, ZPFDIF, ZPFDIR)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:FINISH')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (PAER, YD_PAER)
  CALL SGET_HOST_DATA_RDONLY (PALB, YD_PALB)
  CALL SGET_HOST_DATA_RDONLY (PALBD, YD_PALBD)
  CALL SGET_HOST_DATA_RDONLY (PALBP, YD_PALBP)
  CALL SGET_HOST_DATA_RDONLY (PAPRS, YD_PAPRS)
  CALL SGET_HOST_DATA_RDONLY (PAPRSF, YD_PAPRSF)
  ...
  CALL SGET_HOST_DATA_RDONLY (PDELP, YD_PDELP)
  CALL SGET_HOST_DATA_RDWR (PEMTD, YD_PEMTD)
  CALL SGET_HOST_DATA_RDWR (PEMTU, YD_PEMTU)
  CALL SGET_HOST_DATA_RDONLY (PFSDNN, YD_PFSDNN)
  CALL SGET_HOST_DATA_RDONLY (PFSDNV, YD_PFSDNV)
  CALL SGET_HOST_DATA_RDWR (PLWFC, YD_PLWFC)
  CALL SGET_HOST_DATA_RDONLY (PLWFT, YD_PLWFT)
  CALL SGET_HOST_DATA_RDONLY (PMU0LU, YD_PMU0LU)
  CALL SGET_HOST_DATA_RDONLY (PMU0M, YD_PMU0M)
  CALL SGET_HOST_DATA_RDONLY (PNEB, YD_PNEB)
  CALL SGET_HOST_DATA_RDONLY (PQ, YD_PQ)
  CALL SGET_HOST_DATA_RDONLY (PQICE, YD_PQICE)
  ...
  CALL SGET_HOST_DATA_RDWR (PSFSWDIF, YD_PSFSWDIF)
  CALL SGET_HOST_DATA_RDWR (PSFSWDIR, YD_PSFSWDIR)
  CALL SGET_HOST_DATA_RDWR (PSWDIF, YD_PSWDIF)
  CALL SGET_HOST_DATA_RDWR (PSWDIR, YD_PSWDIR)
  CALL SGET_HOST_DATA_RDWR (PSWFC, YD_PSWFC)
  CALL SGET_HOST_DATA_RDONLY (PSWFT, YD_PSWFT)
  CALL SGET_HOST_DATA_RDONLY (PT, YD_PT)
  CALL SGET_HOST_DATA_RDWR (PTRSO, YD_PTRSO)
  ...
  CALL SGET_HOST_DATA_RDWR (PVRMOON, YD_PVRMOON)
  CALL SGET_HOST_DATA_RDONLY (ZFCS, YL_ZFCS)
  CALL SGET_HOST_DATA_RDONLY (ZFCT, YL_ZFCT)
  CALL SGET_HOST_DATA_RDONLY (ZFRSOD, YL_ZFRSOD)
  CALL SGET_HOST_DATA_RDONLY (ZPFDIF, YL_ZPFDIF)
  CALL SGET_HOST_DATA_RDONLY (ZPFDIR, YL_ZPFDIR)
  CALL SGET_HOST_DATA_RDONLY (ZRCO2, YL_ZRCO2)
  CALL SGET_HOST_DATA_RDWR (ZRMU0, YL_ZRMU0)
  CALL SGET_HOST_DATA_RDONLY (ZSWDIFFUSEBAND, YL_ZSWDIFFUSEBAND)
  CALL SGET_HOST_DATA_RDONLY (ZSWDIRECTBAND, YL_ZSWDIRECTBAND)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('RECMWF_PARALLEL:FINISH')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (PAER, YD_PAER)
    CALL SGET_HOST_DATA_RDWR (PALB, YD_PALB)
    CALL SGET_HOST_DATA_RDWR (PALBD, YD_PALBD)
    CALL SGET_HOST_DATA_RDWR (PALBP, YD_PALBP)
    CALL SGET_HOST_DATA_RDWR (PAPRS, YD_PAPRS)
    CALL SGET_HOST_DATA_RDWR (PAPRSF, YD_PAPRSF)
    ...
    CALL SGET_HOST_DATA_RDWR (PLWFC, YD_PLWFC)
    CALL SGET_HOST_DATA_RDWR (PLWFT, YD_PLWFT)
    CALL SGET_HOST_DATA_RDWR (PMU0LU, YD_PMU0LU)
    CALL SGET_HOST_DATA_RDWR (PMU0M, YD_PMU0M)
    CALL SGET_HOST_DATA_RDWR (PNEB, YD_PNEB)
    CALL SGET_HOST_DATA_RDWR (PQ, YD_PQ)
    CALL SGET_HOST_DATA_RDWR (PQICE, YD_PQICE)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','RECMWF_PARALLEL:FINISH')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:FINISH:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (PAER, YD_PAER)
  CALL SGET_DEVICE_DATA_RDONLY (PALB, YD_PALB)
  ...
  CALL SGET_DEVICE_DATA_RDONLY (PDELP, YD_PDELP)
  CALL SGET_DEVICE_DATA_RDWR (PEMTD, YD_PEMTD)
  CALL SGET_DEVICE_DATA_RDWR (PEMTU, YD_PEMTU)
  CALL SGET_DEVICE_DATA_RDONLY (PFSDNN, YD_PFSDNN)
  CALL SGET_DEVICE_DATA_RDONLY (PFSDNV, YD_PFSDNV)
  CALL SGET_DEVICE_DATA_RDWR (PLWFC, YD_PLWFC)
  CALL SGET_DEVICE_DATA_RDONLY (PLWFT, YD_PLWFT)
  CALL SGET_DEVICE_DATA_RDONLY (PMU0LU, YD_PMU0LU)
  CALL SGET_DEVICE_DATA_RDONLY (PMU0M, YD_PMU0M)
  CALL SGET_DEVICE_DATA_RDONLY (PNEB, YD_PNEB)
  CALL SGET_DEVICE_DATA_RDONLY (PQ, YD_PQ)
  CALL SGET_DEVICE_DATA_RDONLY (PQICE, YD_PQICE)
  ...
  CALL SGET_DEVICE_DATA_RDWR (PSWDIF, YD_PSWDIF)
  CALL SGET_DEVICE_DATA_RDWR (PSWDIR, YD_PSWDIR)
  CALL SGET_DEVICE_DATA_RDWR (PSWFC, YD_PSWFC)
  CALL SGET_DEVICE_DATA_RDONLY (PSWFT, YD_PSWFT)
  CALL SGET_DEVICE_DATA_RDONLY (PT, YD_PT)
  CALL SGET_DEVICE_DATA_RDWR (PTRSO, YD_PTRSO)
  ...
  CALL SGET_DEVICE_DATA_RDWR (PVRMOON, YD_PVRMOON)
  CALL SGET_DEVICE_DATA_RDONLY (ZFCS, YL_ZFCS)
  CALL SGET_DEVICE_DATA_RDONLY (ZFCT, YL_ZFCT)
  CALL SGET_DEVICE_DATA_RDONLY (ZFRSOD, YL_ZFRSOD)
  CALL SGET_DEVICE_DATA_RDONLY (ZPFDIF, YL_ZPFDIF)
  CALL SGET_DEVICE_DATA_RDONLY (ZPFDIR, YL_ZPFDIR)
  CALL SGET_DEVICE_DATA_RDONLY (ZRCO2, YL_ZRCO2)
  CALL SGET_DEVICE_DATA_RDWR (ZRMU0, YL_ZRMU0)
  CALL SGET_DEVICE_DATA_RDONLY (ZSWDIFFUSEBAND, YL_ZSWDIFFUSEBAND)
  CALL SGET_DEVICE_DATA_RDONLY (ZSWDIRECTBAND, YL_ZSWDIRECTBAND)
  IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:FINISH:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:FINISH:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:PAER, PALB, PALBD, PALBP, PAPRS, PAPRSF, PCEMTR, PCTRSO, PDELP, PEMTD,  & 
  !$OMP &          PEMTU, PFSDNN, PFSDNV, PLWFC, PLWFT, PMU0LU, PMU0M, PNEB, PQ, PQICE, PQLIQ,  & 
  !$OMP &          PQO3, PSFSWDIF, PSFSWDIR, PSWDIF, PSWDIR, PSWFC, PSWFT, PT, PTRSO, PTRSOD,  & 
  !$OMP &          PTRSODIF, PTRSODIR, PVRMOON, YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK,  & 
  !$OMP &          ZFCS, ZFCT, ZFRSOD, ZPFDIF, ZPFDIR, ZRCO2, ZRMU0, ZSWDIFFUSEBAND, ZSWDIRECTBAND)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
  ...
  DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
    ...
    !$OMP PARALLEL DO SIMD  & 
    !$OMP & PRIVATE (JLEV, JLON, JSW, YLCPG_BNDS, YLSTACK, ZSW)       
