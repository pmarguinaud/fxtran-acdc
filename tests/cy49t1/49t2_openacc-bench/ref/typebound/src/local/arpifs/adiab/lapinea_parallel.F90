...
IF (LPARALLELMETHOD ('OPENMP','LAPINEA_PARALLEL:LARCINA')) THEN
  ...
  IF (LSYNCHOST ('LAPINEA_PARALLEL:LARCINA')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LAPINEA_PARALLEL:LARCINA')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEA_PARALLEL:LARCINA')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('LAPINEA_PARALLEL:LARCINA:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&PRESENT (IDEP, ILEV, YDCPG_OPTS, YDGEOMETRY, YDMODEL, YDSL, YSTACK, ZLEV, Z_YDA_KL0_P, &
    !$ACC&         Z_YDA_KLH0_P, Z_YDA_KNOWENO_P, Z_YDA_KVSEPC_P, Z_YDA_KVSEPL_P, &
    !$ACC&         Z_YDA_PCCO_P, Z_YDA_PLSCAW_P, Z_YDA_PRSCAW_P, Z_YDA_PSCO_P, &
    !$ACC&         Z_YDCPG_SL2_KAPPA, Z_YDCPG_SL2_KAPPAH, Z_YDCPG_SL2_KAPPAM, &
...
ENDSUBROUTINE LAPINEA_PARALLEL
