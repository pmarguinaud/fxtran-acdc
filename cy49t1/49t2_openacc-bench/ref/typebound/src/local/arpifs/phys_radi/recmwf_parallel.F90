...
IF (LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:PREPARE')) THEN
  ...
  IF (LSYNCHOST ('RECMWF_PARALLEL:PREPARE')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','RECMWF_PARALLEL:PREPARE')) THEN
  ...
  !$OMP PARALLEL DO PRIVATE (JBLK, JEMIS, JLEV, JLON, YLCPG_BNDS, YLSTACK, ZFRAC)
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','RECMWF_PARALLEL:PREPARE')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:PREPARE:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PTS, YDCPG_OPTS, YDMODEL, YSTACK, ZCCNL, ZCCNO, ZEMIW, ZNBAS, ZNTOP, &
    !$ACC&         ZPAERO, ZPQO3, ZQ, ZQIWP, ZQLWP, ZQS, ZRAER, ZRC11, ZRC12, ZRC22, ZRCH4, &
    !$ACC&         ZRCL4, ZRCLC, ZRCO2, ZRMU0, ZRN2O, ZRNO2, ZSPECTRALEMISS, ZTH) &
    !$ACC&PRIVATE (JBLK) &
    ...
    !$ACC LOOP VECTOR &
    !$ACC&PRIVATE (JEMIS, JLEV, JLON, YLCPG_BNDS, YLSTACK, ZFRAC) 
    ...
    DO JLON = 1, MIN (YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1) * YDCPG_OPTS%KLON)
      ...
      YLSTACK%U4 = stack_u4 (YSTACK, JBLK-YDCPG_OPTS%JBLKMIN+1, YDCPG_OPTS%KGPBLKS)
        ...
        IF (KOZOCL==4.OR.KOZOCL==5.OR.KOZOCL==6) THEN
          CALL ACPY (JLON, ZRCH4 (:,:, JBLK), PQCH4 (:,:, JBLK))
          CALL ACPY (JLON, ZRN2O (:,:, JBLK), PQN2O (:,:, JBLK))
          CALL ACPY (JLON, ZRNO2 (:,:, JBLK), PQNO2 (:,:, JBLK))
          CALL ACPY (JLON, ZRC11 (:,:, JBLK), PQC11 (:,:, JBLK))
          CALL ACPY (JLON, ZRC12 (:,:, JBLK), PQC12 (:,:, JBLK))
          CALL ACPY (JLON, ZRC22 (:,:, JBLK), PQC22 (:,:, JBLK))
          CALL ACPY (JLON, ZRCL4 (:,:, JBLK), PQCL4 (:,:, JBLK))
          CALL ACPY (JLON, ZRCO2 (:,:, JBLK), PQCO2 (:,:, JBLK))
        ELSE
          ZRCH4 (JLON,:, JBLK)=YDMODEL%YRML_PHY_RAD%YRERDI%RCH4
          ZRN2O (JLON,:, JBLK)=YDMODEL%YRML_PHY_RAD%YRERDI%RN2O
          ZRNO2 (JLON,:, JBLK)=YDMODEL%YRML_PHY_RAD%YRERDI%RNO2
        ...
        IF (KAERO>0) THEN
          CALL ACPY (JLON, ZPAERO (:,:,:, JBLK), PAERO (:,:,:, JBLK))
        ELSE
          ZPAERO (JLON,:,:, JBLK)=0.0_JPRB
        ENDIF
...
ELSE
  ...
  IF (LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:1')) THEN
    ...
    IF (LSYNCHOST ('RECMWF_PARALLEL:1')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','RECMWF_PARALLEL:1')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','RECMWF_PARALLEL:1')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZRSWINHF) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ELSE
  ...
  IF (LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:2')) THEN
    ...
    IF (LSYNCHOST ('RECMWF_PARALLEL:2')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','RECMWF_PARALLEL:2')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','RECMWF_PARALLEL:2')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZRLWINHF) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDMODEL%YRML_PHY_RAD%YRERAD%LSRTM.AND.YDMODEL%YRML_PHY_RAD%YRERAD%LUSEPRE2017RAD) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:SRTM')) THEN
    ...
    IF (LSYNCHOST ('RECMWF_PARALLEL:SRTM')) THEN
...
ELSEIF (YDMODEL%YRML_PHY_RAD%YRERAD%LRRTM.AND..NOT.YDMODEL%YRML_PHY_RAD&
  ...
  IF (LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:RRTM')) THEN
    ...
    IF (LSYNCHOST ('RECMWF_PARALLEL:RRTM')) THEN
...
ELSEIF (.NOT.YDMODEL%YRML_PHY_RAD%YRERAD%LUSEPRE2017RAD) THEN
  ...
  IF (YDMODEL%YRML_PHY_RAD%YRERAD%CECRADARCH=='CPU') THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:ECRAD_CPU')) THEN
      ...
      IF (LSYNCHOST ('RECMWF_PARALLEL:ECRAD_CPU')) THEN
  ...
  IF (YDMODEL%YRML_PHY_RAD%YRERAD%CECRADARCH=='GPU') THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:ECRAD_GPU')) THEN
      ...
      IF (LSYNCHOST ('RECMWF_PARALLEL:ECRAD_GPU')) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:ECRAD_POST')) THEN
    ...
    IF (LSYNCHOST ('RECMWF_PARALLEL:ECRAD_POST')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','RECMWF_PARALLEL:ECRAD_POST')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','RECMWF_PARALLEL:ECRAD_POST')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:ECRAD_POST:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YSTACK, ZFRSOD, ZPFDIF, ZPFDIR) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','RECMWF_PARALLEL:FINISH')) THEN
  ...
  IF (LSYNCHOST ('RECMWF_PARALLEL:FINISH')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','RECMWF_PARALLEL:FINISH')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','RECMWF_PARALLEL:FINISH')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('RECMWF_PARALLEL:FINISH:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PTRSODIF, PTRSODIR, PVRMOON, YDCPG_OPTS, YDMODEL, YSTACK, ZFCS, ZFCT, &
    !$ACC&         ZFRSOD, ZPFDIF, ZPFDIR, ZRCO2, ZRMU0, ZSWDIFFUSEBAND, ZSWDIRECTBAND) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
    ...
    DO JLON = 1, MIN (YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1) * YDCPG_OPTS%KLON)
      ...
      YLSTACK%U4 = stack_u4 (YSTACK, JBLK-YDCPG_OPTS%JBLKMIN+1, YDCPG_OPTS%KGPBLKS)
        ...
        CALL ACPY (JLON, PEMTD(:,:, JBLK), PLWFT (:,:, 1, JBLK))  
        CALL ACPY (JLON, PEMTU(:,:, JBLK), PLWFT (:,:, 1, JBLK))  
        CALL ACPY (JLON, PCEMTR(:,:, JBLK), PLWFC(:,:, JBLK))  
