SUBROUTINE RECMWF_RRTM (YDCPG_OPTS, YDDIMV, YDMODEL, YDCPG_BNDS, PEMIW, PLSM, PRLWINHF, PPIZA_DST, PUVDF&
&, PAERINDS, PFCT, PRSWINHF, PTINCF, PTAUREL_DST, PFSDNN, PNBAS, PQLWP, PEMIS, PRAER, PFCS, PTH, PRCLC&
&, PRMU0, PQ, PALBD, PAPRS, PFRSOD, PFSDNV, PNTOP, PCGA_DST, PPARF, PPQO3, PT, PTS, PCCNO, PALBP, PQIWP&
&, PPARCF, PLWFT, PSFSWDIF, PSWFT, PCCNL, PQS, PEMIT, PDELP, PSUDU, PSFSWDIR, PAPRSF, PCLDROP)
