...
PROCEDURE :: COPY => COPY_TECUMF2
PROCEDURE :: CRC64 => CRC64_TECUMF2
PROCEDURE :: HOST => HOST_TECUMF2
PROCEDURE :: LOAD => LOAD_TECUMF2
PROCEDURE :: SAVE => SAVE_TECUMF2
PROCEDURE :: SIZE => SIZE_TECUMF2
PROCEDURE :: WIPE => WIPE_TECUMF2
END TYPE TECUMF2
!============================================================================
...
MODULE SUBROUTINE COPY_TECUMF2 (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TECUMF2 (SELF)

IMPLICIT NONE
CLASS (TECUMF2), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TECUMF2 (SELF, KLUN)
...
MODULE SUBROUTINE WIPE_TECUMF2 (SELF, LDDELETED, LDFIELDAPI)
