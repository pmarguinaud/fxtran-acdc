...
SUBROUTINE SAVE_TDPHY (SELF, KLUN)
...
SUBROUTINE LOAD_TDPHY (SELF, KLUN)
...
SUBROUTINE COPY_TDPHY (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE CRC64_TDPHY (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TDPHY (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TDPHY (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
