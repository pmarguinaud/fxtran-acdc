...
CONTAINS
PROCEDURE :: COPY => COPY_CST_T
PROCEDURE :: CRC64 => CRC64_CST_T
PROCEDURE :: HOST => HOST_CST_T
PROCEDURE :: LOAD => LOAD_CST_T
PROCEDURE :: SAVE => SAVE_CST_T
PROCEDURE :: SIZE => SIZE_CST_T
PROCEDURE :: WIPE => WIPE_CST_T
END TYPE CST_t
...
MODULE SUBROUTINE COPY_CST_T (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_CST_T (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_CST_T (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_CST_T (SELF, KLUN)
...
MODULE FUNCTION SIZE_CST_T (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_CST_T (SELF, LDDELETED, LDFIELDAPI)
