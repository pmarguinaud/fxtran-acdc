...
PROCEDURE :: COPY => COPY_TMCC
PROCEDURE :: CRC64 => CRC64_TMCC
PROCEDURE :: HOST => HOST_TMCC
PROCEDURE :: LOAD => LOAD_TMCC
PROCEDURE :: SAVE => SAVE_TMCC
PROCEDURE :: SIZE => SIZE_TMCC
PROCEDURE :: WIPE => WIPE_TMCC
END TYPE TMCC
!======================================================================
...
MODULE SUBROUTINE HOST_TMCC (SELF)

IMPLICIT NONE
CLASS (TMCC), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TMCC (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TMCC (SELF, KLUN)
