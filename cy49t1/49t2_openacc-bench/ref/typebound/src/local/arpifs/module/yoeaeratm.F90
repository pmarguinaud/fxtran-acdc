...
CONTAINS
PROCEDURE :: COPY => COPY_TYPE_AERO_DESC
PROCEDURE :: CRC64 => CRC64_TYPE_AERO_DESC
PROCEDURE :: HOST => HOST_TYPE_AERO_DESC
PROCEDURE :: LOAD => LOAD_TYPE_AERO_DESC
PROCEDURE :: SAVE => SAVE_TYPE_AERO_DESC
PROCEDURE :: SIZE => SIZE_TYPE_AERO_DESC
PROCEDURE :: WIPE => WIPE_TYPE_AERO_DESC
...
PROCEDURE :: COPY => COPY_TEAERATM
PROCEDURE :: CRC64 => CRC64_TEAERATM
PROCEDURE :: HOST => HOST_TEAERATM
PROCEDURE :: LOAD => LOAD_TEAERATM
PROCEDURE :: SAVE => SAVE_TEAERATM
PROCEDURE :: SIZE => SIZE_TEAERATM
PROCEDURE :: WIPE => WIPE_TEAERATM
END TYPE TEAERATM
!============================================================================
...
MODULE SUBROUTINE COPY_TYPE_AERO_DESC (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TYPE_AERO_DESC (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TYPE_AERO_DESC (SELF)

IMPLICIT NONE
CLASS (TYPE_AERO_DESC), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TYPE_AERO_DESC (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TYPE_AERO_DESC (SELF, KLUN)
...
MODULE FUNCTION SIZE_TYPE_AERO_DESC (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TYPE_AERO_DESC (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TEAERATM (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TEAERATM (SELF)

IMPLICIT NONE
CLASS (TEAERATM), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TEAERATM (SELF, KLUN)
USE PARKIND1, ONLY : JPRD
...
MODULE SUBROUTINE WIPE_TEAERATM (SELF, LDDELETED, LDFIELDAPI)
