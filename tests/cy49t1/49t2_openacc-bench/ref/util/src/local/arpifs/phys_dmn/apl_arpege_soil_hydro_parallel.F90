...
IF (YDMODEL%YRML_PHY_MF%YRPHY%LSOLV.AND.(.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE)) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_SOIL_HYDRO_PARALLEL:ACVEG')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_SOIL_HYDRO_PARALLEL:ACVEG')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_SOIL_HYDRO_PARALLEL:ACVEG')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_SOIL_HYDRO_PARALLEL:ACVEG')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_SOIL_HYDRO_PARALLEL:ACVEG:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&         PHTR, PHU, PQV, PWFC, PWLMX, PWWILT, YDCPG_OPTS, YDMODEL, YSTACK, Z_YDMF_PHYS_BASE_STATE_T, &
      !$ACC&         Z_YDMF_PHYS_BASE_STATE_YGSP_RR_FC, Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q, &
      !$ACC&         Z_YDMF_PHYS_OUT_FRSO, Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_SURF_GSD_VV_PD2, &
...
ENDSUBROUTINE APL_ARPEGE_SOIL_HYDRO_PARALLEL
