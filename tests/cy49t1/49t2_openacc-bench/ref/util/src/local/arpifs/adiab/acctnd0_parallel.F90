...
IF (LDT1) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','ACCTND0_PARALLEL:PACC')) THEN
    ...
    IF (LSYNCHOST ('ACCTND0_PARALLEL:PACC')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','ACCTND0_PARALLEL:PACC')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ACCTND0_PARALLEL:PACC')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('ACCTND0_PARALLEL:PACC:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&PRESENT (PACC, PTND, YDCPG_OPTS, YDCST, YSTACK) &
      !$ACC&PRIVATE (JBLK) &
