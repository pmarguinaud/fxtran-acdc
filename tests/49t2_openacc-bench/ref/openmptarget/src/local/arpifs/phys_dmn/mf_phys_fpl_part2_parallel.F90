...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','MF_PHYS_FPL_PART2_PARALLEL:PART2')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (PCPF_T1, YD_PCPF_T1)
  CALL SGET_HOST_DATA_RDONLY (PPFL_FPLCH, YD_PPFL_FPLCH)
  CALL SGET_HOST_DATA_RDONLY (PPFL_FPLSH, YD_PPFL_FPLSH)
  CALL SGET_HOST_DATA_RDWR (PSPF_T1, YD_PSPF_T1)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','MF_PHYS_FPL_PART2_PARALLEL:PART2')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('MF_PHYS_FPL_PART2_PARALLEL:PART2:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (PCPF_T1, YD_PCPF_T1)
  CALL SGET_DEVICE_DATA_RDONLY (PPFL_FPLCH, YD_PPFL_FPLCH)
  CALL SGET_DEVICE_DATA_RDONLY (PPFL_FPLSH, YD_PPFL_FPLSH)
  CALL SGET_DEVICE_DATA_RDWR (PSPF_T1, YD_PSPF_T1)
  IF (LHOOK) CALL DR_HOOK ('MF_PHYS_FPL_PART2_PARALLEL:PART2:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('MF_PHYS_FPL_PART2_PARALLEL:PART2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:PCPF_T1, PPFL_FPLCH, PPFL_FPLSH, PSPF_T1, YDCPG_OPTS, YDMODEL,  & 
