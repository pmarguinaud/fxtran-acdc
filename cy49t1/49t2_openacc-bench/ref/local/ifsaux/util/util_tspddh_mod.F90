...
SUBROUTINE SAVE_TSPDDH (SELF, KLUN)
...
SUBROUTINE LOAD_TSPDDH (SELF, KLUN)
...
SUBROUTINE COPY_TSPDDH (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE CRC64_TSPDDH (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TSPDDH (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TSPDDH (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
