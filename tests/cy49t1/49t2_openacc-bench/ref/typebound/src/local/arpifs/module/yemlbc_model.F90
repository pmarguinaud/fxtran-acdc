...
CONTAINS
PROCEDURE :: COPY => COPY_TGMVSTENC
PROCEDURE :: CRC64 => CRC64_TGMVSTENC
PROCEDURE :: HOST => HOST_TGMVSTENC
PROCEDURE :: LOAD => LOAD_TGMVSTENC
PROCEDURE :: SAVE => SAVE_TGMVSTENC
PROCEDURE :: SIZE => SIZE_TGMVSTENC
PROCEDURE :: WIPE => WIPE_TGMVSTENC
END TYPE TGMVSTENC
...
INTEGER(KIND=JPIM) :: NDIMT      ! number of temporally interpolated fields (includes derivatives)
CONTAINS
PROCEDURE :: COPY => COPY_TGMVCPL
PROCEDURE :: CRC64 => CRC64_TGMVCPL
PROCEDURE :: HOST => HOST_TGMVCPL
PROCEDURE :: LOAD => LOAD_TGMVCPL
PROCEDURE :: SAVE => SAVE_TGMVCPL
PROCEDURE :: SIZE => SIZE_TGMVCPL
PROCEDURE :: WIPE => WIPE_TGMVCPL
END TYPE TGMVCPL
...
INTEGER(KIND=JPIM) :: NDIMT      ! number of temporally interpolated fields (includes derivatives)
CONTAINS
PROCEDURE :: COPY => COPY_TGMVSCPL
PROCEDURE :: CRC64 => CRC64_TGMVSCPL
PROCEDURE :: HOST => HOST_TGMVSCPL
PROCEDURE :: LOAD => LOAD_TGMVSCPL
PROCEDURE :: SAVE => SAVE_TGMVSCPL
PROCEDURE :: SIZE => SIZE_TGMVSCPL
PROCEDURE :: WIPE => WIPE_TGMVSCPL
END TYPE TGMVSCPL
...
CONTAINS
PROCEDURE :: COPY => COPY_TELBC_MODEL
PROCEDURE :: CRC64 => CRC64_TELBC_MODEL
PROCEDURE :: HOST => HOST_TELBC_MODEL
PROCEDURE :: LOAD => LOAD_TELBC_MODEL
PROCEDURE :: SAVE => SAVE_TELBC_MODEL
PROCEDURE :: SIZE => SIZE_TELBC_MODEL
PROCEDURE :: WIPE => WIPE_TELBC_MODEL
...
MODULE SUBROUTINE COPY_TGMVSTENC (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TGMVSTENC (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TGMVSTENC (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TGMVSTENC (SELF, KLUN)
...
MODULE FUNCTION SIZE_TGMVSTENC (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TGMVSTENC (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TGMVCPL (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TGMVCPL (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE LOAD_TGMVCPL (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TGMVCPL (SELF, KLUN)
...
MODULE FUNCTION SIZE_TGMVCPL (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TGMVCPL (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TGMVSCPL (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TGMVSCPL (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_TGMVSCPL (SELF)

IMPLICIT NONE
CLASS (TGMVSCPL), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TGMVSCPL (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TGMVSCPL (SELF, KLUN)
...
MODULE FUNCTION SIZE_TGMVSCPL (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TGMVSCPL (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TELBC_MODEL (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TELBC_MODEL (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE LOAD_TELBC_MODEL (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TELBC_MODEL (SELF, KLUN)
...
MODULE FUNCTION SIZE_TELBC_MODEL (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TELBC_MODEL (SELF, LDDELETED, LDFIELDAPI)
