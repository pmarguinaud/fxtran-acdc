...
IF (KFLAG==1) THEN
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPMPFC_EXPL_PARALLEL:0')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('GPMPFC_EXPL_PARALLEL:0:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDONLY (PGM, YD_PGM)
    CALL SGET_DEVICE_DATA_RDWR (ZGM, YL_ZGM)
    IF (LHOOK) CALL DR_HOOK ('GPMPFC_EXPL_PARALLEL:0:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('GPMPFC_EXPL_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:PGM, YDCPG_OPTS, YFXTRAN_ACDC_STACK, ZGM)  & 
    !$OMP & PRIVATE (JBLK)  & 
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPMPFC_EXPL_PARALLEL:1')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('GPMPFC_EXPL_PARALLEL:1:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (ZGM, YL_ZGM)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_DIV_T0, YDVARS%DIV%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_DIV_T9, YDVARS%DIV%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_NHX_DL, YDVARS%NHX%FDL)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_NHX_DM, YDVARS%NHX%FDM)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SPD_DL, YDVARS%SPD%FDL)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SPD_DL9, YDVARS%SPD%FDL9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SPD_DM, YDVARS%SPD%FDM)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SPD_DM9, YDVARS%SPD%FDM9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SP_DL, YDVARS%SP%FDL)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SP_DL9, YDVARS%SP%FDL9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SP_DM, YDVARS%SP%FDM)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SP_DM9, YDVARS%SP%FDM9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SVD_DL, YDVARS%SVD%FDL)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SVD_DL9, YDVARS%SVD%FDL9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SVD_DM, YDVARS%SVD%FDM)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SVD_DM9, YDVARS%SVD%FDM9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_T_DL, YDVARS%T%FDL)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_T_DL9, YDVARS%T%FDL9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_T_DM, YDVARS%T%FDM)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_T_DM9, YDVARS%T%FDM9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_U_DL, YDVARS%U%FDL)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_U_T0, YDVARS%U%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_U_T9, YDVARS%U%FT9)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_VOR_T0, YDVARS%VOR%FT0)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_V_DL, YDVARS%V%FDL)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDDYN, YDDYNA, YDML_GCONF, YFXTRAN_ACDC_STACK, ZGM,  & 
  !$OMP &          Z_YDVARS_DIV_T0, Z_YDVARS_DIV_T9, Z_YDVARS_NHX_DL, Z_YDVARS_NHX_DM,  & 
  !$OMP &          Z_YDVARS_SPD_DL, Z_YDVARS_SPD_DL9, Z_YDVARS_SPD_DM, Z_YDVARS_SPD_DM9,  & 
  !$OMP &          Z_YDVARS_SP_DL, Z_YDVARS_SP_DL9, Z_YDVARS_SP_DM, Z_YDVARS_SP_DM9,  & 
  !$OMP &          Z_YDVARS_SVD_DL, Z_YDVARS_SVD_DL9, Z_YDVARS_SVD_DM, Z_YDVARS_SVD_DM9,  & 
  !$OMP &          Z_YDVARS_T_DL, Z_YDVARS_T_DL9, Z_YDVARS_T_DM, Z_YDVARS_T_DM9,  & 
  !$OMP &          Z_YDVARS_U_DL, Z_YDVARS_U_T0, Z_YDVARS_U_T9, Z_YDVARS_VOR_T0,  & 
  !$OMP &          Z_YDVARS_V_DL, Z_YDVARS_V_T0, Z_YDVARS_V_T9)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
