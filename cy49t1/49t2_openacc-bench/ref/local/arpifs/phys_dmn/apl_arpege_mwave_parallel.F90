...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_MWAVE_PARALLEL:0')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_MWAVE_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_MWAVE_PARALLEL:0')) THEN
  ...
  !$OMP PARALLEL DO PRIVATE (JBLK, JLEV, JLON, YDPHYSMWAVE, YLCPG_BNDS, YLSTACK)
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_MWAVE_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_MWAVE_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&PRESENT (YDCPG_OPTS, YSTACK, ZCOVPTOT, Z_YDCPG_MISC_NEB, Z_YDCPG_MISC_QICE, &
    !$ACC&         Z_YDCPG_MISC_QLI, Z_YDMF_PHYS_OUT_FPLCL, Z_YDMF_PHYS_OUT_FPLCN, &
    ...
    !$ACC LOOP VECTOR &
    !$ACC&PRIVATE (JLEV, JLON, YDPHYSMWAVE, YLCPG_BNDS, YLSTACK) 
...
ENDSUBROUTINE APL_ARPEGE_MWAVE_PARALLEL
