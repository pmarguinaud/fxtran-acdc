...
SUBROUTINE SAVE_TTHF (SELF, KLUN)
...
SUBROUTINE LOAD_TTHF (SELF, KLUN)
...
SUBROUTINE COPY_TTHF (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE CRC64_TTHF (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TTHF (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TTHF (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
