...
CONTAINS
PROCEDURE :: COPY => COPY_TECVDIM
PROCEDURE :: CRC64 => CRC64_TECVDIM
PROCEDURE :: HOST => HOST_TECVDIM
PROCEDURE :: LOAD => LOAD_TECVDIM
PROCEDURE :: SAVE => SAVE_TECVDIM
PROCEDURE :: SIZE => SIZE_TECVDIM
PROCEDURE :: WIPE => WIPE_TECVDIM
END TYPE TECVDIM
...
CONTAINS
PROCEDURE :: COPY => COPY_TECV_CONFIG_BASE
PROCEDURE :: CRC64 => CRC64_TECV_CONFIG_BASE
PROCEDURE :: HOST => HOST_TECV_CONFIG_BASE
PROCEDURE :: LOAD => LOAD_TECV_CONFIG_BASE
PROCEDURE :: SAVE => SAVE_TECV_CONFIG_BASE
PROCEDURE :: SIZE => SIZE_TECV_CONFIG_BASE
PROCEDURE :: WIPE => WIPE_TECV_CONFIG_BASE
...
CONTAINS
PROCEDURE :: COPY => COPY_TECV_CONFIG
PROCEDURE :: CRC64 => CRC64_TECV_CONFIG
PROCEDURE :: HOST => HOST_TECV_CONFIG
PROCEDURE :: LOAD => LOAD_TECV_CONFIG
PROCEDURE :: SAVE => SAVE_TECV_CONFIG
PROCEDURE :: SIZE => SIZE_TECV_CONFIG
PROCEDURE :: WIPE => WIPE_TECV_CONFIG
...
CONTAINS
PROCEDURE :: COPY => COPY_TECVGRIB
PROCEDURE :: CRC64 => CRC64_TECVGRIB
PROCEDURE :: HOST => HOST_TECVGRIB
PROCEDURE :: LOAD => LOAD_TECVGRIB
PROCEDURE :: SAVE => SAVE_TECVGRIB
PROCEDURE :: SIZE => SIZE_TECVGRIB
PROCEDURE :: WIPE => WIPE_TECVGRIB
END TYPE TECVGRIB
...
CONTAINS
PROCEDURE :: COPY => COPY_ECV_CONTAINER
PROCEDURE :: CRC64 => CRC64_ECV_CONTAINER
PROCEDURE :: HOST => HOST_ECV_CONTAINER
PROCEDURE :: LOAD => LOAD_ECV_CONTAINER
PROCEDURE :: SAVE => SAVE_ECV_CONTAINER
PROCEDURE :: SIZE => SIZE_ECV_CONTAINER
PROCEDURE :: WIPE => WIPE_ECV_CONTAINER
END TYPE ECV_CONTAINER

!-----------------------------------------------------------------------
INTERFACE

MODULE SUBROUTINE COPY_TECVDIM (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TECVDIM (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TECVDIM (SELF)

IMPLICIT NONE
CLASS (TECVDIM), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TECVDIM (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TECVDIM (SELF, KLUN)
...
MODULE FUNCTION SIZE_TECVDIM (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TECVDIM (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TECV_CONFIG_BASE (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TECV_CONFIG_BASE (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_TECV_CONFIG_BASE (SELF)

IMPLICIT NONE
CLASS (TECV_CONFIG_BASE), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TECV_CONFIG_BASE (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TECV_CONFIG_BASE (SELF, KLUN)
...
MODULE FUNCTION SIZE_TECV_CONFIG_BASE (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TECV_CONFIG_BASE (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TECV_CONFIG (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TECV_CONFIG (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE LOAD_TECV_CONFIG (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TECV_CONFIG (SELF, KLUN)
...
MODULE FUNCTION SIZE_TECV_CONFIG (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE COPY_TECVGRIB (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TECVGRIB (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_TECVGRIB (SELF)

IMPLICIT NONE
CLASS (TECVGRIB), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TECVGRIB (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TECVGRIB (SELF, KLUN)
...
MODULE FUNCTION SIZE_TECVGRIB (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TECVGRIB (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_ECV_CONTAINER (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_ECV_CONTAINER (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_ECV_CONTAINER (SELF)

IMPLICIT NONE
CLASS (ECV_CONTAINER), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_ECV_CONTAINER (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_ECV_CONTAINER (SELF, KLUN)
...
MODULE FUNCTION SIZE_ECV_CONTAINER (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_ECV_CONTAINER (SELF, LDDELETED, LDFIELDAPI)
