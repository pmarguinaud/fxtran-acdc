...
IF (YDMODEL%YRML_DYN%YRDYN%NCURRENT_ITER==0) THEN
  ...
  IF (YDMODEL%YRML_DYN%YRDYNA%LTWOTL) THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','CPG_GP_PARALLEL:GPTF2_EXPL_2TL')) THEN
      ...
      IF (LSYNCHOST ('CPG_GP_PARALLEL:GPTF2_EXPL_2TL')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_GP_PARALLEL:GPTF2_EXPL_2TL')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_PARALLEL:GPTF2_EXPL_2TL')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:GPTF2_EXPL_2TL:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, Z_YDVARS_U_T0, Z_YDVARS_U_T9, &
...
IF (LPARALLELMETHOD ('OPENMP','CPG_GP_PARALLEL:MAP_FACTOR')) THEN
  ...
  IF (LSYNCHOST ('CPG_GP_PARALLEL:MAP_FACTOR')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_GP_PARALLEL:MAP_FACTOR')) THEN
  ...
  !$OMP PARALLEL DO PRIVATE (JBLK, JROF, YLCPG_BNDS, YLSTACK, ZGM2)
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_PARALLEL:MAP_FACTOR')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:MAP_FACTOR:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, Z_OROGLL_T0, Z_OROGLM_T0, Z_OROGMM_T0, &
    !$ACC&         Z_YDCPG_DYN0_OROGL, Z_YDCPG_DYN0_OROGM, Z_YDVARS_GEOMETRY_GM_T0, &
    ...
    !$ACC LOOP VECTOR &
    !$ACC&PRIVATE (JROF, YLCPG_BNDS, YLSTACK, ZGM2) 
...
IF (LPARALLELMETHOD ('OPENMP','CPG_GP_PARALLEL:GP_SPV')) THEN
  ...
  IF (LSYNCHOST ('CPG_GP_PARALLEL:GP_SPV')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_GP_PARALLEL:GP_SPV')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_PARALLEL:GP_SPV')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:GP_SPV:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, Z_YDCPG_DYN0_PRE, Z_YDCPG_DYN0_PREL, &
    !$ACC&         Z_YDCPG_DYN0_PREM, Z_YDCPG_DYN9_PRE, Z_YDCPG_DYN9_PREL, Z_YDCPG_DYN9_PREM, &
    !$ACC&         Z_YDVARS_SP_DL, Z_YDVARS_SP_DL9, Z_YDVARS_SP_DM, Z_YDVARS_SP_DM9, &
    !$ACC&         Z_YDVARS_SP_T0, Z_YDVARS_SP_T9) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDMODEL%YRML_DYN%YRDYN%NCURRENT_ITER==0) THEN
  ...
  IF (YDCPG_OPTS%LDIAB.OR.YDMODEL%YRML_PHY_SLIN%YRPHLC%LSPHLC&
    ...
    IF (LPARALLELMETHOD ('OPENMP','CPG_GP_PARALLEL:SETZERO')) THEN
      ...
      IF (LSYNCHOST ('CPG_GP_PARALLEL:SETZERO')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_GP_PARALLEL:SETZERO')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_PARALLEL:SETZERO')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:SETZERO:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (YDCPG_OPTS, YSTACK, Z_YDCPG_MISC_QS) &
        !$ACC&PRIVATE (JBLK) &
        !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
    ...
    IF (YDCPG_OPTS%LFSTEP.AND..NOT.YDMODEL%YRML_DYN%YRDYNA%LTWOTL) THEN
      ...
      IF (LPARALLELMETHOD ('UPDATEVIEW','CPG_GP_PARALLEL:SET9TO0')) THEN
        ...
        IF (LSYNCHOST ('CPG_GP_PARALLEL:SET9TO0')) THEN
...
IF (LPARALLELMETHOD ('OPENMP','CPG_GP_PARALLEL:GPINISLB_PART1_EXPL')) THEN
  ...
  IF (LSYNCHOST ('CPG_GP_PARALLEL:GPINISLB_PART1_EXPL')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_GP_PARALLEL:GPINISLB_PART1_EXPL')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_PARALLEL:GPINISLB_PART1_EXPL')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:GPINISLB_PART1_EXPL:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, Z_YDCPG_DYN9_NHX, Z_YDCPG_MISC_QGRAUPEL, &
    !$ACC&         Z_YDCPG_MISC_QICE, Z_YDCPG_MISC_QLI, Z_YDCPG_MISC_QRAIN, &
    !$ACC&         Z_YDCPG_MISC_QSNOW, Z_YDVARS_G_T0, Z_YDVARS_G_T9, Z_YDVARS_I_T0, &
    !$ACC&         Z_YDVARS_I_T9, Z_YDVARS_L_T0, Z_YDVARS_L_T9, Z_YDVARS_NHX_T1, &
    !$ACC&         Z_YDVARS_R_T0, Z_YDVARS_R_T9, Z_YDVARS_SPD_T1, Z_YDVARS_SPD_T9, &
    !$ACC&         Z_YDVARS_SP_T1, Z_YDVARS_SP_T9, Z_YDVARS_SVD_T1, Z_YDVARS_SVD_T9, &
    !$ACC&         Z_YDVARS_S_T0, Z_YDVARS_S_T9, Z_YDVARS_T_T1, Z_YDVARS_T_T9, &
    !$ACC&         Z_YDVARS_U_T1, Z_YDVARS_U_T9, Z_YDVARS_V_T1, Z_YDVARS_V_T9) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','CPG_GP_PARALLEL:GPINISLB_PART3_EXPL')) THEN
  ...
  IF (LSYNCHOST ('CPG_GP_PARALLEL:GPINISLB_PART3_EXPL')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_GP_PARALLEL:GPINISLB_PART3_EXPL')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_GP_PARALLEL:GPINISLB_PART3_EXPL')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPG_GP_PARALLEL:GPINISLB_PART3_EXPL:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDMODEL, YSTACK, Z_GDW_T0, Z_GWHT_T0, Z_YDCPG_DYN0_CTY_VVEL, &
    !$ACC&         Z_YDCPG_DYN0_GWFT, Z_YDCPG_DYN0_PREF, Z_YDCPG_SL2_GDW, Z_YDCPG_SL2_GWF, &
    !$ACC&         Z_YDCPG_SL2_GWS, Z_YDCPG_SL2_VVEL) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDMODEL%YRML_DYN%YRDYN%NCURRENT_ITER==0) THEN
  ...
  IF (YDCPG_OPTS%LDIAB.OR.YDMODEL%YRML_PHY_MF%YRSIMPHL%LSIMPH) THEN
    ...
    IF (YDMODEL%YRML_DYN%YRDYNA%LTWOTL) THEN
      ...
      IF (LPARALLELMETHOD ('UPDATEVIEW','CPG_GP_PARALLEL:SET1TO0')) THEN
        ...
        IF (LSYNCHOST ('CPG_GP_PARALLEL:SET1TO0')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENMPMETHOD','CPG_GP_PARALLEL:SET1TO0')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENACCMETHOD','CPG_GP_PARALLEL:SET1TO0')) THEN
    ...
    ELSE
      ...
      IF (LPARALLELMETHOD ('UPDATEVIEW','CPG_GP_PARALLEL:SET1TO9')) THEN
        ...
        IF (LSYNCHOST ('CPG_GP_PARALLEL:SET1TO9')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENMPMETHOD','CPG_GP_PARALLEL:SET1TO9')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENACCMETHOD','CPG_GP_PARALLEL:SET1TO9')) THEN
