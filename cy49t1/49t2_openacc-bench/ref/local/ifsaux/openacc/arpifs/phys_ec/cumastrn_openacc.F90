...
DO JK=YDML_PHY_EC%YRECUMF%NJKT2, KLEV
  ...
  DO JL=KIDIA, KFDIA
    ...
    IF (LLO3.AND.YDML_PHY_EC%YRECUMF%RCAPQADV>0.0_JPRB) THEN
      ...
      ZCAPE2 =ZCAPE2 +((PTU (JLON, JK)-ZTENH2 (JLON, JK))/ZTENH2 (JLON, JK)&
      &+YDCST%RETV*(PQU (JLON, JK)-ZQENH2 (JLON, JK))-PLU (JLON, JK))*ZDZ
    ENDIF
...
DO JK=2, KLEV
  ...
  DO JL=KIDIA, KFDIA
    ...
    IF (LDCUM (JLON).AND.JK>=KCTOP (JLON)-1.AND.JK<KCBOT (JLON)) THEN
      ...
      ZMFA=ZMFUQ (JLON, JK+1)+ZMFDQ (JLON, JK+1)-ZMFUQ (JLON, JK)-ZMFDQ (JLON, JK)+ZMFUL (JLON&
      &, JK+1)-ZMFUL (JLON, JK)+ZDMFUP (JLON, JK)-PSNDE (JLON, JK, 1)-PSNDE (JLON, JK, 2)
