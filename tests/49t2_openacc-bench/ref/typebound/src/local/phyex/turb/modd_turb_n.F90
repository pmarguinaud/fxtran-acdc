...
!  
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TURB_T
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TURB_T
PROCEDURE :: ACDC_HOST => ACDC_HOST_TURB_T
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TURB_T
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TURB_T
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TURB_T
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TURB_T
END TYPE TURB_t
