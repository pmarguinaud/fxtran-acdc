...
CONTAINS
PROCEDURE :: COPY => COPY_TEOZOC
PROCEDURE :: CRC64 => CRC64_TEOZOC
PROCEDURE :: HOST => HOST_TEOZOC
PROCEDURE :: LOAD => LOAD_TEOZOC
PROCEDURE :: SAVE => SAVE_TEOZOC
PROCEDURE :: SIZE => SIZE_TEOZOC
PROCEDURE :: WIPE => WIPE_TEOZOC
END TYPE TEOZOC
...
MODULE SUBROUTINE COPY_TEOZOC (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TEOZOC (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TEOZOC (SELF)
...
MODULE SUBROUTINE SAVE_TEOZOC (SELF, KLUN)
...
MODULE SUBROUTINE WIPE_TEOZOC (SELF, LDDELETED, LDFIELDAPI)
