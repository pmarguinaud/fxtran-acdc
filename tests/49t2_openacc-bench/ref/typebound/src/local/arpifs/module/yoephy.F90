...
PROCEDURE :: ACDC_COPY => ACDC_COPY_TEPHY
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TEPHY
PROCEDURE :: ACDC_HOST => ACDC_HOST_TEPHY
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TEPHY
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TEPHY
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TEPHY
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TEPHY
END TYPE TEPHY
...
USE YOMHOOK, ONLY : LHOOK, DR_HOOK, JPHOOK
  ...
  IF (LHOOK) CALL DR_HOOK('YOEPHY:PRINT_CONFIGURATION',0,ZHOOK_HANDLE)
  ...
  WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LERADIMPL = ', SELF%LERADIMPL
  ...
  WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LEVDIFSL = ', SELF%LEVDIFSL
  ...
  WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LWETONLINE = ', SELF%LWETONLINE
  ...
  WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LEXTRATEND = ', SELF%LEXTRATEND
  ...
  WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LVDFNEWTRAC = ', SELF%LVDFNEWTRAC
  ...
  WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LEFARQUHAR = ', SELF%LEFARQUHAR
  WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LEC4MAP = ', SELF%LEC4MAP
  WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LEAIRCO2COUP = ', SELF%LEAIRCO2COUP
  ...
  WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LEURBAN = ', SELF%LEURBAN
  ...
  WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LVEXTRDYNACC = ', SELF%LVEXTRDYNACC
 

  IF (LHOOK) CALL DR_HOOK('YOEPHY:PRINT_CONFIGURATION',1,ZHOOK_HANDLE)
