...
IF (YDLDDH%LRSIDDH) THEN
  CALL LATTEX_LRSIDDH (YDCPG_TNDSI_DDH, YDCPG_SL1, YDML_DYN, YDGEOMETRY, YDCPG_BNDS)
ENDIF
...
CALL LATTEX_MAIN (LLCT, LLCTC, LLSETTLSW, YDCPG_TNDSI_DDH, YDCPG_SL1, YDCPG_SL2, ZCMSLP, YDML_GCONF&
&, YDGEOMETRY, PDTS2, PESGP, YDML_DYN, ZRTWORGRA, YDVARS, YDCPG_OPTS, PBT, YDCPG_TND, ZRGOM, YDLDDH&
&, PESGM, YDCPG_BNDS, PEVEL, PGWT9, PGAGT0L, PGAGT9L, PGWT0, PSPDS0, PNHXT0, POROGM, POROGL, PLPD0&
&, PRDELP, PTOD9, PHIF0, PGWFT0, PTOD0, PMIXNL, PBDT, PSPDS9, PGAGT9M, PLPD9, PNHXT9, PGAGT0M)
...
IF (YDML_DYN%YRDYN%LRHS_CURV) THEN
  CALL LATTEX_LRHS_CURV (YDVARS, YDCPG_SL1, YDML_DYN, YDGEOMETRY, YDCPG_BNDS)
ENDIF
