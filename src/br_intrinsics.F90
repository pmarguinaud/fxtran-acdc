...
PURE REAL(KIND=C_DOUBLE) FUNCTION BR_LOGGAMMA_C(P) BIND(C,NAME="br_loggamma")
!$ACC ROUTINE SEQ
IMPORT C_DOUBLE
REAL(KIND=C_DOUBLE), VALUE, INTENT(IN) :: P
END FUNCTION
...
INTERFACE BR_LOGGAMMA
  MODULE PROCEDURE BR_LOGGAMMA_RM
  MODULE PROCEDURE BR_LOGGAMMA_RD
END INTERFACE
...
!$ACC ROUTINE SEQ
REAL (KIND=JPRM), INTENT(IN) :: P
BR_LOG_RM = BR_LOG_C(REAL(P,KIND=C_DOUBLE))/BR_LOG_C(REAL(10.,KIND=C_DOUBLE))
END FUNCTION
...
ELEMENTAL REAL (KIND=JPRM) FUNCTION BR_LOGGAMMA_RM(P)
!$ACC ROUTINE SEQ
REAL (KIND=JPRM), INTENT(IN) :: P
BR_LOGGAMMA_RM = BR_LOGGAMMA_C(REAL(P,KIND=C_DOUBLE))
END FUNCTION
...
!$ACC ROUTINE SEQ
REAL (KIND=JPRD), INTENT(IN) :: P
BR_LOG_RD = BR_LOG_C(REAL(P,KIND=C_DOUBLE))/BR_LOG_C(REAL(10.,KIND=C_DOUBLE))
END FUNCTION
...
ELEMENTAL REAL (KIND=JPRD) FUNCTION BR_LOGGAMMA_RD(P)
!$ACC ROUTINE SEQ
REAL (KIND=JPRD), INTENT(IN) :: P
BR_LOGGAMMA_RD = BR_LOGGAMMA_C(REAL(P,KIND=C_DOUBLE))
END FUNCTION
