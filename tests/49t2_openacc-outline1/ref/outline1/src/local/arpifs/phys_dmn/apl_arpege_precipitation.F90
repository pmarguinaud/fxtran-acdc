...
&, YDMF_PHYS_SURF, YDVARS, YDMODEL, PFLU_NEIJ, PNEBS, PNEB_CVPP, PQC_DET_PCMT, PQI, PQL&
&, PQLIS, PQLI_CVPP, PQR, PQS, PQV, PSEDIQI, PSEDIQL, PTENHA, PTENQVA, YDSTA)
...
#include "apl_arpege_precipitation_acuptq.intfb.h"
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PRECIPITATION', 0, ZHOOK_HANDLE)

LLPTQ=.TRUE.
CALL APL_ARPEGE_PRECIPITATION_ACUPTQ (LLPTQ, YDCPG_BNDS, YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_BASE_STATE&
&, YDMF_PHYS_SURF, YDMODEL, YDSTA, YDVARS, PFLU_NEIJ, PNEBS, PNEB_CVPP, PQC_DET_PCMT, PQI&
&, PQL, PQLIS, PQLI_CVPP, PQR, PQS, PQV, PSEDIQI, PSEDIQL, PTENHA, PTENQVA)

IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PRECIPITATION', 1, ZHOOK_HANDLE)
ENDSUBROUTINE APL_ARPEGE_PRECIPITATION
