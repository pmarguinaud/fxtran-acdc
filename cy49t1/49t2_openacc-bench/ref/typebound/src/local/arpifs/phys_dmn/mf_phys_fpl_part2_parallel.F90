...
IF (LPARALLELMETHOD ('OPENMP','MF_PHYS_FPL_PART2_PARALLEL:PART2')) THEN
  ...
  IF (LSYNCHOST ('MF_PHYS_FPL_PART2_PARALLEL:PART2')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','MF_PHYS_FPL_PART2_PARALLEL:PART2')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','MF_PHYS_FPL_PART2_PARALLEL:PART2')) THEN
