...
IF (LPARALLELMETHOD ('OPENMP','GPRCP_EXPL_PARALLEL:0')) THEN
  ...
  IF (LSYNCHOST ('GPRCP_EXPL_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPRCP_EXPL_PARALLEL:0')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPRCP_EXPL_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('GPRCP_EXPL_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&PRESENT (YDCPG_OPTS, YSTACK, ZCP, ZR) &
    !$ACC&PRIVATE (JBLK) &
...
CASE (0)
  ...
  DO JFLD=1, IFLD
    ...
    IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LTHERMACT) THEN
      ...
      IF (LPARALLELMETHOD ('OPENMP','GPRCP_EXPL_PARALLEL:1')) THEN
        ...
        IF (LSYNCHOST ('GPRCP_EXPL_PARALLEL:1')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPRCP_EXPL_PARALLEL:1')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPRCP_EXPL_PARALLEL:1')) THEN
        ...
        IF (LHOOK) CALL DR_HOOK ('GPRCP_EXPL_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
          ...
          !$ACC PARALLEL LOOP GANG &
          !$ACC&PRESENT (YDCPG_OPTS, YDCST, YDVARS, YSTACK, ZCP, ZR, Z_YDVARS_GFL_PTR_T0) &
          !$ACC&PRIVATE (JBLK) &
          !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
CASE (1)
  ...
  DO JFLD=1, IFLD
    ...
    IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LTHERMACT) THEN
      ...
      IF (LPARALLELMETHOD ('OPENMP','GPRCP_EXPL_PARALLEL:2')) THEN
        ...
        IF (LSYNCHOST ('GPRCP_EXPL_PARALLEL:2')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPRCP_EXPL_PARALLEL:2')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPRCP_EXPL_PARALLEL:2')) THEN
        ...
        IF (LHOOK) CALL DR_HOOK ('GPRCP_EXPL_PARALLEL:2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
          ...
          !$ACC PARALLEL LOOP GANG &
          !$ACC&PRESENT (YDCPG_OPTS, YDCST, YDVARS, YSTACK, ZCP, ZR, Z_YDVARS_GFL_PTR_T1) &
          !$ACC&PRIVATE (JBLK) &
          !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
CASE (9)
  ...
  DO JFLD=1, IFLD
    ...
    IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LTHERMACT) THEN
      ...
      IF (LPARALLELMETHOD ('OPENMP','GPRCP_EXPL_PARALLEL:3')) THEN
        ...
        IF (LSYNCHOST ('GPRCP_EXPL_PARALLEL:3')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPRCP_EXPL_PARALLEL:3')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPRCP_EXPL_PARALLEL:3')) THEN
        ...
        IF (LHOOK) CALL DR_HOOK ('GPRCP_EXPL_PARALLEL:3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
          ...
          !$ACC PARALLEL LOOP GANG &
          !$ACC&PRESENT (YDCPG_OPTS, YDCST, YDVARS, YSTACK, ZCP, ZR, Z_YDVARS_GFL_PTR_T9) &
          !$ACC&PRIVATE (JBLK) &
          !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','GPRCP_EXPL_PARALLEL:4')) THEN
  ...
  IF (LSYNCHOST ('GPRCP_EXPL_PARALLEL:4')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPRCP_EXPL_PARALLEL:4')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPRCP_EXPL_PARALLEL:4')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('GPRCP_EXPL_PARALLEL:4:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (YDCPG_OPTS, YDCST, YSTACK, ZCP, ZR) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (PRESENT(YD_PKAP)) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','GPRCP_EXPL_PARALLEL:5')) THEN
    ...
    IF (LSYNCHOST ('GPRCP_EXPL_PARALLEL:5')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','GPRCP_EXPL_PARALLEL:5')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','GPRCP_EXPL_PARALLEL:5')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('GPRCP_EXPL_PARALLEL:5:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (PKAP, YDCPG_OPTS, YSTACK, ZCP, ZR) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ENDSUBROUTINE GPRCP_EXPL_PARALLEL
