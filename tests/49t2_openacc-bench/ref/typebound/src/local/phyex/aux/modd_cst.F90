...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_CST_T
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_CST_T
PROCEDURE :: ACDC_HOST => ACDC_HOST_CST_T
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_CST_T
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_CST_T
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_CST_T
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_CST_T
END TYPE CST_t
