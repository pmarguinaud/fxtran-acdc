...
!
CONTAINS
PROCEDURE :: COPY => COPY_CLOUDPAR_T
PROCEDURE :: CRC64 => CRC64_CLOUDPAR_T
PROCEDURE :: HOST => HOST_CLOUDPAR_T
PROCEDURE :: LOAD => LOAD_CLOUDPAR_T
PROCEDURE :: SAVE => SAVE_CLOUDPAR_T
PROCEDURE :: SIZE => SIZE_CLOUDPAR_T
PROCEDURE :: WIPE => WIPE_CLOUDPAR_T
END TYPE CLOUDPAR_t
...
MODULE SUBROUTINE COPY_CLOUDPAR_T (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_CLOUDPAR_T (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_CLOUDPAR_T (SELF)

IMPLICIT NONE
CLASS (CLOUDPAR_T), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_CLOUDPAR_T (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_CLOUDPAR_T (SELF, KLUN)
...
MODULE FUNCTION SIZE_CLOUDPAR_T (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_CLOUDPAR_T (SELF, LDDELETED, LDFIELDAPI)
