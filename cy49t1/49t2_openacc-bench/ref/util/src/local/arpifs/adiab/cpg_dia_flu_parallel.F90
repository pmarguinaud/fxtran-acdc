...
IF (LLCALL_CPCFU.OR.LLCALL_CPXFU.OR.LLCALL_CUMCPLDM) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','CPG_DIA_FLU_PARALLEL:0')) THEN
    ...
    IF (LSYNCHOST ('CPG_DIA_FLU_PARALLEL:0')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:0')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:0')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('CPG_DIA_FLU_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&PRESENT (YDCPG_OPTS, YSTACK, ZSTRCU, ZSTRCV, ZSTRDU, ZSTRDV, ZSTRTU, ZSTRTV, &
      !$ACC&         Z_YDMF_PHYS_OUT_STRCU, Z_YDMF_PHYS_OUT_STRCV, Z_YDMF_PHYS_OUT_STRDU, &
      !$ACC&         Z_YDMF_PHYS_OUT_STRDV, Z_YDMF_PHYS_OUT_STRTU, Z_YDMF_PHYS_OUT_STRTV) &
      !$ACC&PRIVATE (JBLK) &
...
IF (LLCALL_CPXFU.OR.YDMODEL%YRML_PHY_G%YRDPHY%LDIRCLSMOD) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','CPG_DIA_FLU_PARALLEL:1')) THEN
    ...
    IF (LSYNCHOST ('CPG_DIA_FLU_PARALLEL:1')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:1')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:1')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('CPG_DIA_FLU_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YSTACK, ZNUCLS, ZNVCLS, ZUCLS, ZUGST, ZVCLS, ZVGST, Z_YDMF_PHYS_OUT_NUCLS, &
      !$ACC&         Z_YDMF_PHYS_OUT_NVCLS, Z_YDMF_PHYS_OUT_UCLS, Z_YDMF_PHYS_OUT_UGST, &
      !$ACC&         Z_YDMF_PHYS_OUT_VCLS, Z_YDMF_PHYS_OUT_VGST) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDCPG_OPTS%LDIAB.OR.(YDMODEL%YRML_PHY_MF%YRSIMPHL%LSIMPH&
  ...
  IF (LLCALL_CPCFU.OR.LLCALL_CPXFU.OR.LLCALL_CUMCPLDM) THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','CPG_DIA_FLU_PARALLEL:2')) THEN
      ...
      IF (LSYNCHOST ('CPG_DIA_FLU_PARALLEL:2')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:2')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:2')) THEN
  ...
  IF (LLCALL_CPXFU.OR.YDMODEL%YRML_PHY_G%YRDPHY%LDIRCLSMOD) THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','CPG_DIA_FLU_PARALLEL:3')) THEN
      ...
      IF (LSYNCHOST ('CPG_DIA_FLU_PARALLEL:3')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:3')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:3')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('CPG_DIA_FLU_PARALLEL:3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (YDCPG_OPTS, YSTACK, ZNUCLS, ZNVCLS, ZUCLS, ZUGST, ZVCLS, ZVGST, Z_YDVARS_GEOMETRY_GM_P) &
        !$ACC&PRIVATE (JBLK) &
        !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LLCALL_CPXFU) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','CPG_DIA_FLU_PARALLEL:4')) THEN
    ...
    IF (LSYNCHOST ('CPG_DIA_FLU_PARALLEL:4')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:4')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPG_DIA_FLU_PARALLEL:4')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('CPG_DIA_FLU_PARALLEL:4:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, ZDPRECIPS, ZDPRECIPS2, Z_YDMF_PHYS_SURF_GSD_XP2_PPRECIP2, &
      ...
      DO JLON = 1, MIN (YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1) * YDCPG_OPTS%KLON)
        ...
        IF (YDMODEL%YRML_PHY_MF%YRPHY%LDPRECIPS) THEN
          CALL ACPY (JLON, ZDPRECIPS (:, 1:YDMODEL%YRML_PHY_MF%YRPHY%YRDPRECIPS%NDTPREC, JBLK), Z_YDMF_PHYS_SURF_GSD_XP_PPRECIP&
          & (:, 1:YDMODEL%YRML_PHY_MF%YRPHY%YRDPRECIPS%NDTPREC, JBLK))
        ENDIF


        IF (YDMODEL%YRML_PHY_MF%YRPHY%LDPRECIPS2) THEN
          CALL ACPY (JLON, ZDPRECIPS2 (:, 1:YDMODEL%YRML_PHY_MF%YRPHY%YRDPRECIPS%NDTPREC2, JBLK), Z_YDMF_PHYS_SURF_GSD_XP2_PPRECIP2&
          & (:, 1:YDMODEL%YRML_PHY_MF%YRPHY%YRDPRECIPS%NDTPREC2, JBLK))
        ENDIF
...
ENDSUBROUTINE CPG_DIA_FLU_PARALLEL
