...
LOGICAL :: LHDPAS
CONTAINS
PROCEDURE :: COPY => COPY_TSDDH
PROCEDURE :: CRC64 => CRC64_TSDDH
PROCEDURE :: HOST => HOST_TSDDH
PROCEDURE :: LOAD => LOAD_TSDDH
PROCEDURE :: SAVE => SAVE_TSDDH
PROCEDURE :: SIZE => SIZE_TSDDH
PROCEDURE :: WIPE => WIPE_TSDDH
END TYPE TSDDH
...
MODULE SUBROUTINE COPY_TSDDH (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TSDDH (SELF)

IMPLICIT NONE
CLASS (TSDDH), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TSDDH (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TSDDH (SELF, KLUN)
...
MODULE SUBROUTINE WIPE_TSDDH (SELF, LDDELETED, LDFIELDAPI)
