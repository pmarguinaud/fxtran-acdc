...
PROCEDURE :: COPY => COPY_TVDF
PROCEDURE :: CRC64 => CRC64_TVDF
PROCEDURE :: HOST => HOST_TVDF
PROCEDURE :: LOAD => LOAD_TVDF
PROCEDURE :: SAVE => SAVE_TVDF
PROCEDURE :: SIZE => SIZE_TVDF
PROCEDURE :: WIPE => WIPE_TVDF
END TYPE TVDF
!*     *YOEVDF* CONTAINS CONSTANTS NEEDED BY *VDF....*
...
MODULE SUBROUTINE COPY_TVDF (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE LOAD_TVDF (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TVDF (SELF, KLUN)
...
MODULE SUBROUTINE WIPE_TVDF (SELF, LDDELETED, LDFIELDAPI)
