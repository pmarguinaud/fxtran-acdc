...
!  
CONTAINS
PROCEDURE :: COPY => COPY_TURB_T
PROCEDURE :: CRC64 => CRC64_TURB_T
PROCEDURE :: HOST => HOST_TURB_T
PROCEDURE :: LOAD => LOAD_TURB_T
PROCEDURE :: SAVE => SAVE_TURB_T
PROCEDURE :: SIZE => SIZE_TURB_T
PROCEDURE :: WIPE => WIPE_TURB_T
END TYPE TURB_t
...
MODULE SUBROUTINE COPY_TURB_T (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TURB_T (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TURB_T (SELF)

IMPLICIT NONE
CLASS (TURB_T), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TURB_T (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TURB_T (SELF, KLUN)
...
MODULE FUNCTION SIZE_TURB_T (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TURB_T (SELF, LDDELETED, LDFIELDAPI)
