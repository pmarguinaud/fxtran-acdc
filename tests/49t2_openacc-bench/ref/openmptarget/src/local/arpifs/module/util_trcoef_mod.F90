...
LSOLRAD = ALLOCATED (SELF%SOLRAD)
IF (LSOLRAD) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%SOLRAD)
  !$OMP TARGET UPDATE TO (SELF%SOLRAD)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%SOLRAD)
ENDIF

LTHERRAD = ALLOCATED (SELF%THERRAD)
IF (LTHERRAD) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%THERRAD)
  !$OMP TARGET UPDATE TO (SELF%THERRAD)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%THERRAD)
ENDIF

LTRWEIGHT = ALLOCATED (SELF%TRWEIGHT)
IF (LTRWEIGHT) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%TRWEIGHT)
  !$OMP TARGET UPDATE TO (SELF%TRWEIGHT)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%TRWEIGHT)
ENDIF

LTRMATSUM = ALLOCATED (SELF%TRMATSUM)
IF (LTRMATSUM) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%TRMATSUM)
  !$OMP TARGET UPDATE TO (SELF%TRMATSUM)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%TRMATSUM)
ENDIF
...
LSOLRAD = ALLOCATED (SELF%SOLRAD)
IF (LSOLRAD) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%SOLRAD)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%SOLRAD)
ENDIF

LTHERRAD = ALLOCATED (SELF%THERRAD)
IF (LTHERRAD) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%THERRAD)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%THERRAD)
ENDIF

LTRWEIGHT = ALLOCATED (SELF%TRWEIGHT)
IF (LTRWEIGHT) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%TRWEIGHT)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%TRWEIGHT)
ENDIF

LTRMATSUM = ALLOCATED (SELF%TRMATSUM)
IF (LTRMATSUM) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%TRMATSUM)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%TRMATSUM)
ENDIF
