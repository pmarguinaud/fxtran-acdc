...
&, YDSPP_CONFIG, KIDIA, KFDIA, KLON, KGPBLKS, KLEV, KINDEX, LDMIXS, LDTDKMF, PTENH, PQENH&
&, PGEOH, PAPH, PQHFL, PAHFS, PGP2DSPP, PKMFL, PTEN, PQEN, PQSEN, PGEO, PTU, PQU, PLU&
&, PWU2H, PWUBASE, KLAB, LDCUM, LDSC, KCBOT, KBOTSC, KCTOP, KDPL, PCAPE)
...
REAL (KIND=JPRB), INTENT (INOUT)::PWU2H (:, :, :)
