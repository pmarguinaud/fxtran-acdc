...
ELSE
  ...
  IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LRHS_CURV_F')) THEN
    ...
    IF (LSYNCHOST ('LARCINB_PARALLEL:LRHS_CURV_F')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:LRHS_CURV_F')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LRHS_CURV_F')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LRHS_CURV_F:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&         YDLDDH, YDML_DYN, YSTACK, Z_YDCPG_DDH_TND_YSI_U_T0, Z_YDCPG_DDH_TND_YSI_V_T0, &
      !$ACC&         Z_YDCPG_DDH_TND_YSL_U_P, Z_YDCPG_DDH_TND_YSL_V_P, Z_YDCPG_GMVF_NL_U_P, &
      !$ACC&         Z_YDCPG_GMVF_NL_V_P, Z_YDCPG_GMVF_SI_U_P, Z_YDCPG_GMVF_SI_V_P, &
      !$ACC&         Z_YDCPG_GMVF_U_P, Z_YDCPG_GMVF_V_P, Z_YDCPG_SL1_U0_P, Z_YDCPG_SL1_U9_NL_P, &
      !$ACC&         Z_YDCPG_SL1_U9_P, Z_YDCPG_SL1_U9_SI_P, Z_YDCPG_SL1_UF9_P, &
      !$ACC&         Z_YDCPG_SL1_UP9_P, Z_YDCPG_SL1_UR9_P, Z_YDCPG_SL1_V0_P, Z_YDCPG_SL1_V9_NL_P, &
      ...
      DO JROF = 1, MIN (YDCPG_OPTS%KLON, YDCPG_OPTS%KGPCOMP - (JBLK - 1) * YDCPG_OPTS%KLON)
        ...
        IF (YDML_DYN%YRDYN%NWLAG>=3) THEN
          ...
          IF (LD2TLFF1) THEN
            ...
            &), PRSCAW(:,:,:, JBLK), Z_YDCPG_SL1_UR9_P(:,:), PUFZ(:,:, JBLK),YDSTACK=YLSTACK)
          ELSE
            CALL ACPY (JROF, PUFZ (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK),&
            & Z_YDCPG_GMVF_U_P (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK))
          ENDIF
        ...
        IF (YDML_DYN%YRDYN%NWLAG>=3) THEN
          ...
          IF (LD2TLFF1) THEN
            ...
            &), PRSCAW(:,:,:, JBLK), Z_YDCPG_SL1_VR9_P(:,:), PVFZ(:,:, JBLK),YDSTACK=YLSTACK)
          ELSE
            CALL ACPY (JROF, PVFZ (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK),&
            & Z_YDCPG_GMVF_V_P (:, 1:YDGEOMETRY%YRDIMV%NFLEVG, JBLK))
          ENDIF
...
IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LAITRE_GMV')) THEN
  ...
  IF (LSYNCHOST ('LARCINB_PARALLEL:LAITRE_GMV')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:LAITRE_GMV')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LAITRE_GMV')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LAITRE_GMV:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         YSTACK, Z_YDCPG_DDH_TND_YSL_T_P, Z_YDCPG_GMVF_T_P, Z_YDCPG_SL1_T9_P, &
    !$ACC&         Z_YDCPG_SL1_TF9_P) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDML_DYN%YRDYN%NTLAG>=3) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:NTLAG_3')) THEN
    ...
    IF (LSYNCHOST ('LARCINB_PARALLEL:NTLAG_3')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:NTLAG_3')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:NTLAG_3')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:NTLAG_3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (KL0, PLSCAW, YDCPG_OPTS, YDGEOMETRY, YDLDDH, YDML_DYN, YSTACK, Z_YDCPG_DDH_TND_YSI_T_T0, &
      !$ACC&         Z_YDCPG_GMVF_NL_T_P, Z_YDCPG_GMVF_SI_T_P, Z_YDCPG_GMVF_T_P, &
      !$ACC&         Z_YDCPG_SL1_T0_P, Z_YDCPG_SL1_T9_NL_P, Z_YDCPG_SL1_T9_SI_P) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LDSLPHY) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LDSLPHY')) THEN
    ...
    IF (LSYNCHOST ('LARCINB_PARALLEL:LDSLPHY')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:LDSLPHY')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LDSLPHY')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LDSLPHY:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (KL0, PLSCAW, PTPF, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YSTACK, Z_YDCPG_SL1_TP9_P) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
DO JFLD=1, SIZE (YDVARS%GFL_PTR)
  ...
  IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LADV.AND.(.NOT.YDVARS%GFL_PTR (JFLD)%YCOMP%LMGRID)) THEN
    ...
    IF (YDVARS%GFL_PTR (JFLD)%YCOMP%CSLINT (1:3)=="LIN") THEN
      ...
      IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LIN')) THEN
        ...
        IF (LSYNCHOST ('LARCINB_PARALLEL:LIN')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:LIN')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LIN')) THEN
        ...
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LIN:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
          ...
          !$ACC PARALLEL LOOP GANG &
          !$ACC&PRESENT (KL0, PLSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YDML_GCONF, YSTACK, &
    ...
    ELSEIF (YDML_GCONF%YGFL%NUMFLDS_SL1>0.AND.YDML_GCONF%YGFL%NUMFLDS_SPL&
      ...
      IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LAITVSPCQM')) THEN
        ...
        IF (LSYNCHOST ('LARCINB_PARALLEL:LAITVSPCQM')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:LAITVSPCQM')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LAITVSPCQM')) THEN
        ...
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LAITVSPCQM:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
          ...
          !$ACC&         YDVARS, YSTACK, Z_YDCPG_GFLF_GFL_P, Z_YDCPG_SL1_GFL_P, Z_YDCPG_SL1_GFL_P_SP) &
          !$ACC&PRIVATE (JBLK) &
          !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
    ...
    ELSE
      ...
      IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LAITRE_GFL')) THEN
        ...
        IF (LSYNCHOST ('LARCINB_PARALLEL:LAITRE_GFL')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:LAITRE_GFL')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LAITRE_GFL')) THEN
        ...
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LAITRE_GFL:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
          ...
          !$ACC PARALLEL LOOP GANG &
          !$ACC&PRESENT (KL0, KNOWENO, PLSCAW, PRSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YDML_GCONF, &
          !$ACC&         YDVARS, YSTACK, Z_YDCPG_GFLF_GFL_P, Z_YDCPG_SL1_GFL_P) &
          !$ACC&PRIVATE (JBLK) &
          !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
    ...
    IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:RRINTOPT')) THEN
      ...
      IF (LSYNCHOST ('LARCINB_PARALLEL:RRINTOPT')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:RRINTOPT')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:RRINTOPT')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:RRINTOPT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YDLDDH, YDML_DYN, YSTACK, Z_YDCPG_DDH_TND_YSL_GFL_P, &
        !$ACC&         Z_YDCPG_GFLF_GFL_P) &
        !$ACC&PRIVATE (JBLK) &
        !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
    ...
    IF (.NOT.(YDML_DYN%YRDYN%NSPLTHOI==0.OR.YDVARS%GFL_PTR (JFLD)%YCOMP%LTDIABLIN)) THEN
      ...
      IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LTDIABLIN')) THEN
        ...
        IF (LSYNCHOST ('LARCINB_PARALLEL:LTDIABLIN')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:LTDIABLIN')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LTDIABLIN')) THEN
        ...
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LTDIABLIN:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
          ...
          !$ACC PARALLEL LOOP GANG &
          !$ACC&PRESENT (KL0, KNOWENO, PLSCAW, PRSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YDML_GCONF, &
          !$ACC&         YDVARS, YSTACK, ZGFLF, Z_YDCPG_GFLF_GFL_P, Z_YDCPG_SL1_GFL_P, &
    ...
    IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LTDIABLIN) THEN
      ...
      IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LLCOMAD')) THEN
        ...
        IF (LSYNCHOST ('LARCINB_PARALLEL:LLCOMAD')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:LLCOMAD')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LLCOMAD')) THEN
        ...
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LLCOMAD:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
          ...
          !$ACC PARALLEL LOOP GANG &
          !$ACC&PRESENT (KL0, PLSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YSTACK, Z_YDCPG_GFLF_GFL_P, &
          !$ACC&         Z_YDCPG_SL1_GFL_P_F) &
          !$ACC&PRIVATE (JBLK) &
          !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
  ...
  IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LADV) THEN
    ...
    IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LPHY.AND.LDSLPHY) THEN
      ...
      IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LLCOMAD_2')) THEN
        ...
        IF (LSYNCHOST ('LARCINB_PARALLEL:LLCOMAD_2')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:LLCOMAD_2')) THEN
      ...
      ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LLCOMAD_2')) THEN
        ...
        IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LLCOMAD_2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
          ...
          !$ACC PARALLEL LOOP GANG &
          !$ACC&PRESENT (KL0, PLSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YSTACK, Z_YDCPG_GFLPF_GFL_P, &
          !$ACC&         Z_YDCPG_SL1_GFL_P_P) &
          !$ACC&PRIVATE (JBLK) &
          !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDML_DYN%YRDYN%NVLAG==2) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:NVLAG_2')) THEN
    ...
    IF (LSYNCHOST ('LARCINB_PARALLEL:NVLAG_2')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:NVLAG_2')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:NVLAG_2')) THEN
...
IF (YDML_DYN%YRDYN%NVLAG==3) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:NVLAG_3')) THEN
    ...
    IF (LSYNCHOST ('LARCINB_PARALLEL:NVLAG_3')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:NVLAG_3')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:NVLAG_3')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:NVLAG_3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&         YSTACK, Z_YDCPG_SL1_C9_NL_P, Z_YDCPG_SL1_C9_P, Z_YDCPG_SL1_C9_SI_P) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDML_DYN%YRDYNA%NQMGMV==-4) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:NQMGMV')) THEN
    ...
    IF (LSYNCHOST ('LARCINB_PARALLEL:NQMGMV')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:NQMGMV')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:NQMGMV')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:NQMGMV:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (KLH0, PDP, PLSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YSTACK, Z_YDCPG_SL1_SP9_P) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ELSE
  ...
  IF (LPARALLELMETHOD ('OPENMP','LARCINB_PARALLEL:LCOMAD_SP')) THEN
    ...
    IF (LSYNCHOST ('LARCINB_PARALLEL:LCOMAD_SP')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LARCINB_PARALLEL:LCOMAD_SP')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LARCINB_PARALLEL:LCOMAD_SP')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LARCINB_PARALLEL:LCOMAD_SP:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (KLH0, PDP, PLSCAW, PRSCAW, YDCPG_OPTS, YDGEOMETRY, YDML_DYN, YSTACK, &
...
ENDSUBROUTINE LARCINB_PARALLEL
