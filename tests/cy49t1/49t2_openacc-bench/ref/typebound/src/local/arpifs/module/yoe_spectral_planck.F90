...
PROCEDURE :: COPY => COPY_TSPECTRALPLANCK
PROCEDURE :: CRC64 => CRC64_TSPECTRALPLANCK
PROCEDURE :: HOST => HOST_TSPECTRALPLANCK
PROCEDURE :: LOAD => LOAD_TSPECTRALPLANCK
PROCEDURE :: SAVE => SAVE_TSPECTRALPLANCK
PROCEDURE :: SIZE => SIZE_TSPECTRALPLANCK
PROCEDURE :: WIPE => WIPE_TSPECTRALPLANCK
END TYPE TSPECTRALPLANCK

INTERFACE

MODULE SUBROUTINE COPY_TSPECTRALPLANCK (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TSPECTRALPLANCK (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TSPECTRALPLANCK (SELF)

IMPLICIT NONE
CLASS (TSPECTRALPLANCK), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TSPECTRALPLANCK (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TSPECTRALPLANCK (SELF, KLUN)
...
MODULE FUNCTION SIZE_TSPECTRALPLANCK (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TSPECTRALPLANCK (SELF, LDDELETED, LDFIELDAPI)
