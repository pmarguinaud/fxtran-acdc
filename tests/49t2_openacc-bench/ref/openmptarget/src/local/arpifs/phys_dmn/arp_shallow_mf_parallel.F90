...
IF (YDCPG_OPTS%NSTEP==0) THEN
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ARP_SHALLOW_MF_PARALLEL:ZERO')) THEN
    ...
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YFXTRAN_ACDC_STACK, Z_YDMF_PHYS_SURF_GSD_SFL_PGROUP)  & 
    !$OMP & PRIVATE (JBLK)  & 
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','ARP_SHALLOW_MF_PARALLEL:INIT')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (PQLI, YD_PQLI)
  ...
  CALL SGET_HOST_DATA_RDONLY (PZZ, YD_PZZ)
  CALL SGET_HOST_DATA_RDONLY (PZZF, YD_PZZF)
  CALL SGET_HOST_DATA_RDWR (ZDPSG, YL_ZDPSG)
  CALL SGET_HOST_DATA_RDWR (ZDRTDT_MF, YL_ZDRTDT_MF)
  CALL SGET_HOST_DATA_RDWR (ZDTHLDT_MF, YL_ZDTHLDT_MF)
  CALL SGET_HOST_DATA_RDWR (ZDUDT_MF, YL_ZDUDT_MF)
  CALL SGET_HOST_DATA_RDWR (ZDVDT_MF, YL_ZDVDT_MF)
  CALL SGET_HOST_DATA_RDWR (ZDZZ, YL_ZDZZ)
  CALL SGET_HOST_DATA_RDWR (ZEMF, YL_ZEMF)
  CALL SGET_HOST_DATA_RDWR (ZEXNER, YL_ZEXNER)
  CALL SGET_HOST_DATA_RDWR (ZFLXZTHMF, YL_ZFLXZTHMF)
  CALL SGET_HOST_DATA_RDWR (ZFLXZTHVMF, YL_ZFLXZTHVMF)
  CALL SGET_HOST_DATA_RDWR (ZFLXZUMF, YL_ZFLXZUMF)
  CALL SGET_HOST_DATA_RDWR (ZFLXZVMF, YL_ZFLXZVMF)
  CALL SGET_HOST_DATA_RDWR (ZFRAC_UP, YL_ZFRAC_UP)
  CALL SGET_HOST_DATA_RDWR (ZHRO, YL_ZHRO)
  CALL SGET_HOST_DATA_RDWR (ZHRODJ, YL_ZHRODJ)
  CALL SGET_HOST_DATA_RDWR (ZHRODREF, YL_ZHRODREF)
  CALL SGET_HOST_DATA_RDWR (ZQDM, YL_ZQDM)
  CALL SGET_HOST_DATA_RDWR (ZRC_UP, YL_ZRC_UP)
  CALL SGET_HOST_DATA_RDWR (ZRI_UP, YL_ZRI_UP)
  CALL SGET_HOST_DATA_RDWR (ZRM, YL_ZRM)
  CALL SGET_HOST_DATA_RDWR (ZRT_UP, YL_ZRT_UP)
  CALL SGET_HOST_DATA_RDWR (ZRV_UP, YL_ZRV_UP)
  CALL SGET_HOST_DATA_RDWR (ZSFRV, YL_ZSFRV)
  CALL SGET_HOST_DATA_RDWR (ZSFTH, YL_ZSFTH)
  CALL SGET_HOST_DATA_RDWR (ZSVM, YL_ZSVM)
  CALL SGET_HOST_DATA_RDWR (ZTHETA, YL_ZTHETA)
  CALL SGET_HOST_DATA_RDWR (ZTHL_UP, YL_ZTHL_UP)
  CALL SGET_HOST_DATA_RDWR (ZU_UP, YL_ZU_UP)
  CALL SGET_HOST_DATA_RDWR (ZW_UP, YL_ZW_UP)
  CALL SGET_HOST_DATA_RDWR (ZZZ, YL_ZZZ)
  CALL SGET_HOST_DATA_RDWR (ZZZF, YL_ZZZF)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_SFL_PGROUP, YDMF_PHYS_SURF%GSD_SFL%F_GROUP)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('ARP_SHALLOW_MF_PARALLEL:INIT')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (PZZ, YD_PZZ)
    CALL SGET_HOST_DATA_RDWR (PZZF, YD_PZZF)
    CALL SGET_HOST_DATA_RDWR (ZDPSG, YL_ZDPSG)
    CALL SGET_HOST_DATA_RDWR (ZDRTDT_MF, YL_ZDRTDT_MF)
    CALL SGET_HOST_DATA_RDWR (ZDTHLDT_MF, YL_ZDTHLDT_MF)
    CALL SGET_HOST_DATA_RDWR (ZDUDT_MF, YL_ZDUDT_MF)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ARP_SHALLOW_MF_PARALLEL:INIT')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDWR (PQLI, YD_PQLI)
  ...
  CALL SGET_DEVICE_DATA_RDONLY (PZZ, YD_PZZ)
  CALL SGET_DEVICE_DATA_RDONLY (PZZF, YD_PZZF)
  CALL SGET_DEVICE_DATA_RDWR (ZDPSG, YL_ZDPSG)
  CALL SGET_DEVICE_DATA_RDWR (ZDRTDT_MF, YL_ZDRTDT_MF)
  CALL SGET_DEVICE_DATA_RDWR (ZDTHLDT_MF, YL_ZDTHLDT_MF)
  CALL SGET_DEVICE_DATA_RDWR (ZDUDT_MF, YL_ZDUDT_MF)
  CALL SGET_DEVICE_DATA_RDWR (ZDVDT_MF, YL_ZDVDT_MF)
  CALL SGET_DEVICE_DATA_RDWR (ZDZZ, YL_ZDZZ)
  CALL SGET_DEVICE_DATA_RDWR (ZEMF, YL_ZEMF)
  CALL SGET_DEVICE_DATA_RDWR (ZEXNER, YL_ZEXNER)
  CALL SGET_DEVICE_DATA_RDWR (ZFLXZTHMF, YL_ZFLXZTHMF)
  CALL SGET_DEVICE_DATA_RDWR (ZFLXZTHVMF, YL_ZFLXZTHVMF)
  CALL SGET_DEVICE_DATA_RDWR (ZFLXZUMF, YL_ZFLXZUMF)
  CALL SGET_DEVICE_DATA_RDWR (ZFLXZVMF, YL_ZFLXZVMF)
  CALL SGET_DEVICE_DATA_RDWR (ZFRAC_UP, YL_ZFRAC_UP)
  CALL SGET_DEVICE_DATA_RDWR (ZHRO, YL_ZHRO)
  CALL SGET_DEVICE_DATA_RDWR (ZHRODJ, YL_ZHRODJ)
  CALL SGET_DEVICE_DATA_RDWR (ZHRODREF, YL_ZHRODREF)
  CALL SGET_DEVICE_DATA_RDWR (ZQDM, YL_ZQDM)
  CALL SGET_DEVICE_DATA_RDWR (ZRC_UP, YL_ZRC_UP)
  CALL SGET_DEVICE_DATA_RDWR (ZRI_UP, YL_ZRI_UP)
  CALL SGET_DEVICE_DATA_RDWR (ZRM, YL_ZRM)
  CALL SGET_DEVICE_DATA_RDWR (ZRT_UP, YL_ZRT_UP)
  CALL SGET_DEVICE_DATA_RDWR (ZRV_UP, YL_ZRV_UP)
  CALL SGET_DEVICE_DATA_RDWR (ZSFRV, YL_ZSFRV)
  CALL SGET_DEVICE_DATA_RDWR (ZSFTH, YL_ZSFTH)
  CALL SGET_DEVICE_DATA_RDWR (ZSVM, YL_ZSVM)
  CALL SGET_DEVICE_DATA_RDWR (ZTHETA, YL_ZTHETA)
  CALL SGET_DEVICE_DATA_RDWR (ZTHL_UP, YL_ZTHL_UP)
  CALL SGET_DEVICE_DATA_RDWR (ZU_UP, YL_ZU_UP)
  CALL SGET_DEVICE_DATA_RDWR (ZW_UP, YL_ZW_UP)
  CALL SGET_DEVICE_DATA_RDWR (ZZZ, YL_ZZZ)
  CALL SGET_DEVICE_DATA_RDWR (ZZZF, YL_ZZZF)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_SFL_PGROUP, YDMF_PHYS_SURF%GSD_SFL%F_GROUP)
  IF (LHOOK) CALL DR_HOOK ('ARP_SHALLOW_MF_PARALLEL:INIT:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('ARP_SHALLOW_MF_PARALLEL:INIT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:KNLAB, PAPRSF, PDELP, PMF_UP, PQI, PQL, PQLI, PQR, PQS, PQV, PR, PT, PZZ, PZZF,  & 
  !$OMP &          YDCPG_OPTS, YDCST, YFXTRAN_ACDC_STACK, ZDPSG, ZDRTDT_MF, ZDTHLDT_MF,  & 
  !$OMP &          ZDUDT_MF, ZDVDT_MF, ZDZZ, ZEMF, ZEXNER, ZFLXZTHMF, ZFLXZTHVMF, ZFLXZUMF,  & 
  !$OMP &          ZFLXZVMF, ZFRAC_UP, ZHRO, ZHRODJ, ZHRODREF, ZQDM, ZRC_UP, ZRI_UP, ZRM,  & 
  !$OMP &          ZRT_UP, ZRV_UP, ZSFRV, ZSFTH, ZSVM, ZTHETA, ZTHL_UP, ZU_UP, ZW_UP, ZZZ,  & 
  !$OMP &          ZZZF, Z_YDMF_PHYS_SURF_GSD_SFL_PGROUP)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','ARP_SHALLOW_MF_PARALLEL:SHALLOW_MF')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (IKCTL, YL_IKCTL)
  CALL SGET_HOST_DATA_RDWR (IKETL, YL_IKETL)
  CALL SGET_HOST_DATA_RDWR (IKLCL, YL_IKLCL)
  CALL SGET_HOST_DATA_RDONLY (PAPRSF, YD_PAPRSF)
  ...
  CALL SGET_HOST_DATA_RDWR (ZDETR, YL_ZDETR)
  CALL SGET_HOST_DATA_RDWR (ZDRTDT_MF, YL_ZDRTDT_MF)
  CALL SGET_HOST_DATA_RDWR (ZDTHLDT_MF, YL_ZDTHLDT_MF)
  CALL SGET_HOST_DATA_RDWR (ZDUDT_MF, YL_ZDUDT_MF)
  CALL SGET_HOST_DATA_RDWR (ZDVDT_MF, YL_ZDVDT_MF)
  CALL SGET_HOST_DATA_RDONLY (ZDZZ, YL_ZDZZ)
  CALL SGET_HOST_DATA_RDWR (ZEMF, YL_ZEMF)
  CALL SGET_HOST_DATA_RDWR (ZENTR, YL_ZENTR)
  CALL SGET_HOST_DATA_RDONLY (ZEXNER, YL_ZEXNER)
  CALL SGET_HOST_DATA_RDWR (ZFLXZRMF, YL_ZFLXZRMF)
  CALL SGET_HOST_DATA_RDWR (ZFLXZTHMF, YL_ZFLXZTHMF)
  CALL SGET_HOST_DATA_RDWR (ZFLXZTHVMF, YL_ZFLXZTHVMF)
  CALL SGET_HOST_DATA_RDWR (ZFLXZUMF, YL_ZFLXZUMF)
  CALL SGET_HOST_DATA_RDWR (ZFLXZVMF, YL_ZFLXZVMF)
  CALL SGET_HOST_DATA_RDWR (ZFRAC_UP, YL_ZFRAC_UP)
  CALL SGET_HOST_DATA_RDONLY (ZHRODJ, YL_ZHRODJ)
  CALL SGET_HOST_DATA_RDONLY (ZHRODREF, YL_ZHRODREF)
  CALL SGET_HOST_DATA_RDWR (ZRC_UP, YL_ZRC_UP)
  CALL SGET_HOST_DATA_RDWR (ZRI_UP, YL_ZRI_UP)
  CALL SGET_HOST_DATA_RDONLY (ZRM, YL_ZRM)
  CALL SGET_HOST_DATA_RDWR (ZRT_UP, YL_ZRT_UP)
  CALL SGET_HOST_DATA_RDWR (ZRV_UP, YL_ZRV_UP)
  CALL SGET_HOST_DATA_RDONLY (ZSFRV, YL_ZSFRV)
  CALL SGET_HOST_DATA_RDONLY (ZSFTH, YL_ZSFTH)
  CALL SGET_HOST_DATA_RDWR (ZSIGMF, YL_ZSIGMF)
  CALL SGET_HOST_DATA_RDWR (ZSVDT_MF, YL_ZSVDT_MF)
  CALL SGET_HOST_DATA_RDONLY (ZSVM, YL_ZSVM)
  CALL SGET_HOST_DATA_RDONLY (ZTHETA, YL_ZTHETA)
  CALL SGET_HOST_DATA_RDWR (ZTHL_UP, YL_ZTHL_UP)
  CALL SGET_HOST_DATA_RDWR (ZTHV_UP, YL_ZTHV_UP)
  CALL SGET_HOST_DATA_RDWR (ZU_UP, YL_ZU_UP)
  CALL SGET_HOST_DATA_RDWR (ZV_UP, YL_ZV_UP)
  CALL SGET_HOST_DATA_RDWR (ZW_UP, YL_ZW_UP)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
  ...
  IF (LHOOK) CALL DR_HOOK ('ARP_SHALLOW_MF_PARALLEL:SHALLOW_MF:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (IKCTL, YL_IKCTL)
  CALL SGET_DEVICE_DATA_RDWR (IKETL, YL_IKETL)
  CALL SGET_DEVICE_DATA_RDWR (IKLCL, YL_IKLCL)
  CALL SGET_DEVICE_DATA_RDONLY (PAPRSF, YD_PAPRSF)
  CALL SGET_DEVICE_DATA_RDWR (PNEB, YD_PNEB)
  CALL SGET_DEVICE_DATA_RDONLY (PTKE, YD_PTKE)
  CALL SGET_DEVICE_DATA_RDONLY (PU, YD_PU)
  CALL SGET_DEVICE_DATA_RDONLY (PV, YD_PV)
  CALL SGET_DEVICE_DATA_RDWR (ZDETR, YL_ZDETR)
  CALL SGET_DEVICE_DATA_RDWR (ZDRTDT_MF, YL_ZDRTDT_MF)
  CALL SGET_DEVICE_DATA_RDWR (ZDTHLDT_MF, YL_ZDTHLDT_MF)
  CALL SGET_DEVICE_DATA_RDWR (ZDUDT_MF, YL_ZDUDT_MF)
  CALL SGET_DEVICE_DATA_RDWR (ZDVDT_MF, YL_ZDVDT_MF)
  CALL SGET_DEVICE_DATA_RDONLY (ZDZZ, YL_ZDZZ)
  CALL SGET_DEVICE_DATA_RDWR (ZEMF, YL_ZEMF)
  CALL SGET_DEVICE_DATA_RDWR (ZENTR, YL_ZENTR)
  CALL SGET_DEVICE_DATA_RDONLY (ZEXNER, YL_ZEXNER)
  CALL SGET_DEVICE_DATA_RDWR (ZFLXZRMF, YL_ZFLXZRMF)
  CALL SGET_DEVICE_DATA_RDWR (ZFLXZTHMF, YL_ZFLXZTHMF)
  CALL SGET_DEVICE_DATA_RDWR (ZFLXZTHVMF, YL_ZFLXZTHVMF)
  CALL SGET_DEVICE_DATA_RDWR (ZFLXZUMF, YL_ZFLXZUMF)
  CALL SGET_DEVICE_DATA_RDWR (ZFLXZVMF, YL_ZFLXZVMF)
  CALL SGET_DEVICE_DATA_RDWR (ZFRAC_UP, YL_ZFRAC_UP)
  CALL SGET_DEVICE_DATA_RDONLY (ZHRODJ, YL_ZHRODJ)
  CALL SGET_DEVICE_DATA_RDONLY (ZHRODREF, YL_ZHRODREF)
  CALL SGET_DEVICE_DATA_RDWR (ZRC_UP, YL_ZRC_UP)
  CALL SGET_DEVICE_DATA_RDWR (ZRI_UP, YL_ZRI_UP)
  CALL SGET_DEVICE_DATA_RDONLY (ZRM, YL_ZRM)
  CALL SGET_DEVICE_DATA_RDWR (ZRT_UP, YL_ZRT_UP)
  CALL SGET_DEVICE_DATA_RDWR (ZRV_UP, YL_ZRV_UP)
  CALL SGET_DEVICE_DATA_RDONLY (ZSFRV, YL_ZSFRV)
  CALL SGET_DEVICE_DATA_RDONLY (ZSFTH, YL_ZSFTH)
  CALL SGET_DEVICE_DATA_RDWR (ZSIGMF, YL_ZSIGMF)
  CALL SGET_DEVICE_DATA_RDWR (ZSVDT_MF, YL_ZSVDT_MF)
  CALL SGET_DEVICE_DATA_RDONLY (ZSVM, YL_ZSVM)
  CALL SGET_DEVICE_DATA_RDONLY (ZTHETA, YL_ZTHETA)
  CALL SGET_DEVICE_DATA_RDWR (ZTHL_UP, YL_ZTHL_UP)
  CALL SGET_DEVICE_DATA_RDWR (ZTHV_UP, YL_ZTHV_UP)
  CALL SGET_DEVICE_DATA_RDWR (ZU_UP, YL_ZU_UP)
  CALL SGET_DEVICE_DATA_RDWR (ZV_UP, YL_ZV_UP)
  CALL SGET_DEVICE_DATA_RDWR (ZW_UP, YL_ZW_UP)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & COPYIN (D)  & 
  !$OMP & MAP(PRESENT:IKCTL, IKETL, IKLCL, PAPRSF, PNEB, PTKE, PU, PV, YDCPG_OPTS, YDPHYEX, YFXTRAN_ACDC_STACK,  & 
  !$OMP &          ZDETR, ZDRTDT_MF, ZDTHLDT_MF, ZDUDT_MF, ZDVDT_MF, ZDZZ, ZEMF, ZENTR,  & 
  !$OMP &          ZEXNER, ZFLXZRMF, ZFLXZTHMF, ZFLXZTHVMF, ZFLXZUMF, ZFLXZVMF, ZFRAC_UP,  & 
  !$OMP &          ZHRODJ, ZHRODREF, ZRC_UP, ZRI_UP, ZRM, ZRT_UP, ZRV_UP, ZSFRV, ZSFTH,  & 
  !$OMP &          ZSIGMF, ZSVDT_MF, ZSVM, ZTHETA, ZTHL_UP, ZTHV_UP, ZU_UP, ZV_UP, ZW_UP,  & 
  !$OMP &          ZZZ)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','ARP_SHALLOW_MF_PARALLEL:FINISH')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (PDIFTQ, YD_PDIFTQ)
  CALL SGET_HOST_DATA_RDWR (PDIFTS, YD_PDIFTS)
  CALL SGET_HOST_DATA_RDWR (PMF_UP, YD_PMF_UP)
  CALL SGET_HOST_DATA_RDWR (PQLI, YD_PQLI)
  CALL SGET_HOST_DATA_RDWR (PRODTH_CVPP, YD_PRODTH_CVPP)
  ...
  CALL SGET_HOST_DATA_RDONLY (ZDRTDT_MF, YL_ZDRTDT_MF)
  CALL SGET_HOST_DATA_RDONLY (ZDTHLDT_MF, YL_ZDTHLDT_MF)
  CALL SGET_HOST_DATA_RDONLY (ZDUDT_MF, YL_ZDUDT_MF)
  CALL SGET_HOST_DATA_RDONLY (ZDVDT_MF, YL_ZDVDT_MF)
  CALL SGET_HOST_DATA_RDONLY (ZEMF, YL_ZEMF)
  CALL SGET_HOST_DATA_RDONLY (ZEXNER, YL_ZEXNER)
  CALL SGET_HOST_DATA_RDWR (ZFH_MF, YL_ZFH_MF)
  CALL SGET_HOST_DATA_RDONLY (ZFLXZTHVMF, YL_ZFLXZTHVMF)
  CALL SGET_HOST_DATA_RDWR (ZFQ_MF, YL_ZFQ_MF)
  CALL SGET_HOST_DATA_RDWR (ZFU_MF, YL_ZFU_MF)
  CALL SGET_HOST_DATA_RDWR (ZFV_MF, YL_ZFV_MF)
  CALL SGET_HOST_DATA_RDONLY (ZHRODREF, YL_ZHRODREF)
  CALL SGET_HOST_DATA_RDONLY (ZQDM, YL_ZQDM)
  CALL SGET_HOST_DATA_RDONLY (ZRC_UP, YL_ZRC_UP)
  CALL SGET_HOST_DATA_RDONLY (ZRI_UP, YL_ZRI_UP)
  CALL SGET_HOST_DATA_RDONLY (ZRT_UP, YL_ZRT_UP)
  CALL SGET_HOST_DATA_RDONLY (ZTHETA, YL_ZTHETA)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ARP_SHALLOW_MF_PARALLEL:FINISH')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDWR (PDIFTQ, YD_PDIFTQ)
  CALL SGET_DEVICE_DATA_RDWR (PDIFTS, YD_PDIFTS)
  CALL SGET_DEVICE_DATA_RDWR (PMF_UP, YD_PMF_UP)
  CALL SGET_DEVICE_DATA_RDWR (PQLI, YD_PQLI)
  CALL SGET_DEVICE_DATA_RDWR (PRODTH_CVPP, YD_PRODTH_CVPP)
  CALL SGET_DEVICE_DATA_RDWR (PSTRTU, YD_PSTRTU)
  CALL SGET_DEVICE_DATA_RDWR (PSTRTV, YD_PSTRTV)
  CALL SGET_DEVICE_DATA_RDONLY (PT, YD_PT)
  CALL SGET_DEVICE_DATA_RDONLY (ZDPSG, YL_ZDPSG)
  CALL SGET_DEVICE_DATA_RDONLY (ZDRTDT_MF, YL_ZDRTDT_MF)
  CALL SGET_DEVICE_DATA_RDONLY (ZDTHLDT_MF, YL_ZDTHLDT_MF)
  CALL SGET_DEVICE_DATA_RDONLY (ZDUDT_MF, YL_ZDUDT_MF)
  CALL SGET_DEVICE_DATA_RDONLY (ZDVDT_MF, YL_ZDVDT_MF)
  CALL SGET_DEVICE_DATA_RDONLY (ZEMF, YL_ZEMF)
  CALL SGET_DEVICE_DATA_RDONLY (ZEXNER, YL_ZEXNER)
  CALL SGET_DEVICE_DATA_RDWR (ZFH_MF, YL_ZFH_MF)
  CALL SGET_DEVICE_DATA_RDONLY (ZFLXZTHVMF, YL_ZFLXZTHVMF)
  CALL SGET_DEVICE_DATA_RDWR (ZFQ_MF, YL_ZFQ_MF)
  CALL SGET_DEVICE_DATA_RDWR (ZFU_MF, YL_ZFU_MF)
  CALL SGET_DEVICE_DATA_RDWR (ZFV_MF, YL_ZFV_MF)
  CALL SGET_DEVICE_DATA_RDONLY (ZHRODREF, YL_ZHRODREF)
  CALL SGET_DEVICE_DATA_RDONLY (ZQDM, YL_ZQDM)
  CALL SGET_DEVICE_DATA_RDONLY (ZRC_UP, YL_ZRC_UP)
  CALL SGET_DEVICE_DATA_RDONLY (ZRI_UP, YL_ZRI_UP)
  CALL SGET_DEVICE_DATA_RDONLY (ZRT_UP, YL_ZRT_UP)
  CALL SGET_DEVICE_DATA_RDONLY (ZTHETA, YL_ZTHETA)
  IF (LHOOK) CALL DR_HOOK ('ARP_SHALLOW_MF_PARALLEL:FINISH:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('ARP_SHALLOW_MF_PARALLEL:FINISH:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:KNLAB, PCP, PDIFTQ, PDIFTS, PMF_UP, PQLI, PRODTH_CVPP, PSTRTU, PSTRTV,  & 
  !$OMP &          PT, YDCPG_OPTS, YDCST, YFXTRAN_ACDC_STACK, ZDPSG, ZDRTDT_MF, ZDTHLDT_MF,  & 
  !$OMP &          ZDUDT_MF, ZDVDT_MF, ZEMF, ZEXNER, ZFH_MF, ZFLXZTHVMF, ZFQ_MF, ZFU_MF,  & 
  !$OMP &          ZFV_MF, ZHRODREF, ZQDM, ZRC_UP, ZRI_UP, ZRT_UP, ZTHETA)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
  ...
  DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
    ...
    !$OMP PARALLEL DO SIMD  & 
    !$OMP & PRIVATE (JLEV, JLON, YLCPG_BNDS, ZTDCP)       
