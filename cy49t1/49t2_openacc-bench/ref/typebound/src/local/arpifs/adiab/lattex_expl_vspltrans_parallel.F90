...
DO JGFL=1, SIZE (YDCPG_SL1%GFL)
  ...
  IF (YDCPG_SL1%GFL (JGFL)%YCOMP%LADV.AND.YDCPG_SL1%GFL (JGFL)%YCOMP%CSLINT=='LAITVSPCQM  ') THEN
    ...
    IF ((YDML_DYN%YRDYN%NSPLTHOI/=0).OR.LLTDIABLIN) THEN
      ...
      IF (LPARALLELMETHOD ('OPENMP','LATTEX_EXPL_VSPLTRANS_PARALLEL:0')) THEN
        ...
        IF (LSYNCHOST ('LATTEX_EXPL_VSPLTRANS_PARALLEL:0')) THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','LATTEX_EXPL_VSPLTRANS_PARALLEL:1')) THEN
      ...
      IF (LSYNCHOST ('LATTEX_EXPL_VSPLTRANS_PARALLEL:1')) THEN
...
ENDSUBROUTINE LATTEX_EXPL_VSPLTRANS_PARALLEL
