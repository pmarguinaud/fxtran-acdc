...
SUBROUTINE SAVE_TERAD (SELF, KLUN)
...
CALL SAVE_TSPECTRALPLANCK (SELF%YSPECTPLANCK, KLUN)
END SUBROUTINE

SUBROUTINE LOAD_TERAD (SELF, KLUN)
USE UTIL_TSPECTRALPLANCK_MOD
...
CALL LOAD_TSPECTRALPLANCK (SELF%YSPECTPLANCK, KLUN)
END SUBROUTINE


SUBROUTINE COPY_TERAD (SELF, LDCREATED, LDFIELDAPI)
USE UTIL_TSPECTRALPLANCK_MOD
IMPLICIT NONE
TYPE (TERAD), INTENT (IN), TARGET :: SELF
...
CALL COPY_TSPECTRALPLANCK (SELF%YSPECTPLANCK, LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)

END SUBROUTINE

SUBROUTINE HOST_TERAD (SELF)
USE UTIL_TSPECTRALPLANCK_MOD
...
CALL HOST_TSPECTRALPLANCK (SELF%YSPECTPLANCK)

END SUBROUTINE

     

SUBROUTINE CRC64_TERAD (SELF, KLUN, CDPATH)
USE UTIL_TSPECTRALPLANCK_MOD
...
CLIND = ''
CALL CRC64_TSPECTRALPLANCK (SELF%YSPECTPLANCK, KLUN, CDPATH//'%YSPECTPLANCK'//TRIM(CLIND))

END SUBROUTINE

SUBROUTINE WIPE_TERAD (SELF, LDDELETED, LDFIELDAPI)
USE UTIL_TSPECTRALPLANCK_MOD
IMPLICIT NONE
TYPE (TERAD), INTENT (IN), TARGET :: SELF
...
CALL WIPE_TSPECTRALPLANCK (SELF%YSPECTPLANCK, LDDELETED=.TRUE., LDFIELDAPI=LDFIELDAPI)
...
FUNCTION SIZE_TERAD (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
USE UTIL_TSPECTRALPLANCK_MOD
IMPLICIT NONE
TYPE (TERAD),     INTENT (IN), TARGET :: SELF
...
KSIZE = KSIZE + ISIZE
JSIZE = 0
ISIZE = SIZE_TSPECTRALPLANCK (SELF%YSPECTPLANCK, CLPATH//'%YSPECTPLANCK', .FALSE.)
JSIZE = JSIZE + ISIZE
KSIZE = KSIZE + ISIZE
IF (LLPRINT) THEN
