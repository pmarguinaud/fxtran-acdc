...
INTERFACE COPY
MODULE PROCEDURE COPY_VARIABLE_3RD
END INTERFACE

INTERFACE HOST
MODULE PROCEDURE HOST_VARIABLE_3RD
END INTERFACE

INTERFACE LEGACY
MODULE PROCEDURE LEGACY_VARIABLE_3RD
END INTERFACE
     
INTERFACE CRC64
MODULE PROCEDURE CRC64_VARIABLE_3RD
END INTERFACE

INTERFACE WIPE
MODULE PROCEDURE WIPE_VARIABLE_3RD
END INTERFACE

INTERFACE SIZE
MODULE PROCEDURE SIZE_VARIABLE_3RD
END INTERFACE
...
SUBROUTINE COPY_VARIABLE_3RD (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE HOST_VARIABLE_3RD (SELF)
USE FIELD_UTIL_MODULE
...
SUBROUTINE LEGACY_VARIABLE_3RD (SELF, KADDRL, KADDRU, KDIR)
USE FIELD_UTIL_MODULE
...
SUBROUTINE CRC64_VARIABLE_3RD (SELF, KLUN, CDPATH)
USE FIELD_UTIL_MODULE
...
SUBROUTINE WIPE_VARIABLE_3RD (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
...
FUNCTION SIZE_VARIABLE_3RD (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
USE FIELD_UTIL_MODULE
