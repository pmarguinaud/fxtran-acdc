...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LAVENT_PARALLEL:0')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (KSETTLOFF, YD_KSETTLOFF)
  CALL SGET_HOST_DATA_RDWR (PALPHA, YD_PALPHA)
  CALL SGET_HOST_DATA_RDONLY (PEVEL, YD_PEVEL)
  CALL SGET_HOST_DATA_RDONLY (PRDELP, YD_PRDELP)
  CALL SGET_HOST_DATA_RDWR (PWRL9, YD_PWRL9)
  CALL SGET_HOST_DATA_RDWR (ZWRL0, YL_ZWRL0)
  ...
  CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_ZRL, YDCPG_SL2%F_ZRL)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_TND_TNDU, YDCPG_TND%F_TNDU)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_TND_TNDV, YDCPG_TND%F_TNDV)
  CALL SGET_HOST_DATA_RDWR (Z_YDVARS_EDOT_T9, YDVARS%EDOT%FT9)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAVENT_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('LAVENT_PARALLEL:0:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (KSETTLOFF, YD_KSETTLOFF)
  CALL SGET_DEVICE_DATA_RDWR (PALPHA, YD_PALPHA)
  CALL SGET_DEVICE_DATA_RDONLY (PEVEL, YD_PEVEL)
  CALL SGET_DEVICE_DATA_RDONLY (PRDELP, YD_PRDELP)
  CALL SGET_DEVICE_DATA_RDWR (PWRL9, YD_PWRL9)
  CALL SGET_DEVICE_DATA_RDWR (ZWRL0, YL_ZWRL0)
  ...
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL1_WRA_P, YDCPG_SL1%WRA%F_P)
  ...
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL2_URL, YDCPG_SL2%F_URL)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL2_VRL, YDCPG_SL2%F_VRL)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL2_WRL, YDCPG_SL2%F_WRL)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDCPG_SL2_ZRL, YDCPG_SL2%F_ZRL)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_TND_TNDU, YDCPG_TND%F_TNDU)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_TND_TNDV, YDCPG_TND%F_TNDV)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_EDOT_T9, YDVARS%EDOT%FT9)
  ...
  !$OMP & MAP(PRESENT:KSETTLOFF, PALPHA, PEVEL, PRDELP, PWRL9, YDCPG_OPTS, YDGEOMETRY,  & 
  !$OMP &          YDML_DYN, YDPARAR, YDRIP, YFXTRAN_ACDC_STACK, ZWRL0, Z_YDCPG_SL1_U9_P,  & 
  !$OMP &          Z_YDCPG_SL1_UF9_P, Z_YDCPG_SL1_UR00_P, Z_YDCPG_SL1_UR0_P,  & 
  !$OMP &          Z_YDCPG_SL1_UR9_P, Z_YDCPG_SL1_V9_P, Z_YDCPG_SL1_VF9_P, Z_YDCPG_SL1_VR00_P,  & 
  !$OMP &          Z_YDCPG_SL1_VR0_P, Z_YDCPG_SL1_VR9_P, Z_YDCPG_SL1_WR00_P,  & 
  !$OMP &          Z_YDCPG_SL1_WR0_P, Z_YDCPG_SL1_WRA_P, Z_YDCPG_SL1_ZR00_P,  & 
  !$OMP &          Z_YDCPG_SL1_ZR0_P, Z_YDCPG_SL1_ZR9_P, Z_YDCPG_SL2_URL, Z_YDCPG_SL2_VRL,  & 
  !$OMP &          Z_YDCPG_SL2_WRL, Z_YDCPG_SL2_ZRL, Z_YDCPG_TND_TNDU, Z_YDCPG_TND_TNDV,  & 
  !$OMP &          Z_YDVARS_EDOT_T9, Z_YDVARS_GEOMETRY_GECLO_P, Z_YDVARS_GEOMETRY_GEMU_P,  & 
  !$OMP &          Z_YDVARS_GEOMETRY_GESLO_P, Z_YDVARS_GEOMETRY_GSQM2_P, Z_YDVARS_U_T0,  & 
  ...
  DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
    ...
    !$OMP & PRIVATE (JLEV, JROF, YLCPG_BNDS, YLSTACK, ZALPHA, ZZU, ZZV)       
