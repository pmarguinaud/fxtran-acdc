...
IF (YDMODEL%YRML_PHY_MF%YRPHY%LRAY.AND.YDMODEL%YRML_PHY_MF%YRPHY%NRAY==2) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_RADIATION_PARALLEL:ACRANEB2')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_RADIATION_PARALLEL:ACRANEB2')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:ACRANEB2')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:ACRANEB2')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_RADIATION_PARALLEL:ACRANEB2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&         PRDG_MU0LU, YDCFU, YDCPG_OPTS, YDMODEL, YSTACK, ZFRSODS, Z_YDCPG_MISC_NEB, &
...
ELSEIF (YDMODEL%YRML_PHY_MF%YRPHY%LRAYFM) THEN
  ...
  ELSE
    ...
    IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_RADIATION_PARALLEL:CALLRAD_F')) THEN
      ...
      IF (LSYNCHOST ('APL_ARPEGE_RADIATION_PARALLEL:CALLRAD_F')) THEN
        IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_RADIATION_PARALLEL&
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:CALLRAD_F')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:CALLRAD_F')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_RADIATION_PARALLEL:CALLRAD_F:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (PTRSODIF, PTRSODIR, YDCPG_OPTS, YDMODEL, YSTACK, Z_YDCPG_GPAR_SWDIF, &
        !$ACC&         Z_YDCPG_GPAR_SWDIR) &
        !$ACC&PRIVATE (JBLK) &
        !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
  ...
  IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_RADIATION_PARALLEL:RADHEAT')) THEN
    ...
    IF (LSYNCHOST ('APL_ARPEGE_RADIATION_PARALLEL:RADHEAT')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:RADHEAT')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:RADHEAT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_RADIATION_PARALLEL:RADHEAT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&         YDMODEL, YSTACK, ZDSRP, ZFRSODS, ZSDUR, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, &
  ...
  IF (YDMODEL%YRML_PHY_MF%YRPHY%LDAYD) THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_RADIATION_PARALLEL:ACDAYD')) THEN
      ...
      IF (LSYNCHOST ('APL_ARPEGE_RADIATION_PARALLEL:ACDAYD')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:ACDAYD')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:ACDAYD')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_RADIATION_PARALLEL:ACDAYD:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (PRDG_MU0, YDCPG_OPTS, YDMODEL, YSTACK, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, &
  ...
  IF (YDMODEL%YRML_PHY_MF%YRPHY0%GRSO<1._JPRB) THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_RADIATION_PARALLEL:ACRSO')) THEN
      ...
      IF (LSYNCHOST ('APL_ARPEGE_RADIATION_PARALLEL:ACRSO')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:ACRSO')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:ACRSO')) THEN
  ...
  IF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_RADIATION_PARALLEL:LMSE_F')) THEN
      ...
      IF (LSYNCHOST ('APL_ARPEGE_RADIATION_PARALLEL:LMSE_F')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:LMSE_F')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:LMSE_F')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_RADIATION_PARALLEL:LMSE_F:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (PALBD, PALBP, YDCPG_OPTS, YDMODEL, YSTACK, ZALB, Z_YDMF_PHYS_OUT_FRSO, &
  ...
  IF (.NOT.YDCPG_OPTS%LCONFX) THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_RADIATION_PARALLEL:SUNSHINE')) THEN
      ...
      IF (LSYNCHOST ('APL_ARPEGE_RADIATION_PARALLEL:SUNSHINE')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:SUNSHINE')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:SUNSHINE')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_RADIATION_PARALLEL:SUNSHINE:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (YDCPG_OPTS, YDMODEL, YSTACK, Z_YDMF_PHYS_OUT_FRSODS, Z_YDMF_PHYS_SURF_GSD_VD_PSUND) &
        !$ACC&PRIVATE (JBLK) &
        !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_RADIATION_PARALLEL:DIRECT')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_RADIATION_PARALLEL:DIRECT')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:DIRECT')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_RADIATION_PARALLEL:DIRECT')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_RADIATION_PARALLEL:DIRECT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (PRDG_MU0, YDCPG_OPTS, YSTACK, Z_YDMF_PHYS_OUT_FRSDNI, Z_YDMF_PHYS_OUT_FRSGNI, &
    !$ACC&         Z_YDMF_PHYS_OUT_FRSO, Z_YDMF_PHYS_OUT_FRSODS, Z_YDMF_PHYS_OUT_FRSOPS) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ENDSUBROUTINE APL_ARPEGE_RADIATION_PARALLEL
