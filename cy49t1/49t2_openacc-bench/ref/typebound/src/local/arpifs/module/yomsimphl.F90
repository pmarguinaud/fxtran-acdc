...
CONTAINS
PROCEDURE :: COPY => COPY_TSIMPHL
PROCEDURE :: CRC64 => CRC64_TSIMPHL
PROCEDURE :: HOST => HOST_TSIMPHL
PROCEDURE :: LOAD => LOAD_TSIMPHL
PROCEDURE :: SAVE => SAVE_TSIMPHL
PROCEDURE :: SIZE => SIZE_TSIMPHL
PROCEDURE :: WIPE => WIPE_TSIMPHL
END TYPE TSIMPHL
...
MODULE SUBROUTINE COPY_TSIMPHL (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TSIMPHL (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TSIMPHL (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TSIMPHL (SELF, KLUN)
...
MODULE FUNCTION SIZE_TSIMPHL (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TSIMPHL (SELF, LDDELETED, LDFIELDAPI)
