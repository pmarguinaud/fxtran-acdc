...
DO JGFL=1, SIZE (YDCPG_SL1%GFL)
  ...
  IF ((YDCPG_SL1%GFL (JGFL)%YCOMP%CSLINT/='LAITVSPCQM  ').AND.YDCPG_SL1%GFL (JGFL)%YCOMP%LADV) THEN
    ...
    IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LAVABO_EXPL_LAITVSPCQM_PART1_PARALLEL:0')) THEN
      ...
      IF (FXTRAN_ACDC_LSYNCHOST ('LAVABO_EXPL_LAITVSPCQM_PART1_PARALLEL:0')) THEN
        IF (LHOOK) CALL DR_HOOK ('LAVABO_EXPL_LAITVSPCQM_PART1_PARALLEL&
    ...
    ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMPSINGLECOLUMN&
      &','LAVABO_EXPL_LAITVSPCQM_PART1_PARALLEL:0')) THEN
...
END SUBROUTINE LAVABO_EXPL_LAITVSPCQM_PART1_PARALLEL
