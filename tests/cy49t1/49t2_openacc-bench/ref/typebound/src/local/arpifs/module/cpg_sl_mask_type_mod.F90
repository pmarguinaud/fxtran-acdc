...
PROCEDURE :: ACDC_COPY => ACDC_COPY_CPG_SL_MASK_TYPE
PROCEDURE :: ACDC_HOST => ACDC_HOST_CPG_SL_MASK_TYPE
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_CPG_SL_MASK_TYPE
END TYPE CPG_SL_MASK_TYPE

INTERFACE

MODULE SUBROUTINE ACDC_COPY_CPG_SL_MASK_TYPE (SELF, LDCREATED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_SL_MASK_TYPE), INTENT (IN), TARGET :: SELF
...
MODULE SUBROUTINE ACDC_WIPE_CPG_SL_MASK_TYPE (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
IMPLICIT NONE
CLASS (CPG_SL_MASK_TYPE), INTENT (IN), TARGET :: SELF
