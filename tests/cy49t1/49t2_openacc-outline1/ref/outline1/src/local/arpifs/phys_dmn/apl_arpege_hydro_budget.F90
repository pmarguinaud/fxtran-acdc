SUBROUTINE APL_ARPEGE_HYDRO_BUDGET (YDMF_PHYS_BASE_STATE, YDCPG_BNDS, YDCPG_OPTS,&
& YDCPG_GPAR, YDMF_PHYS, YDMF_PHYS_SURF, YDMODEL, PC3, PCN, PDSA_C1, PDSA_C2, PFLU_FEVI&
&, PFLU_NEIJ, PFLU_VEG, PFPLSL, PFPLSN, PWFC, PWLMX, PWPMX, PWSEQ, PWSMX)
...
#include "apl_arpege_hydro_budget_lmse.intfb.h"
#include "apl_arpege_hydro_budget_acdrov.intfb.h"
...
IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  CALL APL_ARPEGE_HYDRO_BUDGET_LMSE (YDCPG_GPAR, YDCPG_OPTS, YDMF_PHYS, YDCPG_BNDS, PFPLSN, PFPLSL)
ELSEIF (YDMODEL%YRML_PHY_MF%YRPHY%LSOLV) THEN
  CALL APL_ARPEGE_HYDRO_BUDGET_ACDROV (YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_BASE_STATE&
...
ENDSUBROUTINE APL_ARPEGE_HYDRO_BUDGET
