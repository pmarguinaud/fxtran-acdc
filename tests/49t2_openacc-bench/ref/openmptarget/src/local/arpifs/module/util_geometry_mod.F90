...
LYRELBC_GEO = ASSOCIATED (SELF%YRELBC_GEO)
IF (LYRELBC_GEO) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%YRELBC_GEO)
  !$OMP TARGET UPDATE TO (SELF%YRELBC_GEO)
  CALL ACDC_COPY_TELBC_GEO (SELF%YRELBC_GEO, LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%YRELBC_GEO)
ENDIF
...
LYRELBC_GEO = ASSOCIATED (SELF%YRELBC_GEO)
IF (LYRELBC_GEO) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%YRELBC_GEO)
  CALL ACDC_WIPE_TELBC_GEO (SELF%YRELBC_GEO, LDDELETED=.TRUE., LDFIELDAPI=LDFIELDAPI)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%YRELBC_GEO)
ENDIF
