...
SUBROUTINE SAVE_RADIATION_GRID_STRUCT (SELF, KLUN)
...
SUBROUTINE LOAD_RADIATION_GRID_STRUCT (SELF, KLUN)
...
SUBROUTINE COPY_RADIATION_GRID_STRUCT (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE HOST_RADIATION_GRID_STRUCT (SELF)
...
SUBROUTINE CRC64_RADIATION_GRID_STRUCT (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_RADIATION_GRID_STRUCT (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_RADIATION_GRID_STRUCT (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
