...
SUBROUTINE SAVE_TPHNC (SELF, KLUN)
...
SUBROUTINE LOAD_TPHNC (SELF, KLUN)
...
SUBROUTINE COPY_TPHNC (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE CRC64_TPHNC (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TPHNC (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TPHNC (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
