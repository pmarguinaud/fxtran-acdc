...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:CPPHINP')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (ZRDG_CVGQ, YL_ZRDG_CVGQ)
  CALL SGET_HOST_DATA_RDWR (ZRDG_CVGT, YL_ZRDG_CVGT)
  CALL SGET_HOST_DATA_RDWR (ZRDG_MU0, YL_ZRDG_MU0)
  CALL SGET_HOST_DATA_RDWR (ZRDG_MU0LU, YL_ZRDG_MU0LU)
  CALL SGET_HOST_DATA_RDWR (ZRDG_MU0M, YL_ZRDG_MU0M)
  CALL SGET_HOST_DATA_RDWR (ZRDG_MU0N, YL_ZRDG_MU0N)
  CALL SGET_HOST_DATA_RDWR (ZRDG_SOLO, YL_ZRDG_SOLO)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_DYN0_CTY_EVEL, YDCPG_DYN0%CTY%F_EVEL)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_PHY0_XYB_RDELP, YDCPG_PHY0%XYB%F_RDELP)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_CVGQ_DL, YDVARS%CVGQ%FDL)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_CVGQ_DM, YDVARS%CVGQ%FDM)
  CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_CVGQ_T0, YDVARS%CVGQ%FT0)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_PARALLEL:CPPHINP')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_XYB_RDELP, YDCPG_PHY0%XYB%F_RDELP)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_CVGQ_DL, YDVARS%CVGQ%FDL)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_CVGQ_DM, YDVARS%CVGQ%FDM)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_CVGQ_T0, YDVARS%CVGQ%FT0)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:CPPHINP')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:CPPHINP:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (ZRDG_CVGQ, YL_ZRDG_CVGQ)
  CALL SGET_DEVICE_DATA_RDWR (ZRDG_CVGT, YL_ZRDG_CVGT)
  CALL SGET_DEVICE_DATA_RDWR (ZRDG_MU0, YL_ZRDG_MU0)
  CALL SGET_DEVICE_DATA_RDWR (ZRDG_MU0LU, YL_ZRDG_MU0LU)
  CALL SGET_DEVICE_DATA_RDWR (ZRDG_MU0M, YL_ZRDG_MU0M)
  CALL SGET_DEVICE_DATA_RDWR (ZRDG_MU0N, YL_ZRDG_MU0N)
  CALL SGET_DEVICE_DATA_RDWR (ZRDG_SOLO, YL_ZRDG_SOLO)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_DYN0_CTY_EVEL, YDCPG_DYN0%CTY%F_EVEL)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_PHY0_XYB_RDELP, YDCPG_PHY0%XYB%F_RDELP)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_CVGQ_DL, YDVARS%CVGQ%FDL)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_CVGQ_DM, YDVARS%CVGQ%FDM)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_CVGQ_T0, YDVARS%CVGQ%FT0)
  ...
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_Q_T0, YDVARS%Q%FT0)
  ...
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDGEOMETRY, YDMODEL, YFXTRAN_ACDC_STACK, ZRDG_CVGQ,  & 
  !$OMP &          ZRDG_CVGT, ZRDG_MU0, ZRDG_MU0LU, ZRDG_MU0M, ZRDG_MU0N, ZRDG_SOLO,  & 
  !$OMP &          Z_YDCPG_DYN0_CTY_EVEL, Z_YDCPG_PHY0_XYB_RDELP, Z_YDVARS_CVGQ_DL,  & 
  !$OMP &          Z_YDVARS_CVGQ_DM, Z_YDVARS_CVGQ_T0, Z_YDVARS_GEOMETRY_GELAM_T0,  & 
  !$OMP &          Z_YDVARS_GEOMETRY_GEMU_T0, Z_YDVARS_Q_DL, Z_YDVARS_Q_DM,  & 
  !$OMP &          Z_YDVARS_Q_T0, Z_YDVARS_T_DL, Z_YDVARS_T_DM, Z_YDVARS_U_T0,  & 
  !$OMP &          Z_YDVARS_V_T0)  & 
  !$OMP & PRIVATE (JBLK)  & 
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:ZRDG_LCVQ')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (ZFLU_QSATS, YL_ZFLU_QSATS)
  CALL SGET_HOST_DATA_RDWR (ZQCO2, YL_ZQCO2)
  CALL SGET_HOST_DATA_RDONLY (ZRDG_CVGQ, YL_ZRDG_CVGQ)
  CALL SGET_HOST_DATA_RDWR (ZRDG_LCVQ, YL_ZRDG_LCVQ)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ZRDG_LCVQ')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ZRDG_LCVQ:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (ZFLU_QSATS, YL_ZFLU_QSATS)
  CALL SGET_DEVICE_DATA_RDWR (ZQCO2, YL_ZQCO2)
  CALL SGET_DEVICE_DATA_RDONLY (ZRDG_CVGQ, YL_ZRDG_CVGQ)
  CALL SGET_DEVICE_DATA_RDWR (ZRDG_LCVQ, YL_ZRDG_LCVQ)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ZRDG_LCVQ:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ZRDG_LCVQ:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZFLU_QSATS, ZQCO2, ZRDG_CVGQ,  & 
  !$OMP &          ZRDG_LCVQ)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:APLPAR_INIT')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (IMOC_CLPH, YL_IMOC_CLPH)
  CALL SGET_HOST_DATA_RDWR (ZDSA_C1, YL_ZDSA_C1)
  CALL SGET_HOST_DATA_RDWR (ZDSA_C2, YL_ZDSA_C2)
  CALL SGET_HOST_DATA_RDWR (ZDSA_CPS, YL_ZDSA_CPS)
  CALL SGET_HOST_DATA_RDWR (ZDSA_LHS, YL_ZDSA_LHS)
  CALL SGET_HOST_DATA_RDWR (ZDSA_RS, YL_ZDSA_RS)
  CALL SGET_HOST_DATA_RDWR (ZFCHQ, YL_ZFCHQ)
  CALL SGET_HOST_DATA_RDWR (ZFLU_CD, YL_ZFLU_CD)
  CALL SGET_HOST_DATA_RDWR (ZFLU_CDN, YL_ZFLU_CDN)
  CALL SGET_HOST_DATA_RDWR (ZFLU_CH, YL_ZFLU_CH)
  CALL SGET_HOST_DATA_RDWR (ZFLU_CHN, YL_ZFLU_CHN)
  CALL SGET_HOST_DATA_RDWR (ZFLU_EMIS, YL_ZFLU_EMIS)
  CALL SGET_HOST_DATA_RDWR (ZFLU_FEVI, YL_ZFLU_FEVI)
  CALL SGET_HOST_DATA_RDWR (ZFLU_NEIJ, YL_ZFLU_NEIJ)
  CALL SGET_HOST_DATA_RDWR (ZFLU_QSAT, YL_ZFLU_QSAT)
  CALL SGET_HOST_DATA_RDWR (ZFLU_QSATS, YL_ZFLU_QSATS)
  CALL SGET_HOST_DATA_RDWR (ZFLU_VEG, YL_ZFLU_VEG)
  CALL SGET_HOST_DATA_RDWR (ZMSC_FRMQ, YL_ZMSC_FRMQ)
  CALL SGET_HOST_DATA_RDWR (ZMSC_LH, YL_ZMSC_LH)
  CALL SGET_HOST_DATA_RDWR (ZMSC_LSCPE, YL_ZMSC_LSCPE)
  CALL SGET_HOST_DATA_RDWR (ZMSC_QW, YL_ZMSC_QW)
  CALL SGET_HOST_DATA_RDWR (ZMSC_TW, YL_ZMSC_TW)
  CALL SGET_HOST_DATA_RDWR (ZPFL_FEFB1, YL_ZPFL_FEFB1)
  CALL SGET_HOST_DATA_RDWR (ZPFL_FEFB2, YL_ZPFL_FEFB2)
  CALL SGET_HOST_DATA_RDWR (ZPFL_FEFB3, YL_ZPFL_FEFB3)
  CALL SGET_HOST_DATA_RDWR (ZPFL_FTKE, YL_ZPFL_FTKE)
  CALL SGET_HOST_DATA_RDWR (ZPFL_FTKEI, YL_ZPFL_FTKEI)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PVEG, YDMF_PHYS_SURF%GSD_VF%F_VEG)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_PARALLEL:APLPAR_INIT')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZPFL_FTKE, YL_ZPFL_FTKE)
    CALL SGET_HOST_DATA_RDWR (ZPFL_FTKEI, YL_ZPFL_FTKEI)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PVEG, YDMF_PHYS_SURF%GSD_VF%F_VEG)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:APLPAR_INIT')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:APLPAR_INIT:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (IMOC_CLPH, YL_IMOC_CLPH)
  CALL SGET_DEVICE_DATA_RDWR (ZDSA_C1, YL_ZDSA_C1)
  CALL SGET_DEVICE_DATA_RDWR (ZDSA_C2, YL_ZDSA_C2)
  CALL SGET_DEVICE_DATA_RDWR (ZDSA_CPS, YL_ZDSA_CPS)
  CALL SGET_DEVICE_DATA_RDWR (ZDSA_LHS, YL_ZDSA_LHS)
  CALL SGET_DEVICE_DATA_RDWR (ZDSA_RS, YL_ZDSA_RS)
  CALL SGET_DEVICE_DATA_RDWR (ZFCHQ, YL_ZFCHQ)
  CALL SGET_DEVICE_DATA_RDWR (ZFLU_CD, YL_ZFLU_CD)
  CALL SGET_DEVICE_DATA_RDWR (ZFLU_CDN, YL_ZFLU_CDN)
  CALL SGET_DEVICE_DATA_RDWR (ZFLU_CH, YL_ZFLU_CH)
  CALL SGET_DEVICE_DATA_RDWR (ZFLU_CHN, YL_ZFLU_CHN)
  CALL SGET_DEVICE_DATA_RDWR (ZFLU_EMIS, YL_ZFLU_EMIS)
  CALL SGET_DEVICE_DATA_RDWR (ZFLU_FEVI, YL_ZFLU_FEVI)
  CALL SGET_DEVICE_DATA_RDWR (ZFLU_NEIJ, YL_ZFLU_NEIJ)
  CALL SGET_DEVICE_DATA_RDWR (ZFLU_QSAT, YL_ZFLU_QSAT)
  CALL SGET_DEVICE_DATA_RDWR (ZFLU_QSATS, YL_ZFLU_QSATS)
  CALL SGET_DEVICE_DATA_RDWR (ZFLU_VEG, YL_ZFLU_VEG)
  CALL SGET_DEVICE_DATA_RDWR (ZMSC_FRMQ, YL_ZMSC_FRMQ)
  CALL SGET_DEVICE_DATA_RDWR (ZMSC_LH, YL_ZMSC_LH)
  CALL SGET_DEVICE_DATA_RDWR (ZMSC_LSCPE, YL_ZMSC_LSCPE)
  CALL SGET_DEVICE_DATA_RDWR (ZMSC_QW, YL_ZMSC_QW)
  CALL SGET_DEVICE_DATA_RDWR (ZMSC_TW, YL_ZMSC_TW)
  CALL SGET_DEVICE_DATA_RDWR (ZPFL_FEFB1, YL_ZPFL_FEFB1)
  CALL SGET_DEVICE_DATA_RDWR (ZPFL_FEFB2, YL_ZPFL_FEFB2)
  CALL SGET_DEVICE_DATA_RDWR (ZPFL_FEFB3, YL_ZPFL_FEFB3)
  CALL SGET_DEVICE_DATA_RDWR (ZPFL_FTKE, YL_ZPFL_FTKE)
  CALL SGET_DEVICE_DATA_RDWR (ZPFL_FTKEI, YL_ZPFL_FTKEI)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PVEG, YDMF_PHYS_SURF%GSD_VF%F_VEG)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:APLPAR_INIT:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:APLPAR_INIT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:IMOC_CLPH, YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZDSA_C1,  & 
  !$OMP &          ZDSA_C2, ZDSA_CPS, ZDSA_LHS, ZDSA_RS, ZFCHQ, ZFLU_CD, ZFLU_CDN, ZFLU_CH,  & 
  !$OMP &          ZFLU_CHN, ZFLU_EMIS, ZFLU_FEVI, ZFLU_NEIJ, ZFLU_QSAT, ZFLU_QSATS,  & 
  !$OMP &          ZFLU_VEG, ZMSC_FRMQ, ZMSC_LH, ZMSC_LSCPE, ZMSC_QW, ZMSC_TW, ZPFL_FEFB1,  & 
  !$OMP &          ZPFL_FEFB2, ZPFL_FEFB3, ZPFL_FTKE, ZPFL_FTKEI, Z_YDMF_PHYS_SURF_GSD_VF_PVEG)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:PLSM')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:PLSM:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PLSM, YDMF_PHYS_SURF%GSD_VF%F_LSM)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:PLSM:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:PLSM:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YFXTRAN_ACDC_STACK, Z_YDMF_PHYS_SURF_GSD_VF_PLSM)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (YDMODEL%YRML_PHY_MF%YRPHY%LGCHECKMV) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OpenMP','APL_ARPEGE_PARALLEL:CHECKMV')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (ZRDG_MU0, YL_ZRDG_MU0)
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:ACTQSAT')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (ZFLU_QSAT, YL_ZFLU_QSAT)
  CALL SGET_HOST_DATA_RDWR (ZGEOSLC, YL_ZGEOSLC)
  CALL SGET_HOST_DATA_RDWR (ZMSC_LH, YL_ZMSC_LH)
  CALL SGET_HOST_DATA_RDWR (ZMSC_LSCPE, YL_ZMSC_LSCPE)
  CALL SGET_HOST_DATA_RDWR (ZMSC_QW, YL_ZMSC_QW)
  CALL SGET_HOST_DATA_RDWR (ZMSC_TW, YL_ZMSC_TW)
  CALL SGET_HOST_DATA_RDONLY (ZQV, YL_ZQV)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_PARALLEL:ACTQSAT')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZMSC_QW, YL_ZMSC_QW)
    CALL SGET_HOST_DATA_RDWR (ZMSC_TW, YL_ZMSC_TW)
    CALL SGET_HOST_DATA_RDWR (ZQV, YL_ZQV)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_RH, YDCPG_MISC%F_RH)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACTQSAT')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACTQSAT:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (ZFLU_QSAT, YL_ZFLU_QSAT)
  CALL SGET_DEVICE_DATA_RDWR (ZGEOSLC, YL_ZGEOSLC)
  CALL SGET_DEVICE_DATA_RDWR (ZMSC_LH, YL_ZMSC_LH)
  CALL SGET_DEVICE_DATA_RDWR (ZMSC_LSCPE, YL_ZMSC_LSCPE)
  CALL SGET_DEVICE_DATA_RDWR (ZMSC_QW, YL_ZMSC_QW)
  CALL SGET_DEVICE_DATA_RDWR (ZMSC_TW, YL_ZMSC_TW)
  CALL SGET_DEVICE_DATA_RDONLY (ZQV, YL_ZQV)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZFLU_QSAT, ZGEOSLC,  & 
  !$OMP &          ZMSC_LH, ZMSC_LSCPE, ZMSC_QW, ZMSC_TW, ZQV, Z_YDCPG_MISC_RH, Z_YDMF_PHYS_BASE_STATE_T,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (.NOT.YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:ACSOL')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZC3, YL_ZC3)
    CALL SGET_HOST_DATA_RDWR (ZCG, YL_ZCG)
    CALL SGET_HOST_DATA_RDWR (ZCN, YL_ZCN)
    CALL SGET_HOST_DATA_RDWR (ZDSA_C1, YL_ZDSA_C1)
    CALL SGET_HOST_DATA_RDWR (ZDSA_C2, YL_ZDSA_C2)
    CALL SGET_HOST_DATA_RDWR (ZNEIJG, YL_ZNEIJG)
    CALL SGET_HOST_DATA_RDWR (ZNEIJV, YL_ZNEIJV)
    CALL SGET_HOST_DATA_RDWR (ZWFC, YL_ZWFC)
    CALL SGET_HOST_DATA_RDWR (ZWPMX, YL_ZWPMX)
    CALL SGET_HOST_DATA_RDWR (ZWSEQ, YL_ZWSEQ)
    CALL SGET_HOST_DATA_RDWR (ZWSMX, YL_ZWSMX)
    CALL SGET_HOST_DATA_RDWR (ZWWILT, YL_ZWWILT)
    ...
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A, YDMF_PHYS_BASE_STATE%YGSP_SG%F_A)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, YDMF_PHYS_BASE_STATE%YGSP_SG%F_F)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R, YDMF_PHYS_BASE_STATE%YGSP_SG%F_R)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_CT, YDMF_PHYS%OUT%F_CT)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PLSM, YDMF_PHYS_SURF%GSD_VF%F_LSM)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PVEG, YDMF_PHYS_SURF%GSD_VF%F_VEG)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, YDMF_PHYS_SURF%GSD_VF%F_Z0F)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, YDMF_PHYS_SURF%GSD_VF%F_Z0RLF)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VV_PARG, YDMF_PHYS_SURF%GSD_VV%F_ARG)
    ...
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VV_PSAB, YDMF_PHYS_SURF%GSD_VV%F_SAB)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, YDMF_PHYS_SURF%GSD_VV%F_Z0H)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_PARALLEL:ACSOL')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A, YDMF_PHYS_BASE_STATE%YGSP_SG%F_A)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, YDMF_PHYS_BASE_STATE%YGSP_SG%F_F)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R, YDMF_PHYS_BASE_STATE%YGSP_SG%F_R)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_CT, YDMF_PHYS%OUT%F_CT)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PLSM, YDMF_PHYS_SURF%GSD_VF%F_LSM)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PVEG, YDMF_PHYS_SURF%GSD_VF%F_VEG)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, YDMF_PHYS_SURF%GSD_VF%F_Z0F)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, YDMF_PHYS_SURF%GSD_VF%F_Z0RLF)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VV_PARG, YDMF_PHYS_SURF%GSD_VV%F_ARG)
      ...
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VV_PSAB, YDMF_PHYS_SURF%GSD_VV%F_SAB)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, YDMF_PHYS_SURF%GSD_VV%F_Z0H)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACSOL')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACSOL:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDWR (ZC3, YL_ZC3)
    CALL SGET_DEVICE_DATA_RDWR (ZCG, YL_ZCG)
    CALL SGET_DEVICE_DATA_RDWR (ZCN, YL_ZCN)
    CALL SGET_DEVICE_DATA_RDWR (ZDSA_C1, YL_ZDSA_C1)
    CALL SGET_DEVICE_DATA_RDWR (ZDSA_C2, YL_ZDSA_C2)
    CALL SGET_DEVICE_DATA_RDWR (ZNEIJG, YL_ZNEIJG)
    CALL SGET_DEVICE_DATA_RDWR (ZNEIJV, YL_ZNEIJV)
    CALL SGET_DEVICE_DATA_RDWR (ZWFC, YL_ZWFC)
    CALL SGET_DEVICE_DATA_RDWR (ZWPMX, YL_ZWPMX)
    CALL SGET_DEVICE_DATA_RDWR (ZWSEQ, YL_ZWSEQ)
    CALL SGET_DEVICE_DATA_RDWR (ZWSMX, YL_ZWSMX)
    CALL SGET_DEVICE_DATA_RDWR (ZWWILT, YL_ZWWILT)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC, YDMF_PHYS_BASE_STATE%YGSP_RR%F_IC)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, YDMF_PHYS_BASE_STATE%YGSP_RR%F_T)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W, YDMF_PHYS_BASE_STATE%YGSP_RR%F_W)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q, YDMF_PHYS_BASE_STATE%YGSP_SB%F_Q)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_SB_TL, YDMF_PHYS_BASE_STATE%YGSP_SB%F_TL)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A, YDMF_PHYS_BASE_STATE%YGSP_SG%F_A)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, YDMF_PHYS_BASE_STATE%YGSP_SG%F_F)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R, YDMF_PHYS_BASE_STATE%YGSP_SG%F_R)
    ...
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PVEG, YDMF_PHYS_SURF%GSD_VF%F_VEG)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, YDMF_PHYS_SURF%GSD_VF%F_Z0F)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, YDMF_PHYS_SURF%GSD_VF%F_Z0RLF)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VV_PARG, YDMF_PHYS_SURF%GSD_VV%F_ARG)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VV_PD2, YDMF_PHYS_SURF%GSD_VV%F_D2)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VV_PIVEG, YDMF_PHYS_SURF%GSD_VV%F_IVEG)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VV_PLAI, YDMF_PHYS_SURF%GSD_VV%F_LAI)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VV_PSAB, YDMF_PHYS_SURF%GSD_VV%F_SAB)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, YDMF_PHYS_SURF%GSD_VV%F_Z0H)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACSOL:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACSOL:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZC3, ZCG, ZCN, ZDSA_C1,  & 
    !$OMP &          ZDSA_C2, ZNEIJG, ZNEIJV, ZWFC, ZWPMX, ZWSEQ, ZWSMX, ZWWILT, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YGSP_SB_Q, Z_YDMF_PHYS_BASE_STATE_YGSP_SB_TL,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YGSP_SG_A, Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YGSP_SG_R, Z_YDMF_PHYS_OUT_CT, Z_YDMF_PHYS_SURF_GSD_VF_PLSM,  & 
    !$OMP &          Z_YDMF_PHYS_SURF_GSD_VF_PVEG, Z_YDMF_PHYS_SURF_GSD_VF_PZ0F,  & 
    !$OMP &          Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, Z_YDMF_PHYS_SURF_GSD_VV_PARG,  & 
    !$OMP &          Z_YDMF_PHYS_SURF_GSD_VV_PD2, Z_YDMF_PHYS_SURF_GSD_VV_PIVEG,  & 
    !$OMP &          Z_YDMF_PHYS_SURF_GSD_VV_PLAI, Z_YDMF_PHYS_SURF_GSD_VV_PSAB,  & 
    !$OMP &          Z_YDMF_PHYS_SURF_GSD_VV_PZ0H)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
    ...
    DO JBLK = YDCPG_OPTS%JBLKMIN, YDCPG_OPTS%JBLKMAX
      ...
      !$OMP PARALLEL DO SIMD  & 
      !$OMP & PRIVATE (JLON, LLHMT, YLCPG_BNDS, YLSTACK)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:ZDPHIV')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (ZDPHIT, YL_ZDPHIT)
  CALL SGET_HOST_DATA_RDWR (ZDPHIV, YL_ZDPHIV)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ZDPHIV')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ZDPHIV:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (ZDPHIT, YL_ZDPHIT)
  CALL SGET_DEVICE_DATA_RDWR (ZDPHIV, YL_ZDPHIV)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ZDPHIV:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ZDPHIV:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZDPHIT, ZDPHIV)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:ACHMTLS')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZDPHI, YL_ZDPHI)
    CALL SGET_HOST_DATA_RDONLY (ZDPHIT, YL_ZDPHIT)
    CALL SGET_HOST_DATA_RDWR (ZDSA_CPS, YL_ZDSA_CPS)
    CALL SGET_HOST_DATA_RDWR (ZDSA_LHS, YL_ZDSA_LHS)
    CALL SGET_HOST_DATA_RDWR (ZFLU_CD, YL_ZFLU_CD)
    CALL SGET_HOST_DATA_RDWR (ZFLU_CDN, YL_ZFLU_CDN)
    CALL SGET_HOST_DATA_RDWR (ZGWDCS, YL_ZGWDCS)
    CALL SGET_HOST_DATA_RDWR (ZMRIPP, YL_ZMRIPP)
    CALL SGET_HOST_DATA_RDWR (ZNBVNO, YL_ZNBVNO)
    CALL SGET_HOST_DATA_RDWR (ZPCLS, YL_ZPCLS)
    CALL SGET_HOST_DATA_RDWR (ZPRS, YL_ZPRS)
    CALL SGET_HOST_DATA_RDWR (ZRTI, YL_ZRTI)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_MISC_QS, YDCPG_MISC%F_QS)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
    ...
    &, YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYDF)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, YDMF_PHYS_BASE_STATE%YGSP_RR%F_T)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_GZ0, YDMF_PHYS%OUT%F_GZ0)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_GZ0H, YDMF_PHYS%OUT%F_GZ0H)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACHMTLS')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACHMTLS:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDWR (ZDPHI, YL_ZDPHI)
    CALL SGET_DEVICE_DATA_RDONLY (ZDPHIT, YL_ZDPHIT)
    CALL SGET_DEVICE_DATA_RDWR (ZDSA_CPS, YL_ZDSA_CPS)
    CALL SGET_DEVICE_DATA_RDWR (ZDSA_LHS, YL_ZDSA_LHS)
    CALL SGET_DEVICE_DATA_RDWR (ZFLU_CD, YL_ZFLU_CD)
    CALL SGET_DEVICE_DATA_RDWR (ZFLU_CDN, YL_ZFLU_CDN)
    CALL SGET_DEVICE_DATA_RDWR (ZGWDCS, YL_ZGWDCS)
    CALL SGET_DEVICE_DATA_RDWR (ZMRIPP, YL_ZMRIPP)
    CALL SGET_DEVICE_DATA_RDWR (ZNBVNO, YL_ZNBVNO)
    CALL SGET_DEVICE_DATA_RDWR (ZPCLS, YL_ZPCLS)
    CALL SGET_DEVICE_DATA_RDWR (ZPRS, YL_ZPRS)
    CALL SGET_DEVICE_DATA_RDWR (ZRTI, YL_ZRTI)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_MISC_QS, YDCPG_MISC%F_QS)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
    ...
    &, YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYDF)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, YDMF_PHYS_BASE_STATE%YGSP_RR%F_T)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_GZ0, YDMF_PHYS%OUT%F_GZ0)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_GZ0H, YDMF_PHYS%OUT%F_GZ0H)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACHMTLS:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACHMTLS:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZDPHI, ZDPHIT, ZDSA_CPS,  & 
    !$OMP &          ZDSA_LHS, ZFLU_CD, ZFLU_CDN, ZGWDCS, ZMRIPP, ZNBVNO, ZPCLS, ZPRS, ZRTI,  & 
    !$OMP &          Z_YDCPG_MISC_QS, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_U,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_OUT_GZ0,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_GZ0H)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
ELSE
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:ACHMT')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZCDROV, YL_ZCDROV)
    CALL SGET_HOST_DATA_RDWR (ZCHROV, YL_ZCHROV)
    CALL SGET_HOST_DATA_RDONLY (ZDPHIT, YL_ZDPHIT)
    CALL SGET_HOST_DATA_RDONLY (ZDPHIV, YL_ZDPHIV)
    CALL SGET_HOST_DATA_RDWR (ZDQSTS, YL_ZDQSTS)
    CALL SGET_HOST_DATA_RDWR (ZDSA_CPS, YL_ZDSA_CPS)
    CALL SGET_HOST_DATA_RDWR (ZDSA_RS, YL_ZDSA_RS)
    CALL SGET_HOST_DATA_RDWR (ZFLU_CD, YL_ZFLU_CD)
    CALL SGET_HOST_DATA_RDWR (ZFLU_CDN, YL_ZFLU_CDN)
    ...
    CALL SGET_HOST_DATA_RDWR (ZFLU_VEG, YL_ZFLU_VEG)
    CALL SGET_HOST_DATA_RDWR (ZGWDCS, YL_ZGWDCS)
    CALL SGET_HOST_DATA_RDWR (ZHQ, YL_ZHQ)
    CALL SGET_HOST_DATA_RDWR (ZHU, YL_ZHU)
    CALL SGET_HOST_DATA_RDWR (ZMRIPP, YL_ZMRIPP)
    CALL SGET_HOST_DATA_RDWR (ZNBVNO, YL_ZNBVNO)
    CALL SGET_HOST_DATA_RDONLY (ZNEIJG, YL_ZNEIJG)
    CALL SGET_HOST_DATA_RDONLY (ZNEIJV, YL_ZNEIJV)
    CALL SGET_HOST_DATA_RDWR (ZPCLS, YL_ZPCLS)
    CALL SGET_HOST_DATA_RDONLY (ZPFL_FPLCH, YL_ZPFL_FPLCH)
    CALL SGET_HOST_DATA_RDONLY (ZPFL_FPLSH, YL_ZPFL_FPLSH)
    CALL SGET_HOST_DATA_RDONLY (ZQV, YL_ZQV)
    CALL SGET_HOST_DATA_RDWR (ZRTI, YL_ZRTI)
    CALL SGET_HOST_DATA_RDWR (ZSTAB, YL_ZSTAB)
    CALL SGET_HOST_DATA_RDONLY (ZWFC, YL_ZWFC)
    CALL SGET_HOST_DATA_RDWR (ZXDROV, YL_ZXDROV)
    CALL SGET_HOST_DATA_RDWR (ZXHROV, YL_ZXHROV)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QS, YDCPG_MISC%F_QS)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%F_U)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_V, YDMF_PHYS_BASE_STATE%F_V)
    ...
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, YDMF_PHYS_SURF%GSD_VF%F_Z0F)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, YDMF_PHYS_SURF%GSD_VF%F_Z0RLF)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VV_PHV, YDMF_PHYS_SURF%GSD_VV%F_HV)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, YDMF_PHYS_SURF%GSD_VV%F_Z0H)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_PARALLEL:ACHMT')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (ZNEIJV, YL_ZNEIJV)
      CALL SGET_HOST_DATA_RDWR (ZPCLS, YL_ZPCLS)
      CALL SGET_HOST_DATA_RDWR (ZPFL_FPLCH, YL_ZPFL_FPLCH)
      CALL SGET_HOST_DATA_RDWR (ZPFL_FPLSH, YL_ZPFL_FPLSH)
      CALL SGET_HOST_DATA_RDWR (ZQV, YL_ZQV)
      CALL SGET_HOST_DATA_RDWR (ZRTI, YL_ZRTI)
      CALL SGET_HOST_DATA_RDWR (ZSTAB, YL_ZSTAB)
      CALL SGET_HOST_DATA_RDWR (ZWFC, YL_ZWFC)
      ...
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, YDMF_PHYS_SURF%GSD_VF%F_Z0F)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, YDMF_PHYS_SURF%GSD_VF%F_Z0RLF)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VV_PHV, YDMF_PHYS_SURF%GSD_VV%F_HV)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, YDMF_PHYS_SURF%GSD_VV%F_Z0H)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACHMT')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACHMT:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDWR (ZCDROV, YL_ZCDROV)
    CALL SGET_DEVICE_DATA_RDWR (ZCHROV, YL_ZCHROV)
    CALL SGET_DEVICE_DATA_RDONLY (ZDPHIT, YL_ZDPHIT)
    CALL SGET_DEVICE_DATA_RDONLY (ZDPHIV, YL_ZDPHIV)
    CALL SGET_DEVICE_DATA_RDWR (ZDQSTS, YL_ZDQSTS)
    CALL SGET_DEVICE_DATA_RDWR (ZDSA_CPS, YL_ZDSA_CPS)
    CALL SGET_DEVICE_DATA_RDWR (ZDSA_RS, YL_ZDSA_RS)
    CALL SGET_DEVICE_DATA_RDWR (ZFLU_CD, YL_ZFLU_CD)
    CALL SGET_DEVICE_DATA_RDWR (ZFLU_CDN, YL_ZFLU_CDN)
    ...
    CALL SGET_DEVICE_DATA_RDWR (ZFLU_VEG, YL_ZFLU_VEG)
    CALL SGET_DEVICE_DATA_RDWR (ZGWDCS, YL_ZGWDCS)
    CALL SGET_DEVICE_DATA_RDWR (ZHQ, YL_ZHQ)
    CALL SGET_DEVICE_DATA_RDWR (ZHU, YL_ZHU)
    CALL SGET_DEVICE_DATA_RDWR (ZMRIPP, YL_ZMRIPP)
    CALL SGET_DEVICE_DATA_RDWR (ZNBVNO, YL_ZNBVNO)
    CALL SGET_DEVICE_DATA_RDONLY (ZNEIJG, YL_ZNEIJG)
    CALL SGET_DEVICE_DATA_RDONLY (ZNEIJV, YL_ZNEIJV)
    CALL SGET_DEVICE_DATA_RDWR (ZPCLS, YL_ZPCLS)
    CALL SGET_DEVICE_DATA_RDONLY (ZPFL_FPLCH, YL_ZPFL_FPLCH)
    CALL SGET_DEVICE_DATA_RDONLY (ZPFL_FPLSH, YL_ZPFL_FPLSH)
    CALL SGET_DEVICE_DATA_RDONLY (ZQV, YL_ZQV)
    CALL SGET_DEVICE_DATA_RDWR (ZRTI, YL_ZRTI)
    CALL SGET_DEVICE_DATA_RDWR (ZSTAB, YL_ZSTAB)
    CALL SGET_DEVICE_DATA_RDONLY (ZWFC, YL_ZWFC)
    CALL SGET_DEVICE_DATA_RDWR (ZXDROV, YL_ZXDROV)
    CALL SGET_DEVICE_DATA_RDWR (ZXHROV, YL_ZXHROV)
    ...
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, YDMF_PHYS_BASE_STATE%YGSP_RR%F_T)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W, YDMF_PHYS_BASE_STATE%YGSP_RR%F_W)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, YDMF_PHYS_BASE_STATE%YGSP_SG%F_F)
    ...
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, YDMF_PHYS_SURF%GSD_VF%F_Z0F)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF, YDMF_PHYS_SURF%GSD_VF%F_Z0RLF)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VV_PHV, YDMF_PHYS_SURF%GSD_VV%F_HV)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VV_PZ0H, YDMF_PHYS_SURF%GSD_VV%F_Z0H)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACHMT:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACHMT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZCDROV, ZCHROV, ZDPHIT,  & 
    !$OMP &          ZDPHIV, ZDQSTS, ZDSA_CPS, ZDSA_RS, ZFLU_CD, ZFLU_CDN, ZFLU_CH, ZFLU_NEIJ,  & 
    !$OMP &          ZFLU_QSATS, ZFLU_VEG, ZGWDCS, ZHQ, ZHU, ZMRIPP, ZNBVNO, ZNEIJG, ZNEIJV,  & 
    !$OMP &          ZPCLS, ZPFL_FPLCH, ZPFL_FPLSH, ZQV, ZRTI, ZSTAB, ZWFC, ZXDROV, ZXHROV,  & 
    !$OMP &          Z_YDCPG_MISC_QS, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_U,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_IC,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_BASE_STATE_YGSP_RR_W,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YGSP_SG_F, Z_YDMF_PHYS_OUT_GZ0,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_GZ0H, Z_YDMF_PHYS_OUT_NUCLS, Z_YDMF_PHYS_OUT_NVCLS,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_QCLS, Z_YDMF_PHYS_OUT_RHCLS, Z_YDMF_PHYS_OUT_TCLS,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_UCLS, Z_YDMF_PHYS_OUT_UGST, Z_YDMF_PHYS_OUT_VCLS,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_VGST, Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_SURF_GSD_VF_PVEG,  & 
    !$OMP &          Z_YDMF_PHYS_SURF_GSD_VF_PZ0F, Z_YDMF_PHYS_SURF_GSD_VF_PZ0RLF,  & 
    !$OMP &          Z_YDMF_PHYS_SURF_GSD_VV_PHV, Z_YDMF_PHYS_SURF_GSD_VV_PZ0H)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:ACCLPH')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (IMOC_CLPH, YL_IMOC_CLPH)
  CALL SGET_HOST_DATA_RDWR (ZBLH, YL_ZBLH)
  CALL SGET_HOST_DATA_RDWR (ZCP, YL_ZCP)
  CALL SGET_HOST_DATA_RDONLY (ZQV, YL_ZQV)
  CALL SGET_HOST_DATA_RDWR (ZTHETAV, YL_ZTHETAV)
  CALL SGET_HOST_DATA_RDWR (ZTHETAVS, YL_ZTHETAVS)
  CALL SGET_HOST_DATA_RDWR (ZUGST, YL_ZUGST)
  CALL SGET_HOST_DATA_RDWR (ZVGST, YL_ZVGST)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_MISC_QS, YDCPG_MISC%F_QS)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%F_U)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_V, YDMF_PHYS_BASE_STATE%F_V)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACCLPH')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACCLPH:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (IMOC_CLPH, YL_IMOC_CLPH)
  CALL SGET_DEVICE_DATA_RDWR (ZBLH, YL_ZBLH)
  CALL SGET_DEVICE_DATA_RDWR (ZCP, YL_ZCP)
  CALL SGET_DEVICE_DATA_RDONLY (ZQV, YL_ZQV)
  CALL SGET_DEVICE_DATA_RDWR (ZTHETAV, YL_ZTHETAV)
  CALL SGET_DEVICE_DATA_RDWR (ZTHETAVS, YL_ZTHETAVS)
  CALL SGET_DEVICE_DATA_RDWR (ZUGST, YL_ZUGST)
  CALL SGET_DEVICE_DATA_RDWR (ZVGST, YL_ZVGST)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_MISC_QS, YDCPG_MISC%F_QS)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%F_U)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_V, YDMF_PHYS_BASE_STATE%F_V)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:IMOC_CLPH, YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZBLH, ZCP,  & 
  !$OMP &          ZQV, ZTHETAV, ZTHETAVS, ZUGST, ZVGST, Z_YDCPG_MISC_QS, Z_YDMF_PHYS_BASE_STATE_T,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_OUT_CLPH,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_VEIN)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:DIFTQ')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (ZDIFCVPPQ, YL_ZDIFCVPPQ)
  CALL SGET_HOST_DATA_RDONLY (ZDIFCVPPS, YL_ZDIFCVPPS)
  CALL SGET_HOST_DATA_RDONLY (ZDIFCVPPU, YL_ZDIFCVPPU)
  CALL SGET_HOST_DATA_RDONLY (ZDIFCVPPV, YL_ZDIFCVPPV)
  CALL SGET_HOST_DATA_RDONLY (ZEDMFQ, YL_ZEDMFQ)
  CALL SGET_HOST_DATA_RDONLY (ZEDMFS, YL_ZEDMFS)
  CALL SGET_HOST_DATA_RDONLY (ZEDMFU, YL_ZEDMFU)
  CALL SGET_HOST_DATA_RDONLY (ZEDMFV, YL_ZEDMFV)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_PARALLEL:DIFTQ')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZDIFCVPPQ, YL_ZDIFCVPPQ)
    CALL SGET_HOST_DATA_RDWR (ZDIFCVPPS, YL_ZDIFCVPPS)
    CALL SGET_HOST_DATA_RDWR (ZDIFCVPPU, YL_ZDIFCVPPU)
    CALL SGET_HOST_DATA_RDWR (ZDIFCVPPV, YL_ZDIFCVPPV)
    CALL SGET_HOST_DATA_RDWR (ZEDMFQ, YL_ZEDMFQ)
    CALL SGET_HOST_DATA_RDWR (ZEDMFS, YL_ZEDMFS)
    CALL SGET_HOST_DATA_RDWR (ZEDMFU, YL_ZEDMFU)
    CALL SGET_HOST_DATA_RDWR (ZEDMFV, YL_ZEDMFV)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_DIFTQ, YDMF_PHYS%OUT%F_DIFTQ)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_DIFTS, YDMF_PHYS%OUT%F_DIFTS)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_STRTU, YDMF_PHYS%OUT%F_STRTU)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_STRTV, YDMF_PHYS%OUT%F_STRTV)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:DIFTQ')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:DIFTQ:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (ZDIFCVPPQ, YL_ZDIFCVPPQ)
  CALL SGET_DEVICE_DATA_RDONLY (ZDIFCVPPS, YL_ZDIFCVPPS)
  CALL SGET_DEVICE_DATA_RDONLY (ZDIFCVPPU, YL_ZDIFCVPPU)
  CALL SGET_DEVICE_DATA_RDONLY (ZDIFCVPPV, YL_ZDIFCVPPV)
  CALL SGET_DEVICE_DATA_RDONLY (ZEDMFQ, YL_ZEDMFQ)
  CALL SGET_DEVICE_DATA_RDONLY (ZEDMFS, YL_ZEDMFS)
  CALL SGET_DEVICE_DATA_RDONLY (ZEDMFU, YL_ZEDMFU)
  CALL SGET_DEVICE_DATA_RDONLY (ZEDMFV, YL_ZEDMFV)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZDIFCVPPQ, ZDIFCVPPS,  & 
  !$OMP &          ZDIFCVPPU, ZDIFCVPPV, ZEDMFQ, ZEDMFS, ZEDMFU, ZEDMFV, Z_YDMF_PHYS_OUT_DIFTQ,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_DIFTS, Z_YDMF_PHYS_OUT_STRTU, Z_YDMF_PHYS_OUT_STRTV)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:FRSOPT')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (ZFLU_EMIS, YL_ZFLU_EMIS)
  CALL SGET_HOST_DATA_RDONLY (ZRDG_MU0, YL_ZRDG_MU0)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, YDMF_PHYS_BASE_STATE%YGSP_RR%F_T)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:FRSOPT')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:FRSOPT:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (ZFLU_EMIS, YL_ZFLU_EMIS)
  CALL SGET_DEVICE_DATA_RDONLY (ZRDG_MU0, YL_ZRDG_MU0)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, YDMF_PHYS_BASE_STATE%YGSP_RR%F_T)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZFLU_EMIS, ZRDG_MU0,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, Z_YDMF_PHYS_OUT_FRSOPT,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FRTH, Z_YDMF_PHYS_OUT_FRTHDS)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:ACDRAG')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (ZCHROV, YL_ZCHROV)
  CALL SGET_HOST_DATA_RDONLY (ZDQSTS, YL_ZDQSTS)
  CALL SGET_HOST_DATA_RDONLY (ZFLU_EMIS, YL_ZFLU_EMIS)
  CALL SGET_HOST_DATA_RDONLY (ZFLU_NEIJ, YL_ZFLU_NEIJ)
  CALL SGET_HOST_DATA_RDONLY (ZGWDCS, YL_ZGWDCS)
  CALL SGET_HOST_DATA_RDONLY (ZMSC_QW, YL_ZMSC_QW)
  CALL SGET_HOST_DATA_RDONLY (ZNBVNO, YL_ZNBVNO)
  CALL SGET_HOST_DATA_RDONLY (ZNEBS, YL_ZNEBS)
  CALL SGET_HOST_DATA_RDONLY (ZQLIS, YL_ZQLIS)
  CALL SGET_HOST_DATA_RDONLY (ZQV, YL_ZQV)
  CALL SGET_HOST_DATA_RDWR (ZTRAJGWD, YL_ZTRAJGWD)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_MISC_QS, YDCPG_MISC%F_QS)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%F_U)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_V, YDMF_PHYS_BASE_STATE%F_V)
  ...
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, YDMF_PHYS_BASE_STATE%YGSP_RR%F_T)
  CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_DRNSHF, YDMF_PHYS%OUT%F_DRNSHF)
  ...
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PGETRL, YDMF_PHYS_SURF%GSD_VF%F_GETRL)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PLSM, YDMF_PHYS_SURF%GSD_VF%F_LSM)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PVRLAN, YDMF_PHYS_SURF%GSD_VF%F_VRLAN)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PVRLDI, YDMF_PHYS_SURF%GSD_VF%F_VRLDI)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_PARALLEL:ACDRAG')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZMSC_QW, YL_ZMSC_QW)
    CALL SGET_HOST_DATA_RDWR (ZNBVNO, YL_ZNBVNO)
    CALL SGET_HOST_DATA_RDWR (ZNEBS, YL_ZNEBS)
    CALL SGET_HOST_DATA_RDWR (ZQLIS, YL_ZQLIS)
    CALL SGET_HOST_DATA_RDWR (ZQV, YL_ZQV)
    CALL SGET_HOST_DATA_RDWR (ZTRAJGWD, YL_ZTRAJGWD)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QS, YDCPG_MISC%F_QS)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
    ...
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_STRDU, YDMF_PHYS%OUT%F_STRDU)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_STRDV, YDMF_PHYS%OUT%F_STRDV)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PGETRL, YDMF_PHYS_SURF%GSD_VF%F_GETRL)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PLSM, YDMF_PHYS_SURF%GSD_VF%F_LSM)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PVRLAN, YDMF_PHYS_SURF%GSD_VF%F_VRLAN)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VF_PVRLDI, YDMF_PHYS_SURF%GSD_VF%F_VRLDI)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACDRAG')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACDRAG:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (ZCHROV, YL_ZCHROV)
  CALL SGET_DEVICE_DATA_RDONLY (ZDQSTS, YL_ZDQSTS)
  CALL SGET_DEVICE_DATA_RDONLY (ZFLU_EMIS, YL_ZFLU_EMIS)
  CALL SGET_DEVICE_DATA_RDONLY (ZFLU_NEIJ, YL_ZFLU_NEIJ)
  CALL SGET_DEVICE_DATA_RDONLY (ZGWDCS, YL_ZGWDCS)
  CALL SGET_DEVICE_DATA_RDONLY (ZMSC_QW, YL_ZMSC_QW)
  CALL SGET_DEVICE_DATA_RDONLY (ZNBVNO, YL_ZNBVNO)
  CALL SGET_DEVICE_DATA_RDONLY (ZNEBS, YL_ZNEBS)
  CALL SGET_DEVICE_DATA_RDONLY (ZQLIS, YL_ZQLIS)
  CALL SGET_DEVICE_DATA_RDONLY (ZQV, YL_ZQV)
  CALL SGET_DEVICE_DATA_RDWR (ZTRAJGWD, YL_ZTRAJGWD)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_MISC_QS, YDCPG_MISC%F_QS)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%F_U)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_V, YDMF_PHYS_BASE_STATE%F_V)
  ...
  &, YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%F_RDELP)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, YDMF_PHYS_BASE_STATE%YGSP_RR%F_T)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_OUT_DRNSHF, YDMF_PHYS%OUT%F_DRNSHF)
  ...
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PGETRL, YDMF_PHYS_SURF%GSD_VF%F_GETRL)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PLSM, YDMF_PHYS_SURF%GSD_VF%F_LSM)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PVRLAN, YDMF_PHYS_SURF%GSD_VF%F_VRLAN)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSD_VF_PVRLDI, YDMF_PHYS_SURF%GSD_VF%F_VRLDI)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDVARS_GEOMETRY_RCORI_T0, YDVARS%GEOMETRY%RCORI%FT0)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACDRAG:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACDRAG:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZCHROV, ZDQSTS, ZFLU_EMIS,  & 
  !$OMP &          ZFLU_NEIJ, ZGWDCS, ZMSC_QW, ZNBVNO, ZNEBS, ZQLIS, ZQV, ZTRAJGWD, Z_YDCPG_MISC_QS,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_V,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD,  & 
  ...
  !$OMP &          Z_YDMF_PHYS_OUT_DRNSHF, Z_YDMF_PHYS_OUT_FCSQL, Z_YDMF_PHYS_OUT_FCSQN,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FPEVPSL, Z_YDMF_PHYS_OUT_FPEVPSN, Z_YDMF_PHYS_OUT_FPFPSL,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FPFPSN, Z_YDMF_PHYS_OUT_FPLSL, Z_YDMF_PHYS_OUT_FPLSN,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_STRDU, Z_YDMF_PHYS_OUT_STRDV, Z_YDMF_PHYS_SURF_GSD_VF_PGETRL,  & 
  !$OMP &          Z_YDMF_PHYS_SURF_GSD_VF_PLSM, Z_YDMF_PHYS_SURF_GSD_VF_PVRLAN,  & 
  !$OMP &          Z_YDMF_PHYS_SURF_GSD_VF_PVRLDI, Z_YDVARS_GEOMETRY_RCORI_T0)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (YDMODEL%YRML_PHY_MF%YRPHY%LECTPRODCVP) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:TURBULENCE_PART2')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (ZECTCLS, YL_ZECTCLS)
    CALL SGET_HOST_DATA_RDONLY (ZKCLS, YL_ZKCLS)
    CALL SGET_HOST_DATA_RDWR (ZKUROV2, YL_ZKUROV2)
    CALL SGET_HOST_DATA_RDWR (ZPFL_FTKE, YL_ZPFL_FTKE)
    CALL SGET_HOST_DATA_RDWR (ZPRODTH, YL_ZPRODTH)
    CALL SGET_HOST_DATA_RDWR (ZTKE1, YL_ZTKE1)
    CALL SGET_HOST_DATA_RDONLY (ZUSLE, YL_ZUSLE)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_Q, YDMF_PHYS_BASE_STATE%F_Q)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_TKE, YDMF_PHYS_BASE_STATE%F_TKE)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%F_U)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_V, YDMF_PHYS_BASE_STATE%F_V)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI&
    &, YDMF_PHYS_BASE_STATE%YCPG_DYN%F_PHI)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_PARALLEL:TURBULENCE_PART2')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (ZECTCLS, YL_ZECTCLS)
      CALL SGET_HOST_DATA_RDWR (ZKCLS, YL_ZKCLS)
      CALL SGET_HOST_DATA_RDWR (ZKUROV2, YL_ZKUROV2)
      CALL SGET_HOST_DATA_RDWR (ZPFL_FTKE, YL_ZPFL_FTKE)
      CALL SGET_HOST_DATA_RDWR (ZPRODTH, YL_ZPRODTH)
      CALL SGET_HOST_DATA_RDWR (ZTKE1, YL_ZTKE1)
      CALL SGET_HOST_DATA_RDWR (ZUSLE, YL_ZUSLE)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_Q, YDMF_PHYS_BASE_STATE%F_Q)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_TKE, YDMF_PHYS_BASE_STATE%F_TKE)
      CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%F_U)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN&
    ...
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:TURBULENCE_PART2:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDONLY (ZECTCLS, YL_ZECTCLS)
    CALL SGET_DEVICE_DATA_RDONLY (ZKCLS, YL_ZKCLS)
    CALL SGET_DEVICE_DATA_RDWR (ZKUROV2, YL_ZKUROV2)
    CALL SGET_DEVICE_DATA_RDWR (ZPFL_FTKE, YL_ZPFL_FTKE)
    CALL SGET_DEVICE_DATA_RDWR (ZPRODTH, YL_ZPRODTH)
    CALL SGET_DEVICE_DATA_RDWR (ZTKE1, YL_ZTKE1)
    CALL SGET_DEVICE_DATA_RDONLY (ZUSLE, YL_ZUSLE)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_Q, YDMF_PHYS_BASE_STATE%F_Q)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_TKE, YDMF_PHYS_BASE_STATE%F_TKE)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%F_U)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_V, YDMF_PHYS_BASE_STATE%F_V)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI&
    &, YDMF_PHYS_BASE_STATE%YCPG_DYN%F_PHI)
    ...
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZECTCLS, ZKCLS, ZKUROV2,  & 
    !$OMP &          ZPFL_FTKE, ZPRODTH, ZTKE1, ZUSLE, Z_YDMF_PHYS_BASE_STATE_Q, Z_YDMF_PHYS_BASE_STATE_T,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_TKE, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_V,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP, Z_YDMF_PHYS_OUT_DIFCQ,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_DIFCS, Z_YDMF_PHYS_OUT_EDR, Z_YDMF_PHYS_OUT_STRCU,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_STRCV)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:QNGCOR')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (ZFLX_LOTT_GWU, YL_ZFLX_LOTT_GWU)
  CALL SGET_HOST_DATA_RDWR (ZFLX_LOTT_GWV, YL_ZFLX_LOTT_GWV)
  CALL SGET_HOST_DATA_RDONLY (ZFPCOR, YL_ZFPCOR)
  CALL SGET_HOST_DATA_RDWR (ZFPLSL, YL_ZFPLSL)
  CALL SGET_HOST_DATA_RDWR (ZFPLSN, YL_ZFPLSN)
  CALL SGET_HOST_DATA_RDWR (ZPFL_FPLCH, YL_ZPFL_FPLCH)
  CALL SGET_HOST_DATA_RDWR (ZPFL_FPLSH, YL_ZPFL_FPLSH)
  CALL SGET_HOST_DATA_RDONLY (ZQI, YL_ZQI)
  CALL SGET_HOST_DATA_RDONLY (ZQL, YL_ZQL)
  CALL SGET_HOST_DATA_RDONLY (ZQV, YL_ZQV)
  CALL SGET_HOST_DATA_RDONLY (ZSEDIQI, YL_ZSEDIQI)
  CALL SGET_HOST_DATA_RDONLY (ZSEDIQL, YL_ZSEDIQL)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP&
  &, YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%F_RDELP)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_DIFCQ, YDMF_PHYS%OUT%F_DIFCQ)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_PARALLEL:QNGCOR')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZFLX_LOTT_GWU, YL_ZFLX_LOTT_GWU)
    CALL SGET_HOST_DATA_RDWR (ZFLX_LOTT_GWV, YL_ZFLX_LOTT_GWV)
    CALL SGET_HOST_DATA_RDWR (ZFPCOR, YL_ZFPCOR)
    CALL SGET_HOST_DATA_RDWR (ZFPLSL, YL_ZFPLSL)
    CALL SGET_HOST_DATA_RDWR (ZFPLSN, YL_ZFPLSN)
    CALL SGET_HOST_DATA_RDWR (ZPFL_FPLCH, YL_ZPFL_FPLCH)
    CALL SGET_HOST_DATA_RDWR (ZPFL_FPLSH, YL_ZPFL_FPLSH)
    CALL SGET_HOST_DATA_RDWR (ZQI, YL_ZQI)
    CALL SGET_HOST_DATA_RDWR (ZQL, YL_ZQL)
    CALL SGET_HOST_DATA_RDWR (ZQV, YL_ZQV)
    CALL SGET_HOST_DATA_RDWR (ZSEDIQI, YL_ZSEDIQI)
    CALL SGET_HOST_DATA_RDWR (ZSEDIQL, YL_ZSEDIQL)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP&
    &, YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%F_RDELP)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_DIFCQ, YDMF_PHYS%OUT%F_DIFCQ)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:QNGCOR')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:QNGCOR:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (ZFLX_LOTT_GWU, YL_ZFLX_LOTT_GWU)
  CALL SGET_DEVICE_DATA_RDWR (ZFLX_LOTT_GWV, YL_ZFLX_LOTT_GWV)
  CALL SGET_DEVICE_DATA_RDONLY (ZFPCOR, YL_ZFPCOR)
  CALL SGET_DEVICE_DATA_RDWR (ZFPLSL, YL_ZFPLSL)
  CALL SGET_DEVICE_DATA_RDWR (ZFPLSN, YL_ZFPLSN)
  CALL SGET_DEVICE_DATA_RDWR (ZPFL_FPLCH, YL_ZPFL_FPLCH)
  CALL SGET_DEVICE_DATA_RDWR (ZPFL_FPLSH, YL_ZPFL_FPLSH)
  CALL SGET_DEVICE_DATA_RDONLY (ZQI, YL_ZQI)
  CALL SGET_DEVICE_DATA_RDONLY (ZQL, YL_ZQL)
  CALL SGET_DEVICE_DATA_RDONLY (ZQV, YL_ZQV)
  CALL SGET_DEVICE_DATA_RDONLY (ZSEDIQI, YL_ZSEDIQI)
  CALL SGET_DEVICE_DATA_RDONLY (ZSEDIQL, YL_ZSEDIQL)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP&
  &, YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%F_RDELP)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_DIFCQ, YDMF_PHYS%OUT%F_DIFCQ)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZFLX_LOTT_GWU, ZFLX_LOTT_GWV,  & 
  !$OMP &          ZFPCOR, ZFPLSL, ZFPLSN, ZPFL_FPLCH, ZPFL_FPLSH, ZQI, ZQL, ZQV, ZSEDIQI,  & 
  !$OMP &          ZSEDIQL, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_RDELP, Z_YDMF_PHYS_OUT_DIFCQ,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_DIFCQL, Z_YDMF_PHYS_OUT_DIFCQN, Z_YDMF_PHYS_OUT_DIFTQ,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_DIFTQL, Z_YDMF_PHYS_OUT_DIFTQN, Z_YDMF_PHYS_OUT_FCCQL,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FCCQN, Z_YDMF_PHYS_OUT_FCQNG, Z_YDMF_PHYS_OUT_FCSQL,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FCSQN, Z_YDMF_PHYS_OUT_FPEVPCL, Z_YDMF_PHYS_OUT_FPEVPCN,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FPEVPSL, Z_YDMF_PHYS_OUT_FPEVPSN, Z_YDMF_PHYS_OUT_FPFPCL,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FPFPCN, Z_YDMF_PHYS_OUT_FPFPSL, Z_YDMF_PHYS_OUT_FPFPSN,  & 
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:ACDRME')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (Z_YDVARS_A_T1, YDVARS%A%FT1)
  CALL SGET_HOST_DATA_RDWR (Z_YDVARS_IRAD_T1, YDVARS%IRAD%FT1)
  CALL SGET_HOST_DATA_RDWR (Z_YDVARS_LRAD_T1, YDVARS%LRAD%FT1)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACDRME')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_A_T1, YDVARS%A%FT1)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_IRAD_T1, YDVARS%IRAD%FT1)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_LRAD_T1, YDVARS%LRAD%FT1)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACDRME:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACDRME:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDGEOMETRY, YDMODEL, YFXTRAN_ACDC_STACK, ZMSC_FRMQ,  & 
  !$OMP &          ZQV, Z_YDCPG_MISC_NEB, Z_YDCPG_MISC_QICE, Z_YDCPG_MISC_QLI,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_U, Z_YDMF_PHYS_BASE_STATE_V,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_XYB_DELP,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FRMH, Z_YDMF_PHYS_OUT_STRMU, Z_YDMF_PHYS_OUT_STRMV,  & 
  !$OMP &          Z_YDVARS_A_T1, Z_YDVARS_IRAD_T1, Z_YDVARS_LRAD_T1)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (YDMODEL%YRML_PHY_MF%YRPHY2%LRAFTKE) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:ACEVADCAPE')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (IMOC_CLPH, YL_IMOC_CLPH)
    CALL SGET_HOST_DATA_RDWR (ZBLH, YL_ZBLH)
    CALL SGET_HOST_DATA_RDWR (ZDCAPE, YL_ZDCAPE)
    CALL SGET_HOST_DATA_RDONLY (ZTKE1, YL_ZTKE1)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%F_U)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_V, YDMF_PHYS_BASE_STATE%F_V)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI&
    ...
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF&
    &, YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYDF)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_CAPE, YDMF_PHYS%OUT%F_CAPE)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_CLPH, YDMF_PHYS%OUT%F_CLPH)
    ...
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_FPLSL, YDMF_PHYS%OUT%F_FPLSL)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_FPLSN, YDMF_PHYS%OUT%F_FPLSN)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_UCLS, YDMF_PHYS%OUT%F_UCLS)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_UGST, YDMF_PHYS%OUT%F_UGST)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_VCLS, YDMF_PHYS%OUT%F_VCLS)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_VGST, YDMF_PHYS%OUT%F_VGST)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACEVADCAPE')) THEN
    ...
    CALL SGET_DEVICE_DATA_RDWR (IMOC_CLPH, YL_IMOC_CLPH)
    CALL SGET_DEVICE_DATA_RDWR (ZBLH, YL_ZBLH)
    CALL SGET_DEVICE_DATA_RDWR (ZDCAPE, YL_ZDCAPE)
    CALL SGET_DEVICE_DATA_RDONLY (ZTKE1, YL_ZTKE1)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_U, YDMF_PHYS_BASE_STATE%F_U)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_V, YDMF_PHYS_BASE_STATE%F_V)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI&
    ...
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF&
    &, YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYDF)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_CAPE, YDMF_PHYS%OUT%F_CAPE)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_OUT_CLPH, YDMF_PHYS%OUT%F_CLPH)
    ...
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_FPLSL, YDMF_PHYS%OUT%F_FPLSL)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_FPLSN, YDMF_PHYS%OUT%F_FPLSN)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_UCLS, YDMF_PHYS%OUT%F_UCLS)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_OUT_UGST, YDMF_PHYS%OUT%F_UGST)
    CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_VCLS, YDMF_PHYS%OUT%F_VCLS)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_OUT_VGST, YDMF_PHYS%OUT%F_VGST)
    ...
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:IMOC_CLPH, YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZBLH, ZDCAPE,  & 
    !$OMP &          ZTKE1, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_U,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_V, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_CP,  & 
    !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYD, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_CAPE, Z_YDMF_PHYS_OUT_CLPH, Z_YDMF_PHYS_OUT_FPLCL,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_FPLCN, Z_YDMF_PHYS_OUT_FPLSL, Z_YDMF_PHYS_OUT_FPLSN,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_UCLS, Z_YDMF_PHYS_OUT_UGST, Z_YDMF_PHYS_OUT_VCLS,  & 
    !$OMP &          Z_YDMF_PHYS_OUT_VGST, Z_YDVARS_GEOMETRY_OROG_T0)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:ACVISIH')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (ZQGM, YL_ZQGM)
  CALL SGET_HOST_DATA_RDONLY (ZQR, YL_ZQR)
  CALL SGET_HOST_DATA_RDONLY (ZQS, YL_ZQS)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_MISC_QICE, YDCPG_MISC%F_QICE)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_MISC_QLI, YDCPG_MISC%F_QLI)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI&
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_PARALLEL:ACVISIH')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZQGM, YL_ZQGM)
    CALL SGET_HOST_DATA_RDWR (ZQR, YL_ZQR)
    CALL SGET_HOST_DATA_RDWR (ZQS, YL_ZQS)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QICE, YDCPG_MISC%F_QICE)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QLI, YDCPG_MISC%F_QLI)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI, YDMF_PHYS_BASE_STATE%YCPG_DYN%F_PHI)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ACVISIH')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ACVISIH:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (ZQGM, YL_ZQGM)
  CALL SGET_DEVICE_DATA_RDONLY (ZQR, YL_ZQR)
  CALL SGET_DEVICE_DATA_RDONLY (ZQS, YL_ZQS)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_MISC_QICE, YDCPG_MISC%F_QICE)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_MISC_QLI, YDCPG_MISC%F_QLI)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI&
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZQGM, ZQR, ZQS, Z_YDCPG_MISC_QICE,  & 
  !$OMP &          Z_YDCPG_MISC_QLI, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHI,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_PHIF, Z_YDMF_PHYS_BASE_STATE_YCPG_DYN_RCP_R,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF, Z_YDMF_PHYS_OUT_MXCLWC,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_VISICLD, Z_YDMF_PHYS_OUT_VISIHYD)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:ZBAY_QRCONV')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (ZBAY_QRCONV, YL_ZBAY_QRCONV)
  CALL SGET_HOST_DATA_RDWR (ZBAY_QSCONV, YL_ZBAY_QSCONV)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_FPLCL, YDMF_PHYS%OUT%F_FPLCL)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_FPLCN, YDMF_PHYS%OUT%F_FPLCN)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ZBAY_QRCONV')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ZBAY_QRCONV:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (ZBAY_QRCONV, YL_ZBAY_QRCONV)
  CALL SGET_DEVICE_DATA_RDWR (ZBAY_QSCONV, YL_ZBAY_QSCONV)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_FPLCL, YDMF_PHYS%OUT%F_FPLCL)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_FPLCN, YDMF_PHYS%OUT%F_FPLCN)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ZBAY_QRCONV:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ZBAY_QRCONV:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZBAY_QRCONV, ZBAY_QSCONV,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_FPLCL, Z_YDMF_PHYS_OUT_FPLCN)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:ZDE2MR')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (ZBAY_QRCONV, YL_ZBAY_QRCONV)
  CALL SGET_HOST_DATA_RDWR (ZBAY_QSCONV, YL_ZBAY_QSCONV)
  CALL SGET_HOST_DATA_RDWR (ZDE2MR, YL_ZDE2MR)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF&
  &, YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYDF)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:ZDE2MR')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDWR (ZBAY_QRCONV, YL_ZBAY_QRCONV)
  CALL SGET_DEVICE_DATA_RDWR (ZBAY_QSCONV, YL_ZBAY_QSCONV)
  CALL SGET_DEVICE_DATA_RDWR (ZDE2MR, YL_ZDE2MR)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_T, YDMF_PHYS_BASE_STATE%F_T)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF&
  &, YDMF_PHYS_BASE_STATE%YCPG_PHY%F_PREHYDF)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:ZDE2MR:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  ...
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZBAY_QRCONV, ZBAY_QSCONV,  & 
  !$OMP &          ZDE2MR, Z_YDMF_PHYS_BASE_STATE_T, Z_YDMF_PHYS_BASE_STATE_YCPG_PHY_PREHYDF)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:PPWETPOINT')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (ZPCLS, YL_ZPCLS)
  ...
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_Q, YDMF_PHYS_BASE_STATE%F_Q)
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_TCLS, YDMF_PHYS%OUT%F_TCLS)
  CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_OUT_TPWCLS, YDMF_PHYS%OUT%F_TPWCLS)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:PPWETPOINT')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:PPWETPOINT:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (ZPCLS, YL_ZPCLS)
  ...
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_BASE_STATE_Q, YDMF_PHYS_BASE_STATE%F_Q)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_TCLS, YDMF_PHYS%OUT%F_TCLS)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_OUT_TPWCLS, YDMF_PHYS%OUT%F_TPWCLS)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:PPWETPOINT:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:PPWETPOINT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZPCLS, Z_YDMF_PHYS_BASE_STATE_I,  & 
  !$OMP &          Z_YDMF_PHYS_BASE_STATE_L, Z_YDMF_PHYS_BASE_STATE_Q, Z_YDMF_PHYS_OUT_TCLS,  & 
  !$OMP &          Z_YDMF_PHYS_OUT_TPWCLS)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (YDCPG_OPTS%LCORWAT) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OpenMP','APL_ARPEGE_PARALLEL:22')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_FPLSL, YDMF_PHYS%OUT%F_FPLSL)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_FPLSN, YDMF_PHYS%OUT%F_FPLSN)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VH_PEVA, YDMF_PHYS_SURF%GSD_VH%F_EVA)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VH_PPCL, YDMF_PHYS_SURF%GSD_VH%F_PCL)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VH_PPCN, YDMF_PHYS_SURF%GSD_VH%F_PCN)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VH_PPSL, YDMF_PHYS_SURF%GSD_VH%F_PSL)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_VH_PPSN, YDMF_PHYS_SURF%GSD_VH%F_PSN)
...
IF (YDMODEL%YRML_PHY_MF%YRPHY%NDPSFI==1) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OpenMP','APL_ARPEGE_PARALLEL:23')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (ZFLU_QSATS, YL_ZFLU_QSATS)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_MISC_QS, YDCPG_MISC%F_QS)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QSOL, YDCPG_MISC%F_QSOL)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_PHY0_PREHYD, YDCPG_PHY0%F_PREHYD)
    CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_SURF_GSP_RR_PT_T0, YDMF_PHYS_SURF%GSP_RR%F_T_T0)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_PARALLEL:23')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QS, YDCPG_MISC%F_QS)
      CALL SGET_HOST_DATA_RDWR (Z_YDCPG_MISC_QSOL, YDCPG_MISC%F_QSOL)
      CALL SGET_HOST_DATA_RDWR (Z_YDCPG_PHY0_PREHYD, YDCPG_PHY0%F_PREHYD)
...
IF (YDMODEL%YRML_PHY_MF%YRPHY%LCVPGY) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OpenMP','APL_ARPEGE_PARALLEL:24')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (Z_YDVARS_CVV_T0, YDVARS%CVV%FT0)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_CVV_T1, YDVARS%CVV%FT1)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_PARALLEL:24')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (Z_YDVARS_CVV_T0, YDVARS%CVV%FT0)
      CALL SGET_HOST_DATA_RDWR (Z_YDVARS_CVV_T1, YDVARS%CVV%FT1)
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:BAYRAD')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (ZBAY_QRCONV, YL_ZBAY_QRCONV)
  CALL SGET_HOST_DATA_RDONLY (ZBAY_QSCONV, YL_ZBAY_QSCONV)
  CALL SGET_HOST_DATA_RDWR (Z_YDVARS_RCONV_T1, YDVARS%RCONV%FT1)
  CALL SGET_HOST_DATA_RDWR (Z_YDVARS_SCONV_T1, YDVARS%SCONV%FT1)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:BAYRAD')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:BAYRAD:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (ZBAY_QRCONV, YL_ZBAY_QRCONV)
  CALL SGET_DEVICE_DATA_RDONLY (ZBAY_QSCONV, YL_ZBAY_QSCONV)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_RCONV_T1, YDVARS%RCONV%FT1)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_SCONV_T1, YDVARS%SCONV%FT1)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:BAYRAD:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:BAYRAD:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZBAY_QRCONV, ZBAY_QSCONV,  & 
  !$OMP &          Z_YDVARS_RCONV_T1, Z_YDVARS_SCONV_T1)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:EDR')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (Z_YDMF_PHYS_OUT_EDR, YDMF_PHYS%OUT%F_EDR)
  CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_DI_PXEDR, YDMF_PHYS_SURF%GSD_DI%F_XEDR)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:EDR')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:EDR:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDMF_PHYS_OUT_EDR, YDMF_PHYS%OUT%F_EDR)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_DI_PXEDR, YDMF_PHYS_SURF%GSD_DI%F_XEDR)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:EDR:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:EDR:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, Z_YDMF_PHYS_OUT_EDR,  & 
  !$OMP &          Z_YDMF_PHYS_SURF_GSD_DI_PXEDR)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','APL_ARPEGE_PARALLEL:PRECIPS')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (ZPRC_DPRECIPS, YL_ZPRC_DPRECIPS)
  CALL SGET_HOST_DATA_RDONLY (ZPRC_DPRECIPS2, YL_ZPRC_DPRECIPS2)
  CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_XP2_PPRECIP2, YDMF_PHYS_SURF%GSD_XP2%F_PRECIP2)
  CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_XP_PPRECIP, YDMF_PHYS_SURF%GSD_XP%F_PRECIP)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('APL_ARPEGE_PARALLEL:PRECIPS')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (ZPRC_DPRECIPS, YL_ZPRC_DPRECIPS)
    CALL SGET_HOST_DATA_RDWR (ZPRC_DPRECIPS2, YL_ZPRC_DPRECIPS2)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_XP2_PPRECIP2, YDMF_PHYS_SURF%GSD_XP2%F_PRECIP2)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_XP_PPRECIP, YDMF_PHYS_SURF%GSD_XP%F_PRECIP)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_PARALLEL:PRECIPS')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:PRECIPS:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (ZPRC_DPRECIPS, YL_ZPRC_DPRECIPS)
  CALL SGET_DEVICE_DATA_RDONLY (ZPRC_DPRECIPS2, YL_ZPRC_DPRECIPS2)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_XP2_PPRECIP2, YDMF_PHYS_SURF%GSD_XP2%F_PRECIP2)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDMF_PHYS_SURF_GSD_XP_PPRECIP, YDMF_PHYS_SURF%GSD_XP%F_PRECIP)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:PRECIPS:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_PARALLEL:PRECIPS:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDMODEL, YFXTRAN_ACDC_STACK, ZPRC_DPRECIPS, ZPRC_DPRECIPS2,  & 
  !$OMP &          Z_YDMF_PHYS_SURF_GSD_XP2_PPRECIP2, Z_YDMF_PHYS_SURF_GSD_XP_PPRECIP)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
