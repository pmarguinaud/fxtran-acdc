  ...
  DO JGFL=1, SIZE (YDCPG_SL1%GFL)
    ...
    IF (YDVARS%GFL_PTR (JGFL)%YCOMP%LADV) THEN
      ...
      IF (YDML_DYN%YRDYN%LSPLTHOIGFL.AND.(YDML_DYN%YRDYN%NSPLTHOI==0&
        ...
        IF (LPARALLELMETHOD ('OPENMP','LATTEX_EXPL_2TL_PARALLEL:0')) THEN
          ...
          IF (LSYNCHOST ('LATTEX_EXPL_2TL_PARALLEL:0')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LATTEX_EXPL_2TL_PARALLEL:0')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTEX_EXPL_2TL_PARALLEL:0')) THEN
          ...
          IF (LHOOK) CALL DR_HOOK ('LATTEX_EXPL_2TL_PARALLEL:0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
            ...
            !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, Z_YDCPG_SL1_GFL_P, Z_YDCPG_SL1_GFL_P_F, &
      ...
      ELSE
        ...
        IF (LPARALLELMETHOD ('OPENMP','LATTEX_EXPL_2TL_PARALLEL:1')) THEN
          ...
          IF (LSYNCHOST ('LATTEX_EXPL_2TL_PARALLEL:1')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LATTEX_EXPL_2TL_PARALLEL:1')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTEX_EXPL_2TL_PARALLEL:1')) THEN
          ...
          IF (LHOOK) CALL DR_HOOK ('LATTEX_EXPL_2TL_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
            ...
            !$ACC PARALLEL LOOP GANG &
            !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, Z_YDCPG_SL1_GFL_P, Z_YDVARS_GFL_PTR_T9) &
            !$ACC&PRIVATE (JBLK) &
            !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
  ...
  DO JGFL=1, SIZE (YDCPG_SL1%GFL)
    ...
    IF (YDVARS%GFL_PTR (JGFL)%YCOMP%LADV) THEN
      ...
      IF (YDML_DYN%YRDYN%LSPLTHOIGFL.AND.(YDML_DYN%YRDYN%NSPLTHOI==0&
        ...
        IF (LPARALLELMETHOD ('OPENMP','LATTEX_EXPL_2TL_PARALLEL:2')) THEN
          ...
          IF (LSYNCHOST ('LATTEX_EXPL_2TL_PARALLEL:2')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LATTEX_EXPL_2TL_PARALLEL:2')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTEX_EXPL_2TL_PARALLEL:2')) THEN
      ...
      ELSE
        ...
        IF (LPARALLELMETHOD ('OPENMP','LATTEX_EXPL_2TL_PARALLEL:3')) THEN
          ...
          IF (LSYNCHOST ('LATTEX_EXPL_2TL_PARALLEL:3')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LATTEX_EXPL_2TL_PARALLEL:3')) THEN
        ...
        ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTEX_EXPL_2TL_PARALLEL:3')) THEN
          ...
          IF (LHOOK) CALL DR_HOOK ('LATTEX_EXPL_2TL_PARALLEL:3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
            ...
            !$ACC PARALLEL LOOP GANG &
            !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, Z_YDCPG_SL1_GFL_P, Z_YDVARS_GFL_PTR_T0) &
            !$ACC&PRIVATE (JBLK) &
            !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (YDVARS%CVGQ%YCOMP%LGP.AND.(.NOT.LDCTC)) THEN
  ...
  IF ((YDML_DYN%YRDYN%NSPLTHOI/=0).OR.LLTDIABLIN) THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','LATTEX_EXPL_2TL_PARALLEL:4')) THEN
      ...
      IF (LSYNCHOST ('LATTEX_EXPL_2TL_PARALLEL:4')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LATTEX_EXPL_2TL_PARALLEL:4')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTEX_EXPL_2TL_PARALLEL:4')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('LATTEX_EXPL_2TL_PARALLEL:4:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, Z_YDCPG_SL1_CVGQ_P_F, Z_YDCPG_SL1_Q_P_F) &
        !$ACC&PRIVATE (JBLK) &
        !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
  ...
  IF (LPARALLELMETHOD ('OPENMP','LATTEX_EXPL_2TL_PARALLEL:5')) THEN
    ...
    IF (LSYNCHOST ('LATTEX_EXPL_2TL_PARALLEL:5')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LATTEX_EXPL_2TL_PARALLEL:5')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTEX_EXPL_2TL_PARALLEL:5')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('LATTEX_EXPL_2TL_PARALLEL:5:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC PARALLEL LOOP GANG &
      !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, Z_YDCPG_SL1_CVGQ_P, Z_YDCPG_SL1_Q_P) &
      !$ACC&PRIVATE (JBLK) &
      !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
  ...
  IF ((YDML_DYN%YRDYN%NSPLTHOI==0).AND.LLTDIABLIN) THEN
    ...
    IF (LPARALLELMETHOD ('OPENMP','LATTEX_EXPL_2TL_PARALLEL:6')) THEN
      ...
      IF (LSYNCHOST ('LATTEX_EXPL_2TL_PARALLEL:6')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','LATTEX_EXPL_2TL_PARALLEL:6')) THEN
    ...
    ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LATTEX_EXPL_2TL_PARALLEL:6')) THEN
      ...
      IF (LHOOK) CALL DR_HOOK ('LATTEX_EXPL_2TL_PARALLEL:6:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
        ...
        !$ACC PARALLEL LOOP GANG &
        !$ACC&PRESENT (YDCPG_OPTS, YDGEOMETRY, YSTACK, Z_YDCPG_SL1_CVGQ_P, Z_YDCPG_SL1_Q_P_F) &
        !$ACC&PRIVATE (JBLK) &
        !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
ENDSUBROUTINE LATTEX_EXPL_2TL_PARALLEL
