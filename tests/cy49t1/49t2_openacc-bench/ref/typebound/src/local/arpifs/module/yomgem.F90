...
CONTAINS
PROCEDURE :: COPY => COPY_TGEM
PROCEDURE :: CRC64 => CRC64_TGEM
PROCEDURE :: HOST => HOST_TGEM
PROCEDURE :: LOAD => LOAD_TGEM
PROCEDURE :: SAVE => SAVE_TGEM
PROCEDURE :: SIZE => SIZE_TGEM
PROCEDURE :: WIPE => WIPE_TGEM
END TYPE TGEM
...
MODULE SUBROUTINE COPY_TGEM (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TGEM (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TGEM (SELF)

IMPLICIT NONE
CLASS (TGEM), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TGEM (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TGEM (SELF, KLUN)
...
MODULE FUNCTION SIZE_TGEM (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TGEM (SELF, LDDELETED, LDFIELDAPI)
