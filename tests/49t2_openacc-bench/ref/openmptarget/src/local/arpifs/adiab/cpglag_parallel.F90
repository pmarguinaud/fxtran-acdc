...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CPGLAG_PARALLEL:0')) THEN
  ...
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_PDSI, YDCPG_SL2%F_PDSI)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_SPSI, YDCPG_SL2%F_SPSI)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_TSI, YDCPG_SL2%F_TSI)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_USI, YDCPG_SL2%F_USI)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_VDSI, YDCPG_SL2%F_VDSI)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_VSI, YDCPG_SL2%F_VSI)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPGLAG_PARALLEL:0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('CPGLAG_PARALLEL:0:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_PDSI, YDCPG_SL2%F_PDSI)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_SPSI, YDCPG_SL2%F_SPSI)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_TSI, YDCPG_SL2%F_TSI)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_USI, YDCPG_SL2%F_USI)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_VDSI, YDCPG_SL2%F_VDSI)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_VSI, YDCPG_SL2%F_VSI)
  ...
  !$OMP & MAP(PRESENT:YDCPG_OPTS, YDGEOMETRY, YDMODEL, YFXTRAN_ACDC_STACK, Z_YDCPG_SL2_PDSI,  & 
  !$OMP &          Z_YDCPG_SL2_SPSI, Z_YDCPG_SL2_TSI, Z_YDCPG_SL2_USI, Z_YDCPG_SL2_VDSI,  & 
  !$OMP &          Z_YDCPG_SL2_VSI, Z_YDVARS_SPD_T1, Z_YDVARS_SP_T1, Z_YDVARS_SVD_T1,  & 
  !$OMP &          Z_YDVARS_T_T1, Z_YDVARS_U_T1, Z_YDVARS_V_T1)  & 
  !$OMP & PRIVATE (JBLK)  & 
...
IF (YDMODEL%YRML_DYN%YRDYNA%LSPRT) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','CPGLAG_PARALLEL:1')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (ZR1, YL_ZR1)
    CALL SGET_HOST_DATA_RDWR (Z_YDVARS_T_T1, YDVARS%T%FT1)
    ...
    IF (FXTRAN_ACDC_LSYNCHOST ('CPGLAG_PARALLEL:1')) THEN
      ...
      CALL SGET_HOST_DATA_RDWR (ZR1, YL_ZR1)
      CALL SGET_HOST_DATA_RDWR (Z_YDVARS_T_T1, YDVARS%T%FT1)
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPGLAG_PARALLEL:1')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('CPGLAG_PARALLEL:1:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
    CALL SGET_DEVICE_DATA_RDONLY (ZR1, YL_ZR1)
    CALL SGET_DEVICE_DATA_RDWR (Z_YDVARS_T_T1, YDVARS%T%FT1)
    IF (LHOOK) CALL DR_HOOK ('CPGLAG_PARALLEL:1:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
    IF (LHOOK) CALL DR_HOOK ('CPGLAG_PARALLEL:1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YDGEOMETRY, YFXTRAN_ACDC_STACK, ZR1, Z_YDVARS_T_T1)  & 
    !$OMP & PRIVATE (JBLK)  & 
    !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
IF (LLSTR) THEN
  ...
  ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','CPGLAG_PARALLEL:STR')) THEN
    ...
    !$OMP TARGET TEAMS DISTRIBUTE  & 
    !$OMP & MAP(PRESENT:YDCPG_OPTS, YDGEOMETRY, YFXTRAN_ACDC_STACK, Z_YDVARS_GEOMETRY_GM_P,  & 
