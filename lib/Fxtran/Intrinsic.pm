...
my @BR = qw (SIN COS TAN ASIN ACOS ATAN SINH COSH TANH ASINH ACOSH ATANH LOG LOG10 EXP ERF GAMMA LOG_GAMMA ATAN2);

my %BR = map { ($_, 1) } @BR;

my @INTRINSIC = qw (SIGN MAX MIN MOD REAL SQRT PRESENT INT NULL HUGE TINY EPSILON ANY
