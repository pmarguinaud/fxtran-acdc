...
SUBROUTINE SAVE_TDPRECIPS (SELF, KLUN)
...
SUBROUTINE LOAD_TDPRECIPS (SELF, KLUN)
...
SUBROUTINE COPY_TDPRECIPS (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE HOST_TDPRECIPS (SELF)
...
SUBROUTINE CRC64_TDPRECIPS (SELF, KLUN, CDPATH)
...
SUBROUTINE WIPE_TDPRECIPS (SELF, LDDELETED, LDFIELDAPI)
...
FUNCTION SIZE_TDPRECIPS (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
