...
PROCEDURE :: COPY => COPY_TECLD
PROCEDURE :: CRC64 => CRC64_TECLD
PROCEDURE :: HOST => HOST_TECLD
PROCEDURE :: LOAD => LOAD_TECLD
PROCEDURE :: SAVE => SAVE_TECLD
PROCEDURE :: SIZE => SIZE_TECLD
PROCEDURE :: WIPE => WIPE_TECLD
END TYPE TECLD
!============================================================================
...
MODULE SUBROUTINE COPY_TECLD (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE LOAD_TECLD (SELF, KLUN)
...
MODULE SUBROUTINE WIPE_TECLD (SELF, LDDELETED, LDFIELDAPI)
