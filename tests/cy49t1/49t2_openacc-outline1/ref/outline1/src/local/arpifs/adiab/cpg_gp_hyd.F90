...
CALL CPG_GP_HYD_OUTLINE_000 (YDCPG_DYN0, YDCPG_OPTS, YDMODEL, YDGEOMETRY,&
& YDCPG_BNDS, Z_XYBDER_ALPHM_T0, Z_XYBDER_ALPHPLL_T0, Z_XYBDER_ALPHPLM_T0&
&, Z_XYBDER_ALPHL_T0, Z_XYBDER_LNPRL_T0, Z_XYBDER_LNPRM_T0, Z_RPREF_T0)
...
CALL CPG_GP_HYD_OUTLINE_001 (YDVARS, YDCPG_DYN0, YDMODEL, YDGEOMETRY&
&, YDCPG_BNDS, Z_RDT_T0, Z_RT_T0, Z_RPREF_T0)
...
CALL CPG_GP_HYD_OUTLINE_002 (LLUVH, LLGPXX, YDVARS, YDCPG_OPTS, YDCPG_TND, YDGEOMETRY, YDCPG_DYN0,&
& YDMODEL, YDCPG_BNDS, Z_XYBDER_ALPHPLL_T0, Z_XYBDER_ALPHPLM_T0, Z_XYBDER_ALPHL_T0, Z_XYBDER_LNPRL_T0&
&, Z_XYBDER_ALPHM_T0, P_GWHT_T0, Z_RDT_T0, Z_GPHM_T0, Z_RT_T0, Z_XYBDER_LNPRM_T0, Z_GPHL_T0)
