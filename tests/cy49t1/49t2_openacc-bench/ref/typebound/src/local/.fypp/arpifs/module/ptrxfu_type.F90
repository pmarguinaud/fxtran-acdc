...
CONTAINS
PROCEDURE :: COPY => COPY_TXFUPTR
PROCEDURE :: HOST => HOST_TXFUPTR
PROCEDURE :: SIZE => SIZE_TXFUPTR
PROCEDURE :: WIPE => WIPE_TXFUPTR
END TYPE TXFUPTR

INTERFACE

MODULE SUBROUTINE COPY_TXFUPTR (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TXFUPTR (SELF)

IMPLICIT NONE
CLASS (TXFUPTR), TARGET :: SELF
END SUBROUTINE

MODULE FUNCTION SIZE_TXFUPTR (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TXFUPTR (SELF, LDDELETED, LDFIELDAPI)
