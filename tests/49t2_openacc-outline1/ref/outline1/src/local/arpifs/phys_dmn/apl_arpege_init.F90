...
&, YDMF_PHYS_SURF, YDVARS, YDMODEL, KMOC_CLPH, KNLAB_CVPP, PAER, PAERINDS, PAIPCMT, PALBD, PALBP, PALPHA1&
&, PCEMTR, PCFATH, PCFAU, PCFBTH, PCFBU, PCFBV, PCOEFA, PCONDCVPPI, PCONDCVPPL, PCTRSO, PDECRD, PDIFCVPPQ&
...
& PNEBS0, PNEB_CVPP, PPFL_FPLCH, PPFL_FPLSH, PPOID, PPRODTH_CVPP, PQC_DET_PCMT, PQI, PQIC, PQICE, PQL&
&, PQLC, PQLIS, PQLIS0, PQLI_CVP, PQLI_CVPP, PQO3, PQR, PQS, PQV, PSC_FCLL, PSC_FCLN, PSC_FEVI, PSC_FEVN&
&, PSEDIQI, PSEDIQL, PSFSWDIF, PSFSWDIR, PSUDU, PTENHA, PTENQVA, PTENT, PTRSOD, PTRSODIF, PTRSODIR&
&, PUNEBH, PXDROV, PXHROV, PXQRO, PXTRO, PXTROV, PXURO, PXUROV)
...
#include "apl_arpege_init_outline_006.intfb.h"
#include "apl_arpege_init_outline_005.intfb.h"
#include "apl_arpege_init_outline_004.intfb.h"
#include "apl_arpege_init_outline_003.intfb.h"
#include "apl_arpege_init_outline_002.intfb.h"
#include "apl_arpege_init_outline_001.intfb.h"
#include "apl_arpege_init_outline_000.intfb.h"
...
CALL APL_ARPEGE_INIT_OUTLINE_000 (YDCPG_BNDS, YDCPG_OPTS, YDMODEL, YDVARS, PAIPCMT, PDECRD)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART1', 1, ZHOOK_HANDLE_1)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART2', 0, ZHOOK_HANDLE_1)
CALL APL_ARPEGE_INIT_OUTLINE_001 (YDCPG_BNDS, YDCPG_MISC, YDCPG_OPTS&
...
CALL APL_ARPEGE_INIT_OUTLINE_002 (YDCPG_BNDS, YDCPG_OPTS, YDCST&
&, YDMF_PHYS_BASE_STATE, YDMODEL, PPOID, PPRODTH_CVPP, ZIPOI)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART3', 1, ZHOOK_HANDLE_1)
PEPS0=1.E-12_JPRB
PEPSNEB=1.E-10_JPRB
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART4', 0, ZHOOK_HANDLE_1)
CALL APL_ARPEGE_INIT_OUTLINE_003 (PEPS0, YDCPG_OPTS, KNLAB_CVPP, PALPHA1, PCFATH, PCFAU, PCFBTH&
&, PCFBU, PCFBV, PCOEFA, PCONDCVPPI, PCONDCVPPL, PDIFCVPPQ, PDIFCVPPS, PDIFCVPPU, PDIFCVPPV,&
...
CALL APL_ARPEGE_INIT_OUTLINE_004 (YDCPG_BNDS, YDCPG_OPTS, YDMF_PHYS&
&, YDMF_PHYS_BASE_STATE, PPOID, PQI, PQL, PQR, PQS, PQV, ZIPOI)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART5', 1, ZHOOK_HANDLE_1)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART6', 0, ZHOOK_HANDLE_1)
CALL APL_ARPEGE_INIT_OUTLINE_005 (YDCPG_BNDS, YDCPG_OPTS, YDMODEL, KMOC_CLPH, PAER, PAERINDS, PALBD&
...
CALL APL_ARPEGE_INIT_OUTLINE_006 (YDCPG_BNDS, YDCPG_OPTS, YDMODEL, PPFL_FPLCH, PPFL_FPLSH)
IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT:PART7', 1, ZHOOK_HANDLE_1)

IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_INIT', 1, ZHOOK_HANDLE)
ENDSUBROUTINE APL_ARPEGE_INIT
