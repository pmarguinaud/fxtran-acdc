...
IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OpenMP','APL_ARPEGE_INIT_SURFEX_PARALLEL:0')) THEN
    ...
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_GPAR_GZ0, YDCPG_GPAR%F_GZ0)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_GPAR_GZ0H, YDCPG_GPAR%F_GZ0H)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_GPAR_RAIN, YDCPG_GPAR%F_RAIN)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_GPAR_SNOW, YDCPG_GPAR%F_SNOW)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_GPAR_VEMIS, YDCPG_GPAR%F_VEMIS)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_GPAR_VQS, YDCPG_GPAR%F_VQS)
  ...
  IF (FXTRAN_ACDC_LPARALLELMETHOD ('OpenMP','APL_ARPEGE_INIT_SURFEX_PARALLEL:1')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (PFLU_EMIS, YD_PFLU_EMIS)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_GPAR_ALBDIR, YDCPG_GPAR%F_ALBDIR)
    CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_GPAR_ALBSCA, YDCPG_GPAR%F_ALBSCA)
    CALL SGET_HOST_DATA_RDWR (Z_YDMF_PHYS_BASE_STATE_YGSP_RR_T, YDMF_PHYS_BASE_STATE%YGSP_RR%F_T)
