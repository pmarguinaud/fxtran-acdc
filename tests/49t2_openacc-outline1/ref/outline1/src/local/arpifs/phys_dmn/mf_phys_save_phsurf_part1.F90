...
#include "mf_phys_save_phsurf_part1_part1.intfb.h"
IF (LHOOK) CALL DR_HOOK ('MF_PHYS_SAVE_PHSURF_PART1', 0, ZHOOK_HANDLE)


CALL MF_PHYS_SAVE_PHSURF_PART1_PART1 (YDCPG_OPTS, YDMODEL, PDAL_T0, PDOM_T0, PGSD_VF_PZ0F, PGSD_VH_PPBLH&
...
ENDSUBROUTINE MF_PHYS_SAVE_PHSURF_PART1
