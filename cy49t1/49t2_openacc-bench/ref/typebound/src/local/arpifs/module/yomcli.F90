...
CONTAINS
PROCEDURE :: COPY => COPY_TCLI
PROCEDURE :: CRC64 => CRC64_TCLI
PROCEDURE :: HOST => HOST_TCLI
PROCEDURE :: LOAD => LOAD_TCLI
PROCEDURE :: SAVE => SAVE_TCLI
PROCEDURE :: SIZE => SIZE_TCLI
PROCEDURE :: WIPE => WIPE_TCLI
END TYPE TCLI
...
MODULE SUBROUTINE COPY_TCLI (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TCLI (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE LOAD_TCLI (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TCLI (SELF, KLUN)
...
MODULE FUNCTION SIZE_TCLI (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TCLI (SELF, LDDELETED, LDFIELDAPI)
