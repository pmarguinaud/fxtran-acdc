...
CALL CUBASEN &
 ...
 & KIDIA,    KFDIA,    KLON,     KLEV,   KSPPN2D,   NJKT1, LLMIXS, LDTDKMF,&
...
! ZMFCFL(JL) = 2._JPRB*MIN(2._JPRB,1._JPRB + 2.5E-5_JPRB*ZDX)
  IF(LDCUM(JL).AND.KTYPE(JL) == 1) THEN
    IF (LNEWTAU) THEN    
       ZTAURES = RTAULIM*(1._JPRB + RTAUFAC/((ZDX/1000._JPRB-RXMIN+1._JPRB)**2))    
    ELSE
...
CALL CUDTDQN &
 ...
 & KIDIA,    KFDIA,    KLON,     KLEV,&
 & ITOPM2,   KTYPE,    KCTOP,    IDTOP,    LDTDKMF, LDCUM,    LLDDRAF,   PTSPHY,&
 & PAPH,     PAP,      PGEOH,    PGEO,&
