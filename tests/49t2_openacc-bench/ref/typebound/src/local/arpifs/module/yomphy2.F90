...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TPHY2
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TPHY2
PROCEDURE :: ACDC_HOST => ACDC_HOST_TPHY2
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TPHY2
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TPHY2
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TPHY2
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TPHY2
END TYPE TPHY2
...
MODULE SUBROUTINE ACDC_COPY_TPHY2 (SELF, LDCREATED, LDFIELDAPI)
