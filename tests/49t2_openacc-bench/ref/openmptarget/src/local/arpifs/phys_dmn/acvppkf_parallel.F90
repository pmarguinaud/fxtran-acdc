...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','ACVPPKF_PARALLEL:PART2')) THEN
  ...
  ICLBASS_GATHER => GATHER_HOST_DATA_RDWR (YL_FGS, YL_ICLBASS)
  ICLTOPS_GATHER => GATHER_HOST_DATA_RDWR (YL_FGS, YL_ICLTOPS)
  ISDPL_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ISDPL)
  ISLCL_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ISLCL)
  ISPBL_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ISPBL)
  LLTRIG1_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_LLTRIG1)
  ZPABS_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZPABS)
  ZRC_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZRC)
  ZRCTEN_GATHER => GATHER_HOST_DATA_RDWR (YL_FGS, YL_ZRCTEN)
  ZRI_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZRI)
  ZRITEN_GATHER => GATHER_HOST_DATA_RDWR (YL_FGS, YL_ZRITEN)
  ZRV_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZRV)
  ZRVTEN_GATHER => GATHER_HOST_DATA_RDWR (YL_FGS, YL_ZRVTEN)
  ZSHAL_ZCH1_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZSHAL_ZCH1)
  ZSHAL_ZCH1TENS_GATHER => GATHER_HOST_DATA_RDWR (YL_FGS, YL_ZSHAL_ZCH1TENS)
  ZSRVLCL_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZSRVLCL)
  ZSTHES_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZSTHES)
  ZSTHLCL_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZSTHLCL)
  ZSTHV_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZSTHV)
  ZSTHVELCL_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZSTHVELCL)
  ZSTLCL_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZSTLCL)
  ZSWLCL_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZSWLCL)
  ZSZLCL_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZSZLCL)
  ZT_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZT)
  ZTHT_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZTHT)
  ZTTEN_GATHER => GATHER_HOST_DATA_RDWR (YL_FGS, YL_ZTTEN)
  ZZUMF_GATHER => GATHER_HOST_DATA_RDWR (YL_FGS, YL_ZZUMF)
  ZZZ_GATHER => GATHER_HOST_DATA_RDONLY (YL_FGS, YL_ZZZ)
  ...
  DO JBLK = 1, YL_FGS%KGPBLKS
    ...
    &%YRCVMNH%LSETTADJ, YDML_PHY_MF%YRCVMNH%OTADJS, ZPABS_GATHER(:,:, JBLK), ZZZ_GATHER(:,:, JBLK), ZT_GATHER&
    &(:,:, JBLK), ZRV_GATHER(:,:, JBLK), ZRC_GATHER(:,:, JBLK), ZRI_GATHER(:,:, JBLK), LLOCHTRANS, I_KCH1&
    &, ZSHAL_ZCH1_GATHER(:,:,:, JBLK), ZRDOCP, ZTHT_GATHER(:,:, JBLK), ZSTHV_GATHER(:,:, JBLK), ZSTHES_GATHER&
    &(:,:, JBLK), ISDPL_GATHER(:, JBLK), ISPBL_GATHER(:, JBLK), ISLCL_GATHER(:, JBLK), ZSTHLCL_GATHER(:,&
    & JBLK), ZSTLCL_GATHER(:, JBLK), ZSRVLCL_GATHER(:, JBLK), ZSWLCL_GATHER(:, JBLK), ZSZLCL_GATHER(:, JBLK&
    &), ZSTHVELCL_GATHER(:, JBLK), LLTRIG1_GATHER(:, JBLK), ZZUMF_GATHER(:,:, JBLK), ZTTEN_GATHER(:,:, JBLK&
    &), ZRVTEN_GATHER(:,:, JBLK), ZRCTEN_GATHER(:,:, JBLK), ZRITEN_GATHER(:,:, JBLK), ICLTOPS_GATHER(:, JBLK&
    &), ICLBASS_GATHER(:, JBLK), ZSHAL_ZCH1TENS_GATHER(:,:,:, JBLK))
  ENDDO
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('ACVPPKF_PARALLEL:PART2')) THEN
    ...
    ICLBASS_GATHER => GET_HOST_DATA_RDWR (YL_ICLBASS)
    ICLTOPS_GATHER => GET_HOST_DATA_RDWR (YL_ICLTOPS)
    ISDPL_GATHER => GET_HOST_DATA_RDWR (YL_ISDPL)
    ISLCL_GATHER => GET_HOST_DATA_RDWR (YL_ISLCL)
    ISPBL_GATHER => GET_HOST_DATA_RDWR (YL_ISPBL)
    LLTRIG1_GATHER => GET_HOST_DATA_RDWR (YL_LLTRIG1)
    ZPABS_GATHER => GET_HOST_DATA_RDWR (YL_ZPABS)
    ZRC_GATHER => GET_HOST_DATA_RDWR (YL_ZRC)
    ZRCTEN_GATHER => GET_HOST_DATA_RDWR (YL_ZRCTEN)
    ZRI_GATHER => GET_HOST_DATA_RDWR (YL_ZRI)
    ZRITEN_GATHER => GET_HOST_DATA_RDWR (YL_ZRITEN)
    ZRV_GATHER => GET_HOST_DATA_RDWR (YL_ZRV)
    ZRVTEN_GATHER => GET_HOST_DATA_RDWR (YL_ZRVTEN)
    ZSHAL_ZCH1_GATHER => GET_HOST_DATA_RDWR (YL_ZSHAL_ZCH1)
    ZSHAL_ZCH1TENS_GATHER => GET_HOST_DATA_RDWR (YL_ZSHAL_ZCH1TENS)
    ZSRVLCL_GATHER => GET_HOST_DATA_RDWR (YL_ZSRVLCL)
    ZSTHES_GATHER => GET_HOST_DATA_RDWR (YL_ZSTHES)
    ZSTHLCL_GATHER => GET_HOST_DATA_RDWR (YL_ZSTHLCL)
    ZSTHV_GATHER => GET_HOST_DATA_RDWR (YL_ZSTHV)
    ZSTHVELCL_GATHER => GET_HOST_DATA_RDWR (YL_ZSTHVELCL)
    ZSTLCL_GATHER => GET_HOST_DATA_RDWR (YL_ZSTLCL)
    ZSWLCL_GATHER => GET_HOST_DATA_RDWR (YL_ZSWLCL)
    ZSZLCL_GATHER => GET_HOST_DATA_RDWR (YL_ZSZLCL)
    ZT_GATHER => GET_HOST_DATA_RDWR (YL_ZT)
    ZTHT_GATHER => GET_HOST_DATA_RDWR (YL_ZTHT)
    ZTTEN_GATHER => GET_HOST_DATA_RDWR (YL_ZTTEN)
    ZZUMF_GATHER => GET_HOST_DATA_RDWR (YL_ZZUMF)
    ZZZ_GATHER => GET_HOST_DATA_RDWR (YL_ZZZ)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMPSINGLECOLUMN','ACVPPKF_PARALLEL:PART2')) THEN
  ...
  DO JBLK = 1, YL_FGS%KGPBLKS
    ...
    DO JLON = 1, MIN (YL_FGS%KLON, YL_FGS%KGPTOT - (JBLK - 1) * YL_FGS%KLON)
      ...
      &, IKICE, YDML_PHY_MF%YRCVMNH%LSETTADJ, YDML_PHY_MF%YRCVMNH%OTADJS, ZPABS_GATHER(:,:, JBLK), ZZZ_GATHER&
      &(:,:, JBLK), ZT_GATHER(:,:, JBLK), ZRV_GATHER(:,:, JBLK), ZRC_GATHER(:,:, JBLK), ZRI_GATHER(&
      &:,:, JBLK), LLOCHTRANS, I_KCH1, ZSHAL_ZCH1_GATHER(:,:,:, JBLK), ZRDOCP, ZTHT_GATHER(:,:, JBLK&
      &), ZSTHV_GATHER(:,:, JBLK), ZSTHES_GATHER(:,:, JBLK), ISDPL_GATHER(:, JBLK), ISPBL_GATHER(:,&
      & JBLK), ISLCL_GATHER(:, JBLK), ZSTHLCL_GATHER(:, JBLK), ZSTLCL_GATHER(:, JBLK), ZSRVLCL_GATHER&
      &(:, JBLK), ZSWLCL_GATHER(:, JBLK), ZSZLCL_GATHER(:, JBLK), ZSTHVELCL_GATHER(:, JBLK), LLTRIG1_GATHER&
      &(:, JBLK), ZZUMF_GATHER(:,:, JBLK), ZTTEN_GATHER(:,:, JBLK), ZRVTEN_GATHER(:,:, JBLK), ZRCTEN_GATHER&
      &(:,:, JBLK), ZRITEN_GATHER(:,:, JBLK), ICLTOPS_GATHER(:, JBLK), ICLBASS_GATHER(:, JBLK), ZSHAL_ZCH1TENS_GATHER&
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ACVPPKF_PARALLEL:PART2')) THEN
  ...
  CALL YL_FGS%INIT (YL_LLTRIG1, YDCPG_OPTS%KGPTOTB)
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART2:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  ICLBASS_GATHER => GATHER_DEVICE_DATA_RDWR (YL_FGS, YL_ICLBASS)
  ICLTOPS_GATHER => GATHER_DEVICE_DATA_RDWR (YL_FGS, YL_ICLTOPS)
  ISDPL_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ISDPL)
  ISLCL_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ISLCL)
  ISPBL_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ISPBL)
  LLTRIG1_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_LLTRIG1)
  ZPABS_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZPABS)
  ZRC_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZRC)
  ZRCTEN_GATHER => GATHER_DEVICE_DATA_RDWR (YL_FGS, YL_ZRCTEN)
  ZRI_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZRI)
  ZRITEN_GATHER => GATHER_DEVICE_DATA_RDWR (YL_FGS, YL_ZRITEN)
  ZRV_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZRV)
  ZRVTEN_GATHER => GATHER_DEVICE_DATA_RDWR (YL_FGS, YL_ZRVTEN)
  ZSHAL_ZCH1_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZSHAL_ZCH1)
  ZSHAL_ZCH1TENS_GATHER => GATHER_DEVICE_DATA_RDWR (YL_FGS, YL_ZSHAL_ZCH1TENS)
  ZSRVLCL_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZSRVLCL)
  ZSTHES_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZSTHES)
  ZSTHLCL_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZSTHLCL)
  ZSTHV_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZSTHV)
  ZSTHVELCL_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZSTHVELCL)
  ZSTLCL_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZSTLCL)
  ZSWLCL_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZSWLCL)
  ZSZLCL_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZSZLCL)
  ZT_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZT)
  ZTHT_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZTHT)
  ZTTEN_GATHER => GATHER_DEVICE_DATA_RDWR (YL_FGS, YL_ZTTEN)
  ZZUMF_GATHER => GATHER_DEVICE_DATA_RDWR (YL_FGS, YL_ZZUMF)
  ZZZ_GATHER => GATHER_DEVICE_DATA_RDONLY (YL_FGS, YL_ZZZ)
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART2:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
