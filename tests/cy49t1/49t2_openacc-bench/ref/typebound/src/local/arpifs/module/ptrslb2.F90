...
PROCEDURE :: COPY => COPY_TPTRSLB2
PROCEDURE :: CRC64 => CRC64_TPTRSLB2
PROCEDURE :: HOST => HOST_TPTRSLB2
PROCEDURE :: LOAD => LOAD_TPTRSLB2
PROCEDURE :: SAVE => SAVE_TPTRSLB2
PROCEDURE :: SIZE => SIZE_TPTRSLB2
PROCEDURE :: WIPE => WIPE_TPTRSLB2
END TYPE TPTRSLB2
!==============================================================
...
MODULE SUBROUTINE COPY_TPTRSLB2 (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE WIPE_TPTRSLB2 (SELF, LDDELETED, LDFIELDAPI)
