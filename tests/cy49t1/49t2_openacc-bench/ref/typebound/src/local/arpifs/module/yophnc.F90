...
PROCEDURE :: COPY => COPY_TPHNC
PROCEDURE :: CRC64 => CRC64_TPHNC
PROCEDURE :: HOST => HOST_TPHNC
PROCEDURE :: LOAD => LOAD_TPHNC
PROCEDURE :: SAVE => SAVE_TPHNC
PROCEDURE :: SIZE => SIZE_TPHNC
PROCEDURE :: WIPE => WIPE_TPHNC
END TYPE TPHNC
!============================================================================
...
MODULE SUBROUTINE COPY_TPHNC (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TPHNC (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TPHNC (SELF)

IMPLICIT NONE
CLASS (TPHNC), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TPHNC (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TPHNC (SELF, KLUN)
...
MODULE FUNCTION SIZE_TPHNC (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TPHNC (SELF, LDDELETED, LDFIELDAPI)
