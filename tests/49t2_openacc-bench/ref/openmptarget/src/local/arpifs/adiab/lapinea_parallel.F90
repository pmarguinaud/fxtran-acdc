...
IF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENMP','LAPINEA_PARALLEL:LARCINA')) THEN
  ...
  CALL SGET_HOST_DATA_RDWR (ILEV, YL_ILEV)
  CALL SGET_HOST_DATA_RDONLY (ZLEV, YL_ZLEV)
  CALL SGET_HOST_DATA_RDWR (Z_YDA_KL0_P, YDA_KL0%F_P)
  CALL SGET_HOST_DATA_RDWR (Z_YDA_KLH0_P, YDA_KLH0%F_P)
  CALL SGET_HOST_DATA_RDWR (Z_YDA_KNOWENO_P, YDA_KNOWENO%F_P)
  ...
  CALL SGET_HOST_DATA_RDWR (Z_YDA_PLSCAW_P, YDA_PLSCAW%F_P)
  CALL SGET_HOST_DATA_RDWR (Z_YDA_PRSCAW_P, YDA_PRSCAW%F_P)
  CALL SGET_HOST_DATA_RDONLY (Z_YDA_PSCO_P, YDA_PSCO%F_P)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_KAPPA, YDCPG_SL2%F_KAPPA)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_KAPPAH, YDCPG_SL2%F_KAPPAH)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_KAPPAM, YDCPG_SL2%F_KAPPAM)
  CALL SGET_HOST_DATA_RDONLY (Z_YDCPG_SL2_KAPPAT, YDCPG_SL2%F_KAPPAT)
  ...
  IF (FXTRAN_ACDC_LSYNCHOST ('LAPINEA_PARALLEL:LARCINA')) THEN
    ...
    CALL SGET_HOST_DATA_RDWR (IDEP, YL_IDEP)
    CALL SGET_HOST_DATA_RDWR (ILEV, YL_ILEV)
    CALL SGET_HOST_DATA_RDWR (ZLEV, YL_ZLEV)
    CALL SGET_HOST_DATA_RDWR (Z_YDA_KL0_P, YDA_KL0%F_P)
    CALL SGET_HOST_DATA_RDWR (Z_YDA_KLH0_P, YDA_KLH0%F_P)
    CALL SGET_HOST_DATA_RDWR (Z_YDA_KNOWENO_P, YDA_KNOWENO%F_P)
    CALL SGET_HOST_DATA_RDWR (Z_YDA_KVSEPC_P, YDA_KVSEPC%F_P)
    ...
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_KAPPA, YDCPG_SL2%F_KAPPA)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_KAPPAH, YDCPG_SL2%F_KAPPAH)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_KAPPAM, YDCPG_SL2%F_KAPPAM)
    CALL SGET_HOST_DATA_RDWR (Z_YDCPG_SL2_KAPPAT, YDCPG_SL2%F_KAPPAT)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','LAPINEA_PARALLEL:LARCINA')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDWR (ILEV, YL_ILEV)
  CALL SGET_DEVICE_DATA_RDONLY (ZLEV, YL_ZLEV)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDA_KL0_P, YDA_KL0%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDA_KLH0_P, YDA_KLH0%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDA_KNOWENO_P, YDA_KNOWENO%F_P)
  ...
  CALL SGET_DEVICE_DATA_RDWR (Z_YDA_PLSCAW_P, YDA_PLSCAW%F_P)
  CALL SGET_DEVICE_DATA_RDWR (Z_YDA_PRSCAW_P, YDA_PRSCAW%F_P)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDA_PSCO_P, YDA_PSCO%F_P)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_KAPPA, YDCPG_SL2%F_KAPPA)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_KAPPAH, YDCPG_SL2%F_KAPPAH)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_KAPPAM, YDCPG_SL2%F_KAPPAM)
  CALL SGET_DEVICE_DATA_RDONLY (Z_YDCPG_SL2_KAPPAT, YDCPG_SL2%F_KAPPAT)
  ...
  !$OMP & MAP(PRESENT:IDEP, ILEV, YDCPG_OPTS, YDGEOMETRY, YDMODEL, YDSL, YFXTRAN_ACDC_STACK,  & 
  !$OMP &          ZLEV, Z_YDA_KL0_P, Z_YDA_KLH0_P, Z_YDA_KNOWENO_P, Z_YDA_KVSEPC_P,  & 
  !$OMP &          Z_YDA_KVSEPL_P, Z_YDA_PCCO_P, Z_YDA_PLSCAW_P, Z_YDA_PRSCAW_P,  & 
  !$OMP &          Z_YDA_PSCO_P, Z_YDCPG_SL2_KAPPA, Z_YDCPG_SL2_KAPPAH, Z_YDCPG_SL2_KAPPAM,  & 
  !$OMP &          Z_YDCPG_SL2_KAPPAT, Z_YDCPG_SL2_STDDISU, Z_YDCPG_SL2_STDDISV,  & 
  !$OMP &          Z_YDCPG_SL2_STDDISW, Z_YDMASK_SL2_P, Z_YDVARS_GEOMETRY_GECLO_P,  & 
