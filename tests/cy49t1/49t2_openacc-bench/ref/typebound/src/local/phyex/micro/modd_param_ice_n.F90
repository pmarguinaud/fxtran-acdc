...
!
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_PARAM_ICE_T
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_PARAM_ICE_T
PROCEDURE :: ACDC_HOST => ACDC_HOST_PARAM_ICE_T
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_PARAM_ICE_T
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_PARAM_ICE_T
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_PARAM_ICE_T
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_PARAM_ICE_T
...
MODULE SUBROUTINE ACDC_COPY_PARAM_ICE_T (SELF, LDCREATED, LDFIELDAPI)
