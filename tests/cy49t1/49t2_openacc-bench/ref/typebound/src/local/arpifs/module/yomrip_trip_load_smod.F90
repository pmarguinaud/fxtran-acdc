...
READ (KLUN) ZTMP0
SELF%RSIVSRLU = ZTMP0
CALL SELF%YREOZOC%LOAD (KLUN)
CALL SELF%YRECMIP%LOAD (KLUN)
CALL SELF%YRERADGHG%LOAD (KLUN)
CALL SELF%YREAERC_TEGEN%LOAD (KLUN)
CALL SELF%YREAERC_MACC%LOAD (KLUN)
CALL SELF%RAERSO4%LOAD (KLUN)
