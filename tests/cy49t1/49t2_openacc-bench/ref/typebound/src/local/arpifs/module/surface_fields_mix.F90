...
CONTAINS
PROCEDURE :: COPY => COPY_TYPE_SURF_GEN
PROCEDURE :: CRC64 => CRC64_TYPE_SURF_GEN
PROCEDURE :: HOST => HOST_TYPE_SURF_GEN
PROCEDURE :: LOAD => LOAD_TYPE_SURF_GEN
PROCEDURE :: SAVE => SAVE_TYPE_SURF_GEN
PROCEDURE :: SIZE => SIZE_TYPE_SURF_GEN
PROCEDURE :: WIPE => WIPE_TYPE_SURF_GEN
...
MODULE SUBROUTINE COPY_TYPE_SURF_GEN (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TYPE_SURF_GEN (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TYPE_SURF_GEN (SELF)

IMPLICIT NONE
CLASS (TYPE_SURF_GEN), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TYPE_SURF_GEN (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TYPE_SURF_GEN (SELF, KLUN)
...
MODULE FUNCTION SIZE_TYPE_SURF_GEN (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TYPE_SURF_GEN (SELF, LDDELETED, LDFIELDAPI)
