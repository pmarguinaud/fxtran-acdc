SUBROUTINE APL_ARPEGE_DEEP_CONVECTION_ZERO (YDCPG_OPTS, YDMF_PHYS_BASE_STATE, YDCPG_BNDS&
&, PTENHA, PTENV, PRDG_CVGT, PTENT, PTENQ, PTENDQ, PTENDT, PTENU, PRDG_CVGQ, PTENQVA)
