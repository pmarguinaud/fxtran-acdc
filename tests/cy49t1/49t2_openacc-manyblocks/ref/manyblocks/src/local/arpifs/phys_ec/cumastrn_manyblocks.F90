SUBROUTINE CUMASTRN_MANYBLOCKS (PPLDARE, PPLRG, YDTHF, YDCST, YDML_PHY_SLIN, YDML_PHY_EC, YGFL,&
& YDCHEM, YDSPP_CONFIG, YDPERTPAR, KIDIA, KFDIA, KLON, KGPBLKS, KLEV, PDX, LDTDKMF, LDMCAPEA, LDLAND&
&, PTSPHY, PTEN, PQEN, PUEN, PVEN, PLITOT, PVERVEL, PQSEN, PQHFL, PAHFS, PAP, PAPH, PGEO, PGEOH&
&, PGAW, PCUCONVCA, PGP2DSPP, PTENT, PTENQ, PTENU, PTENV, PTENTA, PTENQA, LDCUM, KTYPE, KCBOT, KCTOP&
&, LDCUM_LIG, KCBOT_LIG, KCTOP_LIG, KBOTSC, LDSC, LDSHCV, PLCRIT_AER, PTU, PQU, PLU, PLUDE, PLUDELI&
&, PSNDE, PENTH, PMFLXR, PMFLXS, PRAIN, PLRAIN, PRSUD, PMFU, PMFD, PLGLAC, PMFUDE_RATE, PMFDDE_RATE&
&, PCAPE, PWU, PWMEAN, PVDISCU, PDISS, KTRAC, PCEN, PTENC, PSCAV, PSCAV0)
...
REAL (KIND=JPRB), INTENT (INOUT)::PTEN (:, :, :)
REAL (KIND=JPRB), INTENT (INOUT)::PQEN (:, :, :)
...
REAL (KIND=JPRB), INTENT (IN)::PTENTA (:, :, :)
REAL (KIND=JPRB), INTENT (IN)::PTENQA (:, :, :)
...
LLMIXS=LDTDKMF
CALL CUBASEN_MANYBLOCKS (PPLDARE, PPLRG, YDTHF, YDCST, YDML_PHY_SLIN%YREPHLI, YDML_PHY_EC%YRECLDP&
&, YDML_PHY_EC%YRECUMF, YDSPP_CONFIG, KIDIA, KFDIA, KLON, KGPBLKS, KLEV, YDML_PHY_EC%YRECUMF%NJKT1&
&, LLMIXS, LDTDKMF, ZTENH, ZQENH, PGEOH, PAPH, PQHFL, PAHFS, PGP2DSPP, ZKMFL, PTEN, PQEN, PQSEN, PGEO&
&, PTU, PQU, PLU, ZKINEU, ZWUBASE, ILAB, LDCUM, LDSC, KCBOT, KBOTSC, ICTOP0, IDPL, PCAPE)
...
CALL CUASCN_MANYBLOCKS (YDTHF, YDCST, YDML_PHY_SLIN%YREPHLI, YDML_PHY_EC%YRECLDP, YDML_PHY_EC%YRECUMF&
&, YDSPP_CONFIG, YGFL, KIDIA, KFDIA, KLON, KGPBLKS, KLEV, LDTDKMF, PTSPHY, ZTENH, ZQENH, PUEN, PVEN&
&, PTEN, PQEN, PQSEN, PLITOT, PGEO, PGEOH, PAP, PAPH, PVERVEL, ZWUBASE, PGP2DSPP, LDLAND, LDCUM, KTYPE&
&, ILAB, LLSCVFLAG, PTU, PQU, PLU, PLRAIN, PMFU, ZMFUB, PLGLAC, ZMFUS, ZMFUQ, ZMFUL, PLUDE, PLUDELI&
&, ZDMFUP, PLCRIT_AER, ZDMFEN, KCBOT, KCTOP, ICTOP0, IDPL, PMFUDE_RATE, ZKINEU, PWU, PWMEAN)
