...
!        LECTPRODCVP : CLE POUR PRENDRE EN COMPTE LA PRODUCTION DE TKE PAR ACCVIMP
!                    : KEY TO ACTIVATE TKE PRODUCTION BY ACCVIMP
...
!        LFVGICE3 : GRAUPEL: MARSHALL-PALMER DISTRIBUTION AND FALL VELOCITY ADOPTED FROM ICE3
!        LEVAPLOP: KEY FOR ACTIVATING LOPEZ EVAPORATION FOR ALARO-0 PROCESSES.
!        LCP06   : KEY FOR ACTIVATING THRESHOLD FOR ICE AUTOCONVERSION FOLLOWING CHABOUREAU & PINTY (2006)
...
!        LAEROMMR: KEY TO USE CLIM.AEROSOL MASS MIXING RATIOS IN RADIATION
!        LAERONRT: KEY TO USE NRT  AEROSOL MASS MIXING RATIOS IN RADIATION
...
!        LZ0SNOWH: KEY FOR SNOW EFFECT ON ROUGHNESS LENGTH VIA SNOW HEIGHT
...
! STRUCTURE FOR WET SNOW AND ICE ACCRETION
TYPE(TDWET) :: YRDWET
...
LOGICAL :: L2MICRO
!-------------------------------------------------
! NSOLE: SOLar Eclipses.
!   * NSOLE=0         old solar and lunar computations.
!   * NSOLE=1         new precise solar and lunar computations. Eclipse computation activated.
!   * NSOLE=-1        new precise solar and lunar computations. No eclipse computation.
!   * NSOLE=AAAAMMDD  new precise solar and lunar computations, as if date was AAAAMMDD. Eclipse computation activated.
!   * NSOLE=-AAAAMMDD new precise solar and lunar computations, as if date was AAAAMMDD. No eclipse computation.
!-------------------------------------------------
...
CONTAINS
PROCEDURE :: ACDC_COPY => ACDC_COPY_TPHY
PROCEDURE :: ACDC_CRC64 => ACDC_CRC64_TPHY
PROCEDURE :: ACDC_HOST => ACDC_HOST_TPHY
PROCEDURE :: ACDC_LOAD => ACDC_LOAD_TPHY
PROCEDURE :: ACDC_SAVE => ACDC_SAVE_TPHY
PROCEDURE :: ACDC_SIZE => ACDC_SIZE_TPHY
PROCEDURE :: ACDC_WIPE => ACDC_WIPE_TPHY
END TYPE TPHY
