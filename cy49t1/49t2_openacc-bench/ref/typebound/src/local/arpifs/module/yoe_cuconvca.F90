...
PROCEDURE :: COPY => COPY_TECUCONVCA
PROCEDURE :: CRC64 => CRC64_TECUCONVCA
PROCEDURE :: HOST => HOST_TECUCONVCA
PROCEDURE :: LOAD => LOAD_TECUCONVCA
PROCEDURE :: SAVE => SAVE_TECUCONVCA
PROCEDURE :: SIZE => SIZE_TECUCONVCA
PROCEDURE :: WIPE => WIPE_TECUCONVCA
END TYPE TECUCONVCA
...
MODULE SUBROUTINE COPY_TECUCONVCA (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TECUCONVCA (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TECUCONVCA (SELF)

IMPLICIT NONE
CLASS (TECUCONVCA), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TECUCONVCA (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TECUCONVCA (SELF, KLUN)
...
MODULE FUNCTION SIZE_TECUCONVCA (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TECUCONVCA (SELF, LDDELETED, LDFIELDAPI)
