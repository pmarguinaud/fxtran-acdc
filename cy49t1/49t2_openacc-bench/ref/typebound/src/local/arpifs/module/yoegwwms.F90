...
PROCEDURE :: COPY => COPY_TEGWWMS
PROCEDURE :: CRC64 => CRC64_TEGWWMS
PROCEDURE :: HOST => HOST_TEGWWMS
PROCEDURE :: LOAD => LOAD_TEGWWMS
PROCEDURE :: SAVE => SAVE_TEGWWMS
PROCEDURE :: SIZE => SIZE_TEGWWMS
PROCEDURE :: WIPE => WIPE_TEGWWMS
END TYPE TEGWWMS
...
MODULE SUBROUTINE COPY_TEGWWMS (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE LOAD_TEGWWMS (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TEGWWMS (SELF, KLUN)
...
MODULE SUBROUTINE WIPE_TEGWWMS (SELF, LDDELETED, LDFIELDAPI)
