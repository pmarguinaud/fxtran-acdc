...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ACVPPKF_PARALLEL:PART0')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART0:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (ICLBAS, YL_ICLBAS)
  CALL SGET_DEVICE_DATA_RDWR (ICLBASS, YL_ICLBASS)
  CALL SGET_DEVICE_DATA_RDWR (ICLTOP, YL_ICLTOP)
  CALL SGET_DEVICE_DATA_RDWR (ICLTOPS, YL_ICLTOPS)
  CALL SGET_DEVICE_DATA_RDWR (I_KCLBAS, YL_I_KCLBAS)
  CALL SGET_DEVICE_DATA_RDWR (I_KCLTOP, YL_I_KCLTOP)
  CALL SGET_DEVICE_DATA_RDWR (I_KCOUNT, YL_I_KCOUNT)
  CALL SGET_DEVICE_DATA_RDONLY (PAPHIF, YD_PAPHIF)
  CALL SGET_DEVICE_DATA_RDONLY (PAPRSF, YD_PAPRSF)
  CALL SGET_DEVICE_DATA_RDONLY (PDELP, YD_PDELP)
  CALL SGET_DEVICE_DATA_RDONLY (PQ, YD_PQ)
  CALL SGET_DEVICE_DATA_RDONLY (PQI, YD_PQI)
  CALL SGET_DEVICE_DATA_RDONLY (PQL, YD_PQL)
  CALL SGET_DEVICE_DATA_RDONLY (PT, YD_PT)
  CALL SGET_DEVICE_DATA_RDONLY (PTKE, YD_PTKE)
  CALL SGET_DEVICE_DATA_RDONLY (PU, YD_PU)
  CALL SGET_DEVICE_DATA_RDONLY (PV, YD_PV)
  CALL SGET_DEVICE_DATA_RDWR (ZAPHIF, YL_ZAPHIF)
  CALL SGET_DEVICE_DATA_RDWR (ZCAPE, YL_ZCAPE)
  CALL SGET_DEVICE_DATA_RDONLY (ZCH1, YL_ZCH1)
  CALL SGET_DEVICE_DATA_RDWR (ZDPSG, YL_ZDPSG)
  CALL SGET_DEVICE_DATA_RDWR (ZDQIDT, YL_ZDQIDT)
  CALL SGET_DEVICE_DATA_RDWR (ZDQLDT, YL_ZDQLDT)
  CALL SGET_DEVICE_DATA_RDWR (ZDQVDT, YL_ZDQVDT)
  CALL SGET_DEVICE_DATA_RDWR (ZDTDT, YL_ZDTDT)
  CALL SGET_DEVICE_DATA_RDWR (ZDUDT, YL_ZDUDT)
  CALL SGET_DEVICE_DATA_RDWR (ZDVDT, YL_ZDVDT)
  CALL SGET_DEVICE_DATA_RDWR (ZLS, YL_ZLS)
  CALL SGET_DEVICE_DATA_RDWR (ZLV, YL_ZLV)
  CALL SGET_DEVICE_DATA_RDWR (ZPABS, YL_ZPABS)
  CALL SGET_DEVICE_DATA_RDWR (ZQC, YL_ZQC)
  CALL SGET_DEVICE_DATA_RDWR (ZRC, YL_ZRC)
  CALL SGET_DEVICE_DATA_RDWR (ZRCTEN, YL_ZRCTEN)
  CALL SGET_DEVICE_DATA_RDWR (ZRI, YL_ZRI)
  CALL SGET_DEVICE_DATA_RDWR (ZRITEN, YL_ZRITEN)
  CALL SGET_DEVICE_DATA_RDWR (ZRV, YL_ZRV)
  CALL SGET_DEVICE_DATA_RDWR (ZRVTEN, YL_ZRVTEN)
  CALL SGET_DEVICE_DATA_RDWR (ZSHAL_ZCH1, YL_ZSHAL_ZCH1)
  CALL SGET_DEVICE_DATA_RDWR (ZSHAL_ZCH1TEN, YL_ZSHAL_ZCH1TEN)
  CALL SGET_DEVICE_DATA_RDWR (ZT, YL_ZT)
  CALL SGET_DEVICE_DATA_RDWR (ZTKECLS, YL_ZTKECLS)
  CALL SGET_DEVICE_DATA_RDWR (ZTTEN, YL_ZTTEN)
  CALL SGET_DEVICE_DATA_RDWR (ZU, YL_ZU)
  CALL SGET_DEVICE_DATA_RDWR (ZUMF, YL_ZUMF)
  CALL SGET_DEVICE_DATA_RDWR (ZUMFMAX, YL_ZUMFMAX)
  CALL SGET_DEVICE_DATA_RDWR (ZUQL, YL_ZUQL)
  CALL SGET_DEVICE_DATA_RDWR (ZUQV, YL_ZUQV)
  CALL SGET_DEVICE_DATA_RDWR (ZURCI, YL_ZURCI)
  CALL SGET_DEVICE_DATA_RDWR (ZURV, YL_ZURV)
  CALL SGET_DEVICE_DATA_RDWR (ZUTEN, YL_ZUTEN)
  CALL SGET_DEVICE_DATA_RDWR (ZV, YL_ZV)
  CALL SGET_DEVICE_DATA_RDWR (ZVTEN, YL_ZVTEN)
  CALL SGET_DEVICE_DATA_RDWR (ZW, YL_ZW)
  CALL SGET_DEVICE_DATA_RDWR (ZZUMF, YL_ZZUMF)
  CALL SGET_DEVICE_DATA_RDWR (ZZW, YL_ZZW)
  CALL SGET_DEVICE_DATA_RDWR (ZZZ, YL_ZZZ)
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART0:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART0:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ACVPPKF_PARALLEL:PART1')) THEN
  ...
  CALL SGET_DEVICE_DATA_RDWR (ICLBASS, YL_ICLBASS)
  CALL SGET_DEVICE_DATA_RDWR (ICLTOPS, YL_ICLTOPS)
  CALL SGET_DEVICE_DATA_RDWR (ISDPL, YL_ISDPL)
  CALL SGET_DEVICE_DATA_RDWR (ISLCL, YL_ISLCL)
  CALL SGET_DEVICE_DATA_RDWR (ISPBL, YL_ISPBL)
  CALL SGET_DEVICE_DATA_RDWR (LLTRIG1, YL_LLTRIG1)
  CALL SGET_DEVICE_DATA_RDONLY (ZPABS, YL_ZPABS)
  CALL SGET_DEVICE_DATA_RDONLY (ZRC, YL_ZRC)
  CALL SGET_DEVICE_DATA_RDWR (ZRCTEN, YL_ZRCTEN)
  CALL SGET_DEVICE_DATA_RDONLY (ZRI, YL_ZRI)
  CALL SGET_DEVICE_DATA_RDWR (ZRITEN, YL_ZRITEN)
  CALL SGET_DEVICE_DATA_RDONLY (ZRV, YL_ZRV)
  CALL SGET_DEVICE_DATA_RDWR (ZRVTEN, YL_ZRVTEN)
  CALL SGET_DEVICE_DATA_RDONLY (ZSHAL_ZCH1, YL_ZSHAL_ZCH1)
  CALL SGET_DEVICE_DATA_RDWR (ZSHAL_ZCH1TENS, YL_ZSHAL_ZCH1TENS)
  CALL SGET_DEVICE_DATA_RDWR (ZSRVLCL, YL_ZSRVLCL)
  CALL SGET_DEVICE_DATA_RDWR (ZSTHES, YL_ZSTHES)
  CALL SGET_DEVICE_DATA_RDWR (ZSTHLCL, YL_ZSTHLCL)
  CALL SGET_DEVICE_DATA_RDWR (ZSTHV, YL_ZSTHV)
  CALL SGET_DEVICE_DATA_RDWR (ZSTHVELCL, YL_ZSTHVELCL)
  CALL SGET_DEVICE_DATA_RDWR (ZSTLCL, YL_ZSTLCL)
  CALL SGET_DEVICE_DATA_RDWR (ZSWLCL, YL_ZSWLCL)
  CALL SGET_DEVICE_DATA_RDWR (ZSZLCL, YL_ZSZLCL)
  CALL SGET_DEVICE_DATA_RDONLY (ZT, YL_ZT)
  CALL SGET_DEVICE_DATA_RDWR (ZTHT, YL_ZTHT)
  CALL SGET_DEVICE_DATA_RDONLY (ZTKECLS, YL_ZTKECLS)
  CALL SGET_DEVICE_DATA_RDWR (ZTTEN, YL_ZTTEN)
  CALL SGET_DEVICE_DATA_RDWR (ZZUMF, YL_ZZUMF)
  CALL SGET_DEVICE_DATA_RDONLY (ZZW, YL_ZZW)
  CALL SGET_DEVICE_DATA_RDONLY (ZZZ, YL_ZZZ)
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART1:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART1:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ACVPPKF_PARALLEL:PART2')) THEN
  ...
  CALL YL_FGS%INIT (YL_LLTRIG1, YDCPG_OPTS%KGPTOTB)
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART2:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGATHER_DEVICE_DATA_RDWR (YL_FGS, ICLBASS_GATHER, YL_ICLBASS)
  CALL SGATHER_DEVICE_DATA_RDWR (YL_FGS, ICLTOPS_GATHER, YL_ICLTOPS)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ISDPL_GATHER, YL_ISDPL)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ISLCL_GATHER, YL_ISLCL)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ISPBL_GATHER, YL_ISPBL)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, LLTRIG1_GATHER, YL_LLTRIG1)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZPABS_GATHER, YL_ZPABS)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZRC_GATHER, YL_ZRC)
  CALL SGATHER_DEVICE_DATA_RDWR (YL_FGS, ZRCTEN_GATHER, YL_ZRCTEN)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZRI_GATHER, YL_ZRI)
  CALL SGATHER_DEVICE_DATA_RDWR (YL_FGS, ZRITEN_GATHER, YL_ZRITEN)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZRV_GATHER, YL_ZRV)
  CALL SGATHER_DEVICE_DATA_RDWR (YL_FGS, ZRVTEN_GATHER, YL_ZRVTEN)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZSHAL_ZCH1_GATHER, YL_ZSHAL_ZCH1)
  CALL SGATHER_DEVICE_DATA_RDWR (YL_FGS, ZSHAL_ZCH1TENS_GATHER, YL_ZSHAL_ZCH1TENS)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZSRVLCL_GATHER, YL_ZSRVLCL)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZSTHES_GATHER, YL_ZSTHES)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZSTHLCL_GATHER, YL_ZSTHLCL)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZSTHV_GATHER, YL_ZSTHV)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZSTHVELCL_GATHER, YL_ZSTHVELCL)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZSTLCL_GATHER, YL_ZSTLCL)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZSWLCL_GATHER, YL_ZSWLCL)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZSZLCL_GATHER, YL_ZSZLCL)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZT_GATHER, YL_ZT)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZTHT_GATHER, YL_ZTHT)
  CALL SGATHER_DEVICE_DATA_RDWR (YL_FGS, ZTTEN_GATHER, YL_ZTTEN)
  CALL SGATHER_DEVICE_DATA_RDWR (YL_FGS, ZZUMF_GATHER, YL_ZZUMF)
  CALL SGATHER_DEVICE_DATA_RDONLY (YL_FGS, ZZZ_GATHER, YL_ZZZ)
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART2:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART2:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
  
  !$OMP TARGET TEAMS DISTRIBUTE  & 
  !$OMP & COPYIN (D)  & 
  !$OMP & MAP(PRESENT:ICLBASS_GATHER, ICLTOPS_GATHER, ISDPL_GATHER, ISLCL_GATHER, ISPBL_GATHER, LLTRIG1_GATHER, YDCPG_OPTS, YDML_PHY_MF,  & 
  !$OMP &          YFXTRAN_ACDC_STACK, ZPABS_GATHER, ZRC_GATHER, ZRCTEN_GATHER, ZRI_GATHER, ZRITEN_GATHER, ZRV_GATHER, ZRVTEN_GATHER, ZSHAL_ZCH1_GATHER,  & 
  !$OMP &          ZSHAL_ZCH1TENS_GATHER, ZSRVLCL_GATHER, ZSTHES_GATHER, ZSTHLCL_GATHER, ZSTHV_GATHER, ZSTHVELCL_GATHER, ZSTLCL_GATHER,  & 
  !$OMP &          ZSWLCL_GATHER, ZSZLCL_GATHER, ZT_GATHER, ZTHT_GATHER, ZTTEN_GATHER, ZZUMF_GATHER, ZZZ_GATHER)  & 
  !$OMP & PRIVATE (JBLK)  & 
  !$OMP & THREAD_LIMIT (YDCPG_OPTS%KLON)       
...
ELSEIF (FXTRAN_ACDC_LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ACVPPKF_PARALLEL:PART3')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART3:GET_DATA',0,ZHOOK_HANDLE_FIELD_API)
  CALL SGET_DEVICE_DATA_RDWR (ICLBAS, YL_ICLBAS)
  CALL SGET_DEVICE_DATA_RDONLY (ICLBASS, YL_ICLBASS)
  CALL SGET_DEVICE_DATA_RDWR (ICLTOP, YL_ICLTOP)
  CALL SGET_DEVICE_DATA_RDONLY (ICLTOPS, YL_ICLTOPS)
  CALL SGET_DEVICE_DATA_RDWR (I_KCLBAS, YL_I_KCLBAS)
  CALL SGET_DEVICE_DATA_RDWR (I_KCLTOP, YL_I_KCLTOP)
  CALL SGET_DEVICE_DATA_RDWR (KNLAB, YD_KNLAB)
  CALL SGET_DEVICE_DATA_RDWR (KNND, YD_KNND)
  CALL SGET_DEVICE_DATA_RDONLY (PAPRSF, YD_PAPRSF)
  CALL SGET_DEVICE_DATA_RDONLY (PCP, YD_PCP)
  CALL SGET_DEVICE_DATA_RDWR (PDIFCQ, YD_PDIFCQ)
  CALL SGET_DEVICE_DATA_RDWR (PDIFCS, YD_PDIFCS)
  CALL SGET_DEVICE_DATA_RDWR (PFCCQL, YD_PFCCQL)
  CALL SGET_DEVICE_DATA_RDWR (PFCCQN, YD_PFCCQN)
  CALL SGET_DEVICE_DATA_RDWR (PNEBPP, YD_PNEBPP)
  CALL SGET_DEVICE_DATA_RDWR (PPRODTH, YD_PPRODTH)
  CALL SGET_DEVICE_DATA_RDWR (PQCPP, YD_PQCPP)
  CALL SGET_DEVICE_DATA_RDONLY (PR, YD_PR)
  CALL SGET_DEVICE_DATA_RDONLY (PT, YD_PT)
  CALL SGET_DEVICE_DATA_RDWR (ZBETA, YL_ZBETA)
  CALL SGET_DEVICE_DATA_RDWR (ZCH1TEN, YL_ZCH1TEN)
  CALL SGET_DEVICE_DATA_RDONLY (ZDPSG, YL_ZDPSG)
  CALL SGET_DEVICE_DATA_RDWR (ZDQIDT, YL_ZDQIDT)
  CALL SGET_DEVICE_DATA_RDWR (ZDQLDT, YL_ZDQLDT)
  CALL SGET_DEVICE_DATA_RDWR (ZDQVDT, YL_ZDQVDT)
  CALL SGET_DEVICE_DATA_RDWR (ZDTDT, YL_ZDTDT)
  CALL SGET_DEVICE_DATA_RDWR (ZDUDT, YL_ZDUDT)
  CALL SGET_DEVICE_DATA_RDWR (ZDVDT, YL_ZDVDT)
  CALL SGET_DEVICE_DATA_RDONLY (ZLS, YL_ZLS)
  CALL SGET_DEVICE_DATA_RDONLY (ZLV, YL_ZLV)
  CALL SGET_DEVICE_DATA_RDONLY (ZQC, YL_ZQC)
  CALL SGET_DEVICE_DATA_RDONLY (ZRCTEN, YL_ZRCTEN)
  CALL SGET_DEVICE_DATA_RDWR (ZRHO, YL_ZRHO)
  CALL SGET_DEVICE_DATA_RDONLY (ZRITEN, YL_ZRITEN)
  CALL SGET_DEVICE_DATA_RDONLY (ZRVTEN, YL_ZRVTEN)
  CALL SGET_DEVICE_DATA_RDONLY (ZSHAL_ZCH1TEN, YL_ZSHAL_ZCH1TEN)
  CALL SGET_DEVICE_DATA_RDWR (ZTHETA, YL_ZTHETA)
  CALL SGET_DEVICE_DATA_RDONLY (ZTTEN, YL_ZTTEN)
  CALL SGET_DEVICE_DATA_RDWR (ZUMF, YL_ZUMF)
  CALL SGET_DEVICE_DATA_RDWR (ZUMFMAX, YL_ZUMFMAX)
  CALL SGET_DEVICE_DATA_RDWR (ZUQL, YL_ZUQL)
  CALL SGET_DEVICE_DATA_RDWR (ZUQV, YL_ZUQV)
  CALL SGET_DEVICE_DATA_RDONLY (ZURCI, YL_ZURCI)
  CALL SGET_DEVICE_DATA_RDONLY (ZURV, YL_ZURV)
  CALL SGET_DEVICE_DATA_RDONLY (ZUTEN, YL_ZUTEN)
  CALL SGET_DEVICE_DATA_RDONLY (ZVTEN, YL_ZVTEN)
  CALL SGET_DEVICE_DATA_RDONLY (ZZUMF, YL_ZZUMF)
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART3:GET_DATA',1,ZHOOK_HANDLE_FIELD_API)
  IF (LHOOK) CALL DR_HOOK ('ACVPPKF_PARALLEL:PART3:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
