...
CONTAINS
PROCEDURE :: COPY => COPY_TGSGEOM
PROCEDURE :: CRC64 => CRC64_TGSGEOM
PROCEDURE :: HOST => HOST_TGSGEOM
PROCEDURE :: LOAD => LOAD_TGSGEOM
PROCEDURE :: SAVE => SAVE_TGSGEOM
PROCEDURE :: SIZE => SIZE_TGSGEOM
PROCEDURE :: WIPE => WIPE_TGSGEOM
END TYPE TGSGEOM
...
TYPE TGSGEOM_BLOCKED
  ...
  INTEGER(KIND=JPIM), POINTER,CONTIGUOUS :: NUNIQUEGP(:,:) => NULL()
CONTAINS
PROCEDURE :: COPY => COPY_TGSGEOM_BLOCKED
PROCEDURE :: CRC64 => CRC64_TGSGEOM_BLOCKED
PROCEDURE :: HOST => HOST_TGSGEOM_BLOCKED
PROCEDURE :: LOAD => LOAD_TGSGEOM_BLOCKED
PROCEDURE :: SAVE => SAVE_TGSGEOM_BLOCKED
PROCEDURE :: SIZE => SIZE_TGSGEOM_BLOCKED
PROCEDURE :: WIPE => WIPE_TGSGEOM_BLOCKED
...
MODULE SUBROUTINE HOST_TGSGEOM (SELF)
...
MODULE SUBROUTINE HOST_TGSGEOM_BLOCKED (SELF)
