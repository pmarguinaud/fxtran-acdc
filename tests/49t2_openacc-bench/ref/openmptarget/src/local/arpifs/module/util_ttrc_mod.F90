...
LGRSURF = ALLOCATED (SELF%GRSURF)
IF (LGRSURF) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GRSURF)
  !$OMP TARGET UPDATE TO (SELF%GRSURF)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GRSURF)
ENDIF

LGDEOTI = ALLOCATED (SELF%GDEOTI)
IF (LGDEOTI) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GDEOTI)
  !$OMP TARGET UPDATE TO (SELF%GDEOTI)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GDEOTI)
ENDIF

LGDEOTI2 = ALLOCATED (SELF%GDEOTI2)
IF (LGDEOTI2) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GDEOTI2)
  !$OMP TARGET UPDATE TO (SELF%GDEOTI2)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GDEOTI2)
ENDIF

LGUEOTI = ALLOCATED (SELF%GUEOTI)
IF (LGUEOTI) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GUEOTI)
  !$OMP TARGET UPDATE TO (SELF%GUEOTI)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GUEOTI)
ENDIF

LGUEOTI2 = ALLOCATED (SELF%GUEOTI2)
IF (LGUEOTI2) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GUEOTI2)
  !$OMP TARGET UPDATE TO (SELF%GUEOTI2)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GUEOTI2)
ENDIF

LGEOLT = ALLOCATED (SELF%GEOLT)
IF (LGEOLT) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GEOLT)
  !$OMP TARGET UPDATE TO (SELF%GEOLT)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GEOLT)
ENDIF

LGEOXT = ALLOCATED (SELF%GEOXT)
IF (LGEOXT) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GEOXT)
  !$OMP TARGET UPDATE TO (SELF%GEOXT)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GEOXT)
ENDIF

LGRPROX = ALLOCATED (SELF%GRPROX)
IF (LGRPROX) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GRPROX)
  !$OMP TARGET UPDATE TO (SELF%GRPROX)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GRPROX)
ENDIF

LGMIXP = ALLOCATED (SELF%GMIXP)
IF (LGMIXP) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GMIXP)
  !$OMP TARGET UPDATE TO (SELF%GMIXP)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GMIXP)
ENDIF

LGFLUXC = ALLOCATED (SELF%GFLUXC)
IF (LGFLUXC) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GFLUXC)
  !$OMP TARGET UPDATE TO (SELF%GFLUXC)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GFLUXC)
ENDIF

LGDEOSI = ALLOCATED (SELF%GDEOSI)
IF (LGDEOSI) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GDEOSI)
  !$OMP TARGET UPDATE TO (SELF%GDEOSI)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GDEOSI)
ENDIF

LGUEOSI = ALLOCATED (SELF%GUEOSI)
IF (LGUEOSI) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GUEOSI)
  !$OMP TARGET UPDATE TO (SELF%GUEOSI)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GUEOSI)
ENDIF

LGMU0 = ALLOCATED (SELF%GMU0)
IF (LGMU0) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GMU0)
  !$OMP TARGET UPDATE TO (SELF%GMU0)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GMU0)
ENDIF

LGMU0_MIN = ALLOCATED (SELF%GMU0_MIN)
IF (LGMU0_MIN) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GMU0_MIN)
  !$OMP TARGET UPDATE TO (SELF%GMU0_MIN)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GMU0_MIN)
ENDIF

LGMU0_MAX = ALLOCATED (SELF%GMU0_MAX)
IF (LGMU0_MAX) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%GMU0_MAX)
  !$OMP TARGET UPDATE TO (SELF%GMU0_MAX)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%GMU0_MAX)
ENDIF
...
LGRSURF = ALLOCATED (SELF%GRSURF)
IF (LGRSURF) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GRSURF)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GRSURF)
ENDIF

LGDEOTI = ALLOCATED (SELF%GDEOTI)
IF (LGDEOTI) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GDEOTI)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GDEOTI)
ENDIF

LGDEOTI2 = ALLOCATED (SELF%GDEOTI2)
IF (LGDEOTI2) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GDEOTI2)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GDEOTI2)
ENDIF

LGUEOTI = ALLOCATED (SELF%GUEOTI)
IF (LGUEOTI) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GUEOTI)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GUEOTI)
ENDIF

LGUEOTI2 = ALLOCATED (SELF%GUEOTI2)
IF (LGUEOTI2) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GUEOTI2)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GUEOTI2)
ENDIF

LGEOLT = ALLOCATED (SELF%GEOLT)
IF (LGEOLT) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GEOLT)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GEOLT)
ENDIF

LGEOXT = ALLOCATED (SELF%GEOXT)
IF (LGEOXT) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GEOXT)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GEOXT)
ENDIF

LGRPROX = ALLOCATED (SELF%GRPROX)
IF (LGRPROX) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GRPROX)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GRPROX)
ENDIF

LGMIXP = ALLOCATED (SELF%GMIXP)
IF (LGMIXP) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GMIXP)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GMIXP)
ENDIF

LGFLUXC = ALLOCATED (SELF%GFLUXC)
IF (LGFLUXC) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GFLUXC)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GFLUXC)
ENDIF

LGDEOSI = ALLOCATED (SELF%GDEOSI)
IF (LGDEOSI) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GDEOSI)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GDEOSI)
ENDIF

LGUEOSI = ALLOCATED (SELF%GUEOSI)
IF (LGUEOSI) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GUEOSI)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GUEOSI)
ENDIF

LGMU0 = ALLOCATED (SELF%GMU0)
IF (LGMU0) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GMU0)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GMU0)
ENDIF

LGMU0_MIN = ALLOCATED (SELF%GMU0_MIN)
IF (LGMU0_MIN) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GMU0_MIN)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GMU0_MIN)
ENDIF

LGMU0_MAX = ALLOCATED (SELF%GMU0_MAX)
IF (LGMU0_MAX) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%GMU0_MAX)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%GMU0_MAX)
ENDIF
