...
PROCEDURE :: COPY => COPY_TECUMF
PROCEDURE :: CRC64 => CRC64_TECUMF
PROCEDURE :: HOST => HOST_TECUMF
PROCEDURE :: LOAD => LOAD_TECUMF
PROCEDURE :: SAVE => SAVE_TECUMF
PROCEDURE :: SIZE => SIZE_TECUMF
PROCEDURE :: WIPE => WIPE_TECUMF
END TYPE TECUMF
!============================================================================
...
MODULE SUBROUTINE COPY_TECUMF (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE WIPE_TECUMF (SELF, LDDELETED, LDFIELDAPI)
