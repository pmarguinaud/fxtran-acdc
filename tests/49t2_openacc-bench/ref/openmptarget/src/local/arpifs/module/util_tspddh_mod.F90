...
LSPTNDHD_VOR = ALLOCATED (SELF%SPTNDHD_VOR)
IF (LSPTNDHD_VOR) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%SPTNDHD_VOR)
  !$OMP TARGET UPDATE TO (SELF%SPTNDHD_VOR)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%SPTNDHD_VOR)
ENDIF

LSPTNDHD_DIV = ALLOCATED (SELF%SPTNDHD_DIV)
IF (LSPTNDHD_DIV) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%SPTNDHD_DIV)
  !$OMP TARGET UPDATE TO (SELF%SPTNDHD_DIV)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%SPTNDHD_DIV)
ENDIF

LSPTNDHD_T = ALLOCATED (SELF%SPTNDHD_T)
IF (LSPTNDHD_T) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%SPTNDHD_T)
  !$OMP TARGET UPDATE TO (SELF%SPTNDHD_T)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%SPTNDHD_T)
ENDIF

LSPTNDHD_SPD = ALLOCATED (SELF%SPTNDHD_SPD)
IF (LSPTNDHD_SPD) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%SPTNDHD_SPD)
  !$OMP TARGET UPDATE TO (SELF%SPTNDHD_SPD)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%SPTNDHD_SPD)
ENDIF

LSPTNDHD_SVD = ALLOCATED (SELF%SPTNDHD_SVD)
IF (LSPTNDHD_SVD) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%SPTNDHD_SVD)
  !$OMP TARGET UPDATE TO (SELF%SPTNDHD_SVD)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%SPTNDHD_SVD)
ENDIF

LSPTNDHD_SNHX = ALLOCATED (SELF%SPTNDHD_SNHX)
IF (LSPTNDHD_SNHX) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%SPTNDHD_SNHX)
  !$OMP TARGET UPDATE TO (SELF%SPTNDHD_SNHX)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%SPTNDHD_SNHX)
ENDIF

LSPTNDHD_GFL = ALLOCATED (SELF%SPTNDHD_GFL)
IF (LSPTNDHD_GFL) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%SPTNDHD_GFL)
  !$OMP TARGET UPDATE TO (SELF%SPTNDHD_GFL)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%SPTNDHD_GFL)
ENDIF

LSPTNDSI_VOR = ALLOCATED (SELF%SPTNDSI_VOR)
IF (LSPTNDSI_VOR) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%SPTNDSI_VOR)
  !$OMP TARGET UPDATE TO (SELF%SPTNDSI_VOR)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%SPTNDSI_VOR)
ENDIF

LSPTNDSI_DIV = ALLOCATED (SELF%SPTNDSI_DIV)
IF (LSPTNDSI_DIV) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%SPTNDSI_DIV)
  !$OMP TARGET UPDATE TO (SELF%SPTNDSI_DIV)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%SPTNDSI_DIV)
ENDIF

LSPTNDSI_T = ALLOCATED (SELF%SPTNDSI_T)
IF (LSPTNDSI_T) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%SPTNDSI_T)
  !$OMP TARGET UPDATE TO (SELF%SPTNDSI_T)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%SPTNDSI_T)
ENDIF

LSPTNDSI_SPD = ALLOCATED (SELF%SPTNDSI_SPD)
IF (LSPTNDSI_SPD) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%SPTNDSI_SPD)
  !$OMP TARGET UPDATE TO (SELF%SPTNDSI_SPD)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%SPTNDSI_SPD)
ENDIF

LSPTNDSI_SVD = ALLOCATED (SELF%SPTNDSI_SVD)
IF (LSPTNDSI_SVD) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%SPTNDSI_SVD)
  !$OMP TARGET UPDATE TO (SELF%SPTNDSI_SVD)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%SPTNDSI_SVD)
ENDIF
...
LSPTNDHD_VOR = ALLOCATED (SELF%SPTNDHD_VOR)
IF (LSPTNDHD_VOR) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%SPTNDHD_VOR)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%SPTNDHD_VOR)
ENDIF

LSPTNDHD_DIV = ALLOCATED (SELF%SPTNDHD_DIV)
IF (LSPTNDHD_DIV) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%SPTNDHD_DIV)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%SPTNDHD_DIV)
ENDIF

LSPTNDHD_T = ALLOCATED (SELF%SPTNDHD_T)
IF (LSPTNDHD_T) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%SPTNDHD_T)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%SPTNDHD_T)
ENDIF

LSPTNDHD_SPD = ALLOCATED (SELF%SPTNDHD_SPD)
IF (LSPTNDHD_SPD) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%SPTNDHD_SPD)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%SPTNDHD_SPD)
ENDIF

LSPTNDHD_SVD = ALLOCATED (SELF%SPTNDHD_SVD)
IF (LSPTNDHD_SVD) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%SPTNDHD_SVD)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%SPTNDHD_SVD)
ENDIF

LSPTNDHD_SNHX = ALLOCATED (SELF%SPTNDHD_SNHX)
IF (LSPTNDHD_SNHX) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%SPTNDHD_SNHX)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%SPTNDHD_SNHX)
ENDIF

LSPTNDHD_GFL = ALLOCATED (SELF%SPTNDHD_GFL)
IF (LSPTNDHD_GFL) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%SPTNDHD_GFL)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%SPTNDHD_GFL)
ENDIF

LSPTNDSI_VOR = ALLOCATED (SELF%SPTNDSI_VOR)
IF (LSPTNDSI_VOR) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%SPTNDSI_VOR)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%SPTNDSI_VOR)
ENDIF

LSPTNDSI_DIV = ALLOCATED (SELF%SPTNDSI_DIV)
IF (LSPTNDSI_DIV) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%SPTNDSI_DIV)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%SPTNDSI_DIV)
ENDIF

LSPTNDSI_T = ALLOCATED (SELF%SPTNDSI_T)
IF (LSPTNDSI_T) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%SPTNDSI_T)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%SPTNDSI_T)
ENDIF

LSPTNDSI_SPD = ALLOCATED (SELF%SPTNDSI_SPD)
IF (LSPTNDSI_SPD) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%SPTNDSI_SPD)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%SPTNDSI_SPD)
ENDIF

LSPTNDSI_SVD = ALLOCATED (SELF%SPTNDSI_SVD)
IF (LSPTNDSI_SVD) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%SPTNDSI_SVD)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%SPTNDSI_SVD)
ENDIF
