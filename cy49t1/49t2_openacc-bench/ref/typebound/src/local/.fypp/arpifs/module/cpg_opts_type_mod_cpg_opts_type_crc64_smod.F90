...
CLIND = ''
CALL SELF%YRSURF_OPTS%CRC64 (KLUN, CDPATH//'%YRSURF_OPTS'//TRIM(CLIND))

CLIND = ''
CALL SELF%YRSURF_DIMS%CRC64 (KLUN, CDPATH//'%YRSURF_DIMS'//TRIM(CLIND))

CLIND = ''
CALL SELF%YRVARS_DIMS%CRC64 (KLUN, CDPATH//'%YRVARS_DIMS'//TRIM(CLIND))
...
CLIND = ''
CALL SELF%YRCLI%CRC64 (KLUN, CDPATH//'%YRCLI'//TRIM(CLIND))
