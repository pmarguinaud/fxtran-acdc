...
IF (YDCPG_OPTS%NSTEP==0) THEN
  ...
  IF (LPARALLELMETHOD ('OPENMP','ARP_SHALLOW_MF_PARALLEL:ZERO')) THEN
    ...
    IF (LSYNCHOST ('ARP_SHALLOW_MF_PARALLEL:ZERO')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','ARP_SHALLOW_MF_PARALLEL:ZERO')) THEN
  ...
  ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ARP_SHALLOW_MF_PARALLEL:ZERO')) THEN
    ...
    IF (LHOOK) CALL DR_HOOK ('ARP_SHALLOW_MF_PARALLEL:ZERO:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
      ...
      !$ACC&PRESENT (YDCPG_OPTS, YSTACK, Z_YDMF_PHYS_SURF_GSD_SFL_PGROUP) &
      !$ACC&PRIVATE (JBLK) &
...
IF (LPARALLELMETHOD ('OPENMP','ARP_SHALLOW_MF_PARALLEL:INIT')) THEN
  ...
  IF (LSYNCHOST ('ARP_SHALLOW_MF_PARALLEL:INIT')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','ARP_SHALLOW_MF_PARALLEL:INIT')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ARP_SHALLOW_MF_PARALLEL:INIT')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('ARP_SHALLOW_MF_PARALLEL:INIT:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         YDCPG_OPTS, YDCST, YSTACK, ZDPSG, ZDRTDT_MF, ZDTHLDT_MF, ZDUDT_MF, &
    !$ACC&         ZDVDT_MF, ZDZZ, ZEMF, ZEXNER, ZFLXZTHMF, ZFLXZTHVMF, ZFLXZUMF, ZFLXZVMF, &
    !$ACC&         ZFRAC_UP, ZHRO, ZHRODJ, ZHRODREF, ZQDM, ZRC_UP, ZRI_UP, ZRM, ZRT_UP, &
    !$ACC&         ZRV_UP, ZSFRV, ZSFTH, ZSVM, ZTHETA, ZTHL_UP, ZU_UP, ZW_UP, ZZZ, ZZZF, Z_YDMF_PHYS_SURF_GSD_SFL_PGROUP) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
...
IF (LPARALLELMETHOD ('OPENMP','ARP_SHALLOW_MF_PARALLEL:SHALLOW_MF')) THEN
  ...
  IF (LSYNCHOST ('ARP_SHALLOW_MF_PARALLEL:SHALLOW_MF')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','ARP_SHALLOW_MF_PARALLEL:SHALLOW_MF')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ARP_SHALLOW_MF_PARALLEL:SHALLOW_MF')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('ARP_SHALLOW_MF_PARALLEL:SHALLOW_MF:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC PARALLEL LOOP GANG &
    !$ACC&PRESENT (IKCTL, IKETL, IKLCL, PAPRSF, PNEB, PTKE, PU, PV, YDCPG_OPTS, YDPHYEX, YSTACK, &
...
IF (LPARALLELMETHOD ('OPENMP','ARP_SHALLOW_MF_PARALLEL:FINISH')) THEN
  ...
  IF (LSYNCHOST ('ARP_SHALLOW_MF_PARALLEL:FINISH')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','ARP_SHALLOW_MF_PARALLEL:FINISH')) THEN
  ...
  !$OMP PARALLEL DO PRIVATE (JBLK, JLEV, JLON, YLCPG_BNDS, YLSTACK, ZTDCP)
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','ARP_SHALLOW_MF_PARALLEL:FINISH')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('ARP_SHALLOW_MF_PARALLEL:FINISH:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PT, YDCPG_OPTS, YDCST, YSTACK, ZDPSG, ZDRTDT_MF, ZDTHLDT_MF, ZDUDT_MF, &
    !$ACC&         ZDVDT_MF, ZEMF, ZEXNER, ZFH_MF, ZFLXZTHVMF, ZFQ_MF, ZFU_MF, ZFV_MF, &
    !$ACC&         ZHRODREF, ZQDM, ZRC_UP, ZRI_UP, ZRT_UP, ZTHETA) &
    !$ACC&PRIVATE (JBLK) &
    !$ACC&VECTOR_LENGTH (YDCPG_OPTS%KLON) 
    ...
    !$ACC LOOP VECTOR &
    !$ACC&PRIVATE (JLEV, JLON, YLCPG_BNDS, YLSTACK, ZTDCP) 
...
ENDSUBROUTINE ARP_SHALLOW_MF_PARALLEL
