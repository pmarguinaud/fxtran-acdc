...
ELSE
  CALL PRINT_MSG_OPENACC (NVERB_FATAL,'GEN','COMPUTE_MF_CLOUD','Shallow convection cloud&
  & scheme not valid: PARAMMF%CMF_CLOUD='//TRIM (PARAMMF%CMF_CLOUD), YDSTACK=YLSTACK)
ENDIF
