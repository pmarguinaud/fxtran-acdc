...
PROCEDURE :: COPY => COPY_MODEL
PROCEDURE :: CRC64 => CRC64_MODEL
PROCEDURE :: HOST => HOST_MODEL
PROCEDURE :: LOAD => LOAD_MODEL
PROCEDURE :: SAVE => SAVE_MODEL
PROCEDURE :: SIZE => SIZE_MODEL
PROCEDURE :: WIPE => WIPE_MODEL
END TYPE MODEL
