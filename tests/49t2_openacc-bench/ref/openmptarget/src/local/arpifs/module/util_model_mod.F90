...
LYRCST = ASSOCIATED (SELF%YRCST)
IF (LYRCST) THEN
  !$OMP TARGET ENTER DATA MAP (ALLOC: SELF%YRCST)
  !$OMP TARGET UPDATE TO (SELF%YRCST)
  CALL ACDC_COPY_TCST (SELF%YRCST, LDCREATED=.TRUE., LDFIELDAPI=LDFIELDAPI)
  !$OMP TARGET ENTER DATA MAP (TO: SELF%YRCST)
ENDIF
...
LYRCST = ASSOCIATED (SELF%YRCST)
IF (LYRCST) THEN
  !$OMP TARGET EXIT DATA MAP (RELEASE: SELF%YRCST)
  CALL ACDC_WIPE_TCST (SELF%YRCST, LDDELETED=.TRUE., LDFIELDAPI=LDFIELDAPI)
  !$OMP TARGET EXIT DATA MAP (DELETE: SELF%YRCST)
ENDIF
