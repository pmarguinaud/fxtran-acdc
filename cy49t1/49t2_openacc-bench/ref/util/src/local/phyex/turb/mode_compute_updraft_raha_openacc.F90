...
temp (REAL, ZTHSM, (D%NIJT, D%NKT))
temp (REAL, ZTHS_UP, (D%NIJT, D%NKT))
...
REAL::ZALIM_STAR_TOT
REAL::ZPHI
temp (REAL, ZZZ, (D%NIJT, D%NKT))
temp (REAL, ZZDZ, (D%NIJT, D%NKT))
temp (REAL, ZALIM_STAR, (D%NIJT, D%NKT))
temp (REAL, ZDTHETASDZ, (D%NIJT, D%NKT))
INTEGER::IALIM
REAL::ZWUP_MEAN
REAL::ZDZ
REAL::ZTEST
