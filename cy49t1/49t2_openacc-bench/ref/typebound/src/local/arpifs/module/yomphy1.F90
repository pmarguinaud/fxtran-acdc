...
CONTAINS
PROCEDURE :: COPY => COPY_TPHY1
PROCEDURE :: CRC64 => CRC64_TPHY1
PROCEDURE :: HOST => HOST_TPHY1
PROCEDURE :: LOAD => LOAD_TPHY1
PROCEDURE :: SAVE => SAVE_TPHY1
PROCEDURE :: SIZE => SIZE_TPHY1
PROCEDURE :: WIPE => WIPE_TPHY1
END TYPE TPHY1
...
MODULE SUBROUTINE COPY_TPHY1 (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TPHY1 (SELF)

IMPLICIT NONE
CLASS (TPHY1), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LOAD_TPHY1 (SELF, KLUN)
...
MODULE SUBROUTINE WIPE_TPHY1 (SELF, LDDELETED, LDFIELDAPI)
