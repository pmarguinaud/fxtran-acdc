...
TYPE(STACK) :: YLSTACK
temp (REAL, ZFLXZ3, (D%NIJT, D%NKT))
temp (REAL, ZFLXZ2, (D%NIJT, D%NKT))
temp (REAL, ZFLXZ, (D%NIJT, D%NKT))
temp (REAL, ZT, (D%NIJT, D%NKT))
temp (REAL, ZATHETA, (D%NIJT, D%NKT))
temp (REAL, ZAMOIST, (D%NIJT, D%NKT))
temp (REAL, ZWK2, (D%NIJT, D%NKT))
