...
CONTAINS
PROCEDURE :: COPY => COPY_TTDDH
PROCEDURE :: CRC64 => CRC64_TTDDH
PROCEDURE :: HOST => HOST_TTDDH
PROCEDURE :: LOAD => LOAD_TTDDH
PROCEDURE :: SAVE => SAVE_TTDDH
PROCEDURE :: SIZE => SIZE_TTDDH
PROCEDURE :: WIPE => WIPE_TTDDH
END TYPE TTDDH
...
MODULE SUBROUTINE COPY_TTDDH (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE HOST_TTDDH (SELF)
...
MODULE SUBROUTINE WIPE_TTDDH (SELF, LDDELETED, LDFIELDAPI)
