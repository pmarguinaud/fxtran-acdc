...
IF (LPARALLELMETHOD ('OPENMP','APL_ARPEGE_CLOUDINESS_PARALLEL:ACNEBCOND')) THEN
  ...
  IF (LSYNCHOST ('APL_ARPEGE_CLOUDINESS_PARALLEL:ACNEBCOND')) THEN
    IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_CLOUDINESS_PARALLEL&
...
ELSEIF (LPARALLELMETHOD ('OPENMPSINGLECOLUMN','APL_ARPEGE_CLOUDINESS_PARALLEL:ACNEBCOND')) THEN
...
ELSEIF (LPARALLELMETHOD ('OPENACCSINGLECOLUMN','APL_ARPEGE_CLOUDINESS_PARALLEL:ACNEBCOND')) THEN
  ...
  IF (LHOOK) CALL DR_HOOK ('APL_ARPEGE_CLOUDINESS_PARALLEL:ACNEBCOND:COMPUTE',0,ZHOOK_HANDLE_COMPUTE)
    ...
    !$ACC&         PQV, PUNEBH, YDCPG_OPTS, YDMODEL, YDSTA, YSTACK, ZICEFR1, ZQSATS, ZRH, &
    !$ACC&         ZRHCRI, Z_YDCPG_MISC_CLCT, Z_YDCPG_MISC_NEB, Z_YDCPG_MISC_QICE, &
...
ENDSUBROUTINE APL_ARPEGE_CLOUDINESS_PARALLEL
