...
REAL (KIND=JPRB)::ZWL2
REAL (KIND=JPRB)::ZWL1
REAL (KIND=JPRB)::ZWDS3 (KPROMA)
REAL (KIND=JPRB)::ZWDS2 (KPROMA)
REAL (KIND=JPRB)::ZWDS1 (KPROMA)
REAL (KIND=JPRB)::ZWH3 (KPROMA)
REAL (KIND=JPRB)::ZWH2 (KPROMA)
REAL (KIND=JPRB)::ZWH1 (KPROMA)
  ...
  ELSE
    ...
    IF (LDSLVF) THEN
      ...
      DO JROF=KST, KEND
        ...
        IF (ILEV>=1.AND.ILEV<=KFLEV-3) THEN
          PVINTWSLVF (JROF, JLEV, 1)=PVSLVF (1, 1, ILEV)*ZWH1 (JROF)+PVSLVF&
          & (1, 2, ILEV)*ZWH2 (JROF)+PVSLVF (1, 3, ILEV)*ZWH3 (JROF)
          PVINTWSLVF (JROF, JLEV, 2)=PVSLVF (2, 1, ILEV)*ZWH1 (JROF)+PVSLVF&
          & (2, 2, ILEV)*ZWH2 (JROF)+PVSLVF (2, 3, ILEV)*ZWH3 (JROF)
          PVINTWSLVF (JROF, JLEV, 3)=PVSLVF (3, 1, ILEV)*ZWH1 (JROF)+PVSLVF&
          & (3, 2, ILEV)*ZWH2 (JROF)+PVSLVF (3, 3, ILEV)*ZWH3 (JROF)
        ELSE
...
ENDSUBROUTINE LASCAW_VINTW_OPENACC
