...
CALL CPG_ZEROPB2 (YDCPG_OPTS, YDCPG_SL2, YDCPG_BNDS)
...
IF (YDCPG_OPTS%LUSEPB1) THEN
  CALL CPG_ZEROSL1 (YDCPG_OPTS, YDCPG_BNDS, YDCPG_SL1AUX)
ENDIF
...
CALL CPG_LSMTSOL (YDVARS, YDCPG_MISC, YDMF_PHYS_SURF, YDCPG_OPTS, YDGEOMETRY, YDCPG_BNDS)
...
IF (YDCPG_OPTS%LUSEPB1) THEN
  CALL CPG_SHUFFLESL1 (YDCPG_SL1, YDCPG_OPTS, YDMODEL, YDCPG_BNDS, YDCPG_SL1AUX)
ENDIF
