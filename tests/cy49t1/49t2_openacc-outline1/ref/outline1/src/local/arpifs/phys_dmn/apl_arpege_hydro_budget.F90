...
IF (YDMODEL%YRML_PHY_MF%YRARPHY%LMSE) THEN
  CALL APL_ARPEGE_HYDRO_BUDGET_LMSE (YDCPG_BNDS, YDCPG_GPAR, YDCPG_OPTS, YDMF_PHYS, PFPLSL, PFPLSN)
ELSEIF (YDMODEL%YRML_PHY_MF%YRPHY%LSOLV) THEN
  CALL APL_ARPEGE_HYDRO_BUDGET_ACDROV (YDCPG_BNDS, YDCPG_OPTS, YDMF_PHYS, YDMF_PHYS_BASE_STATE&
