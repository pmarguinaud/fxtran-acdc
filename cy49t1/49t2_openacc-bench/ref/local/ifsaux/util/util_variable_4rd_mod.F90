...
SUBROUTINE COPY_VARIABLE_4RD (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE HOST_VARIABLE_4RD (SELF)
USE FIELD_UTIL_MODULE
...
SUBROUTINE LEGACY_VARIABLE_4RD (SELF, KADDRL, KADDRU, KDIR)
USE FIELD_UTIL_MODULE
...
SUBROUTINE CRC64_VARIABLE_4RD (SELF, KLUN, CDPATH)
USE FIELD_UTIL_MODULE
...
SUBROUTINE WIPE_VARIABLE_4RD (SELF, LDDELETED, LDFIELDAPI)
USE FIELD_UTIL_MODULE
...
FUNCTION SIZE_VARIABLE_4RD (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
USE FIELD_UTIL_MODULE
