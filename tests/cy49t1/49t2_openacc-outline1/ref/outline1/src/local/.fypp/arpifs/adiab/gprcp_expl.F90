...
CASE (0)
  ...
  DO JFLD=1, IFLD
    ...
    IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LTHERMACT) THEN
      CALL GPRCP_EXPL_OUTLINE_001 (LLCP, ZCP, YDVARS, JFLD, YDCPG_OPTS, ZR, YDCST, YDCPG_BNDS)
    ENDIF
...
CASE (1)
  ...
  DO JFLD=1, IFLD
    ...
    IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LTHERMACT) THEN
      CALL GPRCP_EXPL_OUTLINE_002 (LLCP, ZCP, YDVARS, JFLD, YDCPG_OPTS, ZR, YDCST, YDCPG_BNDS)
    ENDIF
...
CASE (9)
  ...
  DO JFLD=1, IFLD
    ...
    IF (YDVARS%GFL_PTR (JFLD)%YCOMP%LTHERMACT) THEN
      CALL GPRCP_EXPL_OUTLINE_003 (LLCP, ZCP, YDVARS, JFLD, YDCPG_OPTS, ZR, YDCST, YDCPG_BNDS)
    ENDIF
...
CALL GPRCP_EXPL_OUTLINE_004 (LLCP, ZCP, ZR, YDCPG_OPTS, YDCST, YDCPG_BNDS)

IF (PRESENT (PKAP)) THEN
  CALL GPRCP_EXPL_OUTLINE_005 (ZCP, ZR, YDCPG_OPTS, YDCPG_BNDS, PKAP)
ENDIF
