...
CONTAINS
PROCEDURE :: COPY => COPY_TYPE_GFL_COMP
PROCEDURE :: CRC64 => CRC64_TYPE_GFL_COMP
PROCEDURE :: HOST => HOST_TYPE_GFL_COMP
PROCEDURE :: LEGACY => LEGACY_TYPE_GFL_COMP
PROCEDURE :: LOAD => LOAD_TYPE_GFL_COMP
PROCEDURE :: SAVE => SAVE_TYPE_GFL_COMP
PROCEDURE :: SIZE => SIZE_TYPE_GFL_COMP
PROCEDURE :: WIPE => WIPE_TYPE_GFL_COMP
...
CONTAINS
PROCEDURE :: COPY => COPY_TYPE_GFL_NAML
PROCEDURE :: CRC64 => CRC64_TYPE_GFL_NAML
PROCEDURE :: HOST => HOST_TYPE_GFL_NAML
PROCEDURE :: LEGACY => LEGACY_TYPE_GFL_NAML
PROCEDURE :: LOAD => LOAD_TYPE_GFL_NAML
PROCEDURE :: SAVE => SAVE_TYPE_GFL_NAML
PROCEDURE :: SIZE => SIZE_TYPE_GFL_NAML
PROCEDURE :: WIPE => WIPE_TYPE_GFL_NAML
...
CONTAINS
PROCEDURE :: COPY => COPY_TYPE_GFLD
PROCEDURE :: CRC64 => CRC64_TYPE_GFLD
PROCEDURE :: HOST => HOST_TYPE_GFLD
PROCEDURE :: LEGACY => LEGACY_TYPE_GFLD
PROCEDURE :: LOAD => LOAD_TYPE_GFLD
PROCEDURE :: SAVE => SAVE_TYPE_GFLD
PROCEDURE :: SIZE => SIZE_TYPE_GFLD
PROCEDURE :: WIPE => WIPE_TYPE_GFLD
END TYPE TYPE_GFLD
...
MODULE SUBROUTINE COPY_TYPE_GFL_COMP (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TYPE_GFL_COMP (SELF, KLUN, CDPATH)
...
MODULE SUBROUTINE HOST_TYPE_GFL_COMP (SELF)

IMPLICIT NONE
CLASS (TYPE_GFL_COMP), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LEGACY_TYPE_GFL_COMP (SELF, KADDRL, KADDRU, KDIR)
...
MODULE SUBROUTINE LOAD_TYPE_GFL_COMP (SELF, KLUN)
...
MODULE SUBROUTINE SAVE_TYPE_GFL_COMP (SELF, KLUN)
...
MODULE FUNCTION SIZE_TYPE_GFL_COMP (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TYPE_GFL_COMP (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TYPE_GFL_NAML (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TYPE_GFL_NAML (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE HOST_TYPE_GFL_NAML (SELF)

IMPLICIT NONE
CLASS (TYPE_GFL_NAML), TARGET :: SELF
END SUBROUTINE

MODULE SUBROUTINE LEGACY_TYPE_GFL_NAML (SELF, KADDRL, KADDRU, KDIR)
...
MODULE SUBROUTINE LOAD_TYPE_GFL_NAML (SELF, KLUN)
USE PARKIND1, ONLY : JPRD
...
MODULE SUBROUTINE SAVE_TYPE_GFL_NAML (SELF, KLUN)
...
MODULE FUNCTION SIZE_TYPE_GFL_NAML (SELF, CDPATH, LDPRINT) RESULT (KSIZE)
...
MODULE SUBROUTINE WIPE_TYPE_GFL_NAML (SELF, LDDELETED, LDFIELDAPI)
...
MODULE SUBROUTINE COPY_TYPE_GFLD (SELF, LDCREATED, LDFIELDAPI)
...
MODULE SUBROUTINE CRC64_TYPE_GFLD (SELF, KLUN, CDPATH)
USE CRC64_INTRINSIC, ONLY : FCRC64 => CRC64
...
MODULE SUBROUTINE LEGACY_TYPE_GFLD (SELF, KADDRL, KADDRU, KDIR)
...
MODULE SUBROUTINE LOAD_TYPE_GFLD (SELF, KLUN)
USE PARKIND1, ONLY : JPRD
