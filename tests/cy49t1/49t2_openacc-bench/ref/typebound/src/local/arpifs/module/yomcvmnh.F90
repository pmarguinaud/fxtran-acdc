...
CONTAINS
PROCEDURE :: COPY => COPY_TCVMNH
PROCEDURE :: CRC64 => CRC64_TCVMNH
PROCEDURE :: HOST => HOST_TCVMNH
PROCEDURE :: LOAD => LOAD_TCVMNH
PROCEDURE :: SAVE => SAVE_TCVMNH
PROCEDURE :: SIZE => SIZE_TCVMNH
PROCEDURE :: WIPE => WIPE_TCVMNH
END TYPE TCVMNH
...
MODULE SUBROUTINE LOAD_TCVMNH (SELF, KLUN)
