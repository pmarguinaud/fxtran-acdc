...
IF (ZNOR>ZVMAX2) THEN
  ...
  PRINT *, 'LON=',ACOS(PRCOLON(IROFEXP))*180._JPRB/YDCST%RPI,'DEGREES'
  PRINT *, 'LAT=',ASIN(PGEMU(IROFEXP))*180._JPRB/YDCST%RPI,'DEGREES'
  CALL ABOR1_ACC (' !V WIND TOO STRONG, EXPLOSION!!!')
ENDIF
...
IF (ZEW>ZVMAX2) THEN
  ...
  PRINT *, 'LON=',ACOS(PRCOLON(IROFEXP))*180._JPRB/YDCST%RPI,'DEGREES'
  PRINT *, 'LAT=',ASIN(PGEMU(IROFEXP))*180._JPRB/YDCST%RPI,'DEGREES'
  CALL ABOR1_ACC (' !U WIND TOO STRONG, EXPLOSION!!!')
ENDIF
