SUBROUTINE APL_ARPEGE_DEEP_CONVECTION_INIT (YDVARS, YDCPG_DYN0, YDCPG_OPTS, YDMF_PHYS_SURF&
&, YDMF_PHYS_BASE_STATE, YDGEOMETRY, YDCPG_BNDS, PDXTDK, LDLAND, PVERVEL, PFCQLF, PGEOM1&
&, PGEOMH, PLISUM, PACPR, PLCRIT_AER, PCUCONVCA, PFCQLI, LDSHCV)
